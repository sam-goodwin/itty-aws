 ...
 *
 * Input:  cloudflare/specs/api/resources/**\/methods/**\/index.md
 *         (the per-method markdown pages produced by download-api-docs.ts)
 * Output: cloudflare/smithy/*.json  (one Smithy JSON model per top-level
 ...
 *   bun scripts/spec-to-smithy.ts --specs specs/api/resources --out smithy
 */
