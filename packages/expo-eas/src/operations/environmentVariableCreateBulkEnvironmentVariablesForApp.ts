...
export const EnvironmentVariableCreateBulkEnvironmentVariablesForAppInput =
  Schema.Struct({
    ...
    T.GraphQLOp({
      query: __document,
      operationName: "environmentVariableCreateBulkEnvironmentVariablesForApp",
      type: "mutation",
    }),
  );
export type EnvironmentVariableCreateBulkEnvironmentVariablesForAppInput =
  typeof EnvironmentVariableCreateBulkEnvironmentVariablesForAppInput.Type;

// Output Schema (GraphQL selection set)
export const EnvironmentVariableCreateBulkEnvironmentVariablesForAppOutput =
  Schema.Array(
    Schema.Struct({
      apps: Schema.Array(
        Schema.Struct({
    ...
    T.ResponsePath("environmentVariable.createBulkEnvironmentVariablesForApp"),
  );
export type EnvironmentVariableCreateBulkEnvironmentVariablesForAppOutput =
  typeof EnvironmentVariableCreateBulkEnvironmentVariablesForAppOutput.Type;

export const environmentVariableCreateBulkEnvironmentVariablesForApp = API.make(
  () => ({
    inputSchema: EnvironmentVariableCreateBulkEnvironmentVariablesForAppInput,
    outputSchema: EnvironmentVariableCreateBulkEnvironmentVariablesForAppOutput,
  }),
);
