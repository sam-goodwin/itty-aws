...
const __document =
  "mutation echoMessagePartCreateParts($inputs: [CreateEchoMessagePartInput!]!) {\n  echoMessagePart {\n    createParts(inputs: $inputs) {\n      data\n      echoMessage {\n        completedAt\n        echoChat {\n          agentMetadata\n          agentType\n          id\n          state\n          stats\n          title\n        }\n        echoTurn {\n          completedAt\n          createdAt\n          id\n        }\n        id\n        metadata\n        role\n        turnId\n        user {\n          appCount\n          appetizeCode\n          bestContactEmail\n          created\n          displayName\n          email\n          emailVerified\n          firstName\n          fullName\n          githubUsername\n          hasPassword\n          hasPendingUserInvitations\n          id\n          industry\n          isExpoAdmin\n          isLegacy\n          isSecondFactorAuthenticationEnabled\n          isStaffModeEnabled\n          lastDeletionAttemptTime\n          lastName\n          location\n          newEmailPendingVerification\n          primaryAccountProfileImageUrl\n          profilePhoto\n          twitterUsername\n          username\n        }\n      }\n      id\n      index\n      type\n    }\n  }\n}";

// Input Schema (GraphQL variables)
export const EchoMessagePartCreatePartsInput = Schema.Struct({
  inputs: Schema.Array(
    Schema.Struct({
      data: Schema.Unknown,
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "echoMessagePartCreateParts",
    type: "mutation",
  }),
);
export type EchoMessagePartCreatePartsInput =
  typeof EchoMessagePartCreatePartsInput.Type;

// Output Schema (GraphQL selection set)
export const EchoMessagePartCreatePartsOutput = Schema.Array(
  Schema.Struct({
    data: Schema.Unknown,
...
).pipe(T.ResponsePath("echoMessagePart.createParts"));
export type EchoMessagePartCreatePartsOutput =
  typeof EchoMessagePartCreatePartsOutput.Type;

export const echoMessagePartCreateParts = API.make(() => ({
  inputSchema: EchoMessagePartCreatePartsInput,
  outputSchema: EchoMessagePartCreatePartsOutput,
}));
