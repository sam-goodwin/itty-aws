...
export const UpdateSetRolloutPercentageInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "updateSetRolloutPercentage",
    type: "mutation",
  }),
);
export type UpdateSetRolloutPercentageInput =
  typeof UpdateSetRolloutPercentageInput.Type;

// Output Schema (GraphQL selection set)
export const UpdateSetRolloutPercentageOutput = Schema.Struct({
...
}).pipe(T.ResponsePath("update.setRolloutPercentage"));
export type UpdateSetRolloutPercentageOutput =
  typeof UpdateSetRolloutPercentageOutput.Type;

export const updateSetRolloutPercentage = API.make(() => ({
  inputSchema: UpdateSetRolloutPercentageInput,
  outputSchema: UpdateSetRolloutPercentageOutput,
}));
