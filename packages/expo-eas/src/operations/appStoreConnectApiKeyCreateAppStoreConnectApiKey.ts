...
export const AppStoreConnectApiKeyCreateAppStoreConnectApiKeyInput =
  Schema.Struct({
    ...
    T.GraphQLOp({
      query: __document,
      operationName: "appStoreConnectApiKeyCreateAppStoreConnectApiKey",
      type: "mutation",
    }),
  );
export type AppStoreConnectApiKeyCreateAppStoreConnectApiKeyInput =
  typeof AppStoreConnectApiKeyCreateAppStoreConnectApiKeyInput.Type;

// Output Schema (GraphQL selection set)
export const AppStoreConnectApiKeyCreateAppStoreConnectApiKeyOutput =
  Schema.Struct({
    ...
    updatedAt: Schema.String,
  }).pipe(T.ResponsePath("appStoreConnectApiKey.createAppStoreConnectApiKey"));
export type AppStoreConnectApiKeyCreateAppStoreConnectApiKeyOutput =
  typeof AppStoreConnectApiKeyCreateAppStoreConnectApiKeyOutput.Type;

export const appStoreConnectApiKeyCreateAppStoreConnectApiKey = API.make(
  () => ({
    inputSchema: AppStoreConnectApiKeyCreateAppStoreConnectApiKeyInput,
    outputSchema: AppStoreConnectApiKeyCreateAppStoreConnectApiKeyOutput,
  }),
);
