...
}).pipe(T.ResponsePath("appleTeam.scheduleAppleTeamDeletion"));
export type AppleTeamScheduleAppleTeamDeletionOutput =
  typeof AppleTeamScheduleAppleTeamDeletionOutput.Type;

export const appleTeamScheduleAppleTeamDeletion = API.make(() => ({
  inputSchema: AppleTeamScheduleAppleTeamDeletionInput,
  outputSchema: AppleTeamScheduleAppleTeamDeletionOutput,
}));
