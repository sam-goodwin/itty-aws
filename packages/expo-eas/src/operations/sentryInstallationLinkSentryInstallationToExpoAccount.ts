...
export const SentryInstallationLinkSentryInstallationToExpoAccountOutput =
  Schema.Struct({
    ...
    T.ResponsePath("sentryInstallation.linkSentryInstallationToExpoAccount"),
  );
export type SentryInstallationLinkSentryInstallationToExpoAccountOutput =
  typeof SentryInstallationLinkSentryInstallationToExpoAccountOutput.Type;

export const sentryInstallationLinkSentryInstallationToExpoAccount = API.make(
  () => ({
    inputSchema: SentryInstallationLinkSentryInstallationToExpoAccountInput,
    outputSchema: SentryInstallationLinkSentryInstallationToExpoAccountOutput,
  }),
);
