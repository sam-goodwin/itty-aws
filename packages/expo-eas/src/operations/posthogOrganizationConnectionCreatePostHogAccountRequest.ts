...
export const PosthogOrganizationConnectionCreatePostHogAccountRequestInput =
  Schema.Struct({
    ...
    T.GraphQLOp({
      query: __document,
      operationName: "posthogOrganizationConnectionCreatePostHogAccountRequest",
      type: "mutation",
    }),
  );
export type PosthogOrganizationConnectionCreatePostHogAccountRequestInput =
  typeof PosthogOrganizationConnectionCreatePostHogAccountRequestInput.Type;

// Output Schema (GraphQL selection set)
export const PosthogOrganizationConnectionCreatePostHogAccountRequestOutput =
  Schema.Struct({
    ...
    T.ResponsePath("posthogOrganizationConnection.createPostHogAccountRequest"),
  );
export type PosthogOrganizationConnectionCreatePostHogAccountRequestOutput =
  typeof PosthogOrganizationConnectionCreatePostHogAccountRequestOutput.Type;

export const posthogOrganizationConnectionCreatePostHogAccountRequest =
  API.make(() => ({
    inputSchema: PosthogOrganizationConnectionCreatePostHogAccountRequestInput,
    outputSchema:
      PosthogOrganizationConnectionCreatePostHogAccountRequestOutput,
  }));
