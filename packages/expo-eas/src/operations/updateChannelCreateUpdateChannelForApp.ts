...
export const UpdateChannelCreateUpdateChannelForAppOutput = Schema.Struct({
  ...
  updatedAt: Schema.String,
}).pipe(T.ResponsePath("updateChannel.createUpdateChannelForApp"));
export type UpdateChannelCreateUpdateChannelForAppOutput =
  typeof UpdateChannelCreateUpdateChannelForAppOutput.Type;

export const updateChannelCreateUpdateChannelForApp = API.make(() => ({
  inputSchema: UpdateChannelCreateUpdateChannelForAppInput,
  outputSchema: UpdateChannelCreateUpdateChannelForAppOutput,
}));
