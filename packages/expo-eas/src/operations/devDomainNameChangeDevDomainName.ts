...
export const DevDomainNameChangeDevDomainNameInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "devDomainNameChangeDevDomainName",
    type: "mutation",
  }),
);
export type DevDomainNameChangeDevDomainNameInput =
  typeof DevDomainNameChangeDevDomainNameInput.Type;

// Output Schema (GraphQL selection set)
export const DevDomainNameChangeDevDomainNameOutput = Schema.Struct({
  app: Schema.NullOr(
    Schema.Struct({
  ...
  id: Schema.String,
  name: Schema.Unknown,
}).pipe(T.ResponsePath("devDomainName.changeDevDomainName"));
export type DevDomainNameChangeDevDomainNameOutput =
  typeof DevDomainNameChangeDevDomainNameOutput.Type;

export const devDomainNameChangeDevDomainName = API.make(() => ({
  inputSchema: DevDomainNameChangeDevDomainNameInput,
  outputSchema: DevDomainNameChangeDevDomainNameOutput,
}));
