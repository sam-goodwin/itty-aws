...
}).pipe(T.ResponsePath("updateChannel.scheduleUpdateChannelDeletion"));
export type UpdateChannelScheduleUpdateChannelDeletionOutput =
  typeof UpdateChannelScheduleUpdateChannelDeletionOutput.Type;

export const updateChannelScheduleUpdateChannelDeletion = API.make(() => ({
  inputSchema: UpdateChannelScheduleUpdateChannelDeletionInput,
  outputSchema: UpdateChannelScheduleUpdateChannelDeletionOutput,
}));
