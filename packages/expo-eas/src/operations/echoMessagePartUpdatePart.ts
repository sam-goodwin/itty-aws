...
export const EchoMessagePartUpdatePartInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "echoMessagePartUpdatePart",
    type: "mutation",
  }),
);
export type EchoMessagePartUpdatePartInput =
  typeof EchoMessagePartUpdatePartInput.Type;

// Output Schema (GraphQL selection set)
export const EchoMessagePartUpdatePartOutput = Schema.Struct({
  data: Schema.Unknown,
...
}).pipe(T.ResponsePath("echoMessagePart.updatePart"));
export type EchoMessagePartUpdatePartOutput =
  typeof EchoMessagePartUpdatePartOutput.Type;

export const echoMessagePartUpdatePart = API.make(() => ({
  inputSchema: EchoMessagePartUpdatePartInput,
  outputSchema: EchoMessagePartUpdatePartOutput,
}));
