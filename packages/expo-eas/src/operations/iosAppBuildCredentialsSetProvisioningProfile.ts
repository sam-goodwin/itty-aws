...
export const IosAppBuildCredentialsSetProvisioningProfileInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "iosAppBuildCredentialsSetProvisioningProfile",
    type: "mutation",
  }),
);
export type IosAppBuildCredentialsSetProvisioningProfileInput =
  typeof IosAppBuildCredentialsSetProvisioningProfileInput.Type;

// Output Schema (GraphQL selection set)
export const IosAppBuildCredentialsSetProvisioningProfileOutput = Schema.Struct(
  {
...
).pipe(T.ResponsePath("iosAppBuildCredentials.setProvisioningProfile"));
export type IosAppBuildCredentialsSetProvisioningProfileOutput =
  typeof IosAppBuildCredentialsSetProvisioningProfileOutput.Type;

export const iosAppBuildCredentialsSetProvisioningProfile = API.make(() => ({
  inputSchema: IosAppBuildCredentialsSetProvisioningProfileInput,
  outputSchema: IosAppBuildCredentialsSetProvisioningProfileOutput,
}));
