...
export const EchoMessagePartByEchoMessageIdInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "echoMessagePartByEchoMessageId",
    type: "query",
  }),
);
export type EchoMessagePartByEchoMessageIdInput =
  typeof EchoMessagePartByEchoMessageIdInput.Type;

// Output Schema (GraphQL selection set)
export const EchoMessagePartByEchoMessageIdOutput = Schema.Array(
  Schema.Struct({
    data: Schema.Unknown,
...
).pipe(T.ResponsePath("echoMessagePart.byEchoMessageId"));
export type EchoMessagePartByEchoMessageIdOutput =
  typeof EchoMessagePartByEchoMessageIdOutput.Type;

export const echoMessagePartByEchoMessageId = API.make(() => ({
  inputSchema: EchoMessagePartByEchoMessageIdInput,
  outputSchema: EchoMessagePartByEchoMessageIdOutput,
}));
