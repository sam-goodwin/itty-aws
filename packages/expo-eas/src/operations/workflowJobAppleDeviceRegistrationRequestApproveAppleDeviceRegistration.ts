...
export const WorkflowJobAppleDeviceRegistrationRequestApproveAppleDeviceRegistrationInput =
  Schema.Struct({
    ...
    T.GraphQLOp({
      query: __document,
      operationName:
        "workflowJobAppleDeviceRegistrationRequestApproveAppleDeviceRegistration",
      type: "mutation",
    }),
  );
export type WorkflowJobAppleDeviceRegistrationRequestApproveAppleDeviceRegistrationInput =
  typeof WorkflowJobAppleDeviceRegistrationRequestApproveAppleDeviceRegistrationInput.Type;

// Output Schema (GraphQL selection set)
export const WorkflowJobAppleDeviceRegistrationRequestApproveAppleDeviceRegistrationOutput =
  Schema.Struct({
    ...
    T.ResponsePath(
      "workflowJobAppleDeviceRegistrationRequest.approveAppleDeviceRegistration",
    ),
  );
export type WorkflowJobAppleDeviceRegistrationRequestApproveAppleDeviceRegistrationOutput =
  typeof WorkflowJobAppleDeviceRegistrationRequestApproveAppleDeviceRegistrationOutput.Type;

export const workflowJobAppleDeviceRegistrationRequestApproveAppleDeviceRegistration =
  API.make(() => ({
    inputSchema:
      WorkflowJobAppleDeviceRegistrationRequestApproveAppleDeviceRegistrationInput,
    outputSchema:
      WorkflowJobAppleDeviceRegistrationRequestApproveAppleDeviceRegistrationOutput,
  }));
