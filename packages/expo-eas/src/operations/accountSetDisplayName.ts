...
export const AccountSetDisplayNameInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "accountSetDisplayName",
    type: "mutation",
  }),
);
export type AccountSetDisplayNameInput = typeof AccountSetDisplayNameInput.Type;

// Output Schema (GraphQL selection set)
export const AccountSetDisplayNameOutput = Schema.Struct({
...
}).pipe(T.ResponsePath("account.setDisplayName"));
export type AccountSetDisplayNameOutput =
  typeof AccountSetDisplayNameOutput.Type;

export const accountSetDisplayName = API.make(() => ({
  inputSchema: AccountSetDisplayNameInput,
  outputSchema: AccountSetDisplayNameOutput,
}));
