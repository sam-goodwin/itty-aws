...
export const AccountRenameInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "accountRename",
    type: "mutation",
  }),
);
export type AccountRenameInput = typeof AccountRenameInput.Type;

// Output Schema (GraphQL selection set)
export const AccountRenameOutput = Schema.Struct({
...
}).pipe(T.ResponsePath("account.rename"));
export type AccountRenameOutput = typeof AccountRenameOutput.Type;

export const accountRename = API.make(() => ({
  inputSchema: AccountRenameInput,
  outputSchema: AccountRenameOutput,
}));
