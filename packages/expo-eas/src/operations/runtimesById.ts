...
}).pipe(T.ResponsePath("runtimes.byId"));
export type RuntimesByIdOutput = typeof RuntimesByIdOutput.Type;

export const runtimesById = API.make(() => ({
  inputSchema: RuntimesByIdInput,
  outputSchema: RuntimesByIdOutput,
}));
