...
export const VexoAccountConnectionRevokeAndDeleteVexoAccountConnectionOutput =
  Schema.Struct({
    ...
    T.ResponsePath(
      "vexoAccountConnection.revokeAndDeleteVexoAccountConnection",
    ),
  );
export type VexoAccountConnectionRevokeAndDeleteVexoAccountConnectionOutput =
  typeof VexoAccountConnectionRevokeAndDeleteVexoAccountConnectionOutput.Type;

export const vexoAccountConnectionRevokeAndDeleteVexoAccountConnection =
  API.make(() => ({
    inputSchema: VexoAccountConnectionRevokeAndDeleteVexoAccountConnectionInput,
    outputSchema:
      VexoAccountConnectionRevokeAndDeleteVexoAccountConnectionOutput,
  }));
