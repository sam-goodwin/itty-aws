...
export const WorkflowRevisionGetWorkflowRevisionsFromGitRefInput =
  Schema.Struct({
    ...
    T.GraphQLOp({
      query: __document,
      operationName: "workflowRevisionGetWorkflowRevisionsFromGitRef",
      type: "mutation",
    }),
  );
export type WorkflowRevisionGetWorkflowRevisionsFromGitRefInput =
  typeof WorkflowRevisionGetWorkflowRevisionsFromGitRefInput.Type;

// Output Schema (GraphQL selection set)
export const WorkflowRevisionGetWorkflowRevisionsFromGitRefOutput =
  Schema.Array(
    Schema.Struct({
  ...
  ).pipe(T.ResponsePath("workflowRevision.getWorkflowRevisionsFromGitRef"));
export type WorkflowRevisionGetWorkflowRevisionsFromGitRefOutput =
  typeof WorkflowRevisionGetWorkflowRevisionsFromGitRefOutput.Type;

export const workflowRevisionGetWorkflowRevisionsFromGitRef = API.make(() => ({
  inputSchema: WorkflowRevisionGetWorkflowRevisionsFromGitRefInput,
  outputSchema: WorkflowRevisionGetWorkflowRevisionsFromGitRefOutput,
}));
