...
export const AppleTeamCreateAppleTeamInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "appleTeamCreateAppleTeam",
    type: "mutation",
  }),
);
export type AppleTeamCreateAppleTeamInput =
  typeof AppleTeamCreateAppleTeamInput.Type;

// Output Schema (GraphQL selection set)
export const AppleTeamCreateAppleTeamOutput = Schema.Struct({
  ...
  id: Schema.String,
  lastDeletionAttemptTime: Schema.NullOr(Schema.String),
}).pipe(T.ResponsePath("appleTeam.createAppleTeam"));
export type AppleTeamCreateAppleTeamOutput =
  typeof AppleTeamCreateAppleTeamOutput.Type;

export const appleTeamCreateAppleTeam = API.make(() => ({
  inputSchema: AppleTeamCreateAppleTeamInput,
  outputSchema: AppleTeamCreateAppleTeamOutput,
}));
