...
export const AndroidAppCredentialsCreateFcmV1CredentialOutput = Schema.Struct({
  ...
  androidAppBuildCredentialsList: Schema.Array(
    Schema.Struct({
      androidKeystore: Schema.NullOr(
        Schema.Struct({
          createdAt: Schema.String,
  ...
  androidFcm: Schema.NullOr(
    Schema.Struct({
      ...
      id: Schema.String,
      updatedAt: Schema.String,
      version: Schema.Literals(["LEGACY", "V1"]),
    }),
  ),
  app: Schema.Struct({
  ...
  googleServiceAccountKeyForFcmV1: Schema.NullOr(
    Schema.Struct({
      account: Schema.Struct({
        appCount: Schema.Number,
        availableBuilds: Schema.NullOr(Schema.Number),
  ...
  googleServiceAccountKeyForSubmissions: Schema.NullOr(
    Schema.Struct({
      account: Schema.Struct({
        appCount: Schema.Number,
        availableBuilds: Schema.NullOr(Schema.Number),
  ...
  id: Schema.String,
  isLegacy: Schema.Boolean,
}).pipe(T.ResponsePath("androidAppCredentials.createFcmV1Credential"));
export type AndroidAppCredentialsCreateFcmV1CredentialOutput =
  typeof AndroidAppCredentialsCreateFcmV1CredentialOutput.Type;

export const androidAppCredentialsCreateFcmV1Credential = API.make(() => ({
  inputSchema: AndroidAppCredentialsCreateFcmV1CredentialInput,
  outputSchema: AndroidAppCredentialsCreateFcmV1CredentialOutput,
}));
