...
export const IosAppCredentialsSetAppStoreConnectApiKeyForSubmissionsOutput =
  Schema.Struct({
    ...
    T.ResponsePath("iosAppCredentials.setAppStoreConnectApiKeyForSubmissions"),
  );
export type IosAppCredentialsSetAppStoreConnectApiKeyForSubmissionsOutput =
  typeof IosAppCredentialsSetAppStoreConnectApiKeyForSubmissionsOutput.Type;

export const iosAppCredentialsSetAppStoreConnectApiKeyForSubmissions = API.make(
  () => ({
    inputSchema: IosAppCredentialsSetAppStoreConnectApiKeyForSubmissionsInput,
    outputSchema: IosAppCredentialsSetAppStoreConnectApiKeyForSubmissionsOutput,
  }),
);
