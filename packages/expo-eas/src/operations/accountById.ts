...
export const AccountByIdInput = Schema.Struct({
...
export type AccountByIdInput = typeof AccountByIdInput.Type;

// Output Schema (GraphQL selection set)
export const AccountByIdOutput = Schema.Struct({
...
}).pipe(T.ResponsePath("account.byId"));
export type AccountByIdOutput = typeof AccountByIdOutput.Type;

export const accountById = API.make(() => ({
  inputSchema: AccountByIdInput,
  outputSchema: AccountByIdOutput,
}));
