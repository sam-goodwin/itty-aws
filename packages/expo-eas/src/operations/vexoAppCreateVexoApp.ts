...
export const VexoAppCreateVexoAppInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "vexoAppCreateVexoApp",
    type: "mutation",
  }),
);
export type VexoAppCreateVexoAppInput = typeof VexoAppCreateVexoAppInput.Type;

// Output Schema (GraphQL selection set)
export const VexoAppCreateVexoAppOutput = Schema.Struct({
  app: Schema.Struct({
  ...
  slug: Schema.String,
  vexoIdentifier: Schema.String,
}).pipe(T.ResponsePath("vexoApp.createVexoApp"));
export type VexoAppCreateVexoAppOutput = typeof VexoAppCreateVexoAppOutput.Type;

export const vexoAppCreateVexoApp = API.make(() => ({
  inputSchema: VexoAppCreateVexoAppInput,
  outputSchema: VexoAppCreateVexoAppOutput,
}));
