...
export const GithubRepositoryCreateGitHubRepositoryInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "githubRepositoryCreateGitHubRepository",
    type: "mutation",
  }),
);
export type GithubRepositoryCreateGitHubRepositoryInput =
  typeof GithubRepositoryCreateGitHubRepositoryInput.Type;

// Output Schema (GraphQL selection set)
export const GithubRepositoryCreateGitHubRepositoryOutput = Schema.Struct({
  app: Schema.Struct({
  ...
  nodeIdentifier: Schema.String,
}).pipe(T.ResponsePath("githubRepository.createGitHubRepository"));
export type GithubRepositoryCreateGitHubRepositoryOutput =
  typeof GithubRepositoryCreateGitHubRepositoryOutput.Type;

export const githubRepositoryCreateGitHubRepository = API.make(() => ({
  inputSchema: GithubRepositoryCreateGitHubRepositoryInput,
  outputSchema: GithubRepositoryCreateGitHubRepositoryOutput,
}));
