...
export const EnvironmentVariableCreateBulkEnvironmentVariablesForAccountInput =
  Schema.Struct({
    ...
    T.GraphQLOp({
      query: __document,
      operationName:
        "environmentVariableCreateBulkEnvironmentVariablesForAccount",
      type: "mutation",
    }),
  );
export type EnvironmentVariableCreateBulkEnvironmentVariablesForAccountInput =
  typeof EnvironmentVariableCreateBulkEnvironmentVariablesForAccountInput.Type;

// Output Schema (GraphQL selection set)
export const EnvironmentVariableCreateBulkEnvironmentVariablesForAccountOutput =
  Schema.Array(
    Schema.Struct({
      apps: Schema.Array(
        Schema.Struct({
    ...
    T.ResponsePath(
      "environmentVariable.createBulkEnvironmentVariablesForAccount",
    ),
  );
export type EnvironmentVariableCreateBulkEnvironmentVariablesForAccountOutput =
  typeof EnvironmentVariableCreateBulkEnvironmentVariablesForAccountOutput.Type;

export const environmentVariableCreateBulkEnvironmentVariablesForAccount =
  API.make(() => ({
    inputSchema:
      EnvironmentVariableCreateBulkEnvironmentVariablesForAccountInput,
    outputSchema:
      EnvironmentVariableCreateBulkEnvironmentVariablesForAccountOutput,
  }));
