...
export const EmbeddedUpdateUploadEmbeddedUpdateInput = Schema.Struct({
  input: Schema.Struct({
    ...
    turtleBuildId: Schema.optional(Schema.NullOr(Schema.String)),
  }),
}).pipe(
  T.Http({ method: "POST", path: "/graphql" }),
  T.GraphQLOp({
    query: __document,
    operationName: "embeddedUpdateUploadEmbeddedUpdate",
    type: "mutation",
  }),
);
export type EmbeddedUpdateUploadEmbeddedUpdateInput =
  typeof EmbeddedUpdateUploadEmbeddedUpdateInput.Type;

// Output Schema (GraphQL selection set)
export const EmbeddedUpdateUploadEmbeddedUpdateOutput = Schema.Struct({
  build: Schema.NullOr(
    Schema.Struct({
...
}).pipe(T.ResponsePath("embeddedUpdate.uploadEmbeddedUpdate"));
export type EmbeddedUpdateUploadEmbeddedUpdateOutput =
  typeof EmbeddedUpdateUploadEmbeddedUpdateOutput.Type;

export const embeddedUpdateUploadEmbeddedUpdate = API.make(() => ({
  inputSchema: EmbeddedUpdateUploadEmbeddedUpdateInput,
  outputSchema: EmbeddedUpdateUploadEmbeddedUpdateOutput,
}));
