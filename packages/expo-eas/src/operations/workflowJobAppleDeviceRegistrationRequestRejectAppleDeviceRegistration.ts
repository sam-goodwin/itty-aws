...
export const WorkflowJobAppleDeviceRegistrationRequestRejectAppleDeviceRegistrationInput =
  Schema.Struct({
    ...
    T.GraphQLOp({
      query: __document,
      operationName:
        "workflowJobAppleDeviceRegistrationRequestRejectAppleDeviceRegistration",
      type: "mutation",
    }),
  );
export type WorkflowJobAppleDeviceRegistrationRequestRejectAppleDeviceRegistrationInput =
  typeof WorkflowJobAppleDeviceRegistrationRequestRejectAppleDeviceRegistrationInput.Type;

// Output Schema (GraphQL selection set)
export const WorkflowJobAppleDeviceRegistrationRequestRejectAppleDeviceRegistrationOutput =
  Schema.Struct({
    ...
    T.ResponsePath(
      "workflowJobAppleDeviceRegistrationRequest.rejectAppleDeviceRegistration",
    ),
  );
export type WorkflowJobAppleDeviceRegistrationRequestRejectAppleDeviceRegistrationOutput =
  typeof WorkflowJobAppleDeviceRegistrationRequestRejectAppleDeviceRegistrationOutput.Type;

export const workflowJobAppleDeviceRegistrationRequestRejectAppleDeviceRegistration =
  API.make(() => ({
    inputSchema:
      WorkflowJobAppleDeviceRegistrationRequestRejectAppleDeviceRegistrationInput,
    outputSchema:
      WorkflowJobAppleDeviceRegistrationRequestRejectAppleDeviceRegistrationOutput,
  }));
