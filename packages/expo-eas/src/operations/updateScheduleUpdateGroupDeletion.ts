...
}).pipe(T.ResponsePath("update.scheduleUpdateGroupDeletion"));
export type UpdateScheduleUpdateGroupDeletionOutput =
  typeof UpdateScheduleUpdateGroupDeletionOutput.Type;

export const updateScheduleUpdateGroupDeletion = API.make(() => ({
  inputSchema: UpdateScheduleUpdateGroupDeletionInput,
  outputSchema: UpdateScheduleUpdateGroupDeletionOutput,
}));
