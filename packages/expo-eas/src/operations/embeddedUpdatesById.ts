...
export const EmbeddedUpdatesByIdInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "embeddedUpdatesById",
    type: "query",
  }),
);
export type EmbeddedUpdatesByIdInput = typeof EmbeddedUpdatesByIdInput.Type;

// Output Schema (GraphQL selection set)
export const EmbeddedUpdatesByIdOutput = Schema.Struct({
  build: Schema.NullOr(
    Schema.Struct({
...
}).pipe(T.ResponsePath("embeddedUpdates.byId"));
export type EmbeddedUpdatesByIdOutput = typeof EmbeddedUpdatesByIdOutput.Type;

export const embeddedUpdatesById = API.make(() => ({
  inputSchema: EmbeddedUpdatesByIdInput,
  outputSchema: EmbeddedUpdatesByIdOutput,
}));
