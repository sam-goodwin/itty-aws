...
export const PosthogOrganizationConnectionCompletePostHogConnectionInput =
  Schema.Struct({
    ...
    T.GraphQLOp({
      query: __document,
      operationName: "posthogOrganizationConnectionCompletePostHogConnection",
      type: "mutation",
    }),
  );
export type PosthogOrganizationConnectionCompletePostHogConnectionInput =
  typeof PosthogOrganizationConnectionCompletePostHogConnectionInput.Type;

// Output Schema (GraphQL selection set)
export const PosthogOrganizationConnectionCompletePostHogConnectionOutput =
  Schema.Struct({
    ...
    T.ResponsePath("posthogOrganizationConnection.completePostHogConnection"),
  );
export type PosthogOrganizationConnectionCompletePostHogConnectionOutput =
  typeof PosthogOrganizationConnectionCompletePostHogConnectionOutput.Type;

export const posthogOrganizationConnectionCompletePostHogConnection = API.make(
  () => ({
    inputSchema: PosthogOrganizationConnectionCompletePostHogConnectionInput,
    outputSchema: PosthogOrganizationConnectionCompletePostHogConnectionOutput,
  }),
);
