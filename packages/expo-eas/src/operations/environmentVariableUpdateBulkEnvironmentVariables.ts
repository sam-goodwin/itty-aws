...
export const EnvironmentVariableUpdateBulkEnvironmentVariablesInput =
  Schema.Struct({
    ...
    T.GraphQLOp({
      query: __document,
      operationName: "environmentVariableUpdateBulkEnvironmentVariables",
      type: "mutation",
    }),
  );
export type EnvironmentVariableUpdateBulkEnvironmentVariablesInput =
  typeof EnvironmentVariableUpdateBulkEnvironmentVariablesInput.Type;

// Output Schema (GraphQL selection set)
export const EnvironmentVariableUpdateBulkEnvironmentVariablesOutput =
  Schema.Array(
    Schema.Struct({
      apps: Schema.Array(
        Schema.Struct({
  ...
  ).pipe(T.ResponsePath("environmentVariable.updateBulkEnvironmentVariables"));
export type EnvironmentVariableUpdateBulkEnvironmentVariablesOutput =
  typeof EnvironmentVariableUpdateBulkEnvironmentVariablesOutput.Type;

export const environmentVariableUpdateBulkEnvironmentVariables = API.make(
  () => ({
    inputSchema: EnvironmentVariableUpdateBulkEnvironmentVariablesInput,
    outputSchema: EnvironmentVariableUpdateBulkEnvironmentVariablesOutput,
  }),
);
