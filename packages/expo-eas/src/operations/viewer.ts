...
export const ViewerInput = Schema.Struct({}).pipe(
...
export type ViewerInput = typeof ViewerInput.Type;

// Output Schema (GraphQL selection set)
export const ViewerOutput = Schema.NullOr(
  Schema.Struct({
 ...
 * query object
 */
export const viewer = API.make(() => ({
  inputSchema: ViewerInput,
  outputSchema: ViewerOutput,
}));
