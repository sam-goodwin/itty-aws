...
export const UpdateChannelPauseUpdateChannelOutput = Schema.Struct({
  ...
  updatedAt: Schema.String,
}).pipe(T.ResponsePath("updateChannel.pauseUpdateChannel"));
export type UpdateChannelPauseUpdateChannelOutput =
  typeof UpdateChannelPauseUpdateChannelOutput.Type;

export const updateChannelPauseUpdateChannel = API.make(() => ({
  inputSchema: UpdateChannelPauseUpdateChannelInput,
  outputSchema: UpdateChannelPauseUpdateChannelOutput,
}));
