...
export const IosAppBuildCredentialsCreateIosAppBuildCredentialsInput =
  Schema.Struct({
    iosAppBuildCredentialsInput: Schema.Struct({
      ...
      provisioningProfileId: Schema.String,
    }),
    iosAppCredentialsId: Schema.String,
  }).pipe(
    T.Http({ method: "POST", path: "/graphql" }),
    T.GraphQLOp({
      query: __document,
      operationName: "iosAppBuildCredentialsCreateIosAppBuildCredentials",
      type: "mutation",
    }),
  );
export type IosAppBuildCredentialsCreateIosAppBuildCredentialsInput =
  typeof IosAppBuildCredentialsCreateIosAppBuildCredentialsInput.Type;

// Output Schema (GraphQL selection set)
export const IosAppBuildCredentialsCreateIosAppBuildCredentialsOutput =
  Schema.Struct({
    ...
    T.ResponsePath("iosAppBuildCredentials.createIosAppBuildCredentials"),
  );
export type IosAppBuildCredentialsCreateIosAppBuildCredentialsOutput =
  typeof IosAppBuildCredentialsCreateIosAppBuildCredentialsOutput.Type;

export const iosAppBuildCredentialsCreateIosAppBuildCredentials = API.make(
  () => ({
    inputSchema: IosAppBuildCredentialsCreateIosAppBuildCredentialsInput,
    outputSchema: IosAppBuildCredentialsCreateIosAppBuildCredentialsOutput,
  }),
);
