...
export const AppleDistributionCertificateCreateAppleDistributionCertificateInput =
  Schema.Struct({
    ...
    T.GraphQLOp({
      query: __document,
      operationName:
        "appleDistributionCertificateCreateAppleDistributionCertificate",
      type: "mutation",
    }),
  );
export type AppleDistributionCertificateCreateAppleDistributionCertificateInput =
  typeof AppleDistributionCertificateCreateAppleDistributionCertificateInput.Type;

// Output Schema (GraphQL selection set)
export const AppleDistributionCertificateCreateAppleDistributionCertificateOutput =
  Schema.NullOr(
    Schema.Struct({
    ...
    T.ResponsePath(
      "appleDistributionCertificate.createAppleDistributionCertificate",
    ),
  );
export type AppleDistributionCertificateCreateAppleDistributionCertificateOutput =
  typeof AppleDistributionCertificateCreateAppleDistributionCertificateOutput.Type;

export const appleDistributionCertificateCreateAppleDistributionCertificate =
  API.make(() => ({
    inputSchema:
      AppleDistributionCertificateCreateAppleDistributionCertificateInput,
    outputSchema:
      AppleDistributionCertificateCreateAppleDistributionCertificateOutput,
  }));
