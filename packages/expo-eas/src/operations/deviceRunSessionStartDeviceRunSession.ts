...
export const DeviceRunSessionStartDeviceRunSessionOutput = Schema.Struct({
  ...
  updatedAt: Schema.String,
}).pipe(T.ResponsePath("deviceRunSession.startDeviceRunSession"));
export type DeviceRunSessionStartDeviceRunSessionOutput =
  typeof DeviceRunSessionStartDeviceRunSessionOutput.Type;

export const deviceRunSessionStartDeviceRunSession = API.make(() => ({
  inputSchema: DeviceRunSessionStartDeviceRunSessionInput,
  outputSchema: DeviceRunSessionStartDeviceRunSessionOutput,
}));
