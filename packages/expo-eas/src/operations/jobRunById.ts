...
}).pipe(T.ResponsePath("jobRun.byId"));
export type JobRunByIdOutput = typeof JobRunByIdOutput.Type;

export const jobRunById = API.make(() => ({
  inputSchema: JobRunByIdInput,
  outputSchema: JobRunByIdOutput,
}));
