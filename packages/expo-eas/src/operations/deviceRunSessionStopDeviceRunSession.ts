...
export const DeviceRunSessionStopDeviceRunSessionOutput = Schema.Struct({
  ...
  updatedAt: Schema.String,
}).pipe(T.ResponsePath("deviceRunSession.stopDeviceRunSession"));
export type DeviceRunSessionStopDeviceRunSessionOutput =
  typeof DeviceRunSessionStopDeviceRunSessionOutput.Type;

export const deviceRunSessionStopDeviceRunSession = API.make(() => ({
  inputSchema: DeviceRunSessionStopDeviceRunSessionInput,
  outputSchema: DeviceRunSessionStopDeviceRunSessionOutput,
}));
