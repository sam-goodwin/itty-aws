...
export const GithubBuildTriggerDeleteGitHubBuildTriggerOutput = Schema.Struct({
  ...
  updatedAt: Schema.String,
}).pipe(T.ResponsePath("githubBuildTrigger.deleteGitHubBuildTrigger"));
export type GithubBuildTriggerDeleteGitHubBuildTriggerOutput =
  typeof GithubBuildTriggerDeleteGitHubBuildTriggerOutput.Type;

export const githubBuildTriggerDeleteGitHubBuildTrigger = API.make(() => ({
  inputSchema: GithubBuildTriggerDeleteGitHubBuildTriggerInput,
  outputSchema: GithubBuildTriggerDeleteGitHubBuildTriggerOutput,
}));
