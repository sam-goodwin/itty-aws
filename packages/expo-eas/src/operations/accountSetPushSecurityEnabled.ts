...
export const AccountSetPushSecurityEnabledInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "accountSetPushSecurityEnabled",
    type: "mutation",
  }),
);
export type AccountSetPushSecurityEnabledInput =
  typeof AccountSetPushSecurityEnabledInput.Type;

// Output Schema (GraphQL selection set)
export const AccountSetPushSecurityEnabledOutput = Schema.Struct({
...
}).pipe(T.ResponsePath("account.setPushSecurityEnabled"));
export type AccountSetPushSecurityEnabledOutput =
  typeof AccountSetPushSecurityEnabledOutput.Type;

export const accountSetPushSecurityEnabled = API.make(() => ({
  inputSchema: AccountSetPushSecurityEnabledInput,
  outputSchema: AccountSetPushSecurityEnabledOutput,
}));
