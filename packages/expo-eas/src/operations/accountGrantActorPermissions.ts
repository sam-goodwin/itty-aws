...
export const AccountGrantActorPermissionsInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "accountGrantActorPermissions",
    type: "mutation",
  }),
);
export type AccountGrantActorPermissionsInput =
  typeof AccountGrantActorPermissionsInput.Type;

// Output Schema (GraphQL selection set)
export const AccountGrantActorPermissionsOutput = Schema.Struct({
...
}).pipe(T.ResponsePath("account.grantActorPermissions"));
export type AccountGrantActorPermissionsOutput =
  typeof AccountGrantActorPermissionsOutput.Type;

export const accountGrantActorPermissions = API.make(() => ({
  inputSchema: AccountGrantActorPermissionsInput,
  outputSchema: AccountGrantActorPermissionsOutput,
}));
