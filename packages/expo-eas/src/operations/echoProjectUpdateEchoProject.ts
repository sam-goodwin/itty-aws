...
export const EchoProjectUpdateEchoProjectInput = Schema.Struct({
  ...
  input: Schema.Struct({
    ...
    initFromEchoProjectId: Schema.optional(Schema.NullOr(Schema.String)),
    initFromGitHubUrl: Schema.optional(Schema.NullOr(Schema.String)),
    ...
    visibility: Schema.optional(
      Schema.NullOr(Schema.Literals(["PRIVATE", "PUBLIC"])),
    ),
  }),
}).pipe(
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "echoProjectUpdateEchoProject",
    type: "mutation",
  }),
);
export type EchoProjectUpdateEchoProjectInput =
  typeof EchoProjectUpdateEchoProjectInput.Type;

// Output Schema (GraphQL selection set)
export const EchoProjectUpdateEchoProjectOutput = Schema.Struct({
...
}).pipe(T.ResponsePath("echoProject.updateEchoProject"));
export type EchoProjectUpdateEchoProjectOutput =
  typeof EchoProjectUpdateEchoProjectOutput.Type;

export const echoProjectUpdateEchoProject = API.make(() => ({
  inputSchema: EchoProjectUpdateEchoProjectInput,
  outputSchema: EchoProjectUpdateEchoProjectOutput,
}));
