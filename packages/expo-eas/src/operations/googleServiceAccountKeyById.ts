...
export const GoogleServiceAccountKeyByIdOutput = Schema.Struct({
  ...
  updatedAt: Schema.String,
}).pipe(T.ResponsePath("googleServiceAccountKey.byId"));
export type GoogleServiceAccountKeyByIdOutput =
  typeof GoogleServiceAccountKeyByIdOutput.Type;

export const googleServiceAccountKeyById = API.make(() => ({
  inputSchema: GoogleServiceAccountKeyByIdInput,
  outputSchema: GoogleServiceAccountKeyByIdOutput,
}));
