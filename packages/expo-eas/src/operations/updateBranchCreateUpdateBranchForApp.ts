...
export const UpdateBranchCreateUpdateBranchForAppInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "updateBranchCreateUpdateBranchForApp",
    type: "mutation",
  }),
);
export type UpdateBranchCreateUpdateBranchForAppInput =
  typeof UpdateBranchCreateUpdateBranchForAppInput.Type;

// Output Schema (GraphQL selection set)
export const UpdateBranchCreateUpdateBranchForAppOutput = Schema.Struct({
  app: Schema.Struct({
  ...
  name: Schema.String,
  updatedAt: Schema.String,
}).pipe(T.ResponsePath("updateBranch.createUpdateBranchForApp"));
export type UpdateBranchCreateUpdateBranchForAppOutput =
  typeof UpdateBranchCreateUpdateBranchForAppOutput.Type;

export const updateBranchCreateUpdateBranchForApp = API.make(() => ({
  inputSchema: UpdateBranchCreateUpdateBranchForAppInput,
  outputSchema: UpdateBranchCreateUpdateBranchForAppOutput,
}));
