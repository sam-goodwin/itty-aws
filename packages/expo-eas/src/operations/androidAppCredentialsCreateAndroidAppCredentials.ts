...
export const AndroidAppCredentialsCreateAndroidAppCredentialsInput =
  Schema.Struct({
    ...
    T.GraphQLOp({
      query: __document,
      operationName: "androidAppCredentialsCreateAndroidAppCredentials",
      type: "mutation",
    }),
  );
export type AndroidAppCredentialsCreateAndroidAppCredentialsInput =
  typeof AndroidAppCredentialsCreateAndroidAppCredentialsInput.Type;

// Output Schema (GraphQL selection set)
export const AndroidAppCredentialsCreateAndroidAppCredentialsOutput =
  Schema.Struct({
    ...
    id: Schema.String,
    isLegacy: Schema.Boolean,
  }).pipe(T.ResponsePath("androidAppCredentials.createAndroidAppCredentials"));
export type AndroidAppCredentialsCreateAndroidAppCredentialsOutput =
  typeof AndroidAppCredentialsCreateAndroidAppCredentialsOutput.Type;

export const androidAppCredentialsCreateAndroidAppCredentials = API.make(
  () => ({
    inputSchema: AndroidAppCredentialsCreateAndroidAppCredentialsInput,
    outputSchema: AndroidAppCredentialsCreateAndroidAppCredentialsOutput,
  }),
);
