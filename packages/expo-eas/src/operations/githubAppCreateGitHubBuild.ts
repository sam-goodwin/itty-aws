...
export const GithubAppCreateGitHubBuildInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "githubAppCreateGitHubBuild",
    type: "mutation",
  }),
);
export type GithubAppCreateGitHubBuildInput =
  typeof GithubAppCreateGitHubBuildInput.Type;

// Output Schema (GraphQL selection set)
export const GithubAppCreateGitHubBuildOutput = Schema.Struct({
...
}).pipe(T.ResponsePath("githubApp.createGitHubBuild"));
export type GithubAppCreateGitHubBuildOutput =
  typeof GithubAppCreateGitHubBuildOutput.Type;

export const githubAppCreateGitHubBuild = API.make(() => ({
  inputSchema: GithubAppCreateGitHubBuildInput,
  outputSchema: GithubAppCreateGitHubBuildOutput,
}));
