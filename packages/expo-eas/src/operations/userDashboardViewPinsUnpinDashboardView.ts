...
).pipe(T.ResponsePath("userDashboardViewPins.unpinDashboardView"));
export type UserDashboardViewPinsUnpinDashboardViewOutput =
  typeof UserDashboardViewPinsUnpinDashboardViewOutput.Type;

export const userDashboardViewPinsUnpinDashboardView = API.make(() => ({
  inputSchema: UserDashboardViewPinsUnpinDashboardViewInput,
  outputSchema: UserDashboardViewPinsUnpinDashboardViewOutput,
}));
