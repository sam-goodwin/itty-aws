...
export const ApplePushKeyCreateApplePushKeyInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "applePushKeyCreateApplePushKey",
    type: "mutation",
  }),
);
export type ApplePushKeyCreateApplePushKeyInput =
  typeof ApplePushKeyCreateApplePushKeyInput.Type;

// Output Schema (GraphQL selection set)
export const ApplePushKeyCreateApplePushKeyOutput = Schema.Struct({
  ...
  keyP8: Schema.String,
  updatedAt: Schema.String,
}).pipe(T.ResponsePath("applePushKey.createApplePushKey"));
export type ApplePushKeyCreateApplePushKeyOutput =
  typeof ApplePushKeyCreateApplePushKeyOutput.Type;

export const applePushKeyCreateApplePushKey = API.make(() => ({
  inputSchema: ApplePushKeyCreateApplePushKeyInput,
  outputSchema: ApplePushKeyCreateApplePushKeyOutput,
}));
