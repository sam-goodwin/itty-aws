...
}).pipe(T.ResponsePath("jobRun.cancelJobRun"));
export type JobRunCancelJobRunOutput = typeof JobRunCancelJobRunOutput.Type;

export const jobRunCancelJobRun = API.make(() => ({
  inputSchema: JobRunCancelJobRunInput,
  outputSchema: JobRunCancelJobRunOutput,
}));
