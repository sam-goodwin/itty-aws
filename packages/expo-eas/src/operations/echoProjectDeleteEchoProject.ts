...
}).pipe(T.ResponsePath("echoProject.deleteEchoProject"));
export type EchoProjectDeleteEchoProjectOutput =
  typeof EchoProjectDeleteEchoProjectOutput.Type;

export const echoProjectDeleteEchoProject = API.make(() => ({
  inputSchema: EchoProjectDeleteEchoProjectInput,
  outputSchema: EchoProjectDeleteEchoProjectOutput,
}));
