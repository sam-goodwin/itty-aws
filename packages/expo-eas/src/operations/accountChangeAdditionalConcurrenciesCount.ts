...
}).pipe(T.ResponsePath("account.changeAdditionalConcurrenciesCount"));
export type AccountChangeAdditionalConcurrenciesCountOutput =
  typeof AccountChangeAdditionalConcurrenciesCountOutput.Type;

export const accountChangeAdditionalConcurrenciesCount = API.make(() => ({
  inputSchema: AccountChangeAdditionalConcurrenciesCountInput,
  outputSchema: AccountChangeAdditionalConcurrenciesCountOutput,
}));
