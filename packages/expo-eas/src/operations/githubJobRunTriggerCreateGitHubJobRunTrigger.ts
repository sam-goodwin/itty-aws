...
export const GithubJobRunTriggerCreateGitHubJobRunTriggerInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "githubJobRunTriggerCreateGitHubJobRunTrigger",
    type: "mutation",
  }),
);
export type GithubJobRunTriggerCreateGitHubJobRunTriggerInput =
  typeof GithubJobRunTriggerCreateGitHubJobRunTriggerInput.Type;

// Output Schema (GraphQL selection set)
export const GithubJobRunTriggerCreateGitHubJobRunTriggerOutput = Schema.Struct(
  {
    app: Schema.Struct({
...
).pipe(T.ResponsePath("githubJobRunTrigger.createGitHubJobRunTrigger"));
export type GithubJobRunTriggerCreateGitHubJobRunTriggerOutput =
  typeof GithubJobRunTriggerCreateGitHubJobRunTriggerOutput.Type;

export const githubJobRunTriggerCreateGitHubJobRunTrigger = API.make(() => ({
  inputSchema: GithubJobRunTriggerCreateGitHubJobRunTriggerInput,
  outputSchema: GithubJobRunTriggerCreateGitHubJobRunTriggerOutput,
}));
