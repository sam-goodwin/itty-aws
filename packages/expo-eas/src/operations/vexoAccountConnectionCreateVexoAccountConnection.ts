...
export const VexoAccountConnectionCreateVexoAccountConnectionInput =
  Schema.Struct({
    ...
    T.GraphQLOp({
      query: __document,
      operationName: "vexoAccountConnectionCreateVexoAccountConnection",
      type: "mutation",
    }),
  );
export type VexoAccountConnectionCreateVexoAccountConnectionInput =
  typeof VexoAccountConnectionCreateVexoAccountConnectionInput.Type;

// Output Schema (GraphQL selection set)
export const VexoAccountConnectionCreateVexoAccountConnectionOutput =
  Schema.Struct({
    ...
    id: Schema.String,
  }).pipe(T.ResponsePath("vexoAccountConnection.createVexoAccountConnection"));
export type VexoAccountConnectionCreateVexoAccountConnectionOutput =
  typeof VexoAccountConnectionCreateVexoAccountConnectionOutput.Type;

export const vexoAccountConnectionCreateVexoAccountConnection = API.make(
  () => ({
    inputSchema: VexoAccountConnectionCreateVexoAccountConnectionInput,
    outputSchema: VexoAccountConnectionCreateVexoAccountConnectionOutput,
  }),
);
