...
export const AppleProvisioningProfileByIdOutput = Schema.Struct({
  ...
  updatedAt: Schema.String,
}).pipe(T.ResponsePath("appleProvisioningProfile.byId"));
export type AppleProvisioningProfileByIdOutput =
  typeof AppleProvisioningProfileByIdOutput.Type;

export const appleProvisioningProfileById = API.make(() => ({
  inputSchema: AppleProvisioningProfileByIdInput,
  outputSchema: AppleProvisioningProfileByIdOutput,
}));
