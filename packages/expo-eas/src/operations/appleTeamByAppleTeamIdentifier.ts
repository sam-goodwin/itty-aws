...
export const AppleTeamByAppleTeamIdentifierInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "appleTeamByAppleTeamIdentifier",
    type: "query",
  }),
);
export type AppleTeamByAppleTeamIdentifierInput =
  typeof AppleTeamByAppleTeamIdentifierInput.Type;

// Output Schema (GraphQL selection set)
export const AppleTeamByAppleTeamIdentifierOutput = Schema.NullOr(
  Schema.Struct({
...
).pipe(T.ResponsePath("appleTeam.byAppleTeamIdentifier"));
export type AppleTeamByAppleTeamIdentifierOutput =
  typeof AppleTeamByAppleTeamIdentifierOutput.Type;

export const appleTeamByAppleTeamIdentifier = API.make(() => ({
  inputSchema: AppleTeamByAppleTeamIdentifierInput,
  outputSchema: AppleTeamByAppleTeamIdentifierOutput,
}));
