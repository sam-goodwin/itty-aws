...
}).pipe(T.ResponsePath("workflowRun.retryWorkflowRun"));
export type WorkflowRunRetryWorkflowRunOutput =
  typeof WorkflowRunRetryWorkflowRunOutput.Type;

export const workflowRunRetryWorkflowRun = API.make(() => ({
  inputSchema: WorkflowRunRetryWorkflowRunInput,
  outputSchema: WorkflowRunRetryWorkflowRunOutput,
}));
