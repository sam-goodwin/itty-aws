...
export const GithubAppInstallationDeleteGitHubAppInstallationInput =
  Schema.Struct({
    ...
    T.GraphQLOp({
      query: __document,
      operationName: "githubAppInstallationDeleteGitHubAppInstallation",
      type: "mutation",
    }),
  );
export type GithubAppInstallationDeleteGitHubAppInstallationInput =
  typeof GithubAppInstallationDeleteGitHubAppInstallationInput.Type;

// Output Schema (GraphQL selection set)
export const GithubAppInstallationDeleteGitHubAppInstallationOutput =
  Schema.Struct({
  ...
  }).pipe(T.ResponsePath("githubAppInstallation.deleteGitHubAppInstallation"));
export type GithubAppInstallationDeleteGitHubAppInstallationOutput =
  typeof GithubAppInstallationDeleteGitHubAppInstallationOutput.Type;

export const githubAppInstallationDeleteGitHubAppInstallation = API.make(
  () => ({
    inputSchema: GithubAppInstallationDeleteGitHubAppInstallationInput,
    outputSchema: GithubAppInstallationDeleteGitHubAppInstallationOutput,
  }),
);
