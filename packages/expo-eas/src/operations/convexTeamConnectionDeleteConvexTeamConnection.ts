...
export const ConvexTeamConnectionDeleteConvexTeamConnectionInput =
  Schema.Struct({
    ...
    T.GraphQLOp({
      query: __document,
      operationName: "convexTeamConnectionDeleteConvexTeamConnection",
      type: "mutation",
    }),
  );
export type ConvexTeamConnectionDeleteConvexTeamConnectionInput =
  typeof ConvexTeamConnectionDeleteConvexTeamConnectionInput.Type;

// Output Schema (GraphQL selection set)
export const ConvexTeamConnectionDeleteConvexTeamConnectionOutput =
  Schema.Struct({
    ...
    id: Schema.String,
    updatedAt: Schema.String,
  }).pipe(T.ResponsePath("convexTeamConnection.deleteConvexTeamConnection"));
export type ConvexTeamConnectionDeleteConvexTeamConnectionOutput =
  typeof ConvexTeamConnectionDeleteConvexTeamConnectionOutput.Type;

export const convexTeamConnectionDeleteConvexTeamConnection = API.make(() => ({
  inputSchema: ConvexTeamConnectionDeleteConvexTeamConnectionInput,
  outputSchema: ConvexTeamConnectionDeleteConvexTeamConnectionOutput,
}));
