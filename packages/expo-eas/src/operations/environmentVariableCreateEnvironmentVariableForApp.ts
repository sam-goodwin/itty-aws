...
export const EnvironmentVariableCreateEnvironmentVariableForAppInput =
  Schema.Struct({
    ...
    T.GraphQLOp({
      query: __document,
      operationName: "environmentVariableCreateEnvironmentVariableForApp",
      type: "mutation",
    }),
  );
export type EnvironmentVariableCreateEnvironmentVariableForAppInput =
  typeof EnvironmentVariableCreateEnvironmentVariableForAppInput.Type;

// Output Schema (GraphQL selection set)
export const EnvironmentVariableCreateEnvironmentVariableForAppOutput =
  Schema.Struct({
    apps: Schema.Array(
      Schema.Struct({
    ...
    T.ResponsePath("environmentVariable.createEnvironmentVariableForApp"),
  );
export type EnvironmentVariableCreateEnvironmentVariableForAppOutput =
  typeof EnvironmentVariableCreateEnvironmentVariableForAppOutput.Type;

export const environmentVariableCreateEnvironmentVariableForApp = API.make(
  () => ({
    inputSchema: EnvironmentVariableCreateEnvironmentVariableForAppInput,
    outputSchema: EnvironmentVariableCreateEnvironmentVariableForAppOutput,
  }),
);
