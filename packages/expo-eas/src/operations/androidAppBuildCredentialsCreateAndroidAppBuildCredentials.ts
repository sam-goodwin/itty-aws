...
const __document =
  "mutation androidAppBuildCredentialsCreateAndroidAppBuildCredentials($androidAppBuildCredentialsInput: AndroidAppBuildCredentialsInput!, $androidAppCredentialsId: ID!) {\n  androidAppBuildCredentials {\n    createAndroidAppBuildCredentials(androidAppBuildCredentialsInput: $androidAppBuildCredentialsInput, androidAppCredentialsId: $androidAppCredentialsId) {\n      androidKeystore {\n        account {\n          appCount\n          availableBuilds\n          createdAt\n          displayName\n          environmentVariableEnvironments\n          hasBuilds\n          id\n          isCurrent\n          isDisabled\n          isFreeAppDevDomainTier\n          isSSOEnabled\n          lastDeletionAttemptTime\n          name\n          profileImageUrl\n          pushSecurityEnabled\n          requireTwoFactor\n          requiresAccessTokenForPushSecurity\n          ssoAllowedAuthProviders\n          subscriptionChangesPending\n          unlimitedBuilds\n          updatedAt\n          userSpecifiedAccountUsage\n          willAutoRenewBuilds\n        }\n        createdAt\n        id\n        keyAlias\n        keyPassword\n        keystore\n        keystorePassword\n        md5CertificateFingerprint\n        sha1CertificateFingerprint\n        sha256CertificateFingerprint\n        type\n        updatedAt\n      }\n      id\n      isDefault\n      isLegacy\n      name\n    }\n  }\n}";

// Input Schema (GraphQL variables)
export const AndroidAppBuildCredentialsCreateAndroidAppBuildCredentialsInput =
  Schema.Struct({
    androidAppBuildCredentialsInput: Schema.Struct({
    ...
    T.GraphQLOp({
      query: __document,
      operationName:
        "androidAppBuildCredentialsCreateAndroidAppBuildCredentials",
      type: "mutation",
    }),
  );
export type AndroidAppBuildCredentialsCreateAndroidAppBuildCredentialsInput =
  typeof AndroidAppBuildCredentialsCreateAndroidAppBuildCredentialsInput.Type;

// Output Schema (GraphQL selection set)
export const AndroidAppBuildCredentialsCreateAndroidAppBuildCredentialsOutput =
  Schema.Struct({
...
export type AndroidAppBuildCredentialsCreateAndroidAppBuildCredentialsOutput =
  typeof AndroidAppBuildCredentialsCreateAndroidAppBuildCredentialsOutput.Type;

export const androidAppBuildCredentialsCreateAndroidAppBuildCredentials =
  API.make(() => ({
    inputSchema:
      AndroidAppBuildCredentialsCreateAndroidAppBuildCredentialsInput,
    outputSchema:
      AndroidAppBuildCredentialsCreateAndroidAppBuildCredentialsOutput,
  }));
