...
export const UpdateSetCodeSigningInfoInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "updateSetCodeSigningInfo",
    type: "mutation",
  }),
);
export type UpdateSetCodeSigningInfoInput =
  typeof UpdateSetCodeSigningInfoInput.Type;

// Output Schema (GraphQL selection set)
export const UpdateSetCodeSigningInfoOutput = Schema.Struct({
...
}).pipe(T.ResponsePath("update.setCodeSigningInfo"));
export type UpdateSetCodeSigningInfoOutput =
  typeof UpdateSetCodeSigningInfoOutput.Type;

export const updateSetCodeSigningInfo = API.make(() => ({
  inputSchema: UpdateSetCodeSigningInfoInput,
  outputSchema: UpdateSetCodeSigningInfoOutput,
}));
