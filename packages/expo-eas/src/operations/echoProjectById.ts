...
).pipe(T.ResponsePath("echoProject.byId"));
export type EchoProjectByIdOutput = typeof EchoProjectByIdOutput.Type;

export const echoProjectById = API.make(() => ({
  inputSchema: EchoProjectByIdInput,
  outputSchema: EchoProjectByIdOutput,
}));
