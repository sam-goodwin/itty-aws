...
export const AppleDeviceRegistrationRequestCreateAppleDeviceRegistrationRequestInput =
  Schema.Struct({
    ...
    T.GraphQLOp({
      query: __document,
      operationName:
        "appleDeviceRegistrationRequestCreateAppleDeviceRegistrationRequest",
      type: "mutation",
    }),
  );
export type AppleDeviceRegistrationRequestCreateAppleDeviceRegistrationRequestInput =
  typeof AppleDeviceRegistrationRequestCreateAppleDeviceRegistrationRequestInput.Type;

// Output Schema (GraphQL selection set)
export const AppleDeviceRegistrationRequestCreateAppleDeviceRegistrationRequestOutput =
  Schema.Struct({
    ...
    T.ResponsePath(
      "appleDeviceRegistrationRequest.createAppleDeviceRegistrationRequest",
    ),
  );
export type AppleDeviceRegistrationRequestCreateAppleDeviceRegistrationRequestOutput =
  typeof AppleDeviceRegistrationRequestCreateAppleDeviceRegistrationRequestOutput.Type;

export const appleDeviceRegistrationRequestCreateAppleDeviceRegistrationRequest =
  API.make(() => ({
    inputSchema:
      AppleDeviceRegistrationRequestCreateAppleDeviceRegistrationRequestInput,
    outputSchema:
      AppleDeviceRegistrationRequestCreateAppleDeviceRegistrationRequestOutput,
  }));
