...
}).pipe(T.ResponsePath("appleDevice.createAppleDevice"));
export type AppleDeviceCreateAppleDeviceOutput =
  typeof AppleDeviceCreateAppleDeviceOutput.Type;

export const appleDeviceCreateAppleDevice = API.make(() => ({
  inputSchema: AppleDeviceCreateAppleDeviceInput,
  outputSchema: AppleDeviceCreateAppleDeviceOutput,
}));
