...
const __document =
  "mutation customDomainRegisterCustomDomain($aliasName: WorkerDeploymentIdentifier, $appId: ID!, $hostname: String!) {\n  customDomain {\n    registerCustomDomain(aliasName: $aliasName, appId: $appId, hostname: $hostname) {\n      alias {\n        aliasName\n        createdAt\n        deploymentDomain\n        devDomainName\n        id\n        subdomain\n        updatedAt\n        url\n        workerDeployment {\n          activityTimestamp\n          createdAt\n          deploymentDomain\n          deploymentIdentifier\n          devDomainName\n          id\n          signedAssetsURL\n          signedDeploymentURL\n          subdomain\n          url\n        }\n      }\n      createdAt\n      dcvDelegationRecord {\n        dnsContent\n        dnsName\n        dnsType\n        isConfigured\n      }\n      devDomainName\n      dnsRecord {\n        dnsContent\n        dnsName\n        dnsType\n        isConfigured\n      }\n      hostname\n      id\n      setup {\n        sslErrors\n        sslStatus\n        status\n        verificationErrors\n        verificationStatus\n      }\n      updatedAt\n      verificationRecord {\n        dnsContent\n        dnsName\n        dnsType\n        isConfigured\n      }\n    }\n  }\n}";

// Input Schema (GraphQL variables)
export const CustomDomainRegisterCustomDomainInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "customDomainRegisterCustomDomain",
    type: "mutation",
  }),
);
export type CustomDomainRegisterCustomDomainInput =
  typeof CustomDomainRegisterCustomDomainInput.Type;

// Output Schema (GraphQL selection set)
export const CustomDomainRegisterCustomDomainOutput = Schema.Struct({
  alias: Schema.Struct({
...
}).pipe(T.ResponsePath("customDomain.registerCustomDomain"));
export type CustomDomainRegisterCustomDomainOutput =
  typeof CustomDomainRegisterCustomDomainOutput.Type;

export const customDomainRegisterCustomDomain = API.make(() => ({
  inputSchema: CustomDomainRegisterCustomDomainInput,
  outputSchema: CustomDomainRegisterCustomDomainOutput,
}));
