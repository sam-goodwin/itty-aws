...
export const GoogleServiceAccountKeyCreateGoogleServiceAccountKeyOutput =
  Schema.Struct({
    ...
    T.ResponsePath("googleServiceAccountKey.createGoogleServiceAccountKey"),
  );
export type GoogleServiceAccountKeyCreateGoogleServiceAccountKeyOutput =
  typeof GoogleServiceAccountKeyCreateGoogleServiceAccountKeyOutput.Type;

export const googleServiceAccountKeyCreateGoogleServiceAccountKey = API.make(
  () => ({
    inputSchema: GoogleServiceAccountKeyCreateGoogleServiceAccountKeyInput,
    outputSchema: GoogleServiceAccountKeyCreateGoogleServiceAccountKeyOutput,
  }),
);
