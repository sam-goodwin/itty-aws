...
export const AccountRevokeActorPermissionsInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "accountRevokeActorPermissions",
    type: "mutation",
  }),
);
export type AccountRevokeActorPermissionsInput =
  typeof AccountRevokeActorPermissionsInput.Type;

// Output Schema (GraphQL selection set)
export const AccountRevokeActorPermissionsOutput = Schema.Struct({
...
}).pipe(T.ResponsePath("account.revokeActorPermissions"));
export type AccountRevokeActorPermissionsOutput =
  typeof AccountRevokeActorPermissionsOutput.Type;

export const accountRevokeActorPermissions = API.make(() => ({
  inputSchema: AccountRevokeActorPermissionsInput,
  outputSchema: AccountRevokeActorPermissionsOutput,
}));
