...
}).pipe(T.ResponsePath("app.scheduleAppDeletion"));
export type AppScheduleAppDeletionOutput =
  typeof AppScheduleAppDeletionOutput.Type;

export const appScheduleAppDeletion = API.make(() => ({
  inputSchema: AppScheduleAppDeletionInput,
  outputSchema: AppScheduleAppDeletionOutput,
}));
