...
export const AccountChangePlanInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "accountChangePlan",
    type: "mutation",
  }),
);
export type AccountChangePlanInput = typeof AccountChangePlanInput.Type;

// Output Schema (GraphQL selection set)
export const AccountChangePlanOutput = Schema.Struct({
...
}).pipe(T.ResponsePath("account.changePlan"));
export type AccountChangePlanOutput = typeof AccountChangePlanOutput.Type;

export const accountChangePlan = API.make(() => ({
  inputSchema: AccountChangePlanInput,
  outputSchema: AccountChangePlanOutput,
}));
