...
).pipe(T.ResponsePath("echoMessage.byId"));
export type EchoMessageByIdOutput = typeof EchoMessageByIdOutput.Type;

export const echoMessageById = API.make(() => ({
  inputSchema: EchoMessageByIdInput,
  outputSchema: EchoMessageByIdOutput,
}));
