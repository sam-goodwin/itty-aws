...
).pipe(T.ResponsePath("echoChat.byId"));
export type EchoChatByIdOutput = typeof EchoChatByIdOutput.Type;

export const echoChatById = API.make(() => ({
  inputSchema: EchoChatByIdInput,
  outputSchema: EchoChatByIdOutput,
}));
