...
export const AppleTeamUpdateAppleTeamInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "appleTeamUpdateAppleTeam",
    type: "mutation",
  }),
);
export type AppleTeamUpdateAppleTeamInput =
  typeof AppleTeamUpdateAppleTeamInput.Type;

// Output Schema (GraphQL selection set)
export const AppleTeamUpdateAppleTeamOutput = Schema.Struct({
  ...
  id: Schema.String,
  lastDeletionAttemptTime: Schema.NullOr(Schema.String),
}).pipe(T.ResponsePath("appleTeam.updateAppleTeam"));
export type AppleTeamUpdateAppleTeamOutput =
  typeof AppleTeamUpdateAppleTeamOutput.Type;

export const appleTeamUpdateAppleTeam = API.make(() => ({
  inputSchema: AppleTeamUpdateAppleTeamInput,
  outputSchema: AppleTeamUpdateAppleTeamOutput,
}));
