...
}).pipe(T.ResponsePath("app.removeProfileImage"));
export type AppRemoveProfileImageOutput =
  typeof AppRemoveProfileImageOutput.Type;

export const appRemoveProfileImage = API.make(() => ({
  inputSchema: AppRemoveProfileImageInput,
  outputSchema: AppRemoveProfileImageOutput,
}));
