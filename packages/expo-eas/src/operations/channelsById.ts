...
export const ChannelsByIdOutput = Schema.Struct({
  ...
  updatedAt: Schema.String,
}).pipe(T.ResponsePath("channels.byId"));
export type ChannelsByIdOutput = typeof ChannelsByIdOutput.Type;

export const channelsById = API.make(() => ({
  inputSchema: ChannelsByIdInput,
  outputSchema: ChannelsByIdOutput,
}));
