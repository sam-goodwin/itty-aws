...
export const EchoProjectCreateEchoProjectInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "echoProjectCreateEchoProject",
    type: "mutation",
  }),
);
export type EchoProjectCreateEchoProjectInput =
  typeof EchoProjectCreateEchoProjectInput.Type;

// Output Schema (GraphQL selection set)
export const EchoProjectCreateEchoProjectOutput = Schema.Struct({
...
}).pipe(T.ResponsePath("echoProject.createEchoProject"));
export type EchoProjectCreateEchoProjectOutput =
  typeof EchoProjectCreateEchoProjectOutput.Type;

export const echoProjectCreateEchoProject = API.make(() => ({
  inputSchema: EchoProjectCreateEchoProjectInput,
  outputSchema: EchoProjectCreateEchoProjectOutput,
}));
