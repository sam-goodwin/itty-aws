...
export const DeviceRunSessionEnsureDeviceRunSessionStoppedInput = Schema.Struct(
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "deviceRunSessionEnsureDeviceRunSessionStopped",
    type: "mutation",
  }),
);
export type DeviceRunSessionEnsureDeviceRunSessionStoppedInput =
  typeof DeviceRunSessionEnsureDeviceRunSessionStoppedInput.Type;

// Output Schema (GraphQL selection set)
export const DeviceRunSessionEnsureDeviceRunSessionStoppedOutput =
  Schema.Struct({
    app: Schema.Struct({
...
export type DeviceRunSessionEnsureDeviceRunSessionStoppedOutput =
  typeof DeviceRunSessionEnsureDeviceRunSessionStoppedOutput.Type;

export const deviceRunSessionEnsureDeviceRunSessionStopped = API.make(() => ({
  inputSchema: DeviceRunSessionEnsureDeviceRunSessionStoppedInput,
  outputSchema: DeviceRunSessionEnsureDeviceRunSessionStoppedOutput,
}));
