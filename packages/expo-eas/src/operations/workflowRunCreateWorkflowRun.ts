...
export const WorkflowRunCreateWorkflowRunInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "workflowRunCreateWorkflowRun",
    type: "mutation",
  }),
);
export type WorkflowRunCreateWorkflowRunInput =
  typeof WorkflowRunCreateWorkflowRunInput.Type;

// Output Schema (GraphQL selection set)
export const WorkflowRunCreateWorkflowRunOutput = Schema.Struct({
...
}).pipe(T.ResponsePath("workflowRun.createWorkflowRun"));
export type WorkflowRunCreateWorkflowRunOutput =
  typeof WorkflowRunCreateWorkflowRunOutput.Type;

export const workflowRunCreateWorkflowRun = API.make(() => ({
  inputSchema: WorkflowRunCreateWorkflowRunInput,
  outputSchema: WorkflowRunCreateWorkflowRunOutput,
}));
