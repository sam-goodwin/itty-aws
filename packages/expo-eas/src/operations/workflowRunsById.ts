...
}).pipe(T.ResponsePath("workflowRuns.byId"));
export type WorkflowRunsByIdOutput = typeof WorkflowRunsByIdOutput.Type;

export const workflowRunsById = API.make(() => ({
  inputSchema: WorkflowRunsByIdInput,
  outputSchema: WorkflowRunsByIdOutput,
}));
