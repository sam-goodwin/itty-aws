...
export const AndroidAppCredentialsSetFcmInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "androidAppCredentialsSetFcm",
    type: "mutation",
  }),
);
export type AndroidAppCredentialsSetFcmInput =
  typeof AndroidAppCredentialsSetFcmInput.Type;

// Output Schema (GraphQL selection set)
export const AndroidAppCredentialsSetFcmOutput = Schema.Struct({
  ...
  id: Schema.String,
  isLegacy: Schema.Boolean,
}).pipe(T.ResponsePath("androidAppCredentials.setFcm"));
export type AndroidAppCredentialsSetFcmOutput =
  typeof AndroidAppCredentialsSetFcmOutput.Type;

export const androidAppCredentialsSetFcm = API.make(() => ({
  inputSchema: AndroidAppCredentialsSetFcmInput,
  outputSchema: AndroidAppCredentialsSetFcmOutput,
}));
