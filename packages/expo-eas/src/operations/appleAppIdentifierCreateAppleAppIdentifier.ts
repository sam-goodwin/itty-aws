...
export const AppleAppIdentifierCreateAppleAppIdentifierOutput = Schema.Struct({
  ...
  bundleIdentifier: Schema.String,
  id: Schema.String,
}).pipe(T.ResponsePath("appleAppIdentifier.createAppleAppIdentifier"));
export type AppleAppIdentifierCreateAppleAppIdentifierOutput =
  typeof AppleAppIdentifierCreateAppleAppIdentifierOutput.Type;

export const appleAppIdentifierCreateAppleAppIdentifier = API.make(() => ({
  inputSchema: AppleAppIdentifierCreateAppleAppIdentifierInput,
  outputSchema: AppleAppIdentifierCreateAppleAppIdentifierOutput,
}));
