...
export const WorkerDeploymentByIdOutput = Schema.Struct({
  ...
  subdomain: Schema.String,
  url: Schema.String,
}).pipe(T.ResponsePath("workerDeployment.byId"));
export type WorkerDeploymentByIdOutput = typeof WorkerDeploymentByIdOutput.Type;

export const workerDeploymentById = API.make(() => ({
  inputSchema: WorkerDeploymentByIdInput,
  outputSchema: WorkerDeploymentByIdOutput,
}));
