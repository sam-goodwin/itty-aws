...
export const WorkflowRevisionGetOrCreateWorkflowRevisionFromGitRefInput =
  Schema.Struct({
    ...
    T.GraphQLOp({
      query: __document,
      operationName: "workflowRevisionGetOrCreateWorkflowRevisionFromGitRef",
      type: "mutation",
    }),
  );
export type WorkflowRevisionGetOrCreateWorkflowRevisionFromGitRefInput =
  typeof WorkflowRevisionGetOrCreateWorkflowRevisionFromGitRefInput.Type;

// Output Schema (GraphQL selection set)
export const WorkflowRevisionGetOrCreateWorkflowRevisionFromGitRefOutput =
  Schema.Struct({
    ...
    T.ResponsePath("workflowRevision.getOrCreateWorkflowRevisionFromGitRef"),
  );
export type WorkflowRevisionGetOrCreateWorkflowRevisionFromGitRefOutput =
  typeof WorkflowRevisionGetOrCreateWorkflowRevisionFromGitRefOutput.Type;

export const workflowRevisionGetOrCreateWorkflowRevisionFromGitRef = API.make(
  () => ({
    inputSchema: WorkflowRevisionGetOrCreateWorkflowRevisionFromGitRefInput,
    outputSchema: WorkflowRevisionGetOrCreateWorkflowRevisionFromGitRefOutput,
  }),
);
