...
).pipe(T.ResponsePath("githubJobRunTrigger.deleteGitHubJobRunTrigger"));
export type GithubJobRunTriggerDeleteGitHubJobRunTriggerOutput =
  typeof GithubJobRunTriggerDeleteGitHubJobRunTriggerOutput.Type;

export const githubJobRunTriggerDeleteGitHubJobRunTrigger = API.make(() => ({
  inputSchema: GithubJobRunTriggerDeleteGitHubJobRunTriggerInput,
  outputSchema: GithubJobRunTriggerDeleteGitHubJobRunTriggerOutput,
}));
