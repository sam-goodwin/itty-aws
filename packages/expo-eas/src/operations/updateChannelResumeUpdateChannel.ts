...
export const UpdateChannelResumeUpdateChannelOutput = Schema.Struct({
  ...
  updatedAt: Schema.String,
}).pipe(T.ResponsePath("updateChannel.resumeUpdateChannel"));
export type UpdateChannelResumeUpdateChannelOutput =
  typeof UpdateChannelResumeUpdateChannelOutput.Type;

export const updateChannelResumeUpdateChannel = API.make(() => ({
  inputSchema: UpdateChannelResumeUpdateChannelInput,
  outputSchema: UpdateChannelResumeUpdateChannelOutput,
}));
