...
export const LogRocketProjectCreateLogRocketProjectInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "logRocketProjectCreateLogRocketProject",
    type: "mutation",
  }),
);
export type LogRocketProjectCreateLogRocketProjectInput =
  typeof LogRocketProjectCreateLogRocketProjectInput.Type;

// Output Schema (GraphQL selection set)
export const LogRocketProjectCreateLogRocketProjectOutput = Schema.Struct({
  app: Schema.Struct({
  ...
  logRocketProjectSlug: Schema.String,
  updatedAt: Schema.String,
}).pipe(T.ResponsePath("logRocketProject.createLogRocketProject"));
export type LogRocketProjectCreateLogRocketProjectOutput =
  typeof LogRocketProjectCreateLogRocketProjectOutput.Type;

export const logRocketProjectCreateLogRocketProject = API.make(() => ({
  inputSchema: LogRocketProjectCreateLogRocketProjectInput,
  outputSchema: LogRocketProjectCreateLogRocketProjectOutput,
}));
