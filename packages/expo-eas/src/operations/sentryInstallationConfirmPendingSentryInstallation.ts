...
export const SentryInstallationConfirmPendingSentryInstallationInput =
  Schema.Struct({
    ...
    T.GraphQLOp({
      query: __document,
      operationName: "sentryInstallationConfirmPendingSentryInstallation",
      type: "mutation",
    }),
  );
export type SentryInstallationConfirmPendingSentryInstallationInput =
  typeof SentryInstallationConfirmPendingSentryInstallationInput.Type;

// Output Schema (GraphQL selection set)
export const SentryInstallationConfirmPendingSentryInstallationOutput =
  Schema.Struct({
    ...
    T.ResponsePath("sentryInstallation.confirmPendingSentryInstallation"),
  );
export type SentryInstallationConfirmPendingSentryInstallationOutput =
  typeof SentryInstallationConfirmPendingSentryInstallationOutput.Type;

export const sentryInstallationConfirmPendingSentryInstallation = API.make(
  () => ({
    inputSchema: SentryInstallationConfirmPendingSentryInstallationInput,
    outputSchema: SentryInstallationConfirmPendingSentryInstallationOutput,
  }),
);
