...
export const AndroidAppCredentialsSetGoogleServiceAccountKeyForFcmV1Input =
  Schema.Struct({
    ...
    T.GraphQLOp({
      query: __document,
      operationName: "androidAppCredentialsSetGoogleServiceAccountKeyForFcmV1",
      type: "mutation",
    }),
  );
export type AndroidAppCredentialsSetGoogleServiceAccountKeyForFcmV1Input =
  typeof AndroidAppCredentialsSetGoogleServiceAccountKeyForFcmV1Input.Type;

// Output Schema (GraphQL selection set)
export const AndroidAppCredentialsSetGoogleServiceAccountKeyForFcmV1Output =
  Schema.Struct({
    ...
    T.ResponsePath("androidAppCredentials.setGoogleServiceAccountKeyForFcmV1"),
  );
export type AndroidAppCredentialsSetGoogleServiceAccountKeyForFcmV1Output =
  typeof AndroidAppCredentialsSetGoogleServiceAccountKeyForFcmV1Output.Type;

export const androidAppCredentialsSetGoogleServiceAccountKeyForFcmV1 = API.make(
  () => ({
    inputSchema: AndroidAppCredentialsSetGoogleServiceAccountKeyForFcmV1Input,
    outputSchema: AndroidAppCredentialsSetGoogleServiceAccountKeyForFcmV1Output,
  }),
);
