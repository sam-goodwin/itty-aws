...
export const IosAppCredentialsCreateIosAppCredentialsInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "iosAppCredentialsCreateIosAppCredentials",
    type: "mutation",
  }),
);
export type IosAppCredentialsCreateIosAppCredentialsInput =
  typeof IosAppCredentialsCreateIosAppCredentialsInput.Type;

// Output Schema (GraphQL selection set)
export const IosAppCredentialsCreateIosAppCredentialsOutput = Schema.Struct({
  app: Schema.Struct({
...
}).pipe(T.ResponsePath("iosAppCredentials.createIosAppCredentials"));
export type IosAppCredentialsCreateIosAppCredentialsOutput =
  typeof IosAppCredentialsCreateIosAppCredentialsOutput.Type;

export const iosAppCredentialsCreateIosAppCredentials = API.make(() => ({
  inputSchema: IosAppCredentialsCreateIosAppCredentialsInput,
  outputSchema: IosAppCredentialsCreateIosAppCredentialsOutput,
}));
