...
export const FingerprintCreateOrGetExistingFingerprintInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "fingerprintCreateOrGetExistingFingerprint",
    type: "mutation",
  }),
);
export type FingerprintCreateOrGetExistingFingerprintInput =
  typeof FingerprintCreateOrGetExistingFingerprintInput.Type;

// Output Schema (GraphQL selection set)
export const FingerprintCreateOrGetExistingFingerprintOutput = Schema.Struct({
  app: Schema.Struct({
  ...
  updatedAt: Schema.String,
}).pipe(T.ResponsePath("fingerprint.createOrGetExistingFingerprint"));
export type FingerprintCreateOrGetExistingFingerprintOutput =
  typeof FingerprintCreateOrGetExistingFingerprintOutput.Type;

export const fingerprintCreateOrGetExistingFingerprint = API.make(() => ({
  inputSchema: FingerprintCreateOrGetExistingFingerprintInput,
  outputSchema: FingerprintCreateOrGetExistingFingerprintOutput,
}));
