...
export const AppByIdInput = Schema.Struct({
  appId: Schema.String,
}).pipe(
  T.Http({ method: "POST", path: "/graphql" }),
  T.GraphQLOp({
    query: __document,
    operationName: "appById",
    type: "query",
  }),
);
export type AppByIdInput = typeof AppByIdInput.Type;

// Output Schema (GraphQL selection set)
export const AppByIdOutput = Schema.Struct({
...
}).pipe(T.ResponsePath("app.byId"));
export type AppByIdOutput = typeof AppByIdOutput.Type;

export const appById = API.make(() => ({
  inputSchema: AppByIdInput,
  outputSchema: AppByIdOutput,
}));
