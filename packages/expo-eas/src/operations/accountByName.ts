...
export const AccountByNameInput = Schema.Struct({
  accountName: Schema.String,
}).pipe(
  T.Http({ method: "POST", path: "/graphql" }),
  T.GraphQLOp({
    query: __document,
    operationName: "accountByName",
    type: "query",
  }),
);
export type AccountByNameInput = typeof AccountByNameInput.Type;

// Output Schema (GraphQL selection set)
export const AccountByNameOutput = Schema.Struct({
...
}).pipe(T.ResponsePath("account.byName"));
export type AccountByNameOutput = typeof AccountByNameOutput.Type;

export const accountByName = API.make(() => ({
  inputSchema: AccountByNameInput,
  outputSchema: AccountByNameOutput,
}));
