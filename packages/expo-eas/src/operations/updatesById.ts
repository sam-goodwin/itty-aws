...
}).pipe(T.ResponsePath("updates.byId"));
export type UpdatesByIdOutput = typeof UpdatesByIdOutput.Type;

export const updatesById = API.make(() => ({
  inputSchema: UpdatesByIdInput,
  outputSchema: UpdatesByIdOutput,
}));
