...
export const GithubRepositorySettingsUpdateGitHubRepositorySettingsInput =
  Schema.Struct({
    ...
    T.GraphQLOp({
      query: __document,
      operationName: "githubRepositorySettingsUpdateGitHubRepositorySettings",
      type: "mutation",
    }),
  );
export type GithubRepositorySettingsUpdateGitHubRepositorySettingsInput =
  typeof GithubRepositorySettingsUpdateGitHubRepositorySettingsInput.Type;

// Output Schema (GraphQL selection set)
export const GithubRepositorySettingsUpdateGitHubRepositorySettingsOutput =
  Schema.Struct({
    app: Schema.Struct({
    ...
    T.ResponsePath("githubRepositorySettings.updateGitHubRepositorySettings"),
  );
export type GithubRepositorySettingsUpdateGitHubRepositorySettingsOutput =
  typeof GithubRepositorySettingsUpdateGitHubRepositorySettingsOutput.Type;

export const githubRepositorySettingsUpdateGitHubRepositorySettings = API.make(
  () => ({
    inputSchema: GithubRepositorySettingsUpdateGitHubRepositorySettingsInput,
    outputSchema: GithubRepositorySettingsUpdateGitHubRepositorySettingsOutput,
  }),
);
