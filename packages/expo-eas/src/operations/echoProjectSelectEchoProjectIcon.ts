...
export const EchoProjectSelectEchoProjectIconInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "echoProjectSelectEchoProjectIcon",
    type: "mutation",
  }),
);
export type EchoProjectSelectEchoProjectIconInput =
  typeof EchoProjectSelectEchoProjectIconInput.Type;

// Output Schema (GraphQL selection set)
export const EchoProjectSelectEchoProjectIconOutput = Schema.Struct({
...
}).pipe(T.ResponsePath("echoProject.selectEchoProjectIcon"));
export type EchoProjectSelectEchoProjectIconOutput =
  typeof EchoProjectSelectEchoProjectIconOutput.Type;

export const echoProjectSelectEchoProjectIcon = API.make(() => ({
  inputSchema: EchoProjectSelectEchoProjectIconInput,
  outputSchema: EchoProjectSelectEchoProjectIconOutput,
}));
