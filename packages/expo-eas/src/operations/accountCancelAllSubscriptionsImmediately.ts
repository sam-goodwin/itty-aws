...
export const AccountCancelAllSubscriptionsImmediatelyInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "accountCancelAllSubscriptionsImmediately",
    type: "mutation",
  }),
);
export type AccountCancelAllSubscriptionsImmediatelyInput =
  typeof AccountCancelAllSubscriptionsImmediatelyInput.Type;

// Output Schema (GraphQL selection set)
export const AccountCancelAllSubscriptionsImmediatelyOutput = Schema.Struct({
...
}).pipe(T.ResponsePath("account.cancelAllSubscriptionsImmediately"));
export type AccountCancelAllSubscriptionsImmediatelyOutput =
  typeof AccountCancelAllSubscriptionsImmediatelyOutput.Type;

export const accountCancelAllSubscriptionsImmediately = API.make(() => ({
  inputSchema: AccountCancelAllSubscriptionsImmediatelyInput,
  outputSchema: AccountCancelAllSubscriptionsImmediatelyOutput,
}));
