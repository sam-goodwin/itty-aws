...
}).pipe(T.ResponsePath("submissions.byId"));
export type SubmissionsByIdOutput = typeof SubmissionsByIdOutput.Type;

export const submissionsById = API.make(() => ({
  inputSchema: SubmissionsByIdInput,
  outputSchema: SubmissionsByIdOutput,
}));
