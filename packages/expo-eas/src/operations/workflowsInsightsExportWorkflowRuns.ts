...
export const WorkflowsInsightsExportWorkflowRunsInput = Schema.Struct({
    ...
    filters: Schema.optional(
      Schema.NullOr(
        Schema.Struct({
          ...
          triggerEventTypes: Schema.optional(
            Schema.NullOr(
              Schema.Array(
                Schema.Literals([
          ...
          workflowIds: Schema.optional(
            Schema.NullOr(Schema.Array(Schema.String)),
          ),
        }),
      ),
    ),
    format: Schema.Literals(["CSV", "NDJSON"]),
    timespan: Schema.Struct({
      end: Schema.String,
      start: Schema.String,
    }),
  }),
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "workflowsInsightsExportWorkflowRuns",
    type: "mutation",
  }),
);
export type WorkflowsInsightsExportWorkflowRunsInput =
  typeof WorkflowsInsightsExportWorkflowRunsInput.Type;

// Output Schema (GraphQL selection set)
export const WorkflowsInsightsExportWorkflowRunsOutput = Schema.Struct({
...
}).pipe(T.ResponsePath("workflowsInsights.exportWorkflowRuns"));
export type WorkflowsInsightsExportWorkflowRunsOutput =
  typeof WorkflowsInsightsExportWorkflowRunsOutput.Type;

export const workflowsInsightsExportWorkflowRuns = API.make(() => ({
  inputSchema: WorkflowsInsightsExportWorkflowRunsInput,
  outputSchema: WorkflowsInsightsExportWorkflowRunsOutput,
}));
