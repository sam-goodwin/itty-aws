...
).pipe(T.ResponsePath("echoProject.bySlug"));
export type EchoProjectBySlugOutput = typeof EchoProjectBySlugOutput.Type;

export const echoProjectBySlug = API.make(() => ({
  inputSchema: EchoProjectBySlugInput,
  outputSchema: EchoProjectBySlugOutput,
}));
