...
}).pipe(T.ResponsePath("account.changeAdditionalAgentCreditsCount"));
export type AccountChangeAdditionalAgentCreditsCountOutput =
  typeof AccountChangeAdditionalAgentCreditsCountOutput.Type;

export const accountChangeAdditionalAgentCreditsCount = API.make(() => ({
  inputSchema: AccountChangeAdditionalAgentCreditsCountInput,
  outputSchema: AccountChangeAdditionalAgentCreditsCountOutput,
}));
