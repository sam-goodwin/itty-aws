...
export const WorkflowsByAppIdAndFileNameInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "workflowsByAppIdAndFileName",
    type: "query",
  }),
);
export type WorkflowsByAppIdAndFileNameInput =
  typeof WorkflowsByAppIdAndFileNameInput.Type;

// Output Schema (GraphQL selection set)
export const WorkflowsByAppIdAndFileNameOutput = Schema.Struct({
  app: Schema.Struct({
  ...
  updatedAt: Schema.String,
}).pipe(T.ResponsePath("workflows.byAppIdAndFileName"));
export type WorkflowsByAppIdAndFileNameOutput =
  typeof WorkflowsByAppIdAndFileNameOutput.Type;

export const workflowsByAppIdAndFileName = API.make(() => ({
  inputSchema: WorkflowsByAppIdAndFileNameInput,
  outputSchema: WorkflowsByAppIdAndFileNameOutput,
}));
