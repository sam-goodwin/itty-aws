...
export const AppleDeviceUpdateAppleDeviceInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "appleDeviceUpdateAppleDevice",
    type: "mutation",
  }),
);
export type AppleDeviceUpdateAppleDeviceInput =
  typeof AppleDeviceUpdateAppleDeviceInput.Type;

// Output Schema (GraphQL selection set)
export const AppleDeviceUpdateAppleDeviceOutput = Schema.Struct({
...
}).pipe(T.ResponsePath("appleDevice.updateAppleDevice"));
export type AppleDeviceUpdateAppleDeviceOutput =
  typeof AppleDeviceUpdateAppleDeviceOutput.Type;

export const appleDeviceUpdateAppleDevice = API.make(() => ({
  inputSchema: AppleDeviceUpdateAppleDeviceInput,
  outputSchema: AppleDeviceUpdateAppleDeviceOutput,
}));
