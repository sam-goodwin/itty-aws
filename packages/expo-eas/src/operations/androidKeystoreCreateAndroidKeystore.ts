...
export const AndroidKeystoreCreateAndroidKeystoreInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "androidKeystoreCreateAndroidKeystore",
    type: "mutation",
  }),
);
export type AndroidKeystoreCreateAndroidKeystoreInput =
  typeof AndroidKeystoreCreateAndroidKeystoreInput.Type;

// Output Schema (GraphQL selection set)
export const AndroidKeystoreCreateAndroidKeystoreOutput = Schema.NullOr(
  Schema.Struct({
...
).pipe(T.ResponsePath("androidKeystore.createAndroidKeystore"));
export type AndroidKeystoreCreateAndroidKeystoreOutput =
  typeof AndroidKeystoreCreateAndroidKeystoreOutput.Type;

export const androidKeystoreCreateAndroidKeystore = API.make(() => ({
  inputSchema: AndroidKeystoreCreateAndroidKeystoreInput,
  outputSchema: AndroidKeystoreCreateAndroidKeystoreOutput,
}));
