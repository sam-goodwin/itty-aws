...
).pipe(T.ResponsePath("githubJobRunTrigger.updateGitHubJobRunTrigger"));
export type GithubJobRunTriggerUpdateGitHubJobRunTriggerOutput =
  typeof GithubJobRunTriggerUpdateGitHubJobRunTriggerOutput.Type;

export const githubJobRunTriggerUpdateGitHubJobRunTrigger = API.make(() => ({
  inputSchema: GithubJobRunTriggerUpdateGitHubJobRunTriggerInput,
  outputSchema: GithubJobRunTriggerUpdateGitHubJobRunTriggerOutput,
}));
