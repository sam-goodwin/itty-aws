...
export const MeUserActorInput = Schema.Struct({}).pipe(
  T.Http({ method: "POST", path: "/graphql" }),
  T.GraphQLOp({
    query: __document,
    operationName: "meUserActor",
    type: "query",
  }),
);
export type MeUserActorInput = typeof MeUserActorInput.Type;

// Output Schema (GraphQL selection set)
export const MeUserActorOutput = Schema.NullOr(
  Schema.Struct({
 ...
 */
export const meUserActor = API.make(() => ({
  inputSchema: MeUserActorInput,
  outputSchema: MeUserActorOutput,
}));
