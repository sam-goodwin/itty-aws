...
export const PosthogProjectSetupPostHogProjectOutput = Schema.Struct({
  ...
  updatedAt: Schema.String,
}).pipe(T.ResponsePath("posthogProject.setupPostHogProject"));
export type PosthogProjectSetupPostHogProjectOutput =
  typeof PosthogProjectSetupPostHogProjectOutput.Type;

export const posthogProjectSetupPostHogProject = API.make(() => ({
  inputSchema: PosthogProjectSetupPostHogProjectInput,
  outputSchema: PosthogProjectSetupPostHogProjectOutput,
}));
