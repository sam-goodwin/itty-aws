...
export const AndroidAppCredentialsSetGoogleServiceAccountKeyForSubmissionsInput =
  Schema.Struct({
    ...
    T.GraphQLOp({
      query: __document,
      operationName:
        "androidAppCredentialsSetGoogleServiceAccountKeyForSubmissions",
      type: "mutation",
    }),
  );
export type AndroidAppCredentialsSetGoogleServiceAccountKeyForSubmissionsInput =
  typeof AndroidAppCredentialsSetGoogleServiceAccountKeyForSubmissionsInput.Type;

// Output Schema (GraphQL selection set)
export const AndroidAppCredentialsSetGoogleServiceAccountKeyForSubmissionsOutput =
  Schema.Struct({
    ...
    T.ResponsePath(
      "androidAppCredentials.setGoogleServiceAccountKeyForSubmissions",
    ),
  );
export type AndroidAppCredentialsSetGoogleServiceAccountKeyForSubmissionsOutput =
  typeof AndroidAppCredentialsSetGoogleServiceAccountKeyForSubmissionsOutput.Type;

export const androidAppCredentialsSetGoogleServiceAccountKeyForSubmissions =
  API.make(() => ({
    inputSchema:
      AndroidAppCredentialsSetGoogleServiceAccountKeyForSubmissionsInput,
    outputSchema:
      AndroidAppCredentialsSetGoogleServiceAccountKeyForSubmissionsOutput,
  }));
