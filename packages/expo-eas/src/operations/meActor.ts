...
export const MeActorInput = Schema.Struct({}).pipe(
  T.Http({ method: "POST", path: "/graphql" }),
  T.GraphQLOp({
    query: __document,
    operationName: "meActor",
    type: "query",
  }),
);
export type MeActorInput = typeof MeActorInput.Type;

// Output Schema (GraphQL selection set)
export const MeActorOutput = Schema.NullOr(
  Schema.Struct({
 ...
 * query object
 */
export const meActor = API.make(() => ({
  inputSchema: MeActorInput,
  outputSchema: MeActorOutput,
}));
