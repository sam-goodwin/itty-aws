...
export const EnvironmentVariableCreateEnvironmentVariableForEchoProjectInput =
  Schema.Struct({
    ...
    T.GraphQLOp({
      query: __document,
      operationName:
        "environmentVariableCreateEnvironmentVariableForEchoProject",
      type: "mutation",
    }),
  );
export type EnvironmentVariableCreateEnvironmentVariableForEchoProjectInput =
  typeof EnvironmentVariableCreateEnvironmentVariableForEchoProjectInput.Type;

// Output Schema (GraphQL selection set)
export const EnvironmentVariableCreateEnvironmentVariableForEchoProjectOutput =
  Schema.Struct({
    apps: Schema.Array(
      Schema.Struct({
    ...
    T.ResponsePath(
      "environmentVariable.createEnvironmentVariableForEchoProject",
    ),
  );
export type EnvironmentVariableCreateEnvironmentVariableForEchoProjectOutput =
  typeof EnvironmentVariableCreateEnvironmentVariableForEchoProjectOutput.Type;

export const environmentVariableCreateEnvironmentVariableForEchoProject =
  API.make(() => ({
    inputSchema:
      EnvironmentVariableCreateEnvironmentVariableForEchoProjectInput,
    outputSchema:
      EnvironmentVariableCreateEnvironmentVariableForEchoProjectOutput,
  }));
