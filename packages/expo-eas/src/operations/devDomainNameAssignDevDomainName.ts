...
export const DevDomainNameAssignDevDomainNameInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "devDomainNameAssignDevDomainName",
    type: "mutation",
  }),
);
export type DevDomainNameAssignDevDomainNameInput =
  typeof DevDomainNameAssignDevDomainNameInput.Type;

// Output Schema (GraphQL selection set)
export const DevDomainNameAssignDevDomainNameOutput = Schema.Struct({
  app: Schema.NullOr(
    Schema.Struct({
  ...
  id: Schema.String,
  name: Schema.Unknown,
}).pipe(T.ResponsePath("devDomainName.assignDevDomainName"));
export type DevDomainNameAssignDevDomainNameOutput =
  typeof DevDomainNameAssignDevDomainNameOutput.Type;

export const devDomainNameAssignDevDomainName = API.make(() => ({
  inputSchema: DevDomainNameAssignDevDomainNameInput,
  outputSchema: DevDomainNameAssignDevDomainNameOutput,
}));
