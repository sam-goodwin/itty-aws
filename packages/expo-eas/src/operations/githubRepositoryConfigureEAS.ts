...
}).pipe(T.ResponsePath("githubRepository.configureEAS"));
export type GithubRepositoryConfigureEASOutput =
  typeof GithubRepositoryConfigureEASOutput.Type;

export const githubRepositoryConfigureEAS = API.make(() => ({
  inputSchema: GithubRepositoryConfigureEASInput,
  outputSchema: GithubRepositoryConfigureEASOutput,
}));
