...
export const GithubAppInstallationCreateGitHubAppInstallationForAccountInput =
  Schema.Struct({
    ...
    T.GraphQLOp({
      query: __document,
      operationName:
        "githubAppInstallationCreateGitHubAppInstallationForAccount",
      type: "mutation",
    }),
  );
export type GithubAppInstallationCreateGitHubAppInstallationForAccountInput =
  typeof GithubAppInstallationCreateGitHubAppInstallationForAccountInput.Type;

// Output Schema (GraphQL selection set)
export const GithubAppInstallationCreateGitHubAppInstallationForAccountOutput =
  Schema.Struct({
    ...
    T.ResponsePath(
      "githubAppInstallation.createGitHubAppInstallationForAccount",
    ),
  );
export type GithubAppInstallationCreateGitHubAppInstallationForAccountOutput =
  typeof GithubAppInstallationCreateGitHubAppInstallationForAccountOutput.Type;

export const githubAppInstallationCreateGitHubAppInstallationForAccount =
  API.make(() => ({
    inputSchema:
      GithubAppInstallationCreateGitHubAppInstallationForAccountInput,
    outputSchema:
      GithubAppInstallationCreateGitHubAppInstallationForAccountOutput,
  }));
