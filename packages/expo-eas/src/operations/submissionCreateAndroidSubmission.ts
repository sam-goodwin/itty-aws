...
export const SubmissionCreateAndroidSubmissionInput = Schema.Struct({
  input: Schema.Struct({
    ...
    config: Schema.Struct({
      applicationIdentifier: Schema.optional(Schema.NullOr(Schema.String)),
      changelog: Schema.optional(Schema.NullOr(Schema.String)),
      changesNotSentForReview: Schema.optional(Schema.NullOr(Schema.Boolean)),
      googleServiceAccountKeyId: Schema.optional(Schema.NullOr(Schema.String)),
      googleServiceAccountKeyJson: Schema.optional(
        Schema.NullOr(Schema.String),
      ),
      isVerboseFastlaneEnabled: Schema.optional(Schema.NullOr(Schema.Boolean)),
      releaseStatus: Schema.optional(
        Schema.NullOr(
          Schema.Literals(["COMPLETED", "DRAFT", "HALTED", "IN_PROGRESS"]),
        ),
      ),
      rollout: Schema.optional(Schema.NullOr(Schema.Number)),
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "submissionCreateAndroidSubmission",
    type: "mutation",
  }),
);
export type SubmissionCreateAndroidSubmissionInput =
  typeof SubmissionCreateAndroidSubmissionInput.Type;

// Output Schema (GraphQL selection set)
export const SubmissionCreateAndroidSubmissionOutput = Schema.Struct({
...
}).pipe(T.ResponsePath("submission.createAndroidSubmission"));
export type SubmissionCreateAndroidSubmissionOutput =
  typeof SubmissionCreateAndroidSubmissionOutput.Type;

export const submissionCreateAndroidSubmission = API.make(() => ({
  inputSchema: SubmissionCreateAndroidSubmissionInput,
  outputSchema: SubmissionCreateAndroidSubmissionOutput,
}));
