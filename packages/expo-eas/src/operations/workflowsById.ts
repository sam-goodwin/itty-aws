...
export const WorkflowsByIdOutput = Schema.Struct({
  ...
  updatedAt: Schema.String,
}).pipe(T.ResponsePath("workflows.byId"));
export type WorkflowsByIdOutput = typeof WorkflowsByIdOutput.Type;

export const workflowsById = API.make(() => ({
  inputSchema: WorkflowsByIdInput,
  outputSchema: WorkflowsByIdOutput,
}));
