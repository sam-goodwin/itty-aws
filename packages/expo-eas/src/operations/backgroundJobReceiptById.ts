...
export const BackgroundJobReceiptByIdInput = Schema.Struct({
  id: Schema.String,
}).pipe(
  T.Http({ method: "POST", path: "/graphql" }),
  T.GraphQLOp({
    query: __document,
    operationName: "backgroundJobReceiptById",
    type: "query",
  }),
);
export type BackgroundJobReceiptByIdInput =
  typeof BackgroundJobReceiptByIdInput.Type;

// Output Schema (GraphQL selection set)
export const BackgroundJobReceiptByIdOutput = Schema.Struct({
...
}).pipe(T.ResponsePath("backgroundJobReceipt.byId"));
export type BackgroundJobReceiptByIdOutput =
  typeof BackgroundJobReceiptByIdOutput.Type;

export const backgroundJobReceiptById = API.make(() => ({
  inputSchema: BackgroundJobReceiptByIdInput,
  outputSchema: BackgroundJobReceiptByIdOutput,
}));
