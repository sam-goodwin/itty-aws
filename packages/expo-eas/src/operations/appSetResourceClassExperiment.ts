...
export const AppSetResourceClassExperimentOutput = Schema.Struct({
  ...
  posthogProject: Schema.NullOr(
    Schema.Struct({
      ...
      posthogOrganizationConnection: Schema.Struct({
        createdAt: Schema.String,
        id: Schema.String,
        posthogOrganizationIdentifier: Schema.String,
        posthogOrganizationName: Schema.String,
...
}).pipe(T.ResponsePath("app.setResourceClassExperiment"));
export type AppSetResourceClassExperimentOutput =
  typeof AppSetResourceClassExperimentOutput.Type;

export const appSetResourceClassExperiment = API.make(() => ({
  inputSchema: AppSetResourceClassExperimentInput,
  outputSchema: AppSetResourceClassExperimentOutput,
}));
