...
}).pipe(T.ResponsePath("account.setUserSpecifiedAccountUsage"));
export type AccountSetUserSpecifiedAccountUsageOutput =
  typeof AccountSetUserSpecifiedAccountUsageOutput.Type;

export const accountSetUserSpecifiedAccountUsage = API.make(() => ({
  inputSchema: AccountSetUserSpecifiedAccountUsageInput,
  outputSchema: AccountSetUserSpecifiedAccountUsageOutput,
}));
