...
}).pipe(T.ResponsePath("appleDistributionCertificate.byId"));
export type AppleDistributionCertificateByIdOutput =
  typeof AppleDistributionCertificateByIdOutput.Type;

export const appleDistributionCertificateById = API.make(() => ({
  inputSchema: AppleDistributionCertificateByIdInput,
  outputSchema: AppleDistributionCertificateByIdOutput,
}));
