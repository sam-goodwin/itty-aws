...
}).pipe(T.ResponsePath("builds.byId"));
export type BuildsByIdOutput = typeof BuildsByIdOutput.Type;

export const buildsById = API.make(() => ({
  inputSchema: BuildsByIdInput,
  outputSchema: BuildsByIdOutput,
}));
