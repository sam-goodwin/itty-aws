...
export const DeviceRunSessionCreateDeviceRunSessionInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "deviceRunSessionCreateDeviceRunSession",
    type: "mutation",
  }),
);
export type DeviceRunSessionCreateDeviceRunSessionInput =
  typeof DeviceRunSessionCreateDeviceRunSessionInput.Type;

// Output Schema (GraphQL selection set)
export const DeviceRunSessionCreateDeviceRunSessionOutput = Schema.Struct({
  app: Schema.Struct({
  ...
  type: Schema.Literals(["AGENT_DEVICE", "ARGENT", "SERVE_SIM"]),
  updatedAt: Schema.String,
}).pipe(T.ResponsePath("deviceRunSession.createDeviceRunSession"));
export type DeviceRunSessionCreateDeviceRunSessionOutput =
  typeof DeviceRunSessionCreateDeviceRunSessionOutput.Type;

export const deviceRunSessionCreateDeviceRunSession = API.make(() => ({
  inputSchema: DeviceRunSessionCreateDeviceRunSessionInput,
  outputSchema: DeviceRunSessionCreateDeviceRunSessionOutput,
}));
