...
const __document =
  "mutation echoChatDeleteChat($id: ID!) {\n  echoChat {\n    deleteChat(id: $id) {\n      agentMetadata\n      agentType\n      echoProject {\n        account {\n          appCount\n          availableBuilds\n          createdAt\n          displayName\n          environmentVariableEnvironments\n          hasBuilds\n          id\n          isCurrent\n          isDisabled\n          isFreeAppDevDomainTier\n          isSSOEnabled\n          lastDeletionAttemptTime\n          name\n          profileImageUrl\n          pushSecurityEnabled\n          requireTwoFactor\n          requiresAccessTokenForPushSecurity\n          ssoAllowedAuthProviders\n          subscriptionChangesPending\n          unlimitedBuilds\n          updatedAt\n          userSpecifiedAccountUsage\n          willAutoRenewBuilds\n        }\n        createdByActor {\n          created\n          displayName\n          firstName\n          id\n          isExpoAdmin\n          lastDeletionAttemptTime\n        }\n        currentPreviewEchoVersion {\n          buildError\n          buildStatus\n          diffs\n          gitBranch\n          gitCommitHash\n          gitCommitMessage\n          id\n          previewDeployment\n          source\n          turnId\n        }\n        description\n        displayName\n        echoProjectIcon {\n          accentColor\n          createdAt\n          id\n          model\n          prompt\n          source\n          url\n        }\n        githubInfo {\n          accountType\n          branch\n          installationId\n          repoName\n          repoOwner\n          repoUrl\n        }\n        icon {\n          accentColor\n          url\n        }\n        iconGallery {\n          accentColor\n          createdAt\n          id\n          model\n          prompt\n          source\n          url\n        }\n        id\n        images {\n          createdAt\n          id\n          url\n        }\n        initFromGitHubUrl\n        lastMessageAt\n        slug\n        thumbnail {\n          accentColor\n          height\n          url\n          visualHash\n          width\n        }\n        updatedAt\n        visibility\n      }\n      id\n      state\n      stats\n      title\n    }\n  }\n}";

// Input Schema (GraphQL variables)
export const EchoChatDeleteChatInput = Schema.Struct({
  id: Schema.String,
}).pipe(
  T.Http({ method: "POST", path: "/graphql" }),
  T.GraphQLOp({
    query: __document,
    operationName: "echoChatDeleteChat",
    type: "mutation",
  }),
);
export type EchoChatDeleteChatInput = typeof EchoChatDeleteChatInput.Type;

// Output Schema (GraphQL selection set)
export const EchoChatDeleteChatOutput = Schema.Struct({
...
}).pipe(T.ResponsePath("echoChat.deleteChat"));
export type EchoChatDeleteChatOutput = typeof EchoChatDeleteChatOutput.Type;

export const echoChatDeleteChat = API.make(() => ({
  inputSchema: EchoChatDeleteChatInput,
  outputSchema: EchoChatDeleteChatOutput,
}));
