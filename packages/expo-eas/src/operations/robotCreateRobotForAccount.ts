...
export const RobotCreateRobotForAccountInput = Schema.Struct({
  accountID: Schema.String,
  permissions: Schema.Array(
    Schema.NullOr(Schema.Literals(["ADMIN", "OWN", "PUBLISH", "VIEW"])),
  ),
  robotData: Schema.optional(
    Schema.NullOr(
      Schema.Struct({
...
export type RobotCreateRobotForAccountInput =
  typeof RobotCreateRobotForAccountInput.Type;

// Output Schema (GraphQL selection set)
export const RobotCreateRobotForAccountOutput = Schema.Struct({
...
export type RobotCreateRobotForAccountOutput =
  typeof RobotCreateRobotForAccountOutput.Type;

export const robotCreateRobotForAccount = API.make(() => ({
  inputSchema: RobotCreateRobotForAccountInput,
  outputSchema: RobotCreateRobotForAccountOutput,
}));
