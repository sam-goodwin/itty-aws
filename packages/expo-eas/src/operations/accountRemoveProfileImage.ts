...
export const AccountRemoveProfileImageInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "accountRemoveProfileImage",
    type: "mutation",
  }),
);
export type AccountRemoveProfileImageInput =
  typeof AccountRemoveProfileImageInput.Type;

// Output Schema (GraphQL selection set)
export const AccountRemoveProfileImageOutput = Schema.Struct({
...
}).pipe(T.ResponsePath("account.removeProfileImage"));
export type AccountRemoveProfileImageOutput =
  typeof AccountRemoveProfileImageOutput.Type;

export const accountRemoveProfileImage = API.make(() => ({
  inputSchema: AccountRemoveProfileImageInput,
  outputSchema: AccountRemoveProfileImageOutput,
}));
