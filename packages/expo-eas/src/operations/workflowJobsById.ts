...
export const WorkflowJobsByIdInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "workflowJobsById",
    type: "query",
  }),
);
...
export const WorkflowJobsByIdOutput = Schema.Struct({
...
}).pipe(T.ResponsePath("workflowJobs.byId"));
export type WorkflowJobsByIdOutput = typeof WorkflowJobsByIdOutput.Type;

export const workflowJobsById = API.make(() => ({
  inputSchema: WorkflowJobsByIdInput,
  outputSchema: WorkflowJobsByIdOutput,
}));
