  ...
  Schema.Struct({
    ...
    environmentVariablesData: Schema.Array(
      Schema.Struct({
        ...
        value: Schema.String,
        visibility: Schema.Literals(["PUBLIC", "SECRET", "SENSITIVE"]),
      }),
    ),
  }).pipe(
    ...
    T.GraphQLOp({
      query: __document,
      operationName:
        "environmentVariableCreateBulkEnvironmentVariablesForEchoProject",
      type: "mutation",
    }),
  );
export type EnvironmentVariableCreateBulkEnvironmentVariablesForEchoProjectInput =
  typeof EnvironmentVariableCreateBulkEnvironmentVariablesForEchoProjectInput.Type;

// Output Schema (GraphQL selection set)
export const EnvironmentVariableCreateBulkEnvironmentVariablesForEchoProjectOutput =
  Schema.Array(
    Schema.Struct({
      apps: Schema.Array(
        Schema.Struct({
    ...
    T.ResponsePath(
      "environmentVariable.createBulkEnvironmentVariablesForEchoProject",
    ),
  );
export type EnvironmentVariableCreateBulkEnvironmentVariablesForEchoProjectOutput =
  typeof EnvironmentVariableCreateBulkEnvironmentVariablesForEchoProjectOutput.Type;

export const environmentVariableCreateBulkEnvironmentVariablesForEchoProject =
  API.make(() => ({
    inputSchema:
      EnvironmentVariableCreateBulkEnvironmentVariablesForEchoProjectInput,
    outputSchema:
      EnvironmentVariableCreateBulkEnvironmentVariablesForEchoProjectOutput,
  }));
