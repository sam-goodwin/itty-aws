...
}).pipe(T.ResponsePath("app.byDevDomainName"));
export type AppByDevDomainNameOutput = typeof AppByDevDomainNameOutput.Type;

export const appByDevDomainName = API.make(() => ({
  inputSchema: AppByDevDomainNameInput,
  outputSchema: AppByDevDomainNameOutput,
}));
