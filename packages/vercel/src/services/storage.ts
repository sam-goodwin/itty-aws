...
export interface GetStorageStoresByIdRequest {
  id: string;
  _skip_metadata_?: boolean;
  _include_guides_?: boolean;
}
export const GetStorageStoresByIdRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.String.pipe(T.Label()),
    _skip_metadata_: S.optional(S.Boolean.pipe(T.Query("'skip-metadata'"))),
    _include_guides_: S.optional(S.Boolean.pipe(T.Query("'include-guides'"))),
