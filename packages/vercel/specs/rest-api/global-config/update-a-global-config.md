---
title: update-a-global-config
product: vercel
url: /docs/rest-api/global-config/update-a-global-config
canonical_url: "https://vercel.com/docs/rest-api/global-config/update-a-global-config"
...
related:
  - /docs/rest-api
summary: Learn about update-a-global-config on Vercel.
...
```http
PUT /v1/global-config/{edgeConfigId}
```
