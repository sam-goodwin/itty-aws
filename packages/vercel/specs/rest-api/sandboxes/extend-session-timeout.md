...
product: vercel
url: /docs/rest-api/sandboxes/extend-session-timeout
canonical_url: "https://vercel.com/docs/rest-api/sandboxes/extend-session-timeout"
...
related:
  - /docs/rest-api
summary: Learn about extend-session-timeout on Vercel.
...
### 200: The session timeout was extended successfully.
