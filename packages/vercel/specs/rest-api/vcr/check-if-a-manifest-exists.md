---
title: check-if-a-manifest-exists
product: vercel
url: /docs/rest-api/vcr/check-if-a-manifest-exists
canonical_url: "https://vercel.com/docs/rest-api/vcr/check-if-a-manifest-exists"
...
related:
  - /docs/rest-api
summary: Learn about check-if-a-manifest-exists on Vercel.
...
```http
HEAD /v2/{teamSlug}/{projectSlug}/{repositoryName}/manifests/{reference}
```
