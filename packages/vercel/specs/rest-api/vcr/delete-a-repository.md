...
product: vercel
url: /docs/rest-api/vcr/delete-a-repository
canonical_url: "https://vercel.com/docs/rest-api/vcr/delete-a-repository"
...
related:
  - /docs/rest-api
summary: Learn about delete-a-repository on Vercel.
...
```http
DELETE /v1/vcr/repository/{idOrName}
```
