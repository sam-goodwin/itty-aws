---
title: start-a-rolling-release-for-the-project
product: vercel
url: /docs/rest-api/rolling-release/start-a-rolling-release-for-the-project
canonical_url: "https://vercel.com/docs/rest-api/rolling-release/start-a-rolling-release-for-the-project"
...
related:
  - /docs/rest-api
summary: Learn about start-a-rolling-release-for-the-project on Vercel.
...
```http
POST /v1/projects/{idOrName}/rolling-release/start
```
...
```json
{
  ...
  "properties": {
    "canaryDeploymentId": {
      "type": "string",
      "description": "The ID of the canary deployment to start the rolling release for"
    }
  }
}
```
