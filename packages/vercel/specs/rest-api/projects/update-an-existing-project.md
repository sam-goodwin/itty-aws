...
product: vercel
url: /docs/rest-api/projects/update-an-existing-project
canonical_url: "https://vercel.com/docs/rest-api/projects/update-an-existing-project"
...
related:
  - /docs/rest-api
summary: Learn about update-an-existing-project on Vercel.
...
```json
{
  ...
  "properties": {
    ...
    "passport": {
      "type": "object",
      "description": "Passport configuration for the project.",
      "nullable": true,
      "required": [
        "connectorId"
      ],
    ...
    "trustedSources": {
      "type": "object",
      "description": "Deployment Protection Trusted Sources",
      "nullable": true,
      "properties": {
        "projects": {
          "type": "object",
...
### 409: The provided name for the project is already being used
