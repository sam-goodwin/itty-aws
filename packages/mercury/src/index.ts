/**
 * @distilled.cloud/mercury — Mercury SDK for Effect.
 *
 ...
 * spec assembled from https://docs.mercury.com/llms.txt). Everything else
 ...
 *
 * const accounts = yield* Mercury.Services.mercury.getAccounts({});
 * ```
 */
...
export * from "./services/mercury.ts";
export { BadRequest, NotFound } from "./services/mercury.ts";
