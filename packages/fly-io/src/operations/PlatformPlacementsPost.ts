...
// Input Schema
export const PlatformPlacementsPostInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type PlatformPlacementsPostInput = typeof PlatformPlacementsPostInput.Type;

// Output Schema
export const PlatformPlacementsPostOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type PlatformPlacementsPostOutput = typeof PlatformPlacementsPostOutput.Type;
