...
// Input Schema
export const MachinesListProcessesInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  app_name: Schema.String.pipe(T.PathParam()),
  machine_id: Schema.String.pipe(T.PathParam()),
  sort_by: Schema.optional(Schema.String),
  order: Schema.optional(Schema.String),
}).pipe(T.Http({ method: "GET", path: "/apps/{app_name}/machines/{machine_id}/ps" }));
export type MachinesListProcessesInput = typeof MachinesListProcessesInput.Type;

// Output Schema
export const MachinesListProcessesOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Array(Schema.Struct({
  command: Schema.optional(Schema.String),
  cpu: Schema.optional(Schema.Number),
  directory: Schema.optional(Schema.String),
  listen_sockets: Schema.optional(Schema.Array(Schema.Struct({
...
export type MachinesListProcessesOutput = typeof MachinesListProcessesOutput.Type;
