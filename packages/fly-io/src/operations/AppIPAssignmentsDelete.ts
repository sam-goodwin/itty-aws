...
// Input Schema
export const AppIPAssignmentsDeleteInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({

}).pipe(T.Http({ method: "DELETE", path: "/apps/{app_name}/ip_assignments/{ip}" }));
export type AppIPAssignmentsDeleteInput = typeof AppIPAssignmentsDeleteInput.Type;

// Output Schema
export const AppIPAssignmentsDeleteOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
