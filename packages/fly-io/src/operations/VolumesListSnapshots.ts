...
// Input Schema
export const VolumesListSnapshotsInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  app_name: Schema.String.pipe(T.PathParam()),
  volume_id: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "GET", path: "/apps/{app_name}/volumes/{volume_id}/snapshots" }));
export type VolumesListSnapshotsInput = typeof VolumesListSnapshotsInput.Type;

// Output Schema
export const VolumesListSnapshotsOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Array(Schema.Struct({
