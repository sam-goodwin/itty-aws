...
// Input Schema
export interface MachinesListVersionsInput {
  app_name: string;
  machine_id: string;
}
export const MachinesListVersionsInput =
  ...
  ) as unknown as Schema.Codec<MachinesListVersionsInput>;

// Output Schema
export type MachinesListVersionsOutput = {
  user_config?: {
...
export const MachinesListVersionsOutput =
  ...
  ) as unknown as Schema.Codec<MachinesListVersionsOutput>;
