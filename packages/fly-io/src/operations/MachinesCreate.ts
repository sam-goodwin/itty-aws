...
// Input Schema
export interface MachinesCreateInput {
  app_name: string;
  config?: {
...
export const MachinesCreateInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "POST", path: "/apps/{app_name}/machines" }),
) as unknown as Schema.Codec<MachinesCreateInput>;

// Output Schema
export interface MachinesCreateOutput {
  checks?: {
    name?: string;
    output?: string;
    status?: string;
...
export const MachinesCreateOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  updated_at: Schema.optional(Schema.String),
}) as unknown as Schema.Codec<MachinesCreateOutput>;
