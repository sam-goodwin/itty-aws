...
// Input Schema
export const AppCertificatesShowInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const AppCertificatesShowOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const AppCertificatesShow = /*@__PURE__*/ API.make(() => ({
