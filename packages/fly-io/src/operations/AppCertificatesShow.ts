...
// Input Schema
export const AppCertificatesShowInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({

}).pipe(T.Http({ method: "GET", path: "/apps/{app_name}/certificates/{hostname}" }));
export type AppCertificatesShowInput = typeof AppCertificatesShowInput.Type;

// Output Schema
export const AppCertificatesShowOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
