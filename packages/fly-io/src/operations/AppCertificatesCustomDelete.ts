...
// Input Schema
export const AppCertificatesCustomDeleteInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({

}).pipe(T.Http({ method: "DELETE", path: "/apps/{app_name}/certificates/{hostname}/custom" }));
export type AppCertificatesCustomDeleteInput = typeof AppCertificatesCustomDeleteInput.Type;

// Output Schema
export const AppCertificatesCustomDeleteOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  certificates: Schema.optional(Schema.Array(Schema.Struct({
    ...
    status: Schema.optional(Schema.Literals(["active", "pending_ownership", "pending_validation"])),
  }))),
...
export type AppCertificatesCustomDeleteOutput = typeof AppCertificatesCustomDeleteOutput.Type;
