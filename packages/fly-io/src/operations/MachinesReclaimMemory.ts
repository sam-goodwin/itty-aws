...
// Input Schema
export const MachinesReclaimMemoryInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  app_name: Schema.String.pipe(T.PathParam()),
  machine_id: Schema.String.pipe(T.PathParam()),
  amount_mb: Schema.optional(Schema.Number),
}).pipe(T.Http({ method: "POST", path: "/apps/{app_name}/machines/{machine_id}/memory/reclaim" }));
export type MachinesReclaimMemoryInput = typeof MachinesReclaimMemoryInput.Type;

// Output Schema
export const MachinesReclaimMemoryOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  actual_mb: Schema.optional(Schema.Number),
});
export type MachinesReclaimMemoryOutput = typeof MachinesReclaimMemoryOutput.Type;
