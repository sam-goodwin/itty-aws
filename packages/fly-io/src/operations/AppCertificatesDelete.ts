...
// Input Schema
export const AppCertificatesDeleteInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({

}).pipe(T.Http({ method: "DELETE", path: "/apps/{app_name}/certificates/{hostname}" }));
export type AppCertificatesDeleteInput = typeof AppCertificatesDeleteInput.Type;

// Output Schema
export const AppCertificatesDeleteOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
