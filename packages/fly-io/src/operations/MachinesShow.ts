...
// Input Schema
export interface MachinesShowInput {
  app_name: string;
  machine_id: string;
}
...
) as unknown as Schema.Codec<MachinesShowInput>;

// Output Schema
export interface MachinesShowOutput {
  checks?: {
    name?: string;
    output?: string;
    status?: string;
...
export const MachinesShowOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  updated_at: Schema.optional(Schema.String),
}) as unknown as Schema.Codec<MachinesShowOutput>;
