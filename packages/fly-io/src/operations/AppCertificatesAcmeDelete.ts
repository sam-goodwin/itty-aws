...
// Input Schema
export const AppCertificatesAcmeDeleteInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({

}).pipe(T.Http({ method: "DELETE", path: "/apps/{app_name}/certificates/{hostname}/acme" }));
export type AppCertificatesAcmeDeleteInput = typeof AppCertificatesAcmeDeleteInput.Type;

// Output Schema
export const AppCertificatesAcmeDeleteOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
