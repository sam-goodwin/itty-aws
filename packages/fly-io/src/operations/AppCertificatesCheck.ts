...
// Input Schema
export const AppCertificatesCheckInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({

}).pipe(T.Http({ method: "POST", path: "/apps/{app_name}/certificates/{hostname}/check" }));
export type AppCertificatesCheckInput = typeof AppCertificatesCheckInput.Type;

// Output Schema
export const AppCertificatesCheckOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
