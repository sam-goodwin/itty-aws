...
// Input Schema
export const MachinesCreateLeaseInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  app_name: Schema.String.pipe(T.PathParam()),
  machine_id: Schema.String.pipe(T.PathParam()),
  description: Schema.optional(Schema.String),
  ttl: Schema.optional(Schema.Number),
}).pipe(T.Http({ method: "POST", path: "/apps/{app_name}/machines/{machine_id}/lease" }));
export type MachinesCreateLeaseInput = typeof MachinesCreateLeaseInput.Type;

// Output Schema
export const MachinesCreateLeaseOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  description: Schema.optional(Schema.String),
