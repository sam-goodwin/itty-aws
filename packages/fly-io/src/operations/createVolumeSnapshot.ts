...
// Input Schema
export const CreateVolumeSnapshotInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  app_name: Schema.String.pipe(T.PathParam()),
  volume_id: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "POST", path: "/apps/{app_name}/volumes/{volume_id}/snapshots" }));
export type CreateVolumeSnapshotInput = typeof CreateVolumeSnapshotInput.Type;

// Output Schema
export const CreateVolumeSnapshotOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
