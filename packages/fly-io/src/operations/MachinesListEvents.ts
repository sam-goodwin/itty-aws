...
// Input Schema
export const MachinesListEventsInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  app_name: Schema.String.pipe(T.PathParam()),
  machine_id: Schema.String.pipe(T.PathParam()),
  limit: Schema.optional(Schema.Number),
}).pipe(T.Http({ method: "GET", path: "/apps/{app_name}/machines/{machine_id}/events" }));
export type MachinesListEventsInput = typeof MachinesListEventsInput.Type;

// Output Schema
export const MachinesListEventsOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Array(Schema.Struct({
