...
// Input Schema
export const MachinesListEventsInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const MachinesListEventsOutput = /*@__PURE__*/ Schema.Array(
  Schema.Struct({
 ...
 */
export const MachinesListEvents = /*@__PURE__*/ API.make(() => ({
