...
// Input Schema
export const MachinesShowMetadataInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  app_name: Schema.String.pipe(T.PathParam()),
  machine_id: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "GET", path: "/apps/{app_name}/machines/{machine_id}/metadata" }));
export type MachinesShowMetadataInput = typeof MachinesShowMetadataInput.Type;

// Output Schema
export const MachinesShowMetadataOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Record(Schema.String, Schema.String);
