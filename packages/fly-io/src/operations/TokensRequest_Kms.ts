...
// Input Schema
export const TokensRequest_KmsInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({ method: "POST", path: "/tokens/kms" }),
);
export type TokensRequest_KmsInput = typeof TokensRequest_KmsInput.Type;

// Output Schema
export const TokensRequest_KmsOutput = /*@__PURE__*/ Schema.String;
 ...
 */
export const TokensRequest_Kms = /*@__PURE__*/ API.make(() => ({
