...
// Input Schema
export const UpdateGroupConfigurationInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  organizationSlug: Schema.String.pipe(T.PathParam()),
  groupName: Schema.String.pipe(T.PathParam()),
  delete_protection: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "PATCH", path: "/v1/organizations/{organizationSlug}/groups/{groupName}/configuration" }));
export type UpdateGroupConfigurationInput = typeof UpdateGroupConfigurationInput.Type;

// Output Schema
export const UpdateGroupConfigurationOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  delete_protection: Schema.optional(Schema.Boolean),
});
