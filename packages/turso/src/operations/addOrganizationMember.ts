...
// Input Schema
export const AddOrganizationMemberInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  organizationSlug: Schema.String.pipe(T.PathParam()),
  username: Schema.optional(Schema.String),
  role: Schema.optional(Schema.Literals(["admin", "member", "viewer"])),
}).pipe(T.Http({ method: "POST", path: "/v1/organizations/{organizationSlug}/members" }));
export type AddOrganizationMemberInput = typeof AddOrganizationMemberInput.Type;

// Output Schema
export const AddOrganizationMemberOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
