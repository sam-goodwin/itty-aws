...
// Input Schema
export const CreateDatabaseTokenInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "POST", path: "/v1/organizations/{organizationSlug}/databases/{databaseName}/auth/tokens" }));
export type CreateDatabaseTokenInput = typeof CreateDatabaseTokenInput.Type;

// Output Schema
export const CreateDatabaseTokenOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
