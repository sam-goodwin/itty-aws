...
// Input Schema
export const GetDatabaseConfigurationInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  organizationSlug: Schema.String.pipe(T.PathParam()),
  databaseName: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "GET", path: "/v1/organizations/{organizationSlug}/databases/{databaseName}/configuration" }));
export type GetDatabaseConfigurationInput = typeof GetDatabaseConfigurationInput.Type;

// Output Schema
export const GetDatabaseConfigurationOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
