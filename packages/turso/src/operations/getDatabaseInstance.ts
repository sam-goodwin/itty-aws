...
// Input Schema
export const GetDatabaseInstanceInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  organizationSlug: Schema.String.pipe(T.PathParam()),
  databaseName: Schema.String.pipe(T.PathParam()),
  instanceName: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "GET", path: "/v1/organizations/{organizationSlug}/databases/{databaseName}/instances/{instanceName}" }));
export type GetDatabaseInstanceInput = typeof GetDatabaseInstanceInput.Type;

// Output Schema
export const GetDatabaseInstanceOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
