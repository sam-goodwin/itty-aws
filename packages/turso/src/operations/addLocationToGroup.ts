...
// Input Schema
export const AddLocationToGroupInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  organizationSlug: Schema.String.pipe(T.PathParam()),
  groupName: Schema.String.pipe(T.PathParam()),
  location: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "POST", path: "/v1/organizations/{organizationSlug}/groups/{groupName}/locations/{location}" }));
export type AddLocationToGroupInput = typeof AddLocationToGroupInput.Type;

// Output Schema
export const AddLocationToGroupOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
