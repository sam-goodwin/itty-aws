...
// Input Schema
export const ListOrganizationMembersInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  organizationSlug: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "GET", path: "/v1/organizations/{organizationSlug}/members" }));
export type ListOrganizationMembersInput = typeof ListOrganizationMembersInput.Type;

// Output Schema
export const ListOrganizationMembersOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
