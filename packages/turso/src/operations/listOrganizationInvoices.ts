...
// Input Schema
export const ListOrganizationInvoicesInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  organizationSlug: Schema.String.pipe(T.PathParam()),
  type: Schema.optional(Schema.Literals(["all", "upcoming", "issued"])),
}).pipe(T.Http({ method: "GET", path: "/v1/organizations/{organizationSlug}/invoices" }));
export type ListOrganizationInvoicesInput = typeof ListOrganizationInvoicesInput.Type;

// Output Schema
export const ListOrganizationInvoicesOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
