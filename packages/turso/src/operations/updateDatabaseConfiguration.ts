...
// Input Schema
export const UpdateDatabaseConfigurationInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "PATCH", path: "/v1/organizations/{organizationSlug}/databases/{databaseName}/configuration" }));
export type UpdateDatabaseConfigurationInput = typeof UpdateDatabaseConfigurationInput.Type;

// Output Schema
export const UpdateDatabaseConfigurationOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  size_limit: Schema.optional(Schema.String),
  allow_attach: Schema.optional(Schema.Boolean),
  block_reads: Schema.optional(Schema.Boolean),
  block_writes: Schema.optional(Schema.Boolean),
