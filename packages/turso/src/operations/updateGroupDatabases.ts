...
// Input Schema
export const UpdateGroupDatabasesInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  organizationSlug: Schema.String.pipe(T.PathParam()),
  groupName: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "POST", path: "/v1/organizations/{organizationSlug}/groups/{groupName}/update" }));
export type UpdateGroupDatabasesInput = typeof UpdateGroupDatabasesInput.Type;

// Output Schema
export const UpdateGroupDatabasesOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
