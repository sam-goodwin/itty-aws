...
// Input Schema
export const InviteOrganizationMemberInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  organizationSlug: Schema.String.pipe(T.PathParam()),
  email: Schema.String,
  role: Schema.optional(Schema.Literals(["admin", "member", "viewer"])),
}).pipe(T.Http({ method: "POST", path: "/v1/organizations/{organizationSlug}/invites" }));
export type InviteOrganizationMemberInput = typeof InviteOrganizationMemberInput.Type;

// Output Schema
export const InviteOrganizationMemberOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
