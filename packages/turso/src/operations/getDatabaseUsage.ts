...
// Input Schema
export const GetDatabaseUsageInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const GetDatabaseUsageOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const getDatabaseUsage = /*@__PURE__*/ API.make(() => ({
