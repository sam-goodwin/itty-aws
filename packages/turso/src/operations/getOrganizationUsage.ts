...
// Input Schema
export const GetOrganizationUsageInput = /*@__PURE__*/ Schema.Struct({
  organizationSlug: Schema.String.pipe(T.PathParam()),
}).pipe(
  T.Http({ method: "GET", path: "/v1/organizations/{organizationSlug}/usage" }),
);
export type GetOrganizationUsageInput = typeof GetOrganizationUsageInput.Type;

// Output Schema
export const GetOrganizationUsageOutput = /*@__PURE__*/ Schema.Struct({
