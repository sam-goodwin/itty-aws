...
// Input Schema
export const ListOrganizationInvitesInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  organizationSlug: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "GET", path: "/v1/organizations/{organizationSlug}/invites" }));
export type ListOrganizationInvitesInput = typeof ListOrganizationInvitesInput.Type;

// Output Schema
export const ListOrganizationInvitesOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
