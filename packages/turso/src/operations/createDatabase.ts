...
export const CreateDatabaseInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  remote_encryption: Schema.optional(Schema.Struct({
    ...
    encryption_cipher: Schema.optional(Schema.Literals(["aes256gcm", "aes128gcm", "chacha20poly1305", "aegis128l", "aegis128x2", "aegis128x4", "aegis256", "aegis256x2", "aegis256x4"])),
  })),
}).pipe(T.Http({ method: "POST", path: "/v1/organizations/{organizationSlug}/databases" }));
