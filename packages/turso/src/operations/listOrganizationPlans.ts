...
// Input Schema
export const ListOrganizationPlansInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  organizationSlug: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "GET", path: "/v1/organizations/{organizationSlug}/plans" }));
export type ListOrganizationPlansInput = typeof ListOrganizationPlansInput.Type;

// Output Schema
export const ListOrganizationPlansOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
