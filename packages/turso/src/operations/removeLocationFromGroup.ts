...
// Input Schema
export const RemoveLocationFromGroupInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  organizationSlug: Schema.String.pipe(T.PathParam()),
  groupName: Schema.String.pipe(T.PathParam()),
  location: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "DELETE", path: "/v1/organizations/{organizationSlug}/groups/{groupName}/locations/{location}" }));
export type RemoveLocationFromGroupInput = typeof RemoveLocationFromGroupInput.Type;

// Output Schema
export const RemoveLocationFromGroupOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
