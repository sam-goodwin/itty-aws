...
// Input Schema
export const GetGroupConfigurationInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  organizationSlug: Schema.String.pipe(T.PathParam()),
  groupName: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "GET", path: "/v1/organizations/{organizationSlug}/groups/{groupName}/configuration" }));
export type GetGroupConfigurationInput = typeof GetGroupConfigurationInput.Type;

// Output Schema
export const GetGroupConfigurationOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
