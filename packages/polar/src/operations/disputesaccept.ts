...
// Input Schema
export interface DisputesacceptInput {
  id: string;
}
export const DisputesacceptInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String.pipe(T.PathParam()),
}).pipe(
  T.Http({ method: "POST", path: "/v1/disputes/{id}/accept" }),
) as unknown as Schema.Codec<DisputesacceptInput>;

// Output Schema
export interface DisputesacceptOutput {
  created_at: string;
...
export const DisputesacceptOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
}) as unknown as Schema.Codec<DisputesacceptOutput>;
 ...
 */
export const disputesaccept = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: DisputesacceptInput,
  outputSchema: DisputesacceptOutput,
}));
