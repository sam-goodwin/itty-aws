...
// Input Schema
export interface CustomerPortalsubscriptionscancelInput {
  id: string;
}
export const CustomerPortalsubscriptionscancelInput =
  ...
  ) as unknown as Schema.Codec<CustomerPortalsubscriptionscancelInput>;

// Output Schema
export interface CustomerPortalsubscriptionscancelOutput {
  created_at: string;
...
export const CustomerPortalsubscriptionscancelOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  }) as unknown as Schema.Codec<CustomerPortalsubscriptionscancelOutput>;
 ...
 */
export const customerPortalsubscriptionscancel =
  /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
    inputSchema: CustomerPortalsubscriptionscancelInput,
    outputSchema: CustomerPortalsubscriptionscancelOutput,
  }));
