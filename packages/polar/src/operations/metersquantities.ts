...
// Input Schema
export interface MetersquantitiesInput {
  id: string;
...
export const MetersquantitiesInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  customer_aggregation_function: Schema.optional(
    Schema.NullOr(
      Schema.Literals(["count", "sum", "max", "min", "avg", "unique"]),
    ),
  ),
  ...
  T.Http({ method: "GET", path: "/v1/meters/{id}/quantities" }),
) as unknown as Schema.Codec<MetersquantitiesInput>;

// Output Schema
export interface MetersquantitiesOutput {
  quantities: ReadonlyArray<{ timestamp: string; quantity: number }>;
  total: number;
}
export const MetersquantitiesOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct(
  {
    quantities: Schema.Array(
      Schema.Struct({
...
) as unknown as Schema.Codec<MetersquantitiesOutput>;
 ...
 */
export const metersquantities = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: MetersquantitiesInput,
  outputSchema: MetersquantitiesOutput,
}));
