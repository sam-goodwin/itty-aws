...
// Input Schema
export interface CustomerSeatsassignSeatInput {
...
export const CustomerSeatsassignSeatInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "POST", path: "/v1/customer-seats" }),
  ) as unknown as Schema.Codec<CustomerSeatsassignSeatInput>;

// Output Schema
export interface CustomerSeatsassignSeatOutput {
  created_at: string;
...
export const CustomerSeatsassignSeatOutput =
  ...
  }) as unknown as Schema.Codec<CustomerSeatsassignSeatOutput>;
