...
// Input Schema
export interface DisputesgetInput {
  id: string;
}
export const DisputesgetInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String.pipe(T.PathParam()),
}).pipe(
  T.Http({ method: "GET", path: "/v1/disputes/{id}" }),
) as unknown as Schema.Codec<DisputesgetInput>;

// Output Schema
export interface DisputesgetOutput {
  created_at: string;
...
}) as unknown as Schema.Codec<DisputesgetOutput>;
