...
// Input Schema
export interface OrdersfinalizeInput {
  id: string;
  payment_method_id?: string | null;
}
export const OrdersfinalizeInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String.pipe(T.PathParam()),
  payment_method_id: Schema.optional(Schema.NullOr(Schema.String)),
}).pipe(
  T.Http({ method: "POST", path: "/v1/orders/{id}/finalize" }),
) as unknown as Schema.Codec<OrdersfinalizeInput>;

// Output Schema
export interface OrdersfinalizeOutput {
  id: string;
  created_at: string;
...
export const OrdersfinalizeOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String,
...
}) as unknown as Schema.Codec<OrdersfinalizeOutput>;
 ...
 */
export const ordersfinalize = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: OrdersfinalizeInput,
  outputSchema: OrdersfinalizeOutput,
}));
