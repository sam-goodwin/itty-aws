...
// Input Schema
export interface CheckoutsclientGetInput {
  client_secret: string;
}
export const CheckoutsclientGetInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    client_secret: Schema.String.pipe(T.PathParam()),
  }).pipe(
    T.Http({ method: "GET", path: "/v1/checkouts/client/{client_secret}" }),
  ) as unknown as Schema.Codec<CheckoutsclientGetInput>;

// Output Schema
export interface CheckoutsclientGetOutput {
  id: string;
  created_at: string;
...
export const CheckoutsclientGetOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.String,
  ...
  }) as unknown as Schema.Codec<CheckoutsclientGetOutput>;
 ...
 */
export const checkoutsclientGet = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
