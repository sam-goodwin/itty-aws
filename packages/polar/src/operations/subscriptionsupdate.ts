...
export interface SubscriptionsupdateInput {
  ...
  proration_behavior?: "invoice" | "prorate" | "next_period" | "reset" | null;
...
export const SubscriptionsupdateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    trial_end: Schema.optional(Schema.NullOr(Schema.String)),
    seats: Schema.optional(Schema.Number),
    current_billing_period_end: Schema.optional(Schema.String),
    ...
    T.Http({ method: "PATCH", path: "/v1/subscriptions/{id}" }),
  ) as unknown as Schema.Codec<SubscriptionsupdateInput>;

// Output Schema
export interface SubscriptionsupdateOutput {
  created_at: string;
...
export const SubscriptionsupdateOutput =
  ...
  }) as unknown as Schema.Codec<SubscriptionsupdateOutput>;
