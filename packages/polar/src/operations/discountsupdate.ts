...
export const DiscountsupdateInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "/v1/discounts/{id}" }),
) as unknown as Schema.Codec<DiscountsupdateInput>;

// Output Schema
export type DiscountsupdateOutput = unknown;
export const DiscountsupdateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Unknown as unknown as Schema.Codec<DiscountsupdateOutput>;
