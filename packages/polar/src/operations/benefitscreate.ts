...
// Input Schema
export interface BenefitscreateInput {
...
export const BenefitscreateInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "POST", path: "/v1/benefits/" }),
) as unknown as Schema.Codec<BenefitscreateInput>;

// Output Schema
export type BenefitscreateOutput =
  | {
      id: string;
      created_at: string;
...
export const BenefitscreateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Unknown as unknown as Schema.Codec<BenefitscreateOutput>;
