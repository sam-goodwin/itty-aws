...
export const OrdersupdateInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "/v1/orders/{id}" }),
) as unknown as Schema.Codec<OrdersupdateInput>;

// Output Schema
export interface OrdersupdateOutput {
  id: string;
  created_at: string;
...
}) as unknown as Schema.Codec<OrdersupdateOutput>;
