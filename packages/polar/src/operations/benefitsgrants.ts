...
// Input Schema
export interface BenefitsgrantsInput {
  id: string;
...
export const BenefitsgrantsInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "GET", path: "/v1/benefits/{id}/grants" }),
) as unknown as Schema.Codec<BenefitsgrantsInput>;

// Output Schema
export interface BenefitsgrantsOutput {
  items: ReadonlyArray<{
    created_at: string;
...
}) as unknown as Schema.Codec<BenefitsgrantsOutput>;
