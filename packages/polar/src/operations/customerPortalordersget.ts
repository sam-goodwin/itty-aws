...
export const CustomerPortalordersgetInput =
  ...
  }).pipe(T.Http({ method: "GET", path: "/v1/customer-portal/orders/{id}" }));
export type CustomerPortalordersgetInput =
  typeof CustomerPortalordersgetInput.Type;
...
export type CustomerPortalordersgetOutput =
  typeof CustomerPortalordersgetOutput.Type;
