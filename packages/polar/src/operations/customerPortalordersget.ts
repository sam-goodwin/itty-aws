...
// Input Schema
export interface CustomerPortalordersgetInput {
  id: string;
}
export const CustomerPortalordersgetInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.String.pipe(T.PathParam()),
  }).pipe(
    T.Http({ method: "GET", path: "/v1/customer-portal/orders/{id}" }),
  ) as unknown as Schema.Codec<CustomerPortalordersgetInput>;

// Output Schema
export interface CustomerPortalordersgetOutput {
  id: string;
  created_at: string;
...
export const CustomerPortalordersgetOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.String,
  ...
  }) as unknown as Schema.Codec<CustomerPortalordersgetOutput>;
 ...
 */
export const customerPortalordersget = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: CustomerPortalordersgetInput,
    outputSchema: CustomerPortalordersgetOutput,
  }),
);
