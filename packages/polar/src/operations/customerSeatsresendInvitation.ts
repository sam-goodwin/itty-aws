...
// Input Schema
export interface CustomerSeatsresendInvitationInput {
  seat_id: string;
}
export const CustomerSeatsresendInvitationInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    seat_id: Schema.String.pipe(T.PathParam()),
  }).pipe(
    T.Http({ method: "POST", path: "/v1/customer-seats/{seat_id}/resend" }),
  ) as unknown as Schema.Codec<CustomerSeatsresendInvitationInput>;

// Output Schema
export interface CustomerSeatsresendInvitationOutput {
  created_at: string;
...
export const CustomerSeatsresendInvitationOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  }) as unknown as Schema.Codec<CustomerSeatsresendInvitationOutput>;
 ...
 */
export const customerSeatsresendInvitation =
  /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
    inputSchema: CustomerSeatsresendInvitationInput,
    outputSchema: CustomerSeatsresendInvitationOutput,
  }));
