...
// Input Schema
export interface CheckoutsclientUpdateInput {
...
export const CheckoutsclientUpdateInput =
  ...
  ) as unknown as Schema.Codec<CheckoutsclientUpdateInput>;

// Output Schema
export interface CheckoutsclientUpdateOutput {
  id: string;
  created_at: string;
...
export const CheckoutsclientUpdateOutput =
  ...
  }) as unknown as Schema.Codec<CheckoutsclientUpdateOutput>;
