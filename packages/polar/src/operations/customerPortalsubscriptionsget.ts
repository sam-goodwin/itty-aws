...
// Input Schema
export interface CustomerPortalsubscriptionsgetInput {
  id: string;
}
export const CustomerPortalsubscriptionsgetInput =
  ...
  ) as unknown as Schema.Codec<CustomerPortalsubscriptionsgetInput>;

// Output Schema
export interface CustomerPortalsubscriptionsgetOutput {
  created_at: string;
...
export const CustomerPortalsubscriptionsgetOutput =
  ...
  }) as unknown as Schema.Codec<CustomerPortalsubscriptionsgetOutput>;
