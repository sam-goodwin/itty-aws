...
// Input Schema
export interface CustomerPortallicenseKeyslistInput {
...
export const CustomerPortallicenseKeyslistInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "GET", path: "/v1/customer-portal/license-keys/" }),
  ) as unknown as Schema.Codec<CustomerPortallicenseKeyslistInput>;

// Output Schema
export interface CustomerPortallicenseKeyslistOutput {
  items: ReadonlyArray<{
    id: string;
    created_at: string;
...
export const CustomerPortallicenseKeyslistOutput =
  ...
  }) as unknown as Schema.Codec<CustomerPortallicenseKeyslistOutput>;
