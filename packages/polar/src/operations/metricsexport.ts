...
// Input Schema
export interface MetricsexportInput {
  start_date: string;
  end_date: string;
  timezone?:
    | "Africa/Abidjan"
...
export const MetricsexportInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "GET", path: "/v1/metrics/export" }),
) as unknown as Schema.Codec<MetricsexportInput>;

// Output Schema
export type MetricsexportOutput = void;
export const MetricsexportOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Void as unknown as Schema.Codec<MetricsexportOutput>;
 ...
 */
export const metricsexport = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: MetricsexportInput,
  outputSchema: MetricsexportOutput,
}));
