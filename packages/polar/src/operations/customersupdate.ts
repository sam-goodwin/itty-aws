...
export const CustomersupdateInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  type: Schema.optional(Schema.NullOr(Schema.Literals(["individual", "team"]))),
}).pipe(
  T.Http({ method: "PATCH", path: "/v1/customers/{id}" }),
) as unknown as Schema.Codec<CustomersupdateInput>;

// Output Schema
export type CustomersupdateOutput = unknown;
export const CustomersupdateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Unknown as unknown as Schema.Codec<CustomersupdateOutput>;
