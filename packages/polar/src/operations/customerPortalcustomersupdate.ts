...
// Input Schema
export interface CustomerPortalcustomersupdateInput {
...
export const CustomerPortalcustomersupdateInput =
  ...
  ) as unknown as Schema.Codec<CustomerPortalcustomersupdateInput>;

// Output Schema
export interface CustomerPortalcustomersupdateOutput {
  created_at: string;
...
export const CustomerPortalcustomersupdateOutput =
  ...
  }) as unknown as Schema.Codec<CustomerPortalcustomersupdateOutput>;
