...
// Input Schema
export interface WebhookscreateWebhookEndpointInput {
  url: string;
  name?: string | null;
...
export const WebhookscreateWebhookEndpointInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "POST", path: "/v1/webhooks/endpoints" }),
  ) as unknown as Schema.Codec<WebhookscreateWebhookEndpointInput>;

// Output Schema
export interface WebhookscreateWebhookEndpointOutput {
  created_at: string;
...
export const WebhookscreateWebhookEndpointOutput =
  ...
  }) as unknown as Schema.Codec<WebhookscreateWebhookEndpointOutput>;
