...
// Input Schema
export interface CustomerPortalseatsresendInvitationInput {
  seat_id: string;
}
export const CustomerPortalseatsresendInvitationInput =
  ...
  ) as unknown as Schema.Codec<CustomerPortalseatsresendInvitationInput>;

// Output Schema
export interface CustomerPortalseatsresendInvitationOutput {
  created_at: string;
...
export const CustomerPortalseatsresendInvitationOutput =
  ...
  }) as unknown as Schema.Codec<CustomerPortalseatsresendInvitationOutput>;
