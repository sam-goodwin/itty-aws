...
// Input Schema
export interface LicenseKeysactivateInput {
  key: string;
...
export const LicenseKeysactivateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "POST", path: "/v1/license-keys/activate" }),
  ) as unknown as Schema.Codec<LicenseKeysactivateInput>;

// Output Schema
export interface LicenseKeysactivateOutput {
  id: string;
...
export const LicenseKeysactivateOutput =
  ...
  }) as unknown as Schema.Codec<LicenseKeysactivateOutput>;
