...
// Input Schema
export interface CheckoutsupdateInput {
  id: string;
...
export const CheckoutsupdateInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "/v1/checkouts/{id}" }),
) as unknown as Schema.Codec<CheckoutsupdateInput>;

// Output Schema
export interface CheckoutsupdateOutput {
  id: string;
  created_at: string;
...
export const CheckoutsupdateOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String,
...
}) as unknown as Schema.Codec<CheckoutsupdateOutput>;
 ...
 */
export const checkoutsupdate = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
