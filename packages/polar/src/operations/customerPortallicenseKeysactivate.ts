...
// Input Schema
export interface CustomerPortallicenseKeysactivateInput {
  key: string;
...
export const CustomerPortallicenseKeysactivateInput =
  ...
  ) as unknown as Schema.Codec<CustomerPortallicenseKeysactivateInput>;

// Output Schema
export interface CustomerPortallicenseKeysactivateOutput {
  id: string;
...
export const CustomerPortallicenseKeysactivateOutput =
  ...
  }) as unknown as Schema.Codec<CustomerPortallicenseKeysactivateOutput>;
