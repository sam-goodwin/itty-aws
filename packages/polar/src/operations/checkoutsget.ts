...
// Input Schema
export interface CheckoutsgetInput {
  id: string;
}
export const CheckoutsgetInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String.pipe(T.PathParam()),
}).pipe(
  T.Http({ method: "GET", path: "/v1/checkouts/{id}" }),
) as unknown as Schema.Codec<CheckoutsgetInput>;

// Output Schema
export interface CheckoutsgetOutput {
  id: string;
  created_at: string;
...
}) as unknown as Schema.Codec<CheckoutsgetOutput>;
