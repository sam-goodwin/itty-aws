...
// Input Schema
export interface Oauth2clientsoauth2updateClientInput {
  client_id: string;
...
export const Oauth2clientsoauth2updateClientInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "PUT", path: "/v1/oauth2/register/{client_id}" }),
  ) as unknown as Schema.Codec<Oauth2clientsoauth2updateClientInput>;

// Output Schema
export type Oauth2clientsoauth2updateClientOutput = unknown;
export const Oauth2clientsoauth2updateClientOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Unknown as unknown as Schema.Codec<Oauth2clientsoauth2updateClientOutput>;
