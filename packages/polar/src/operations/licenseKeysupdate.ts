...
// Input Schema
export interface LicenseKeysupdateInput {
  id: string;
  status?: "granted" | "revoked" | "disabled" | null;
  usage?: number;
...
export const LicenseKeysupdateInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct(
  {
    ...
    status: Schema.optional(
      Schema.NullOr(Schema.Literals(["granted", "revoked", "disabled"])),
    ),
  ...
  T.Http({ method: "PATCH", path: "/v1/license-keys/{id}" }),
) as unknown as Schema.Codec<LicenseKeysupdateInput>;

// Output Schema
export interface LicenseKeysupdateOutput {
  id: string;
  created_at: string;
...
export const LicenseKeysupdateOutput =
  ...
  }) as unknown as Schema.Codec<LicenseKeysupdateOutput>;
