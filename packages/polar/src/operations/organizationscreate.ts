...
export interface OrganizationscreateInput {
  ...
  legal_entity?:
    | { type: string }
    | { type: string; registered_name: string }
    | null;
  email?: string | null;
  website?: string | null;
...
export const OrganizationscreateInput =
  ...
  ) as unknown as Schema.Codec<OrganizationscreateInput>;

// Output Schema
export interface OrganizationscreateOutput {
  created_at: string;
...
export const OrganizationscreateOutput =
  ...
  }) as unknown as Schema.Codec<OrganizationscreateOutput>;
