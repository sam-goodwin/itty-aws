...
export const WebhooksgetWebhookEndpointInput =
  ...
  }).pipe(T.Http({ method: "GET", path: "/v1/webhooks/endpoints/{id}" }));
export type WebhooksgetWebhookEndpointInput =
  typeof WebhooksgetWebhookEndpointInput.Type;
...
export type WebhooksgetWebhookEndpointOutput =
  typeof WebhooksgetWebhookEndpointOutput.Type;
