...
// Input Schema
export interface CustomerPortalorganizationsgetInput {
  slug: string;
}
export const CustomerPortalorganizationsgetInput =
  ...
  ) as unknown as Schema.Codec<CustomerPortalorganizationsgetInput>;

// Output Schema
export interface CustomerPortalorganizationsgetOutput {
  organization: {
    created_at: string;
...
export const CustomerPortalorganizationsgetOutput =
  ...
  }) as unknown as Schema.Codec<CustomerPortalorganizationsgetOutput>;
