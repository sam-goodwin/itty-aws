...
// Input Schema
export interface CustomerPortallicenseKeysgetInput {
  id: string;
}
export const CustomerPortallicenseKeysgetInput =
  ...
  ) as unknown as Schema.Codec<CustomerPortallicenseKeysgetInput>;

// Output Schema
export interface CustomerPortallicenseKeysgetOutput {
  id: string;
  created_at: string;
...
export const CustomerPortallicenseKeysgetOutput =
  ...
  }) as unknown as Schema.Codec<CustomerPortallicenseKeysgetOutput>;
