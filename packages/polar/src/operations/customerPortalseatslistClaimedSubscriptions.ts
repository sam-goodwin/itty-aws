...
// Input Schema
export interface CustomerPortalseatslistClaimedSubscriptionsInput {
  page?: number;
  limit?: number;
}
export const CustomerPortalseatslistClaimedSubscriptionsInput =
  ...
  ) as unknown as Schema.Codec<CustomerPortalseatslistClaimedSubscriptionsInput>;

// Output Schema
export interface CustomerPortalseatslistClaimedSubscriptionsOutput {
  items: ReadonlyArray<{
    created_at: string;
...
export const CustomerPortalseatslistClaimedSubscriptionsOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    items: Schema.Array(
      Schema.Struct({
  ...
  }) as unknown as Schema.Codec<CustomerPortalseatslistClaimedSubscriptionsOutput>;
 ...
 */
export const customerPortalseatslistClaimedSubscriptions =
  /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
    inputSchema: CustomerPortalseatslistClaimedSubscriptionsInput,
    outputSchema: CustomerPortalseatslistClaimedSubscriptionsOutput,
  }));
