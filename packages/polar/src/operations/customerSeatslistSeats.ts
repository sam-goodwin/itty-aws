...
// Input Schema
export interface CustomerSeatslistSeatsInput {
...
export const CustomerSeatslistSeatsInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "GET", path: "/v1/customer-seats" }),
  ) as unknown as Schema.Codec<CustomerSeatslistSeatsInput>;

// Output Schema
export interface CustomerSeatslistSeatsOutput {
  seats: ReadonlyArray<{
    created_at: string;
...
export const CustomerSeatslistSeatsOutput =
  ...
  }) as unknown as Schema.Codec<CustomerSeatslistSeatsOutput>;
