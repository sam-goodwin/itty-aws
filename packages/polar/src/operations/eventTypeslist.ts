...
export const EventTypeslistInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  source: Schema.optional(Schema.NullOr(Schema.Literals(["system", "user"]))),
  ...
  T.Http({ method: "GET", path: "/v1/event-types/" }),
) as unknown as Schema.Codec<EventTypeslistInput>;

// Output Schema
export interface EventTypeslistOutput {
  items: ReadonlyArray<{
    id?: string | null;
...
}) as unknown as Schema.Codec<EventTypeslistOutput>;
