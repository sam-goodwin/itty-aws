...
// Input Schema
export interface CustomFieldsgetInput {
  id: string;
}
export const CustomFieldsgetInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String.pipe(T.PathParam()),
}).pipe(
  T.Http({ method: "GET", path: "/v1/custom-fields/{id}" }),
) as unknown as Schema.Codec<CustomFieldsgetInput>;

// Output Schema
export type CustomFieldsgetOutput =
  | {
      created_at: string;
...
export const CustomFieldsgetOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Union([
  Schema.Struct({
...
]) as unknown as Schema.Codec<CustomFieldsgetOutput>;
