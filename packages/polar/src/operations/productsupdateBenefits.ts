...
// Input Schema
export interface ProductsupdateBenefitsInput {
  id: string;
...
export const ProductsupdateBenefitsInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "POST", path: "/v1/products/{id}/benefits" }),
  ) as unknown as Schema.Codec<ProductsupdateBenefitsInput>;

// Output Schema
export interface ProductsupdateBenefitsOutput {
  id: string;
  created_at: string;
...
export const ProductsupdateBenefitsOutput =
  ...
  }) as unknown as Schema.Codec<ProductsupdateBenefitsOutput>;
