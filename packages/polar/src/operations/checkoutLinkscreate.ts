...
// Input Schema
export interface CheckoutLinkscreateInput {
...
export const CheckoutLinkscreateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    product_price_id: Schema.optional(Schema.String),
  ...
  ) as unknown as Schema.Codec<CheckoutLinkscreateInput>;

// Output Schema
export interface CheckoutLinkscreateOutput {
  id: string;
  created_at: string;
...
export const CheckoutLinkscreateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    url: Schema.String,
  }) as unknown as Schema.Codec<CheckoutLinkscreateOutput>;
