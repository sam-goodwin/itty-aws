...
// Input Schema
export interface CheckoutLinksupdateInput {
  id: string;
...
export const CheckoutLinksupdateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "PATCH", path: "/v1/checkout-links/{id}" }),
  ) as unknown as Schema.Codec<CheckoutLinksupdateInput>;

// Output Schema
export interface CheckoutLinksupdateOutput {
  id: string;
  created_at: string;
...
export const CheckoutLinksupdateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    url: Schema.String,
  }) as unknown as Schema.Codec<CheckoutLinksupdateOutput>;
