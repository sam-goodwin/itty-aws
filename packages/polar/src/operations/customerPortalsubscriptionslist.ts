...
// Input Schema
export interface CustomerPortalsubscriptionslistInput {
...
export const CustomerPortalsubscriptionslistInput =
  ...
  ) as unknown as Schema.Codec<CustomerPortalsubscriptionslistInput>;

// Output Schema
export interface CustomerPortalsubscriptionslistOutput {
  items: ReadonlyArray<{
    created_at: string;
...
export const CustomerPortalsubscriptionslistOutput =
  ...
  }) as unknown as Schema.Codec<CustomerPortalsubscriptionslistOutput>;
