...
export const OrderscreateInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "POST", path: "/v1/orders/" }),
) as unknown as Schema.Codec<OrderscreateInput>;
...
export const OrderscreateOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String,
...
}) as unknown as Schema.Codec<OrderscreateOutput>;
 ...
 * **Scopes**: `orders:write`
 */
export const orderscreate = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: OrderscreateInput,
  outputSchema: OrderscreateOutput,
}));
