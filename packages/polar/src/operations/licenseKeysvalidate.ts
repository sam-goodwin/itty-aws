...
// Input Schema
export interface LicenseKeysvalidateInput {
  key: string;
...
export const LicenseKeysvalidateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "POST", path: "/v1/license-keys/validate" }),
  ) as unknown as Schema.Codec<LicenseKeysvalidateInput>;

// Output Schema
export interface LicenseKeysvalidateOutput {
  id: string;
  created_at: string;
...
export const LicenseKeysvalidateOutput =
  ...
  }) as unknown as Schema.Codec<LicenseKeysvalidateOutput>;
