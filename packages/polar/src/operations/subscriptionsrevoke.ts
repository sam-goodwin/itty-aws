...
// Input Schema
export interface SubscriptionsrevokeInput {
  id: string;
}
export const SubscriptionsrevokeInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "DELETE", path: "/v1/subscriptions/{id}" }),
  ) as unknown as Schema.Codec<SubscriptionsrevokeInput>;

// Output Schema
export interface SubscriptionsrevokeOutput {
  created_at: string;
...
export const SubscriptionsrevokeOutput =
  ...
  }) as unknown as Schema.Codec<SubscriptionsrevokeOutput>;
