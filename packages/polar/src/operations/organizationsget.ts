...
}).pipe(T.Http({ method: "GET", path: "/v1/organizations/{id}" }));
export type OrganizationsgetInput = typeof OrganizationsgetInput.Type;
...
export type OrganizationsgetOutput = typeof OrganizationsgetOutput.Type;
