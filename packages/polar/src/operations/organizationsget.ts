...
// Input Schema
export interface OrganizationsgetInput {
  id: string;
}
export const OrganizationsgetInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String.pipe(T.PathParam()),
}).pipe(
  T.Http({ method: "GET", path: "/v1/organizations/{id}" }),
) as unknown as Schema.Codec<OrganizationsgetInput>;

// Output Schema
export interface OrganizationsgetOutput {
  created_at: string;
...
export const OrganizationsgetOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct(
  {
...
) as unknown as Schema.Codec<OrganizationsgetOutput>;
 ...
 */
export const organizationsget = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: OrganizationsgetInput,
  outputSchema: OrganizationsgetOutput,
}));
