...
// Input Schema
export interface LicenseKeysgetActivationInput {
  id: string;
  activation_id: string;
}
export const LicenseKeysgetActivationInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.String.pipe(T.PathParam()),
    activation_id: Schema.String.pipe(T.PathParam()),
  }).pipe(
    T.Http({
      method: "GET",
      path: "/v1/license-keys/{id}/activations/{activation_id}",
    }),
  ) as unknown as Schema.Codec<LicenseKeysgetActivationInput>;

// Output Schema
export interface LicenseKeysgetActivationOutput {
  id: string;
...
export const LicenseKeysgetActivationOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.String,
  ...
  }) as unknown as Schema.Codec<LicenseKeysgetActivationOutput>;
 ...
 */
export const licenseKeysgetActivation = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
