...
// Input Schema
export interface CheckoutsclientConfirmInput {
...
export const CheckoutsclientConfirmInput =
  ...
  ) as unknown as Schema.Codec<CheckoutsclientConfirmInput>;

// Output Schema
export interface CheckoutsclientConfirmOutput {
  id: string;
  created_at: string;
...
export const CheckoutsclientConfirmOutput =
  ...
  }) as unknown as Schema.Codec<CheckoutsclientConfirmOutput>;
