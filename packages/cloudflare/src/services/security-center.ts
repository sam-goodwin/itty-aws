...
export const ListByInsightInsightAuditLogResponse = /*@__PURE__*/ Schema.Struct(
  {
    result: Schema.Array(
      Schema.Struct({
...
export const ListInsightsForAccountRequest = /*@__PURE__*/ Schema.Struct({
  accountId: Schema.String.pipe(T.HttpPath("account_id")),
...
export const ListInsightsForZoneRequest = /*@__PURE__*/ Schema.Struct({
  zoneId: Schema.String.pipe(T.HttpPath("zone_id")),
  ...ListInsightsBaseFields,
}).pipe(
...
export const ListInsightsResponse = /*@__PURE__*/ Schema.Struct({
...
export const DismissInsightForAccountRequest = /*@__PURE__*/ Schema.Struct({
  accountId: Schema.String.pipe(T.HttpPath("account_id")),
...
export const DismissInsightForZoneRequest = /*@__PURE__*/ Schema.Struct({
  zoneId: Schema.String.pipe(T.HttpPath("zone_id")),
  ...DismissInsightBaseFields,
}).pipe(
  T.Http({
...
export const DismissInsightResponse = /*@__PURE__*/ Schema.Struct({
  errors: Schema.Array(
    Schema.Struct({
      code: Schema.Number,
...
export const ListInsightAuditLogsForZoneRequest = /*@__PURE__*/ Schema.Struct({
  zoneId: Schema.String.pipe(T.HttpPath("zone_id")),
  ...ListInsightAuditLogsBaseFields,
}).pipe(
  T.Http({
...
export const ListInsightAuditLogsResponse = /*@__PURE__*/ Schema.Struct({
  result: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.Union([Schema.String, Schema.Null])),
      changedAt: Schema.optional(Schema.Union([Schema.String, Schema.Null])),
...
export const GetInsightClassForAccountRequest = /*@__PURE__*/ Schema.Struct({
  accountId: Schema.String.pipe(T.HttpPath("account_id")),
...
export const GetInsightClassForZoneRequest = /*@__PURE__*/ Schema.Struct({
  zoneId: Schema.String.pipe(T.HttpPath("zone_id")),
  ...GetInsightClassBaseFields,
}).pipe(
  T.Http({
...
export const GetInsightClassResponse = /*@__PURE__*/ Schema.Array(
  Schema.Struct({
    count: Schema.optional(Schema.Union([Schema.Number, Schema.Null])),
...
export const PatchInsightClassificationResponse = /*@__PURE__*/ Schema.Struct({
  errors: Schema.Array(
    Schema.Struct({
      code: Schema.Number,
      message: Schema.String,
...
export const GetInsightContextRequest = /*@__PURE__*/ Schema.Struct({
  issueId: Schema.String.pipe(T.HttpPath("issueId")),
  accountId: Schema.String.pipe(T.HttpPath("account_id")),
}).pipe(
  T.Http({
...
export const GetInsightContextResponse = /*@__PURE__*/ Schema.Record(
  Schema.String,
  Schema.Unknown,
).pipe(
  T.ResponsePath("result"),
...
export const GetInsightSeverityForAccountRequest = /*@__PURE__*/ Schema.Struct({
  accountId: Schema.String.pipe(T.HttpPath("account_id")),
...
export const GetInsightSeverityForZoneRequest = /*@__PURE__*/ Schema.Struct({
  zoneId: Schema.String.pipe(T.HttpPath("zone_id")),
  ...GetInsightSeverityBaseFields,
}).pipe(
  T.Http({
...
export const GetInsightSeverityResponse = /*@__PURE__*/ Schema.Array(
  Schema.Struct({
    count: Schema.optional(Schema.Union([Schema.Number, Schema.Null])),
    value: Schema.optional(Schema.Union([Schema.String, Schema.Null])),
  }),
...
export const GetInsightTypeForAccountRequest = /*@__PURE__*/ Schema.Struct({
  accountId: Schema.String.pipe(T.HttpPath("account_id")),
...
export const GetInsightTypeForZoneRequest = /*@__PURE__*/ Schema.Struct({
  zoneId: Schema.String.pipe(T.HttpPath("zone_id")),
  ...GetInsightTypeBaseFields,
}).pipe(
  T.Http({
...
export const GetInsightTypeResponse = /*@__PURE__*/ Schema.Array(
  Schema.Struct({
    count: Schema.optional(Schema.Union([Schema.Number, Schema.Null])),
    value: Schema.optional(Schema.Union([Schema.String, Schema.Null])),
  }),
