...
export const GetEndpointHealthcheckRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetEndpointHealthcheckResponse = /*@__PURE__*/ Schema.Struct({
...
export const ListEndpointHealthchecksRequest = /*@__PURE__*/ Schema.Struct({
  accountId: Schema.String.pipe(T.HttpPath("account_id")),
}).pipe(
  T.Http({
    method: "GET",
...
export const ListEndpointHealthchecksResponse = /*@__PURE__*/ Schema.Struct({
  checkType: Schema.Literal("icmp"),
  endpoint: Schema.String,
  id: Schema.optional(Schema.Union([Schema.String, Schema.Null])),
  name: Schema.optional(Schema.Union([Schema.String, Schema.Null])),
...
export const CreateEndpointHealthcheckRequest = /*@__PURE__*/ Schema.Struct({
  accountId: Schema.String.pipe(T.HttpPath("account_id")),
  checkType: Schema.Literal("icmp"),
  endpoint: Schema.String,
...
export const CreateEndpointHealthcheckResponse = /*@__PURE__*/ Schema.Struct({
  checkType: Schema.Literal("icmp"),
  endpoint: Schema.String,
  id: Schema.optional(Schema.Union([Schema.String, Schema.Null])),
  name: Schema.optional(Schema.Union([Schema.String, Schema.Null])),
...
export const UpdateEndpointHealthcheckRequest = /*@__PURE__*/ Schema.Struct({
  id: Schema.String.pipe(T.HttpPath("id")),
  accountId: Schema.String.pipe(T.HttpPath("account_id")),
  checkType: Schema.Literal("icmp"),
  endpoint: Schema.String,
...
export const UpdateEndpointHealthcheckResponse = /*@__PURE__*/ Schema.Struct({
  checkType: Schema.Literal("icmp"),
  endpoint: Schema.String,
  id: Schema.optional(Schema.Union([Schema.String, Schema.Null])),
  name: Schema.optional(Schema.Union([Schema.String, Schema.Null])),
...
export const DeleteEndpointHealthcheckRequest = /*@__PURE__*/ Schema.Struct({
  id: Schema.String.pipe(T.HttpPath("id")),
  accountId: Schema.String.pipe(T.HttpPath("account_id")),
}).pipe(
  T.Http({
...
export const DeleteEndpointHealthcheckResponse = /*@__PURE__*/ Schema.Struct({
  errors: Schema.Array(
    Schema.Struct({
      code: Schema.Number,
...
export const CreateTracerouteRequest = /*@__PURE__*/ Schema.Struct({
  accountId: Schema.String.pipe(T.HttpPath("account_id")),
...
export const CreateTracerouteResponse = /*@__PURE__*/ Schema.Struct({
  result: Schema.Array(
    Schema.Struct({
