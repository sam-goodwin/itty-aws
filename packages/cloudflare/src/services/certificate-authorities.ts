...
export const GetHostnameAssociationRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetHostnameAssociationResponse = /*@__PURE__*/ Schema.Struct({
...
export const PutHostnameAssociationRequest = /*@__PURE__*/ Schema.Struct({
  zoneId: Schema.String.pipe(T.HttpPath("zone_id")),
...
export const PutHostnameAssociationResponse = /*@__PURE__*/ Schema.Struct({
  hostnames: Schema.optional(
    Schema.Union([Schema.Array(Schema.String), Schema.Null]),
  ),
}).pipe(
