...
export const GetSmartRoutingRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetSmartRoutingResponse = /*@__PURE__*/ Schema.Struct({
  id: Schema.String,
...
export const PatchSmartRoutingRequest = /*@__PURE__*/ Schema.Struct({
  zoneId: Schema.String.pipe(T.HttpPath("zone_id")),
  value: Schema.Union([Schema.Literals(["on", "off"]), Schema.String]),
}).pipe(
...
export const PatchSmartRoutingResponse = /*@__PURE__*/ Schema.Struct({
  id: Schema.String,
  editable: Schema.Boolean,
  value: Schema.Union([Schema.Literals(["on", "off"]), Schema.String]),
  modifiedOn: Schema.optional(Schema.Union([Schema.String, Schema.Null])),
...
export const GetTieredCachingRequest = /*@__PURE__*/ Schema.Struct({
  zoneId: Schema.String.pipe(T.HttpPath("zone_id")),
}).pipe(
...
export const GetTieredCachingResponse = /*@__PURE__*/ Schema.Struct({
...
export const PatchTieredCachingRequest = /*@__PURE__*/ Schema.Struct({
  zoneId: Schema.String.pipe(T.HttpPath("zone_id")),
  value: Schema.Union([Schema.Literals(["on", "off"]), Schema.String]),
}).pipe(
...
export const PatchTieredCachingResponse = /*@__PURE__*/ Schema.Struct({
  id: Schema.Literal("tiered_caching"),
  editable: Schema.Boolean,
  value: Schema.Union([Schema.Literals(["on", "off"]), Schema.String]),
  modifiedOn: Schema.optional(Schema.Union([Schema.String, Schema.Null])),
