...
export const GetBookmarkDatabaseTimeTravelRequest = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export const GetBookmarkDatabaseTimeTravelResponse = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  bookmark: Schema.optional(Schema.Union([Schema.String, Schema.Null]))
}).pipe(T.ResponsePath("result")) as unknown as Schema.Schema<GetBookmarkDatabaseTimeTravelResponse>;
...
export interface ListDatabasesResponse {
  result: ({ createdAt?: string | null; name?: string | null; uuid?: string | null; version?: string | null })[];
...
}).pipe(Schema.encodeKeys({ createdAt: "created_at", name: "name", uuid: "uuid", version: "version" }))),
...
}).pipe(Schema.encodeKeys({ result: "result", resultInfo: "result_info" })) as unknown as Schema.Schema<ListDatabasesResponse>;
...
export const GetDatabaseResponse = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  readReplication: Schema.optional(Schema.Union([Schema.Struct({
  mode: Schema.Literals(["auto", "disabled"])
}), Schema.Null])),
  uuid: Schema.optional(Schema.Union([Schema.String, Schema.Null])),
  version: Schema.optional(Schema.Union([Schema.String, Schema.Null]))
}).pipe(Schema.encodeKeys({ createdAt: "created_at", fileSize: "file_size", name: "name", numTables: "num_tables", readReplication: "read_replication", uuid: "uuid", version: "version" })).pipe(T.ResponsePath("result")) as unknown as Schema.Schema<GetDatabaseResponse>;
...
export const CreateDatabaseResponse = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  uuid: Schema.optional(Schema.Union([Schema.String, Schema.Null])),
  version: Schema.optional(Schema.Union([Schema.String, Schema.Null]))
}).pipe(Schema.encodeKeys({ createdAt: "created_at", fileSize: "file_size", name: "name", numTables: "num_tables", readReplication: "read_replication", uuid: "uuid", version: "version" })).pipe(T.ResponsePath("result")) as unknown as Schema.Schema<CreateDatabaseResponse>;
...
export const UpdateDatabaseResponse = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  uuid: Schema.optional(Schema.Union([Schema.String, Schema.Null])),
  version: Schema.optional(Schema.Union([Schema.String, Schema.Null]))
}).pipe(Schema.encodeKeys({ createdAt: "created_at", fileSize: "file_size", name: "name", numTables: "num_tables", readReplication: "read_replication", uuid: "uuid", version: "version" })).pipe(T.ResponsePath("result")) as unknown as Schema.Schema<UpdateDatabaseResponse>;
...
export const PatchDatabaseResponse = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  uuid: Schema.optional(Schema.Union([Schema.String, Schema.Null])),
  version: Schema.optional(Schema.Union([Schema.String, Schema.Null]))
}).pipe(Schema.encodeKeys({ createdAt: "created_at", fileSize: "file_size", name: "name", numTables: "num_tables", readReplication: "read_replication", uuid: "uuid", version: "version" })).pipe(T.ResponsePath("result")) as unknown as Schema.Schema<PatchDatabaseResponse>;
...
export const DeleteDatabaseResponse = /*@__PURE__*/ /*#__PURE__*/ Schema.Unknown.pipe(T.ResponsePath("result")) as unknown as Schema.Schema<DeleteDatabaseResponse>;
...
}).pipe(Schema.encodeKeys({ filename: "filename", signedUrl: "signed_url" })), Schema.Null])),
  status: Schema.optional(Schema.Union([Schema.Literals(["complete", "error", "active"]), Schema.Null])),
...
}).pipe(Schema.encodeKeys({ atBookmark: "at_bookmark", error: "error", messages: "messages", result: "result", status: "status", success: "success", type: "type" })).pipe(T.ResponsePath("result")) as unknown as Schema.Schema<ExportDatabaseResponse>;
...
export interface ImportDatabaseResponse {
  ...
  messages?: string[] | null;
  /** Only present when status = 'complete' */
  result?: { finalBookmark?: string | null; meta?: { changedDb?: boolean | null; changes?: number | null; duration?: number | null; lastRowId?: number | null; rowsRead?: number | null; rowsWritten?: number | null; servedByColo?: string | null; servedByPrimary?: boolean | null; servedByRegion?: "WNAM" | "ENAM" | "WEUR" | "EEUR" | "APAC" | "OC" | null; sizeAfter?: number | null; timings?: { sqlDurationMs?: number | null } | null } | null; numQueries?: number | null } | null;
...
export const ImportDatabaseResponse = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  meta: Schema.optional(Schema.Union([Schema.Struct({
    ...
    servedByPrimary: Schema.optional(Schema.Union([Schema.Boolean, Schema.Null])),
    servedByRegion: Schema.optional(Schema.Union([Schema.Literals(["WNAM", "ENAM", "WEUR", "EEUR", "APAC", "OC"]), Schema.Null])),
    sizeAfter: Schema.optional(Schema.Union([Schema.Number, Schema.Null])),
    timings: Schema.optional(Schema.Union([Schema.Struct({
      sqlDurationMs: Schema.optional(Schema.Union([Schema.Number, Schema.Null]))
    }).pipe(Schema.encodeKeys({ sqlDurationMs: "sql_duration_ms" })), Schema.Null]))
  }).pipe(Schema.encodeKeys({ changedDb: "changed_db", changes: "changes", duration: "duration", lastRowId: "last_row_id", rowsRead: "rows_read", rowsWritten: "rows_written", servedByColo: "served_by_colo", servedByPrimary: "served_by_primary", servedByRegion: "served_by_region", sizeAfter: "size_after", timings: "timings" })), Schema.Null])),
  numQueries: Schema.optional(Schema.Union([Schema.Number, Schema.Null]))
}).pipe(Schema.encodeKeys({ finalBookmark: "final_bookmark", meta: "meta", numQueries: "num_queries" })), Schema.Null])),
  status: Schema.optional(Schema.Union([Schema.Literals(["complete", "error"]), Schema.Null])),
  success: Schema.optional(Schema.Union([Schema.Boolean, Schema.Null])),
...
}).pipe(Schema.encodeKeys({ atBookmark: "at_bookmark", error: "error", filename: "filename", messages: "messages", result: "result", status: "status", success: "success", type: "type", uploadUrl: "upload_url" })).pipe(T.ResponsePath("result")) as unknown as Schema.Schema<ImportDatabaseResponse>;
...
export interface QueryDatabaseResponse {
  result: ({ meta?: { changedDb?: boolean | null; changes?: number | null; duration?: number | null; lastRowId?: number | null; rowsRead?: number | null; rowsWritten?: number | null; servedByColo?: string | null; servedByPrimary?: boolean | null; servedByRegion?: "WNAM" | "ENAM" | "WEUR" | "EEUR" | "APAC" | "OC" | null; sizeAfter?: number | null; timings?: { sqlDurationMs?: number | null } | null } | null; results?: unknown[] | null; success?: boolean | null })[];
}
...
export const QueryDatabaseResponse = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  results: Schema.optional(Schema.Union([Schema.Array(Schema.Unknown), Schema.Null])),
  success: Schema.optional(Schema.Union([Schema.Boolean, Schema.Null]))
}))
...
export interface RawDatabaseResponse {
  result: ({ meta?: { changedDb?: boolean | null; changes?: number | null; duration?: number | null; lastRowId?: number | null; rowsRead?: number | null; rowsWritten?: number | null; servedByColo?: string | null; servedByPrimary?: boolean | null; servedByRegion?: "WNAM" | "ENAM" | "WEUR" | "EEUR" | "APAC" | "OC" | null; sizeAfter?: number | null; timings?: { sqlDurationMs?: number | null } | null } | null; results?: { columns?: string[] | null; rows?: ((number | string)[])[] | null } | null; success?: boolean | null })[];
}
...
export const RawDatabaseResponse = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  results: Schema.optional(Schema.Union([Schema.Struct({
    columns: Schema.optional(Schema.Union([Schema.Array(Schema.String), Schema.Null])),
    rows: Schema.optional(Schema.Union([Schema.Array(Schema.Array(Schema.Union([Schema.Number, Schema.String]))), Schema.Null]))
  }), Schema.Null])),
  success: Schema.optional(Schema.Union([Schema.Boolean, Schema.Null]))
}))
...
export const RestoreDatabaseTimeTravelRequest = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  databaseId: Schema.String.pipe(T.HttpPath("databaseId")),
  accountId: Schema.String.pipe(T.HttpPath("account_id")),
...
export const RestoreDatabaseTimeTravelResponse = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  bookmark: Schema.optional(Schema.Union([Schema.String, Schema.Null])),
...
}).pipe(Schema.encodeKeys({ bookmark: "bookmark", message: "message", previousBookmark: "previous_bookmark" })).pipe(T.ResponsePath("result")) as unknown as Schema.Schema<RestoreDatabaseTimeTravelResponse>;
