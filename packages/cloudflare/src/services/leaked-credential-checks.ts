...
export const GetDetectionRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetDetectionResponse = /*@__PURE__*/ Schema.Struct({
...
export const ListDetectionsResponse = /*@__PURE__*/ Schema.Struct({
  result: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.Union([Schema.String, Schema.Null])),
...
export const CreateDetectionRequest = /*@__PURE__*/ Schema.Struct({
  zoneId: Schema.String.pipe(T.HttpPath("zone_id")),
...
export const CreateDetectionResponse = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.Union([Schema.String, Schema.Null])),
  password: Schema.optional(Schema.Union([Schema.String, Schema.Null])),
  username: Schema.optional(Schema.Union([Schema.String, Schema.Null])),
}).pipe(
...
export const UpdateDetectionRequest = /*@__PURE__*/ Schema.Struct({
  detectionId: Schema.String.pipe(T.HttpPath("detectionId")),
  zoneId: Schema.String.pipe(T.HttpPath("zone_id")),
  password: Schema.optional(Schema.String),
  username: Schema.optional(Schema.String),
...
export const UpdateDetectionResponse = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.Union([Schema.String, Schema.Null])),
  password: Schema.optional(Schema.Union([Schema.String, Schema.Null])),
  username: Schema.optional(Schema.Union([Schema.String, Schema.Null])),
}).pipe(
...
export const DeleteDetectionRequest = /*@__PURE__*/ Schema.Struct({
  detectionId: Schema.String.pipe(T.HttpPath("detectionId")),
  zoneId: Schema.String.pipe(T.HttpPath("zone_id")),
}).pipe(
  T.Http({
...
export const DeleteDetectionResponse = /*@__PURE__*/ Schema.Unknown.pipe(
  T.ResponsePath("result"),
...
export const GetLeakedCredentialCheckRequest = /*@__PURE__*/ Schema.Struct({
  zoneId: Schema.String.pipe(T.HttpPath("zone_id")),
}).pipe(
...
export const GetLeakedCredentialCheckResponse = /*@__PURE__*/ Schema.Struct({
...
export const CreateLeakedCredentialCheckRequest = /*@__PURE__*/ Schema.Struct({
  zoneId: Schema.String.pipe(T.HttpPath("zone_id")),
...
export const CreateLeakedCredentialCheckResponse = /*@__PURE__*/ Schema.Struct({
  enabled: Schema.optional(Schema.Union([Schema.Boolean, Schema.Null])),
}).pipe(
  T.ResponsePath("result"),
