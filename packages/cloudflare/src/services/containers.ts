...
export const GetContainerApplicationRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetContainerApplicationResponse = /*@__PURE__*/ Schema.Struct({
  id: Schema.String,
...
export const ListContainerApplicationsRequest = /*@__PURE__*/ Schema.Struct({
  accountId: Schema.String.pipe(T.HttpPath("account_id")),
}).pipe(
  T.Http({
    method: "GET",
...
export const ListContainerApplicationsResponse = /*@__PURE__*/ Schema.Array(
  Schema.Struct({
    id: Schema.String,
    accountId: Schema.String,
    name: Schema.String,
...
export const CreateContainerApplicationRequest = /*@__PURE__*/ Schema.Struct({
  accountId: Schema.String.pipe(T.HttpPath("account_id")),
  name: Schema.String,
  maxInstances: Schema.Number,
  configuration: Schema.Struct({
...
export const CreateContainerApplicationResponse = /*@__PURE__*/ Schema.Struct({
  id: Schema.String,
  accountId: Schema.String,
  name: Schema.String,
  schedulingPolicy: Schema.Union([
...
export const UpdateContainerApplicationRequest = /*@__PURE__*/ Schema.Struct({
  accountId: Schema.String.pipe(T.HttpPath("account_id")),
  applicationId: Schema.String.pipe(T.HttpPath("application_id")),
  instances: Schema.optional(Schema.Number),
...
export const UpdateContainerApplicationResponse = /*@__PURE__*/ Schema.Struct({
  id: Schema.String,
  accountId: Schema.String,
  name: Schema.String,
  schedulingPolicy: Schema.Union([
...
export const DeleteContainerApplicationRequest = /*@__PURE__*/ Schema.Struct({
  accountId: Schema.String.pipe(T.HttpPath("account_id")),
  applicationId: Schema.String.pipe(T.HttpPath("application_id")),
}).pipe(
  T.Http({
...
export const GetContainerIdentityRequest = /*@__PURE__*/ Schema.Struct({
  accountId: Schema.String.pipe(T.HttpPath("account_id")),
}).pipe(
...
export const GetContainerIdentityResponse = /*@__PURE__*/ Schema.Struct({
