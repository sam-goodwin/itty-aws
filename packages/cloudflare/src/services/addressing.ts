...
export type AddressMapsCreateResponseKind = "zone";
export const AddressMapsCreateResponseKind = /*@__PURE__*/ S.String;
...
export interface CreateAddressMapResponse {
  ...
  ips_2: unknown;
  /** { */
  memberships_2: unknown;
  identifier: unknown;
  /** } */
  kind: AddressMapsCreateResponseKind;
}
export const CreateAddressMapResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    memberships_2: S.Unknown.pipe(T.Body("memberships")),
...
export type PrefixesCreateResponseLoaDocumentId =
  "d933b1530bc56c9953cf8ce166da8004";
export const PrefixesCreateResponseLoaDocumentId = /*@__PURE__*/ S.String;
...
export interface CreatePrefixResponse {
  ...
  /** Identifier of a Cloudflare account. */
  accountId?: string | null;
  /** Prefer the BGP Prefixes API instead, which allows for advertising multiple BGP routes within a single IP Prefix. */
  deprecatedadvertised?: boolean | null;
  /** Prefer the BGP Prefixes API instead, which allows for advertising multiple BGP routes within a single IP Prefix. */
  deprecatedadvertisedModifiedAt?: string | null;
  ...
  modifiedAt?: string | null;
  /** Prefer the BGP Prefixes API instead, which allows for advertising multiple BGP routes within a single IP Prefix. */
  deprecatedonDemandEnabled?: boolean | null;
  /** Prefer the BGP Prefixes API instead, which allows for advertising multiple BGP routes within a single IP Prefix. */
  deprecatedonDemandLocked?: boolean | null;
  /** State of one kind of validation for an IP prefix. */
  ...
  asn_2: unknown;
  cidr_2: unknown;
  delegate_loa_creation_2: unknown;
  description_2: unknown;
  /** }' */
  loa_document_id_2: PrefixesCreateResponseLoaDocumentId;
}
export const CreatePrefixResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.optional(S.NullOr(S.String)),
    accountId: S.optional(S.NullOr(S.String).pipe(T.Body("account_id"))),
    deprecatedadvertised: S.optional(
      S.NullOr(S.Boolean).pipe(T.Body("Deprecatedadvertised")),
    ),
    deprecatedadvertisedModifiedAt: S.optional(
      S.NullOr(S.String).pipe(T.Body("Deprecatedadvertised_modified_at")),
    ),
    ...
    modifiedAt: S.optional(S.NullOr(S.String).pipe(T.Body("modified_at"))),
    deprecatedonDemandEnabled: S.optional(
      S.NullOr(S.Boolean).pipe(T.Body("Deprecatedon_demand_enabled")),
    ),
    deprecatedonDemandLocked: S.optional(
      S.NullOr(S.Boolean).pipe(T.Body("Deprecatedon_demand_locked")),
    ),
    ...
    cidr_2: S.Unknown.pipe(T.Body("cidr")),
    delegate_loa_creation_2: S.Unknown.pipe(T.Body("delegate_loa_creation")),
    description_2: S.Unknown.pipe(T.Body("description")),
    loa_document_id_2: PrefixesCreateResponseLoaDocumentId.pipe(
      T.Body("loa_document_id"),
    ),
  }).pipe(T.KeyDictionary(KEY_DICTIONARY)),
).annotate({
...
export type PrefixesBgpPrefixesCreateResponseCidr = "192.0.2.0/24";
export const PrefixesBgpPrefixesCreateResponseCidr = /*@__PURE__*/ S.String;
...
export interface CreatePrefixBgpPrefixResponse {
  ...
  /** }' */
  cidr_2: PrefixesBgpPrefixesCreateResponseCidr;
}
export const CreatePrefixBgpPrefixResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    cidr_2: PrefixesBgpPrefixesCreateResponseCidr.pipe(T.Body("cidr")),
  }).pipe(T.KeyDictionary(KEY_DICTIONARY)),
).annotate({
...
export type PrefixesDelegationsCreateResponseDelegatedAccountId =
  "b1946ac92492d2347c6235b4d2611184";
export const PrefixesDelegationsCreateResponseDelegatedAccountId =
  /*@__PURE__*/ S.String;
...
export interface CreatePrefixDelegationResponse {
  ...
  cidr_2: unknown;
  /** }' */
  delegated_account_id_2: PrefixesDelegationsCreateResponseDelegatedAccountId;
}
export const CreatePrefixDelegationResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    cidr_2: S.Unknown.pipe(T.Body("cidr")),
    delegated_account_id_2:
      PrefixesDelegationsCreateResponseDelegatedAccountId.pipe(
        T.Body("delegated_account_id"),
      ),
  }).pipe(T.KeyDictionary(KEY_DICTIONARY)),
).annotate({
...
export type PrefixesServiceBindingsCreateResponseServiceId =
  "2db684ee7ca04e159946fd05b99e1bcd";
export const PrefixesServiceBindingsCreateResponseServiceId =
  /*@__PURE__*/ S.String;
...
export interface CreatePrefixServiceBindingResponse {
  ...
  cidr_2: unknown;
  /** }' */
  service_id_2: PrefixesServiceBindingsCreateResponseServiceId;
}
export const CreatePrefixServiceBindingResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    cidr_2: S.Unknown.pipe(T.Body("cidr")),
    service_id_2: PrefixesServiceBindingsCreateResponseServiceId.pipe(
      T.Body("service_id"),
    ),
  }).pipe(T.KeyDictionary(KEY_DICTIONARY)),
).annotate({
...
export type RegionalHostnamesCreateResponseRouting = "dns";
export const RegionalHostnamesCreateResponseRouting = /*@__PURE__*/ S.String;
...
export interface CreateRegionalHostnameResponse {
  ...
  routing: string;
  hostname_2: unknown;
  region_key_2: unknown;
  /** }' */
  routing_2: RegionalHostnamesCreateResponseRouting;
}
export const CreateRegionalHostnameResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    regionKey: S.String.pipe(T.Body("region_key")),
    routing: S.String,
    hostname_2: S.Unknown.pipe(T.Body("hostname")),
    region_key_2: S.Unknown.pipe(T.Body("region_key")),
    routing_2: RegionalHostnamesCreateResponseRouting.pipe(T.Body("routing")),
  }).pipe(T.KeyDictionary(KEY_DICTIONARY)),
).annotate({
...
export type AddressMapsDeleteResponsePointer = "pointer";
export const AddressMapsDeleteResponsePointer = /*@__PURE__*/ S.String;

export type AddressMapsDeleteResponsePointer2 = "pointer";
export const AddressMapsDeleteResponsePointer2 = /*@__PURE__*/ S.String;

export type AddressMapsDeleteResponseTotalPages = 100;
export const AddressMapsDeleteResponseTotalPages = /*@__PURE__*/ S.Number;
...
export interface AddressMapsDeleteResponse {
  ...
  source: unknown;
  /** } */
  pointer: AddressMapsDeleteResponsePointer;
  code_2: unknown;
  message_2: unknown;
  documentation_url_2: unknown;
  source_2: unknown;
  /** } */
  pointer_2: AddressMapsDeleteResponsePointer2;
  count: unknown;
  page: unknown;
  perPage: unknown;
  totalCount: unknown;
  /** } */
  totalPages: AddressMapsDeleteResponseTotalPages;
}
export const AddressMapsDeleteResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    pointer_2: AddressMapsDeleteResponsePointer2.pipe(T.Body("pointer")),
    count: S.Unknown,
    page: S.Unknown,
    perPage: S.Unknown.pipe(T.Body("per_page")),
    totalCount: S.Unknown.pipe(T.Body("total_count")),
    totalPages: AddressMapsDeleteResponseTotalPages.pipe(T.Body("total_pages")),
  }).pipe(T.KeyDictionary(KEY_DICTIONARY)),
).annotate({
...
export type AddressMapsAccountsDeleteResponsePointer = "pointer";
export const AddressMapsAccountsDeleteResponsePointer = /*@__PURE__*/ S.String;

export type AddressMapsAccountsDeleteResponsePointer2 = "pointer";
export const AddressMapsAccountsDeleteResponsePointer2 = /*@__PURE__*/ S.String;

export type AddressMapsAccountsDeleteResponseTotalPages = 100;
export const AddressMapsAccountsDeleteResponseTotalPages =
  /*@__PURE__*/ S.Number;
...
export interface AddressMapsAccountsDeleteResponse {
  ...
  source: unknown;
  /** } */
  pointer: AddressMapsAccountsDeleteResponsePointer;
  code_2: unknown;
  message_2: unknown;
  documentation_url_2: unknown;
  source_2: unknown;
  /** } */
  pointer_2: AddressMapsAccountsDeleteResponsePointer2;
  count: unknown;
  page: unknown;
  perPage: unknown;
  totalCount: unknown;
  /** } */
  totalPages: AddressMapsAccountsDeleteResponseTotalPages;
}
export const AddressMapsAccountsDeleteResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    documentation_url_2: S.Unknown.pipe(T.Body("documentation_url")),
    source_2: S.Unknown.pipe(T.Body("source")),
    pointer_2: AddressMapsAccountsDeleteResponsePointer2.pipe(
      T.Body("pointer"),
    ),
    count: S.Unknown,
    page: S.Unknown,
    perPage: S.Unknown.pipe(T.Body("per_page")),
    totalCount: S.Unknown.pipe(T.Body("total_count")),
    totalPages: AddressMapsAccountsDeleteResponseTotalPages.pipe(
      T.Body("total_pages"),
    ),
  }).pipe(T.KeyDictionary(KEY_DICTIONARY)),
).annotate({
...
export type AddressMapsIpsDeleteResponsePointer = "pointer";
export const AddressMapsIpsDeleteResponsePointer = /*@__PURE__*/ S.String;

export type AddressMapsIpsDeleteResponsePointer2 = "pointer";
export const AddressMapsIpsDeleteResponsePointer2 = /*@__PURE__*/ S.String;

export type AddressMapsIpsDeleteResponseTotalPages = 100;
export const AddressMapsIpsDeleteResponseTotalPages = /*@__PURE__*/ S.Number;
...
export interface AddressMapsIpsDeleteResponse {
  ...
  source: unknown;
  /** } */
  pointer: AddressMapsIpsDeleteResponsePointer;
  code_2: unknown;
  message_2: unknown;
  documentation_url_2: unknown;
  source_2: unknown;
  /** } */
  pointer_2: AddressMapsIpsDeleteResponsePointer2;
  count: unknown;
  page: unknown;
  perPage: unknown;
  totalCount: unknown;
  /** } */
  totalPages: AddressMapsIpsDeleteResponseTotalPages;
}
export const AddressMapsIpsDeleteResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    documentation_url_2: S.Unknown.pipe(T.Body("documentation_url")),
    source_2: S.Unknown.pipe(T.Body("source")),
    pointer_2: AddressMapsIpsDeleteResponsePointer2.pipe(T.Body("pointer")),
    count: S.Unknown,
    page: S.Unknown,
    perPage: S.Unknown.pipe(T.Body("per_page")),
    totalCount: S.Unknown.pipe(T.Body("total_count")),
    totalPages: AddressMapsIpsDeleteResponseTotalPages.pipe(
      T.Body("total_pages"),
    ),
  }).pipe(T.KeyDictionary(KEY_DICTIONARY)),
).annotate({
...
export type AddressMapsZonesDeleteResponsePointer = "pointer";
export const AddressMapsZonesDeleteResponsePointer = /*@__PURE__*/ S.String;

export type AddressMapsZonesDeleteResponsePointer2 = "pointer";
export const AddressMapsZonesDeleteResponsePointer2 = /*@__PURE__*/ S.String;

export type AddressMapsZonesDeleteResponseTotalPages = 100;
export const AddressMapsZonesDeleteResponseTotalPages = /*@__PURE__*/ S.Number;
...
export interface AddressMapsZonesDeleteResponse {
  ...
  source: unknown;
  /** } */
  pointer: AddressMapsZonesDeleteResponsePointer;
  code_2: unknown;
  message_2: unknown;
  documentation_url_2: unknown;
  source_2: unknown;
  /** } */
  pointer_2: AddressMapsZonesDeleteResponsePointer2;
  count: unknown;
  page: unknown;
  perPage: unknown;
  totalCount: unknown;
  /** } */
  totalPages: AddressMapsZonesDeleteResponseTotalPages;
}
export const AddressMapsZonesDeleteResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    documentation_url_2: S.Unknown.pipe(T.Body("documentation_url")),
    source_2: S.Unknown.pipe(T.Body("source")),
    pointer_2: AddressMapsZonesDeleteResponsePointer2.pipe(T.Body("pointer")),
    count: S.Unknown,
    page: S.Unknown,
    perPage: S.Unknown.pipe(T.Body("per_page")),
    totalCount: S.Unknown.pipe(T.Body("total_count")),
    totalPages: AddressMapsZonesDeleteResponseTotalPages.pipe(
      T.Body("total_pages"),
    ),
  }).pipe(T.KeyDictionary(KEY_DICTIONARY)),
).annotate({
...
export type PrefixesDeleteResponsePointer = "pointer";
export const PrefixesDeleteResponsePointer = /*@__PURE__*/ S.String;

export type PrefixesDeleteResponsePointer2 = "pointer";
export const PrefixesDeleteResponsePointer2 = /*@__PURE__*/ S.String;
...
export interface PrefixesDeleteResponse {
  ...
  source: unknown;
  /** } */
  pointer: PrefixesDeleteResponsePointer;
  code_2: unknown;
  message_2: unknown;
  documentation_url_2: unknown;
  source_2: unknown;
  /** } */
  pointer_2: PrefixesDeleteResponsePointer2;
}
export const PrefixesDeleteResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    documentation_url_2: S.Unknown.pipe(T.Body("documentation_url")),
    source_2: S.Unknown.pipe(T.Body("source")),
    pointer_2: PrefixesDeleteResponsePointer2.pipe(T.Body("pointer")),
  }).pipe(T.KeyDictionary(KEY_DICTIONARY)),
).annotate({
...
export type PrefixesServiceBindingsDeleteResponsePointer = "pointer";
export const PrefixesServiceBindingsDeleteResponsePointer =
  /*@__PURE__*/ S.String;

export type PrefixesServiceBindingsDeleteResponsePointer2 = "pointer";
export const PrefixesServiceBindingsDeleteResponsePointer2 =
  /*@__PURE__*/ S.String;
...
export interface PrefixesServiceBindingsDeleteResponse {
  ...
  source: unknown;
  /** } */
  pointer: PrefixesServiceBindingsDeleteResponsePointer;
  code_2: unknown;
  message_2: unknown;
  documentation_url_2: unknown;
  source_2: unknown;
  /** } */
  pointer_2: PrefixesServiceBindingsDeleteResponsePointer2;
}
export const PrefixesServiceBindingsDeleteResponse = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      ...
      documentation_url_2: S.Unknown.pipe(T.Body("documentation_url")),
      source_2: S.Unknown.pipe(T.Body("source")),
      pointer_2: PrefixesServiceBindingsDeleteResponsePointer2.pipe(
        T.Body("pointer"),
      ),
    }).pipe(T.KeyDictionary(KEY_DICTIONARY)),
).annotate({
...
export type RegionalHostnamesDeleteResponsePointer = "pointer";
export const RegionalHostnamesDeleteResponsePointer = /*@__PURE__*/ S.String;

export type RegionalHostnamesDeleteResponsePointer2 = "pointer";
export const RegionalHostnamesDeleteResponsePointer2 = /*@__PURE__*/ S.String;
...
export interface RegionalHostnamesDeleteResponse {
  ...
  source: unknown;
  /** } */
  pointer: RegionalHostnamesDeleteResponsePointer;
  code_2: unknown;
  message_2: unknown;
  documentation_url_2: unknown;
  source_2: unknown;
  /** } */
  pointer_2: RegionalHostnamesDeleteResponsePointer2;
}
export const RegionalHostnamesDeleteResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    documentation_url_2: S.Unknown.pipe(T.Body("documentation_url")),
    source_2: S.Unknown.pipe(T.Body("source")),
    pointer_2: RegionalHostnamesDeleteResponsePointer2.pipe(T.Body("pointer")),
  }).pipe(T.KeyDictionary(KEY_DICTIONARY)),
).annotate({
...
export const PatchAddressMapResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    enabled: S.optional(S.NullOr(S.Boolean)),
    modifiedAt: S.optional(S.NullOr(S.String).pipe(T.Body("modified_at"))),
    default_sni_2: S.Unknown.pipe(T.Body("default_sni")),
    description_2: S.Unknown.pipe(T.Body("description")),
...
export type PrefixesEditResponseDescription = "Internal test prefix";
export const PrefixesEditResponseDescription = /*@__PURE__*/ S.String;
...
export interface PatchPrefixResponse {
  ...
  rpkiValidationState?: string | null;
  /** }' */
  description_2: PrefixesEditResponseDescription;
}
export const PatchPrefixResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    description_2: PrefixesEditResponseDescription.pipe(T.Body("description")),
  }).pipe(T.KeyDictionary(KEY_DICTIONARY)),
).annotate({
...
export const PatchPrefixAdvertisementStatusResponse = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      ...
      advertised_2: S.Boolean.pipe(T.Body("advertised")),
    }).pipe(T.KeyDictionary(KEY_DICTIONARY)),
).annotate({
...
export interface PatchPrefixBgpPrefixResponse {
  ...
  modifiedAt?: string | null;
  onDemand?: PrefixesBgpPrefixesCreateResponseOnDemand | null;
  asn_prepend_count_2: unknown;
  /** }' */
  auto_advertise_withdraw_2: boolean;
}
export const PatchPrefixBgpPrefixResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    asn_prepend_count_2: S.Unknown.pipe(T.Body("asn_prepend_count")),
    auto_advertise_withdraw_2: S.Boolean.pipe(
      T.Body("auto_advertise_withdraw"),
    ),
  }).pipe(T.KeyDictionary(KEY_DICTIONARY)),
).annotate({
...
export type RegionalHostnamesEditResponseRegionKey = "ca";
export const RegionalHostnamesEditResponseRegionKey = /*@__PURE__*/ S.String;
...
export interface PatchRegionalHostnameResponse {
  ...
  routing: string;
  /** }' */
  region_key_2: RegionalHostnamesEditResponseRegionKey;
}
export const PatchRegionalHostnameResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    regionKey: S.String.pipe(T.Body("region_key")),
    routing: S.String,
    region_key_2: RegionalHostnamesEditResponseRegionKey.pipe(
      T.Body("region_key"),
    ),
  }).pipe(T.KeyDictionary(KEY_DICTIONARY)),
).annotate({
...
export interface PrefixesValidateRequest {
  /** Identifier of a Cloudflare account. */
  accountId: string;
  /** Identifier of an IP Prefix. */
  prefixId: string;
}
export const PrefixesValidateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    accountId: S.String.pipe(T.Label("account_id")),
    prefixId: S.String.pipe(T.Label("prefix_id")),
  })
  ...
  identifier: "PrefixesValidateRequest",
}) as any as S.Schema<PrefixesValidateRequest>;

/** Unwrapped `result` payload of the Cloudflare v4 response envelope. */
export interface PrefixesValidateResponse {
  /** Identifier of an IP Prefix. */
  id?: string | null;
  /** Identifier of a Cloudflare account. */
  accountId?: string | null;
...
export const PrefixesValidateResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.optional(S.NullOr(S.String)),
    accountId: S.optional(S.NullOr(S.String).pipe(T.Body("account_id"))),
    deprecatedadvertised: S.optional(
  ...
  identifier: "PrefixesValidateResponse",
}) as any as S.Schema<PrefixesValidateResponse>;
...
export type AddressMapsAccountsUpdateResponsePointer = "pointer";
export const AddressMapsAccountsUpdateResponsePointer = /*@__PURE__*/ S.String;

export type AddressMapsAccountsUpdateResponsePointer2 = "pointer";
export const AddressMapsAccountsUpdateResponsePointer2 = /*@__PURE__*/ S.String;

export type AddressMapsAccountsUpdateResponseTotalPages = 100;
export const AddressMapsAccountsUpdateResponseTotalPages =
  /*@__PURE__*/ S.Number;
...
export interface AddressMapsAccountsUpdateResponse {
  ...
  source: unknown;
  /** } */
  pointer: AddressMapsAccountsUpdateResponsePointer;
  code_2: unknown;
  message_2: unknown;
  documentation_url_2: unknown;
  source_2: unknown;
  /** } */
  pointer_2: AddressMapsAccountsUpdateResponsePointer2;
  count: unknown;
  page: unknown;
  perPage: unknown;
  totalCount: unknown;
  /** } */
  totalPages: AddressMapsAccountsUpdateResponseTotalPages;
}
export const AddressMapsAccountsUpdateResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    documentation_url_2: S.Unknown.pipe(T.Body("documentation_url")),
    source_2: S.Unknown.pipe(T.Body("source")),
    pointer_2: AddressMapsAccountsUpdateResponsePointer2.pipe(
      T.Body("pointer"),
    ),
    count: S.Unknown,
    page: S.Unknown,
    perPage: S.Unknown.pipe(T.Body("per_page")),
    totalCount: S.Unknown.pipe(T.Body("total_count")),
    totalPages: AddressMapsAccountsUpdateResponseTotalPages.pipe(
      T.Body("total_pages"),
    ),
  }).pipe(T.KeyDictionary(KEY_DICTIONARY)),
).annotate({
...
export type AddressMapsIpsUpdateResponsePointer = "pointer";
export const AddressMapsIpsUpdateResponsePointer = /*@__PURE__*/ S.String;

export type AddressMapsIpsUpdateResponsePointer2 = "pointer";
export const AddressMapsIpsUpdateResponsePointer2 = /*@__PURE__*/ S.String;

export type AddressMapsIpsUpdateResponseTotalPages = 100;
export const AddressMapsIpsUpdateResponseTotalPages = /*@__PURE__*/ S.Number;
...
export interface AddressMapsIpsUpdateResponse {
  ...
  source: unknown;
  /** } */
  pointer: AddressMapsIpsUpdateResponsePointer;
  code_2: unknown;
  message_2: unknown;
  documentation_url_2: unknown;
  source_2: unknown;
  /** } */
  pointer_2: AddressMapsIpsUpdateResponsePointer2;
  count: unknown;
  page: unknown;
  perPage: unknown;
  totalCount: unknown;
  /** } */
  totalPages: AddressMapsIpsUpdateResponseTotalPages;
}
export const AddressMapsIpsUpdateResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    documentation_url_2: S.Unknown.pipe(T.Body("documentation_url")),
    source_2: S.Unknown.pipe(T.Body("source")),
    pointer_2: AddressMapsIpsUpdateResponsePointer2.pipe(T.Body("pointer")),
    count: S.Unknown,
    page: S.Unknown,
    perPage: S.Unknown.pipe(T.Body("per_page")),
    totalCount: S.Unknown.pipe(T.Body("total_count")),
    totalPages: AddressMapsIpsUpdateResponseTotalPages.pipe(
      T.Body("total_pages"),
    ),
  }).pipe(T.KeyDictionary(KEY_DICTIONARY)),
).annotate({
...
export type AddressMapsZonesUpdateResponsePointer = "pointer";
export const AddressMapsZonesUpdateResponsePointer = /*@__PURE__*/ S.String;

export type AddressMapsZonesUpdateResponsePointer2 = "pointer";
export const AddressMapsZonesUpdateResponsePointer2 = /*@__PURE__*/ S.String;

export type AddressMapsZonesUpdateResponseTotalPages = 100;
export const AddressMapsZonesUpdateResponseTotalPages = /*@__PURE__*/ S.Number;
...
export interface AddressMapsZonesUpdateResponse {
  ...
  source: unknown;
  /** } */
  pointer: AddressMapsZonesUpdateResponsePointer;
  code_2: unknown;
  message_2: unknown;
  documentation_url_2: unknown;
  source_2: unknown;
  /** } */
  pointer_2: AddressMapsZonesUpdateResponsePointer2;
  count: unknown;
  page: unknown;
  perPage: unknown;
  totalCount: unknown;
  /** } */
  totalPages: AddressMapsZonesUpdateResponseTotalPages;
}
export const AddressMapsZonesUpdateResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    documentation_url_2: S.Unknown.pipe(T.Body("documentation_url")),
    source_2: S.Unknown.pipe(T.Body("source")),
    pointer_2: AddressMapsZonesUpdateResponsePointer2.pipe(T.Body("pointer")),
    count: S.Unknown,
    page: S.Unknown,
    perPage: S.Unknown.pipe(T.Body("per_page")),
    totalCount: S.Unknown.pipe(T.Body("total_count")),
    totalPages: AddressMapsZonesUpdateResponseTotalPages.pipe(
      T.Body("total_pages"),
    ),
  }).pipe(T.KeyDictionary(KEY_DICTIONARY)),
).annotate({
...
export type PrefixesValidateError = CloudflareOpError;
/** Triggers a new prefix validation. The checks are run asynchronously and include IRR, RPKI, and prefix ownership. */
export const prefixesValidate: API.OperationMethod<
  PrefixesValidateRequest,
  PrefixesValidateResponse,
  PrefixesValidateError,
  CloudflareOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: PrefixesValidateRequest,
  output: PrefixesValidateResponse,
  errors: [CloudflareRateLimited, CloudflareError],
  protocol: CloudflareProtocol,
  retry: Retry.Retry,
}));
