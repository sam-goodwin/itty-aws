...
// Input Schema
export const PatchV1DatabasesByDatabaseIdInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const PatchV1DatabasesByDatabaseIdOutput = /*@__PURE__*/ Schema.Struct({
  data: Schema.Struct({
    id: Schema.String,
    type: Schema.String,
    url: Schema.String,
 ...
 */
export const patchV1DatabasesByDatabaseId = /*@__PURE__*/ API.make(() => ({
