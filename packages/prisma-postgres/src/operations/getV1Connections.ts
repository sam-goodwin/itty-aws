...
// Input Schema
export const GetV1ConnectionsInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const GetV1ConnectionsOutput = /*@__PURE__*/ Schema.Struct({
  data: Schema.Array(
    Schema.Struct({
      id: Schema.String,
      type: Schema.String,
 ...
 */
export const getV1Connections = /*@__PURE__*/ API.make(() => ({
