...
// Input Schema
export const PostV1VersionsInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const PostV1VersionsOutput = /*@__PURE__*/ Schema.Struct({
  data: Schema.Struct({
    id: Schema.String,
    type: Schema.String,
    url: Schema.String,
 ...
 */
export const postV1Versions = /*@__PURE__*/ API.make(() => ({
