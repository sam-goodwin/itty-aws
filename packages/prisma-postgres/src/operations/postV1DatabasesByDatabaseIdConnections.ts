...
// Input Schema
export const PostV1DatabasesByDatabaseIdConnectionsInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
// Output Schema
export const PostV1DatabasesByDatabaseIdConnectionsOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  data: Schema.Struct({
    id: Schema.String,
    type: Schema.String,
    url: Schema.String,
 ...
 */
export const postV1DatabasesByDatabaseIdConnections = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
