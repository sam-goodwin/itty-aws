...
// Input Schema
export const DeleteV1WorkspacesByWorkspaceIdIntegrationsByClientIdInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  clientId: Schema.String.pipe(T.PathParam()),
  workspaceId: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "DELETE", path: "/v1/workspaces/{workspaceId}/integrations/{clientId}" }));
...
// Output Schema
export const DeleteV1WorkspacesByWorkspaceIdIntegrationsByClientIdOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
 ...
 */
export const deleteV1WorkspacesByWorkspaceIdIntegrationsByClientId = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
