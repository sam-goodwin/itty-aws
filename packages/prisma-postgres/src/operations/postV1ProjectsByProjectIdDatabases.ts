...
// Input Schema
export const PostV1ProjectsByProjectIdDatabasesInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
// Output Schema
export const PostV1ProjectsByProjectIdDatabasesOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  data: Schema.Struct({
    id: Schema.String,
    type: Schema.String,
    url: Schema.String,
 ...
 */
export const postV1ProjectsByProjectIdDatabases = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
