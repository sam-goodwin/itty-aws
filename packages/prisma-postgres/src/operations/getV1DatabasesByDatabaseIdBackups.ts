...
// Input Schema
export const GetV1DatabasesByDatabaseIdBackupsInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
// Output Schema
export const GetV1DatabasesByDatabaseIdBackupsOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
 ...
 */
export const getV1DatabasesByDatabaseIdBackups = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
