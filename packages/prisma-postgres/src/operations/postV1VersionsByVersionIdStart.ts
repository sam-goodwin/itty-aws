...
// Input Schema
export const PostV1VersionsByVersionIdStartInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const PostV1VersionsByVersionIdStartOutput = /*@__PURE__*/ Schema.Struct(
  {
    data: Schema.Struct({
 ...
 */
export const postV1VersionsByVersionIdStart = /*@__PURE__*/ API.make(() => ({
