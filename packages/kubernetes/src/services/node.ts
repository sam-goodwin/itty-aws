...
// Input Schema
export const CreateNodeV1RuntimeClassInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const CreateNodeV1RuntimeClassOutput = /*@__PURE__*/ Schema.Struct({
 ...
 * @param dryRun - When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
 */
export const deleteNodeV1CollectionRuntimeClass = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const DeleteNodeV1RuntimeClassInput = /*@__PURE__*/ Schema.Struct({
  dryRun: Schema.optional(Schema.String),
}).pipe(
  T.Http({
    method: "DELETE",
...
// Output Schema
export const DeleteNodeV1RuntimeClassOutput = /*@__PURE__*/ Schema.Struct({
  apiVersion: Schema.optional(Schema.String),
  code: Schema.optional(Schema.Number),
  details: Schema.optional(
    Schema.Struct({
...
// Input Schema
export const GetNodeV1APIResourcesInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({ method: "GET", path: "/apis/node.k8s.io/v1/" }),
);
export type GetNodeV1APIResourcesInput = typeof GetNodeV1APIResourcesInput.Type;

// Output Schema
export const GetNodeV1APIResourcesOutput = /*@__PURE__*/ Schema.Struct({
  apiVersion: Schema.optional(Schema.String),
  groupVersion: Schema.String,
  kind: Schema.optional(Schema.String),
...
// Input Schema
export const ListNodeV1RuntimeClassInput = /*@__PURE__*/ Schema.Struct({}).pipe(
...
// Output Schema
export const ListNodeV1RuntimeClassOutput = /*@__PURE__*/ Schema.Struct({
  apiVersion: Schema.optional(Schema.String),
  items: Schema.Array(
    Schema.Struct({
      apiVersion: Schema.optional(Schema.String),
...
// Input Schema
export const PatchNodeV1RuntimeClassInput = /*@__PURE__*/ Schema.Struct({
  dryRun: Schema.optional(Schema.String),
  fieldValidation: Schema.optional(Schema.String),
}).pipe(
  T.Http({
...
// Output Schema
export const PatchNodeV1RuntimeClassOutput = /*@__PURE__*/ Schema.Struct({
  apiVersion: Schema.optional(Schema.String),
  handler: Schema.String,
  kind: Schema.optional(Schema.String),
  metadata: Schema.optional(
...
// Input Schema
export const ReadNodeV1RuntimeClassInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({ method: "GET", path: "/apis/node.k8s.io/v1/runtimeclasses/{name}" }),
);
export type ReadNodeV1RuntimeClassInput =
  typeof ReadNodeV1RuntimeClassInput.Type;

// Output Schema
export const ReadNodeV1RuntimeClassOutput = /*@__PURE__*/ Schema.Struct({
  apiVersion: Schema.optional(Schema.String),
  handler: Schema.String,
  kind: Schema.optional(Schema.String),
  metadata: Schema.optional(
...
// Input Schema
export const ReplaceNodeV1RuntimeClassInput = /*@__PURE__*/ Schema.Struct({
  dryRun: Schema.optional(Schema.String),
  fieldValidation: Schema.optional(Schema.String),
}).pipe(
  T.Http({ method: "PUT", path: "/apis/node.k8s.io/v1/runtimeclasses/{name}" }),
);
export type ReplaceNodeV1RuntimeClassInput =
  typeof ReplaceNodeV1RuntimeClassInput.Type;

// Output Schema
export const ReplaceNodeV1RuntimeClassOutput = /*@__PURE__*/ Schema.Struct({
  apiVersion: Schema.optional(Schema.String),
  handler: Schema.String,
  kind: Schema.optional(Schema.String),
  metadata: Schema.optional(
...
// Input Schema
export const WatchNodeV1RuntimeClassInput = /*@__PURE__*/ Schema.Struct(
  {},
).pipe(
  T.Http({
    method: "GET",
...
// Output Schema
export const WatchNodeV1RuntimeClassOutput = /*@__PURE__*/ Schema.Struct({
...
// Input Schema
export const WatchNodeV1RuntimeClassListInput = /*@__PURE__*/ Schema.Struct(
  {},
).pipe(
  T.Http({ method: "GET", path: "/apis/node.k8s.io/v1/watch/runtimeclasses" }),
);
export type WatchNodeV1RuntimeClassListInput =
  typeof WatchNodeV1RuntimeClassListInput.Type;

// Output Schema
export const WatchNodeV1RuntimeClassListOutput = /*@__PURE__*/ Schema.Struct({
  object: Schema.Unknown,
  type: Schema.String,
});
