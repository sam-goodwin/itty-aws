...
// Input Schema
export const CreateSchedulingV1PriorityClassInput = /*@__PURE__*/ Schema.Struct(
  {
 ...
 */
export const createSchedulingV1PriorityClass = /*@__PURE__*/ API.make(() => ({
 ...
 * @param dryRun - When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
 */
export const deleteSchedulingV1CollectionPriorityClass = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const DeleteSchedulingV1PriorityClassInput = /*@__PURE__*/ Schema.Struct(
  {
    dryRun: Schema.optional(Schema.String),
  },
).pipe(
 ...
 * @param dryRun - When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
 */
export const deleteSchedulingV1PriorityClass = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const GetSchedulingAPIGroupInput = /*@__PURE__*/ Schema.Struct({}).pipe(
...
// Output Schema
export const GetSchedulingAPIGroupOutput = /*@__PURE__*/ Schema.Struct({
  apiVersion: Schema.optional(Schema.String),
  kind: Schema.optional(Schema.String),
  name: Schema.String,
 ...
 */
export const getSchedulingAPIGroup = /*@__PURE__*/ API.make(() => ({
  inputSchema: GetSchedulingAPIGroupInput,
  outputSchema: GetSchedulingAPIGroupOutput,
}));
// Input Schema
export const GetSchedulingV1APIResourcesInput = /*@__PURE__*/ Schema.Struct(
  {},
).pipe(T.Http({ method: "GET", path: "/apis/scheduling.k8s.io/v1/" }));
export type GetSchedulingV1APIResourcesInput =
  typeof GetSchedulingV1APIResourcesInput.Type;

// Output Schema
export const GetSchedulingV1APIResourcesOutput = /*@__PURE__*/ Schema.Struct({
  apiVersion: Schema.optional(Schema.String),
  groupVersion: Schema.String,
  kind: Schema.optional(Schema.String),
 ...
 */
export const getSchedulingV1APIResources = /*@__PURE__*/ API.make(() => ({
 ...
 * get available resources
 */
export const getSchedulingV1alpha2APIResources = /*@__PURE__*/ API.make(() => ({
  inputSchema: GetSchedulingV1alpha2APIResourcesInput,
  outputSchema: GetSchedulingV1alpha2APIResourcesOutput,
}));
// Input Schema
export const ListSchedulingV1PriorityClassInput = /*@__PURE__*/ Schema.Struct(
  {},
).pipe(
  T.Http({ method: "GET", path: "/apis/scheduling.k8s.io/v1/priorityclasses" }),
);
export type ListSchedulingV1PriorityClassInput =
  typeof ListSchedulingV1PriorityClassInput.Type;

// Output Schema
export const ListSchedulingV1PriorityClassOutput = /*@__PURE__*/ Schema.Struct({
  apiVersion: Schema.optional(Schema.String),
  items: Schema.Array(
    Schema.Struct({
      apiVersion: Schema.optional(Schema.String),
 ...
 */
export const listSchedulingV1PriorityClass = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const listSchedulingV1alpha2NamespacedPodGroup = /*@__PURE__*/ API.make(
  () => ({
 ...
 */
export const listSchedulingV1alpha2NamespacedWorkload = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const PatchSchedulingV1PriorityClassInput = /*@__PURE__*/ Schema.Struct({
  dryRun: Schema.optional(Schema.String),
  fieldValidation: Schema.optional(Schema.String),
}).pipe(
  T.Http({
...
// Output Schema
export const PatchSchedulingV1PriorityClassOutput = /*@__PURE__*/ Schema.Struct(
  {
    apiVersion: Schema.optional(Schema.String),
    description: Schema.optional(Schema.String),
    globalDefault: Schema.optional(Schema.Boolean),
 ...
 * @param fieldValidation - fieldValidation instructs the server on how to handle objects in the request (POST/PUT/PATCH) containing unknown or duplicate fields. Valid values are: - Ignore: This will ignore any unknown fields that are silently dropped from the object, and will ignore all but the last duplicate field that the decoder encounters. This is the default behavior prior to v1.23. - Warn: This will send a warning via the standard warning response header for each unknown field that is dropped from the object, and for each duplicate field that is encountered. The request will still succeed if there are no other errors, and will only persist the last of any duplicate fields. This is the default in v1.23+ - Strict: This will fail the request with a BadRequest error if any unknown fields would be dropped from the object, or if any duplicate fields are present. The error returned from the server will contain all unknown and duplicate fields encountered.
 */
export const patchSchedulingV1PriorityClass = /*@__PURE__*/ API.make(() => ({
 ...
 * @param fieldValidation - fieldValidation instructs the server on how to handle objects in the request (POST/PUT/PATCH) containing unknown or duplicate fields. Valid values are: - Ignore: This will ignore any unknown fields that are silently dropped from the object, and will ignore all but the last duplicate field that the decoder encounters. This is the default behavior prior to v1.23. - Warn: This will send a warning via the standard warning response header for each unknown field that is dropped from the object, and for each duplicate field that is encountered. The request will still succeed if there are no other errors, and will only persist the last of any duplicate fields. This is the default in v1.23+ - Strict: This will fail the request with a BadRequest error if any unknown fields would be dropped from the object, or if any duplicate fields are present. The error returned from the server will contain all unknown and duplicate fields encountered.
 */
export const patchSchedulingV1alpha2NamespacedPodGroup = /*@__PURE__*/ API.make(
  () => ({
 ...
 * @param fieldValidation - fieldValidation instructs the server on how to handle objects in the request (POST/PUT/PATCH) containing unknown or duplicate fields. Valid values are: - Ignore: This will ignore any unknown fields that are silently dropped from the object, and will ignore all but the last duplicate field that the decoder encounters. This is the default behavior prior to v1.23. - Warn: This will send a warning via the standard warning response header for each unknown field that is dropped from the object, and for each duplicate field that is encountered. The request will still succeed if there are no other errors, and will only persist the last of any duplicate fields. This is the default in v1.23+ - Strict: This will fail the request with a BadRequest error if any unknown fields would be dropped from the object, or if any duplicate fields are present. The error returned from the server will contain all unknown and duplicate fields encountered.
 */
export const patchSchedulingV1alpha2NamespacedWorkload = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const ReadSchedulingV1PriorityClassInput = /*@__PURE__*/ Schema.Struct(
  {},
).pipe(
  T.Http({
    method: "GET",
...
// Output Schema
export const ReadSchedulingV1PriorityClassOutput = /*@__PURE__*/ Schema.Struct({
  apiVersion: Schema.optional(Schema.String),
  description: Schema.optional(Schema.String),
  globalDefault: Schema.optional(Schema.Boolean),
  kind: Schema.optional(Schema.String),
 ...
 */
export const readSchedulingV1PriorityClass = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const readSchedulingV1alpha2NamespacedPodGroup = /*@__PURE__*/ API.make(
  () => ({
 ...
 */
export const readSchedulingV1alpha2NamespacedWorkload = /*@__PURE__*/ API.make(
  () => ({
 ...
 * @param fieldValidation - fieldValidation instructs the server on how to handle objects in the request (POST/PUT/PATCH) containing unknown or duplicate fields. Valid values are: - Ignore: This will ignore any unknown fields that are silently dropped from the object, and will ignore all but the last duplicate field that the decoder encounters. This is the default behavior prior to v1.23. - Warn: This will send a warning via the standard warning response header for each unknown field that is dropped from the object, and for each duplicate field that is encountered. The request will still succeed if there are no other errors, and will only persist the last of any duplicate fields. This is the default in v1.23+ - Strict: This will fail the request with a BadRequest error if any unknown fields would be dropped from the object, or if any duplicate fields are present. The error returned from the server will contain all unknown and duplicate fields encountered.
 */
export const replaceSchedulingV1PriorityClass = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const WatchSchedulingV1PriorityClassInput = /*@__PURE__*/ Schema.Struct(
  {},
).pipe(
  T.Http({
    method: "GET",
...
// Output Schema
export const WatchSchedulingV1PriorityClassOutput = /*@__PURE__*/ Schema.Struct(
  {
 ...
 */
export const watchSchedulingV1PriorityClass = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const watchSchedulingV1PriorityClassList = /*@__PURE__*/ API.make(
  () => ({
 ...
 */
export const watchSchedulingV1alpha2NamespacedPodGroup = /*@__PURE__*/ API.make(
  () => ({
 ...
 */
export const watchSchedulingV1alpha2NamespacedWorkload = /*@__PURE__*/ API.make(
  () => ({
