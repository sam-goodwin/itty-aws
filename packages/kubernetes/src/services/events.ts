...
// Input Schema
export const CreateEventsV1NamespacedEventInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const CreateEventsV1NamespacedEventOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const createEventsV1NamespacedEvent = /*@__PURE__*/ API.make(() => ({
 ...
 * @param dryRun - When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
 */
export const deleteEventsV1CollectionNamespacedEvent = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const DeleteEventsV1NamespacedEventInput = /*@__PURE__*/ Schema.Struct({
  dryRun: Schema.optional(Schema.String),
}).pipe(
  T.Http({
    method: "DELETE",
...
// Output Schema
export const DeleteEventsV1NamespacedEventOutput = /*@__PURE__*/ Schema.Struct({
  apiVersion: Schema.optional(Schema.String),
  code: Schema.optional(Schema.Number),
  details: Schema.optional(
    Schema.Struct({
 ...
 * @param dryRun - When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
 */
export const deleteEventsV1NamespacedEvent = /*@__PURE__*/ API.make(() => ({
...
// Output Schema
export const GetEventsAPIGroupOutput = /*@__PURE__*/ Schema.Struct({
  apiVersion: Schema.optional(Schema.String),
  kind: Schema.optional(Schema.String),
  name: Schema.String,
...
// Input Schema
export const GetEventsV1APIResourcesInput = /*@__PURE__*/ Schema.Struct(
  {},
).pipe(T.Http({ method: "GET", path: "/apis/events.k8s.io/v1/" }));
export type GetEventsV1APIResourcesInput =
  typeof GetEventsV1APIResourcesInput.Type;

// Output Schema
export const GetEventsV1APIResourcesOutput = /*@__PURE__*/ Schema.Struct({
  apiVersion: Schema.optional(Schema.String),
  groupVersion: Schema.String,
  kind: Schema.optional(Schema.String),
 ...
 */
export const listEventsV1EventForAllNamespaces = /*@__PURE__*/ API.make(() => ({
  inputSchema: ListEventsV1EventForAllNamespacesInput,
  outputSchema: ListEventsV1EventForAllNamespacesOutput,
}));
// Input Schema
export const ListEventsV1NamespacedEventInput = /*@__PURE__*/ Schema.Struct(
  {},
).pipe(
  T.Http({
    method: "GET",
...
// Output Schema
export const ListEventsV1NamespacedEventOutput = /*@__PURE__*/ Schema.Struct({
  apiVersion: Schema.optional(Schema.String),
  items: Schema.Array(
    Schema.Struct({
      action: Schema.optional(Schema.String),
...
// Input Schema
export const PatchEventsV1NamespacedEventInput = /*@__PURE__*/ Schema.Struct({
  dryRun: Schema.optional(Schema.String),
  fieldValidation: Schema.optional(Schema.String),
}).pipe(
  T.Http({
...
// Output Schema
export const PatchEventsV1NamespacedEventOutput = /*@__PURE__*/ Schema.Struct({
  action: Schema.optional(Schema.String),
  apiVersion: Schema.optional(Schema.String),
  deprecatedCount: Schema.optional(Schema.Number),
  deprecatedFirstTimestamp: Schema.optional(Schema.String),
 ...
 * @param fieldValidation - fieldValidation instructs the server on how to handle objects in the request (POST/PUT/PATCH) containing unknown or duplicate fields. Valid values are: - Ignore: This will ignore any unknown fields that are silently dropped from the object, and will ignore all but the last duplicate field that the decoder encounters. This is the default behavior prior to v1.23. - Warn: This will send a warning via the standard warning response header for each unknown field that is dropped from the object, and for each duplicate field that is encountered. The request will still succeed if there are no other errors, and will only persist the last of any duplicate fields. This is the default in v1.23+ - Strict: This will fail the request with a BadRequest error if any unknown fields would be dropped from the object, or if any duplicate fields are present. The error returned from the server will contain all unknown and duplicate fields encountered.
 */
export const patchEventsV1NamespacedEvent = /*@__PURE__*/ API.make(() => ({
  inputSchema: PatchEventsV1NamespacedEventInput,
  outputSchema: PatchEventsV1NamespacedEventOutput,
  errors: [NotFound, Conflict, UnprocessableEntity] as const,
}));
// Input Schema
export const ReadEventsV1NamespacedEventInput = /*@__PURE__*/ Schema.Struct(
  {},
).pipe(
  T.Http({
    method: "GET",
...
// Output Schema
export const ReadEventsV1NamespacedEventOutput = /*@__PURE__*/ Schema.Struct({
  action: Schema.optional(Schema.String),
  apiVersion: Schema.optional(Schema.String),
  deprecatedCount: Schema.optional(Schema.Number),
  deprecatedFirstTimestamp: Schema.optional(Schema.String),
...
// Input Schema
export const ReplaceEventsV1NamespacedEventInput = /*@__PURE__*/ Schema.Struct({
  dryRun: Schema.optional(Schema.String),
  fieldValidation: Schema.optional(Schema.String),
}).pipe(
  T.Http({
...
// Output Schema
export const ReplaceEventsV1NamespacedEventOutput = /*@__PURE__*/ Schema.Struct(
  {
    action: Schema.optional(Schema.String),
    apiVersion: Schema.optional(Schema.String),
    deprecatedCount: Schema.optional(Schema.Number),
 ...
 * @param fieldValidation - fieldValidation instructs the server on how to handle objects in the request (POST/PUT/PATCH) containing unknown or duplicate fields. Valid values are: - Ignore: This will ignore any unknown fields that are silently dropped from the object, and will ignore all but the last duplicate field that the decoder encounters. This is the default behavior prior to v1.23. - Warn: This will send a warning via the standard warning response header for each unknown field that is dropped from the object, and for each duplicate field that is encountered. The request will still succeed if there are no other errors, and will only persist the last of any duplicate fields. This is the default in v1.23+ - Strict: This will fail the request with a BadRequest error if any unknown fields would be dropped from the object, or if any duplicate fields are present. The error returned from the server will contain all unknown and duplicate fields encountered.
 */
export const replaceEventsV1NamespacedEvent = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const watchEventsV1EventListForAllNamespaces = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const WatchEventsV1NamespacedEventInput = /*@__PURE__*/ Schema.Struct(
  {},
).pipe(
  T.Http({
    method: "GET",
...
// Output Schema
export const WatchEventsV1NamespacedEventOutput = /*@__PURE__*/ Schema.Struct({
  object: Schema.Unknown,
  type: Schema.String,
});
 ...
 */
export const watchEventsV1NamespacedEvent = /*@__PURE__*/ API.make(() => ({
 ...
 * watch individual changes to a list of Event. deprecated: use the 'watch' parameter with a list operation instead.
 */
export const watchEventsV1NamespacedEventList = /*@__PURE__*/ API.make(() => ({
