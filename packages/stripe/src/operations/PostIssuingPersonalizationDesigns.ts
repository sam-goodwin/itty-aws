...
// Input Schema
export interface PostIssuingPersonalizationDesignsInput {
  card_logo?: string;
  carrier_text?: {
    footer_body?: string | "";
    footer_title?: string | "";
...
export const PostIssuingPersonalizationDesignsInput =
  ...
  ) as unknown as Schema.Codec<PostIssuingPersonalizationDesignsInput>;

// Output Schema
export interface PostIssuingPersonalizationDesignsOutput {
  card_logo:
    | string
    | {
        created: number;
...
export const PostIssuingPersonalizationDesignsOutput =
  ...
  }) as unknown as Schema.Codec<PostIssuingPersonalizationDesignsOutput>;
