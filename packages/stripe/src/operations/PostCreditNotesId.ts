...
// Input Schema
export interface PostCreditNotesIdInput {
  id: string;
  expand?: string[];
  memo?: string;
...
) as unknown as Schema.Codec<PostCreditNotesIdInput>;

// Output Schema
export interface PostCreditNotesIdOutput {
  amount: number;
...
export const PostCreditNotesIdOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    voided_at: Schema.NullOr(Schema.Number),
  }) as unknown as Schema.Codec<PostCreditNotesIdOutput>;
