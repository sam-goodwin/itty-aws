...
export type PostCreditNotesIdInput = typeof PostCreditNotesIdInput.Type;

// Output Schema
export const PostCreditNotesIdOutput = /*@__PURE__*/ Schema.Struct({
...
export type PostCreditNotesIdOutput = typeof PostCreditNotesIdOutput.Type;
