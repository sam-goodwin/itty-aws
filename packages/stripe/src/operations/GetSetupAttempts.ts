...
export const GetSetupAttemptsInput = /*@__PURE__*/ Schema.Struct({
...
export const GetSetupAttemptsOutput = /*@__PURE__*/ Schema.Struct({
  data: Schema.Array(
    Schema.Struct({
 ...
 */
export const GetSetupAttempts = /*@__PURE__*/ API.make(() => ({
