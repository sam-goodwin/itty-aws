...
// Input Schema
export interface PostInvoicesInvoiceRemoveLinesInput {
  invoice: string;
  expand?: string[];
...
export const PostInvoicesInvoiceRemoveLinesInput =
  ...
  ) as unknown as Schema.Codec<PostInvoicesInvoiceRemoveLinesInput>;

// Output Schema
export interface PostInvoicesInvoiceRemoveLinesOutput {
...
export const PostInvoicesInvoiceRemoveLinesOutput =
  ...
  }) as unknown as Schema.Codec<PostInvoicesInvoiceRemoveLinesOutput>;
