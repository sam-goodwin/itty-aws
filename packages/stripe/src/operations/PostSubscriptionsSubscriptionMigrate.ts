...
// Input Schema
export interface PostSubscriptionsSubscriptionMigrateInput {
  subscription: string;
  billing_mode: {
...
export const PostSubscriptionsSubscriptionMigrateInput =
  ...
  ) as unknown as Schema.Codec<PostSubscriptionsSubscriptionMigrateInput>;

// Output Schema
export interface PostSubscriptionsSubscriptionMigrateOutput {
  application:
    | string
...
export const PostSubscriptionsSubscriptionMigrateOutput =
  ...
  }) as unknown as Schema.Codec<PostSubscriptionsSubscriptionMigrateOutput>;
