...
// Input Schema
export interface PostTreasuryOutboundPaymentsIdCancelInput {
  id: string;
  expand?: string[];
}
export const PostTreasuryOutboundPaymentsIdCancelInput =
  ...
  ) as unknown as Schema.Codec<PostTreasuryOutboundPaymentsIdCancelInput>;

// Output Schema
export interface PostTreasuryOutboundPaymentsIdCancelOutput {
  amount: number;
  cancelable: boolean;
  created: number;
  currency: string;
...
export const PostTreasuryOutboundPaymentsIdCancelOutput =
  ...
  }) as unknown as Schema.Codec<PostTreasuryOutboundPaymentsIdCancelOutput>;
