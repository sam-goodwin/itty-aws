...
// Input Schema
export interface PostAccountsAccountCapabilitiesCapabilityInput {
  account: string;
  capability: string;
  expand?: string[];
  requested?: boolean;
...
export const PostAccountsAccountCapabilitiesCapabilityInput =
  ...
  ) as unknown as Schema.Codec<PostAccountsAccountCapabilitiesCapabilityInput>;

// Output Schema
export interface PostAccountsAccountCapabilitiesCapabilityOutput {
  account: unknown;
  future_requirements?: {
    alternatives:
...
export const PostAccountsAccountCapabilitiesCapabilityOutput =
  ...
  }) as unknown as Schema.Codec<PostAccountsAccountCapabilitiesCapabilityOutput>;
