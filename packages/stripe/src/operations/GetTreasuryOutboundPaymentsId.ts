...
// Input Schema
export const GetTreasuryOutboundPaymentsIdInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const GetTreasuryOutboundPaymentsIdOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const GetTreasuryOutboundPaymentsId = /*@__PURE__*/ API.make(() => ({
