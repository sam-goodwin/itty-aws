...
// Input Schema
export interface GetTreasuryOutboundPaymentsIdInput {
  id: string;
  expand?: string;
}
export const GetTreasuryOutboundPaymentsIdInput =
  ...
  ) as unknown as Schema.Codec<GetTreasuryOutboundPaymentsIdInput>;

// Output Schema
export interface GetTreasuryOutboundPaymentsIdOutput {
  amount: number;
  cancelable: boolean;
  created: number;
  currency: string;
...
export const GetTreasuryOutboundPaymentsIdOutput =
  ...
  }) as unknown as Schema.Codec<GetTreasuryOutboundPaymentsIdOutput>;
