...
// Input Schema
export interface PostTreasuryOutboundTransfersOutboundTransferCancelInput {
...
export const PostTreasuryOutboundTransfersOutboundTransferCancelInput =
  ...
  ) as unknown as Schema.Codec<PostTreasuryOutboundTransfersOutboundTransferCancelInput>;

// Output Schema
export interface PostTreasuryOutboundTransfersOutboundTransferCancelOutput {
  amount: number;
  cancelable: boolean;
  created: number;
  currency: string;
...
export const PostTreasuryOutboundTransfersOutboundTransferCancelOutput =
  ...
  }) as unknown as Schema.Codec<PostTreasuryOutboundTransfersOutboundTransferCancelOutput>;
