...
// Input Schema
export interface PostInvoiceitemsInvoiceitemInput {
  invoiceitem: string;
  amount?: number;
  description?: string;
...
export const PostInvoiceitemsInvoiceitemInput =
  ...
  ) as unknown as Schema.Codec<PostInvoiceitemsInvoiceitemInput>;

// Output Schema
export interface PostInvoiceitemsInvoiceitemOutput {
  amount: number;
  currency: string;
  customer: unknown;
...
export const PostInvoiceitemsInvoiceitemOutput =
  ...
  }) as unknown as Schema.Codec<PostInvoiceitemsInvoiceitemOutput>;
