...
// Input Schema
export const PostV2BillingMeterEventStreamInput = /*@__PURE__*/ Schema.Struct({
  events: Schema.Array(
    Schema.Struct({
...
// Output Schema
export const PostV2BillingMeterEventStreamOutput = /*@__PURE__*/ Schema.Struct(
  {},
);
 ...
 */
export const PostV2BillingMeterEventStream = /*@__PURE__*/ API.make(() => ({
