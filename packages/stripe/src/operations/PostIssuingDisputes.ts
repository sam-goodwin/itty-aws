...
// Input Schema
export interface PostIssuingDisputesInput {
  amount?: number;
  evidence?: {
    canceled?:
      | {
...
export const PostIssuingDisputesInput =
  ...
  ) as unknown as Schema.Codec<PostIssuingDisputesInput>;

// Output Schema
export interface PostIssuingDisputesOutput {
  amount: number;
...
export const PostIssuingDisputesOutput =
  ...
  }) as unknown as Schema.Codec<PostIssuingDisputesOutput>;
