...
// Input Schema
export const DeleteInvoiceitemsInvoiceitemInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const DeleteInvoiceitemsInvoiceitemOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const DeleteInvoiceitemsInvoiceitem = /*@__PURE__*/ API.make(() => ({
