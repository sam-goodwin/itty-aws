...
// Input Schema
export interface PostV2CoreAccountsIdCloseInput {
  id: string;
...
export const PostV2CoreAccountsIdCloseInput =
  /*@__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "POST", path: "/v2/core/accounts/{id}/close" }),
  ) as unknown as Schema.Codec<PostV2CoreAccountsIdCloseInput>;

// Output Schema
export interface PostV2CoreAccountsIdCloseOutput {
  applied_configurations: ("customer" | "merchant" | "recipient")[];
  closed?: boolean;
  configuration?: {
    customer?: {
...
export const PostV2CoreAccountsIdCloseOutput =
  ...
  }) as unknown as Schema.Codec<PostV2CoreAccountsIdCloseOutput>;
