...
// Input Schema
export interface GetIssuingTransactionsTransactionInput {
  transaction: string;
  expand?: string;
}
export const GetIssuingTransactionsTransactionInput =
  ...
  ) as unknown as Schema.Codec<GetIssuingTransactionsTransactionInput>;

// Output Schema
export interface GetIssuingTransactionsTransactionOutput {
  amount: number;
  amount_details: {
    atm_fee: number | null;
...
export const GetIssuingTransactionsTransactionOutput =
  ...
  }) as unknown as Schema.Codec<GetIssuingTransactionsTransactionOutput>;
