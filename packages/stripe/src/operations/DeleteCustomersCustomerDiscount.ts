...
// Input Schema
export interface DeleteCustomersCustomerDiscountInput {
  customer: string;
}
export const DeleteCustomersCustomerDiscountInput =
  ...
  ) as unknown as Schema.Codec<DeleteCustomersCustomerDiscountInput>;

// Output Schema
export interface DeleteCustomersCustomerDiscountOutput {
...
export const DeleteCustomersCustomerDiscountOutput =
  ...
  }) as unknown as Schema.Codec<DeleteCustomersCustomerDiscountOutput>;
