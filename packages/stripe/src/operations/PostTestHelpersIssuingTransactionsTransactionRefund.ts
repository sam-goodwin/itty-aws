...
// Input Schema
export interface PostTestHelpersIssuingTransactionsTransactionRefundInput {
  transaction: string;
  expand?: string[];
...
export const PostTestHelpersIssuingTransactionsTransactionRefundInput =
  ...
  ) as unknown as Schema.Codec<PostTestHelpersIssuingTransactionsTransactionRefundInput>;

// Output Schema
export interface PostTestHelpersIssuingTransactionsTransactionRefundOutput {
  amount: number;
  amount_details: {
    atm_fee: number | null;
...
export const PostTestHelpersIssuingTransactionsTransactionRefundOutput =
  ...
  }) as unknown as Schema.Codec<PostTestHelpersIssuingTransactionsTransactionRefundOutput>;
