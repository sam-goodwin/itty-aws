...
// Input Schema
export interface PostPaymentLinksPaymentLinkInput {
  payment_link: string;
  active?: boolean;
  after_completion?: {
...
export const PostPaymentLinksPaymentLinkInput =
  /*@__PURE__*/ Schema.Struct({
    ...
    inactive_message: Schema.optional(
    ...
    payment_intent_data: Schema.optional(
      Schema.Struct({
        ...
        statement_descriptor_suffix: Schema.optional(
          Schema.Union([Schema.String, Schema.Literals([""])]),
        ),
        transfer_group: Schema.optional(
          Schema.Union([Schema.String, Schema.Literals([""])]),
        ),
      }),
    ),
  ...
  ) as unknown as Schema.Codec<PostPaymentLinksPaymentLinkInput>;

// Output Schema
export interface PostPaymentLinksPaymentLinkOutput {
  active: boolean;
  after_completion: {
...
export const PostPaymentLinksPaymentLinkOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    url: Schema.String,
  }) as unknown as Schema.Codec<PostPaymentLinksPaymentLinkOutput>;
