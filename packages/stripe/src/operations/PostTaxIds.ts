...
// Input Schema
export interface PostTaxIdsInput {
  expand?: string[];
  owner?: {
    account?: string;
    customer?: string;
...
) as unknown as Schema.Codec<PostTaxIdsInput>;

// Output Schema
export interface PostTaxIdsOutput {
  country: string | null;
  created: number;
  customer: unknown;
...
}) as unknown as Schema.Codec<PostTaxIdsOutput>;
