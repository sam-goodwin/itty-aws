...
// Input Schema
export interface PostV2CoreAccountsAccountIdPersonsInput {
  account_id: string;
...
export const PostV2CoreAccountsAccountIdPersonsInput =
  ...
  ) as unknown as Schema.Codec<PostV2CoreAccountsAccountIdPersonsInput>;

// Output Schema
export interface PostV2CoreAccountsAccountIdPersonsOutput {
  account: string;
  additional_addresses?: {
    city?: string;
    country?: string;
...
export const PostV2CoreAccountsAccountIdPersonsOutput =
  ...
  }) as unknown as Schema.Codec<PostV2CoreAccountsAccountIdPersonsOutput>;
