...
// Input Schema
export interface PostBillingMetersIdReactivateInput {
  id: string;
  expand?: string[];
}
export const PostBillingMetersIdReactivateInput =
  ...
  ) as unknown as Schema.Codec<PostBillingMetersIdReactivateInput>;

// Output Schema
export interface PostBillingMetersIdReactivateOutput {
  created: number;
...
export const PostBillingMetersIdReactivateOutput =
  ...
  }) as unknown as Schema.Codec<PostBillingMetersIdReactivateOutput>;
