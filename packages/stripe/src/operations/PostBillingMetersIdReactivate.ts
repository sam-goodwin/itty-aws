...
// Input Schema
export const PostBillingMetersIdReactivateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const PostBillingMetersIdReactivateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const PostBillingMetersIdReactivate = /*@__PURE__*/ API.make(() => ({
