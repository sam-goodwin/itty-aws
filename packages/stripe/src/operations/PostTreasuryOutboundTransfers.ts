...
// Input Schema
export const PostTreasuryOutboundTransfersInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const PostTreasuryOutboundTransfersOutput = /*@__PURE__*/ Schema.Struct({
  amount: Schema.Number,
 ...
 */
export const PostTreasuryOutboundTransfers = /*@__PURE__*/ API.make(() => ({
