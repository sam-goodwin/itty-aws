...
// Input Schema
export interface PostTreasuryOutboundTransfersInput {
  amount: number;
  currency: string;
  description?: string;
...
export const PostTreasuryOutboundTransfersInput =
  ...
  ) as unknown as Schema.Codec<PostTreasuryOutboundTransfersInput>;

// Output Schema
export interface PostTreasuryOutboundTransfersOutput {
  amount: number;
  cancelable: boolean;
  created: number;
  currency: string;
...
export const PostTreasuryOutboundTransfersOutput =
  ...
  }) as unknown as Schema.Codec<PostTreasuryOutboundTransfersOutput>;
