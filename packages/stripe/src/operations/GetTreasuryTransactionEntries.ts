...
// Input Schema
export const GetTreasuryTransactionEntriesInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const GetTreasuryTransactionEntriesOutput = /*@__PURE__*/ Schema.Struct({
  data: Schema.Array(
    Schema.Struct({
 ...
 */
export const GetTreasuryTransactionEntries = /*@__PURE__*/ API.make(() => ({
