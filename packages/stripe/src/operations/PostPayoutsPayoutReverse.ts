...
// Input Schema
export interface PostPayoutsPayoutReverseInput {
  payout: string;
  expand?: string[];
...
export const PostPayoutsPayoutReverseInput =
  ...
  ) as unknown as Schema.Codec<PostPayoutsPayoutReverseInput>;

// Output Schema
export interface PostPayoutsPayoutReverseOutput {
  amount: number;
  application_fee:
    | string
    | {
...
export const PostPayoutsPayoutReverseOutput =
  ...
  }) as unknown as Schema.Codec<PostPayoutsPayoutReverseOutput>;
