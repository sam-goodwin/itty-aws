...
export const GetCountrySpecsInput = /*@__PURE__*/ Schema.Struct({
...
export const GetCountrySpecsOutput = /*@__PURE__*/ Schema.Struct({
  data: Schema.Array(
    Schema.Struct({
 ...
 */
export const GetCountrySpecs = /*@__PURE__*/ API.make(() => ({
