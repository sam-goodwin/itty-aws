...
// Input Schema
export interface GetTreasuryInboundTransfersIdInput {
  id: string;
  expand?: string;
}
export const GetTreasuryInboundTransfersIdInput =
  ...
  ) as unknown as Schema.Codec<GetTreasuryInboundTransfersIdInput>;

// Output Schema
export interface GetTreasuryInboundTransfersIdOutput {
  amount: number;
  cancelable: boolean;
  created: number;
  currency: string;
...
export const GetTreasuryInboundTransfersIdOutput =
  ...
  }) as unknown as Schema.Codec<GetTreasuryInboundTransfersIdOutput>;
