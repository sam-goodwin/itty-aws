...
// Input Schema
export const GetTreasuryInboundTransfersIdInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const GetTreasuryInboundTransfersIdOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const GetTreasuryInboundTransfersId = /*@__PURE__*/ API.make(() => ({
