...
// Input Schema
export const PostTaxRatesTaxRateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const PostTaxRatesTaxRateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const PostTaxRatesTaxRate = /*@__PURE__*/ API.make(() => ({
