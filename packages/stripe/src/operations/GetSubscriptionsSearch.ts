...
// Input Schema
export interface GetSubscriptionsSearchInput {
  expand?: string;
  limit?: number;
  page?: string;
  query: string;
...
export const GetSubscriptionsSearchInput =
  ...
  ) as unknown as Schema.Codec<GetSubscriptionsSearchInput>;

// Output Schema
export interface GetSubscriptionsSearchOutput {
  data: {
    application:
      | string
...
export const GetSubscriptionsSearchOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    url: Schema.String,
  }) as unknown as Schema.Codec<GetSubscriptionsSearchOutput>;
