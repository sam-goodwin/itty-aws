...
// Input Schema
export const GetSubscriptionsSearchInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const GetSubscriptionsSearchOutput = /*@__PURE__*/ Schema.Struct({
  data: Schema.Array(
    Schema.Struct({
 ...
 */
export const GetSubscriptionsSearch = /*@__PURE__*/ API.makePaginated(() => ({
