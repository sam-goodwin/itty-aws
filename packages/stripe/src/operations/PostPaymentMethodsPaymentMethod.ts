...
// Input Schema
export interface PostPaymentMethodsPaymentMethodInput {
...
export const PostPaymentMethodsPaymentMethodInput =
  ...
  ) as unknown as Schema.Codec<PostPaymentMethodsPaymentMethodInput>;

// Output Schema
export interface PostPaymentMethodsPaymentMethodOutput {
  acss_debit?: {
...
export const PostPaymentMethodsPaymentMethodOutput =
  ...
  }) as unknown as Schema.Codec<PostPaymentMethodsPaymentMethodOutput>;
