...
// Input Schema
export interface PostDisputesDisputeInput {
  dispute: string;
  evidence?: {
...
export const PostDisputesDisputeInput =
  /*@__PURE__*/ Schema.Struct({
    ...
    evidence: Schema.optional(
      Schema.Struct({
        ...
        enhanced_evidence: Schema.optional(
          Schema.Union([
            Schema.Struct({
              mastercard_compliance: Schema.optional(
                Schema.Struct({
                  fee_acknowledged: Schema.optional(Schema.Boolean),
                }),
              ),
              visa_compelling_evidence_3: Schema.optional(
                Schema.Struct({
                  disputed_transaction: Schema.optional(
                    Schema.Struct({
                      customer_account_id: Schema.optional(
                        Schema.Union([Schema.String, Schema.Literals([""])]),
                      ),
                      customer_device_fingerprint: Schema.optional(
                        Schema.Union([Schema.String, Schema.Literals([""])]),
                      ),
                      customer_device_id: Schema.optional(
                        Schema.Union([Schema.String, Schema.Literals([""])]),
                      ),
                      customer_email_address: Schema.optional(
                        Schema.Union([Schema.String, Schema.Literals([""])]),
                      ),
                      customer_purchase_ip: Schema.optional(
                        Schema.Union([Schema.String, Schema.Literals([""])]),
                      ),
                      merchandise_or_services: Schema.optional(
                      ...
                      shipping_address: Schema.optional(
                        Schema.Struct({
                          ...
                          line1: Schema.optional(
                            Schema.Union([
                              Schema.String,
                              Schema.Literals([""]),
                            ]),
                          ),
                          line2: Schema.optional(
                            Schema.Union([
                              Schema.String,
                              Schema.Literals([""]),
                            ]),
                  ...
                  prior_undisputed_transactions: Schema.optional(
                    Schema.Array(
                      Schema.Struct({
  ...
  ) as unknown as Schema.Codec<PostDisputesDisputeInput>;

// Output Schema
export interface PostDisputesDisputeOutput {
  amount: number;
...
export const PostDisputesDisputeOutput =
  ...
  }) as unknown as Schema.Codec<PostDisputesDisputeOutput>;
 ...
 */
export const PostDisputesDispute = /*@__PURE__*/ API.make(() => ({
