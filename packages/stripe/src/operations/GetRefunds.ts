...
// Input Schema
export interface GetRefundsInput {
  charge?: string;
  created?: string;
...
) as unknown as Schema.Codec<GetRefundsInput>;

// Output Schema
export interface GetRefundsOutput {
  data: {
    amount: number;
    balance_transaction:
      | string
...
export const GetRefundsOutput = /*@__PURE__*/ Schema.Struct({
  ...
  url: Schema.String,
}) as unknown as Schema.Codec<GetRefundsOutput>;
