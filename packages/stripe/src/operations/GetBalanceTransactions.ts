...
// Input Schema
export const GetBalanceTransactionsInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const GetBalanceTransactionsOutput = /*@__PURE__*/ Schema.Struct({
  data: Schema.Array(
    Schema.Struct({
 ...
 */
export const GetBalanceTransactions = /*@__PURE__*/ API.make(() => ({
