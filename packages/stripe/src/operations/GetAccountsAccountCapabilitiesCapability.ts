...
// Input Schema
export interface GetAccountsAccountCapabilitiesCapabilityInput {
  account: string;
  capability: string;
  expand?: string;
}
export const GetAccountsAccountCapabilitiesCapabilityInput =
  ...
  ) as unknown as Schema.Codec<GetAccountsAccountCapabilitiesCapabilityInput>;

// Output Schema
export interface GetAccountsAccountCapabilitiesCapabilityOutput {
  account: unknown;
  future_requirements?: {
    alternatives:
...
export const GetAccountsAccountCapabilitiesCapabilityOutput =
  ...
  }) as unknown as Schema.Codec<GetAccountsAccountCapabilitiesCapabilityOutput>;
