...
// Input Schema
export const GetChargesSearchInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const GetChargesSearchOutput = /*@__PURE__*/ Schema.Struct({
  data: Schema.Array(
    Schema.Struct({
 ...
 */
export const GetChargesSearch = /*@__PURE__*/ API.makePaginated(() => ({
