...
// Input Schema
export const PostClimateOrdersOrderCancelInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const PostClimateOrdersOrderCancelOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const PostClimateOrdersOrderCancel = /*@__PURE__*/ API.make(() => ({
