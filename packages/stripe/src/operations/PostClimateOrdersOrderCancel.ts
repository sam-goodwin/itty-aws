...
// Input Schema
export interface PostClimateOrdersOrderCancelInput {
  order: string;
  expand?: string[];
}
export const PostClimateOrdersOrderCancelInput =
  ...
  ) as unknown as Schema.Codec<PostClimateOrdersOrderCancelInput>;

// Output Schema
export interface PostClimateOrdersOrderCancelOutput {
  amount_fees: number;
...
export const PostClimateOrdersOrderCancelOutput =
  ...
  }) as unknown as Schema.Codec<PostClimateOrdersOrderCancelOutput>;
