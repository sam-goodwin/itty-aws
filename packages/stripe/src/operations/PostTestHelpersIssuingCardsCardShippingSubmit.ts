...
// Input Schema
export interface PostTestHelpersIssuingCardsCardShippingSubmitInput {
  card: string;
  expand?: string[];
}
export const PostTestHelpersIssuingCardsCardShippingSubmitInput =
  ...
  ) as unknown as Schema.Codec<PostTestHelpersIssuingCardsCardShippingSubmitInput>;

// Output Schema
export interface PostTestHelpersIssuingCardsCardShippingSubmitOutput {
  brand: string;
  cancellation_reason:
    | "design_rejected"
    | "fulfillment_error"
...
export const PostTestHelpersIssuingCardsCardShippingSubmitOutput =
  ...
  }) as unknown as Schema.Codec<PostTestHelpersIssuingCardsCardShippingSubmitOutput>;
