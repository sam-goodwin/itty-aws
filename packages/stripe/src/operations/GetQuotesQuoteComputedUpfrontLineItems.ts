...
// Input Schema
export interface GetQuotesQuoteComputedUpfrontLineItemsInput {
  quote: string;
...
export const GetQuotesQuoteComputedUpfrontLineItemsInput =
  ...
  ) as unknown as Schema.Codec<GetQuotesQuoteComputedUpfrontLineItemsInput>;

// Output Schema
export interface GetQuotesQuoteComputedUpfrontLineItemsOutput {
  data: {
    adjustable_quantity: {
      enabled: boolean;
      maximum: number | null;
...
export const GetQuotesQuoteComputedUpfrontLineItemsOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    url: Schema.String,
  }) as unknown as Schema.Codec<GetQuotesQuoteComputedUpfrontLineItemsOutput>;
