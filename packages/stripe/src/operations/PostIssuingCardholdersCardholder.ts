...
// Input Schema
export interface PostIssuingCardholdersCardholderInput {
  cardholder: string;
  billing?: {
    address: {
      city: string;
  ...
  spending_controls?: {
    allowed_card_presences?: ("not_present" | "present")[];
    allowed_categories?: (
    ...
    blocked_card_presences?: ("not_present" | "present")[];
    blocked_categories?: (
      | "ac_refrigeration_repair"
      | "accounting_bookkeeping_services"
      | "advertising_services"
...
export const PostIssuingCardholdersCardholderInput =
  /*@__PURE__*/ Schema.Struct({
    ...
    individual: Schema.optional(
      Schema.Struct({
        card_issuing: Schema.optional(
          Schema.Struct({
            user_terms_acceptance: Schema.optional(
              Schema.Struct({
    ...
    spending_controls: Schema.optional(
      Schema.Struct({
        ...
        blocked_merchant_countries: Schema.optional(
          Schema.Array(Schema.String),
        ),
        spending_limits: Schema.optional(
          Schema.Array(
            Schema.Struct({
        ...
        spending_limits_currency: Schema.optional(Schema.String),
      }),
    ),
  ...
  ) as unknown as Schema.Codec<PostIssuingCardholdersCardholderInput>;

// Output Schema
export interface PostIssuingCardholdersCardholderOutput {
  billing: {
    address: {
      city: string | null;
      country: string | null;
...
export const PostIssuingCardholdersCardholderOutput =
  ...
  }) as unknown as Schema.Codec<PostIssuingCardholdersCardholderOutput>;
