...
// Input Schema
export interface PostRefundsRefundCancelInput {
  refund: string;
  expand?: string[];
}
export const PostRefundsRefundCancelInput =
  ...
  ) as unknown as Schema.Codec<PostRefundsRefundCancelInput>;

// Output Schema
export interface PostRefundsRefundCancelOutput {
  amount: number;
  balance_transaction:
    | string
    | {
...
export const PostRefundsRefundCancelOutput =
  ...
  }) as unknown as Schema.Codec<PostRefundsRefundCancelOutput>;
