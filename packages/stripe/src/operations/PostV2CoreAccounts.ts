...
// Input Schema
export interface PostV2CoreAccountsInput {
...
export const PostV2CoreAccountsInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "POST", path: "/v2/core/accounts" }),
  ) as unknown as Schema.Codec<PostV2CoreAccountsInput>;

// Output Schema
export interface PostV2CoreAccountsOutput {
...
export const PostV2CoreAccountsOutput =
  ...
  }) as unknown as Schema.Codec<PostV2CoreAccountsOutput>;
