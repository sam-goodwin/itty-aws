...
// Input Schema
export const PostV2CoreAccountsInput = /*@__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "POST", path: "/v2/core/accounts" }));
export type PostV2CoreAccountsInput = typeof PostV2CoreAccountsInput.Type;

// Output Schema
export const PostV2CoreAccountsOutput = /*@__PURE__*/ Schema.Struct({
...
export type PostV2CoreAccountsOutput = typeof PostV2CoreAccountsOutput.Type;
