...
// Input Schema
export interface GetSourcesSourceInput {
  source: string;
  client_secret?: string;
  expand?: string;
}
export const GetSourcesSourceInput = /*@__PURE__*/ Schema.Struct({
...
) as unknown as Schema.Codec<GetSourcesSourceInput>;

// Output Schema
export interface GetSourcesSourceOutput {
  ach_credit_transfer?: {
...
export const GetSourcesSourceOutput = /*@__PURE__*/ Schema.Struct({
...
}) as unknown as Schema.Codec<GetSourcesSourceOutput>;
 ...
 */
export const GetSourcesSource = /*@__PURE__*/ API.make(() => ({
