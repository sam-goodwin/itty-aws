...
// Input Schema
export interface PostTestHelpersIssuingCardsCardShippingDeliverInput {
  card: string;
  expand?: string[];
}
export const PostTestHelpersIssuingCardsCardShippingDeliverInput =
  ...
  ) as unknown as Schema.Codec<PostTestHelpersIssuingCardsCardShippingDeliverInput>;

// Output Schema
export interface PostTestHelpersIssuingCardsCardShippingDeliverOutput {
  brand: string;
  cancellation_reason:
    | "design_rejected"
    | "fulfillment_error"
...
export const PostTestHelpersIssuingCardsCardShippingDeliverOutput =
  ...
  }) as unknown as Schema.Codec<PostTestHelpersIssuingCardsCardShippingDeliverOutput>;
