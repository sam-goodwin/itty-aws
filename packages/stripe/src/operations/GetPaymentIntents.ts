...
// Input Schema
export interface GetPaymentIntentsInput {
  created?: string;
  customer?: string;
...
) as unknown as Schema.Codec<GetPaymentIntentsInput>;

// Output Schema
export interface GetPaymentIntentsOutput {
  data: {
    amount: number;
...
export const GetPaymentIntentsOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    object: Schema.Literals(["list"]),
    url: Schema.String,
  }) as unknown as Schema.Codec<GetPaymentIntentsOutput>;
