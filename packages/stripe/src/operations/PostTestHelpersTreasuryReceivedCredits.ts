...
// Input Schema
export interface PostTestHelpersTreasuryReceivedCreditsInput {
  amount: number;
  currency: string;
  description?: string;
  expand?: string[];
...
export const PostTestHelpersTreasuryReceivedCreditsInput =
  ...
  ) as unknown as Schema.Codec<PostTestHelpersTreasuryReceivedCreditsInput>;

// Output Schema
export interface PostTestHelpersTreasuryReceivedCreditsOutput {
  amount: number;
  created: number;
  currency: string;
  description: string;
...
export const PostTestHelpersTreasuryReceivedCreditsOutput =
  ...
  }) as unknown as Schema.Codec<PostTestHelpersTreasuryReceivedCreditsOutput>;
