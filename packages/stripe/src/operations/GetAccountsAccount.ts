...
// Input Schema
export const GetAccountsAccountInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const GetAccountsAccountOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const GetAccountsAccount = /*@__PURE__*/ API.make(() => ({
