...
// Input Schema
export interface PostIdentityVerificationSessionsSessionInput {
  session: string;
  expand?: string[];
...
export const PostIdentityVerificationSessionsSessionInput =
  ...
  ) as unknown as Schema.Codec<PostIdentityVerificationSessionsSessionInput>;

// Output Schema
export interface PostIdentityVerificationSessionsSessionOutput {
...
export const PostIdentityVerificationSessionsSessionOutput =
  ...
  }) as unknown as Schema.Codec<PostIdentityVerificationSessionsSessionOutput>;
