...
// Input Schema
export interface PostBillingAlertsIdArchiveInput {
  id: string;
  expand?: string[];
}
export const PostBillingAlertsIdArchiveInput =
  ...
  ) as unknown as Schema.Codec<PostBillingAlertsIdArchiveInput>;

// Output Schema
export interface PostBillingAlertsIdArchiveOutput {
...
export const PostBillingAlertsIdArchiveOutput =
  ...
  }) as unknown as Schema.Codec<PostBillingAlertsIdArchiveOutput>;
