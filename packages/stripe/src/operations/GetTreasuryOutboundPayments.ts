...
// Input Schema
export const GetTreasuryOutboundPaymentsInput = /*@__PURE__*/ Schema.Struct({
  ...
  status: Schema.optional(
    Schema.Literals(["canceled", "failed", "posted", "processing", "returned"]),
  ),
}).pipe(
  T.Http({
    method: "GET",
...
// Output Schema
export const GetTreasuryOutboundPaymentsOutput = /*@__PURE__*/ Schema.Struct({
  data: Schema.Array(
    Schema.Struct({
