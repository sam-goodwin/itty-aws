...
// Input Schema
export interface GetTreasuryOutboundPaymentsInput {
  created?: string;
  customer?: string;
...
export const GetTreasuryOutboundPaymentsInput =
  ...
  ) as unknown as Schema.Codec<GetTreasuryOutboundPaymentsInput>;

// Output Schema
export interface GetTreasuryOutboundPaymentsOutput {
  data: {
    amount: number;
    cancelable: boolean;
    created: number;
...
export const GetTreasuryOutboundPaymentsOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    object: Schema.Literals(["list"]),
    url: Schema.String,
  }) as unknown as Schema.Codec<GetTreasuryOutboundPaymentsOutput>;
