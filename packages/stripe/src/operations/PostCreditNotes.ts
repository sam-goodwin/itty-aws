...
// Input Schema
export interface PostCreditNotesInput {
  amount?: number;
  ...
  lines?: {
    ...
    quantity?: number;
    tax_amounts?:
      | { amount: number; tax_rate: string; taxable_amount: number }[]
      | "";
    tax_rates?: string[] | "";
  ...
  refunds?: {
    ...
    payment_record_refund?: { payment_record: string; refund_group: string };
    refund?: string;
...
) as unknown as Schema.Codec<PostCreditNotesInput>;

// Output Schema
export interface PostCreditNotesOutput {
  amount: number;
...
export const PostCreditNotesOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  voided_at: Schema.NullOr(Schema.Number),
}) as unknown as Schema.Codec<PostCreditNotesOutput>;
