...
// Input Schema
export interface PostTestHelpersTreasuryOutboundPaymentsIdPostInput {
  id: string;
  expand?: string[];
}
export const PostTestHelpersTreasuryOutboundPaymentsIdPostInput =
  ...
  ) as unknown as Schema.Codec<PostTestHelpersTreasuryOutboundPaymentsIdPostInput>;

// Output Schema
export interface PostTestHelpersTreasuryOutboundPaymentsIdPostOutput {
  amount: number;
  cancelable: boolean;
  created: number;
  currency: string;
...
export const PostTestHelpersTreasuryOutboundPaymentsIdPostOutput =
  ...
  }) as unknown as Schema.Codec<PostTestHelpersTreasuryOutboundPaymentsIdPostOutput>;
