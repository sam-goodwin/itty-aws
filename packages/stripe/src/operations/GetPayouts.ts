...
) as unknown as Schema.Codec<GetPayoutsInput>;

// Output Schema
export interface GetPayoutsOutput {
  data: {
    amount: number;
    application_fee:
      | string
    ...
    method: string;
    object: "payout";
    original_payout: string | unknown | null;
    payout_method: string | null;
    reconciliation_status: "completed" | "in_progress" | "not_applicable";
    reversed_by: string | unknown | null;
    source_type: string;
...
export const GetPayoutsOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  data: Schema.Array(
    Schema.Struct({
      ...
      reversed_by: Schema.NullOr(Schema.Union([Schema.String, Schema.Unknown])),
  ...
  url: Schema.String,
}) as unknown as Schema.Codec<GetPayoutsOutput>;
