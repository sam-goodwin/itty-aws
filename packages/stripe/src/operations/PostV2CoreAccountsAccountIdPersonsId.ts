...
// Input Schema
export interface PostV2CoreAccountsAccountIdPersonsIdInput {
  account_id: string;
  id: string;
...
export const PostV2CoreAccountsAccountIdPersonsIdInput =
  ...
  ) as unknown as Schema.Codec<PostV2CoreAccountsAccountIdPersonsIdInput>;

// Output Schema
export interface PostV2CoreAccountsAccountIdPersonsIdOutput {
  account: string;
  additional_addresses?: {
    city?: string;
    country?: string;
...
export const PostV2CoreAccountsAccountIdPersonsIdOutput =
  ...
  }) as unknown as Schema.Codec<PostV2CoreAccountsAccountIdPersonsIdOutput>;
