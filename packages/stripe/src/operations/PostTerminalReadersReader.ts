...
// Input Schema
export interface PostTerminalReadersReaderInput {
  reader: string;
  expand?: string[];
  label?: string | "";
...
export const PostTerminalReadersReaderInput =
  ...
  ) as unknown as Schema.Codec<PostTerminalReadersReaderInput>;
...
export const PostTerminalReadersReaderOutput =
  ...
  ]) as unknown as Schema.Codec<PostTerminalReadersReaderOutput>;
