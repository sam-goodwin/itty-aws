...
// Input Schema
export interface GetTerminalReadersReaderInput {
  reader: string;
  expand?: string;
}
export const GetTerminalReadersReaderInput =
  ...
  ) as unknown as Schema.Codec<GetTerminalReadersReaderInput>;
...
export const GetTerminalReadersReaderOutput =
  ...
  ]) as unknown as Schema.Codec<GetTerminalReadersReaderOutput>;
