...
// Input Schema
export interface PostPaymentIntentsIntentConfirmInput {
  intent: string;
  amount_details?:
    | {
...
export const PostPaymentIntentsIntentConfirmInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    amount_to_confirm: Schema.optional(Schema.Number),
    ...
    mandate_data: Schema.optional(
      Schema.Union([
        ...
        Schema.Struct({
          customer_acceptance: Schema.Struct({
            online: Schema.Struct({
              ip_address: Schema.optional(Schema.String),
              user_agent: Schema.optional(Schema.String),
            }),
            type: Schema.Literals(["online"]),
          }),
        }),
      ]),
    ),
    off_session: Schema.optional(
      Schema.Union([Schema.Boolean, Schema.Literals(["one_off", "recurring"])]),
    ),
  ...
  ) as unknown as Schema.Codec<PostPaymentIntentsIntentConfirmInput>;

// Output Schema
export interface PostPaymentIntentsIntentConfirmOutput {
  amount: number;
...
export const PostPaymentIntentsIntentConfirmOutput =
  ...
  }) as unknown as Schema.Codec<PostPaymentIntentsIntentConfirmOutput>;
