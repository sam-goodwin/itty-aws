...
// Input Schema
export interface GetBillingPortalConfigurationsConfigurationInput {
...
export const GetBillingPortalConfigurationsConfigurationInput =
  ...
  ) as unknown as Schema.Codec<GetBillingPortalConfigurationsConfigurationInput>;

// Output Schema
export interface GetBillingPortalConfigurationsConfigurationOutput {
  active: boolean;
  application:
    | string
...
export const GetBillingPortalConfigurationsConfigurationOutput =
  ...
  }) as unknown as Schema.Codec<GetBillingPortalConfigurationsConfigurationOutput>;
