...
// Input Schema
export const PostSetupIntentsIntentConfirmInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const PostSetupIntentsIntentConfirmOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const PostSetupIntentsIntentConfirm = /*@__PURE__*/ API.make(() => ({
