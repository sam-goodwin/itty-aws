...
// Input Schema
export interface PostSetupIntentsIntentConfirmInput {
  intent: string;
...
export const PostSetupIntentsIntentConfirmInput =
  ...
  ) as unknown as Schema.Codec<PostSetupIntentsIntentConfirmInput>;

// Output Schema
export interface PostSetupIntentsIntentConfirmOutput {
  application:
    | string
...
export const PostSetupIntentsIntentConfirmOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    usage: Schema.String,
  }) as unknown as Schema.Codec<PostSetupIntentsIntentConfirmOutput>;
