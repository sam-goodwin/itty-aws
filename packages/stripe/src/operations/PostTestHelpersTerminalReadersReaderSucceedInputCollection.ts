...
// Input Schema
export interface PostTestHelpersTerminalReadersReaderSucceedInputCollectionInput {
  reader: string;
  expand?: string[];
...
export const PostTestHelpersTerminalReadersReaderSucceedInputCollectionInput =
  ...
  ) as unknown as Schema.Codec<PostTestHelpersTerminalReadersReaderSucceedInputCollectionInput>;

// Output Schema
export interface PostTestHelpersTerminalReadersReaderSucceedInputCollectionOutput {
  action: unknown;
...
export const PostTestHelpersTerminalReadersReaderSucceedInputCollectionOutput =
  ...
  }) as unknown as Schema.Codec<PostTestHelpersTerminalReadersReaderSucceedInputCollectionOutput>;
