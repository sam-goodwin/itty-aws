...
// Input Schema
export interface PostPayoutsInput {
  amount: number;
  currency: string;
  description?: string;
  destination?: string;
...
) as unknown as Schema.Codec<PostPayoutsInput>;

// Output Schema
export interface PostPayoutsOutput {
  amount: number;
  application_fee:
    | string
    | {
...
}) as unknown as Schema.Codec<PostPayoutsOutput>;
