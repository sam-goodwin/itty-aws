...
// Input Schema
export interface GetSubscriptionItemsItemInput {
  item: string;
  expand?: string;
}
export const GetSubscriptionItemsItemInput =
  ...
  ) as unknown as Schema.Codec<GetSubscriptionItemsItemInput>;

// Output Schema
export interface GetSubscriptionItemsItemOutput {
  billed_until?: number;
...
export const GetSubscriptionItemsItemOutput =
  ...
  }) as unknown as Schema.Codec<GetSubscriptionItemsItemOutput>;
