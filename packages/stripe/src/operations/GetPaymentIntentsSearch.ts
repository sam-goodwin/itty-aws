...
// Input Schema
export const GetPaymentIntentsSearchInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const GetPaymentIntentsSearchOutput = /*@__PURE__*/ Schema.Struct({
  data: Schema.Array(
    Schema.Struct({
 ...
 */
export const GetPaymentIntentsSearch = /*@__PURE__*/ API.makePaginated(() => ({
