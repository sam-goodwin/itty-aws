...
// Input Schema
export interface PostTopupsTopupCancelInput {
  topup: string;
  expand?: string[];
}
export const PostTopupsTopupCancelInput =
  ...
  ) as unknown as Schema.Codec<PostTopupsTopupCancelInput>;

// Output Schema
export interface PostTopupsTopupCancelOutput {
  amount: number;
  balance_transaction:
    | string
    | {
...
export const PostTopupsTopupCancelOutput =
  ...
  }) as unknown as Schema.Codec<PostTopupsTopupCancelOutput>;
