...
// Input Schema
export const GetV2CoreEventDestinationsIdInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const GetV2CoreEventDestinationsIdOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const GetV2CoreEventDestinationsId = /*@__PURE__*/ API.make(() => ({
