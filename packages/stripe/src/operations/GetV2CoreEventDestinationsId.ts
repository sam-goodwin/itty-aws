...
// Input Schema
export interface GetV2CoreEventDestinationsIdInput {
  id: string;
  include?: string;
}
export const GetV2CoreEventDestinationsIdInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "GET", path: "/v2/core/event_destinations/{id}" }),
  ) as unknown as Schema.Codec<GetV2CoreEventDestinationsIdInput>;

// Output Schema
export interface GetV2CoreEventDestinationsIdOutput {
  amazon_eventbridge?: {
...
export const GetV2CoreEventDestinationsIdOutput =
  ...
  }) as unknown as Schema.Codec<GetV2CoreEventDestinationsIdOutput>;
