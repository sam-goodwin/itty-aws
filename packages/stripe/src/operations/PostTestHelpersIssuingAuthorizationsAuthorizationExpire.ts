...
// Input Schema
export interface PostTestHelpersIssuingAuthorizationsAuthorizationExpireInput {
...
export const PostTestHelpersIssuingAuthorizationsAuthorizationExpireInput =
  ...
  ) as unknown as Schema.Codec<PostTestHelpersIssuingAuthorizationsAuthorizationExpireInput>;

// Output Schema
export interface PostTestHelpersIssuingAuthorizationsAuthorizationExpireOutput {
  amount: number;
  amount_details: {
    atm_fee: number | null;
...
export const PostTestHelpersIssuingAuthorizationsAuthorizationExpireOutput =
  ...
  }) as unknown as Schema.Codec<PostTestHelpersIssuingAuthorizationsAuthorizationExpireOutput>;
