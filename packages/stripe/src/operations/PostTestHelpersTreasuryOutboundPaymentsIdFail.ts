...
// Input Schema
export interface PostTestHelpersTreasuryOutboundPaymentsIdFailInput {
  id: string;
  expand?: string[];
}
export const PostTestHelpersTreasuryOutboundPaymentsIdFailInput =
  ...
  ) as unknown as Schema.Codec<PostTestHelpersTreasuryOutboundPaymentsIdFailInput>;

// Output Schema
export interface PostTestHelpersTreasuryOutboundPaymentsIdFailOutput {
  amount: number;
  cancelable: boolean;
  created: number;
  currency: string;
...
export const PostTestHelpersTreasuryOutboundPaymentsIdFailOutput =
  /*@__PURE__*/ Schema.Struct({
  ...
  }) as unknown as Schema.Codec<PostTestHelpersTreasuryOutboundPaymentsIdFailOutput>;
 ...
 */
export const PostTestHelpersTreasuryOutboundPaymentsIdFail =
  /*@__PURE__*/ API.make(() => ({
    inputSchema: PostTestHelpersTreasuryOutboundPaymentsIdFailInput,
    outputSchema: PostTestHelpersTreasuryOutboundPaymentsIdFailOutput,
  }));
