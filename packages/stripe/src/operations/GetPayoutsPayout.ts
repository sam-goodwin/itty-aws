...
// Input Schema
export interface GetPayoutsPayoutInput {
  payout: string;
  expand?: string;
}
export const GetPayoutsPayoutInput = /*@__PURE__*/ Schema.Struct({
...
) as unknown as Schema.Codec<GetPayoutsPayoutInput>;

// Output Schema
export interface GetPayoutsPayoutOutput {
  amount: number;
  application_fee:
    | string
    | {
...
export const GetPayoutsPayoutOutput = /*@__PURE__*/ Schema.Struct({
...
}) as unknown as Schema.Codec<GetPayoutsPayoutOutput>;
 ...
 */
export const GetPayoutsPayout = /*@__PURE__*/ API.make(() => ({
