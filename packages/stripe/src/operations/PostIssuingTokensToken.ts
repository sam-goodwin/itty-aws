...
// Input Schema
export interface PostIssuingTokensTokenInput {
  token: string;
  expand?: string[];
...
export const PostIssuingTokensTokenInput =
  ...
  ) as unknown as Schema.Codec<PostIssuingTokensTokenInput>;

// Output Schema
export interface PostIssuingTokensTokenOutput {
  card: unknown;
  created: number;
...
export const PostIssuingTokensTokenOutput =
  ...
  }) as unknown as Schema.Codec<PostIssuingTokensTokenOutput>;
