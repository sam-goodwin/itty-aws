...
// Input Schema
export interface GetTreasuryTransactionEntriesIdInput {
  id: string;
  expand?: string;
}
export const GetTreasuryTransactionEntriesIdInput =
  ...
  ) as unknown as Schema.Codec<GetTreasuryTransactionEntriesIdInput>;

// Output Schema
export interface GetTreasuryTransactionEntriesIdOutput {
  balance_impact: {
    cash: number;
...
export const GetTreasuryTransactionEntriesIdOutput =
  ...
  }) as unknown as Schema.Codec<GetTreasuryTransactionEntriesIdOutput>;
