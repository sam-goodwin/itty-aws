...
// Input Schema
export interface PostFinancialConnectionsSessionsInput {
  account_holder: {
    account?: string;
    customer?: string;
...
export const PostFinancialConnectionsSessionsInput =
  ...
  ) as unknown as Schema.Codec<PostFinancialConnectionsSessionsInput>;

// Output Schema
export interface PostFinancialConnectionsSessionsOutput {
  account_holder: {
    account?: unknown;
    customer?: unknown;
    customer_account?: string;
...
export const PostFinancialConnectionsSessionsOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    return_url: Schema.optional(Schema.String),
  }) as unknown as Schema.Codec<PostFinancialConnectionsSessionsOutput>;
