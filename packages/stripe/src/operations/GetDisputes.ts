...
// Input Schema
export interface GetDisputesInput {
  charge?: string;
  created?: string;
...
) as unknown as Schema.Codec<GetDisputesInput>;

// Output Schema
export interface GetDisputesOutput {
  data: {
    amount: number;
...
export const GetDisputesOutput = /*@__PURE__*/ Schema.Struct({
  ...
  object: Schema.Literals(["list"]),
  url: Schema.String,
}) as unknown as Schema.Codec<GetDisputesOutput>;
