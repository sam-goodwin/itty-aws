...
export type PostInvoicesInvoiceAddLinesInput =
  typeof PostInvoicesInvoiceAddLinesInput.Type;
...
export type PostInvoicesInvoiceAddLinesOutput =
  typeof PostInvoicesInvoiceAddLinesOutput.Type;
