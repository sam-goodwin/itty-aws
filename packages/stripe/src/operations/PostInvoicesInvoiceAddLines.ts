...
// Input Schema
export interface PostInvoicesInvoiceAddLinesInput {
  invoice: string;
  expand?: string[];
...
export const PostInvoicesInvoiceAddLinesInput =
  ...
  ) as unknown as Schema.Codec<PostInvoicesInvoiceAddLinesInput>;

// Output Schema
export interface PostInvoicesInvoiceAddLinesOutput {
...
export const PostInvoicesInvoiceAddLinesOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  }) as unknown as Schema.Codec<PostInvoicesInvoiceAddLinesOutput>;
 ...
 */
export const PostInvoicesInvoiceAddLines = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: PostInvoicesInvoiceAddLinesInput,
    outputSchema: PostInvoicesInvoiceAddLinesOutput,
  }),
);
