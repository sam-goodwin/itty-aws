...
// Input Schema
export interface PostPaymentMethodsPaymentMethodAttachInput {
...
export const PostPaymentMethodsPaymentMethodAttachInput =
  ...
  ) as unknown as Schema.Codec<PostPaymentMethodsPaymentMethodAttachInput>;

// Output Schema
export interface PostPaymentMethodsPaymentMethodAttachOutput {
  acss_debit?: {
...
export const PostPaymentMethodsPaymentMethodAttachOutput =
  ...
  }) as unknown as Schema.Codec<PostPaymentMethodsPaymentMethodAttachOutput>;
