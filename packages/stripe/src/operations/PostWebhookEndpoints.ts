...
// Input Schema
export interface PostWebhookEndpointsInput {
  api_version?:
    | "2011-01-01"
    | "2011-06-21"
    | "2011-06-28"
...
export const PostWebhookEndpointsInput =
  ...
  ) as unknown as Schema.Codec<PostWebhookEndpointsInput>;

// Output Schema
export interface PostWebhookEndpointsOutput {
...
export const PostWebhookEndpointsOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    url: Schema.String,
  }) as unknown as Schema.Codec<PostWebhookEndpointsOutput>;
 ...
 */
export const PostWebhookEndpoints = /*@__PURE__*/ API.make(() => ({
