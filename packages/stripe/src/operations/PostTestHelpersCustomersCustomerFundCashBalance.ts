...
// Input Schema
export interface PostTestHelpersCustomersCustomerFundCashBalanceInput {
  customer: string;
  amount: number;
  currency: string;
  expand?: string[];
...
export const PostTestHelpersCustomersCustomerFundCashBalanceInput =
  ...
  ) as unknown as Schema.Codec<PostTestHelpersCustomersCustomerFundCashBalanceInput>;

// Output Schema
export interface PostTestHelpersCustomersCustomerFundCashBalanceOutput {
...
export const PostTestHelpersCustomersCustomerFundCashBalanceOutput =
  ...
  }) as unknown as Schema.Codec<PostTestHelpersCustomersCustomerFundCashBalanceOutput>;
