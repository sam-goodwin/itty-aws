...
// Input Schema
export interface PostIssuingCardsInput {
  cardholder?: string;
  currency: string;
  exp_month?: number;
  exp_year?: number;
  ...
  lifecycle_controls?: { cancel_after: { payment_count: number } };
...
export const PostIssuingCardsInput = /*@__PURE__*/ Schema.Struct({
...
) as unknown as Schema.Codec<PostIssuingCardsInput>;

// Output Schema
export interface PostIssuingCardsOutput {
  brand: string;
  cancellation_reason:
    | "design_rejected"
    | "fulfillment_error"
...
export const PostIssuingCardsOutput = /*@__PURE__*/ Schema.Struct({
  brand: Schema.String,
  cancellation_reason: Schema.NullOr(
    Schema.Literals(["design_rejected", "fulfillment_error", "lost", "stolen"]),
  ),
...
}) as unknown as Schema.Codec<PostIssuingCardsOutput>;
 ...
 */
export const PostIssuingCards = /*@__PURE__*/ API.make(() => ({
