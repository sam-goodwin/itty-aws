...
// Input Schema
export interface PostIdentityVerificationSessionsInput {
  ...
  provided_details?: { email?: string; phone?: string };
...
export const PostIdentityVerificationSessionsInput =
  ...
  ) as unknown as Schema.Codec<PostIdentityVerificationSessionsInput>;

// Output Schema
export interface PostIdentityVerificationSessionsOutput {
...
export const PostIdentityVerificationSessionsOutput =
  ...
  }) as unknown as Schema.Codec<PostIdentityVerificationSessionsOutput>;
