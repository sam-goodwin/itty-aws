...
// Input Schema
export interface PostCheckoutSessionsSessionInput {
  session: string;
...
export const PostCheckoutSessionsSessionInput =
  ...
  ) as unknown as Schema.Codec<PostCheckoutSessionsSessionInput>;

// Output Schema
export interface PostCheckoutSessionsSessionOutput {
...
export const PostCheckoutSessionsSessionOutput =
  ...
  }) as unknown as Schema.Codec<PostCheckoutSessionsSessionOutput>;
