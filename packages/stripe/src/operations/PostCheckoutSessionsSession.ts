...
// Input Schema
export const PostCheckoutSessionsSessionInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const PostCheckoutSessionsSessionOutput = /*@__PURE__*/ Schema.Struct({
  ...
  customer_creation: Schema.NullOr(Schema.Literals(["always", "if_required"])),
