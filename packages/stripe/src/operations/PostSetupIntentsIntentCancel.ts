...
// Input Schema
export const PostSetupIntentsIntentCancelInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const PostSetupIntentsIntentCancelOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const PostSetupIntentsIntentCancel = /*@__PURE__*/ API.make(() => ({
