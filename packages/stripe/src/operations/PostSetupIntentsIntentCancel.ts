...
// Input Schema
export interface PostSetupIntentsIntentCancelInput {
  intent: string;
...
export const PostSetupIntentsIntentCancelInput =
  ...
  ) as unknown as Schema.Codec<PostSetupIntentsIntentCancelInput>;

// Output Schema
export interface PostSetupIntentsIntentCancelOutput {
  application:
    | string
...
export const PostSetupIntentsIntentCancelOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    usage: Schema.String,
  }) as unknown as Schema.Codec<PostSetupIntentsIntentCancelOutput>;
