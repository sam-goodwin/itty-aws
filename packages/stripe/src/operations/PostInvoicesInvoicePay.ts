...
export type PostInvoicesInvoicePayInput =
  typeof PostInvoicesInvoicePayInput.Type;
...
export type PostInvoicesInvoicePayOutput =
  typeof PostInvoicesInvoicePayOutput.Type;
