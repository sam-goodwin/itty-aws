...
// Input Schema
export interface PostInvoicesInvoicePayInput {
  invoice: string;
  expand?: string[];
  forgive?: boolean;
  mandate?: string | "";
...
export const PostInvoicesInvoicePayInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    paid_out_of_band: Schema.optional(Schema.Boolean),
  ...
  ) as unknown as Schema.Codec<PostInvoicesInvoicePayInput>;

// Output Schema
export interface PostInvoicesInvoicePayOutput {
...
export const PostInvoicesInvoicePayOutput =
  ...
  }) as unknown as Schema.Codec<PostInvoicesInvoicePayOutput>;
