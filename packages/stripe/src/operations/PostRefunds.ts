...
// Input Schema
export interface PostRefundsInput {
  amount?: number;
  charge?: string;
  currency?: string;
  customer?: string;
...
) as unknown as Schema.Codec<PostRefundsInput>;

// Output Schema
export interface PostRefundsOutput {
  amount: number;
  balance_transaction:
    | string
    | {
...
}) as unknown as Schema.Codec<PostRefundsOutput>;
