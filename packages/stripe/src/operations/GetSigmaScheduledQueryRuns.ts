...
// Input Schema
export interface GetSigmaScheduledQueryRunsInput {
...
export const GetSigmaScheduledQueryRunsInput =
  ...
  ) as unknown as Schema.Codec<GetSigmaScheduledQueryRunsInput>;

// Output Schema
export interface GetSigmaScheduledQueryRunsOutput {
  data: {
    created: number;
...
export const GetSigmaScheduledQueryRunsOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    object: Schema.Literals(["list"]),
    url: Schema.String,
  }) as unknown as Schema.Codec<GetSigmaScheduledQueryRunsOutput>;
