...
// Input Schema
export const PostBillingAlertsIdDeactivateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const PostBillingAlertsIdDeactivateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const PostBillingAlertsIdDeactivate = /*@__PURE__*/ API.make(() => ({
