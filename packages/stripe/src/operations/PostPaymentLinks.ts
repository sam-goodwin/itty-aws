...
export const PostPaymentLinksInput = /*@__PURE__*/ Schema.Struct({
...
export const PostPaymentLinksOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const PostPaymentLinks = /*@__PURE__*/ API.make(() => ({
