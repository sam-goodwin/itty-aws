...
// Input Schema
export interface PostPaymentLinksInput {
  after_completion?: {
...
) as unknown as Schema.Codec<PostPaymentLinksInput>;

// Output Schema
export interface PostPaymentLinksOutput {
  active: boolean;
  after_completion: {
...
) as unknown as Schema.Codec<PostPaymentLinksOutput>;
