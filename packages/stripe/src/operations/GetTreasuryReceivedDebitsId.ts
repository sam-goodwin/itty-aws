...
// Input Schema
export interface GetTreasuryReceivedDebitsIdInput {
  id: string;
  expand?: string;
}
export const GetTreasuryReceivedDebitsIdInput =
  ...
  ) as unknown as Schema.Codec<GetTreasuryReceivedDebitsIdInput>;

// Output Schema
export interface GetTreasuryReceivedDebitsIdOutput {
  amount: number;
  created: number;
  currency: string;
  description: string;
...
export const GetTreasuryReceivedDebitsIdOutput =
  ...
  }) as unknown as Schema.Codec<GetTreasuryReceivedDebitsIdOutput>;
 ...
 */
export const GetTreasuryReceivedDebitsId = /*@__PURE__*/ API.make(() => ({
