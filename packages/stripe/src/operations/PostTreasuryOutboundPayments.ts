...
// Input Schema
export const PostTreasuryOutboundPaymentsInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const PostTreasuryOutboundPaymentsOutput = /*@__PURE__*/ Schema.Struct({
  amount: Schema.Number,
 ...
 */
export const PostTreasuryOutboundPayments = /*@__PURE__*/ API.make(() => ({
