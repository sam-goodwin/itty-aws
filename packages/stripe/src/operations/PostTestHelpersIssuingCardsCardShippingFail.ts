...
// Input Schema
export interface PostTestHelpersIssuingCardsCardShippingFailInput {
  card: string;
  expand?: string[];
}
export const PostTestHelpersIssuingCardsCardShippingFailInput =
  ...
  ) as unknown as Schema.Codec<PostTestHelpersIssuingCardsCardShippingFailInput>;

// Output Schema
export interface PostTestHelpersIssuingCardsCardShippingFailOutput {
  brand: string;
  cancellation_reason:
    | "design_rejected"
    | "fulfillment_error"
...
export const PostTestHelpersIssuingCardsCardShippingFailOutput =
  ...
  }) as unknown as Schema.Codec<PostTestHelpersIssuingCardsCardShippingFailOutput>;
