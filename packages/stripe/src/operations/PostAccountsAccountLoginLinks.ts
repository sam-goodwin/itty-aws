...
// Input Schema
export const PostAccountsAccountLoginLinksInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const PostAccountsAccountLoginLinksOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const PostAccountsAccountLoginLinks = /*@__PURE__*/ API.make(() => ({
