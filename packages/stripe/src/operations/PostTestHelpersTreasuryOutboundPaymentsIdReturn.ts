...
// Input Schema
export interface PostTestHelpersTreasuryOutboundPaymentsIdReturnInput {
  id: string;
  expand?: string[];
  returned_details?: {
    code?:
...
export const PostTestHelpersTreasuryOutboundPaymentsIdReturnInput =
  ...
  ) as unknown as Schema.Codec<PostTestHelpersTreasuryOutboundPaymentsIdReturnInput>;

// Output Schema
export interface PostTestHelpersTreasuryOutboundPaymentsIdReturnOutput {
  amount: number;
  cancelable: boolean;
  created: number;
  currency: string;
...
export const PostTestHelpersTreasuryOutboundPaymentsIdReturnOutput =
  ...
  }) as unknown as Schema.Codec<PostTestHelpersTreasuryOutboundPaymentsIdReturnOutput>;
