...
// Input Schema
export const DeleteAccountsAccountInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const DeleteAccountsAccountOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const DeleteAccountsAccount = /*@__PURE__*/ API.make(() => ({
