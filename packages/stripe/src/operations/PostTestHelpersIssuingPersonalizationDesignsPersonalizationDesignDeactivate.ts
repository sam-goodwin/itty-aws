...
// Input Schema
export interface PostTestHelpersIssuingPersonalizationDesignsPersonalizationDesignDeactivateInput {
...
export const PostTestHelpersIssuingPersonalizationDesignsPersonalizationDesignDeactivateInput =
  ...
  ) as unknown as Schema.Codec<PostTestHelpersIssuingPersonalizationDesignsPersonalizationDesignDeactivateInput>;

// Output Schema
export interface PostTestHelpersIssuingPersonalizationDesignsPersonalizationDesignDeactivateOutput {
  card_logo:
    | string
    | {
        created: number;
...
export const PostTestHelpersIssuingPersonalizationDesignsPersonalizationDesignDeactivateOutput =
  ...
  }) as unknown as Schema.Codec<PostTestHelpersIssuingPersonalizationDesignsPersonalizationDesignDeactivateOutput>;
