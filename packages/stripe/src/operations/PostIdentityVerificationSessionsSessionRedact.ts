...
// Input Schema
export interface PostIdentityVerificationSessionsSessionRedactInput {
  session: string;
  expand?: string[];
}
export const PostIdentityVerificationSessionsSessionRedactInput =
  ...
  ) as unknown as Schema.Codec<PostIdentityVerificationSessionsSessionRedactInput>;

// Output Schema
export interface PostIdentityVerificationSessionsSessionRedactOutput {
...
export const PostIdentityVerificationSessionsSessionRedactOutput =
  ...
  }) as unknown as Schema.Codec<PostIdentityVerificationSessionsSessionRedactOutput>;
