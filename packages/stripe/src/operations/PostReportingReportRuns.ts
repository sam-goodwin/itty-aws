...
// Input Schema
export interface PostReportingReportRunsInput {
  expand?: string[];
  parameters?: {
    columns?: string[];
...
export const PostReportingReportRunsInput =
  ...
  ) as unknown as Schema.Codec<PostReportingReportRunsInput>;

// Output Schema
export interface PostReportingReportRunsOutput {
  created: number;
  error: string | null;
  id: string;
  livemode: boolean;
...
export const PostReportingReportRunsOutput =
  ...
  }) as unknown as Schema.Codec<PostReportingReportRunsOutput>;
