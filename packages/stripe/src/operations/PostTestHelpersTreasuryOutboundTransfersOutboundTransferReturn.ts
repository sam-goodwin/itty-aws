...
// Input Schema
export interface PostTestHelpersTreasuryOutboundTransfersOutboundTransferReturnInput {
...
export const PostTestHelpersTreasuryOutboundTransfersOutboundTransferReturnInput =
  ...
  ) as unknown as Schema.Codec<PostTestHelpersTreasuryOutboundTransfersOutboundTransferReturnInput>;

// Output Schema
export interface PostTestHelpersTreasuryOutboundTransfersOutboundTransferReturnOutput {
  amount: number;
  cancelable: boolean;
  created: number;
  currency: string;
...
export const PostTestHelpersTreasuryOutboundTransfersOutboundTransferReturnOutput =
  ...
  }) as unknown as Schema.Codec<PostTestHelpersTreasuryOutboundTransfersOutboundTransferReturnOutput>;
