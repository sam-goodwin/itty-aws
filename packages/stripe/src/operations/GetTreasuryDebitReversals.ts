...
// Input Schema
export const GetTreasuryDebitReversalsInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const GetTreasuryDebitReversalsOutput = /*@__PURE__*/ Schema.Struct({
  data: Schema.Array(
    Schema.Struct({
 ...
 */
export const GetTreasuryDebitReversals = /*@__PURE__*/ API.make(() => ({
