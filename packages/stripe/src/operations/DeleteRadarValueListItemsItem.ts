...
// Input Schema
export const DeleteRadarValueListItemsItemInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const DeleteRadarValueListItemsItemOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const DeleteRadarValueListItemsItem = /*@__PURE__*/ API.make(() => ({
