...
// Input Schema
export const GetIssuingTokensInput = /*@__PURE__*/ Schema.Struct({
  card: Schema.String,
...
// Output Schema
export const GetIssuingTokensOutput = /*@__PURE__*/ Schema.Struct({
  data: Schema.Array(
    Schema.Struct({
      card: Schema.Unknown,
 ...
 */
export const GetIssuingTokens = /*@__PURE__*/ API.make(() => ({
