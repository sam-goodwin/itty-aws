...
// Input Schema
export interface PostIssuingDisputesDisputeSubmitInput {
  dispute: string;
  expand?: string[];
...
export const PostIssuingDisputesDisputeSubmitInput =
  ...
  ) as unknown as Schema.Codec<PostIssuingDisputesDisputeSubmitInput>;

// Output Schema
export interface PostIssuingDisputesDisputeSubmitOutput {
  amount: number;
...
export const PostIssuingDisputesDisputeSubmitOutput =
  ...
  }) as unknown as Schema.Codec<PostIssuingDisputesDisputeSubmitOutput>;
