...
// Input Schema
export interface PostQuotesInput {
...
) as unknown as Schema.Codec<PostQuotesInput>;

// Output Schema
export interface PostQuotesOutput {
...
}) as unknown as Schema.Codec<PostQuotesOutput>;
