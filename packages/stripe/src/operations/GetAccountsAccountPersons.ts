...
// Input Schema
export interface GetAccountsAccountPersonsInput {
  account: string;
...
export const GetAccountsAccountPersonsInput =
  ...
  ) as unknown as Schema.Codec<GetAccountsAccountPersonsInput>;

// Output Schema
export interface GetAccountsAccountPersonsOutput {
  data: {
    account?: string;
...
export const GetAccountsAccountPersonsOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    object: Schema.Literals(["list"]),
    url: Schema.String,
  }) as unknown as Schema.Codec<GetAccountsAccountPersonsOutput>;
