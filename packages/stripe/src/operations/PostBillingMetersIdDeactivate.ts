...
// Input Schema
export const PostBillingMetersIdDeactivateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const PostBillingMetersIdDeactivateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const PostBillingMetersIdDeactivate = /*@__PURE__*/ API.make(() => ({
