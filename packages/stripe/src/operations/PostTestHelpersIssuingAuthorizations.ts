...
// Input Schema
export interface PostTestHelpersIssuingAuthorizationsInput {
  amount?: number;
  amount_details?: { atm_fee?: number; cashback_amount?: number };
...
export const PostTestHelpersIssuingAuthorizationsInput =
  /*@__PURE__*/ Schema.Struct({
    ...
    amount_details: Schema.optional(
      Schema.Struct({
        atm_fee: Schema.optional(Schema.Number),
        cashback_amount: Schema.optional(Schema.Number),
      }),
    ),
    authorization_method: Schema.optional(
      Schema.Literals(["chip", "contactless", "keyed_in", "online", "swipe"]),
    ),
    card: Schema.String,
    ...
    fraud_disputability_likelihood: Schema.optional(
      Schema.Literals(["neutral", "unknown", "very_likely", "very_unlikely"]),
    ),
    fuel: Schema.optional(
      Schema.Struct({
    ...
    merchant_amount: Schema.optional(Schema.Number),
    merchant_currency: Schema.optional(Schema.String),
    ...
    network_data: Schema.optional(
      Schema.Struct({
        acquiring_institution_id: Schema.optional(Schema.String),
      }),
    ),
    risk_assessment: Schema.optional(
      Schema.Struct({
        card_testing_risk: Schema.optional(
          Schema.Struct({
            invalid_account_number_decline_rate_past_hour: Schema.optional(
              Schema.Number,
            ),
    ...
    verification_data: Schema.optional(
      Schema.Struct({
        address_line1_check: Schema.optional(
          Schema.Literals(["match", "mismatch", "not_provided"]),
        ),
        address_postal_code_check: Schema.optional(
          Schema.Literals(["match", "mismatch", "not_provided"]),
        ),
        authentication_exemption: Schema.optional(
          Schema.Struct({
        ...
        cvc_check: Schema.optional(
          Schema.Literals(["match", "mismatch", "not_provided"]),
        ),
        expiry_check: Schema.optional(
          Schema.Literals(["match", "mismatch", "not_provided"]),
        ),
  ...
  ) as unknown as Schema.Codec<PostTestHelpersIssuingAuthorizationsInput>;

// Output Schema
export interface PostTestHelpersIssuingAuthorizationsOutput {
  amount: number;
  amount_details: {
    atm_fee: number | null;
...
export const PostTestHelpersIssuingAuthorizationsOutput =
  ...
  }) as unknown as Schema.Codec<PostTestHelpersIssuingAuthorizationsOutput>;
