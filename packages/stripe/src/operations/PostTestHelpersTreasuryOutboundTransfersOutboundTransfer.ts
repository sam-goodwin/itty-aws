...
// Input Schema
export interface PostTestHelpersTreasuryOutboundTransfersOutboundTransferInput {
  outbound_transfer: string;
  expand?: string[];
  tracking_details: {
    ach?: { trace_id: string };
    type: "ach" | "us_domestic_wire";
    us_domestic_wire?: { chips?: string; imad?: string; omad?: string };
  };
}
export const PostTestHelpersTreasuryOutboundTransfersOutboundTransferInput =
  ...
  ) as unknown as Schema.Codec<PostTestHelpersTreasuryOutboundTransfersOutboundTransferInput>;

// Output Schema
export interface PostTestHelpersTreasuryOutboundTransfersOutboundTransferOutput {
  amount: number;
  cancelable: boolean;
  created: number;
  currency: string;
...
export const PostTestHelpersTreasuryOutboundTransfersOutboundTransferOutput =
  ...
  }) as unknown as Schema.Codec<PostTestHelpersTreasuryOutboundTransfersOutboundTransferOutput>;
