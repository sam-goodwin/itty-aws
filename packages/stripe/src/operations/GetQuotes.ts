...
) as unknown as Schema.Codec<GetQuotesInput>;
...
export interface GetQuotesOutput {
  data: {
    ...
    expires_at: number;
    footer: string | null;
    from_quote: { is_revision: boolean; quote: string | unknown } | null;
    header: string | null;
    id: string;
    invoice: unknown;
    invoice_settings: {
...
export const GetQuotesOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    Schema.Struct({
      ...
      from_quote: Schema.NullOr(
        Schema.Struct({
          ...
          quote: Schema.Union([Schema.String, Schema.Unknown]),
        }),
      ),
  ...
  object: Schema.Literals(["list"]),
  url: Schema.String,
}) as unknown as Schema.Codec<GetQuotesOutput>;
