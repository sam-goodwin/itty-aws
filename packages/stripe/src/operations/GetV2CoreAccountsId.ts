...
// Input Schema
export interface GetV2CoreAccountsIdInput {
  id: string;
  include?: string;
}
export const GetV2CoreAccountsIdInput =
  /*@__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "GET", path: "/v2/core/accounts/{id}" }),
  ) as unknown as Schema.Codec<GetV2CoreAccountsIdInput>;

// Output Schema
export interface GetV2CoreAccountsIdOutput {
...
export const GetV2CoreAccountsIdOutput =
  ...
  }) as unknown as Schema.Codec<GetV2CoreAccountsIdOutput>;
