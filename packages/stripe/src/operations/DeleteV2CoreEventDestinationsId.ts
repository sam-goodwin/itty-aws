...
// Input Schema
export const DeleteV2CoreEventDestinationsIdInput = /*@__PURE__*/ Schema.Struct(
  {
    id: Schema.String.pipe(T.PathParam()),
  },
).pipe(T.Http({ method: "DELETE", path: "/v2/core/event_destinations/{id}" }));
 ...
 */
export const DeleteV2CoreEventDestinationsId = /*@__PURE__*/ API.make(() => ({
