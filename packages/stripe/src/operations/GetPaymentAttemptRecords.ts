...
// Input Schema
export interface GetPaymentAttemptRecordsInput {
  expand?: string;
  limit?: number;
...
export const GetPaymentAttemptRecordsInput =
  ...
  ) as unknown as Schema.Codec<GetPaymentAttemptRecordsInput>;

// Output Schema
export interface GetPaymentAttemptRecordsOutput {
  data: {
...
export const GetPaymentAttemptRecordsOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    url: Schema.String,
  }) as unknown as Schema.Codec<GetPaymentAttemptRecordsOutput>;
 ...
 */
export const GetPaymentAttemptRecords = /*@__PURE__*/ API.make(() => ({
