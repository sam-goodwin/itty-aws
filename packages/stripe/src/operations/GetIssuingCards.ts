...
// Input Schema
export interface GetIssuingCardsInput {
  cardholder?: string;
  created?: string;
...
) as unknown as Schema.Codec<GetIssuingCardsInput>;

// Output Schema
export interface GetIssuingCardsOutput {
  data: {
    brand: string;
    cancellation_reason:
      | "design_rejected"
...
export const GetIssuingCardsOutput = /*@__PURE__*/ Schema.Struct({
  ...
  object: Schema.Literals(["list"]),
  url: Schema.String,
}) as unknown as Schema.Codec<GetIssuingCardsOutput>;
