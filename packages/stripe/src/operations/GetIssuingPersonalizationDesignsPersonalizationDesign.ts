...
// Input Schema
export interface GetIssuingPersonalizationDesignsPersonalizationDesignInput {
...
export const GetIssuingPersonalizationDesignsPersonalizationDesignInput =
  ...
  ) as unknown as Schema.Codec<GetIssuingPersonalizationDesignsPersonalizationDesignInput>;

// Output Schema
export interface GetIssuingPersonalizationDesignsPersonalizationDesignOutput {
  card_logo:
    | string
    | {
        created: number;
...
export const GetIssuingPersonalizationDesignsPersonalizationDesignOutput =
  ...
  }) as unknown as Schema.Codec<GetIssuingPersonalizationDesignsPersonalizationDesignOutput>;
