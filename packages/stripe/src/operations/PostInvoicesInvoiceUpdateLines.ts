...
// Input Schema
export interface PostInvoicesInvoiceUpdateLinesInput {
  invoice: string;
  expand?: string[];
...
export const PostInvoicesInvoiceUpdateLinesInput =
  ...
  ) as unknown as Schema.Codec<PostInvoicesInvoiceUpdateLinesInput>;

// Output Schema
export interface PostInvoicesInvoiceUpdateLinesOutput {
...
export const PostInvoicesInvoiceUpdateLinesOutput =
  ...
  }) as unknown as Schema.Codec<PostInvoicesInvoiceUpdateLinesOutput>;
