...
// Input Schema
export interface GetV2CoreAccountsAccountIdPersonsInput {
  account_id: string;
  limit?: number;
}
export const GetV2CoreAccountsAccountIdPersonsInput =
  ...
  ) as unknown as Schema.Codec<GetV2CoreAccountsAccountIdPersonsInput>;

// Output Schema
export interface GetV2CoreAccountsAccountIdPersonsOutput {
  data: {
    account: string;
...
export const GetV2CoreAccountsAccountIdPersonsOutput =
  ...
  }) as unknown as Schema.Codec<GetV2CoreAccountsAccountIdPersonsOutput>;
