...
// Input Schema
export interface PostFinancialConnectionsAccountsAccountRefreshInput {
  account: string;
  expand?: string[];
...
export const PostFinancialConnectionsAccountsAccountRefreshInput =
  ...
  ) as unknown as Schema.Codec<PostFinancialConnectionsAccountsAccountRefreshInput>;

// Output Schema
export interface PostFinancialConnectionsAccountsAccountRefreshOutput {
  account_holder: {
    account?: unknown;
    customer?: unknown;
...
export const PostFinancialConnectionsAccountsAccountRefreshOutput =
  ...
  }) as unknown as Schema.Codec<PostFinancialConnectionsAccountsAccountRefreshOutput>;
