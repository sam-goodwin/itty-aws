...
// Input Schema
export interface PostChargesChargeCaptureInput {
  charge: string;
  amount?: number;
...
export const PostChargesChargeCaptureInput =
  ...
  ) as unknown as Schema.Codec<PostChargesChargeCaptureInput>;

// Output Schema
export interface PostChargesChargeCaptureOutput {
  amount: number;
...
export const PostChargesChargeCaptureOutput =
  ...
  }) as unknown as Schema.Codec<PostChargesChargeCaptureOutput>;
