...
// Input Schema
export interface PostTestHelpersIssuingAuthorizationsAuthorizationReverseInput {
...
export const PostTestHelpersIssuingAuthorizationsAuthorizationReverseInput =
  ...
  ) as unknown as Schema.Codec<PostTestHelpersIssuingAuthorizationsAuthorizationReverseInput>;

// Output Schema
export interface PostTestHelpersIssuingAuthorizationsAuthorizationReverseOutput {
  amount: number;
  amount_details: {
    atm_fee: number | null;
...
export const PostTestHelpersIssuingAuthorizationsAuthorizationReverseOutput =
  ...
  }) as unknown as Schema.Codec<PostTestHelpersIssuingAuthorizationsAuthorizationReverseOutput>;
