...
// Input Schema
export interface GetCustomersCustomerTaxIdsIdInput {
  customer: string;
  id: string;
  expand?: string;
}
export const GetCustomersCustomerTaxIdsIdInput =
  ...
  ) as unknown as Schema.Codec<GetCustomersCustomerTaxIdsIdInput>;

// Output Schema
export interface GetCustomersCustomerTaxIdsIdOutput {
  country: string | null;
  created: number;
  customer: unknown;
...
export const GetCustomersCustomerTaxIdsIdOutput =
  ...
  }) as unknown as Schema.Codec<GetCustomersCustomerTaxIdsIdOutput>;
