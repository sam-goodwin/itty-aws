...
// Input Schema
export const GetTaxTransactionsTransactionInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const GetTaxTransactionsTransactionOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const GetTaxTransactionsTransaction = /*@__PURE__*/ API.make(() => ({
