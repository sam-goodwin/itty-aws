...
// Input Schema
export interface GetTaxTransactionsTransactionInput {
  transaction: string;
  expand?: string;
}
export const GetTaxTransactionsTransactionInput =
  ...
  ) as unknown as Schema.Codec<GetTaxTransactionsTransactionInput>;

// Output Schema
export interface GetTaxTransactionsTransactionOutput {
  created: number;
  currency: string;
...
export const GetTaxTransactionsTransactionOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    type: Schema.Literals(["reversal", "transaction"]),
  }) as unknown as Schema.Codec<GetTaxTransactionsTransactionOutput>;
