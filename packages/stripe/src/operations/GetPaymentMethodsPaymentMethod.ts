...
// Input Schema
export interface GetPaymentMethodsPaymentMethodInput {
...
export const GetPaymentMethodsPaymentMethodInput =
  ...
  ) as unknown as Schema.Codec<GetPaymentMethodsPaymentMethodInput>;

// Output Schema
export interface GetPaymentMethodsPaymentMethodOutput {
  acss_debit?: {
...
export const GetPaymentMethodsPaymentMethodOutput =
  ...
  }) as unknown as Schema.Codec<GetPaymentMethodsPaymentMethodOutput>;
