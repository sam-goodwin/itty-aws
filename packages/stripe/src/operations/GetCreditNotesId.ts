...
// Input Schema
export interface GetCreditNotesIdInput {
  id: string;
  expand?: string;
}
export const GetCreditNotesIdInput = /*@__PURE__*/ Schema.Struct({
...
) as unknown as Schema.Codec<GetCreditNotesIdInput>;

// Output Schema
export interface GetCreditNotesIdOutput {
  amount: number;
...
export const GetCreditNotesIdOutput = /*@__PURE__*/ Schema.Struct({
  ...
  voided_at: Schema.NullOr(Schema.Number),
}) as unknown as Schema.Codec<GetCreditNotesIdOutput>;
 ...
 */
export const GetCreditNotesId = /*@__PURE__*/ API.make(() => ({
