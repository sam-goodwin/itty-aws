...
// Input Schema
export const GetRadarValueListsValueListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const GetRadarValueListsValueListOutput = /*@__PURE__*/ Schema.Struct({
  alias: Schema.String,
 ...
 */
export const GetRadarValueListsValueList = /*@__PURE__*/ API.make(() => ({
