...
// Input Schema
export interface PostChargesInput {
  amount?: number;
...
) as unknown as Schema.Codec<PostChargesInput>;

// Output Schema
export interface PostChargesOutput {
  amount: number;
...
}) as unknown as Schema.Codec<PostChargesOutput>;
