...
// Input Schema
export interface PostBillingAlertsIdActivateInput {
  id: string;
  expand?: string[];
}
export const PostBillingAlertsIdActivateInput =
  ...
  ) as unknown as Schema.Codec<PostBillingAlertsIdActivateInput>;

// Output Schema
export interface PostBillingAlertsIdActivateOutput {
...
export const PostBillingAlertsIdActivateOutput =
  ...
  }) as unknown as Schema.Codec<PostBillingAlertsIdActivateOutput>;
