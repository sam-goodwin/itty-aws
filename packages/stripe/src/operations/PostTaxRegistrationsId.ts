...
// Input Schema
export interface PostTaxRegistrationsIdInput {
  id: string;
...
export const PostTaxRegistrationsIdInput =
  ...
  ) as unknown as Schema.Codec<PostTaxRegistrationsIdInput>;

// Output Schema
export interface PostTaxRegistrationsIdOutput {
  active_from: number;
  country: string;
  country_options: {
    ae?: {
...
export const PostTaxRegistrationsIdOutput =
  ...
  }) as unknown as Schema.Codec<PostTaxRegistrationsIdOutput>;
