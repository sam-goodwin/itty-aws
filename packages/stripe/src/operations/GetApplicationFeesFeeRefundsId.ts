...
// Input Schema
export interface GetApplicationFeesFeeRefundsIdInput {
  fee: string;
  id: string;
  expand?: string;
}
export const GetApplicationFeesFeeRefundsIdInput =
  ...
  ) as unknown as Schema.Codec<GetApplicationFeesFeeRefundsIdInput>;

// Output Schema
export interface GetApplicationFeesFeeRefundsIdOutput {
  amount: number;
  balance_transaction:
    | string
    | {
...
export const GetApplicationFeesFeeRefundsIdOutput =
  ...
  }) as unknown as Schema.Codec<GetApplicationFeesFeeRefundsIdOutput>;
