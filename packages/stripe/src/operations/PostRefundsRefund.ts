...
// Input Schema
export interface PostRefundsRefundInput {
  refund: string;
  expand?: string[];
...
) as unknown as Schema.Codec<PostRefundsRefundInput>;

// Output Schema
export interface PostRefundsRefundOutput {
  amount: number;
  balance_transaction:
    | string
    | {
...
export const PostRefundsRefundOutput =
  ...
  }) as unknown as Schema.Codec<PostRefundsRefundOutput>;
