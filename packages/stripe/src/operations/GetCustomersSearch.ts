...
// Input Schema
export interface GetCustomersSearchInput {
  expand?: string;
  limit?: number;
  page?: string;
  query: string;
...
export const GetCustomersSearchInput =
  ...
  ) as unknown as Schema.Codec<GetCustomersSearchInput>;

// Output Schema
export interface GetCustomersSearchOutput {
  data: {
    address?: {
      city: string | null;
      country: string | null;
...
export const GetCustomersSearchOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
                            ...
                            promotion_code: Schema.NullOr(
                              Schema.Union([
                                ...
                                Schema.Struct({
                                  ...
                                  customer_account: Schema.NullOr(
                                    Schema.String,
                                  ),
                                  expires_at: Schema.NullOr(Schema.Number),
                                  id: Schema.String,
    ...
    url: Schema.String,
  }) as unknown as Schema.Codec<GetCustomersSearchOutput>;
