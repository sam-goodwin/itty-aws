...
// Input Schema
export interface PostTestHelpersTreasuryOutboundTransfersOutboundTransferPostInput {
...
export const PostTestHelpersTreasuryOutboundTransfersOutboundTransferPostInput =
  ...
  ) as unknown as Schema.Codec<PostTestHelpersTreasuryOutboundTransfersOutboundTransferPostInput>;

// Output Schema
export interface PostTestHelpersTreasuryOutboundTransfersOutboundTransferPostOutput {
  amount: number;
  cancelable: boolean;
  created: number;
  currency: string;
...
export const PostTestHelpersTreasuryOutboundTransfersOutboundTransferPostOutput =
  ...
  }) as unknown as Schema.Codec<PostTestHelpersTreasuryOutboundTransfersOutboundTransferPostOutput>;
