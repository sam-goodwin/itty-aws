...
// Input Schema
export interface PostBillingCreditGrantsIdExpireInput {
  id: string;
  expand?: string[];
}
export const PostBillingCreditGrantsIdExpireInput =
  ...
  ) as unknown as Schema.Codec<PostBillingCreditGrantsIdExpireInput>;

// Output Schema
export interface PostBillingCreditGrantsIdExpireOutput {
  amount: {
...
export const PostBillingCreditGrantsIdExpireOutput =
  ...
  }) as unknown as Schema.Codec<PostBillingCreditGrantsIdExpireOutput>;
