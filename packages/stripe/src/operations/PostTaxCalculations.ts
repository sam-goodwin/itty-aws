...
// Input Schema
export const PostTaxCalculationsInput = /*@__PURE__*/ Schema.Struct({
  ...
  customer_details: Schema.optional(
    Schema.Struct({
      ...
      address_source: Schema.optional(Schema.Literals(["billing", "shipping"])),
...
// Output Schema
export const PostTaxCalculationsOutput = /*@__PURE__*/ Schema.Struct({
