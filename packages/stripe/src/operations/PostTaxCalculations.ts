...
// Input Schema
export interface PostTaxCalculationsInput {
  currency: string;
  customer?: string;
  customer_details?: {
    address?: {
...
export const PostTaxCalculationsInput =
  ...
  ) as unknown as Schema.Codec<PostTaxCalculationsInput>;

// Output Schema
export interface PostTaxCalculationsOutput {
  amount_total: number;
  currency: string;
...
export const PostTaxCalculationsOutput =
  ...
  }) as unknown as Schema.Codec<PostTaxCalculationsOutput>;
