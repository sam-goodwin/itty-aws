...
// Input Schema
export interface PostTerminalReadersReaderProcessSetupIntentInput {
  reader: string;
...
export const PostTerminalReadersReaderProcessSetupIntentInput =
  ...
  ) as unknown as Schema.Codec<PostTerminalReadersReaderProcessSetupIntentInput>;

// Output Schema
export interface PostTerminalReadersReaderProcessSetupIntentOutput {
  action: unknown;
...
export const PostTerminalReadersReaderProcessSetupIntentOutput =
  ...
  }) as unknown as Schema.Codec<PostTerminalReadersReaderProcessSetupIntentOutput>;
