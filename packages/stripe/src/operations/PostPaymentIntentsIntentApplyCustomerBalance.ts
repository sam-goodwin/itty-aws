...
// Input Schema
export interface PostPaymentIntentsIntentApplyCustomerBalanceInput {
  intent: string;
  amount?: number;
  currency?: string;
  expand?: string[];
...
export const PostPaymentIntentsIntentApplyCustomerBalanceInput =
  ...
  ) as unknown as Schema.Codec<PostPaymentIntentsIntentApplyCustomerBalanceInput>;

// Output Schema
export interface PostPaymentIntentsIntentApplyCustomerBalanceOutput {
  amount: number;
...
export const PostPaymentIntentsIntentApplyCustomerBalanceOutput =
  ...
  }) as unknown as Schema.Codec<PostPaymentIntentsIntentApplyCustomerBalanceOutput>;
