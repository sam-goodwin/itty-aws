...
export const GetAccountsInput = /*@__PURE__*/ Schema.Struct({
...
) as unknown as Schema.Codec<GetAccountsInput>;
...
export const GetAccountsOutput = /*@__PURE__*/ Schema.Struct({
  data: Schema.Array(
    Schema.Struct({
      business_profile: Schema.optional(
        Schema.NullOr(
          Schema.Struct({
            ...
            estimated_worker_count: Schema.optional(
  ...
  object: Schema.Literals(["list"]),
  url: Schema.String,
}) as unknown as Schema.Codec<GetAccountsOutput>;
 ...
 */
export const GetAccounts = /*@__PURE__*/ API.make(() => ({
