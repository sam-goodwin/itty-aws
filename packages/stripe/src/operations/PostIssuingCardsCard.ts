...
// Input Schema
export const PostIssuingCardsCardInput = /*@__PURE__*/ Schema.Struct({
...
export type PostIssuingCardsCardInput = typeof PostIssuingCardsCardInput.Type;

// Output Schema
export const PostIssuingCardsCardOutput = /*@__PURE__*/ Schema.Struct({
  brand: Schema.String,
...
export type PostIssuingCardsCardOutput = typeof PostIssuingCardsCardOutput.Type;
