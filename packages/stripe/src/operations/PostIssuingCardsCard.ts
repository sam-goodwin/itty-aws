...
// Input Schema
export interface PostIssuingCardsCardInput {
  card: string;
...
export const PostIssuingCardsCardInput =
  /*@__PURE__*/ Schema.Struct({
    ...
    pin: Schema.optional(
      Schema.Struct({
        encrypted_number: Schema.optional(Schema.String),
      }),
    ),
    shipping: Schema.optional(
      Schema.Struct({
        ...
        address_validation: Schema.optional(
          Schema.Struct({
        ...
        customs: Schema.optional(
          Schema.Struct({
            eori_number: Schema.optional(Schema.String),
          }),
        ),
        name: Schema.String,
        phone_number: Schema.optional(Schema.String),
        require_signature: Schema.optional(Schema.Boolean),
        service: Schema.optional(
          Schema.Literals(["express", "priority", "standard"]),
        ),
        type: Schema.optional(Schema.Literals(["bulk", "individual"])),
      }),
    ),
    ...
    status: Schema.optional(
      Schema.Literals(["active", "canceled", "inactive"]),
    ),
  }).pipe(
    T.Http({
      method: "POST",
  ...
  ) as unknown as Schema.Codec<PostIssuingCardsCardInput>;

// Output Schema
export interface PostIssuingCardsCardOutput {
  brand: string;
  cancellation_reason:
    | "design_rejected"
    | "fulfillment_error"
...
export const PostIssuingCardsCardOutput =
  ...
  }) as unknown as Schema.Codec<PostIssuingCardsCardOutput>;
