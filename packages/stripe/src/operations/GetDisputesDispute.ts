...
// Input Schema
export interface GetDisputesDisputeInput {
  dispute: string;
  expand?: string;
}
export const GetDisputesDisputeInput =
  ...
  ) as unknown as Schema.Codec<GetDisputesDisputeInput>;

// Output Schema
export interface GetDisputesDisputeOutput {
  amount: number;
...
export const GetDisputesDisputeOutput =
  ...
  }) as unknown as Schema.Codec<GetDisputesDisputeOutput>;
