...
// Input Schema
export interface GetPaymentIntentsIntentInput {
  intent: string;
...
export const GetPaymentIntentsIntentInput =
  ...
  ) as unknown as Schema.Codec<GetPaymentIntentsIntentInput>;

// Output Schema
export interface GetPaymentIntentsIntentOutput {
  amount: number;
...
export const GetPaymentIntentsIntentOutput =
  ...
  }) as unknown as Schema.Codec<GetPaymentIntentsIntentOutput>;
