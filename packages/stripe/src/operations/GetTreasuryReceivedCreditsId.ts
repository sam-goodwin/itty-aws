...
// Input Schema
export const GetTreasuryReceivedCreditsIdInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const GetTreasuryReceivedCreditsIdOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const GetTreasuryReceivedCreditsId = /*@__PURE__*/ API.make(() => ({
