...
// Input Schema
export interface GetFinancialConnectionsAccountsAccountInput {
  account: string;
  expand?: string;
}
export const GetFinancialConnectionsAccountsAccountInput =
  ...
  ) as unknown as Schema.Codec<GetFinancialConnectionsAccountsAccountInput>;

// Output Schema
export interface GetFinancialConnectionsAccountsAccountOutput {
  account_holder: {
    account?: unknown;
    customer?: unknown;
...
export const GetFinancialConnectionsAccountsAccountOutput =
  ...
  }) as unknown as Schema.Codec<GetFinancialConnectionsAccountsAccountOutput>;
