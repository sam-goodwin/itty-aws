...
// Input Schema
export interface GetTreasuryOutboundTransfersOutboundTransferInput {
...
export const GetTreasuryOutboundTransfersOutboundTransferInput =
  ...
  ) as unknown as Schema.Codec<GetTreasuryOutboundTransfersOutboundTransferInput>;

// Output Schema
export interface GetTreasuryOutboundTransfersOutboundTransferOutput {
  amount: number;
  cancelable: boolean;
  created: number;
  currency: string;
...
export const GetTreasuryOutboundTransfersOutboundTransferOutput =
  ...
  }) as unknown as Schema.Codec<GetTreasuryOutboundTransfersOutboundTransferOutput>;
