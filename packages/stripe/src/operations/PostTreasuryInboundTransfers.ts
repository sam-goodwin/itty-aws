...
// Input Schema
export interface PostTreasuryInboundTransfersInput {
  amount: number;
  currency: string;
  description?: string;
  expand?: string[];
...
export const PostTreasuryInboundTransfersInput =
  ...
  ) as unknown as Schema.Codec<PostTreasuryInboundTransfersInput>;

// Output Schema
export interface PostTreasuryInboundTransfersOutput {
  amount: number;
  cancelable: boolean;
  created: number;
  currency: string;
...
export const PostTreasuryInboundTransfersOutput =
  ...
  }) as unknown as Schema.Codec<PostTreasuryInboundTransfersOutput>;
