...
// Input Schema
export const PostTreasuryInboundTransfersInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const PostTreasuryInboundTransfersOutput = /*@__PURE__*/ Schema.Struct({
  amount: Schema.Number,
 ...
 */
export const PostTreasuryInboundTransfers = /*@__PURE__*/ API.make(() => ({
