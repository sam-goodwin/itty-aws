...
// Input Schema
export const GetTreasuryOutboundTransfersInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const GetTreasuryOutboundTransfersOutput = /*@__PURE__*/ Schema.Struct({
  data: Schema.Array(
    Schema.Struct({
 ...
 */
export const GetTreasuryOutboundTransfers = /*@__PURE__*/ API.make(() => ({
