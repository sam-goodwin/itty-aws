...
// Input Schema
export interface GetTreasuryOutboundTransfersInput {
...
export const GetTreasuryOutboundTransfersInput =
  ...
  ) as unknown as Schema.Codec<GetTreasuryOutboundTransfersInput>;

// Output Schema
export interface GetTreasuryOutboundTransfersOutput {
  data: {
    amount: number;
    cancelable: boolean;
    created: number;
...
export const GetTreasuryOutboundTransfersOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    object: Schema.Literals(["list"]),
    url: Schema.String,
  }) as unknown as Schema.Codec<GetTreasuryOutboundTransfersOutput>;
