...
// Input Schema
export interface PostPayoutsPayoutInput {
  payout: string;
  expand?: string[];
...
) as unknown as Schema.Codec<PostPayoutsPayoutInput>;

// Output Schema
export interface PostPayoutsPayoutOutput {
  amount: number;
  application_fee:
    | string
    | {
...
export const PostPayoutsPayoutOutput =
  ...
  }) as unknown as Schema.Codec<PostPayoutsPayoutOutput>;
