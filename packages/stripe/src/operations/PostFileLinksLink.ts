...
// Input Schema
export interface PostFileLinksLinkInput {
  link: string;
  expand?: string[];
...
) as unknown as Schema.Codec<PostFileLinksLinkInput>;

// Output Schema
export interface PostFileLinksLinkOutput {
  created: number;
  expired: boolean;
...
export const PostFileLinksLinkOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    object: Schema.Literals(["file_link"]),
    url: Schema.NullOr(Schema.String),
  }) as unknown as Schema.Codec<PostFileLinksLinkOutput>;
