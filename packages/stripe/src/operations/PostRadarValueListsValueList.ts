...
// Input Schema
export const PostRadarValueListsValueListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const PostRadarValueListsValueListOutput = /*@__PURE__*/ Schema.Struct({
  alias: Schema.String,
 ...
 */
export const PostRadarValueListsValueList = /*@__PURE__*/ API.make(() => ({
