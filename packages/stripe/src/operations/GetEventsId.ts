...
// Input Schema
export interface GetEventsIdInput {
  id: string;
  expand?: string;
}
...
) as unknown as Schema.Codec<GetEventsIdInput>;

// Output Schema
export interface GetEventsIdOutput {
  account?: string;
...
}) as unknown as Schema.Codec<GetEventsIdOutput>;
