...
// Input Schema
export interface GetRefundsRefundInput {
  refund: string;
  expand?: string;
}
export const GetRefundsRefundInput = /*@__PURE__*/ Schema.Struct({
...
) as unknown as Schema.Codec<GetRefundsRefundInput>;

// Output Schema
export interface GetRefundsRefundOutput {
  amount: number;
  balance_transaction:
    | string
    | {
...
export const GetRefundsRefundOutput = /*@__PURE__*/ Schema.Struct({
...
}) as unknown as Schema.Codec<GetRefundsRefundOutput>;
 ...
 */
export const GetRefundsRefund = /*@__PURE__*/ API.make(() => ({
