...
// Input Schema
export const PostCustomersCustomerSourcesInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const PostCustomersCustomerSourcesOutput = /*@__PURE__*/ Schema.Unknown;
 ...
 */
export const PostCustomersCustomerSources = /*@__PURE__*/ API.make(() => ({
