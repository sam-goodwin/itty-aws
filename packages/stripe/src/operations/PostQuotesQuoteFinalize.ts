...
// Input Schema
export interface PostQuotesQuoteFinalizeInput {
  quote: string;
  expand?: string[];
  expires_at?: number;
}
export const PostQuotesQuoteFinalizeInput =
  ...
  ) as unknown as Schema.Codec<PostQuotesQuoteFinalizeInput>;

// Output Schema
export interface PostQuotesQuoteFinalizeOutput {
...
export const PostQuotesQuoteFinalizeOutput =
  ...
  }) as unknown as Schema.Codec<PostQuotesQuoteFinalizeOutput>;
