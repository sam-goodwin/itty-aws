...
// Input Schema
export interface PostTestHelpersTreasuryOutboundPaymentsIdInput {
  id: string;
  expand?: string[];
  tracking_details: {
    ach?: { trace_id: string };
...
export const PostTestHelpersTreasuryOutboundPaymentsIdInput =
  ...
  ) as unknown as Schema.Codec<PostTestHelpersTreasuryOutboundPaymentsIdInput>;

// Output Schema
export interface PostTestHelpersTreasuryOutboundPaymentsIdOutput {
  amount: number;
  cancelable: boolean;
  created: number;
  currency: string;
...
export const PostTestHelpersTreasuryOutboundPaymentsIdOutput =
  ...
  }) as unknown as Schema.Codec<PostTestHelpersTreasuryOutboundPaymentsIdOutput>;
