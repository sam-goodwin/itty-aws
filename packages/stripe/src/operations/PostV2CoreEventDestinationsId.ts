...
// Input Schema
export const PostV2CoreEventDestinationsIdInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const PostV2CoreEventDestinationsIdOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const PostV2CoreEventDestinationsId = /*@__PURE__*/ API.make(() => ({
