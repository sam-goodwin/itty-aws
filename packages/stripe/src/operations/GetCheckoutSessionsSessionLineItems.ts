...
// Input Schema
export interface GetCheckoutSessionsSessionLineItemsInput {
  session: string;
...
export const GetCheckoutSessionsSessionLineItemsInput =
  ...
  ) as unknown as Schema.Codec<GetCheckoutSessionsSessionLineItemsInput>;

// Output Schema
export interface GetCheckoutSessionsSessionLineItemsOutput {
  data: {
    adjustable_quantity: {
      enabled: boolean;
      maximum: number | null;
...
export const GetCheckoutSessionsSessionLineItemsOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    url: Schema.String,
  }) as unknown as Schema.Codec<GetCheckoutSessionsSessionLineItemsOutput>;
