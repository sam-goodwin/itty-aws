...
// Input Schema
export interface GetCustomersCustomerPaymentMethodsInput {
  customer: string;
...
export const GetCustomersCustomerPaymentMethodsInput =
  ...
  ) as unknown as Schema.Codec<GetCustomersCustomerPaymentMethodsInput>;

// Output Schema
export interface GetCustomersCustomerPaymentMethodsOutput {
  data: {
    acss_debit?: {
...
export const GetCustomersCustomerPaymentMethodsOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    url: Schema.String,
  }) as unknown as Schema.Codec<GetCustomersCustomerPaymentMethodsOutput>;
