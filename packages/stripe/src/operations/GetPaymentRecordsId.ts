...
// Input Schema
export interface GetPaymentRecordsIdInput {
  id: string;
  expand?: string;
}
export const GetPaymentRecordsIdInput =
  ...
  ) as unknown as Schema.Codec<GetPaymentRecordsIdInput>;

// Output Schema
export interface GetPaymentRecordsIdOutput {
...
export const GetPaymentRecordsIdOutput =
  ...
  }) as unknown as Schema.Codec<GetPaymentRecordsIdOutput>;
