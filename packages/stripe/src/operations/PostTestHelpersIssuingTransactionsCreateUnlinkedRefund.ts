...
// Input Schema
export interface PostTestHelpersIssuingTransactionsCreateUnlinkedRefundInput {
  amount: number;
  card: string;
  currency?: string;
  expand?: string[];
...
export const PostTestHelpersIssuingTransactionsCreateUnlinkedRefundInput =
  ...
  ) as unknown as Schema.Codec<PostTestHelpersIssuingTransactionsCreateUnlinkedRefundInput>;

// Output Schema
export interface PostTestHelpersIssuingTransactionsCreateUnlinkedRefundOutput {
  amount: number;
  amount_details: {
    atm_fee: number | null;
...
export const PostTestHelpersIssuingTransactionsCreateUnlinkedRefundOutput =
  ...
  }) as unknown as Schema.Codec<PostTestHelpersIssuingTransactionsCreateUnlinkedRefundOutput>;
