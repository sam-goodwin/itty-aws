...
// Input Schema
export interface PostQuotesQuoteCancelInput {
  quote: string;
  expand?: string[];
}
export const PostQuotesQuoteCancelInput =
  ...
  ) as unknown as Schema.Codec<PostQuotesQuoteCancelInput>;

// Output Schema
export interface PostQuotesQuoteCancelOutput {
...
export const PostQuotesQuoteCancelOutput =
  ...
  }) as unknown as Schema.Codec<PostQuotesQuoteCancelOutput>;
