...
// Input Schema
export interface PostInvoicesInvoiceSendInput {
  invoice: string;
  expand?: string[];
}
export const PostInvoicesInvoiceSendInput =
  ...
  ) as unknown as Schema.Codec<PostInvoicesInvoiceSendInput>;

// Output Schema
export interface PostInvoicesInvoiceSendOutput {
...
export const PostInvoicesInvoiceSendOutput =
  ...
  }) as unknown as Schema.Codec<PostInvoicesInvoiceSendOutput>;
