...
// Input Schema
export const GetProductsProductFeaturesIdInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const GetProductsProductFeaturesIdOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const GetProductsProductFeaturesId = /*@__PURE__*/ API.make(() => ({
