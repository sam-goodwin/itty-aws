...
// Input Schema
export interface GetFilesFileInput {
  file: string;
  expand?: string;
}
...
) as unknown as Schema.Codec<GetFilesFileInput>;

// Output Schema
export interface GetFilesFileOutput {
  created: number;
...
export const GetFilesFileOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  type: Schema.NullOr(Schema.String),
  url: Schema.NullOr(Schema.String),
}) as unknown as Schema.Codec<GetFilesFileOutput>;
