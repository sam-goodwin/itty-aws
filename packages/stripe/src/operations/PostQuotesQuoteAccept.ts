...
// Input Schema
export const PostQuotesQuoteAcceptInput = /*@__PURE__*/ Schema.Struct({
...
export type PostQuotesQuoteAcceptInput = typeof PostQuotesQuoteAcceptInput.Type;

// Output Schema
export const PostQuotesQuoteAcceptOutput = /*@__PURE__*/ Schema.Struct({
...
export type PostQuotesQuoteAcceptOutput =
  typeof PostQuotesQuoteAcceptOutput.Type;
