...
// Input Schema
export interface PostQuotesQuoteAcceptInput {
  quote: string;
  expand?: string[];
}
export const PostQuotesQuoteAcceptInput =
  ...
  ) as unknown as Schema.Codec<PostQuotesQuoteAcceptInput>;

// Output Schema
export interface PostQuotesQuoteAcceptOutput {
...
export const PostQuotesQuoteAcceptOutput =
  ...
  }) as unknown as Schema.Codec<PostQuotesQuoteAcceptOutput>;
