...
// Input Schema
export interface GetQuotesQuoteInput {
  quote: string;
  expand?: string;
}
...
) as unknown as Schema.Codec<GetQuotesQuoteInput>;

// Output Schema
export interface GetQuotesQuoteOutput {
...
}) as unknown as Schema.Codec<GetQuotesQuoteOutput>;
