...
// Input Schema
export interface PostFinancialConnectionsAccountsAccountSubscribeInput {
  account: string;
  expand?: string[];
...
export const PostFinancialConnectionsAccountsAccountSubscribeInput =
  ...
  ) as unknown as Schema.Codec<PostFinancialConnectionsAccountsAccountSubscribeInput>;

// Output Schema
export interface PostFinancialConnectionsAccountsAccountSubscribeOutput {
  account_holder: {
    account?: unknown;
    customer?: unknown;
...
export const PostFinancialConnectionsAccountsAccountSubscribeOutput =
  ...
  }) as unknown as Schema.Codec<PostFinancialConnectionsAccountsAccountSubscribeOutput>;
