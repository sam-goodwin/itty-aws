...
// Input Schema
export interface PostSubscriptionSchedulesScheduleCancelInput {
  schedule: string;
  expand?: string[];
  invoice_now?: boolean;
  prorate?: boolean;
...
export const PostSubscriptionSchedulesScheduleCancelInput =
  ...
  ) as unknown as Schema.Codec<PostSubscriptionSchedulesScheduleCancelInput>;

// Output Schema
export interface PostSubscriptionSchedulesScheduleCancelOutput {
  application:
    | string
...
export const PostSubscriptionSchedulesScheduleCancelOutput =
  ...
  }) as unknown as Schema.Codec<PostSubscriptionSchedulesScheduleCancelOutput>;
