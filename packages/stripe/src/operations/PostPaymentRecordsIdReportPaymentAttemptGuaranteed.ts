...
// Input Schema
export interface PostPaymentRecordsIdReportPaymentAttemptGuaranteedInput {
  id: string;
  expand?: string[];
...
export const PostPaymentRecordsIdReportPaymentAttemptGuaranteedInput =
  ...
  ) as unknown as Schema.Codec<PostPaymentRecordsIdReportPaymentAttemptGuaranteedInput>;

// Output Schema
export interface PostPaymentRecordsIdReportPaymentAttemptGuaranteedOutput {
...
export const PostPaymentRecordsIdReportPaymentAttemptGuaranteedOutput =
  ...
  }) as unknown as Schema.Codec<PostPaymentRecordsIdReportPaymentAttemptGuaranteedOutput>;
