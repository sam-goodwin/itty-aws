...
// Input Schema
export interface PostSubscriptionSchedulesScheduleInput {
  schedule: string;
  default_settings?: {
...
export const PostSubscriptionSchedulesScheduleInput =
  ...
  ) as unknown as Schema.Codec<PostSubscriptionSchedulesScheduleInput>;

// Output Schema
export interface PostSubscriptionSchedulesScheduleOutput {
  application:
    | string
...
export const PostSubscriptionSchedulesScheduleOutput =
  ...
  }) as unknown as Schema.Codec<PostSubscriptionSchedulesScheduleOutput>;
