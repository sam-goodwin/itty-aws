...
// Input Schema
export interface PostInvoicesInvoiceMarkUncollectibleInput {
  invoice: string;
  expand?: string[];
}
export const PostInvoicesInvoiceMarkUncollectibleInput =
  ...
  ) as unknown as Schema.Codec<PostInvoicesInvoiceMarkUncollectibleInput>;

// Output Schema
export interface PostInvoicesInvoiceMarkUncollectibleOutput {
...
export const PostInvoicesInvoiceMarkUncollectibleOutput =
  ...
  }) as unknown as Schema.Codec<PostInvoicesInvoiceMarkUncollectibleOutput>;
