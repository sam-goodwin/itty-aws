...
// Input Schema
export interface GetChargesChargeRefundsInput {
  charge: string;
...
export const GetChargesChargeRefundsInput =
  ...
  ) as unknown as Schema.Codec<GetChargesChargeRefundsInput>;

// Output Schema
export interface GetChargesChargeRefundsOutput {
  data: {
    amount: number;
    balance_transaction:
      | string
...
export const GetChargesChargeRefundsOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    url: Schema.String,
  }) as unknown as Schema.Codec<GetChargesChargeRefundsOutput>;
 ...
 */
export const GetChargesChargeRefunds = /*@__PURE__*/ API.make(() => ({
