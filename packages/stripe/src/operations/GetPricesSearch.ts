...
// Input Schema
export interface GetPricesSearchInput {
  expand?: string;
  limit?: number;
  page?: string;
  query: string;
...
) as unknown as Schema.Codec<GetPricesSearchInput>;

// Output Schema
export interface GetPricesSearchOutput {
  data: {
    active: boolean;
...
export const GetPricesSearchOutput = /*@__PURE__*/ Schema.Struct({
  ...
  url: Schema.String,
}) as unknown as Schema.Codec<GetPricesSearchOutput>;
