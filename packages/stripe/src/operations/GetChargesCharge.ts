...
// Input Schema
export interface GetChargesChargeInput {
  charge: string;
  expand?: string;
}
export const GetChargesChargeInput = /*@__PURE__*/ Schema.Struct({
...
) as unknown as Schema.Codec<GetChargesChargeInput>;

// Output Schema
export interface GetChargesChargeOutput {
  amount: number;
...
export const GetChargesChargeOutput = /*@__PURE__*/ Schema.Struct({
...
}) as unknown as Schema.Codec<GetChargesChargeOutput>;
 ...
 */
export const GetChargesCharge = /*@__PURE__*/ API.make(() => ({
