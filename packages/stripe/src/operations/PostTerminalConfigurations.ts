...
// Input Schema
export interface PostTerminalConfigurationsInput {
...
export const PostTerminalConfigurationsInput =
  ...
  ) as unknown as Schema.Codec<PostTerminalConfigurationsInput>;

// Output Schema
export interface PostTerminalConfigurationsOutput {
  bbpos_wisepad3?: {
    splashscreen?:
      | string
      | {
...
export const PostTerminalConfigurationsOutput =
  ...
  }) as unknown as Schema.Codec<PostTerminalConfigurationsOutput>;
