...
// Input Schema
export interface PostApplicationFeesIdRefundsInput {
  id: string;
  amount?: number;
  expand?: string[];
...
export const PostApplicationFeesIdRefundsInput =
  ...
  ) as unknown as Schema.Codec<PostApplicationFeesIdRefundsInput>;

// Output Schema
export interface PostApplicationFeesIdRefundsOutput {
  amount: number;
  balance_transaction:
    | string
    | {
...
export const PostApplicationFeesIdRefundsOutput =
  ...
  }) as unknown as Schema.Codec<PostApplicationFeesIdRefundsOutput>;
