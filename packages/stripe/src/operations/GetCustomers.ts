...
export const GetCustomersInput = /*@__PURE__*/ Schema.Struct({
...
) as unknown as Schema.Codec<GetCustomersInput>;
  ...
  data: {
    ...
    discount?: {
      ...
      customer:
        | string
        | unknown
        | { deleted: true; id: string; object: "customer" }
        | null;
      customer_account: string | null;
      end: number | null;
      id: string;
...
export const GetCustomersOutput = /*@__PURE__*/ Schema.Struct({
  data: Schema.Array(
    Schema.Struct({
  ...
  object: Schema.Literals(["list"]),
  url: Schema.String,
}) as unknown as Schema.Codec<GetCustomersOutput>;
 ...
 */
export const GetCustomers = /*@__PURE__*/ API.make(() => ({
