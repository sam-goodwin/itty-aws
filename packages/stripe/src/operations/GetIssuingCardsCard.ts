...
// Input Schema
export interface GetIssuingCardsCardInput {
  card: string;
  expand?: string;
}
export const GetIssuingCardsCardInput =
  ...
  ) as unknown as Schema.Codec<GetIssuingCardsCardInput>;

// Output Schema
export interface GetIssuingCardsCardOutput {
  brand: string;
  cancellation_reason:
    | "design_rejected"
    | "fulfillment_error"
...
export const GetIssuingCardsCardOutput =
  ...
  }) as unknown as Schema.Codec<GetIssuingCardsCardOutput>;
