...
// Input Schema
export interface PostPaymentMethodsPaymentMethodDetachInput {
...
export const PostPaymentMethodsPaymentMethodDetachInput =
  ...
  ) as unknown as Schema.Codec<PostPaymentMethodsPaymentMethodDetachInput>;

// Output Schema
export interface PostPaymentMethodsPaymentMethodDetachOutput {
  acss_debit?: {
...
export const PostPaymentMethodsPaymentMethodDetachOutput =
  ...
  }) as unknown as Schema.Codec<PostPaymentMethodsPaymentMethodDetachOutput>;
