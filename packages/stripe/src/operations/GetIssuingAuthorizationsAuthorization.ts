...
// Input Schema
export interface GetIssuingAuthorizationsAuthorizationInput {
...
export const GetIssuingAuthorizationsAuthorizationInput =
  ...
  ) as unknown as Schema.Codec<GetIssuingAuthorizationsAuthorizationInput>;

// Output Schema
export interface GetIssuingAuthorizationsAuthorizationOutput {
  amount: number;
  amount_details: {
    atm_fee: number | null;
...
export const GetIssuingAuthorizationsAuthorizationOutput =
  ...
  }) as unknown as Schema.Codec<GetIssuingAuthorizationsAuthorizationOutput>;
