...
// Input Schema
export interface PostPaymentIntentsIntentCancelInput {
  intent: string;
  cancellation_reason?:
    | "abandoned"
    | "duplicate"
...
export const PostPaymentIntentsIntentCancelInput =
  ...
  ) as unknown as Schema.Codec<PostPaymentIntentsIntentCancelInput>;

// Output Schema
export interface PostPaymentIntentsIntentCancelOutput {
  amount: number;
...
export const PostPaymentIntentsIntentCancelOutput =
  ...
  }) as unknown as Schema.Codec<PostPaymentIntentsIntentCancelOutput>;
