...
export const PostSubscriptionsInput = /*@__PURE__*/ Schema.Struct({
  ...
  cancel_at: Schema.optional(
    Schema.Union([
      Schema.Number,
      Schema.Literals(["max_billed_until", "max_period_end", "min_period_end"]),
    ]),
  ),
...
) as unknown as Schema.Codec<PostSubscriptionsInput>;

// Output Schema
export interface PostSubscriptionsOutput {
  application:
    | string
...
export const PostSubscriptionsOutput =
  ...
  }) as unknown as Schema.Codec<PostSubscriptionsOutput>;
