...
// Input Schema
export interface PostTransfersTransferReversalsIdInput {
  id: string;
  transfer: string;
  expand?: string[];
...
export const PostTransfersTransferReversalsIdInput =
  ...
  ) as unknown as Schema.Codec<PostTransfersTransferReversalsIdInput>;

// Output Schema
export interface PostTransfersTransferReversalsIdOutput {
  amount: number;
  balance_transaction:
    | string
    | {
...
export const PostTransfersTransferReversalsIdOutput =
  ...
  }) as unknown as Schema.Codec<PostTransfersTransferReversalsIdOutput>;
