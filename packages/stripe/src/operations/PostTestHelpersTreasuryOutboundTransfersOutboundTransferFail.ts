...
// Input Schema
export interface PostTestHelpersTreasuryOutboundTransfersOutboundTransferFailInput {
  outbound_transfer: string;
  expand?: string[];
}
export const PostTestHelpersTreasuryOutboundTransfersOutboundTransferFailInput =
  ...
  ) as unknown as Schema.Codec<PostTestHelpersTreasuryOutboundTransfersOutboundTransferFailInput>;

// Output Schema
export interface PostTestHelpersTreasuryOutboundTransfersOutboundTransferFailOutput {
  amount: number;
  cancelable: boolean;
  created: number;
  currency: string;
...
export const PostTestHelpersTreasuryOutboundTransfersOutboundTransferFailOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  }) as unknown as Schema.Codec<PostTestHelpersTreasuryOutboundTransfersOutboundTransferFailOutput>;
 ...
 */
export const PostTestHelpersTreasuryOutboundTransfersOutboundTransferFail =
  /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
    inputSchema:
      PostTestHelpersTreasuryOutboundTransfersOutboundTransferFailInput,
    outputSchema:
      PostTestHelpersTreasuryOutboundTransfersOutboundTransferFailOutput,
  }));
