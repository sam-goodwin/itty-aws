...
export const GetPaymentMethodsInput = /*@__PURE__*/ Schema.Struct({
...
) as unknown as Schema.Codec<GetPaymentMethodsInput>;
...
export interface GetPaymentMethodsOutput {
  data: {
    ...
    sepa_debit?: {
      ...
      country: string | null;
      fingerprint: string | null;
      generated_from: { charge: unknown; setup_attempt: unknown } | null;
      last4: string | null;
    };
...
export const GetPaymentMethodsOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    url: Schema.String,
  }) as unknown as Schema.Codec<GetPaymentMethodsOutput>;
 ...
 */
export const GetPaymentMethods = /*@__PURE__*/ API.make(() => ({
