...
// Input Schema
export interface PostTestHelpersTerminalReadersReaderTimeoutInputCollectionInput {
  reader: string;
  expand?: string[];
}
export const PostTestHelpersTerminalReadersReaderTimeoutInputCollectionInput =
  ...
  ) as unknown as Schema.Codec<PostTestHelpersTerminalReadersReaderTimeoutInputCollectionInput>;

// Output Schema
export interface PostTestHelpersTerminalReadersReaderTimeoutInputCollectionOutput {
  action: unknown;
...
export const PostTestHelpersTerminalReadersReaderTimeoutInputCollectionOutput =
  ...
  }) as unknown as Schema.Codec<PostTestHelpersTerminalReadersReaderTimeoutInputCollectionOutput>;
