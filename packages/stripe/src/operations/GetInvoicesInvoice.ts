...
// Input Schema
export interface GetInvoicesInvoiceInput {
  invoice: string;
  expand?: string;
}
export const GetInvoicesInvoiceInput =
  ...
  ) as unknown as Schema.Codec<GetInvoicesInvoiceInput>;

// Output Schema
export interface GetInvoicesInvoiceOutput {
...
export const GetInvoicesInvoiceOutput =
  ...
  }) as unknown as Schema.Codec<GetInvoicesInvoiceOutput>;
