...
// Input Schema
export interface PostPaymentIntentsInput {
  amount: number;
  amount_details?: {
...
export const PostPaymentIntentsInput =
  ...
  ) as unknown as Schema.Codec<PostPaymentIntentsInput>;

// Output Schema
export interface PostPaymentIntentsOutput {
  amount: number;
...
export const PostPaymentIntentsOutput =
  ...
  }) as unknown as Schema.Codec<PostPaymentIntentsOutput>;
