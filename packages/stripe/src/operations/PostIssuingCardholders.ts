...
// Input Schema
export const PostIssuingCardholdersInput = /*@__PURE__*/ Schema.Struct({
  ...
  spending_controls: Schema.optional(
    Schema.Struct({
      ...
      allowed_merchant_countries: Schema.optional(Schema.Array(Schema.String)),
      ...
      blocked_merchant_countries: Schema.optional(Schema.Array(Schema.String)),
...
export type PostIssuingCardholdersInput =
  typeof PostIssuingCardholdersInput.Type;

// Output Schema
export const PostIssuingCardholdersOutput = /*@__PURE__*/ Schema.Struct({
  billing: Schema.Struct({
    address: Schema.Struct({
...
export type PostIssuingCardholdersOutput =
  typeof PostIssuingCardholdersOutput.Type;
