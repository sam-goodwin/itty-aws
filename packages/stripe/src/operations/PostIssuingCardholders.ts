...
// Input Schema
export interface PostIssuingCardholdersInput {
  billing: {
    address: {
      city: string;
      country: string;
...
export const PostIssuingCardholdersInput =
  ...
  ) as unknown as Schema.Codec<PostIssuingCardholdersInput>;

// Output Schema
export interface PostIssuingCardholdersOutput {
  billing: {
    address: {
      city: string | null;
      country: string | null;
...
export const PostIssuingCardholdersOutput =
  ...
  }) as unknown as Schema.Codec<PostIssuingCardholdersOutput>;
