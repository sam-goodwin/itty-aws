...
// Input Schema
export interface PostWebhookEndpointsWebhookEndpointInput {
...
export const PostWebhookEndpointsWebhookEndpointInput =
  ...
  ) as unknown as Schema.Codec<PostWebhookEndpointsWebhookEndpointInput>;

// Output Schema
export interface PostWebhookEndpointsWebhookEndpointOutput {
...
export const PostWebhookEndpointsWebhookEndpointOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    url: Schema.String,
  }) as unknown as Schema.Codec<PostWebhookEndpointsWebhookEndpointOutput>;
