...
// Input Schema
export interface PostTestHelpersTreasuryInboundTransfersIdSucceedInput {
  id: string;
  expand?: string[];
}
export const PostTestHelpersTreasuryInboundTransfersIdSucceedInput =
  ...
  ) as unknown as Schema.Codec<PostTestHelpersTreasuryInboundTransfersIdSucceedInput>;

// Output Schema
export interface PostTestHelpersTreasuryInboundTransfersIdSucceedOutput {
  amount: number;
  cancelable: boolean;
  created: number;
  currency: string;
...
export const PostTestHelpersTreasuryInboundTransfersIdSucceedOutput =
  ...
  }) as unknown as Schema.Codec<PostTestHelpersTreasuryInboundTransfersIdSucceedOutput>;
