...
// Input Schema
export const PostV2CoreAccountsIdInput = /*@__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "POST", path: "/v2/core/accounts/{id}" }));
export type PostV2CoreAccountsIdInput = typeof PostV2CoreAccountsIdInput.Type;

// Output Schema
export const PostV2CoreAccountsIdOutput = /*@__PURE__*/ Schema.Struct({
...
export type PostV2CoreAccountsIdOutput = typeof PostV2CoreAccountsIdOutput.Type;
