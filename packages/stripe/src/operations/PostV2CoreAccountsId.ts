...
// Input Schema
export interface PostV2CoreAccountsIdInput {
  id: string;
  ...
  configuration?: {
    customer?: {
      ...
      capabilities?: { automatic_indirect_tax?: { requested?: boolean } };
      shipping?: {
        address?: {
          city?: string;
          country?: string;
    ...
    merchant?: {
      ...
      capabilities?: {
        ach_debit_payments?: { requested?: boolean };
      ...
      konbini_payments?: {
        support?: {
          email?: string;
          hours?: { end_time?: string; start_time?: string };
          phone?: string;
        };
      };
      mcc?: string;
      script_statement_descriptor?: {
        kana?: { descriptor?: string; prefix?: string };
        kanji?: { descriptor?: string; prefix?: string };
      };
    ...
    recipient?: {
      applied?: boolean;
      capabilities?: {
        stripe_balance?: { stripe_transfers?: { requested?: boolean } };
      };
    };
  };
  ...
  defaults?: {
    ...
    responsibilities?: {
      fees_collector:
        ...
        | "application_express"
        | "stripe";
      losses_collector: "application" | "stripe";
    };
  };
  display_name?: string;
  identity?: {
    attestations?: {
      ...
      terms_of_service?: {
        ...
        money_manager?: { date?: string; ip?: string; user_agent?: string };
      };
    };
    business_details?: {
      address?: {
...
export const PostV2CoreAccountsIdInput =
  /*@__PURE__*/ Schema.Struct({
    ...
    defaults: Schema.optional(
      Schema.Struct({
        ...
        responsibilities: Schema.optional(
          Schema.Struct({
            fees_collector: Schema.Literals([
              "application",
              "application_custom",
              "application_express",
              "stripe",
            ]),
            losses_collector: Schema.Literals(["application", "stripe"]),
          }),
        ),
      }),
    ),
    ...
    T.Http({ method: "POST", path: "/v2/core/accounts/{id}" }),
  ) as unknown as Schema.Codec<PostV2CoreAccountsIdInput>;

// Output Schema
export interface PostV2CoreAccountsIdOutput {
  ...
  configuration?: {
    customer?: {
      ...
      capabilities?: {
        automatic_indirect_tax?: {
          status: "active" | "pending" | "restricted" | "unsupported";
          status_details: {
            code:
              | "determining_status"
            ...
            resolution: "contact_stripe" | "no_resolution" | "provide_info";
          }[];
        };
      };
      shipping?: {
    ...
    merchant?: {
      ...
      sepa_debit_payments?: { creditor_id?: string };
      statement_descriptor?: { descriptor?: string; prefix?: string };
      support?: {
        address?: {
          city?: string;
  ...
  defaults?: {
    ...
    responsibilities: {
      fees_collector?:
        ...
        | "stripe";
      losses_collector?: "application" | "stripe";
      requirements_collector: "application" | "stripe";
    };
  };
  display_name?: string;
  future_requirements?: {
    entries?: {
      ...
      impact: {
        restricts_capabilities?: {
          capability:
            ...
            | "us_bank_transfer_payments"
            | "zip_payments";
          configuration: "customer" | "merchant" | "recipient";
          deadline: { status: "currently_due" | "eventually_due" | "past_due" };
        }[];
      };
      minimum_deadline: {
      ...
      reference?: {
        inquiry?: string;
        resource?: string;
        type: "inquiry" | "payment_method" | "person";
      };
      requested_reasons: {
        code: "routine_onboarding" | "routine_verification";
      }[];
    }[];
...
export const PostV2CoreAccountsIdOutput =
  ...
  }) as unknown as Schema.Codec<PostV2CoreAccountsIdOutput>;
