...
// Input Schema
export interface GetCheckoutSessionsInput {
  created?: string;
  customer?: string;
...
export const GetCheckoutSessionsInput =
  ...
  ) as unknown as Schema.Codec<GetCheckoutSessionsInput>;

// Output Schema
export interface GetCheckoutSessionsOutput {
  data: {
...
export const GetCheckoutSessionsOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
      ...
      Schema.Struct({
        ...
        consent_collection: Schema.NullOr(
          Schema.Struct({
            ...
            terms_of_service: Schema.NullOr(
    ...
    object: Schema.Literals(["list"]),
    url: Schema.String,
  }) as unknown as Schema.Codec<GetCheckoutSessionsOutput>;
