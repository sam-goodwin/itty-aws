...
// Input Schema
export interface GetSubscriptionSchedulesScheduleInput {
  schedule: string;
  expand?: string;
}
export const GetSubscriptionSchedulesScheduleInput =
  ...
  ) as unknown as Schema.Codec<GetSubscriptionSchedulesScheduleInput>;

// Output Schema
export interface GetSubscriptionSchedulesScheduleOutput {
  application:
    | string
...
export const GetSubscriptionSchedulesScheduleOutput =
  ...
  }) as unknown as Schema.Codec<GetSubscriptionSchedulesScheduleOutput>;
