...
// Input Schema
export interface PostSubscriptionsSubscriptionResumeInput {
  subscription: string;
...
export const PostSubscriptionsSubscriptionResumeInput =
  ...
  ) as unknown as Schema.Codec<PostSubscriptionsSubscriptionResumeInput>;

// Output Schema
export interface PostSubscriptionsSubscriptionResumeOutput {
  application:
    | string
...
export const PostSubscriptionsSubscriptionResumeOutput =
  ...
  }) as unknown as Schema.Codec<PostSubscriptionsSubscriptionResumeOutput>;
