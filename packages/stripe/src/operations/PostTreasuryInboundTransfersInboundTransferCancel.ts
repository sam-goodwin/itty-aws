...
// Input Schema
export interface PostTreasuryInboundTransfersInboundTransferCancelInput {
...
export const PostTreasuryInboundTransfersInboundTransferCancelInput =
  ...
  ) as unknown as Schema.Codec<PostTreasuryInboundTransfersInboundTransferCancelInput>;

// Output Schema
export interface PostTreasuryInboundTransfersInboundTransferCancelOutput {
  amount: number;
  cancelable: boolean;
  created: number;
  currency: string;
...
export const PostTreasuryInboundTransfersInboundTransferCancelOutput =
  ...
  }) as unknown as Schema.Codec<PostTreasuryInboundTransfersInboundTransferCancelOutput>;
