...
// Input Schema
export interface PostFinancialConnectionsAccountsAccountDisconnectInput {
  account: string;
  expand?: string[];
}
export const PostFinancialConnectionsAccountsAccountDisconnectInput =
  ...
  ) as unknown as Schema.Codec<PostFinancialConnectionsAccountsAccountDisconnectInput>;

// Output Schema
export interface PostFinancialConnectionsAccountsAccountDisconnectOutput {
  account_holder: {
    account?: unknown;
    customer?: unknown;
...
export const PostFinancialConnectionsAccountsAccountDisconnectOutput =
    ...
    balance: Schema.NullOr(
      Schema.Struct({
        ...
        credit: Schema.optional(
          Schema.Struct({
            used: Schema.NullOr(Schema.Record(Schema.String, Schema.Number)),
          }),
        ),
    ...
    ownership: Schema.NullOr(
      Schema.Union([
        ...
        Schema.Struct({
          created: Schema.Number,
          id: Schema.String,
          object: Schema.Literals(["financial_connections.account_ownership"]),
  ...
  }) as unknown as Schema.Codec<PostFinancialConnectionsAccountsAccountDisconnectOutput>;
