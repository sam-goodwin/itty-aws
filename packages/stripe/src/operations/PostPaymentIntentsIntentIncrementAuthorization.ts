...
// Input Schema
export interface PostPaymentIntentsIntentIncrementAuthorizationInput {
  intent: string;
  amount: number;
  amount_details?: {
...
export const PostPaymentIntentsIntentIncrementAuthorizationInput =
  ...
  ) as unknown as Schema.Codec<PostPaymentIntentsIntentIncrementAuthorizationInput>;

// Output Schema
export interface PostPaymentIntentsIntentIncrementAuthorizationOutput {
  amount: number;
...
export const PostPaymentIntentsIntentIncrementAuthorizationOutput =
  ...
  }) as unknown as Schema.Codec<PostPaymentIntentsIntentIncrementAuthorizationOutput>;
