...
// Input Schema
export interface PostTestHelpersIssuingAuthorizationsAuthorizationCaptureInput {
...
export const PostTestHelpersIssuingAuthorizationsAuthorizationCaptureInput =
  ...
  ) as unknown as Schema.Codec<PostTestHelpersIssuingAuthorizationsAuthorizationCaptureInput>;

// Output Schema
export interface PostTestHelpersIssuingAuthorizationsAuthorizationCaptureOutput {
  amount: number;
  amount_details: {
    atm_fee: number | null;
...
export const PostTestHelpersIssuingAuthorizationsAuthorizationCaptureOutput =
  ...
  }) as unknown as Schema.Codec<PostTestHelpersIssuingAuthorizationsAuthorizationCaptureOutput>;
