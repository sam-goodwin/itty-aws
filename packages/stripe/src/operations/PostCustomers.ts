...
// Input Schema
export interface PostCustomersInput {
  address?:
    | {
        city?: string;
        country?: string;
...
) as unknown as Schema.Codec<PostCustomersInput>;

// Output Schema
export interface PostCustomersOutput {
  address?: {
    city: string | null;
    country: string | null;
    line1: string | null;
...
}) as unknown as Schema.Codec<PostCustomersOutput>;
