...
// Input Schema
export const GetCreditNotesCreditNoteLinesInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const GetCreditNotesCreditNoteLinesOutput = /*@__PURE__*/ Schema.Struct({
  data: Schema.Array(
    Schema.Struct({
 ...
 */
export const GetCreditNotesCreditNoteLines = /*@__PURE__*/ API.make(() => ({
