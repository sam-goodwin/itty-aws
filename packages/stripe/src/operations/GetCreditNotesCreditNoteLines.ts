...
// Input Schema
export interface GetCreditNotesCreditNoteLinesInput {
  credit_note: string;
...
export const GetCreditNotesCreditNoteLinesInput =
  ...
  ) as unknown as Schema.Codec<GetCreditNotesCreditNoteLinesInput>;

// Output Schema
export interface GetCreditNotesCreditNoteLinesOutput {
  data: {
    amount: number;
...
export const GetCreditNotesCreditNoteLinesOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    url: Schema.String,
  }) as unknown as Schema.Codec<GetCreditNotesCreditNoteLinesOutput>;
