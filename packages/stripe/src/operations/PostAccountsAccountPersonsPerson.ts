...
export type PostAccountsAccountPersonsPersonInput =
  typeof PostAccountsAccountPersonsPersonInput.Type;
...
export type PostAccountsAccountPersonsPersonOutput =
  typeof PostAccountsAccountPersonsPersonOutput.Type;
