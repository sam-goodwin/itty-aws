...
// Input Schema
export interface PostAccountsAccountPersonsPersonInput {
  account: string;
  person: string;
...
export const PostAccountsAccountPersonsPersonInput =
  ...
  ) as unknown as Schema.Codec<PostAccountsAccountPersonsPersonInput>;

// Output Schema
export interface PostAccountsAccountPersonsPersonOutput {
  account?: string;
  additional_tos_acceptances?: {
    account: {
      date: number | null;
...
export const PostAccountsAccountPersonsPersonOutput =
  ...
  }) as unknown as Schema.Codec<PostAccountsAccountPersonsPersonOutput>;
