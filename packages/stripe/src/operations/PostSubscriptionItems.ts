...
// Input Schema
export interface PostSubscriptionItemsInput {
...
export const PostSubscriptionItemsInput =
  ...
  ) as unknown as Schema.Codec<PostSubscriptionItemsInput>;

// Output Schema
export interface PostSubscriptionItemsOutput {
  billed_until?: number;
...
export const PostSubscriptionItemsOutput =
  ...
  }) as unknown as Schema.Codec<PostSubscriptionItemsOutput>;
