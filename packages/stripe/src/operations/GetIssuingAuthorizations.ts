...
// Input Schema
export interface GetIssuingAuthorizationsInput {
  card?: string;
  cardholder?: string;
  created?: string;
...
export const GetIssuingAuthorizationsInput =
  ...
  ) as unknown as Schema.Codec<GetIssuingAuthorizationsInput>;

// Output Schema
export interface GetIssuingAuthorizationsOutput {
  data: {
    amount: number;
    amount_details: {
      atm_fee: number | null;
    ...
    card: {
      ...
      cardholder: {
        ...
        id: string;
        individual: {
          card_issuing?: { user_terms_acceptance: unknown } | null;
          dob: {
            day: number | null;
            month: number | null;
            year: number | null;
          ...
          verification: { document: unknown } | null;
        } | null;
        livemode: boolean;
      ...
      personalization_design:
        ...
        | null;
      replaced_by: string | unknown | null;
      replacement_for: string | unknown | null;
      replacement_reason:
        | "damaged"
        | "expired"
        | "fulfillment_error"
    ...
    card_presence: "not_present" | "present" | null;
    cardholder:
      | string
      | {
          billing: {
    ...
    transactions: {
      ...
      authorization: string | unknown | null;
      balance_transaction:
        | string
        | {
            amount: number;
...
export const GetIssuingAuthorizationsOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
      ...
      Schema.Struct({
        ...
        card: Schema.Struct({
            ...
            individual: Schema.NullOr(
              Schema.Struct({
                card_issuing: Schema.optional(
                  Schema.NullOr(
                    Schema.Struct({
                      user_terms_acceptance: Schema.Unknown,
                    }),
                  ),
                ),
                dob: Schema.NullOr(
          ...
          spending_controls: Schema.Struct({
            ...
            allowed_merchant_countries: Schema.NullOr(
            ...
            blocked_merchant_countries: Schema.NullOr(
              Schema.Array(Schema.String),
            ),
        ...
        card_presence: Schema.NullOr(
          Schema.Literals(["not_present", "present"]),
        ),
            ...
            cardholder: Schema.NullOr(
              Schema.Union([
                ...
                Schema.Struct({
                  ...
                  preferred_locales: Schema.NullOr(
                    Schema.Array(
                      Schema.Literals(["de", "en", "es", "fr", "it"]),
                    ),
                  ),
                  requirements: Schema.Struct({
                    disabled_reason: Schema.NullOr(
                      ...
                      segments: Schema.NullOr(
                        Schema.Array(
                          Schema.Struct({
                            ...
                            departure_airport_code: Schema.NullOr(
                              Schema.String,
                            ),
                      ...
                      Schema.Struct({
                        ...
                        mastercard: Schema.optional(
                          Schema.Struct({
                            ...
                            token_reference_id: Schema.String,
                            token_requestor_id: Schema.String,
                            token_requestor_name: Schema.optional(
                              Schema.String,
                            ),
                          }),
                        ),
        ...
        verification_data: Schema.Struct({
          ...
          authentication_exemption: Schema.NullOr(
            Schema.Struct({
              claimed_by: Schema.Literals(["acquirer", "issuer"]),
              type: Schema.Literals([
    ...
    object: Schema.Literals(["list"]),
    url: Schema.String,
  }) as unknown as Schema.Codec<GetIssuingAuthorizationsOutput>;
