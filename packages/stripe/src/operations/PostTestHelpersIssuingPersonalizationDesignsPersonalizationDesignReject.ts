...
// Input Schema
export interface PostTestHelpersIssuingPersonalizationDesignsPersonalizationDesignRejectInput {
...
export const PostTestHelpersIssuingPersonalizationDesignsPersonalizationDesignRejectInput =
  ...
  ) as unknown as Schema.Codec<PostTestHelpersIssuingPersonalizationDesignsPersonalizationDesignRejectInput>;

// Output Schema
export interface PostTestHelpersIssuingPersonalizationDesignsPersonalizationDesignRejectOutput {
  card_logo:
    | string
    | {
        created: number;
...
export const PostTestHelpersIssuingPersonalizationDesignsPersonalizationDesignRejectOutput =
  ...
  }) as unknown as Schema.Codec<PostTestHelpersIssuingPersonalizationDesignsPersonalizationDesignRejectOutput>;
