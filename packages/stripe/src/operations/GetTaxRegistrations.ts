...
// Input Schema
export const GetTaxRegistrationsInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const GetTaxRegistrationsOutput = /*@__PURE__*/ Schema.Struct({
  data: Schema.Array(
    Schema.Struct({
 ...
 */
export const GetTaxRegistrations = /*@__PURE__*/ API.make(() => ({
