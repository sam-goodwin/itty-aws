...
// Input Schema
export interface PostBillingCreditGrantsIdInput {
  id: string;
  expand?: string[];
  expires_at?: number | "";
...
export const PostBillingCreditGrantsIdInput =
  ...
  ) as unknown as Schema.Codec<PostBillingCreditGrantsIdInput>;

// Output Schema
export interface PostBillingCreditGrantsIdOutput {
  amount: {
...
export const PostBillingCreditGrantsIdOutput =
  ...
  }) as unknown as Schema.Codec<PostBillingCreditGrantsIdOutput>;
 ...
 */
export const PostBillingCreditGrantsId = /*@__PURE__*/ API.make(() => ({
