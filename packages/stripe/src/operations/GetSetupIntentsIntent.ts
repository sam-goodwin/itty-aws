...
// Input Schema
export interface GetSetupIntentsIntentInput {
  intent: string;
...
export const GetSetupIntentsIntentInput =
  ...
  ) as unknown as Schema.Codec<GetSetupIntentsIntentInput>;

// Output Schema
export interface GetSetupIntentsIntentOutput {
  application:
    | string
...
export const GetSetupIntentsIntentOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    usage: Schema.String,
  }) as unknown as Schema.Codec<GetSetupIntentsIntentOutput>;
