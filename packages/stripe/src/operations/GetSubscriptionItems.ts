...
// Input Schema
export interface GetSubscriptionItemsInput {
...
export const GetSubscriptionItemsInput =
  ...
  ) as unknown as Schema.Codec<GetSubscriptionItemsInput>;

// Output Schema
export interface GetSubscriptionItemsOutput {
  data: {
    billed_until?: number;
...
export const GetSubscriptionItemsOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    url: Schema.String,
  }) as unknown as Schema.Codec<GetSubscriptionItemsOutput>;
