...
// Input Schema
export interface PostSubscriptionSchedulesScheduleReleaseInput {
  schedule: string;
  expand?: string[];
...
export const PostSubscriptionSchedulesScheduleReleaseInput =
  ...
  ) as unknown as Schema.Codec<PostSubscriptionSchedulesScheduleReleaseInput>;

// Output Schema
export interface PostSubscriptionSchedulesScheduleReleaseOutput {
  application:
    | string
...
export const PostSubscriptionSchedulesScheduleReleaseOutput =
  ...
  }) as unknown as Schema.Codec<PostSubscriptionSchedulesScheduleReleaseOutput>;
