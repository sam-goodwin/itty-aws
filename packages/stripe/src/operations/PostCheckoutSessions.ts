...
// Input Schema
export const PostCheckoutSessionsInput = /*@__PURE__*/ Schema.Struct({
  ...
  metadata: Schema.optional(Schema.Record(Schema.String, Schema.String)),
  mode: Schema.optional(Schema.Literals(["payment", "setup", "subscription"])),
...
// Output Schema
export const PostCheckoutSessionsOutput = /*@__PURE__*/ Schema.Struct({
