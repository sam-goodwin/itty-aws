...
// Input Schema
export interface PostInvoicesInvoiceInput {
  invoice: string;
...
export const PostInvoicesInvoiceInput =
  ...
  ) as unknown as Schema.Codec<PostInvoicesInvoiceInput>;

// Output Schema
export interface PostInvoicesInvoiceOutput {
...
export const PostInvoicesInvoiceOutput =
  ...
  }) as unknown as Schema.Codec<PostInvoicesInvoiceOutput>;
