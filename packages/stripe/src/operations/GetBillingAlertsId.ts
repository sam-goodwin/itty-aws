...
// Input Schema
export interface GetBillingAlertsIdInput {
  id: string;
  expand?: string;
}
export const GetBillingAlertsIdInput =
  ...
  ) as unknown as Schema.Codec<GetBillingAlertsIdInput>;

// Output Schema
export interface GetBillingAlertsIdOutput {
...
export const GetBillingAlertsIdOutput =
  ...
  }) as unknown as Schema.Codec<GetBillingAlertsIdOutput>;
