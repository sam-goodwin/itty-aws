...
// Input Schema
export const GetCustomersCustomerSourcesIdInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const GetCustomersCustomerSourcesIdOutput = /*@__PURE__*/ Schema.Unknown;
 ...
 */
export const GetCustomersCustomerSourcesId = /*@__PURE__*/ API.make(() => ({
