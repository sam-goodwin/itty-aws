...
// Input Schema
export interface PostTaxTransactionsCreateFromCalculationInput {
  calculation: string;
  expand?: string[];
...
export const PostTaxTransactionsCreateFromCalculationInput =
  ...
  ) as unknown as Schema.Codec<PostTaxTransactionsCreateFromCalculationInput>;

// Output Schema
export interface PostTaxTransactionsCreateFromCalculationOutput {
  created: number;
  currency: string;
...
export const PostTaxTransactionsCreateFromCalculationOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    type: Schema.Literals(["reversal", "transaction"]),
  }) as unknown as Schema.Codec<PostTaxTransactionsCreateFromCalculationOutput>;
