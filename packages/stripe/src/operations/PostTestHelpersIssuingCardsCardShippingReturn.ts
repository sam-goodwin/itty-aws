...
// Input Schema
export interface PostTestHelpersIssuingCardsCardShippingReturnInput {
  card: string;
  expand?: string[];
}
export const PostTestHelpersIssuingCardsCardShippingReturnInput =
  ...
  ) as unknown as Schema.Codec<PostTestHelpersIssuingCardsCardShippingReturnInput>;

// Output Schema
export interface PostTestHelpersIssuingCardsCardShippingReturnOutput {
  brand: string;
  cancellation_reason:
    | "design_rejected"
    | "fulfillment_error"
...
export const PostTestHelpersIssuingCardsCardShippingReturnOutput =
  /*@__PURE__*/ Schema.Struct({
    brand: Schema.String,
  ...
  }) as unknown as Schema.Codec<PostTestHelpersIssuingCardsCardShippingReturnOutput>;
 ...
 */
export const PostTestHelpersIssuingCardsCardShippingReturn =
  /*@__PURE__*/ API.make(() => ({
    inputSchema: PostTestHelpersIssuingCardsCardShippingReturnInput,
    outputSchema: PostTestHelpersIssuingCardsCardShippingReturnOutput,
  }));
