...
// Input Schema
export interface GetCreditNotesInput {
  created?: string;
  customer?: string;
...
) as unknown as Schema.Codec<GetCreditNotesInput>;

// Output Schema
export interface GetCreditNotesOutput {
  data: {
    amount: number;
    ...
    customer_balance_transaction:
      ...
      | {
          ...
          created: number;
          credit_note: string | unknown | null;
          currency: string;
          customer: unknown;
          customer_account: string | null;
...
export const GetCreditNotesOutput = /*@__PURE__*/ Schema.Struct({
                    ...
                    Schema.Struct({
                      ...
                      credit: Schema.NullOr(
                        Schema.Struct({
                          ...
                          credits_application_invoice_voided: Schema.Unknown,
                          type: Schema.Literals([
                            "credits_application_invoice_voided",
                            "credits_granted",
                          ]),
  ...
  object: Schema.Literals(["list"]),
  url: Schema.String,
}) as unknown as Schema.Codec<GetCreditNotesOutput>;
