...
// Input Schema
export interface PostAccountsAccountInput {
  account: string;
...
export const PostAccountsAccountInput =
    ...
    settings: Schema.optional(
      Schema.Struct({
        ...
        invoices: Schema.optional(
          Schema.Struct({
            default_account_tax_ids: Schema.optional(
              Schema.Union([
  ...
  ) as unknown as Schema.Codec<PostAccountsAccountInput>;

// Output Schema
export interface PostAccountsAccountOutput {
  business_profile?: {
    annual_revenue?: {
      amount: number | null;
...
export const PostAccountsAccountOutput =
  ...
  }) as unknown as Schema.Codec<PostAccountsAccountOutput>;
