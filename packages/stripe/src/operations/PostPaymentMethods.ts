...
// Input Schema
export interface PostPaymentMethodsInput {
  acss_debit?: {
...
export const PostPaymentMethodsInput =
  ...
  ) as unknown as Schema.Codec<PostPaymentMethodsInput>;

// Output Schema
export interface PostPaymentMethodsOutput {
  acss_debit?: {
...
export const PostPaymentMethodsOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    wechat_pay: Schema.optional(Schema.Struct({})),
    zip: Schema.optional(Schema.Struct({})),
  }) as unknown as Schema.Codec<PostPaymentMethodsOutput>;
