...
// Input Schema
export interface PostIdentityVerificationSessionsSessionCancelInput {
  session: string;
  expand?: string[];
}
export const PostIdentityVerificationSessionsSessionCancelInput =
  ...
  ) as unknown as Schema.Codec<PostIdentityVerificationSessionsSessionCancelInput>;

// Output Schema
export interface PostIdentityVerificationSessionsSessionCancelOutput {
...
export const PostIdentityVerificationSessionsSessionCancelOutput =
  ...
  }) as unknown as Schema.Codec<PostIdentityVerificationSessionsSessionCancelOutput>;
