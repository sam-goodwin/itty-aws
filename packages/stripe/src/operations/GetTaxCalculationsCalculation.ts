...
// Input Schema
export const GetTaxCalculationsCalculationInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const GetTaxCalculationsCalculationOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const GetTaxCalculationsCalculation = /*@__PURE__*/ API.make(() => ({
