...
// Input Schema
export const PostBillingCreditGrantsIdVoidInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const PostBillingCreditGrantsIdVoidOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const PostBillingCreditGrantsIdVoid = /*@__PURE__*/ API.make(() => ({
