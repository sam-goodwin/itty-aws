...
// Input Schema
export interface PostFinancialConnectionsAccountsAccountUnsubscribeInput {
  account: string;
  expand?: string[];
...
export const PostFinancialConnectionsAccountsAccountUnsubscribeInput =
  ...
  ) as unknown as Schema.Codec<PostFinancialConnectionsAccountsAccountUnsubscribeInput>;

// Output Schema
export interface PostFinancialConnectionsAccountsAccountUnsubscribeOutput {
  account_holder: {
    account?: unknown;
    customer?: unknown;
...
export const PostFinancialConnectionsAccountsAccountUnsubscribeOutput =
  ...
  }) as unknown as Schema.Codec<PostFinancialConnectionsAccountsAccountUnsubscribeOutput>;
