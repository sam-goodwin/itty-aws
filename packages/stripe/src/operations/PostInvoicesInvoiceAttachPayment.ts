...
// Input Schema
export interface PostInvoicesInvoiceAttachPaymentInput {
  invoice: string;
  expand?: string[];
...
export const PostInvoicesInvoiceAttachPaymentInput =
  ...
  ) as unknown as Schema.Codec<PostInvoicesInvoiceAttachPaymentInput>;

// Output Schema
export interface PostInvoicesInvoiceAttachPaymentOutput {
...
export const PostInvoicesInvoiceAttachPaymentOutput =
  ...
  }) as unknown as Schema.Codec<PostInvoicesInvoiceAttachPaymentOutput>;
