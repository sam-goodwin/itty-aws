...
// Input Schema
export interface GetTaxIdsIdInput {
  id: string;
  expand?: string;
}
...
) as unknown as Schema.Codec<GetTaxIdsIdInput>;

// Output Schema
export interface GetTaxIdsIdOutput {
  country: string | null;
  created: number;
  customer: unknown;
...
}) as unknown as Schema.Codec<GetTaxIdsIdOutput>;
