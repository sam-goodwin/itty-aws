...
// Input Schema
export interface GetChargesChargeRefundsRefundInput {
  charge: string;
  refund: string;
  expand?: string;
}
export const GetChargesChargeRefundsRefundInput =
  ...
  ) as unknown as Schema.Codec<GetChargesChargeRefundsRefundInput>;

// Output Schema
export interface GetChargesChargeRefundsRefundOutput {
  amount: number;
  balance_transaction:
    | string
    | {
...
export const GetChargesChargeRefundsRefundOutput =
  ...
  }) as unknown as Schema.Codec<GetChargesChargeRefundsRefundOutput>;
