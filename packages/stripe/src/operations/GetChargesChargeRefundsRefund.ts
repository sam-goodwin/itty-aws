...
// Input Schema
export const GetChargesChargeRefundsRefundInput = /*@__PURE__*/ Schema.Struct({
...
export type GetChargesChargeRefundsRefundInput =
  typeof GetChargesChargeRefundsRefundInput.Type;

// Output Schema
export const GetChargesChargeRefundsRefundOutput = /*@__PURE__*/ Schema.Struct({
...
export type GetChargesChargeRefundsRefundOutput =
  typeof GetChargesChargeRefundsRefundOutput.Type;
 ...
 */
export const GetChargesChargeRefundsRefund = /*@__PURE__*/ API.make(() => ({
