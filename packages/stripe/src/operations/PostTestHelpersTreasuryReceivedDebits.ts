...
// Input Schema
export interface PostTestHelpersTreasuryReceivedDebitsInput {
  amount: number;
  currency: string;
  description?: string;
  expand?: string[];
...
export const PostTestHelpersTreasuryReceivedDebitsInput =
  ...
  ) as unknown as Schema.Codec<PostTestHelpersTreasuryReceivedDebitsInput>;

// Output Schema
export interface PostTestHelpersTreasuryReceivedDebitsOutput {
  amount: number;
  created: number;
  currency: string;
  description: string;
...
export const PostTestHelpersTreasuryReceivedDebitsOutput =
  ...
  }) as unknown as Schema.Codec<PostTestHelpersTreasuryReceivedDebitsOutput>;
