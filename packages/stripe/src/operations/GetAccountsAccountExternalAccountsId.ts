...
// Input Schema
export interface GetAccountsAccountExternalAccountsIdInput {
  account: string;
  id: string;
  expand?: string;
}
export const GetAccountsAccountExternalAccountsIdInput =
  ...
  ) as unknown as Schema.Codec<GetAccountsAccountExternalAccountsIdInput>;
...
export const GetAccountsAccountExternalAccountsIdOutput =
  ...
  ]) as unknown as Schema.Codec<GetAccountsAccountExternalAccountsIdOutput>;
