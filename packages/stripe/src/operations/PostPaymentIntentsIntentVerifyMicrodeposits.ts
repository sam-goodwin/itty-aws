...
// Input Schema
export interface PostPaymentIntentsIntentVerifyMicrodepositsInput {
  intent: string;
  amounts?: number[];
...
export const PostPaymentIntentsIntentVerifyMicrodepositsInput =
  ...
  ) as unknown as Schema.Codec<PostPaymentIntentsIntentVerifyMicrodepositsInput>;

// Output Schema
export interface PostPaymentIntentsIntentVerifyMicrodepositsOutput {
  amount: number;
...
export const PostPaymentIntentsIntentVerifyMicrodepositsOutput =
  ...
  }) as unknown as Schema.Codec<PostPaymentIntentsIntentVerifyMicrodepositsOutput>;
