...
// Input Schema
export interface DeleteSubscriptionsSubscriptionExposedIdInput {
...
export const DeleteSubscriptionsSubscriptionExposedIdInput =
  ...
  ) as unknown as Schema.Codec<DeleteSubscriptionsSubscriptionExposedIdInput>;

// Output Schema
export interface DeleteSubscriptionsSubscriptionExposedIdOutput {
  application:
    | string
...
export const DeleteSubscriptionsSubscriptionExposedIdOutput =
  ...
  }) as unknown as Schema.Codec<DeleteSubscriptionsSubscriptionExposedIdOutput>;
