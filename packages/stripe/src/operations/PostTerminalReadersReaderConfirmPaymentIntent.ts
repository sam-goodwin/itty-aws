...
// Input Schema
export interface PostTerminalReadersReaderConfirmPaymentIntentInput {
  reader: string;
...
export const PostTerminalReadersReaderConfirmPaymentIntentInput =
  ...
  ) as unknown as Schema.Codec<PostTerminalReadersReaderConfirmPaymentIntentInput>;

// Output Schema
export interface PostTerminalReadersReaderConfirmPaymentIntentOutput {
  action: unknown;
...
export const PostTerminalReadersReaderConfirmPaymentIntentOutput =
  ...
  }) as unknown as Schema.Codec<PostTerminalReadersReaderConfirmPaymentIntentOutput>;
