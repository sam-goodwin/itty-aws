...
// Input Schema
export interface PostIssuingAuthorizationsAuthorizationInput {
...
export const PostIssuingAuthorizationsAuthorizationInput =
  ...
  ) as unknown as Schema.Codec<PostIssuingAuthorizationsAuthorizationInput>;

// Output Schema
export interface PostIssuingAuthorizationsAuthorizationOutput {
  amount: number;
  amount_details: {
    atm_fee: number | null;
...
export const PostIssuingAuthorizationsAuthorizationOutput =
  ...
  }) as unknown as Schema.Codec<PostIssuingAuthorizationsAuthorizationOutput>;
