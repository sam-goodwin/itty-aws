...
// Input Schema
export const GetTreasuryFinancialAccountsInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const GetTreasuryFinancialAccountsOutput = /*@__PURE__*/ Schema.Struct({
  data: Schema.Array(
    Schema.Struct({
 ...
 */
export const GetTreasuryFinancialAccounts = /*@__PURE__*/ API.make(() => ({
