...
// Input Schema
export interface GetPaymentLinksPaymentLinkLineItemsInput {
  payment_link: string;
...
export const GetPaymentLinksPaymentLinkLineItemsInput =
  ...
  ) as unknown as Schema.Codec<GetPaymentLinksPaymentLinkLineItemsInput>;

// Output Schema
export interface GetPaymentLinksPaymentLinkLineItemsOutput {
  data: {
    adjustable_quantity: {
      enabled: boolean;
      maximum: number | null;
...
export const GetPaymentLinksPaymentLinkLineItemsOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    url: Schema.String,
  }) as unknown as Schema.Codec<GetPaymentLinksPaymentLinkLineItemsOutput>;
