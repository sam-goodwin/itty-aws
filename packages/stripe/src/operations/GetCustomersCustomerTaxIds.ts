...
// Input Schema
export interface GetCustomersCustomerTaxIdsInput {
  customer: string;
...
export const GetCustomersCustomerTaxIdsInput =
  ...
  ) as unknown as Schema.Codec<GetCustomersCustomerTaxIdsInput>;

// Output Schema
export interface GetCustomersCustomerTaxIdsOutput {
  data: {
    country: string | null;
    created: number;
    customer: unknown;
...
export const GetCustomersCustomerTaxIdsOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    url: Schema.String,
  }) as unknown as Schema.Codec<GetCustomersCustomerTaxIdsOutput>;
