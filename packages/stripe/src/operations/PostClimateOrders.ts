...
// Input Schema
export interface PostClimateOrdersInput {
  amount?: number;
...
) as unknown as Schema.Codec<PostClimateOrdersInput>;

// Output Schema
export interface PostClimateOrdersOutput {
  amount_fees: number;
...
export const PostClimateOrdersOutput =
  ...
  }) as unknown as Schema.Codec<PostClimateOrdersOutput>;
