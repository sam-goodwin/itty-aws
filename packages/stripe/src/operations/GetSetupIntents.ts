...
// Input Schema
export interface GetSetupIntentsInput {
...
) as unknown as Schema.Codec<GetSetupIntentsInput>;

// Output Schema
export interface GetSetupIntentsOutput {
  data: {
    application:
      | string
...
export const GetSetupIntentsOutput = /*@__PURE__*/ Schema.Struct({
  ...
  url: Schema.String,
}) as unknown as Schema.Codec<GetSetupIntentsOutput>;
