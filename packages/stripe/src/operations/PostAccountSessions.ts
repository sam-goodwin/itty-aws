...
// Input Schema
export const PostAccountSessionsInput = /*@__PURE__*/ Schema.Struct({
    ...
    account_management: Schema.optional(
      Schema.Struct({
        ...
        features: Schema.optional(
          Schema.Struct({
            disable_stripe_user_authentication: Schema.optional(Schema.Boolean),
...
// Output Schema
export const PostAccountSessionsOutput = /*@__PURE__*/ Schema.Struct({
  account: Schema.String,
