...
// Input Schema
export interface PostCustomersCustomerInput {
  customer: string;
  address?:
    | {
        city?: string;
...
export const PostCustomersCustomerInput =
  /*@__PURE__*/ Schema.Struct({
    ...
    individual_name: Schema.optional(
      Schema.Union([Schema.String, Schema.Literals([""])]),
    ),
  ...
  ) as unknown as Schema.Codec<PostCustomersCustomerInput>;

// Output Schema
export interface PostCustomersCustomerOutput {
  address?: {
    city: string | null;
    country: string | null;
    line1: string | null;
  ...
  sources?: { data: unknown[]; has_more: boolean; object: "list"; url: string };
  subscriptions?: {
    data: {
      application:
        | string
...
export const PostCustomersCustomerOutput =
                          ...
                          coupon: Schema.NullOr(
                            Schema.Union([
                              ...
                              Schema.Struct({
                                ...
                                duration_in_months: Schema.NullOr(
                                  Schema.Number,
                                ),
                                id: Schema.String,
                                livemode: Schema.Boolean,
  ...
  }) as unknown as Schema.Codec<PostCustomersCustomerOutput>;
