...
// Input Schema
export interface PostSetupIntentsIntentInput {
  intent: string;
...
export const PostSetupIntentsIntentInput =
  ...
  ) as unknown as Schema.Codec<PostSetupIntentsIntentInput>;

// Output Schema
export interface PostSetupIntentsIntentOutput {
  application:
    | string
...
export const PostSetupIntentsIntentOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    usage: Schema.String,
  }) as unknown as Schema.Codec<PostSetupIntentsIntentOutput>;
