...
// Input Schema
export interface GetIdentityVerificationSessionsInput {
...
export const GetIdentityVerificationSessionsInput =
  ...
  ) as unknown as Schema.Codec<GetIdentityVerificationSessionsInput>;

// Output Schema
export interface GetIdentityVerificationSessionsOutput {
  data: {
...
export const GetIdentityVerificationSessionsOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    url: Schema.String,
  }) as unknown as Schema.Codec<GetIdentityVerificationSessionsOutput>;
