...
// Input Schema
export interface PostInvoicesInvoiceFinalizeInput {
  invoice: string;
...
export const PostInvoicesInvoiceFinalizeInput =
  ...
  ) as unknown as Schema.Codec<PostInvoicesInvoiceFinalizeInput>;

// Output Schema
export interface PostInvoicesInvoiceFinalizeOutput {
...
export const PostInvoicesInvoiceFinalizeOutput =
  ...
  }) as unknown as Schema.Codec<PostInvoicesInvoiceFinalizeOutput>;
