...
export type PostInvoicesInvoiceFinalizeInput =
  typeof PostInvoicesInvoiceFinalizeInput.Type;
...
export type PostInvoicesInvoiceFinalizeOutput =
  typeof PostInvoicesInvoiceFinalizeOutput.Type;
