...
// Input Schema
export interface PostInvoicesInvoiceVoidInput {
  invoice: string;
  expand?: string[];
}
export const PostInvoicesInvoiceVoidInput =
  ...
  ) as unknown as Schema.Codec<PostInvoicesInvoiceVoidInput>;

// Output Schema
export interface PostInvoicesInvoiceVoidOutput {
...
export const PostInvoicesInvoiceVoidOutput =
  ...
  }) as unknown as Schema.Codec<PostInvoicesInvoiceVoidOutput>;
