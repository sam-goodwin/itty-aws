...
export type PostInvoicesInvoiceVoidInput =
  typeof PostInvoicesInvoiceVoidInput.Type;
...
export type PostInvoicesInvoiceVoidOutput =
  typeof PostInvoicesInvoiceVoidOutput.Type;
