...
// Input Schema
export interface PostTerminalReadersInput {
  expand?: string[];
  label?: string;
  location?: string;
...
export const PostTerminalReadersInput =
  ...
  ) as unknown as Schema.Codec<PostTerminalReadersInput>;

// Output Schema
export interface PostTerminalReadersOutput {
  action: unknown;
...
export const PostTerminalReadersOutput =
  ...
  }) as unknown as Schema.Codec<PostTerminalReadersOutput>;
