...
// Input Schema
export const PostTreasuryFinancialAccountsInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const PostTreasuryFinancialAccountsOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const PostTreasuryFinancialAccounts = /*@__PURE__*/ API.make(() => ({
