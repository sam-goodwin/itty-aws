...
// Input Schema
export interface PostTreasuryFinancialAccountsInput {
  expand?: string[];
  features?: {
...
export const PostTreasuryFinancialAccountsInput =
  ...
  ) as unknown as Schema.Codec<PostTreasuryFinancialAccountsInput>;

// Output Schema
export interface PostTreasuryFinancialAccountsOutput {
  active_features?: (
    | "card_issuing"
    | "deposit_insurance"
...
export const PostTreasuryFinancialAccountsOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    supported_currencies: Schema.Array(Schema.String),
  }) as unknown as Schema.Codec<PostTreasuryFinancialAccountsOutput>;
