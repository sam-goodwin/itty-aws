...
// Input Schema
export interface GetCreditNotesPreviewInput {
  amount?: number;
...
export const GetCreditNotesPreviewInput =
  ...
  ) as unknown as Schema.Codec<GetCreditNotesPreviewInput>;

// Output Schema
export interface GetCreditNotesPreviewOutput {
  amount: number;
...
export const GetCreditNotesPreviewOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    voided_at: Schema.NullOr(Schema.Number),
  }) as unknown as Schema.Codec<GetCreditNotesPreviewOutput>;
