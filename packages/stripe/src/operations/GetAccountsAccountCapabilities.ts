...
// Input Schema
export interface GetAccountsAccountCapabilitiesInput {
  account: string;
  expand?: string;
}
export const GetAccountsAccountCapabilitiesInput =
  ...
  ) as unknown as Schema.Codec<GetAccountsAccountCapabilitiesInput>;

// Output Schema
export interface GetAccountsAccountCapabilitiesOutput {
  data: {
    account: unknown;
    future_requirements?: {
      alternatives:
...
export const GetAccountsAccountCapabilitiesOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    url: Schema.String,
  }) as unknown as Schema.Codec<GetAccountsAccountCapabilitiesOutput>;
