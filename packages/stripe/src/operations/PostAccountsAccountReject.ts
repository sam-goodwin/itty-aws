...
// Input Schema
export interface PostAccountsAccountRejectInput {
  account: string;
  expand?: string[];
  reason: string;
}
export const PostAccountsAccountRejectInput =
  ...
  ) as unknown as Schema.Codec<PostAccountsAccountRejectInput>;

// Output Schema
export interface PostAccountsAccountRejectOutput {
  business_profile?: {
    annual_revenue?: {
      amount: number | null;
...
export const PostAccountsAccountRejectOutput =
  ...
  }) as unknown as Schema.Codec<PostAccountsAccountRejectOutput>;
