...
// Input Schema
export interface GetCheckoutSessionsSessionInput {
  session: string;
  expand?: string;
}
export const GetCheckoutSessionsSessionInput =
  ...
  ) as unknown as Schema.Codec<GetCheckoutSessionsSessionInput>;

// Output Schema
export interface GetCheckoutSessionsSessionOutput {
...
export const GetCheckoutSessionsSessionOutput =
  ...
  }) as unknown as Schema.Codec<GetCheckoutSessionsSessionOutput>;
