...
// Input Schema
export const PostV2BillingMeterEventSessionInput = /*@__PURE__*/ Schema.Struct(
  {},
).pipe(T.Http({ method: "POST", path: "/v2/billing/meter_event_session" }));
export type PostV2BillingMeterEventSessionInput =
  typeof PostV2BillingMeterEventSessionInput.Type;

// Output Schema
export const PostV2BillingMeterEventSessionOutput = /*@__PURE__*/ Schema.Struct(
  {
 ...
 */
export const PostV2BillingMeterEventSession = /*@__PURE__*/ API.make(() => ({
