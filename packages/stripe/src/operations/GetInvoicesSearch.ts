...
// Input Schema
export interface GetInvoicesSearchInput {
  expand?: string;
  limit?: number;
  page?: string;
  query: string;
...
) as unknown as Schema.Codec<GetInvoicesSearchInput>;

// Output Schema
export interface GetInvoicesSearchOutput {
  data: {
    ...
    footer: string | null;
    from_invoice: { action: string; invoice: string | unknown } | null;
    hosted_invoice_url?: string | null;
    id?: string;
    invoice_pdf?: string | null;
    issuer: { account?: unknown; type: "account" | "self" };
    last_finalization_error: unknown;
    latest_revision: string | unknown | null;
    lines: {
      data: {
        amount: number;
        currency: string;
              ...
              credit_balance_transaction?:
                ...
                | {
                    ...
                    credit: {
                      ...
                      credits_application_invoice_voided: unknown;
                      type:
    ...
    payments?: {
      data: {
        ...
        invoice:
          | string
          | unknown
          | { deleted: true; id: string; object: "invoice" };
        is_default: boolean;
        livemode: boolean;
...
export const GetInvoicesSearchOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
      ...
      Schema.Struct({
        ...
        from_invoice: Schema.NullOr(
          Schema.Struct({
            ...
            invoice: Schema.Union([Schema.String, Schema.Unknown]),
          }),
        ),
                          ...
                          Schema.Struct({
                            ...
                            debit: Schema.NullOr(
                              Schema.Struct({
                                ...
                                credits_applied: Schema.Unknown,
                                type: Schema.Literals([
                                  "credits_applied",
                                  "credits_expired",
                                  "credits_voided",
            ...
            Schema.Struct({
              ...
              customer_balance: Schema.NullOr(
                Schema.Struct({
                  ...
                  funding_type: Schema.NullOr(
                    Schema.Literals(["bank_transfer"]),
                  ),
                }),
              ),
                  ...
                  payment_record: Schema.optional(
                    Schema.Union([
                      ...
                      Schema.Struct({
                        ...
                        description: Schema.NullOr(Schema.String),
                        id: Schema.String,
                        latest_payment_attempt_record: Schema.NullOr(
                          Schema.String,
                        ),
                        livemode: Schema.Boolean,
                        metadata: Schema.Record(Schema.String, Schema.String),
    ...
    url: Schema.String,
  }) as unknown as Schema.Codec<GetInvoicesSearchOutput>;
