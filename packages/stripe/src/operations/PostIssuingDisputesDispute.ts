...
// Input Schema
export interface PostIssuingDisputesDisputeInput {
  dispute: string;
  amount?: number;
  evidence?: {
    canceled?:
...
export const PostIssuingDisputesDisputeInput =
        ...
        canceled: Schema.optional(
          Schema.Union([
            Schema.Struct({
              ...
              product_type: Schema.optional(
                Schema.Literals(["", "merchandise", "service"]),
              ),
              return_status: Schema.optional(
                Schema.Literals(["", "merchant_rejected", "successful"]),
              ),
              returned_at: Schema.optional(
                Schema.Union([Schema.Number, Schema.Literals([""])]),
              ),
            }),
            Schema.Literals([""]),
        ...
        duplicate: Schema.optional(
          Schema.Union([
            Schema.Struct({
              ...
              card_statement: Schema.optional(
                Schema.Union([Schema.String, Schema.Literals([""])]),
              ),
              cash_receipt: Schema.optional(
                Schema.Union([Schema.String, Schema.Literals([""])]),
              ),
              check_image: Schema.optional(
                Schema.Union([Schema.String, Schema.Literals([""])]),
              ),
              explanation: Schema.optional(
                Schema.Union([Schema.String, Schema.Literals([""])]),
              ),
              original_transaction: Schema.optional(Schema.String),
            }),
            Schema.Literals([""]),
          ]),
        ),
        ...
        merchandise_not_as_described: Schema.optional(
          Schema.Union([
            Schema.Struct({
              ...
              received_at: Schema.optional(
                Schema.Union([Schema.Number, Schema.Literals([""])]),
              ),
              return_description: Schema.optional(
                Schema.Union([Schema.String, Schema.Literals([""])]),
              ),
              return_status: Schema.optional(
                Schema.Literals(["", "merchant_rejected", "successful"]),
  ...
  ) as unknown as Schema.Codec<PostIssuingDisputesDisputeInput>;

// Output Schema
export interface PostIssuingDisputesDisputeOutput {
  amount: number;
...
export const PostIssuingDisputesDisputeOutput =
  ...
  }) as unknown as Schema.Codec<PostIssuingDisputesDisputeOutput>;
