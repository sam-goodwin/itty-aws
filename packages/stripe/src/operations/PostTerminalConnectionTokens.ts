...
// Input Schema
export const PostTerminalConnectionTokensInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const PostTerminalConnectionTokensOutput = /*@__PURE__*/ Schema.Struct({
  location: Schema.optional(Schema.String),
 ...
 */
export const PostTerminalConnectionTokens = /*@__PURE__*/ API.make(() => ({
