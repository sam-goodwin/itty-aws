...
// Input Schema
export interface PostTestHelpersTreasuryInboundTransfersIdReturnInput {
  id: string;
  expand?: string[];
}
export const PostTestHelpersTreasuryInboundTransfersIdReturnInput =
  ...
  ) as unknown as Schema.Codec<PostTestHelpersTreasuryInboundTransfersIdReturnInput>;

// Output Schema
export interface PostTestHelpersTreasuryInboundTransfersIdReturnOutput {
  amount: number;
  cancelable: boolean;
  created: number;
  currency: string;
...
export const PostTestHelpersTreasuryInboundTransfersIdReturnOutput =
  ...
  }) as unknown as Schema.Codec<PostTestHelpersTreasuryInboundTransfersIdReturnOutput>;
