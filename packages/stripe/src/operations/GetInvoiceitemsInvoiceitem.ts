...
// Input Schema
export interface GetInvoiceitemsInvoiceitemInput {
  invoiceitem: string;
  expand?: string;
}
export const GetInvoiceitemsInvoiceitemInput =
  ...
  ) as unknown as Schema.Codec<GetInvoiceitemsInvoiceitemInput>;

// Output Schema
export interface GetInvoiceitemsInvoiceitemOutput {
  amount: number;
  currency: string;
  customer: unknown;
...
export const GetInvoiceitemsInvoiceitemOutput =
  ...
  }) as unknown as Schema.Codec<GetInvoiceitemsInvoiceitemOutput>;
