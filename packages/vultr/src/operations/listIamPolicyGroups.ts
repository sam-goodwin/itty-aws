...
// Input Schema
export const ListIamPolicyGroupsInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    policy_id: Schema.String.pipe(T.PathParam()),
    per_page: Schema.optional(Schema.Number),
    cursor: Schema.optional(Schema.String),
  }).pipe(T.Http({ method: "GET", path: "/v2/policies/{policy_id}/groups" }));
export type ListIamPolicyGroupsInput = typeof ListIamPolicyGroupsInput.Type;

// Output Schema
export const ListIamPolicyGroupsOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type ListIamPolicyGroupsOutput = typeof ListIamPolicyGroupsOutput.Type;
 ...
 */
export const listIamPolicyGroups = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: ListIamPolicyGroupsInput,
  outputSchema: ListIamPolicyGroupsOutput,
