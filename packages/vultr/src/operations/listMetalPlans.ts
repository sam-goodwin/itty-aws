  ...
  plans: Schema.optional(
    Schema.Array(
      Schema.Struct({
        ...
        invoice_type: Schema.optional(Schema.Unknown),
        monthly_cost: Schema.optional(Schema.Number),
        hourly_cost: Schema.optional(Schema.Number),
        monthly_cost_preemptible: Schema.optional(Schema.Number),
        hourly_cost_preemptible: Schema.optional(Schema.Number),
