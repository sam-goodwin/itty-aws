...
// Input Schema
export const UpdatePullzoneInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "PUT", path: "/cdns/pull-zones/{pullzoneId}" }));
export type UpdatePullzoneInput = typeof UpdatePullzoneInput.Type;

// Output Schema
export const UpdatePullzoneOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type UpdatePullzoneOutput = typeof UpdatePullzoneOutput.Type;
 ...
 */
export const updatePullzone = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: UpdatePullzoneInput,
  outputSchema: UpdatePullzoneOutput,
