...
// Input Schema
export const ReadRetentionRuleInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct(
  {
...
export type ReadRetentionRuleInput = typeof ReadRetentionRuleInput.Type;

// Output Schema
export const ReadRetentionRuleOutput =
...
export type ReadRetentionRuleOutput = typeof ReadRetentionRuleOutput.Type;
 ...
 */
export const readRetentionRule = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: ReadRetentionRuleInput,
  outputSchema: ReadRetentionRuleOutput,
