...
// Input Schema
export const DatabaseAddReadReplicaInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    region: Schema.String,
    label: Schema.String,
  }).pipe(
    T.Http({ method: "POST", path: "/databases/{databaseId}/read-replica" }),
  );
export type DatabaseAddReadReplicaInput =
  typeof DatabaseAddReadReplicaInput.Type;

// Output Schema
export const DatabaseAddReadReplicaOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type DatabaseAddReadReplicaOutput =
  typeof DatabaseAddReadReplicaOutput.Type;
 ...
 */
export const databaseAddReadReplica = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: DatabaseAddReadReplicaInput,
    outputSchema: DatabaseAddReadReplicaOutput,
