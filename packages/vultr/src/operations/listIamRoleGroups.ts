...
// Input Schema
export const ListIamRoleGroupsInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct(
  {
    role_id: Schema.String.pipe(T.PathParam()),
    per_page: Schema.optional(Schema.Number),
    cursor: Schema.optional(Schema.String),
  },
).pipe(T.Http({ method: "GET", path: "/v2/roles/{role_id}/groups" }));
export type ListIamRoleGroupsInput = typeof ListIamRoleGroupsInput.Type;

// Output Schema
export const ListIamRoleGroupsOutput =
...
export type ListIamRoleGroupsOutput = typeof ListIamRoleGroupsOutput.Type;
 ...
 */
export const listIamRoleGroups = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: ListIamRoleGroupsInput,
  outputSchema: ListIamRoleGroupsOutput,
