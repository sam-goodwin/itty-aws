...
// Input Schema
export const GetBaremetalInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  baremetalId: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "GET", path: "/bare-metals/{baremetalId}" }));
export type GetBaremetalInput = typeof GetBaremetalInput.Type;

// Output Schema
export const GetBaremetalOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  bare_metal: Schema.optional(
    Schema.Struct({
...
export type GetBaremetalOutput = typeof GetBaremetalOutput.Type;
 ...
 */
export const getBaremetal = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: GetBaremetalInput,
  outputSchema: GetBaremetalOutput,
