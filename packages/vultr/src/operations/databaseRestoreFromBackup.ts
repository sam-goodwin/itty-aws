...
// Input Schema
export const DatabaseRestoreFromBackupInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    label: Schema.String,
    type: Schema.optional(Schema.String),
    date: Schema.optional(Schema.String),
    time: Schema.optional(Schema.String),
  }).pipe(T.Http({ method: "POST", path: "/databases/{databaseId}/restore" }));
export type DatabaseRestoreFromBackupInput =
  typeof DatabaseRestoreFromBackupInput.Type;

// Output Schema
export const DatabaseRestoreFromBackupOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type DatabaseRestoreFromBackupOutput =
  typeof DatabaseRestoreFromBackupOutput.Type;
 ...
 */
export const databaseRestoreFromBackup = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: DatabaseRestoreFromBackupInput,
    outputSchema: DatabaseRestoreFromBackupOutput,
