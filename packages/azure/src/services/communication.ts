...
export type DomainsResourceList = string[];
...
export type DomainResourceListValueList = DomainResource[];
...
export type EmailServiceResourceListValueList = EmailServiceResource[];
...
export type VerifiedExchangeOnlineDomainList = string[];
...
export type SmtpUsernameResourceCollectionValueList = SmtpUsernameResource[];
