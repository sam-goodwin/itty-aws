 ...
 */
export const CommunicationServicesCreateOrUpdate = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const CommunicationServicesDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  communicationServiceName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Input Schema
export const CommunicationServicesGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  communicationServiceName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const CommunicationServicesGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param communicationServiceName - The name of the CommunicationService resource.
 */
export const CommunicationServicesLinkNotificationHub = /*@__PURE__*/ API.make(
  () => ({
 ...
 * @param resourceGroupName - The name of the resource group. The name is case insensitive.
 */
export const CommunicationServicesListByResourceGroup = /*@__PURE__*/ API.make(
  () => ({
 ...
 * @param subscriptionId - The ID of the target subscription. The value must be an UUID.
 */
export const CommunicationServicesListBySubscription = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const CommunicationServicesListKeysInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  communicationServiceName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const CommunicationServicesListKeysOutput = /*@__PURE__*/ Schema.Struct({
 ...
 * @param communicationServiceName - The name of the CommunicationService resource.
 */
export const CommunicationServicesListKeys = /*@__PURE__*/ API.make(() => ({
 ...
 * @param communicationServiceName - The name of the CommunicationService resource.
 */
export const CommunicationServicesRegenerateKey = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const CommunicationServicesUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  communicationServiceName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const CommunicationServicesUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
...
// Input Schema
export const DomainsCancelVerificationInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
...
// Input Schema
export const DomainsInitiateVerificationInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  emailServiceName: Schema.String.pipe(T.PathParam()),
  domainName: Schema.String.pipe(T.PathParam()),
 ...
 * @param emailServiceName - The name of the EmailService resource.
 */
export const DomainsListByEmailServiceResource = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const EmailServicesCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  emailServiceName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const EmailServicesCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
...
// Input Schema
export const EmailServicesDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  emailServiceName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
 ...
 * @param resourceGroupName - The name of the resource group. The name is case insensitive.
 */
export const EmailServicesListByResourceGroup = /*@__PURE__*/ API.make(() => ({
  inputSchema: EmailServicesListByResourceGroupInput,
  outputSchema: EmailServicesListByResourceGroupOutput,
}));
// Input Schema
export const EmailServicesListBySubscriptionInput = /*@__PURE__*/ Schema.Struct(
  {
    subscriptionId: Schema.String.pipe(T.PathParam()),
    "api-version": Schema.String,
  },
 ...
 * @param subscriptionId - The ID of the target subscription. The value must be an UUID.
 */
export const EmailServicesListBySubscription = /*@__PURE__*/ API.make(() => ({
...
export const EmailServicesListVerifiedExchangeOnlineDomainsOutput =
  /*@__PURE__*/ Schema.Array(Schema.String);
...
// Input Schema
export const EmailServicesUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  emailServiceName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const EmailServicesUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
...
// Input Schema
export const SenderUsernamesCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  emailServiceName: Schema.String.pipe(T.PathParam()),
  domainName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const SenderUsernamesCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 */
export const SenderUsernamesCreateOrUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: SenderUsernamesCreateOrUpdateInput,
  outputSchema: SenderUsernamesCreateOrUpdateOutput,
}));
// Input Schema
export const SenderUsernamesDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  emailServiceName: Schema.String.pipe(T.PathParam()),
  domainName: Schema.String.pipe(T.PathParam()),
...
// Input Schema
export const SenderUsernamesGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  emailServiceName: Schema.String.pipe(T.PathParam()),
  domainName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const SenderUsernamesGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
...
// Input Schema
export const SenderUsernamesListByDomainsInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  emailServiceName: Schema.String.pipe(T.PathParam()),
  domainName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const SenderUsernamesListByDomainsOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
 ...
 * @param domainName - The name of the Domains resource.
 */
export const SenderUsernamesListByDomains = /*@__PURE__*/ API.make(() => ({
  inputSchema: SenderUsernamesListByDomainsInput,
  outputSchema: SenderUsernamesListByDomainsOutput,
}));
// Input Schema
export const SmtpUsernamesCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  communicationServiceName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const SmtpUsernamesCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
...
// Input Schema
export const SmtpUsernamesDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  communicationServiceName: Schema.String.pipe(T.PathParam()),
  smtpUsername: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const SmtpUsernamesListOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
 ...
 */
export const SuppressionListAddressesCreateOrUpdate = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const SuppressionListAddressesDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  emailServiceName: Schema.String.pipe(T.PathParam()),
  domainName: Schema.String.pipe(T.PathParam()),
 ...
 * @param addressId - The id of the address in a suppression list.
 */
export const SuppressionListAddressesDelete = /*@__PURE__*/ API.make(() => ({
  inputSchema: SuppressionListAddressesDeleteInput,
  outputSchema: SuppressionListAddressesDeleteOutput,
}));
// Input Schema
export const SuppressionListAddressesGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  emailServiceName: Schema.String.pipe(T.PathParam()),
  domainName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const SuppressionListAddressesGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
...
// Input Schema
export const SuppressionListAddressesListInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  emailServiceName: Schema.String.pipe(T.PathParam()),
  domainName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const SuppressionListAddressesListOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
 ...
 * @param suppressionListName - The name of the suppression list.
 */
export const SuppressionListAddressesList = /*@__PURE__*/ API.make(() => ({
  inputSchema: SuppressionListAddressesListInput,
  outputSchema: SuppressionListAddressesListOutput,
}));
// Input Schema
export const SuppressionListsCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  emailServiceName: Schema.String.pipe(T.PathParam()),
  domainName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const SuppressionListsCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct(
  {
    id: Schema.optional(Schema.String),
    name: Schema.optional(Schema.String),
    type: Schema.optional(Schema.String),
 ...
 * @param suppressionListName - The name of the suppression list.
 */
export const SuppressionListsCreateOrUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: SuppressionListsCreateOrUpdateInput,
  outputSchema: SuppressionListsCreateOrUpdateOutput,
}));
// Input Schema
export const SuppressionListsDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  emailServiceName: Schema.String.pipe(T.PathParam()),
  domainName: Schema.String.pipe(T.PathParam()),
...
// Input Schema
export const SuppressionListsGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  emailServiceName: Schema.String.pipe(T.PathParam()),
  domainName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const SuppressionListsGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
...
// Input Schema
export const SuppressionListsListByDomainInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  emailServiceName: Schema.String.pipe(T.PathParam()),
  domainName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const SuppressionListsListByDomainOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
 ...
 * @param domainName - The name of the Domains resource.
 */
export const SuppressionListsListByDomain = /*@__PURE__*/ API.make(() => ({
