...
export interface LogAnalyticsGetLogAnalyticsMetricsRequest {
  ...
  dateTimeEnd: string;
  granularity: LogAnalyticsGetLogAnalyticsMetricsRequestGranularity;
...
export interface LogAnalyticsGetWafLogAnalyticsMetricsRequest {
  ...
  dateTimeBegin: string;
  dateTimeEnd: string;
  granularity: LogAnalyticsGetWafLogAnalyticsMetricsRequestGranularity;
...
export type RoutePropertiesInputLinkToDefaultDomain =
  | "Enabled"
  | "Disabled"
  | (string & {});
...
export type RoutePropertiesInputHttpsRedirect =
  | "Enabled"
  | "Disabled"
  | (string & {});
...
export type RulePropertiesInputMatchProcessingBehavior =
  | "Continue"
  | "Stop"
  | (string & {});
