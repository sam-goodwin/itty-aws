...
// Input Schema
export const AccountsCreateAndUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const AccountsCreateAndUpdateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const AccountsCreateAndUpdate = /*@__PURE__*/ API.make(() => ({
