  ...
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    properties: Schema.optional(
      Schema.Struct({
        ...
        status: Schema.optional(Schema.Literals(["ChangePending", "Complete"])),
        serviceLocations: Schema.Array(
          Schema.Struct({
            name: Schema.String,
            primaryRegionProperties: Schema.Struct({
        ...
        connectivity: Schema.Literals(["PublicAddress"]),
        codecs: Schema.Array(
          Schema.Literals([
            "PCMA",
            "PCMU",
        ...
        e911Type: Schema.Literals(["Standard", "DirectToEsrp"]),
        ...
        allocatedMediaAddressPrefixes: Schema.optional(
          Schema.Array(Schema.String),
        ),
      }),
    ),
  ...
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    properties: Schema.optional(
      Schema.Struct({
        ...
        purpose: Schema.Literals(["Manual", "Automated"]),
      }),
    ),
    tags: Schema.optional(Schema.Record(Schema.String, Schema.String)),
    location: Schema.String,
