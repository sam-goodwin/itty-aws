...
const ResourceProviderOperationSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    properties: Schema.optional(
      Schema.suspend(() => OperationPropertiesSchema),
    ),
  });
...
const PrivateEndpointConnectionWithSystemDataSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.optional(Schema.String),
    name: Schema.optional(Schema.String),
    type: Schema.optional(Schema.String),
...
const ScalingPlanPropertiesSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  objectId: Schema.optional(Schema.String),
  description: Schema.optional(Schema.String),
  friendlyName: Schema.optional(Schema.String),
  ...
  schedules: Schema.optional(
    Schema.Array(Schema.suspend(() => ScalingScheduleSchema)),
  ),
  hostPoolReferences: Schema.optional(
    Schema.Array(Schema.suspend(() => ScalingHostPoolReferenceSchema)),
  ),
});
const ScalingScheduleSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
  ...
  rampUpStartTime: Schema.optional(Schema.suspend(() => TimeSchema)),
  ...
  peakStartTime: Schema.optional(Schema.suspend(() => TimeSchema)),
  peakLoadBalancingAlgorithm: Schema.optional(
    Schema.Literals(["BreadthFirst", "DepthFirst"]),
  ),
  rampDownStartTime: Schema.optional(Schema.suspend(() => TimeSchema)),
  ...
  offPeakStartTime: Schema.optional(Schema.suspend(() => TimeSchema)),
  offPeakLoadBalancingAlgorithm: Schema.optional(
    Schema.Literals(["BreadthFirst", "DepthFirst"]),
  ),
});
const TimeSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  hour: Schema.Number,
  minute: Schema.Number,
});
const ScalingHostPoolReferenceSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    hostPoolArmPath: Schema.optional(Schema.String),
    scalingPlanEnabled: Schema.optional(Schema.Boolean),
  });
const ScalingPlanPatchPropertiesSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    description: Schema.optional(Schema.String),
    friendlyName: Schema.optional(Schema.String),
...
const ScalingPlanSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(Schema.suspend(() => systemDataSchema)),
});
const ScalingPlanPooledSchedulePropertiesSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    daysOfWeek: Schema.optional(
      Schema.Array(
        Schema.Literals([
...
const ScalingPlanPooledScheduleSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.optional(Schema.String),
    name: Schema.optional(Schema.String),
    type: Schema.optional(Schema.String),
...
const ScalingPlanPersonalSchedulePropertiesSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    daysOfWeek: Schema.optional(
      Schema.Array(
        Schema.Literals([
...
const ScalingPlanPersonalScheduleSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.optional(Schema.String),
    name: Schema.optional(Schema.String),
    type: Schema.optional(Schema.String),
...
const ApplicationGroupPropertiesSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    objectId: Schema.optional(Schema.String),
    description: Schema.optional(Schema.String),
    friendlyName: Schema.optional(Schema.String),
...
const ApplicationGroupPatchPropertiesSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    description: Schema.optional(Schema.String),
    friendlyName: Schema.optional(Schema.String),
    showInFeed: Schema.optional(Schema.Boolean),
...
const StartMenuItemSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(Schema.suspend(() => systemDataSchema)),
...
const ApplicationPatchPropertiesSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    description: Schema.optional(Schema.String),
    friendlyName: Schema.optional(Schema.String),
    filePath: Schema.optional(Schema.String),
...
const DesktopPropertiesSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  objectId: Schema.optional(Schema.String),
  description: Schema.optional(Schema.String),
  friendlyName: Schema.optional(Schema.String),
  iconHash: Schema.optional(Schema.String),
...
const DesktopPatchPropertiesSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  description: Schema.optional(Schema.String),
  friendlyName: Schema.optional(Schema.String),
});
const DesktopSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(Schema.suspend(() => systemDataSchema)),
});
const HostPoolPropertiesSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  objectId: Schema.optional(Schema.String),
  friendlyName: Schema.optional(Schema.String),
  description: Schema.optional(Schema.String),
  ...
  registrationInfo: Schema.optional(
    Schema.suspend(() => RegistrationInfoSchema),
  ),
  ...
  ssoClientSecretKeyVaultPath: Schema.optional(SensitiveOutputString),
  ...
  agentUpdate: Schema.optional(
    Schema.suspend(() => AgentUpdatePropertiesSchema),
  ),
  privateEndpointConnections: Schema.optional(
    Schema.NullOr(
      Schema.Array(
...
const RegistrationInfoSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
const AgentUpdatePropertiesSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  maintenanceWindows: Schema.optional(
    Schema.NullOr(
      Schema.Array(Schema.suspend(() => MaintenanceWindowPropertiesSchema)),
    ),
  ),
});
const MaintenanceWindowPropertiesSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
const HostPoolPatchPropertiesSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct(
  {
    friendlyName: Schema.optional(Schema.String),
    description: Schema.optional(Schema.String),
    customRdpProperty: Schema.optional(Schema.String),
    ...
    validationEnvironment: Schema.optional(Schema.NullOr(Schema.Boolean)),
    registrationInfo: Schema.optional(
      Schema.suspend(() => RegistrationInfoPatchSchema),
    ),
    vmTemplate: Schema.optional(Schema.String),
    ssoadfsAuthority: Schema.optional(Schema.String),
    ssoClientId: Schema.optional(Schema.String),
    ...
    agentUpdate: Schema.optional(
      Schema.suspend(() => AgentUpdatePatchPropertiesSchema),
    ),
  },
);
const RegistrationInfoPatchSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  expirationTime: Schema.optional(Schema.NullOr(Schema.String)),
  registrationTokenOperation: Schema.optional(
    Schema.Literals(["Delete", "None", "Update"]),
  ),
});
const AgentUpdatePatchPropertiesSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    type: Schema.optional(Schema.Literals(["Default", "Scheduled"])),
    useSessionHostLocalTime: Schema.optional(Schema.Boolean),
    maintenanceWindowTimeZone: Schema.optional(Schema.String),
    maintenanceWindows: Schema.optional(
      Schema.NullOr(
        Schema.Array(
          Schema.suspend(() => MaintenanceWindowPatchPropertiesSchema),
        ),
      ),
    ),
  });
const MaintenanceWindowPatchPropertiesSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    hour: Schema.optional(Schema.Number),
    dayOfWeek: Schema.optional(
      Schema.Literals([
...
const HostPoolSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(Schema.suspend(() => systemDataSchema)),
});
const RegistrationTokenMinimalSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    expirationTime: Schema.optional(Schema.NullOr(Schema.String)),
    token: Schema.optional(Schema.String),
  });
const UserSessionSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(Schema.suspend(() => systemDataSchema)),
});
const SessionHostPropertiesSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  objectId: Schema.optional(Schema.String),
  ...
  statusTimestamp: Schema.optional(Schema.String),
  osVersion: Schema.optional(Schema.String),
  sxSStackVersion: Schema.optional(Schema.String),
  updateState: Schema.optional(
    Schema.Literals(["Initial", "Pending", "Started", "Succeeded", "Failed"]),
  ),
  lastUpdateTime: Schema.optional(Schema.String),
  updateErrorMessage: Schema.optional(Schema.String),
  sessionHostHealthCheckResults: Schema.optional(
    Schema.Array(Schema.suspend(() => SessionHostHealthCheckReportSchema)),
  ),
});
const SessionHostHealthCheckReportSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    healthCheckName: Schema.optional(
      Schema.Literals([
        "DomainJoinedCheck",
        "DomainTrustCheck",
        "FSLogixHealthCheck",
    ...
    additionalFailureDetails: Schema.optional(
      Schema.suspend(() => SessionHostHealthCheckFailureDetailsSchema),
    ),
  });
const SessionHostHealthCheckFailureDetailsSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    message: Schema.optional(Schema.String),
    errorCode: Schema.optional(Schema.Number),
    lastHealthCheckDateTime: Schema.optional(Schema.String),
  });
const SessionHostPatchPropertiesSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    allowNewSession: Schema.optional(Schema.Boolean),
    assignedUser: Schema.optional(Schema.String),
    friendlyName: Schema.optional(Schema.String),
  });
const SessionHostSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(Schema.suspend(() => systemDataSchema)),
});
const MSIXPackagePropertiesSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  packageDependencies: Schema.optional(
    Schema.Array(Schema.suspend(() => MsixPackageDependenciesSchema)),
  ),
  version: Schema.optional(Schema.String),
  lastUpdated: Schema.optional(Schema.String),
  packageApplications: Schema.optional(
    Schema.Array(Schema.suspend(() => MsixPackageApplicationsSchema)),
  ),
});
const MsixPackageDependenciesSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct(
  {
...
const MsixPackageApplicationsSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct(
  {
...
const MSIXPackagePatchPropertiesSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    isActive: Schema.optional(Schema.Boolean),
    isRegularRegistration: Schema.optional(Schema.Boolean),
    displayName: Schema.optional(Schema.String),
  });
const MSIXPackageSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(Schema.suspend(() => systemDataSchema)),
});
const AppAttachPackageSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(Schema.suspend(() => systemDataSchema)),
});
const ExpandMsixImageSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(Schema.suspend(() => systemDataSchema)),
});
const AppAttachPackagePropertiesSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    provisioningState: Schema.optional(
      Schema.suspend(() => ProvisioningStateSchema),
    ),
    image: Schema.optional(
      Schema.suspend(() => AppAttachPackageInfoPropertiesSchema),
    ),
    ...
    failHealthCheckOnStagingFailure: Schema.optional(
      Schema.suspend(() => FailHealthCheckOnStagingFailureEnumSchema),
    ),
  });
...
const AppAttachPackageInfoPropertiesSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
const FailHealthCheckOnStagingFailureEnumSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Literals([
    "Unhealthy",
    "NeedsAssistance",
    "DoNotFail",
  ]);
const AppAttachPackagePatchPropertiesSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    image: Schema.optional(
      Schema.suspend(() => AppAttachPackageInfoPropertiesSchema),
    ),
...
const UserSessionPropertiesSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  objectId: Schema.optional(Schema.String),
  userPrincipalName: Schema.optional(Schema.String),
  applicationType: Schema.optional(Schema.Literals(["RemoteApp", "Desktop"])),
  sessionState: Schema.optional(
    Schema.Literals([
      "Unknown",
      "Active",
      "Disconnected",
  ...
  activeDirectoryUserName: Schema.optional(Schema.String),
...
export const AppAttachPackageCreateOrUpdateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    properties: Schema.suspend(() => AppAttachPackagePropertiesSchema),
...
export const AppAttachPackageInfoImportOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    value: Schema.optional(
      Schema.Array(Schema.suspend(() => AppAttachPackageSchema)),
    ),
...
export const AppAttachPackageUpdateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    resourceGroupName: Schema.String.pipe(T.PathParam()),
    properties: Schema.optional(
      Schema.suspend(() => AppAttachPackagePatchPropertiesSchema),
    ),
    id: Schema.optional(Schema.String),
    name: Schema.optional(Schema.String),
    type: Schema.optional(Schema.String),
...
export const ApplicationGroupsCreateOrUpdateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    properties: Schema.suspend(() => ApplicationGroupPropertiesSchema),
    tags: Schema.optional(Schema.Record(Schema.String, Schema.String)),
    location: Schema.String,
  }).pipe(
    T.Http({
...
export const ApplicationGroupsUpdateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    properties: Schema.optional(
      Schema.suspend(() => ApplicationGroupPatchPropertiesSchema),
    ),
    id: Schema.optional(Schema.String),
    name: Schema.optional(Schema.String),
    type: Schema.optional(Schema.String),
...
export const ApplicationsUpdateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    resourceGroupName: Schema.String.pipe(T.PathParam()),
    properties: Schema.optional(
      Schema.suspend(() => ApplicationPatchPropertiesSchema),
    ),
  }).pipe(
    T.Http({
      method: "PATCH",
...
export const DesktopsGetOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  systemData: Schema.optional(Schema.suspend(() => systemDataSchema)),
  properties: Schema.optional(Schema.suspend(() => DesktopPropertiesSchema)),
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
});
...
export const DesktopsListOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  value: Schema.optional(Schema.Array(Schema.suspend(() => DesktopSchema))),
  nextLink: Schema.optional(Schema.String),
});
...
export const DesktopsUpdateInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  properties: Schema.optional(
    Schema.suspend(() => DesktopPatchPropertiesSchema),
  ),
}).pipe(
  T.Http({
    method: "PATCH",
...
export const HostPoolsCreateOrUpdateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    properties: Schema.suspend(() => HostPoolPropertiesSchema),
    tags: Schema.optional(Schema.Record(Schema.String, Schema.String)),
    location: Schema.String,
  }).pipe(
    T.Http({
...
export const HostPoolsListOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  value: Schema.optional(Schema.Array(Schema.suspend(() => HostPoolSchema))),
  nextLink: Schema.optional(Schema.String),
});
...
export const HostPoolsListRegistrationTokensOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    value: Schema.optional(
      Schema.Array(Schema.suspend(() => RegistrationTokenMinimalSchema)),
    ),
    nextLink: Schema.optional(Schema.String),
  });
...
export const HostPoolsUpdateInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  properties: Schema.optional(
    Schema.suspend(() => HostPoolPatchPropertiesSchema),
  ),
  identity: Schema.optional(
    Schema.Struct({
      principalId: Schema.optional(Schema.String),
...
export const MsixImagesExpandOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct(
  {
    value: Schema.optional(
      Schema.Array(Schema.suspend(() => ExpandMsixImageSchema)),
    ),
    nextLink: Schema.optional(Schema.String),
  },
);
...
export const MSIXPackagesCreateOrUpdateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    resourceGroupName: Schema.String.pipe(T.PathParam()),
    systemData: Schema.optional(Schema.suspend(() => systemDataSchema)),
    properties: Schema.suspend(() => MSIXPackagePropertiesSchema),
    id: Schema.optional(Schema.String),
    name: Schema.optional(Schema.String),
    type: Schema.optional(Schema.String),
  }).pipe(
...
export const MSIXPackagesListOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct(
  {
    value: Schema.optional(
      Schema.Array(Schema.suspend(() => MSIXPackageSchema)),
    ),
    nextLink: Schema.optional(Schema.String),
  },
);
...
export const MSIXPackagesUpdateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    resourceGroupName: Schema.String.pipe(T.PathParam()),
    properties: Schema.optional(
      Schema.suspend(() => MSIXPackagePatchPropertiesSchema),
    ),
    id: Schema.optional(Schema.String),
    name: Schema.optional(Schema.String),
    type: Schema.optional(Schema.String),
...
export const OperationsListOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  value: Schema.Array(Schema.suspend(() => ResourceProviderOperationSchema)),
  nextLink: Schema.optional(Schema.String),
});
...
export const PrivateEndpointConnectionsListByHostPoolOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    value: Schema.optional(
      Schema.Array(
        Schema.suspend(() => PrivateEndpointConnectionWithSystemDataSchema),
      ),
    ),
    nextLink: Schema.optional(Schema.String),
  });
...
export const ScalingPlanPersonalSchedulesCreateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    properties: Schema.suspend(
      () => ScalingPlanPersonalSchedulePropertiesSchema,
    ),
  }).pipe(
    T.Http({
      method: "PUT",
...
export const ScalingPlanPersonalSchedulesListOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    value: Schema.optional(
      Schema.Array(Schema.suspend(() => ScalingPlanPersonalScheduleSchema)),
    ),
    nextLink: Schema.optional(Schema.String),
  });
...
export const ScalingPlanPersonalSchedulesUpdateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    resourceGroupName: Schema.String.pipe(T.PathParam()),
    properties: Schema.optional(
      Schema.suspend(() => ScalingPlanPersonalSchedulePropertiesSchema),
    ),
  }).pipe(
    T.Http({
      method: "PATCH",
...
export const ScalingPlanPooledSchedulesCreateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    resourceGroupName: Schema.String.pipe(T.PathParam()),
    systemData: Schema.optional(Schema.suspend(() => systemDataSchema)),
    properties: Schema.suspend(() => ScalingPlanPooledSchedulePropertiesSchema),
    id: Schema.optional(Schema.String),
    name: Schema.optional(Schema.String),
    type: Schema.optional(Schema.String),
  }).pipe(
...
export const ScalingPlanPooledSchedulesListOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    value: Schema.optional(
      Schema.Array(Schema.suspend(() => ScalingPlanPooledScheduleSchema)),
    ),
    nextLink: Schema.optional(Schema.String),
  });
...
export const ScalingPlanPooledSchedulesUpdateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    resourceGroupName: Schema.String.pipe(T.PathParam()),
    properties: Schema.optional(
      Schema.suspend(() => ScalingPlanPooledSchedulePropertiesSchema),
    ),
    id: Schema.optional(Schema.String),
    name: Schema.optional(Schema.String),
    type: Schema.optional(Schema.String),
...
export const ScalingPlansCreateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    properties: Schema.suspend(() => ScalingPlanPropertiesSchema),
    tags: Schema.optional(Schema.Record(Schema.String, Schema.String)),
    location: Schema.String,
  }).pipe(
    T.Http({
...
export const ScalingPlansListByHostPoolOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    value: Schema.optional(
      Schema.Array(Schema.suspend(() => ScalingPlanSchema)),
    ),
    nextLink: Schema.optional(Schema.String),
  });
...
export const ScalingPlansUpdateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    properties: Schema.optional(
      Schema.suspend(() => ScalingPlanPatchPropertiesSchema),
    ),
  }).pipe(
    T.Http({
      method: "PATCH",
...
export const SessionHostsGetOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  systemData: Schema.optional(Schema.suspend(() => systemDataSchema)),
  properties: Schema.optional(
    Schema.suspend(() => SessionHostPropertiesSchema),
  ),
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
...
export const SessionHostsListOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct(
  {
    value: Schema.optional(
      Schema.Array(Schema.suspend(() => SessionHostSchema)),
    ),
    nextLink: Schema.optional(Schema.String),
  },
);
...
export const SessionHostsUpdateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    force: Schema.optional(Schema.Boolean),
    properties: Schema.optional(
      Schema.suspend(() => SessionHostPatchPropertiesSchema),
    ),
    id: Schema.optional(Schema.String),
    name: Schema.optional(Schema.String),
    type: Schema.optional(Schema.String),
...
export const StartMenuItemsListOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    value: Schema.optional(
      Schema.Array(Schema.suspend(() => StartMenuItemSchema)),
    ),
    nextLink: Schema.optional(Schema.String),
  });
...
export const UserSessionsGetOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  systemData: Schema.optional(Schema.suspend(() => systemDataSchema)),
  properties: Schema.optional(
    Schema.suspend(() => UserSessionPropertiesSchema),
  ),
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
...
export const UserSessionsListOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct(
  {
    value: Schema.optional(
      Schema.Array(Schema.suspend(() => UserSessionSchema)),
    ),
    nextLink: Schema.optional(Schema.String),
  },
);
