...
// Input Schema
export const DiskPoolsCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct(
  {},
).pipe(
  T.Http({
    method: "PUT",
...
// Output Schema
export const DiskPoolsCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct({
...
// Input Schema
export const DiskPoolsDeallocateInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "POST",
...
// Input Schema
export const DiskPoolsDeleteInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "DELETE",
    path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StoragePool/diskPools/{diskPoolName}",
  }),
...
// Input Schema
export const DiskPoolsGetInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "GET",
    path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StoragePool/diskPools/{diskPoolName}",
  }),
...
// Input Schema
export const DiskPoolsListByResourceGroupInput = /*@__PURE__*/ Schema.Struct(
  {},
).pipe(
  T.Http({
    method: "GET",
...
// Output Schema
export const DiskPoolsListByResourceGroupOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
 ...
 */
export const DiskPoolsListByResourceGroup = /*@__PURE__*/ API.make(() => ({
  inputSchema: DiskPoolsListByResourceGroupInput,
  outputSchema: DiskPoolsListByResourceGroupOutput,
}));
// Input Schema
export const DiskPoolsListBySubscriptionInput = /*@__PURE__*/ Schema.Struct(
  {},
).pipe(
  T.Http({
    method: "GET",
...
// Output Schema
export const DiskPoolsListBySubscriptionOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
...
// Input Schema
export const DiskPoolsStartInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "POST",
...
// Input Schema
export const DiskPoolsUpdateInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "PATCH",
    path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StoragePool/diskPools/{diskPoolName}",
  }),
...
// Input Schema
export const DiskPoolsUpgradeInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "POST",
...
// Input Schema
export const DiskPoolZonesListInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "GET",
...
// Output Schema
export const DiskPoolZonesListOutput = /*@__PURE__*/ Schema.Struct({
...
// Input Schema
export const IscsiTargetsCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct(
  {},
).pipe(
  T.Http({
    method: "PUT",
...
// Output Schema
export const IscsiTargetsCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
});
...
// Input Schema
export const IscsiTargetsDeleteInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "DELETE",
    path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StoragePool/diskPools/{diskPoolName}/iscsiTargets/{iscsiTargetName}",
  }),
...
// Input Schema
export const IscsiTargetsGetInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "GET",
    path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StoragePool/diskPools/{diskPoolName}/iscsiTargets/{iscsiTargetName}",
  }),
...
// Input Schema
export const IscsiTargetsListByDiskPoolInput = /*@__PURE__*/ Schema.Struct(
  {},
).pipe(
  T.Http({
    method: "GET",
...
// Output Schema
export const IscsiTargetsListByDiskPoolOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
...
// Input Schema
export const IscsiTargetsUpdateInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "PATCH",
    path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StoragePool/diskPools/{diskPoolName}/iscsiTargets/{iscsiTargetName}",
  }),
...
// Output Schema
export const IscsiTargetsUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
});
...
// Input Schema
export const ResourceSkusListInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "GET",
