...
// Input Schema
export const CommunityTrainingsCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const CommunityTrainingsCreateOutput = /*@__PURE__*/ Schema.Struct({
...
// Input Schema
export const CommunityTrainingsDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  communityTrainingName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Input Schema
export const CommunityTrainingsGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  communityTrainingName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const CommunityTrainingsGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param resourceGroupName - The name of the resource group. The name is case insensitive.
 */
export const CommunityTrainingsListByResourceGroup = /*@__PURE__*/ API.make(
  () => ({
 ...
 * @param subscriptionId - The ID of the target subscription.
 */
export const CommunityTrainingsListBySubscription = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const CommunityTrainingsUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  communityTrainingName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const CommunityTrainingsUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
