...
// Input Schema
export const InstancesCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const InstancesCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct({
...
// Input Schema
export const InstancesListByResourceGroupInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
}).pipe(
...
// Output Schema
export const InstancesListByResourceGroupOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
 ...
 * @param resourceGroupName - The name of the resource group. The name is case insensitive.
 */
export const InstancesListByResourceGroup = /*@__PURE__*/ API.make(() => ({
  inputSchema: InstancesListByResourceGroupInput,
  outputSchema: InstancesListByResourceGroupOutput,
}));
// Input Schema
export const InstancesListBySubscriptionInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
}).pipe(
  T.Http({
...
// Output Schema
export const InstancesListBySubscriptionOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
