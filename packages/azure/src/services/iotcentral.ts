...
// Input Schema
export const AppsCheckNameAvailabilityInput = /*@__PURE__*/ Schema.Struct(
  {},
).pipe(
  T.Http({
    method: "POST",
...
// Output Schema
export const AppsCheckNameAvailabilityOutput = /*@__PURE__*/ Schema.Struct({
...
// Input Schema
export const AppsCheckSubdomainAvailabilityInput = /*@__PURE__*/ Schema.Struct(
  {},
).pipe(
  T.Http({
    method: "POST",
...
// Output Schema
export const AppsCheckSubdomainAvailabilityOutput = /*@__PURE__*/ Schema.Struct(
  {
    nameAvailable: Schema.optional(Schema.Boolean),
    reason: Schema.optional(Schema.String),
    message: Schema.optional(Schema.String),
 ...
 */
export const AppsCheckSubdomainAvailability = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const AppsGetInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "GET",
    path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.IoTCentral/iotApps/{resourceName}",
  }),
...
// Input Schema
export const AppsListByResourceGroupInput = /*@__PURE__*/ Schema.Struct(
  {},
).pipe(
  T.Http({
    method: "GET",
...
// Output Schema
export const AppsListByResourceGroupOutput = /*@__PURE__*/ Schema.Struct({
...
// Input Schema
export const AppsListBySubscriptionInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "GET",
...
// Output Schema
export const AppsListBySubscriptionOutput = /*@__PURE__*/ Schema.Struct({
  nextLink: Schema.optional(Schema.String),
  value: Schema.optional(
    Schema.Array(
      Schema.Struct({
...
// Input Schema
export const AppsListTemplatesInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "POST",
...
// Output Schema
export const AppsListTemplatesOutput = /*@__PURE__*/ Schema.Struct({
  nextLink: Schema.optional(Schema.String),
  value: Schema.optional(
    Schema.Array(
      Schema.Struct({
