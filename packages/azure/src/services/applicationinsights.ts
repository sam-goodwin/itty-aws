...
// Input Schema
export const WorkbooksCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const WorkbooksCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct({
...
// Input Schema
export const WorkbooksListByResourceGroupInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const WorkbooksListByResourceGroupOutput = /*@__PURE__*/ Schema.Struct({
 ...
 * @param canFetchContent - Flag indicating whether or not to return the full content for each applicable workbook. If false, only return summary content for workbooks.
 */
export const WorkbooksListByResourceGroup = /*@__PURE__*/ API.make(() => ({
  inputSchema: WorkbooksListByResourceGroupInput,
  outputSchema: WorkbooksListByResourceGroupOutput,
}));
// Input Schema
export const WorkbooksListBySubscriptionInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
  category: Schema.Literals(["workbook", "TSG", "performance", "retention"]),
  tags: Schema.optional(Schema.String),
...
// Output Schema
export const WorkbooksListBySubscriptionOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.optional(
    Schema.Array(
      Schema.Struct({
        id: Schema.optional(Schema.String),
...
// Input Schema
export const WorkbooksRevisionGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  resourceName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const WorkbooksRevisionGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
...
// Input Schema
export const WorkbooksRevisionsListInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  resourceName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const WorkbooksRevisionsListOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.optional(
    Schema.Array(
      Schema.Struct({
        id: Schema.optional(Schema.String),
