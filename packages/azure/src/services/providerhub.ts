 ...
 */
export const AuthorizedApplicationsCreateOrUpdate = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const AuthorizedApplicationsDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  providerNamespace: Schema.String.pipe(T.PathParam()),
  applicationId: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
 ...
 * @param applicationId - The application ID.
 */
export const AuthorizedApplicationsDelete = /*@__PURE__*/ API.make(() => ({
  inputSchema: AuthorizedApplicationsDeleteInput,
  outputSchema: AuthorizedApplicationsDeleteOutput,
}));
// Input Schema
export const AuthorizedApplicationsGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  providerNamespace: Schema.String.pipe(T.PathParam()),
  applicationId: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const AuthorizedApplicationsGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
...
// Input Schema
export const AuthorizedApplicationsListInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  providerNamespace: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
}).pipe(
...
// Output Schema
export const AuthorizedApplicationsListOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
...
// Input Schema
export const CustomRolloutsCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  providerNamespace: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const CustomRolloutsCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 */
export const CustomRolloutsCreateOrUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: CustomRolloutsCreateOrUpdateInput,
  outputSchema: CustomRolloutsCreateOrUpdateOutput,
}));
// Input Schema
export const CustomRolloutsDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  providerNamespace: Schema.String.pipe(T.PathParam()),
  rolloutName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const CustomRolloutsGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param providerNamespace - The name of the resource provider hosted within ProviderHub.
 */
export const CustomRolloutsListByProviderRegistration = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const CustomRolloutsStopInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  providerNamespace: Schema.String.pipe(T.PathParam()),
  rolloutName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Input Schema
export const DefaultRolloutsCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  providerNamespace: Schema.String.pipe(T.PathParam()),
  rolloutName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const DefaultRolloutsCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param rolloutName - The rollout name.
 */
export const DefaultRolloutsCreateOrUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: DefaultRolloutsCreateOrUpdateInput,
  outputSchema: DefaultRolloutsCreateOrUpdateOutput,
}));
// Input Schema
export const DefaultRolloutsDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  providerNamespace: Schema.String.pipe(T.PathParam()),
  rolloutName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Input Schema
export const DefaultRolloutsGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  providerNamespace: Schema.String.pipe(T.PathParam()),
  rolloutName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const DefaultRolloutsGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param providerNamespace - The name of the resource provider hosted within ProviderHub.
 */
export const DefaultRolloutsListByProviderRegistration = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const DefaultRolloutsStopInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  providerNamespace: Schema.String.pipe(T.PathParam()),
  rolloutName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
 ...
 */
export const NewRegionFrontloadReleaseCreateOrUpdate = /*@__PURE__*/ API.make(
  () => ({
 ...
 * @param providerNamespace - The name of the resource provider hosted within ProviderHub.
 */
export const NewRegionFrontloadReleaseGenerateManifest = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const NewRegionFrontloadReleaseGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  providerNamespace: Schema.String.pipe(T.PathParam()),
  releaseName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const NewRegionFrontloadReleaseGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param releaseName - The name of the release.
 */
export const NewRegionFrontloadReleaseGet = /*@__PURE__*/ API.make(() => ({
  inputSchema: NewRegionFrontloadReleaseGetInput,
  outputSchema: NewRegionFrontloadReleaseGetOutput,
}));
// Input Schema
export const NewRegionFrontloadReleaseStopInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  providerNamespace: Schema.String.pipe(T.PathParam()),
  releaseName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
 ...
 * @param releaseName - The name of the release.
 */
export const NewRegionFrontloadReleaseStop = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const NotificationRegistrationsCreateOrUpdate = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const NotificationRegistrationsDeleteInput = /*@__PURE__*/ Schema.Struct(
  {
    subscriptionId: Schema.String.pipe(T.PathParam()),
    providerNamespace: Schema.String.pipe(T.PathParam()),
    notificationRegistrationName: Schema.String.pipe(T.PathParam()),
 ...
 * @param notificationRegistrationName - The notification registration.
 */
export const NotificationRegistrationsDelete = /*@__PURE__*/ API.make(() => ({
  inputSchema: NotificationRegistrationsDeleteInput,
  outputSchema: NotificationRegistrationsDeleteOutput,
}));
// Input Schema
export const NotificationRegistrationsGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  providerNamespace: Schema.String.pipe(T.PathParam()),
  notificationRegistrationName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const NotificationRegistrationsGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param notificationRegistrationName - The notification registration.
 */
export const NotificationRegistrationsGet = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const OperationsCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  providerNamespace: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
}).pipe(
...
// Output Schema
export const OperationsCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param providerNamespace - The name of the resource provider hosted within ProviderHub.
 */
export const OperationsListByProviderRegistration = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const ProviderMonitorSettingsCreateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const ProviderMonitorSettingsCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 */
export const ProviderMonitorSettingsCreate = /*@__PURE__*/ API.make(() => ({
  inputSchema: ProviderMonitorSettingsCreateInput,
  outputSchema: ProviderMonitorSettingsCreateOutput,
}));
// Input Schema
export const ProviderMonitorSettingsDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  providerMonitorSettingName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
 ...
 * @param providerMonitorSettingName - The name of the provider monitor setting.
 */
export const ProviderMonitorSettingsDelete = /*@__PURE__*/ API.make(() => ({
  inputSchema: ProviderMonitorSettingsDeleteInput,
  outputSchema: ProviderMonitorSettingsDeleteOutput,
}));
// Input Schema
export const ProviderMonitorSettingsGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  providerMonitorSettingName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const ProviderMonitorSettingsGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param subscriptionId - The ID of the target subscription. The value must be an UUID.
 */
export const ProviderMonitorSettingsListBySubscription = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const ProviderMonitorSettingsUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  providerMonitorSettingName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const ProviderMonitorSettingsUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param providerMonitorSettingName - The name of the provider monitor setting.
 */
export const ProviderMonitorSettingsUpdate = /*@__PURE__*/ API.make(() => ({
 ...
 * @param providerNamespace - The name of the resource provider hosted within ProviderHub.
 */
export const ProviderRegistrationsCreateOrUpdate = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const ProviderRegistrationsDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  providerNamespace: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
}).pipe(
 ...
 * @param providerNamespace - The name of the resource provider hosted within ProviderHub.
 */
export const ProviderRegistrationsGenerateOperations = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const ProviderRegistrationsGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  providerNamespace: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
}).pipe(
...
// Output Schema
export const ProviderRegistrationsGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
...
// Input Schema
export const ProviderRegistrationsListInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
}).pipe(
  T.Http({
...
// Output Schema
export const ProviderRegistrationsListOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
...
// Input Schema
export const ResourceActionsDeleteResourcesInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  providerNamespace: Schema.String.pipe(T.PathParam()),
 ...
 */
export const ResourceActionsDeleteResources = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const ResourceTypeRegistrationsCreateOrUpdate = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const ResourceTypeRegistrationsDeleteInput = /*@__PURE__*/ Schema.Struct(
  {
    subscriptionId: Schema.String.pipe(T.PathParam()),
    providerNamespace: Schema.String.pipe(T.PathParam()),
    resourceType: Schema.String.pipe(T.PathParam()),
 ...
 * @param resourceType - The resource type.
 */
export const ResourceTypeRegistrationsDelete = /*@__PURE__*/ API.make(() => ({
  inputSchema: ResourceTypeRegistrationsDeleteInput,
  outputSchema: ResourceTypeRegistrationsDeleteOutput,
}));
// Input Schema
export const ResourceTypeRegistrationsGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  providerNamespace: Schema.String.pipe(T.PathParam()),
  resourceType: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const ResourceTypeRegistrationsGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param resourceType - The resource type.
 */
export const ResourceTypeRegistrationsGet = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const SkusCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  providerNamespace: Schema.String.pipe(T.PathParam()),
  resourceType: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const SkusCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param sku - The SKU.
 */
export const SkusCreateOrUpdateNestedResourceTypeFirst = /*@__PURE__*/ API.make(
  () => ({
 ...
 * @param sku - The SKU.
 */
export const SkusCreateOrUpdateNestedResourceTypeThird = /*@__PURE__*/ API.make(
  () => ({
 ...
 * @param sku - The SKU.
 */
export const SkusDeleteNestedResourceTypeFirst = /*@__PURE__*/ API.make(() => ({
 ...
 * @param sku - The SKU.
 */
export const SkusDeleteNestedResourceTypeSecond = /*@__PURE__*/ API.make(
  () => ({
 ...
 * @param sku - The SKU.
 */
export const SkusDeleteNestedResourceTypeThird = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const SkusGetNestedResourceTypeFirstInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  providerNamespace: Schema.String.pipe(T.PathParam()),
  resourceType: Schema.String.pipe(T.PathParam()),
  nestedResourceTypeFirst: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const SkusGetNestedResourceTypeFirstOutput = /*@__PURE__*/ Schema.Struct(
  {
    id: Schema.optional(Schema.String),
    name: Schema.optional(Schema.String),
    type: Schema.optional(Schema.String),
 ...
 * @param sku - The SKU.
 */
export const SkusGetNestedResourceTypeFirst = /*@__PURE__*/ API.make(() => ({
  inputSchema: SkusGetNestedResourceTypeFirstInput,
  outputSchema: SkusGetNestedResourceTypeFirstOutput,
}));
// Input Schema
export const SkusGetNestedResourceTypeSecondInput = /*@__PURE__*/ Schema.Struct(
  {
    subscriptionId: Schema.String.pipe(T.PathParam()),
    providerNamespace: Schema.String.pipe(T.PathParam()),
    resourceType: Schema.String.pipe(T.PathParam()),
 ...
 * @param sku - The SKU.
 */
export const SkusGetNestedResourceTypeSecond = /*@__PURE__*/ API.make(() => ({
  inputSchema: SkusGetNestedResourceTypeSecondInput,
  outputSchema: SkusGetNestedResourceTypeSecondOutput,
}));
// Input Schema
export const SkusGetNestedResourceTypeThirdInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  providerNamespace: Schema.String.pipe(T.PathParam()),
  resourceType: Schema.String.pipe(T.PathParam()),
  nestedResourceTypeFirst: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const SkusGetNestedResourceTypeThirdOutput = /*@__PURE__*/ Schema.Struct(
  {
    id: Schema.optional(Schema.String),
    name: Schema.optional(Schema.String),
    type: Schema.optional(Schema.String),
 ...
 * @param sku - The SKU.
 */
export const SkusGetNestedResourceTypeThird = /*@__PURE__*/ API.make(() => ({
 ...
 * @param resourceType - The resource type.
 */
export const SkusListByResourceTypeRegistrations = /*@__PURE__*/ API.make(
  () => ({
