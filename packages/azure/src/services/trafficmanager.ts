...
// Input Schema
export const GeographicHierarchiesGetDefaultInput = /*@__PURE__*/ Schema.Struct(
  {
    "api-version": Schema.String,
  },
).pipe(
 ...
 * @param api-version - The API version to use for this operation.
 */
export const GeographicHierarchiesGetDefault = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const ProfilesListBySubscriptionInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
}).pipe(
  T.Http({
...
// Output Schema
export const ProfilesListBySubscriptionOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
 ...
 * @param subscriptionId - The ID of the target subscription.
 */
export const TrafficManagerUserMetricsKeysDelete = /*@__PURE__*/ API.make(
  () => ({
 ...
 * @param subscriptionId - The ID of the target subscription.
 */
export const TrafficManagerUserMetricsKeysGet = /*@__PURE__*/ API.make(() => ({
