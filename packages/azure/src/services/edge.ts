...
// Input Schema
export const ArtifactsListByParentInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  name: Schema.String.pipe(T.PathParam()),
  imageName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const ArtifactsListByParentOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
 ...
 * @param imageName - The name of the Image
 */
export const ArtifactsListByParent = /*@__PURE__*/ API.make(() => ({
  inputSchema: ArtifactsListByParentInput,
  outputSchema: ArtifactsListByParentOutput,
}));
// Input Schema
export const ArtifactsListDownloadUriInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  name: Schema.String.pipe(T.PathParam()),
  imageName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const ArtifactsListDownloadUriOutput = /*@__PURE__*/ Schema.Struct({
 ...
 * @param artifactName - The name of the Artifact
 */
export const ArtifactsListDownloadUri = /*@__PURE__*/ API.make(() => ({
  inputSchema: ArtifactsListDownloadUriInput,
  outputSchema: ArtifactsListDownloadUriOutput,
}));
// Input Schema
export const ConfigTemplatesCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const ConfigTemplatesCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 */
export const ConfigTemplatesCreateOrUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: ConfigTemplatesCreateOrUpdateInput,
  outputSchema: ConfigTemplatesCreateOrUpdateOutput,
}));
// Input Schema
export const ConfigTemplatesCreateVersionInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  configTemplateName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const ConfigTemplatesCreateVersionOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param configTemplateName - The name of the ConfigTemplate
 */
export const ConfigTemplatesCreateVersion = /*@__PURE__*/ API.make(() => ({
  inputSchema: ConfigTemplatesCreateVersionInput,
  outputSchema: ConfigTemplatesCreateVersionOutput,
}));
// Input Schema
export const ConfigTemplatesDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  configTemplateName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const ConfigTemplatesDeleteOutput = Schema.Void;
 ...
 * @param configTemplateName - The name of the ConfigTemplate
 */
export const ConfigTemplatesDelete = /*@__PURE__*/ API.make(() => ({
  inputSchema: ConfigTemplatesDeleteInput,
  outputSchema: ConfigTemplatesDeleteOutput,
}));
// Input Schema
export const ConfigTemplatesGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  configTemplateName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const ConfigTemplatesGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param configTemplateName - The name of the ConfigTemplate
 */
export const ConfigTemplatesGet = /*@__PURE__*/ API.make(() => ({
 ...
 * @param resourceGroupName - The name of the resource group. The name is case insensitive.
 */
export const ConfigTemplatesListByResourceGroup = /*@__PURE__*/ API.make(
  () => ({
 ...
 * @param subscriptionId - The ID of the target subscription. The value must be an UUID.
 */
export const ConfigTemplatesListBySubscription = /*@__PURE__*/ API.make(() => ({
  inputSchema: ConfigTemplatesListBySubscriptionInput,
  outputSchema: ConfigTemplatesListBySubscriptionOutput,
}));
// Input Schema
export const ConfigTemplatesRemoveVersionInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  configTemplateName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const ConfigTemplatesRemoveVersionOutput = /*@__PURE__*/ Schema.Struct({
 ...
 * @param configTemplateName - The name of the ConfigTemplate
 */
export const ConfigTemplatesRemoveVersion = /*@__PURE__*/ API.make(() => ({
  inputSchema: ConfigTemplatesRemoveVersionInput,
  outputSchema: ConfigTemplatesRemoveVersionOutput,
}));
// Input Schema
export const ConfigTemplatesUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  configTemplateName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const ConfigTemplatesUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param configTemplateName - The name of the ConfigTemplate
 */
export const ConfigTemplatesUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: ConfigTemplatesUpdateInput,
  outputSchema: ConfigTemplatesUpdateOutput,
}));
// Input Schema
export const ConfigTemplateVersionsGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  configTemplateName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const ConfigTemplateVersionsGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 */
export const ConfigTemplateVersionsGet = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const ConfigurationReferencesCreateOrUpdate = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const ConfigurationReferencesDeleteInput = /*@__PURE__*/ Schema.Struct({
  configurationReferenceName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
}).pipe(
  T.Http({
...
// Output Schema
export const ConfigurationReferencesDeleteOutput = Schema.Void;
 ...
 * @param configurationReferenceName - The name of the ConfigurationReference
 */
export const ConfigurationReferencesDelete = /*@__PURE__*/ API.make(() => ({
  inputSchema: ConfigurationReferencesDeleteInput,
  outputSchema: ConfigurationReferencesDeleteOutput,
}));
// Input Schema
export const ConfigurationReferencesGetInput = /*@__PURE__*/ Schema.Struct({
  configurationReferenceName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
}).pipe(
  T.Http({
...
// Output Schema
export const ConfigurationReferencesGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param configurationReferenceName - The name of the ConfigurationReference
 */
export const ConfigurationReferencesGet = /*@__PURE__*/ API.make(() => ({
  inputSchema: ConfigurationReferencesGetInput,
  outputSchema: ConfigurationReferencesGetOutput,
}));
// Input Schema
export const ConfigurationReferencesListInput = /*@__PURE__*/ Schema.Struct({
  "api-version": Schema.String,
}).pipe(
  T.Http({
    method: "GET",
...
// Output Schema
export const ConfigurationReferencesListOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
 ...
 * @param api-version - The API version to use for this operation.
 */
export const ConfigurationReferencesList = /*@__PURE__*/ API.make(() => ({
  inputSchema: ConfigurationReferencesListInput,
  outputSchema: ConfigurationReferencesListOutput,
}));
// Input Schema
export const ConfigurationReferencesUpdateInput = /*@__PURE__*/ Schema.Struct({
  configurationReferenceName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
}).pipe(
  T.Http({
...
// Output Schema
export const ConfigurationReferencesUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param configurationReferenceName - The name of the ConfigurationReference
 */
export const ConfigurationReferencesUpdate = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const ConfigurationsDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  configurationName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const ConfigurationsDeleteOutput = Schema.Void;
 ...
 * @param configurationName - Name of the Configuration
 */
export const ConfigurationsDelete = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const ContextsCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const ContextsCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 */
export const ContextsCreateOrUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: ContextsCreateOrUpdateInput,
  outputSchema: ContextsCreateOrUpdateOutput,
}));
// Input Schema
export const ContextsDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  contextName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const ContextsDeleteOutput = Schema.Void;
 ...
 * @param contextName - The name of the Context.
 */
export const ContextsDelete = /*@__PURE__*/ API.make(() => ({
  inputSchema: ContextsDeleteInput,
  outputSchema: ContextsDeleteOutput,
}));
// Input Schema
export const ContextsGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  contextName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const ContextsGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param contextName - The name of the Context.
 */
export const ContextsGet = /*@__PURE__*/ API.make(() => ({
  inputSchema: ContextsGetInput,
  outputSchema: ContextsGetOutput,
}));
// Input Schema
export const ContextsListByResourceGroupInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
}).pipe(
...
// Output Schema
export const ContextsListByResourceGroupOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
 ...
 * @param resourceGroupName - The name of the resource group. The name is case insensitive.
 */
export const ContextsListByResourceGroup = /*@__PURE__*/ API.make(() => ({
  inputSchema: ContextsListByResourceGroupInput,
  outputSchema: ContextsListByResourceGroupOutput,
}));
// Input Schema
export const ContextsListBySubscriptionInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
}).pipe(
  T.Http({
...
// Output Schema
export const ContextsListBySubscriptionOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
 ...
 * @param subscriptionId - The ID of the target subscription. The value must be an UUID.
 */
export const ContextsListBySubscription = /*@__PURE__*/ API.make(() => ({
  inputSchema: ContextsListBySubscriptionInput,
  outputSchema: ContextsListBySubscriptionOutput,
}));
// Input Schema
export const ContextsUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  contextName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const ContextsUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param contextName - The name of the Context.
 */
export const ContextsUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: ContextsUpdateInput,
  outputSchema: ContextsUpdateOutput,
}));
// Input Schema
export const DiagnosticsCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const DiagnosticsCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 */
export const DiagnosticsCreateOrUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: DiagnosticsCreateOrUpdateInput,
  outputSchema: DiagnosticsCreateOrUpdateOutput,
}));
// Input Schema
export const DiagnosticsDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  diagnosticName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const DiagnosticsDeleteOutput = Schema.Void;
 ...
 * @param diagnosticName - Name of Diagnostic.
 */
export const DiagnosticsDelete = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const DiagnosticsListByResourceGroupInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
}).pipe(
...
// Output Schema
export const DiagnosticsListByResourceGroupOutput = /*@__PURE__*/ Schema.Struct(
  {
    value: Schema.Array(
      Schema.Struct({
        id: Schema.optional(Schema.String),
 ...
 * @param resourceGroupName - The name of the resource group. The name is case insensitive.
 */
export const DiagnosticsListByResourceGroup = /*@__PURE__*/ API.make(() => ({
  inputSchema: DiagnosticsListByResourceGroupInput,
  outputSchema: DiagnosticsListByResourceGroupOutput,
}));
// Input Schema
export const DiagnosticsListBySubscriptionInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
}).pipe(
  T.Http({
...
// Output Schema
export const DiagnosticsListBySubscriptionOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
 ...
 * @param subscriptionId - The ID of the target subscription. The value must be an UUID.
 */
export const DiagnosticsListBySubscription = /*@__PURE__*/ API.make(() => ({
  inputSchema: DiagnosticsListBySubscriptionInput,
  outputSchema: DiagnosticsListBySubscriptionOutput,
}));
// Input Schema
export const DiagnosticsUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  diagnosticName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const DiagnosticsUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param diagnosticName - Name of Diagnostic.
 */
export const DiagnosticsUpdate = /*@__PURE__*/ API.make(() => ({
 ...
 * @param name - Name of the resource
 */
export const DisconnectedOperationsCreateOrUpdate = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const DisconnectedOperationsDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  name: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const DisconnectedOperationsDeleteOutput = Schema.Void;
 ...
 * @param name - Name of the resource
 */
export const DisconnectedOperationsDelete = /*@__PURE__*/ API.make(() => ({
  inputSchema: DisconnectedOperationsDeleteInput,
  outputSchema: DisconnectedOperationsDeleteOutput,
}));
// Input Schema
export const DisconnectedOperationsGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  name: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const DisconnectedOperationsGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param name - Name of the resource
 */
export const DisconnectedOperationsGet = /*@__PURE__*/ API.make(() => ({
 ...
 * @param resourceGroupName - The name of the resource group. The name is case insensitive.
 */
export const DisconnectedOperationsListByResourceGroup = /*@__PURE__*/ API.make(
  () => ({
 ...
 * @param subscriptionId - The ID of the target subscription. The value must be an UUID.
 */
export const DisconnectedOperationsListBySubscription = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const DisconnectedOperationsUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  name: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const DisconnectedOperationsUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param name - Name of the resource
 */
export const DisconnectedOperationsUpdate = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const DynamicConfigurationsCreateOrUpdate = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const DynamicConfigurationsDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  configurationName: Schema.String.pipe(T.PathParam()),
  dynamicConfigurationName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const DynamicConfigurationsDeleteOutput = Schema.Void;
 ...
 * @param dynamicConfigurationName - Name of the dynamic configuration
 */
export const DynamicConfigurationsDelete = /*@__PURE__*/ API.make(() => ({
  inputSchema: DynamicConfigurationsDeleteInput,
  outputSchema: DynamicConfigurationsDeleteOutput,
}));
// Input Schema
export const DynamicConfigurationsGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  configurationName: Schema.String.pipe(T.PathParam()),
  dynamicConfigurationName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const DynamicConfigurationsGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param dynamicConfigurationName - Name of the dynamic configuration
 */
export const DynamicConfigurationsGet = /*@__PURE__*/ API.make(() => ({
 ...
 * @param configurationName - Name of the Configuration
 */
export const DynamicConfigurationsListByConfiguration = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const DynamicConfigurationsUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  configurationName: Schema.String.pipe(T.PathParam()),
  dynamicConfigurationName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const DynamicConfigurationsUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param dynamicConfigurationName - Name of the dynamic configuration
 */
export const DynamicConfigurationsUpdate = /*@__PURE__*/ API.make(() => ({
...
// Output Schema
export const DynamicConfigurationVersionsDeleteOutput = Schema.Void;
 ...
 * @param dynamicConfigurationVersionName - The name of the DynamicConfigurationVersion
 */
export const DynamicConfigurationVersionsDelete = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const DynamicConfigurationVersionsGetInput = /*@__PURE__*/ Schema.Struct(
  {
    subscriptionId: Schema.String.pipe(T.PathParam()),
    resourceGroupName: Schema.String.pipe(T.PathParam()),
    configurationName: Schema.String.pipe(T.PathParam()),
 ...
 * @param dynamicConfigurationVersionName - The name of the DynamicConfigurationVersion
 */
export const DynamicConfigurationVersionsGet = /*@__PURE__*/ API.make(() => ({
 ...
 * @param dynamicConfigurationVersionName - The name of the DynamicConfigurationVersion
 */
export const DynamicConfigurationVersionsUpdate = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const DynamicSchemasCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const DynamicSchemasCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 */
export const DynamicSchemasCreateOrUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: DynamicSchemasCreateOrUpdateInput,
  outputSchema: DynamicSchemasCreateOrUpdateOutput,
}));
// Input Schema
export const DynamicSchemasDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  schemaName: Schema.String.pipe(T.PathParam()),
  dynamicSchemaName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const DynamicSchemasDeleteOutput = Schema.Void;
 ...
 * @param dynamicSchemaName - The name of the DynamicSchema
 */
export const DynamicSchemasDelete = /*@__PURE__*/ API.make(() => ({
  inputSchema: DynamicSchemasDeleteInput,
  outputSchema: DynamicSchemasDeleteOutput,
}));
// Input Schema
export const DynamicSchemasGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  schemaName: Schema.String.pipe(T.PathParam()),
  dynamicSchemaName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const DynamicSchemasGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param dynamicSchemaName - The name of the DynamicSchema
 */
export const DynamicSchemasGet = /*@__PURE__*/ API.make(() => ({
  inputSchema: DynamicSchemasGetInput,
  outputSchema: DynamicSchemasGetOutput,
}));
// Input Schema
export const DynamicSchemasListBySchemaInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  schemaName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const DynamicSchemasListBySchemaOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
 ...
 * @param schemaName - The name of the Schema
 */
export const DynamicSchemasListBySchema = /*@__PURE__*/ API.make(() => ({
  inputSchema: DynamicSchemasListBySchemaInput,
  outputSchema: DynamicSchemasListBySchemaOutput,
}));
// Input Schema
export const DynamicSchemasUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  schemaName: Schema.String.pipe(T.PathParam()),
  dynamicSchemaName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const DynamicSchemasUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param dynamicSchemaName - The name of the DynamicSchema
 */
export const DynamicSchemasUpdate = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const DynamicSchemaVersionsCreateOrUpdate = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const DynamicSchemaVersionsDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  schemaName: Schema.String.pipe(T.PathParam()),
  dynamicSchemaName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const DynamicSchemaVersionsDeleteOutput = Schema.Void;
 ...
 * @param dynamicSchemaVersionName - The name of the DynamicSchemaVersion
 */
export const DynamicSchemaVersionsDelete = /*@__PURE__*/ API.make(() => ({
  inputSchema: DynamicSchemaVersionsDeleteInput,
  outputSchema: DynamicSchemaVersionsDeleteOutput,
}));
// Input Schema
export const DynamicSchemaVersionsGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  schemaName: Schema.String.pipe(T.PathParam()),
  dynamicSchemaName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const DynamicSchemaVersionsGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param dynamicSchemaVersionName - The name of the DynamicSchemaVersion
 */
export const DynamicSchemaVersionsGet = /*@__PURE__*/ API.make(() => ({
 ...
 * @param dynamicSchemaName - The name of the DynamicSchema
 */
export const DynamicSchemaVersionsListByDynamicSchema = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const DynamicSchemaVersionsUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  schemaName: Schema.String.pipe(T.PathParam()),
  dynamicSchemaName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const DynamicSchemaVersionsUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param dynamicSchemaVersionName - The name of the DynamicSchemaVersion
 */
export const DynamicSchemaVersionsUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: DynamicSchemaVersionsUpdateInput,
  outputSchema: DynamicSchemaVersionsUpdateOutput,
}));
// Input Schema
export const ExecutionsCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  contextName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const ExecutionsCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 */
export const ExecutionsCreateOrUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: ExecutionsCreateOrUpdateInput,
  outputSchema: ExecutionsCreateOrUpdateOutput,
}));
// Input Schema
export const ExecutionsDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  contextName: Schema.String.pipe(T.PathParam()),
  workflowName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const ExecutionsDeleteOutput = Schema.Void;
 ...
 * @param executionName - The name of the Execution.
 */
export const ExecutionsDelete = /*@__PURE__*/ API.make(() => ({
  inputSchema: ExecutionsDeleteInput,
  outputSchema: ExecutionsDeleteOutput,
}));
// Input Schema
export const ExecutionsGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  contextName: Schema.String.pipe(T.PathParam()),
  workflowName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const ExecutionsGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param executionName - The name of the Execution.
 */
export const ExecutionsGet = /*@__PURE__*/ API.make(() => ({
  inputSchema: ExecutionsGetInput,
  outputSchema: ExecutionsGetOutput,
}));
// Input Schema
export const ExecutionsListByWorkflowVersionInput = /*@__PURE__*/ Schema.Struct(
  {
    subscriptionId: Schema.String.pipe(T.PathParam()),
    resourceGroupName: Schema.String.pipe(T.PathParam()),
    contextName: Schema.String.pipe(T.PathParam()),
 ...
 * @param versionName - The name of the workflowVersion.
 */
export const ExecutionsListByWorkflowVersion = /*@__PURE__*/ API.make(() => ({
  inputSchema: ExecutionsListByWorkflowVersionInput,
  outputSchema: ExecutionsListByWorkflowVersionOutput,
}));
// Input Schema
export const ExecutionsUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  contextName: Schema.String.pipe(T.PathParam()),
  workflowName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const ExecutionsUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param executionName - The name of the Execution.
 */
export const ExecutionsUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: ExecutionsUpdateInput,
  outputSchema: ExecutionsUpdateOutput,
}));
// Input Schema
export const HardwareSettingsCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  name: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const HardwareSettingsCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct(
  {
    id: Schema.optional(Schema.String),
    name: Schema.optional(Schema.String),
    type: Schema.optional(Schema.String),
 ...
 */
export const HardwareSettingsCreateOrUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: HardwareSettingsCreateOrUpdateInput,
  outputSchema: HardwareSettingsCreateOrUpdateOutput,
}));
// Input Schema
export const HardwareSettingsDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  name: Schema.String.pipe(T.PathParam()),
  hardwareSettingName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const HardwareSettingsDeleteOutput = Schema.Void;
 ...
 * @param hardwareSettingName - The name of the HardwareSetting
 */
export const HardwareSettingsDelete = /*@__PURE__*/ API.make(() => ({
  inputSchema: HardwareSettingsDeleteInput,
  outputSchema: HardwareSettingsDeleteOutput,
}));
// Input Schema
export const HardwareSettingsGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  name: Schema.String.pipe(T.PathParam()),
  hardwareSettingName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const HardwareSettingsGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param hardwareSettingName - The name of the HardwareSetting
 */
export const HardwareSettingsGet = /*@__PURE__*/ API.make(() => ({
  inputSchema: HardwareSettingsGetInput,
  outputSchema: HardwareSettingsGetOutput,
}));
// Input Schema
export const HardwareSettingsListByParentInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  name: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const HardwareSettingsListByParentOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
 ...
 * @param name - Name of the resource
 */
export const HardwareSettingsListByParent = /*@__PURE__*/ API.make(() => ({
 ...
 * @param name - Name of the resource
 */
export const ImagesListByDisconnectedOperation = /*@__PURE__*/ API.make(() => ({
  inputSchema: ImagesListByDisconnectedOperationInput,
  outputSchema: ImagesListByDisconnectedOperationOutput,
}));
// Input Schema
export const ImagesListDownloadUriInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  name: Schema.String.pipe(T.PathParam()),
  imageName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const ImagesListDownloadUriOutput = /*@__PURE__*/ Schema.Struct({
  provisioningState: Schema.optional(
    Schema.Literals(["Succeeded", "Failed", "Canceled"]),
  ),
 ...
 * @param imageName - The name of the Image
 */
export const ImagesListDownloadUri = /*@__PURE__*/ API.make(() => ({
  inputSchema: ImagesListDownloadUriInput,
  outputSchema: ImagesListDownloadUriOutput,
}));
// Input Schema
export const InstanceHistoriesGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const InstanceHistoriesGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 */
export const InstanceHistoriesGet = /*@__PURE__*/ API.make(() => ({
  inputSchema: InstanceHistoriesGetInput,
  outputSchema: InstanceHistoriesGetOutput,
}));
// Input Schema
export const InstanceHistoriesListByInstanceInput = /*@__PURE__*/ Schema.Struct(
  {
    subscriptionId: Schema.String.pipe(T.PathParam()),
    resourceGroupName: Schema.String.pipe(T.PathParam()),
    targetName: Schema.String.pipe(T.PathParam()),
 ...
 * @param instanceName - Name of the instance
 */
export const InstanceHistoriesListByInstance = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const InstancesListBySolutionInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  targetName: Schema.String.pipe(T.PathParam()),
  solutionName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const InstancesListBySolutionOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
 ...
 * @param solutionName - Name of the solution
 */
export const InstancesListBySolution = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const JobsListByTargetInput = /*@__PURE__*/ Schema.Struct({
  "api-version": Schema.String,
}).pipe(
  T.Http({
    method: "GET",
...
// Output Schema
export const JobsListByTargetOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
 ...
 * @param api-version - The API version to use for this operation.
 */
export const JobsListByTarget = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const SchemaReferencesCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const SchemaReferencesCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct(
  {
    id: Schema.optional(Schema.String),
    name: Schema.optional(Schema.String),
    type: Schema.optional(Schema.String),
 ...
 */
export const SchemaReferencesCreateOrUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: SchemaReferencesCreateOrUpdateInput,
  outputSchema: SchemaReferencesCreateOrUpdateOutput,
}));
// Input Schema
export const SchemaReferencesDeleteInput = /*@__PURE__*/ Schema.Struct({
  schemaReferenceName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
}).pipe(
  T.Http({
...
// Output Schema
export const SchemaReferencesDeleteOutput = Schema.Void;
 ...
 * @param schemaReferenceName - The name of the SchemaReference
 */
export const SchemaReferencesDelete = /*@__PURE__*/ API.make(() => ({
  inputSchema: SchemaReferencesDeleteInput,
  outputSchema: SchemaReferencesDeleteOutput,
}));
// Input Schema
export const SchemaReferencesGetInput = /*@__PURE__*/ Schema.Struct({
  schemaReferenceName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
}).pipe(
  T.Http({
...
// Output Schema
export const SchemaReferencesGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param schemaReferenceName - The name of the SchemaReference
 */
export const SchemaReferencesGet = /*@__PURE__*/ API.make(() => ({
 ...
 * @param api-version - The API version to use for this operation.
 */
export const SchemaReferencesListByResourceGroup = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const SchemaReferencesUpdateInput = /*@__PURE__*/ Schema.Struct({
  schemaReferenceName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
}).pipe(
  T.Http({
...
// Output Schema
export const SchemaReferencesUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param schemaReferenceName - The name of the SchemaReference
 */
export const SchemaReferencesUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: SchemaReferencesUpdateInput,
  outputSchema: SchemaReferencesUpdateOutput,
}));
// Input Schema
export const SchemasCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  schemaName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const SchemasCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param schemaName - The name of the Schema
 */
export const SchemasCreateOrUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: SchemasCreateOrUpdateInput,
  outputSchema: SchemasCreateOrUpdateOutput,
}));
// Input Schema
export const SchemasCreateVersionInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  schemaName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const SchemasCreateVersionOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param schemaName - The name of the Schema
 */
export const SchemasCreateVersion = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const SchemasListByResourceGroupInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
}).pipe(
...
// Output Schema
export const SchemasListByResourceGroupOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
 ...
 * @param resourceGroupName - The name of the resource group. The name is case insensitive.
 */
export const SchemasListByResourceGroup = /*@__PURE__*/ API.make(() => ({
  inputSchema: SchemasListByResourceGroupInput,
  outputSchema: SchemasListByResourceGroupOutput,
}));
// Input Schema
export const SchemasListBySubscriptionInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
}).pipe(
  T.Http({
...
// Output Schema
export const SchemasListBySubscriptionOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
 ...
 * @param subscriptionId - The ID of the target subscription. The value must be an UUID.
 */
export const SchemasListBySubscription = /*@__PURE__*/ API.make(() => ({
  inputSchema: SchemasListBySubscriptionInput,
  outputSchema: SchemasListBySubscriptionOutput,
}));
// Input Schema
export const SchemasRemoveVersionInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  schemaName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const SchemasRemoveVersionOutput = /*@__PURE__*/ Schema.Struct({
  status: Schema.String,
});
 ...
 * @param schemaName - The name of the Schema
 */
export const SchemasRemoveVersion = /*@__PURE__*/ API.make(() => ({
  inputSchema: SchemasRemoveVersionInput,
  outputSchema: SchemasRemoveVersionOutput,
}));
// Input Schema
export const SchemasUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  schemaName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const SchemasUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param schemaName - The name of the Schema
 */
export const SchemasUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: SchemasUpdateInput,
  outputSchema: SchemasUpdateOutput,
}));
// Input Schema
export const SchemaVersionsCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  schemaName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const SchemaVersionsCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 */
export const SchemaVersionsCreateOrUpdate = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const SchemaVersionsUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  schemaName: Schema.String.pipe(T.PathParam()),
  schemaVersionName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const SchemaVersionsUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param schemaVersionName - The name of the SchemaVersion
 */
export const SchemaVersionsUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: SchemaVersionsUpdateInput,
  outputSchema: SchemaVersionsUpdateOutput,
}));
// Input Schema
export const SiteReferencesCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  contextName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const SiteReferencesCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 */
export const SiteReferencesCreateOrUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: SiteReferencesCreateOrUpdateInput,
  outputSchema: SiteReferencesCreateOrUpdateOutput,
}));
// Input Schema
export const SiteReferencesDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  contextName: Schema.String.pipe(T.PathParam()),
  siteReferenceName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const SiteReferencesDeleteOutput = Schema.Void;
 ...
 * @param siteReferenceName - The name of the SiteReference
 */
export const SiteReferencesDelete = /*@__PURE__*/ API.make(() => ({
  inputSchema: SiteReferencesDeleteInput,
  outputSchema: SiteReferencesDeleteOutput,
}));
// Input Schema
export const SiteReferencesGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  contextName: Schema.String.pipe(T.PathParam()),
  siteReferenceName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const SiteReferencesGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param siteReferenceName - The name of the SiteReference
 */
export const SiteReferencesGet = /*@__PURE__*/ API.make(() => ({
  inputSchema: SiteReferencesGetInput,
  outputSchema: SiteReferencesGetOutput,
}));
// Input Schema
export const SiteReferencesListByContextInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  contextName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const SiteReferencesListByContextOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
 ...
 * @param contextName - The name of the Context.
 */
export const SiteReferencesListByContext = /*@__PURE__*/ API.make(() => ({
  inputSchema: SiteReferencesListByContextInput,
  outputSchema: SiteReferencesListByContextOutput,
}));
// Input Schema
export const SiteReferencesUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  contextName: Schema.String.pipe(T.PathParam()),
  siteReferenceName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const SiteReferencesUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param siteReferenceName - The name of the SiteReference
 */
export const SiteReferencesUpdate = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const SitesByServiceGroupCreateOrUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: SitesByServiceGroupCreateOrUpdateInput,
  outputSchema: SitesByServiceGroupCreateOrUpdateOutput,
}));
// Input Schema
export const SitesByServiceGroupDeleteInput = /*@__PURE__*/ Schema.Struct({
  servicegroupName: Schema.String.pipe(T.PathParam()),
  siteName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
}).pipe(
...
// Output Schema
export const SitesByServiceGroupDeleteOutput = Schema.Void;
 ...
 * @param siteName - The name of the Site
 */
export const SitesByServiceGroupDelete = /*@__PURE__*/ API.make(() => ({
  inputSchema: SitesByServiceGroupDeleteInput,
  outputSchema: SitesByServiceGroupDeleteOutput,
}));
// Input Schema
export const SitesByServiceGroupGetInput = /*@__PURE__*/ Schema.Struct({
  servicegroupName: Schema.String.pipe(T.PathParam()),
  siteName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
}).pipe(
...
// Output Schema
export const SitesByServiceGroupGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param siteName - The name of the Site
 */
export const SitesByServiceGroupGet = /*@__PURE__*/ API.make(() => ({
 ...
 * @param servicegroupName - The name of the service group
 */
export const SitesByServiceGroupListByServiceGroup = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const SitesByServiceGroupUpdateInput = /*@__PURE__*/ Schema.Struct({
  servicegroupName: Schema.String.pipe(T.PathParam()),
  siteName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
}).pipe(
...
// Output Schema
export const SitesByServiceGroupUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param siteName - The name of the Site
 */
export const SitesByServiceGroupUpdate = /*@__PURE__*/ API.make(() => ({
 ...
 * @param siteName - The name of the Site
 */
export const SitesBySubscriptionCreateOrUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: SitesBySubscriptionCreateOrUpdateInput,
  outputSchema: SitesBySubscriptionCreateOrUpdateOutput,
}));
// Input Schema
export const SitesBySubscriptionDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  siteName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
}).pipe(
...
// Output Schema
export const SitesBySubscriptionDeleteOutput = Schema.Void;
 ...
 * @param siteName - The name of the Site
 */
export const SitesBySubscriptionDelete = /*@__PURE__*/ API.make(() => ({
  inputSchema: SitesBySubscriptionDeleteInput,
  outputSchema: SitesBySubscriptionDeleteOutput,
}));
// Input Schema
export const SitesBySubscriptionGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  siteName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
}).pipe(
...
// Output Schema
export const SitesBySubscriptionGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param siteName - The name of the Site
 */
export const SitesBySubscriptionGet = /*@__PURE__*/ API.make(() => ({
  inputSchema: SitesBySubscriptionGetInput,
  outputSchema: SitesBySubscriptionGetOutput,
}));
// Input Schema
export const SitesBySubscriptionListInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
}).pipe(
  T.Http({
...
// Output Schema
export const SitesBySubscriptionListOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
 ...
 * @param subscriptionId - The ID of the target subscription. The value must be an UUID.
 */
export const SitesBySubscriptionList = /*@__PURE__*/ API.make(() => ({
  inputSchema: SitesBySubscriptionListInput,
  outputSchema: SitesBySubscriptionListOutput,
}));
// Input Schema
export const SitesBySubscriptionUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  siteName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
}).pipe(
...
// Output Schema
export const SitesBySubscriptionUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param siteName - The name of the Site
 */
export const SitesBySubscriptionUpdate = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const SitesUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  siteName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const SitesUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
...
// Input Schema
export const SolutionsCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  targetName: Schema.String.pipe(T.PathParam()),
  solutionName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const SolutionsCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param solutionName - Name of the solution
 */
export const SolutionsCreateOrUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: SolutionsCreateOrUpdateInput,
  outputSchema: SolutionsCreateOrUpdateOutput,
}));
// Input Schema
export const SolutionsDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  targetName: Schema.String.pipe(T.PathParam()),
  solutionName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const SolutionsDeleteOutput = Schema.Void;
 ...
 * @param solutionName - Name of the solution
 */
export const SolutionsDelete = /*@__PURE__*/ API.make(() => ({
  inputSchema: SolutionsDeleteInput,
  outputSchema: SolutionsDeleteOutput,
}));
// Input Schema
export const SolutionsGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  targetName: Schema.String.pipe(T.PathParam()),
  solutionName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const SolutionsGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param solutionName - Name of the solution
 */
export const SolutionsGet = /*@__PURE__*/ API.make(() => ({
  inputSchema: SolutionsGetInput,
  outputSchema: SolutionsGetOutput,
}));
// Input Schema
export const SolutionsListByTargetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  targetName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const SolutionsListByTargetOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
 ...
 * @param targetName - Name of the target
 */
export const SolutionsListByTarget = /*@__PURE__*/ API.make(() => ({
  inputSchema: SolutionsListByTargetInput,
  outputSchema: SolutionsListByTargetOutput,
}));
// Input Schema
export const SolutionsUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  targetName: Schema.String.pipe(T.PathParam()),
  solutionName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const SolutionsUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param solutionName - Name of the solution
 */
export const SolutionsUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: SolutionsUpdateInput,
  outputSchema: SolutionsUpdateOutput,
}));
// Input Schema
export const SolutionTemplatesCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct(
  {
    subscriptionId: Schema.String.pipe(T.PathParam()),
    resourceGroupName: Schema.String.pipe(T.PathParam()),
 ...
 */
export const SolutionTemplatesCreateOrUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: SolutionTemplatesCreateOrUpdateInput,
  outputSchema: SolutionTemplatesCreateOrUpdateOutput,
}));
// Input Schema
export const SolutionTemplatesCreateVersionInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  solutionTemplateName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const SolutionTemplatesCreateVersionOutput = /*@__PURE__*/ Schema.Struct(
  {
    id: Schema.optional(Schema.String),
    name: Schema.optional(Schema.String),
    type: Schema.optional(Schema.String),
 ...
 * @param solutionTemplateName - The name of the SolutionTemplate
 */
export const SolutionTemplatesCreateVersion = /*@__PURE__*/ API.make(() => ({
  inputSchema: SolutionTemplatesCreateVersionInput,
  outputSchema: SolutionTemplatesCreateVersionOutput,
}));
// Input Schema
export const SolutionTemplatesDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  solutionTemplateName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const SolutionTemplatesDeleteOutput = Schema.Void;
 ...
 * @param solutionTemplateName - The name of the SolutionTemplate
 */
export const SolutionTemplatesDelete = /*@__PURE__*/ API.make(() => ({
  inputSchema: SolutionTemplatesDeleteInput,
  outputSchema: SolutionTemplatesDeleteOutput,
}));
// Input Schema
export const SolutionTemplatesGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  solutionTemplateName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const SolutionTemplatesGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param solutionTemplateName - The name of the SolutionTemplate
 */
export const SolutionTemplatesGet = /*@__PURE__*/ API.make(() => ({
 ...
 * @param resourceGroupName - The name of the resource group. The name is case insensitive.
 */
export const SolutionTemplatesListByResourceGroup = /*@__PURE__*/ API.make(
  () => ({
 ...
 * @param subscriptionId - The ID of the target subscription. The value must be an UUID.
 */
export const SolutionTemplatesListBySubscription = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const SolutionTemplatesRemoveVersionInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  solutionTemplateName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const SolutionTemplatesRemoveVersionOutput = Schema.Void;
 ...
 * @param solutionTemplateName - The name of the SolutionTemplate
 */
export const SolutionTemplatesRemoveVersion = /*@__PURE__*/ API.make(() => ({
  inputSchema: SolutionTemplatesRemoveVersionInput,
  outputSchema: SolutionTemplatesRemoveVersionOutput,
}));
// Input Schema
export const SolutionTemplatesUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  solutionTemplateName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const SolutionTemplatesUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param solutionTemplateName - The name of the SolutionTemplate
 */
export const SolutionTemplatesUpdate = /*@__PURE__*/ API.make(() => ({
...
// Output Schema
export const SolutionTemplateVersionsBulkDeploySolutionOutput = Schema.Void;
...
// Output Schema
export const SolutionTemplateVersionsBulkPublishSolutionOutput = Schema.Void;
...
// Output Schema
export const SolutionTemplateVersionsBulkReviewSolutionOutput = Schema.Void;
...
// Input Schema
export const SolutionTemplateVersionsGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  solutionTemplateName: Schema.String.pipe(T.PathParam()),
  solutionTemplateVersionName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const SolutionTemplateVersionsGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param solutionTemplateVersionName - The name of the SolutionTemplateVersion
 */
export const SolutionTemplateVersionsGet = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const SolutionVersionsCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  targetName: Schema.String.pipe(T.PathParam()),
  solutionName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const SolutionVersionsCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct(
  {
    id: Schema.optional(Schema.String),
    name: Schema.optional(Schema.String),
    type: Schema.optional(Schema.String),
 ...
 */
export const SolutionVersionsCreateOrUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: SolutionVersionsCreateOrUpdateInput,
  outputSchema: SolutionVersionsCreateOrUpdateOutput,
}));
// Input Schema
export const SolutionVersionsDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  targetName: Schema.String.pipe(T.PathParam()),
  solutionName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const SolutionVersionsDeleteOutput = Schema.Void;
 ...
 * @param solutionVersionName - Name of the solution version
 */
export const SolutionVersionsDelete = /*@__PURE__*/ API.make(() => ({
  inputSchema: SolutionVersionsDeleteInput,
  outputSchema: SolutionVersionsDeleteOutput,
}));
// Input Schema
export const SolutionVersionsGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  targetName: Schema.String.pipe(T.PathParam()),
  solutionName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const SolutionVersionsGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param solutionVersionName - Name of the solution version
 */
export const SolutionVersionsGet = /*@__PURE__*/ API.make(() => ({
  inputSchema: SolutionVersionsGetInput,
  outputSchema: SolutionVersionsGetOutput,
}));
// Input Schema
export const SolutionVersionsListBySolutionInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  targetName: Schema.String.pipe(T.PathParam()),
  solutionName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const SolutionVersionsListBySolutionOutput = /*@__PURE__*/ Schema.Struct(
  {
    value: Schema.Array(
      Schema.Struct({
        id: Schema.optional(Schema.String),
 ...
 * @param solutionName - Name of the solution
 */
export const SolutionVersionsListBySolution = /*@__PURE__*/ API.make(() => ({
  inputSchema: SolutionVersionsListBySolutionInput,
  outputSchema: SolutionVersionsListBySolutionOutput,
}));
// Input Schema
export const SolutionVersionsUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  targetName: Schema.String.pipe(T.PathParam()),
  solutionName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const SolutionVersionsUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param solutionVersionName - Name of the solution version
 */
export const SolutionVersionsUpdate = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const TargetsInstallSolutionInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  targetName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const TargetsInstallSolutionOutput = Schema.Void;
 ...
 * @param targetName - Name of the target
 */
export const TargetsInstallSolution = /*@__PURE__*/ API.make(() => ({
  inputSchema: TargetsInstallSolutionInput,
  outputSchema: TargetsInstallSolutionOutput,
}));
// Input Schema
export const TargetsListByResourceGroupInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
}).pipe(
...
// Output Schema
export const TargetsListByResourceGroupOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
 ...
 * @param resourceGroupName - The name of the resource group. The name is case insensitive.
 */
export const TargetsListByResourceGroup = /*@__PURE__*/ API.make(() => ({
  inputSchema: TargetsListByResourceGroupInput,
  outputSchema: TargetsListByResourceGroupOutput,
}));
// Input Schema
export const TargetsListBySubscriptionInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
}).pipe(
  T.Http({
...
// Output Schema
export const TargetsListBySubscriptionOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
 ...
 * @param subscriptionId - The ID of the target subscription. The value must be an UUID.
 */
export const TargetsListBySubscription = /*@__PURE__*/ API.make(() => ({
  inputSchema: TargetsListBySubscriptionInput,
  outputSchema: TargetsListBySubscriptionOutput,
}));
// Input Schema
export const TargetsPublishSolutionVersionInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  targetName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const TargetsPublishSolutionVersionOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param targetName - Name of the target
 */
export const TargetsPublishSolutionVersion = /*@__PURE__*/ API.make(() => ({
  inputSchema: TargetsPublishSolutionVersionInput,
  outputSchema: TargetsPublishSolutionVersionOutput,
}));
// Input Schema
export const TargetsRemoveRevisionInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  targetName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const TargetsRemoveRevisionOutput = Schema.Void;
 ...
 * @param targetName - Name of the target
 */
export const TargetsRemoveRevision = /*@__PURE__*/ API.make(() => ({
  inputSchema: TargetsRemoveRevisionInput,
  outputSchema: TargetsRemoveRevisionOutput,
}));
// Input Schema
export const TargetsResolveConfigurationInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  targetName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const TargetsResolveConfigurationOutput = /*@__PURE__*/ Schema.Struct({
 ...
 * @param targetName - Name of the target
 */
export const TargetsResolveConfiguration = /*@__PURE__*/ API.make(() => ({
  inputSchema: TargetsResolveConfigurationInput,
  outputSchema: TargetsResolveConfigurationOutput,
}));
// Input Schema
export const TargetsReviewSolutionVersionInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  targetName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const TargetsReviewSolutionVersionOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param targetName - Name of the target
 */
export const TargetsReviewSolutionVersion = /*@__PURE__*/ API.make(() => ({
  inputSchema: TargetsReviewSolutionVersionInput,
  outputSchema: TargetsReviewSolutionVersionOutput,
}));
// Input Schema
export const TargetsUninstallSolutionInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  targetName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const TargetsUninstallSolutionOutput = Schema.Void;
 ...
 * @param targetName - Name of the target
 */
export const TargetsUninstallSolution = /*@__PURE__*/ API.make(() => ({
  inputSchema: TargetsUninstallSolutionInput,
  outputSchema: TargetsUninstallSolutionOutput,
}));
// Input Schema
export const TargetsUnstageSolutionVersionInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  targetName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const TargetsUnstageSolutionVersionOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param targetName - Name of the target
 */
export const TargetsUnstageSolutionVersion = /*@__PURE__*/ API.make(() => ({
  inputSchema: TargetsUnstageSolutionVersionInput,
  outputSchema: TargetsUnstageSolutionVersionOutput,
}));
// Input Schema
export const TargetsUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  targetName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const TargetsUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param targetName - Name of the target
 */
export const TargetsUpdate = /*@__PURE__*/ API.make(() => ({
 ...
 * @param targetName - Name of the target
 */
export const TargetsUpdateExternalValidationStatus = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const WorkflowsListByContextInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  contextName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const WorkflowsListByContextOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
 ...
 * @param contextName - The name of the Context.
 */
export const WorkflowsListByContext = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const WorkflowVersionsCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  contextName: Schema.String.pipe(T.PathParam()),
  workflowName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const WorkflowVersionsCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct(
  {
    id: Schema.optional(Schema.String),
    name: Schema.optional(Schema.String),
    type: Schema.optional(Schema.String),
 ...
 * @param versionName - The name of the workflowVersion.
 */
export const WorkflowVersionsCreateOrUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: WorkflowVersionsCreateOrUpdateInput,
  outputSchema: WorkflowVersionsCreateOrUpdateOutput,
}));
// Input Schema
export const WorkflowVersionsDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  contextName: Schema.String.pipe(T.PathParam()),
  workflowName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const WorkflowVersionsDeleteOutput = Schema.Void;
 ...
 * @param versionName - The name of the workflowVersion.
 */
export const WorkflowVersionsDelete = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const WorkflowVersionsListByWorkflowInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  contextName: Schema.String.pipe(T.PathParam()),
  workflowName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const WorkflowVersionsListByWorkflowOutput = /*@__PURE__*/ Schema.Struct(
  {
    value: Schema.Array(
      Schema.Struct({
        id: Schema.optional(Schema.String),
 ...
 * @param workflowName - Name of the workflow
 */
export const WorkflowVersionsListByWorkflow = /*@__PURE__*/ API.make(() => ({
  inputSchema: WorkflowVersionsListByWorkflowInput,
  outputSchema: WorkflowVersionsListByWorkflowOutput,
}));
// Input Schema
export const WorkflowVersionsUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  contextName: Schema.String.pipe(T.PathParam()),
  workflowName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const WorkflowVersionsUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param versionName - The name of the workflowVersion.
 */
export const WorkflowVersionsUpdate = /*@__PURE__*/ API.make(() => ({
