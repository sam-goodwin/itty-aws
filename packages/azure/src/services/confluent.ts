...
// Input Schema
export const AccessCreateRoleBindingInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const AccessCreateRoleBindingOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const AccessCreateRoleBinding = /*@__PURE__*/ API.make(() => ({
  inputSchema: AccessCreateRoleBindingInput,
  outputSchema: AccessCreateRoleBindingOutput,
}));
// Input Schema
export const AccessDeleteRoleBindingInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  organizationName: Schema.String.pipe(T.PathParam()),
 ...
 */
export const AccessDeleteRoleBinding = /*@__PURE__*/ API.make(() => ({
  inputSchema: AccessDeleteRoleBindingInput,
  outputSchema: AccessDeleteRoleBindingOutput,
}));
// Input Schema
export const AccessInviteUserInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  organizationName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const AccessInviteUserOutput = /*@__PURE__*/ Schema.Struct({
  kind: Schema.optional(Schema.String),
  id: Schema.optional(Schema.String),
  metadata: Schema.optional(
    Schema.Struct({
 ...
 * @param organizationName - Organization resource name
 */
export const AccessInviteUser = /*@__PURE__*/ API.make(() => ({
  inputSchema: AccessInviteUserInput,
  outputSchema: AccessInviteUserOutput,
}));
// Input Schema
export const AccessListClustersInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  organizationName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const AccessListClustersOutput = /*@__PURE__*/ Schema.Struct({
  kind: Schema.optional(Schema.String),
  metadata: Schema.optional(
    Schema.Struct({
 ...
 * @param organizationName - Organization resource name
 */
export const AccessListClusters = /*@__PURE__*/ API.make(() => ({
  inputSchema: AccessListClustersInput,
  outputSchema: AccessListClustersOutput,
}));
// Input Schema
export const AccessListEnvironmentsInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  organizationName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const AccessListEnvironmentsOutput = /*@__PURE__*/ Schema.Struct({
  kind: Schema.optional(Schema.String),
  metadata: Schema.optional(
    Schema.Struct({
      first: Schema.optional(Schema.String),
 ...
 * @param organizationName - Organization resource name
 */
export const AccessListEnvironments = /*@__PURE__*/ API.make(() => ({
  inputSchema: AccessListEnvironmentsInput,
  outputSchema: AccessListEnvironmentsOutput,
}));
// Input Schema
export const AccessListInvitationsInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  organizationName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const AccessListInvitationsOutput = /*@__PURE__*/ Schema.Struct({
  kind: Schema.optional(Schema.String),
  metadata: Schema.optional(
    Schema.Struct({
      first: Schema.optional(Schema.String),
 ...
 * @param organizationName - Organization resource name
 */
export const AccessListInvitations = /*@__PURE__*/ API.make(() => ({
  inputSchema: AccessListInvitationsInput,
  outputSchema: AccessListInvitationsOutput,
}));
// Input Schema
export const AccessListRoleBindingNameListInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  organizationName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const AccessListRoleBindingNameListOutput = /*@__PURE__*/ Schema.Struct({
  kind: Schema.optional(Schema.String),
  metadata: Schema.optional(
    Schema.Struct({
      first: Schema.optional(Schema.String),
 ...
 * @param organizationName - Organization resource name
 */
export const AccessListRoleBindingNameList = /*@__PURE__*/ API.make(() => ({
  inputSchema: AccessListRoleBindingNameListInput,
  outputSchema: AccessListRoleBindingNameListOutput,
}));
// Input Schema
export const AccessListRoleBindingsInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  organizationName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const AccessListRoleBindingsOutput = /*@__PURE__*/ Schema.Struct({
  kind: Schema.optional(Schema.String),
  metadata: Schema.optional(
    Schema.Struct({
      first: Schema.optional(Schema.String),
 ...
 * @param organizationName - Organization resource name
 */
export const AccessListRoleBindings = /*@__PURE__*/ API.make(() => ({
  inputSchema: AccessListRoleBindingsInput,
  outputSchema: AccessListRoleBindingsOutput,
}));
// Input Schema
export const AccessListServiceAccountsInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  organizationName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const AccessListServiceAccountsOutput = /*@__PURE__*/ Schema.Struct({
  kind: Schema.optional(Schema.String),
  metadata: Schema.optional(
    Schema.Struct({
      first: Schema.optional(Schema.String),
 ...
 * @param organizationName - Organization resource name
 */
export const AccessListServiceAccounts = /*@__PURE__*/ API.make(() => ({
  inputSchema: AccessListServiceAccountsInput,
  outputSchema: AccessListServiceAccountsOutput,
}));
// Input Schema
export const AccessListUsersInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  organizationName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const AccessListUsersOutput = /*@__PURE__*/ Schema.Struct({
  kind: Schema.optional(Schema.String),
  metadata: Schema.optional(
    Schema.Struct({
      first: Schema.optional(Schema.String),
 ...
 * @param organizationName - Organization resource name
 */
export const AccessListUsers = /*@__PURE__*/ API.make(() => ({
  inputSchema: AccessListUsersInput,
  outputSchema: AccessListUsersOutput,
}));
// Input Schema
export const ClusterCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  organizationName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const ClusterCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
 ...
 */
export const ClusterCreateOrUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: ClusterCreateOrUpdateInput,
  outputSchema: ClusterCreateOrUpdateOutput,
}));
// Input Schema
export const ClusterDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  organizationName: Schema.String.pipe(T.PathParam()),
  environmentId: Schema.String.pipe(T.PathParam()),
 ...
 * @param clusterId - Confluent kafka or schema registry cluster id
 */
export const ClusterDelete = /*@__PURE__*/ API.make(() => ({
  inputSchema: ClusterDeleteInput,
  outputSchema: ClusterDeleteOutput,
}));
// Input Schema
export const ConnectorCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  organizationName: Schema.String.pipe(T.PathParam()),
  environmentId: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const ConnectorCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
...
// Input Schema
export const EnvironmentCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  organizationName: Schema.String.pipe(T.PathParam()),
  environmentId: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const EnvironmentCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param environmentId - Confluent environment id
 */
export const EnvironmentCreateOrUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: EnvironmentCreateOrUpdateInput,
  outputSchema: EnvironmentCreateOrUpdateOutput,
}));
// Input Schema
export const EnvironmentDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  organizationName: Schema.String.pipe(T.PathParam()),
  environmentId: Schema.String.pipe(T.PathParam()),
 ...
 * @param environmentId - Confluent environment id
 */
export const EnvironmentDelete = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const OrganizationCreateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  organizationName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const OrganizationCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param organizationName - Organization resource name
 */
export const OrganizationCreate = /*@__PURE__*/ API.make(() => ({
  inputSchema: OrganizationCreateInput,
  outputSchema: OrganizationCreateOutput,
}));
// Input Schema
export const OrganizationCreateAPIKeyInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  organizationName: Schema.String.pipe(T.PathParam()),
  environmentId: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const OrganizationCreateAPIKeyOutput = /*@__PURE__*/ Schema.Struct({
  kind: Schema.optional(Schema.String),
  id: Schema.optional(Schema.String),
  properties: Schema.optional(
    Schema.Struct({
 ...
 * @param clusterId - Confluent kafka or schema registry cluster id
 */
export const OrganizationCreateAPIKey = /*@__PURE__*/ API.make(() => ({
  inputSchema: OrganizationCreateAPIKeyInput,
  outputSchema: OrganizationCreateAPIKeyOutput,
}));
// Input Schema
export const OrganizationDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  organizationName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
 ...
 * @param organizationName - Organization resource name
 */
export const OrganizationDelete = /*@__PURE__*/ API.make(() => ({
  inputSchema: OrganizationDeleteInput,
  outputSchema: OrganizationDeleteOutput,
}));
// Input Schema
export const OrganizationDeleteClusterAPIKeyInput = /*@__PURE__*/ Schema.Struct(
  {
    subscriptionId: Schema.String.pipe(T.PathParam()),
    resourceGroupName: Schema.String.pipe(T.PathParam()),
    organizationName: Schema.String.pipe(T.PathParam()),
 ...
 */
export const OrganizationDeleteClusterAPIKey = /*@__PURE__*/ API.make(() => ({
  inputSchema: OrganizationDeleteClusterAPIKeyInput,
  outputSchema: OrganizationDeleteClusterAPIKeyOutput,
}));
// Input Schema
export const OrganizationGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  organizationName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const OrganizationGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param organizationName - Organization resource name
 */
export const OrganizationGet = /*@__PURE__*/ API.make(() => ({
  inputSchema: OrganizationGetInput,
  outputSchema: OrganizationGetOutput,
}));
// Input Schema
export const OrganizationGetClusterAPIKeyInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  organizationName: Schema.String.pipe(T.PathParam()),
  apiKeyId: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const OrganizationGetClusterAPIKeyOutput = /*@__PURE__*/ Schema.Struct({
  kind: Schema.optional(Schema.String),
  id: Schema.optional(Schema.String),
  properties: Schema.optional(
    Schema.Struct({
 ...
 * @param apiKeyId - Confluent API Key id
 */
export const OrganizationGetClusterAPIKey = /*@__PURE__*/ API.make(() => ({
  inputSchema: OrganizationGetClusterAPIKeyInput,
  outputSchema: OrganizationGetClusterAPIKeyOutput,
}));
// Input Schema
export const OrganizationGetClusterByIdInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  organizationName: Schema.String.pipe(T.PathParam()),
  environmentId: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const OrganizationGetClusterByIdOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param clusterId - Confluent kafka or schema registry cluster id
 */
export const OrganizationGetClusterById = /*@__PURE__*/ API.make(() => ({
  inputSchema: OrganizationGetClusterByIdInput,
  outputSchema: OrganizationGetClusterByIdOutput,
}));
// Input Schema
export const OrganizationGetEnvironmentByIdInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  organizationName: Schema.String.pipe(T.PathParam()),
  environmentId: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const OrganizationGetEnvironmentByIdOutput = /*@__PURE__*/ Schema.Struct(
  {
    id: Schema.optional(Schema.String),
    name: Schema.optional(Schema.String),
    type: Schema.optional(Schema.String),
 ...
 * @param environmentId - Confluent environment id
 */
export const OrganizationGetEnvironmentById = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const OrganizationGetSchemaRegistryClusterById = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const OrganizationListByResourceGroupInput = /*@__PURE__*/ Schema.Struct(
  {
    subscriptionId: Schema.String.pipe(T.PathParam()),
    resourceGroupName: Schema.String.pipe(T.PathParam()),
    "api-version": Schema.String,
 ...
 * @param resourceGroupName - The name of the resource group. The name is case insensitive.
 */
export const OrganizationListByResourceGroup = /*@__PURE__*/ API.make(() => ({
  inputSchema: OrganizationListByResourceGroupInput,
  outputSchema: OrganizationListByResourceGroupOutput,
}));
// Input Schema
export const OrganizationListBySubscriptionInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
}).pipe(
  T.Http({
...
// Output Schema
export const OrganizationListBySubscriptionOutput = /*@__PURE__*/ Schema.Struct(
  {
    value: Schema.Array(
      Schema.Struct({
        id: Schema.optional(Schema.String),
 ...
 * @param subscriptionId - The ID of the target subscription. The value must be an UUID.
 */
export const OrganizationListBySubscription = /*@__PURE__*/ API.make(() => ({
  inputSchema: OrganizationListBySubscriptionInput,
  outputSchema: OrganizationListBySubscriptionOutput,
}));
// Input Schema
export const OrganizationListClustersInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  organizationName: Schema.String.pipe(T.PathParam()),
  environmentId: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const OrganizationListClustersOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
 ...
 * @param pageToken - An opaque pagination token to fetch the next set of records
 */
export const OrganizationListClusters = /*@__PURE__*/ API.make(() => ({
  inputSchema: OrganizationListClustersInput,
  outputSchema: OrganizationListClustersOutput,
}));
// Input Schema
export const OrganizationListEnvironmentsInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  organizationName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const OrganizationListEnvironmentsOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
 ...
 * @param pageToken - An opaque pagination token to fetch the next set of records
 */
export const OrganizationListEnvironments = /*@__PURE__*/ API.make(() => ({
  inputSchema: OrganizationListEnvironmentsInput,
  outputSchema: OrganizationListEnvironmentsOutput,
}));
// Input Schema
export const OrganizationListRegionsInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  organizationName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const OrganizationListRegionsOutput = /*@__PURE__*/ Schema.Struct({
  data: Schema.optional(
    Schema.Array(
      Schema.Struct({
        kind: Schema.optional(Schema.String),
 ...
 * @param organizationName - Organization resource name
 */
export const OrganizationListRegions = /*@__PURE__*/ API.make(() => ({
 ...
 * @param pageToken - An opaque pagination token to fetch the next set of records
 */
export const OrganizationListSchemaRegistryClusters = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const OrganizationOperationsListInput = /*@__PURE__*/ Schema.Struct({
  "api-version": Schema.String,
}).pipe(
  T.Http({ method: "GET", path: "/providers/Microsoft.Confluent/operations" }),
);
export type OrganizationOperationsListInput =
  typeof OrganizationOperationsListInput.Type;

// Output Schema
export const OrganizationOperationsListOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      name: Schema.optional(Schema.String),
 ...
 * @param api-version - The API version to use for this operation.
 */
export const OrganizationOperationsList = /*@__PURE__*/ API.make(() => ({
  inputSchema: OrganizationOperationsListInput,
  outputSchema: OrganizationOperationsListOutput,
}));
// Input Schema
export const OrganizationUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  organizationName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const OrganizationUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param organizationName - Organization resource name
 */
export const OrganizationUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: OrganizationUpdateInput,
  outputSchema: OrganizationUpdateOutput,
}));
// Input Schema
export const TopicsCreateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  organizationName: Schema.String.pipe(T.PathParam()),
  environmentId: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const TopicsCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 */
export const TopicsCreate = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const TopicsListInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  organizationName: Schema.String.pipe(T.PathParam()),
  environmentId: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const TopicsListOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
 ...
 * @param pageToken - An opaque pagination token to fetch the next set of records
 */
export const TopicsList = /*@__PURE__*/ API.make(() => ({
  inputSchema: TopicsListInput,
  outputSchema: TopicsListOutput,
}));
// Input Schema
export const ValidationsValidateOrganizationInput = /*@__PURE__*/ Schema.Struct(
  {
    subscriptionId: Schema.String.pipe(T.PathParam()),
    resourceGroupName: Schema.String.pipe(T.PathParam()),
    organizationName: Schema.String.pipe(T.PathParam()),
 ...
 * @param organizationName - Organization resource name
 */
export const ValidationsValidateOrganization = /*@__PURE__*/ API.make(() => ({
 ...
 * @param organizationName - Organization resource name
 */
export const ValidationsValidateOrganizationV2 = /*@__PURE__*/ API.make(() => ({
