...
const ManagedDashboardSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
const ManagedGrafanaSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(Schema.suspend(() => systemDataSchema)),
});
const ManagedDashboardPropertiesSchema =
...
const ManagedGrafanaPropertiesSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    provisioningState: Schema.optional(
      Schema.suspend(() => ProvisioningStateSchema),
    ),
    ...
    creatorCanAdmin: Schema.optional(
      Schema.suspend(() => CreatorCanAdminSchema),
    ),
    ...
    grafanaIntegrations: Schema.optional(
      Schema.suspend(() => GrafanaIntegrationsSchema),
    ),
    enterpriseConfigurations: Schema.optional(
      Schema.suspend(() => EnterpriseConfigurationsSchema),
    ),
    grafanaConfigurations: Schema.optional(
      Schema.suspend(() => GrafanaConfigurationsSchema),
    ),
    grafanaPlugins: Schema.optional(
      Schema.Record(
        Schema.String,
        Schema.suspend(() => GrafanaPluginSchema),
      ),
    ),
    grafanaMajorVersion: Schema.optional(Schema.String),
  });
const CreatorCanAdminSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Literals([
  "Disabled",
  "Enabled",
]);
...
const AutoGeneratedDomainNameLabelScopeSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Literals(["TenantReuse"]);
const GrafanaIntegrationsSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  azureMonitorWorkspaceIntegrations: Schema.optional(
    Schema.Array(Schema.suspend(() => AzureMonitorWorkspaceIntegrationSchema)),
  ),
});
const AzureMonitorWorkspaceIntegrationSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    azureMonitorWorkspaceResourceId: Schema.optional(Schema.String),
  });
const EnterpriseConfigurationsSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    marketplacePlanId: Schema.optional(Schema.String),
    marketplaceAutoRenew: Schema.optional(
      Schema.suspend(() => MarketplaceAutoRenewSchema),
    ),
  });
const MarketplaceAutoRenewSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Literals([
  "Disabled",
  "Enabled",
]);
const GrafanaConfigurationsSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  smtp: Schema.optional(Schema.suspend(() => SmtpSchema)),
  snapshots: Schema.optional(Schema.suspend(() => SnapshotsSchema)),
  users: Schema.optional(Schema.suspend(() => UsersSchema)),
  security: Schema.optional(Schema.suspend(() => SecuritySchema)),
  unifiedAlertingScreenshots: Schema.optional(
    Schema.suspend(() => UnifiedAlertingScreenshotsSchema),
  ),
});
const SmtpSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  startTLSPolicy: Schema.optional(Schema.suspend(() => StartTLSPolicySchema)),
  skipVerify: Schema.optional(Schema.Boolean),
});
const StartTLSPolicySchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Literals([
  "OpportunisticStartTLS",
  "MandatoryStartTLS",
  "NoStartTLS",
]);
const SnapshotsSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  externalEnabled: Schema.optional(Schema.Boolean),
});
const UsersSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  viewersCanEdit: Schema.optional(Schema.Boolean),
  editorsCanAdmin: Schema.optional(Schema.Boolean),
});
const SecuritySchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  csrfAlwaysCheck: Schema.optional(Schema.Boolean),
});
const UnifiedAlertingScreenshotsSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    captureEnabled: Schema.optional(Schema.Boolean),
  });
const GrafanaPluginSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
const SizeSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Literals(["X1", "X2"]);
...
const ManagedGrafanaPropertiesUpdateParametersSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    zoneRedundancy: Schema.optional(Schema.Literals(["Disabled", "Enabled"])),
    apiKey: Schema.optional(Schema.Literals(["Disabled", "Enabled"])),
    creatorCanAdmin: Schema.optional(
...
const SaasSubscriptionDetailsSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct(
  {
    planId: Schema.optional(Schema.String),
    offerId: Schema.optional(Schema.String),
    publisherId: Schema.optional(Schema.String),
    term: Schema.optional(Schema.suspend(() => SubscriptionTermSchema)),
  },
);
const SubscriptionTermSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  termUnit: Schema.optional(Schema.String),
  startDate: Schema.optional(Schema.String),
  endDate: Schema.optional(Schema.String),
});
const MarketplaceTrialQuotaSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  availablePromotion: Schema.optional(Schema.Literals(["None", "FreeTrial"])),
...
const GrafanaAvailablePluginSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  pluginId: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  author: Schema.optional(Schema.String),
});
const IntegrationFabricSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(Schema.suspend(() => systemDataSchema)),
});
const IntegrationFabricPropertiesSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    provisioningState: Schema.optional(
      Schema.suspend(() => ProvisioningStateSchema),
    ),
...
const IntegrationFabricPropertiesUpdateParametersSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    scenarios: Schema.optional(Schema.Array(Schema.String)),
  });
const ManagedPrivateEndpointModelSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.optional(Schema.String),
    name: Schema.optional(Schema.String),
    type: Schema.optional(Schema.String),
...
const ManagedPrivateEndpointModelPropertiesSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    provisioningState: Schema.optional(
      Schema.suspend(() => ProvisioningStateSchema),
    ),
    ...
    connectionState: Schema.optional(
      Schema.suspend(() => ManagedPrivateEndpointConnectionStateSchema),
    ),
    privateLinkServiceUrl: Schema.optional(Schema.String),
    privateLinkServicePrivateIP: Schema.optional(Schema.String),
  });
const ManagedPrivateEndpointConnectionStateSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    status: Schema.optional(
      Schema.suspend(() => ManagedPrivateEndpointConnectionStatusSchema),
    ),
    description: Schema.optional(Schema.String),
  });
const ManagedPrivateEndpointConnectionStatusSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Literals([
    "Pending",
    "Approved",
    "Rejected",
...
export const DashboardsGetOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  properties: Schema.optional(
    Schema.suspend(() => ManagedDashboardPropertiesSchema),
  ),
...
export const DashboardsListOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  value: Schema.Array(Schema.suspend(() => ManagedDashboardSchema)),
...
export const GrafanaCheckEnterpriseDetailsOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    saasSubscriptionDetails: Schema.optional(
      Schema.suspend(() => SaasSubscriptionDetailsSchema),
    ),
    marketplaceTrialQuota: Schema.optional(
      Schema.suspend(() => MarketplaceTrialQuotaSchema),
    ),
  });
...
export const GrafanaCreateInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  workspaceName: Schema.String.pipe(T.PathParam()),
  properties: Schema.optional(
    Schema.suspend(() => ManagedGrafanaPropertiesSchema),
  ),
...
export const GrafanaFetchAvailablePluginsOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    value: Schema.optional(
      Schema.Array(Schema.suspend(() => GrafanaAvailablePluginSchema)),
    ),
    nextLink: Schema.optional(Schema.String),
  });
...
export const GrafanaListOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  value: Schema.Array(Schema.suspend(() => ManagedGrafanaSchema)),
  nextLink: Schema.optional(Schema.String),
});
...
export const GrafanaUpdateInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  tags: Schema.optional(Schema.Record(Schema.String, Schema.String)),
  properties: Schema.optional(
    Schema.suspend(() => ManagedGrafanaPropertiesUpdateParametersSchema),
  ),
}).pipe(
  T.Http({
    method: "PATCH",
...
export const IntegrationFabricsCreateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    properties: Schema.optional(
      Schema.suspend(() => IntegrationFabricPropertiesSchema),
    ),
    tags: Schema.optional(Schema.Record(Schema.String, Schema.String)),
    location: Schema.String,
  }).pipe(
...
export const IntegrationFabricsListOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    value: Schema.Array(Schema.suspend(() => IntegrationFabricSchema)),
    nextLink: Schema.optional(Schema.String),
  });
...
export const IntegrationFabricsUpdateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    tags: Schema.optional(Schema.Record(Schema.String, Schema.String)),
    properties: Schema.optional(
      Schema.suspend(() => IntegrationFabricPropertiesUpdateParametersSchema),
    ),
  }).pipe(
    T.Http({
      method: "PATCH",
...
export const ManagedPrivateEndpointsCreateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    properties: Schema.optional(
      Schema.suspend(() => ManagedPrivateEndpointModelPropertiesSchema),
    ),
    tags: Schema.optional(Schema.Record(Schema.String, Schema.String)),
    location: Schema.String,
  }).pipe(
...
export const ManagedPrivateEndpointsListOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    value: Schema.Array(
      Schema.suspend(() => ManagedPrivateEndpointModelSchema),
    ),
    nextLink: Schema.optional(Schema.String),
  });
