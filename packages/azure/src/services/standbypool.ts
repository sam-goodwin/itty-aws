 ...
 */
export const StandbyContainerGroupPoolRuntimeViewsGet = /*@__PURE__*/ API.make(
  () => ({
 ...
 * @param standbyContainerGroupPoolName - Name of the standby container group pool
 */
export const StandbyContainerGroupPoolsCreateOrUpdate = /*@__PURE__*/ API.make(
  () => ({
 ...
 * @param standbyContainerGroupPoolName - Name of the standby container group pool
 */
export const StandbyContainerGroupPoolsDelete = /*@__PURE__*/ API.make(() => ({
  inputSchema: StandbyContainerGroupPoolsDeleteInput,
  outputSchema: StandbyContainerGroupPoolsDeleteOutput,
}));
// Input Schema
export const StandbyContainerGroupPoolsGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  standbyContainerGroupPoolName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const StandbyContainerGroupPoolsGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param standbyContainerGroupPoolName - Name of the standby container group pool
 */
export const StandbyContainerGroupPoolsGet = /*@__PURE__*/ API.make(() => ({
 ...
 * @param standbyContainerGroupPoolName - Name of the standby container group pool
 */
export const StandbyContainerGroupPoolsUpdate = /*@__PURE__*/ API.make(() => ({
 ...
 * @param runtimeView - The unique identifier for the runtime view. The input string should be the word 'latest', which will get the latest runtime view of the pool, otherwise the request will fail with NotFound exception.
 */
export const StandbyVirtualMachinePoolRuntimeViewsGet = /*@__PURE__*/ API.make(
  () => ({
 ...
 * @param standbyVirtualMachinePoolName - Name of the standby virtual machine pool
 */
export const StandbyVirtualMachinePoolsCreateOrUpdate = /*@__PURE__*/ API.make(
  () => ({
 ...
 * @param standbyVirtualMachinePoolName - Name of the standby virtual machine pool
 */
export const StandbyVirtualMachinePoolsDelete = /*@__PURE__*/ API.make(() => ({
  inputSchema: StandbyVirtualMachinePoolsDeleteInput,
  outputSchema: StandbyVirtualMachinePoolsDeleteOutput,
}));
// Input Schema
export const StandbyVirtualMachinePoolsGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  standbyVirtualMachinePoolName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const StandbyVirtualMachinePoolsGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param standbyVirtualMachinePoolName - Name of the standby virtual machine pool
 */
export const StandbyVirtualMachinePoolsGet = /*@__PURE__*/ API.make(() => ({
 ...
 * @param standbyVirtualMachinePoolName - Name of the standby virtual machine pool
 */
export const StandbyVirtualMachinePoolsUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: StandbyVirtualMachinePoolsUpdateInput,
  outputSchema: StandbyVirtualMachinePoolsUpdateOutput,
}));
// Input Schema
export const StandbyVirtualMachinesGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  standbyVirtualMachinePoolName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const StandbyVirtualMachinesGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
