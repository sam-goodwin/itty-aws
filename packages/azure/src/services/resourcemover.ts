...
// Input Schema
export const MoveCollectionsBulkRemoveInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const MoveCollectionsBulkRemoveOutput = /*@__PURE__*/ Schema.Struct({
...
// Input Schema
export const MoveCollectionsCommitInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "POST",
...
// Output Schema
export const MoveCollectionsCommitOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  status: Schema.optional(Schema.String),
  startTime: Schema.optional(Schema.String),
...
// Input Schema
export const MoveCollectionsCreateInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "PUT",
...
// Output Schema
export const MoveCollectionsCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
...
// Input Schema
export const MoveCollectionsDeleteInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "DELETE",
    path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/moveCollections/{moveCollectionName}",
  }),
...
// Output Schema
export const MoveCollectionsDeleteOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  status: Schema.optional(Schema.String),
  startTime: Schema.optional(Schema.String),
...
// Input Schema
export const MoveCollectionsDiscardInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "POST",
...
// Output Schema
export const MoveCollectionsDiscardOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  status: Schema.optional(Schema.String),
  startTime: Schema.optional(Schema.String),
...
// Input Schema
export const MoveCollectionsGetInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "GET",
    path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/moveCollections/{moveCollectionName}",
  }),
...
// Output Schema
export const MoveCollectionsGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  etag: Schema.optional(Schema.String),
...
// Input Schema
export const MoveCollectionsInitiateMoveInput = /*@__PURE__*/ Schema.Struct(
  {},
).pipe(
  T.Http({
    method: "POST",
...
// Output Schema
export const MoveCollectionsInitiateMoveOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  status: Schema.optional(Schema.String),
  startTime: Schema.optional(Schema.String),
...
// Input Schema
export const MoveCollectionsListRequiredForInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const MoveCollectionsListRequiredForOutput = /*@__PURE__*/ Schema.Struct(
  {
 ...
 */
export const MoveCollectionsListRequiredFor = /*@__PURE__*/ API.make(() => ({
  inputSchema: MoveCollectionsListRequiredForInput,
  outputSchema: MoveCollectionsListRequiredForOutput,
}));
// Input Schema
export const MoveCollectionsPrepareInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "POST",
...
// Output Schema
export const MoveCollectionsPrepareOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  status: Schema.optional(Schema.String),
  startTime: Schema.optional(Schema.String),
 ...
 */
export const MoveCollectionsResolveDependencies = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const MoveCollectionsUpdateInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "PATCH",
    path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/moveCollections/{moveCollectionName}",
  }),
...
// Output Schema
export const MoveCollectionsUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  etag: Schema.optional(Schema.String),
...
// Input Schema
export const MoveResourcesCreateInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "PUT",
...
// Output Schema
export const MoveResourcesCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  properties: Schema.optional(
...
// Input Schema
export const MoveResourcesDeleteInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "DELETE",
    path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/moveCollections/{moveCollectionName}/moveResources/{moveResourceName}",
  }),
...
// Output Schema
export const MoveResourcesDeleteOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  status: Schema.optional(Schema.String),
  startTime: Schema.optional(Schema.String),
...
// Input Schema
export const MoveResourcesGetInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "GET",
    path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/moveCollections/{moveCollectionName}/moveResources/{moveResourceName}",
  }),
...
// Output Schema
export const MoveResourcesListOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.optional(
    Schema.Array(
      Schema.Struct({
        id: Schema.optional(Schema.String),
...
// Input Schema
export const OperationsDiscoveryGetInput = /*@__PURE__*/ Schema.Struct({}).pipe(
...
// Output Schema
export const OperationsDiscoveryGetOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.optional(
    Schema.Array(
      Schema.Struct({
        name: Schema.optional(Schema.String),
...
// Input Schema
export const UnresolvedDependenciesGetInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const UnresolvedDependenciesGetOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.optional(
    Schema.Array(
      Schema.Struct({
        count: Schema.optional(Schema.Number),
