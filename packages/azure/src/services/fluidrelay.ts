...
// Input Schema
export const FluidRelayContainersDeleteInput = /*@__PURE__*/ Schema.Struct({
...
// Input Schema
export const FluidRelayContainersGetInput = /*@__PURE__*/ Schema.Struct({
  "api-version": Schema.String,
}).pipe(
  T.Http({
    method: "GET",
...
// Output Schema
export const FluidRelayContainersGetOutput = /*@__PURE__*/ Schema.Struct({
...
// Input Schema
export const FluidRelayOperationsListInput = /*@__PURE__*/ Schema.Struct({
  "api-version": Schema.String,
}).pipe(
  T.Http({ method: "GET", path: "/providers/Microsoft.FluidRelay/operations" }),
);
export type FluidRelayOperationsListInput =
  typeof FluidRelayOperationsListInput.Type;

// Output Schema
export const FluidRelayOperationsListOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.optional(
    Schema.Array(
      Schema.Struct({
        name: Schema.optional(Schema.String),
...
// Input Schema
export const FluidRelayServersCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct(
  {
    "api-version": Schema.String,
  },
).pipe(
 ...
 * @param api-version - The API version to use for this operation.
 */
export const FluidRelayServersCreateOrUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: FluidRelayServersCreateOrUpdateInput,
  outputSchema: FluidRelayServersCreateOrUpdateOutput,
}));
// Input Schema
export const FluidRelayServersDeleteInput = /*@__PURE__*/ Schema.Struct({
  "api-version": Schema.String,
}).pipe(
  T.Http({
    method: "DELETE",
...
// Input Schema
export const FluidRelayServersGetInput = /*@__PURE__*/ Schema.Struct({
  "api-version": Schema.String,
}).pipe(
  T.Http({
    method: "GET",
...
// Output Schema
export const FluidRelayServersGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
});
 ...
 * @param api-version - The API version to use for this operation.
 */
export const FluidRelayServersListByResourceGroup = /*@__PURE__*/ API.make(
  () => ({
 ...
 * @param api-version - The API version to use for this operation.
 */
export const FluidRelayServersListBySubscription = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const FluidRelayServersListKeysInput = /*@__PURE__*/ Schema.Struct({
  "api-version": Schema.String,
}).pipe(
  T.Http({
    method: "POST",
...
// Output Schema
export const FluidRelayServersListKeysOutput = /*@__PURE__*/ Schema.Struct({
...
// Input Schema
export const FluidRelayServersRegenerateKeyInput = /*@__PURE__*/ Schema.Struct({
  "api-version": Schema.String,
}).pipe(
  T.Http({
    method: "POST",
...
// Output Schema
export const FluidRelayServersRegenerateKeyOutput = /*@__PURE__*/ Schema.Struct(
  {
    key1: Schema.optional(Schema.String),
    key2: Schema.optional(Schema.String),
  },
 ...
 * @param api-version - The API version to use for this operation.
 */
export const FluidRelayServersRegenerateKey = /*@__PURE__*/ API.make(() => ({
  inputSchema: FluidRelayServersRegenerateKeyInput,
  outputSchema: FluidRelayServersRegenerateKeyOutput,
}));
// Input Schema
export const FluidRelayServersUpdateInput = /*@__PURE__*/ Schema.Struct({
  "api-version": Schema.String,
}).pipe(
  T.Http({
    method: "PATCH",
...
// Output Schema
export const FluidRelayServersUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
});
