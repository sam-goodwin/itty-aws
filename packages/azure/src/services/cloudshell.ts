...
// Input Schema
export const DeleteConsoleInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "DELETE",
...
// Input Schema
export const DeleteConsoleWithLocationInput = /*@__PURE__*/ Schema.Struct(
  {},
).pipe(
  T.Http({
    method: "DELETE",
...
// Input Schema
export const DeleteUserSettingsInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "DELETE",
...
// Input Schema
export const DeleteUserSettingsWithLocationInput = /*@__PURE__*/ Schema.Struct(
  {},
).pipe(
  T.Http({
    method: "DELETE",
 ...
 * Delete cloud shell settings for current signed in user
 */
export const deleteUserSettingsWithLocation = /*@__PURE__*/ API.make(() => ({
  inputSchema: DeleteUserSettingsWithLocationInput,
  outputSchema: DeleteUserSettingsWithLocationOutput,
}));
// Input Schema
export const GetConsoleInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "GET",
    path: "/providers/Microsoft.Portal/consoles/{consoleName}",
  }),
...
// Input Schema
export const GetConsoleWithLocationInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "GET",
    path: "/providers/Microsoft.Portal/locations/{location}/consoles/{consoleName}",
  }),
...
// Input Schema
export const GetUserSettingsInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "GET",
    path: "/providers/Microsoft.Portal/userSettings/{userSettingsName}",
  }),
...
// Input Schema
export const GetUserSettingsWithLocationInput = /*@__PURE__*/ Schema.Struct(
  {},
).pipe(
  T.Http({
    method: "GET",
...
// Input Schema
export const KeepAliveInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "POST",
...
// Input Schema
export const KeepAliveWithLocationInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "POST",
...
// Input Schema
export const PatchUserSettingsInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "PATCH",
    path: "/providers/Microsoft.Portal/userSettings/{userSettingsName}",
  }),
...
// Input Schema
export const PatchUserSettingsWithLocationInput = /*@__PURE__*/ Schema.Struct(
  {},
).pipe(
  T.Http({
    method: "PATCH",
 ...
 * Patch cloud shell settings for current signed in user
 */
export const patchUserSettingsWithLocation = /*@__PURE__*/ API.make(() => ({
  inputSchema: PatchUserSettingsWithLocationInput,
  outputSchema: PatchUserSettingsWithLocationOutput,
}));
// Input Schema
export const PutConsoleInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "PUT",
    path: "/providers/Microsoft.Portal/consoles/{consoleName}",
  }),
...
// Input Schema
export const PutConsoleWithLocationInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "PUT",
    path: "/providers/Microsoft.Portal/locations/{location}/consoles/{consoleName}",
  }),
...
// Input Schema
export const PutUserSettingsInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "PUT",
    path: "/providers/Microsoft.Portal/userSettings/{userSettingsName}",
  }),
...
// Input Schema
export const PutUserSettingsWithLocationInput = /*@__PURE__*/ Schema.Struct(
  {},
).pipe(
  T.Http({
    method: "PUT",
