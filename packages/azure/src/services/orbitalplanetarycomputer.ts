...
// Shared schemas
const GeoCatalogSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
const GeoCatalogPropertiesSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export const GeoCatalogsCreateInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct(
  {
    ...
    properties: Schema.optional(
      Schema.suspend(() => GeoCatalogPropertiesSchema),
    ),
...
export const GeoCatalogsGetOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  properties: Schema.optional(Schema.suspend(() => GeoCatalogPropertiesSchema)),
  identity: Schema.optional(
    Schema.Struct({
      principalId: Schema.optional(Schema.String),
      tenantId: Schema.optional(Schema.String),
...
export const GeoCatalogsListByResourceGroupOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    value: Schema.Array(Schema.suspend(() => GeoCatalogSchema)),
