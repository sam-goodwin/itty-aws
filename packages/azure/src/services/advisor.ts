...
// Input Schema
export const AdvisorScoresListInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "GET",
...
// Output Schema
export const AdvisorScoresListOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const ConfigurationsCreateInResourceGroup = /*@__PURE__*/ API.make(
  () => ({
 ...
 * @param configurationName - Advisor configuration name. Value must be 'default'
 */
export const ConfigurationsCreateInSubscription = /*@__PURE__*/ API.make(
  () => ({
 ...
 * @param resourceGroup - The name of the Azure resource group.
 */
export const ConfigurationsListByResourceGroup = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const ConfigurationsListBySubscription = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const PredictInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "POST",
...
// Input Schema
export const RecommendationMetadataGetInput = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.PathParam()),
}).pipe(
  T.Http({
    method: "GET",
...
// Output Schema
export const RecommendationMetadataGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  properties: Schema.optional(
...
// Input Schema
export const RecommendationMetadataListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const RecommendationMetadataListOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.optional(
    Schema.Array(
      Schema.Struct({
        id: Schema.optional(Schema.String),
...
// Input Schema
export const RecommendationsGenerateInput = /*@__PURE__*/ Schema.Struct(
  {},
).pipe(
  T.Http({
    method: "POST",
...
// Input Schema
export const RecommendationsGetInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const RecommendationsGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 */
export const RecommendationsGetGenerateStatus = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const SuppressionsCreateInput = /*@__PURE__*/ Schema.Struct({
  resourceUri: Schema.String.pipe(T.PathParam()),
  recommendationId: Schema.String.pipe(T.PathParam()),
  name: Schema.String.pipe(T.PathParam()),
}).pipe(
...
// Output Schema
export const SuppressionsCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
...
// Input Schema
export const SuppressionsDeleteInput = /*@__PURE__*/ Schema.Struct({
  resourceUri: Schema.String.pipe(T.PathParam()),
  recommendationId: Schema.String.pipe(T.PathParam()),
  name: Schema.String.pipe(T.PathParam()),
}).pipe(
