...
// Input Schema
export const CustomizationPoliciesGetInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const CustomizationPoliciesGetOutput = /*@__PURE__*/ Schema.Struct({
...
// Input Schema
export const CustomizationPoliciesListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const CustomizationPoliciesListOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const DedicatedCloudNodesCreateOrUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: DedicatedCloudNodesCreateOrUpdateInput,
  outputSchema: DedicatedCloudNodesCreateOrUpdateOutput,
}));
// Input Schema
export const DedicatedCloudNodesDeleteInput = /*@__PURE__*/ Schema.Struct({
  dedicatedCloudNodeName: Schema.String.pipe(T.PathParam()),
}).pipe(
  T.Http({
    method: "DELETE",
...
// Input Schema
export const DedicatedCloudNodesGetInput = /*@__PURE__*/ Schema.Struct({
  dedicatedCloudNodeName: Schema.String.pipe(T.PathParam()),
}).pipe(
  T.Http({
    method: "GET",
...
// Output Schema
export const DedicatedCloudNodesGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  location: Schema.String,
  name: Schema.optional(Schema.String),
  properties: Schema.optional(
 ...
 */
export const DedicatedCloudNodesListByResourceGroup = /*@__PURE__*/ API.make(
  () => ({
 ...
 * @param $skipToken - to be used by nextLink implementation
 */
export const DedicatedCloudNodesListBySubscription = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const DedicatedCloudNodesUpdateInput = /*@__PURE__*/ Schema.Struct({
  dedicatedCloudNodeName: Schema.String.pipe(T.PathParam()),
}).pipe(
  T.Http({
    method: "PATCH",
...
// Output Schema
export const DedicatedCloudNodesUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  location: Schema.String,
  name: Schema.optional(Schema.String),
  properties: Schema.optional(
 ...
 */
export const DedicatedCloudServicesCreateOrUpdate = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const DedicatedCloudServicesDeleteInput = /*@__PURE__*/ Schema.Struct({
  dedicatedCloudServiceName: Schema.String.pipe(T.PathParam()),
}).pipe(
  T.Http({
    method: "DELETE",
 ...
 * @param dedicatedCloudServiceName - dedicated cloud service name
 */
export const DedicatedCloudServicesDelete = /*@__PURE__*/ API.make(() => ({
  inputSchema: DedicatedCloudServicesDeleteInput,
  outputSchema: DedicatedCloudServicesDeleteOutput,
}));
// Input Schema
export const DedicatedCloudServicesGetInput = /*@__PURE__*/ Schema.Struct({
  dedicatedCloudServiceName: Schema.String.pipe(T.PathParam()),
}).pipe(
  T.Http({
    method: "GET",
...
// Output Schema
export const DedicatedCloudServicesGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  location: Schema.String,
  name: Schema.optional(Schema.String),
  properties: Schema.optional(
 ...
 * @param $skipToken - to be used by nextLink implementation
 */
export const DedicatedCloudServicesListByResourceGroup = /*@__PURE__*/ API.make(
  () => ({
 ...
 * @param $skipToken - to be used by nextLink implementation
 */
export const DedicatedCloudServicesListBySubscription = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const DedicatedCloudServicesUpdateInput = /*@__PURE__*/ Schema.Struct({
  dedicatedCloudServiceName: Schema.String.pipe(T.PathParam()),
}).pipe(
  T.Http({
    method: "PATCH",
...
// Output Schema
export const DedicatedCloudServicesUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  location: Schema.String,
  name: Schema.optional(Schema.String),
  properties: Schema.optional(
 ...
 * @param dedicatedCloudServiceName - dedicated cloud service name
 */
export const DedicatedCloudServicesUpdate = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const PrivateCloudsGetInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "GET",
...
// Input Schema
export const PrivateCloudsListInput = /*@__PURE__*/ Schema.Struct({}).pipe(
  T.Http({
    method: "GET",
...
// Input Schema
export const SkusAvailabilityListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const SkusAvailabilityListOutput = /*@__PURE__*/ Schema.Struct({
  nextLink: Schema.optional(Schema.String),
  value: Schema.optional(
    Schema.Array(
      Schema.Struct({
