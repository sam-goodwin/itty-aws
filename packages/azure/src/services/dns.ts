 ...
 */
export const DnsResourceReferenceGetByTargetResources = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const RecordSetsCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const RecordSetsCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
...
// Input Schema
export const RecordSetsListAllByDnsZoneInput = /*@__PURE__*/ Schema.Struct({
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  zoneName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const RecordSetsListAllByDnsZoneOutput = /*@__PURE__*/ Schema.Struct({
...
// Input Schema
export const RecordSetsListByDnsZoneInput = /*@__PURE__*/ Schema.Struct({
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  zoneName: Schema.String.pipe(T.PathParam()),
  $top: Schema.optional(Schema.Number),
  $recordsetnamesuffix: Schema.optional(Schema.String),
...
// Output Schema
export const RecordSetsListByDnsZoneOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.optional(
    Schema.Array(
      Schema.Struct({
        id: Schema.optional(Schema.String),
...
// Input Schema
export const RecordSetsListByTypeInput = /*@__PURE__*/ Schema.Struct({
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  zoneName: Schema.String.pipe(T.PathParam()),
  recordType: Schema.Literals([
    "A",
...
// Output Schema
export const RecordSetsListByTypeOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.optional(
    Schema.Array(
      Schema.Struct({
        id: Schema.optional(Schema.String),
...
// Input Schema
export const ZonesCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  zoneName: Schema.String.pipe(T.PathParam()),
}).pipe(
  T.Http({
...
// Output Schema
export const ZonesCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
...
// Input Schema
export const ZonesListByResourceGroupInput = /*@__PURE__*/ Schema.Struct({
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  $top: Schema.optional(Schema.Number),
}).pipe(
  T.Http({
...
// Output Schema
export const ZonesListByResourceGroupOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.optional(
    Schema.Array(
      Schema.Struct({
        id: Schema.optional(Schema.String),
