...
const CloudHsmClusterSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
const DedicatedHsmSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(Schema.suspend(() => systemDataSchema)),
});
const CloudHsmClusterPropertiesSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    activationState: Schema.optional(
      Schema.suspend(() => ActivationStateSchema),
    ),
    ...
    hsms: Schema.optional(
      Schema.Array(Schema.suspend(() => CloudHsmPropertiesSchema)),
    ),
...
const ActivationStateSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Literals([
  "NotDefined",
  "NotActivated",
  "Active",
  "Failed",
...
const CloudHsmPropertiesSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
const CloudHsmClusterSkuSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  family: Schema.suspend(() => CloudHsmClusterSkuFamilySchema),
  name: Schema.suspend(() => CloudHsmClusterSkuNameSchema),
  capacity: Schema.optional(Schema.Number),
});
const CloudHsmClusterSkuFamilySchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Literals(["B"]);
const CloudHsmClusterSkuNameSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Literals(["Standard_B1", "Standard B10"]);
const BackupResultPropertiesSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  status: Schema.optional(
    Schema.suspend(() => BackupRestoreOperationStatusSchema),
  ),
...
const BackupRestoreOperationStatusSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Literals([
    "InProgress",
    "Succeeded",
    "Failed",
...
const BackupRestoreBaseResultPropertiesSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    status: Schema.optional(
      Schema.suspend(() => BackupRestoreOperationStatusSchema),
    ),
...
export const CloudHsmClusterBackupStatusGetOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    properties: Schema.optional(
      Schema.suspend(() => BackupResultPropertiesSchema),
    ),
  });
...
export const CloudHsmClusterRestoreStatusGetOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    properties: Schema.optional(
      Schema.suspend(() => BackupRestoreBaseResultPropertiesSchema),
    ),
  });
...
export const CloudHsmClustersCreateOrUpdateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    cloudHsmClusterName: Schema.String.pipe(T.PathParam()),
    properties: Schema.optional(
      Schema.suspend(() => CloudHsmClusterPropertiesSchema),
    ),
    ...
    sku: Schema.optional(Schema.suspend(() => CloudHsmClusterSkuSchema)),
...
export const CloudHsmClustersListByResourceGroupOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    value: Schema.Array(Schema.suspend(() => CloudHsmClusterSchema)),
    nextLink: Schema.optional(Schema.String),
  });
...
export const DedicatedHsmCreateOrUpdateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    properties: Schema.suspend(() => DedicatedHsmPropertiesSchema),
...
export const DedicatedHsmListByResourceGroupOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    value: Schema.Array(Schema.suspend(() => DedicatedHsmSchema)),
    nextLink: Schema.optional(Schema.String),
  });
