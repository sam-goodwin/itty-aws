...
// Input Schema
export const CloudHsmClusterBackupStatusGetInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const CloudHsmClusterBackupStatusGetOutput = /*@__PURE__*/ Schema.Struct(
  {
 ...
 */
export const CloudHsmClusterBackupStatusGet = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const CloudHsmClusterRestoreStatusGetInput = /*@__PURE__*/ Schema.Struct(
  {
    subscriptionId: Schema.String.pipe(T.PathParam()),
    resourceGroupName: Schema.String.pipe(T.PathParam()),
    cloudHsmClusterName: Schema.String.pipe(T.PathParam()),
 ...
 */
export const CloudHsmClusterRestoreStatusGet = /*@__PURE__*/ API.make(() => ({
  inputSchema: CloudHsmClusterRestoreStatusGetInput,
  outputSchema: CloudHsmClusterRestoreStatusGetOutput,
}));
// Input Schema
export const CloudHsmClustersBackupInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  cloudHsmClusterName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const CloudHsmClustersBackupOutput = /*@__PURE__*/ Schema.Struct({
  properties: Schema.optional(
    Schema.Struct({
      status: Schema.optional(
        Schema.Literals(["InProgress", "Succeeded", "Failed", "Cancelled"]),
...
// Input Schema
export const CloudHsmClustersCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  cloudHsmClusterName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const CloudHsmClustersCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct(
  {
    id: Schema.optional(Schema.String),
    name: Schema.optional(Schema.String),
    type: Schema.optional(Schema.String),
 ...
 * @param cloudHsmClusterName - The name of the Cloud HSM Cluster within the specified resource group. Cloud HSM Cluster names must be between 3 and 23 characters in length.
 */
export const CloudHsmClustersCreateOrUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: CloudHsmClustersCreateOrUpdateInput,
  outputSchema: CloudHsmClustersCreateOrUpdateOutput,
}));
// Input Schema
export const CloudHsmClustersDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  cloudHsmClusterName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Input Schema
export const CloudHsmClustersGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  cloudHsmClusterName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const CloudHsmClustersGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 */
export const CloudHsmClustersListByResourceGroup = /*@__PURE__*/ API.make(
  () => ({
 ...
 * @param $skiptoken - The page-continuation token to use with a paged version of this API
 */
export const CloudHsmClustersListBySubscription = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const CloudHsmClustersRestoreInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  cloudHsmClusterName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const CloudHsmClustersRestoreOutput = /*@__PURE__*/ Schema.Struct({
  properties: Schema.optional(
    Schema.Struct({
      status: Schema.optional(
        Schema.Literals(["InProgress", "Succeeded", "Failed", "Cancelled"]),
...
// Input Schema
export const CloudHsmClustersUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  cloudHsmClusterName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const CloudHsmClustersUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param cloudHsmClusterName - The name of the Cloud HSM Cluster within the specified resource group. Cloud HSM Cluster names must be between 3 and 23 characters in length.
 */
export const CloudHsmClustersValidateBackupProperties = /*@__PURE__*/ API.make(
  () => ({
 ...
 * @param cloudHsmClusterName - The name of the Cloud HSM Cluster within the specified resource group. Cloud HSM Cluster names must be between 3 and 23 characters in length.
 */
export const CloudHsmClustersValidateRestoreProperties = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const DedicatedHsmCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const DedicatedHsmCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
...
// Input Schema
export const DedicatedHsmDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  name: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Input Schema
export const DedicatedHsmListByResourceGroupInput = /*@__PURE__*/ Schema.Struct(
  {
    subscriptionId: Schema.String.pipe(T.PathParam()),
    resourceGroupName: Schema.String.pipe(T.PathParam()),
    "api-version": Schema.String,
 ...
 */
export const DedicatedHsmListByResourceGroup = /*@__PURE__*/ API.make(() => ({
  inputSchema: DedicatedHsmListByResourceGroupInput,
  outputSchema: DedicatedHsmListByResourceGroupOutput,
}));
// Input Schema
export const DedicatedHsmListBySubscriptionInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
  $top: Schema.optional(Schema.Number),
}).pipe(
...
// Output Schema
export const DedicatedHsmListBySubscriptionOutput = /*@__PURE__*/ Schema.Struct(
  {
    value: Schema.Array(
      Schema.Struct({
        id: Schema.optional(Schema.String),
 ...
 * @param $top - Maximum number of results to return.
 */
export const DedicatedHsmListBySubscription = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const DedicatedHsmUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  name: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const DedicatedHsmUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
