...
// Input Schema
export const DeidServicesCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const DeidServicesCreateOutput = /*@__PURE__*/ Schema.Struct({
...
// Input Schema
export const DeidServicesDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  deidServiceName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Input Schema
export const DeidServicesListByResourceGroupInput = /*@__PURE__*/ Schema.Struct(
  {
    subscriptionId: Schema.String.pipe(T.PathParam()),
    resourceGroupName: Schema.String.pipe(T.PathParam()),
    "api-version": Schema.String,
 ...
 * @param resourceGroupName - The name of the resource group. The name is case insensitive.
 */
export const DeidServicesListByResourceGroup = /*@__PURE__*/ API.make(() => ({
  inputSchema: DeidServicesListByResourceGroupInput,
  outputSchema: DeidServicesListByResourceGroupOutput,
}));
// Input Schema
export const DeidServicesListBySubscriptionInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
}).pipe(
  T.Http({
...
// Output Schema
export const DeidServicesListBySubscriptionOutput = /*@__PURE__*/ Schema.Struct(
  {
    value: Schema.Array(
      Schema.Struct({
        id: Schema.optional(Schema.String),
 ...
 * @param subscriptionId - The ID of the target subscription. The value must be an UUID.
 */
export const DeidServicesListBySubscription = /*@__PURE__*/ API.make(() => ({
  inputSchema: DeidServicesListBySubscriptionInput,
  outputSchema: DeidServicesListBySubscriptionOutput,
}));
// Input Schema
export const DeidServicesUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  deidServiceName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const DeidServicesUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
...
// Input Schema
export const PrivateLinksListByDeidServiceInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  deidServiceName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const PrivateLinksListByDeidServiceOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
      id: Schema.optional(Schema.String),
      name: Schema.optional(Schema.String),
 ...
 * @param deidServiceName - The name of the deid service
 */
export const PrivateLinksListByDeidService = /*@__PURE__*/ API.make(() => ({
