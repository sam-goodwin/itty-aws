...
export type BgpPeerListResultValueList = BgpPeer[];
...
/** IP Range */
export type LoadBalancerPropertiesAddressesList = string[];
...
export type LoadBalancerPropertiesBgpPeersList = string[];
...
export type LoadBalancerListResultValueList = LoadBalancer[];
...
export type StorageClassPropertiesMountOptionsList = string[];
...
export type StorageClassPropertiesAccessModesList = AccessMode[];
...
export type StorageClassPropertiesLimitationsList = string[];
...
export type StorageClassResourceListResultValueList = StorageClassResource[];
