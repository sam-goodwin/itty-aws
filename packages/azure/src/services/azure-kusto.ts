 ...
 * @param attachedDatabaseConfigurationName - The name of the attached database configuration.
 */
export const AttachedDatabaseConfigurationsDelete = /*@__PURE__*/ API.make(
  () => ({
 ...
 * @param attachedDatabaseConfigurationName - The name of the attached database configuration.
 */
export const AttachedDatabaseConfigurationsGet = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const ClusterPrincipalAssignmentsCreateOrUpdate = /*@__PURE__*/ API.make(
  () => ({
 ...
 * @param principalAssignmentName - The name of the Kusto principalAssignment.
 */
export const ClusterPrincipalAssignmentsDelete = /*@__PURE__*/ API.make(() => ({
  inputSchema: ClusterPrincipalAssignmentsDeleteInput,
  outputSchema: ClusterPrincipalAssignmentsDeleteOutput,
}));
// Input Schema
export const ClusterPrincipalAssignmentsGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  clusterName: Schema.String.pipe(T.PathParam()),
  principalAssignmentName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const ClusterPrincipalAssignmentsGetOutput = /*@__PURE__*/ Schema.Struct(
  {
    id: Schema.optional(Schema.String),
    name: Schema.optional(Schema.String),
    type: Schema.optional(Schema.String),
 ...
 * @param principalAssignmentName - The name of the Kusto principalAssignment.
 */
export const ClusterPrincipalAssignmentsGet = /*@__PURE__*/ API.make(() => ({
  inputSchema: ClusterPrincipalAssignmentsGetInput,
  outputSchema: ClusterPrincipalAssignmentsGetOutput,
}));
// Input Schema
export const ClusterPrincipalAssignmentsListInput = /*@__PURE__*/ Schema.Struct(
  {
    subscriptionId: Schema.String.pipe(T.PathParam()),
    resourceGroupName: Schema.String.pipe(T.PathParam()),
    clusterName: Schema.String.pipe(T.PathParam()),
 ...
 * @param clusterName - The name of the Kusto cluster.
 */
export const ClusterPrincipalAssignmentsList = /*@__PURE__*/ API.make(() => ({
  inputSchema: ClusterPrincipalAssignmentsListInput,
  outputSchema: ClusterPrincipalAssignmentsListOutput,
}));
// Input Schema
export const ClustersAddCalloutPoliciesInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  clusterName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Input Schema
export const ClustersAddLanguageExtensionsInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  clusterName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
 ...
 * @param clusterName - The name of the Kusto cluster.
 */
export const ClustersAddLanguageExtensions = /*@__PURE__*/ API.make(() => ({
  inputSchema: ClustersAddLanguageExtensionsInput,
  outputSchema: ClustersAddLanguageExtensionsOutput,
}));
// Input Schema
export const ClustersCheckNameAvailabilityInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const ClustersCheckNameAvailabilityOutput = /*@__PURE__*/ Schema.Struct({
  nameAvailable: Schema.optional(Schema.Boolean),
  name: Schema.optional(Schema.String),
  message: Schema.optional(Schema.String),
  reason: Schema.optional(Schema.Literals(["Invalid", "AlreadyExists"])),
 ...
 */
export const ClustersCheckNameAvailability = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const ClustersDetachFollowerDatabasesInput = /*@__PURE__*/ Schema.Struct(
  {
    subscriptionId: Schema.String.pipe(T.PathParam()),
    resourceGroupName: Schema.String.pipe(T.PathParam()),
    clusterName: Schema.String.pipe(T.PathParam()),
 ...
 * @param clusterName - The name of the Kusto cluster.
 */
export const ClustersDetachFollowerDatabases = /*@__PURE__*/ API.make(() => ({
  inputSchema: ClustersDetachFollowerDatabasesInput,
  outputSchema: ClustersDetachFollowerDatabasesOutput,
}));
// Input Schema
export const ClustersDiagnoseVirtualNetworkInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  clusterName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const ClustersDiagnoseVirtualNetworkOutput = /*@__PURE__*/ Schema.Struct(
  {
 ...
 * @param clusterName - The name of the Kusto cluster.
 */
export const ClustersDiagnoseVirtualNetwork = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const ClustersListCalloutPoliciesInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  clusterName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const ClustersListCalloutPoliciesOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.Array(
    Schema.Struct({
...
// Input Schema
export const ClustersListFollowerDatabasesInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  clusterName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const ClustersListFollowerDatabasesOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.optional(
    Schema.Array(
      Schema.Struct({
 ...
 * @param clusterName - The name of the Kusto cluster.
 */
export const ClustersListFollowerDatabases = /*@__PURE__*/ API.make(() => ({
 ...
 * @param clusterName - The name of the Kusto cluster.
 */
export const ClustersListFollowerDatabasesGet = /*@__PURE__*/ API.make(() => ({
  inputSchema: ClustersListFollowerDatabasesGetInput,
  outputSchema: ClustersListFollowerDatabasesGetOutput,
}));
// Input Schema
export const ClustersListLanguageExtensionsInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  clusterName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const ClustersListLanguageExtensionsOutput = /*@__PURE__*/ Schema.Struct(
  {
    value: Schema.optional(
      Schema.Array(
        Schema.Struct({
 ...
 * @param clusterName - The name of the Kusto cluster.
 */
export const ClustersListLanguageExtensions = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const ClustersListSkusByResourceInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  clusterName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const ClustersListSkusByResourceOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.optional(
    Schema.Array(
      Schema.Struct({
        resourceType: Schema.optional(Schema.String),
...
// Input Schema
export const ClustersRemoveCalloutPolicyInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  clusterName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
 ...
 * @param clusterName - The name of the Kusto cluster.
 */
export const ClustersRemoveLanguageExtensions = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const DatabaseInviteFollowerInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  clusterName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const DatabaseInviteFollowerOutput = /*@__PURE__*/ Schema.Struct({
 ...
 * @param principalAssignmentName - The name of the Kusto principalAssignment.
 */
export const DatabasePrincipalAssignmentsDelete = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const DatabasePrincipalAssignmentsGetInput = /*@__PURE__*/ Schema.Struct(
  {
    subscriptionId: Schema.String.pipe(T.PathParam()),
    resourceGroupName: Schema.String.pipe(T.PathParam()),
    clusterName: Schema.String.pipe(T.PathParam()),
 ...
 * @param principalAssignmentName - The name of the Kusto principalAssignment.
 */
export const DatabasePrincipalAssignmentsGet = /*@__PURE__*/ API.make(() => ({
 ...
 * @param databaseName - The name of the database in the Kusto cluster.
 */
export const DatabasePrincipalAssignmentsList = /*@__PURE__*/ API.make(() => ({
  inputSchema: DatabasePrincipalAssignmentsListInput,
  outputSchema: DatabasePrincipalAssignmentsListOutput,
}));
// Input Schema
export const DatabasesAddPrincipalsInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  clusterName: Schema.String.pipe(T.PathParam()),
  databaseName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const DatabasesAddPrincipalsOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.optional(
    Schema.Array(
      Schema.Struct({
...
// Input Schema
export const DatabasesCheckNameAvailabilityInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  clusterName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const DatabasesCheckNameAvailabilityOutput = /*@__PURE__*/ Schema.Struct(
  {
    nameAvailable: Schema.optional(Schema.Boolean),
    name: Schema.optional(Schema.String),
    message: Schema.optional(Schema.String),
 ...
 * @param clusterName - The name of the Kusto cluster.
 */
export const DatabasesCheckNameAvailability = /*@__PURE__*/ API.make(() => ({
...
// Input Schema
export const DatabasesListPrincipalsInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  clusterName: Schema.String.pipe(T.PathParam()),
  databaseName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const DatabasesListPrincipalsOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.optional(
    Schema.Array(
      Schema.Struct({
        role: Schema.Literals([
...
// Input Schema
export const DatabasesRemovePrincipalsInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  clusterName: Schema.String.pipe(T.PathParam()),
  databaseName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const DatabasesRemovePrincipalsOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.optional(
    Schema.Array(
      Schema.Struct({
        role: Schema.Literals([
 ...
 * @param databaseName - The name of the database in the Kusto cluster.
 */
export const DataConnectionsCheckNameAvailability = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const DataConnectionsCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  clusterName: Schema.String.pipe(T.PathParam()),
  databaseName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const DataConnectionsCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 */
export const DataConnectionsCreateOrUpdate = /*@__PURE__*/ API.make(() => ({
 ...
 * @param databaseName - The name of the database in the Kusto cluster.
 */
export const DataConnectionsDataConnectionValidation = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const DataConnectionsDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  clusterName: Schema.String.pipe(T.PathParam()),
  databaseName: Schema.String.pipe(T.PathParam()),
...
// Input Schema
export const DataConnectionsGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  clusterName: Schema.String.pipe(T.PathParam()),
  databaseName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const DataConnectionsGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
...
// Input Schema
export const DataConnectionsListByDatabaseInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  clusterName: Schema.String.pipe(T.PathParam()),
  databaseName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const DataConnectionsListByDatabaseOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.optional(
    Schema.Array(
      Schema.Struct({
        id: Schema.optional(Schema.String),
 ...
 * @param databaseName - The name of the database in the Kusto cluster.
 */
export const DataConnectionsListByDatabase = /*@__PURE__*/ API.make(() => ({
  inputSchema: DataConnectionsListByDatabaseInput,
  outputSchema: DataConnectionsListByDatabaseOutput,
}));
// Input Schema
export const DataConnectionsUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  clusterName: Schema.String.pipe(T.PathParam()),
  databaseName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const DataConnectionsUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 */
export const ManagedPrivateEndpointsCreateOrUpdate = /*@__PURE__*/ API.make(
  () => ({
...
// Input Schema
export const OperationsResultsGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  location: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const OperationsResultsGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
 ...
 * @param clusterName - The name of the Kusto cluster.
 */
export const SandboxCustomImagesCheckNameAvailability = /*@__PURE__*/ API.make(
  () => ({
 ...
 */
export const SandboxCustomImagesCreateOrUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: SandboxCustomImagesCreateOrUpdateInput,
  outputSchema: SandboxCustomImagesCreateOrUpdateOutput,
}));
// Input Schema
export const SandboxCustomImagesDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  clusterName: Schema.String.pipe(T.PathParam()),
  sandboxCustomImageName: Schema.String.pipe(T.PathParam()),
...
// Input Schema
export const SandboxCustomImagesGetInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  clusterName: Schema.String.pipe(T.PathParam()),
  sandboxCustomImageName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const SandboxCustomImagesGetOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
 ...
 * @param clusterName - The name of the Kusto cluster.
 */
export const SandboxCustomImagesListByCluster = /*@__PURE__*/ API.make(() => ({
  inputSchema: SandboxCustomImagesListByClusterInput,
  outputSchema: SandboxCustomImagesListByClusterOutput,
}));
// Input Schema
export const SandboxCustomImagesUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  clusterName: Schema.String.pipe(T.PathParam()),
  sandboxCustomImageName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const SandboxCustomImagesUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
...
// Input Schema
export const ScriptsCheckNameAvailabilityInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  clusterName: Schema.String.pipe(T.PathParam()),
  databaseName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const ScriptsCheckNameAvailabilityOutput = /*@__PURE__*/ Schema.Struct({
  nameAvailable: Schema.optional(Schema.Boolean),
  name: Schema.optional(Schema.String),
  message: Schema.optional(Schema.String),
  reason: Schema.optional(Schema.Literals(["Invalid", "AlreadyExists"])),
 ...
 * @param databaseName - The name of the database in the Kusto cluster.
 */
export const ScriptsCheckNameAvailability = /*@__PURE__*/ API.make(() => ({
  inputSchema: ScriptsCheckNameAvailabilityInput,
  outputSchema: ScriptsCheckNameAvailabilityOutput,
}));
// Input Schema
export const ScriptsCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  clusterName: Schema.String.pipe(T.PathParam()),
  databaseName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const ScriptsCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
...
// Input Schema
export const ScriptsListByDatabaseInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  clusterName: Schema.String.pipe(T.PathParam()),
  databaseName: Schema.String.pipe(T.PathParam()),
...
// Output Schema
export const ScriptsListByDatabaseOutput = /*@__PURE__*/ Schema.Struct({
  value: Schema.optional(
    Schema.Array(
      Schema.Struct({
        id: Schema.optional(Schema.String),
