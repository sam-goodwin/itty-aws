...
// Input Schema
export const PrivateZonesCreateOrUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const PrivateZonesCreateOrUpdateOutput = /*@__PURE__*/ Schema.Struct({
...
// Input Schema
export const PrivateZonesDeleteInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  privateZoneName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Input Schema
export const PrivateZonesListByResourceGroupInput = /*@__PURE__*/ Schema.Struct(
  {
    subscriptionId: Schema.String.pipe(T.PathParam()),
    resourceGroupName: Schema.String.pipe(T.PathParam()),
    "api-version": Schema.String,
 ...
 */
export const PrivateZonesListByResourceGroup = /*@__PURE__*/ API.make(() => ({
  inputSchema: PrivateZonesListByResourceGroupInput,
  outputSchema: PrivateZonesListByResourceGroupOutput,
}));
// Input Schema
export const PrivateZonesUpdateInput = /*@__PURE__*/ Schema.Struct({
  subscriptionId: Schema.String.pipe(T.PathParam()),
  resourceGroupName: Schema.String.pipe(T.PathParam()),
  privateZoneName: Schema.String.pipe(T.PathParam()),
  "api-version": Schema.String,
...
// Output Schema
export const PrivateZonesUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  systemData: Schema.optional(
