...
export type ActivityParameterSetParametersList = ActivityParameter[];
...
export type ActivityPropertiesParameterSetsList = ActivityParameterSet[];
...
export type ActivityPropertiesOutputTypesList = ActivityOutputType[];
...
export type ActivityListResultValueList = Activity[];
...
export type AutomationAccountListResultValueList = AutomationAccount[];
...
export type DeletedRunbookListResultValueList = DeletedRunbook[];
...
export type ConnectionTypeListResultValueList = ConnectionType[];
...
export const GraphicalRunbookContent = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    rawContent: S.optional(RawGraphicalRunbookContent),
...
export type CredentialListResultValueList = Credential[];
...
export type DscConfigurationListResultValueList = DscConfiguration[];
...
export type DscNodeConfigurationListResultValueList = DscNodeConfiguration[];
...
export type DscNodeListResultValueList = DscNode[];
...
export type TypeFieldListResultValueList = TypeField[];
...
export type HybridRunbookWorkersListResultValueList = HybridRunbookWorker[];
...
export type JobListResultV2ValueList = JobCollectionItem[];
...
export type JobScheduleListResultValueList = JobSchedule[];
...
export type JobStreamListResultValueList = JobStream[];
...
export type KeyListResultKeysList = Key[];
...
export type ModuleListResultValueList = Module[];
...
export type NodeCountsValueList = NodeCount[];
...
export type DscNodeReportErrorsList = DscReportError[];
...
export type DscReportResourceDependsOnList = DscReportResourceNavigation[];
...
export type DscNodeReportResourcesList = DscReportResource[];
...
export type DscNodeReportIPV4AddressesList = string[];
...
export type DscNodeReportIPV6AddressesList = string[];
...
export type DscNodeReportListResultValueList = DscNodeReport[];
...
export type PackageListResultValueList = Package[];
...
export type RunbookPropertiesOutputTypesList = string[];
...
/** Gets or sets the runbook output types. */
export type RunbookDraftOutputTypesList = string[];
...
export type RunbookListResultValueList = Runbook[];
...
export type RuntimeEnvironmentListResultValueList = RuntimeEnvironment[];
...
export type WindowsPropertiesExcludedKbNumbersList = string[];
...
export type WindowsPropertiesIncludedKbNumbersList = string[];
...
export type LinuxPropertiesExcludedPackageNameMasksList = string[];
...
export type LinuxPropertiesIncludedPackageNameMasksList = string[];
...
export type UpdateConfigurationAzureVirtualMachinesList = string[];
...
export type UpdateConfigurationNonAzureComputerNamesList = string[];
...
export type TargetPropertiesAzureQueriesList = AzureQueryProperties[];
...
export type TargetPropertiesNonAzureQueriesList = NonAzureQueryProperties[];
...
export type SourceControlListResultValueList = SourceControl[];
...
export type SourceControlSyncJobListResultValueList = SourceControlSyncJob[];
...
export type StatisticsListResultValueList = Statistics[];
...
export type VariableListResultValueList = Variable[];
...
export type WatcherListResultValueList = Watcher[];
