...
// Input Schema
export interface WarehouseViewLinksCreateInput {
  project_id: string;
  id: string;
...
export const WarehouseViewLinksCreateInput =
  ...
  ) as unknown as Schema.Codec<WarehouseViewLinksCreateInput>;

// Output Schema
export interface WarehouseViewLinksCreateOutput {
  id: string;
  deleted?: boolean | null;
  created_by: {
    id?: number;
...
export const WarehouseViewLinksCreateOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    field_name: Schema.String,
    configuration: Schema.optional(Schema.Unknown),
  }) as unknown as Schema.Codec<WarehouseViewLinksCreateOutput>;
 ...
 */
export const warehouseViewLinksCreate = /*@__PURE__*/ API.make(() => ({
