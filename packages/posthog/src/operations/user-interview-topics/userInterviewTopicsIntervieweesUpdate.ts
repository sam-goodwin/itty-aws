...
// Input Schema
export interface UserInterviewTopicsIntervieweesUpdateInput {
  id: string;
  project_id: string;
  topic_id: string;
  created_by: {
...
export const UserInterviewTopicsIntervieweesUpdateInput =
  ...
  ) as unknown as Schema.Codec<UserInterviewTopicsIntervieweesUpdateInput>;

// Output Schema
export interface UserInterviewTopicsIntervieweesUpdateOutput {
  id: string;
  created_by: {
    id?: number;
    uuid?: string;
...
export const UserInterviewTopicsIntervieweesUpdateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    interviewee_identifier: Schema.String,
    agent_context: Schema.String,
  }) as unknown as Schema.Codec<UserInterviewTopicsIntervieweesUpdateOutput>;
