 ...
 */
export const userInterviewTopicsRetrieve = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: UserInterviewTopicsRetrieveInput,
    outputSchema: UserInterviewTopicsRetrieveOutput,
  }),
);
