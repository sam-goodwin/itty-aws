...
// Input Schema
export interface DatasetItemsUpdateInput {
  id: string;
  project_id: string;
  dataset?: string;
  input?: unknown;
...
export const DatasetItemsUpdateInput =
  ...
  ) as unknown as Schema.Codec<DatasetItemsUpdateInput>;

// Output Schema
export interface DatasetItemsUpdateOutput {
  id?: string;
  dataset?: string;
  input?: unknown;
  output?: unknown;
...
export const DatasetItemsUpdateOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    team: Schema.optional(Schema.Number),
  }) as unknown as Schema.Codec<DatasetItemsUpdateOutput>;
