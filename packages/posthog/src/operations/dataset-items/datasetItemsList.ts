...
// Input Schema
export interface DatasetItemsListInput {
  project_id: string;
  dataset?: string;
  limit?: number;
  offset?: number;
}
export const DatasetItemsListInput = /*@__PURE__*/ Schema.Struct({
...
) as unknown as Schema.Codec<DatasetItemsListInput>;

// Output Schema
export interface DatasetItemsListOutput {
  count?: number;
  next?: string | null;
...
export const DatasetItemsListOutput = /*@__PURE__*/ Schema.Struct({
...
}) as unknown as Schema.Codec<DatasetItemsListOutput>;
 ...
 */
export const datasetItemsList = /*@__PURE__*/ API.make(() => ({
