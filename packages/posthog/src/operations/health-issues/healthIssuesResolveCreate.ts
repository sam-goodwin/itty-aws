...
// Input Schema
export const HealthIssuesResolveCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const HealthIssuesResolveCreateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const healthIssuesResolveCreate = /*@__PURE__*/ API.make(() => ({
