...
// Input Schema
export interface CommentsCompleteCreateInput {
  id: string;
  project_id: string;
}
export const CommentsCompleteCreateInput =
  /*@__PURE__*/ Schema.Struct({
    ...
    T.Http({
      method: "POST",
      path: "/api/projects/{project_id}/comments/{id}/complete/",
    }),
  ) as unknown as Schema.Codec<CommentsCompleteCreateInput>;

// Output Schema
export interface CommentsCompleteCreateOutput {
  id?: string;
  created_by?: {
    id?: number;
    uuid?: string;
...
export const CommentsCompleteCreateOutput =
  ...
  }) as unknown as Schema.Codec<CommentsCompleteCreateOutput>;
