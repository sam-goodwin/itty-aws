...
export type CommentsCompleteCreateInput =
  typeof CommentsCompleteCreateInput.Type;
...
export type CommentsCompleteCreateOutput =
  typeof CommentsCompleteCreateOutput.Type;
