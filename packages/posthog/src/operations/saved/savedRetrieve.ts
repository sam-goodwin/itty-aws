...
export const SavedRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
export const SavedRetrieveOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const savedRetrieve = /*@__PURE__*/ API.make(() => ({
