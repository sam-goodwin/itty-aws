...
// Input Schema
export const SurveysGlobalStatsRetrieveInput = /*@__PURE__*/ Schema.Struct({
  project_id: Schema.String.pipe(T.PathParam()),
  date_from: Schema.optional(Schema.String),
  date_to: Schema.optional(Schema.String),
}).pipe(
  T.Http({ method: "GET", path: "/api/projects/{project_id}/surveys/stats/" }),
);
export type SurveysGlobalStatsRetrieveInput =
  typeof SurveysGlobalStatsRetrieveInput.Type;

// Output Schema
export const SurveysGlobalStatsRetrieveOutput = /*@__PURE__*/ Schema.Struct({
