...
// Input Schema
export const SurveysResponsesCountRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const SurveysResponsesCountRetrieveOutput = /*@__PURE__*/ Schema.Void;
 ...
 */
export const surveysResponsesCountRetrieve = /*@__PURE__*/ API.make(() => ({
