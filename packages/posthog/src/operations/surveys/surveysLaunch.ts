...
export const SurveysLaunchInput = /*@__PURE__*/ Schema.Struct({
...
export const SurveysLaunchOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const surveysLaunch = /*@__PURE__*/ API.make(() => ({
