...
// Input Schema
export interface SurveysLaunchInput {
  id: string;
  project_id: string;
}
export const SurveysLaunchInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String.pipe(T.PathParam()),
  project_id: Schema.String.pipe(T.PathParam()),
}).pipe(
  T.Http({
    method: "POST",
    path: "/api/projects/{project_id}/surveys/{id}/launch/",
  }),
) as unknown as Schema.Codec<SurveysLaunchInput>;

// Output Schema
export interface SurveysLaunchOutput {
  id?: string;
  name?: string;
  description?: string;
...
export const SurveysLaunchOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
}) as unknown as Schema.Codec<SurveysLaunchOutput>;
 ...
 */
export const surveysLaunch = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: SurveysLaunchInput,
  outputSchema: SurveysLaunchOutput,
}));
