...
// Input Schema
export const SurveysPartialUpdateInput = /*@__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "/api/projects/{project_id}/surveys/{id}/" }),
);
export type SurveysPartialUpdateInput = typeof SurveysPartialUpdateInput.Type;

// Output Schema
export const SurveysPartialUpdateOutput = /*@__PURE__*/ Schema.Struct({
