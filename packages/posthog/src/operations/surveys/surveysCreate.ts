...
// Input Schema
export interface SurveysCreateInput {
  project_id: string;
  id?: string;
  name?: string;
  description?: string;
            ...
            branching: Schema.optional(
              Schema.NullOr(
                Schema.Union([
                  ...
                  Schema.Struct({
                    type: Schema.optional(Schema.Literals(["response_based"])),
                    responseValues: Schema.optional(
                      Schema.Record(
                        Schema.String,
                        Schema.Union([Schema.Number, Schema.Literals(["end"])]),
                      ),
                    ),
                  }),
                ]),
...
) as unknown as Schema.Codec<SurveysCreateInput>;

// Output Schema
export interface SurveysCreateOutput {
  id?: string;
  name?: string;
  description?: string;
  type?: "popover" | "widget" | "external_survey" | "api";
...
export const SurveysCreateOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  _create_in_folder: Schema.optional(Schema.String),
  form_content: Schema.optional(Schema.Unknown),
}) as unknown as Schema.Codec<SurveysCreateOutput>;
