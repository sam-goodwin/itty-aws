...
// Input Schema
export const AppMetricsRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const AppMetricsRetrieveOutput = /*@__PURE__*/ Schema.Record(
  Schema.String,
  Schema.Unknown,
);
 ...
 */
export const appMetricsRetrieve = /*@__PURE__*/ API.make(() => ({
