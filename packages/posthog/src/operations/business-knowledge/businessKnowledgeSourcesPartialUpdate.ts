...
// Input Schema
export interface BusinessKnowledgeSourcesPartialUpdateInput {
  id: string;
  project_id: string;
  name?: string;
  text?: string;
...
export const BusinessKnowledgeSourcesPartialUpdateInput =
  ...
  ) as unknown as Schema.Codec<BusinessKnowledgeSourcesPartialUpdateInput>;

// Output Schema
export interface BusinessKnowledgeSourcesPartialUpdateOutput {
  id: string;
  team_id: number;
  name: string;
...
export const BusinessKnowledgeSourcesPartialUpdateOutput =
  ...
  }) as unknown as Schema.Codec<BusinessKnowledgeSourcesPartialUpdateOutput>;
