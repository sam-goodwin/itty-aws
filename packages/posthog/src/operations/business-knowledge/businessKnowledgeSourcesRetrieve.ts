...
export type BusinessKnowledgeSourcesRetrieveInput =
  typeof BusinessKnowledgeSourcesRetrieveInput.Type;
...
export type BusinessKnowledgeSourcesRetrieveOutput =
  typeof BusinessKnowledgeSourcesRetrieveOutput.Type;
