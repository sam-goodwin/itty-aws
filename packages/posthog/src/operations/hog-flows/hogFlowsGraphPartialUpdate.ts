...
// Input Schema
export interface HogFlowsGraphPartialUpdateInput {
  id: string;
  project_id: string;
  operations?: {
    op:
...
export const HogFlowsGraphPartialUpdateInput =
  ...
  ) as unknown as Schema.Codec<HogFlowsGraphPartialUpdateInput>;

// Output Schema
export interface HogFlowsGraphPartialUpdateOutput {
  id?: string;
  name?: string | null;
  description?: string;
  version?: number;
...
export const HogFlowsGraphPartialUpdateOutput =
  ...
  }) as unknown as Schema.Codec<HogFlowsGraphPartialUpdateOutput>;
