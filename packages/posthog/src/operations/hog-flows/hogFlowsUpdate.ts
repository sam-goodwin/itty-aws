...
// Input Schema
export interface HogFlowsUpdateInput {
  id: string;
  project_id: string;
  name?: string | null;
  description?: string;
...
export const HogFlowsUpdateInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "PUT", path: "/api/projects/{project_id}/hog_flows/{id}/" }),
) as unknown as Schema.Codec<HogFlowsUpdateInput>;

// Output Schema
export interface HogFlowsUpdateOutput {
  id?: string;
  name?: string | null;
  description?: string;
  version?: number;
...
export const HogFlowsUpdateOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.NullOr(Schema.String)),
  description: Schema.optional(Schema.String),
  version: Schema.optional(Schema.Number),
...
}) as unknown as Schema.Codec<HogFlowsUpdateOutput>;
 ...
 */
export const hogFlowsUpdate = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: HogFlowsUpdateInput,
  outputSchema: HogFlowsUpdateOutput,
