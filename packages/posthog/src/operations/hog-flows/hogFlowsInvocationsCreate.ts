...
// Input Schema
export interface HogFlowsInvocationsCreateInput {
  id: string;
  project_id: string;
  configuration?: {
    id?: string;
...
export const HogFlowsInvocationsCreateInput =
  ...
  ) as unknown as Schema.Codec<HogFlowsInvocationsCreateInput>;

// Output Schema
export type HogFlowsInvocationsCreateOutput = void;
export const HogFlowsInvocationsCreateOutput =
  /*@__PURE__*/ Schema.Void as unknown as Schema.Codec<HogFlowsInvocationsCreateOutput>;
 ...
 */
export const hogFlowsInvocationsCreate = /*@__PURE__*/ API.make(() => ({
