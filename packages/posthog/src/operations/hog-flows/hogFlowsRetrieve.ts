...
// Input Schema
export interface HogFlowsRetrieveInput {
  id: string;
  project_id: string;
}
export const HogFlowsRetrieveInput = /*@__PURE__*/ Schema.Struct({
  id: Schema.String.pipe(T.PathParam()),
  project_id: Schema.String.pipe(T.PathParam()),
}).pipe(
  T.Http({ method: "GET", path: "/api/projects/{project_id}/hog_flows/{id}/" }),
) as unknown as Schema.Codec<HogFlowsRetrieveInput>;

// Output Schema
export interface HogFlowsRetrieveOutput {
  id?: string;
  name?: string | null;
  description?: string;
  version?: number;
...
export const HogFlowsRetrieveOutput = /*@__PURE__*/ Schema.Struct({
...
}) as unknown as Schema.Codec<HogFlowsRetrieveOutput>;
 ...
 */
export const hogFlowsRetrieve = /*@__PURE__*/ API.make(() => ({
