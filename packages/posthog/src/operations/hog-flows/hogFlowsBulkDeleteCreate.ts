...
export type HogFlowsBulkDeleteCreateInput =
  typeof HogFlowsBulkDeleteCreateInput.Type;
...
export type HogFlowsBulkDeleteCreateOutput =
  typeof HogFlowsBulkDeleteCreateOutput.Type;
