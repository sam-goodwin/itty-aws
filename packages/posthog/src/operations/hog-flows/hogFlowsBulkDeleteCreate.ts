...
// Input Schema
export interface HogFlowsBulkDeleteCreateInput {
  project_id: string;
  id?: string;
  name?: string | null;
  description?: string;
...
export const HogFlowsBulkDeleteCreateInput =
  ...
  ) as unknown as Schema.Codec<HogFlowsBulkDeleteCreateInput>;

// Output Schema
export interface HogFlowsBulkDeleteCreateOutput {
  id?: string;
  name?: string | null;
  description?: string;
  version?: number;
...
export const HogFlowsBulkDeleteCreateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.optional(Schema.String),
    name: Schema.optional(Schema.NullOr(Schema.String)),
    description: Schema.optional(Schema.String),
  ...
  }) as unknown as Schema.Codec<HogFlowsBulkDeleteCreateOutput>;
 ...
 */
export const hogFlowsBulkDeleteCreate = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: HogFlowsBulkDeleteCreateInput,
    outputSchema: HogFlowsBulkDeleteCreateOutput,
