...
// Input Schema
export const EventFilterCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const EventFilterCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  mode: Schema.optional(Schema.Literals(["disabled", "dry_run", "live"])),
  filter_tree: Schema.optional(Schema.NullOr(Schema.Unknown)),
  test_cases: Schema.optional(Schema.Unknown),
 ...
 */
export const eventFilterCreate = /*@__PURE__*/ API.make(() => ({
