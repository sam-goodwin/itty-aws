...
// Input Schema
export interface WarehouseSavedQueryFoldersPartialUpdateInput {
  id: string;
  project_id: string;
  name?: string;
  created_at?: string;
...
export const WarehouseSavedQueryFoldersPartialUpdateInput =
  ...
  ) as unknown as Schema.Codec<WarehouseSavedQueryFoldersPartialUpdateInput>;

// Output Schema
export interface WarehouseSavedQueryFoldersPartialUpdateOutput {
  id?: string;
  name?: string;
  created_at?: string;
  created_by?: {
...
export const WarehouseSavedQueryFoldersPartialUpdateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    view_count: Schema.optional(Schema.Number),
    user_access_level: Schema.optional(Schema.NullOr(Schema.String)),
  }) as unknown as Schema.Codec<WarehouseSavedQueryFoldersPartialUpdateOutput>;
