...
// Input Schema
export const RoleExternalReferencesCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const RoleExternalReferencesCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  provider: Schema.optional(Schema.String),
  provider_organization_id: Schema.optional(Schema.String),
  provider_role_id: Schema.optional(Schema.String),
...
// The operation
export const roleExternalReferencesCreate = /*@__PURE__*/ API.make(() => ({
