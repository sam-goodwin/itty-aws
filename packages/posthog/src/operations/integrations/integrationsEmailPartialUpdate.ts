...
// Input Schema
export const IntegrationsEmailPartialUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const IntegrationsEmailPartialUpdateOutput = /*@__PURE__*/ Schema.Struct(
  {
    id: Schema.optional(Schema.Number),
    kind: Schema.optional(
      Schema.Literals([
 ...
 */
export const integrationsEmailPartialUpdate = /*@__PURE__*/ API.make(() => ({
