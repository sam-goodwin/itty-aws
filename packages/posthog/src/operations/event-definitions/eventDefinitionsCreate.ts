...
// Input Schema
export interface EventDefinitionsCreateInput {
  project_id: string;
  id?: string;
  name?: string;
  owner?: number | null;
...
export const EventDefinitionsCreateInput =
  ...
  ) as unknown as Schema.Codec<EventDefinitionsCreateInput>;

// Output Schema
export interface EventDefinitionsCreateOutput {
  id?: string;
  name?: string;
  owner?: number | null;
  description?: string | null;
...
export const EventDefinitionsCreateOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    default_columns: Schema.optional(Schema.Array(Schema.String)),
    media_preview_urls: Schema.optional(Schema.Array(Schema.String)),
  }) as unknown as Schema.Codec<EventDefinitionsCreateOutput>;
