...
// Input Schema
export interface EventDefinitionsUpdateInput {
  id: string;
  project_id: string;
  name?: string;
  owner?: number | null;
...
export const EventDefinitionsUpdateInput =
  ...
  ) as unknown as Schema.Codec<EventDefinitionsUpdateInput>;

// Output Schema
export interface EventDefinitionsUpdateOutput {
  id?: string;
  name?: string;
  owner?: number | null;
  description?: string | null;
...
export const EventDefinitionsUpdateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    default_columns: Schema.optional(Schema.Array(Schema.String)),
    media_preview_urls: Schema.optional(Schema.Array(Schema.String)),
  }) as unknown as Schema.Codec<EventDefinitionsUpdateOutput>;
