...
// Input Schema
export interface ActionsPartialUpdateInput {
  id: number;
  project_id: string;
  format?: "csv" | "json";
  name?: string | null;
...
export const ActionsPartialUpdateInput =
  ...
  ) as unknown as Schema.Codec<ActionsPartialUpdateInput>;

// Output Schema
export interface ActionsPartialUpdateOutput {
  id?: number;
  name?: string | null;
  description?: string;
  tags?: unknown[];
...
export const ActionsPartialUpdateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.optional(Schema.Number),
    name: Schema.optional(Schema.NullOr(Schema.String)),
    description: Schema.optional(Schema.String),
    ...
    _create_in_folder: Schema.optional(Schema.String),
    user_access_level: Schema.optional(Schema.NullOr(Schema.String)),
  }) as unknown as Schema.Codec<ActionsPartialUpdateOutput>;
 ...
 */
export const actionsPartialUpdate = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
