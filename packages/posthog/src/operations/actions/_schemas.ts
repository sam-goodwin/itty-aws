...
export const ActionSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export const ActionStepJSONSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  event: Schema.optional(Schema.NullOr(Schema.String)),
  properties: Schema.optional(
    Schema.NullOr(
      Schema.Array(Schema.suspend(() => ActionStepPropertyFilterSchema)),
    ),
  ),
...
export const ActionStepPropertyFilterSchema =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Unknown;
export const ActionReferenceSchema = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
