...
// Input Schema
export interface ActionsUpdateInput {
  id: number;
  project_id: string;
  format?: "csv" | "json";
  name?: string | null;
...
export const ActionsUpdateInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "PUT", path: "/api/projects/{project_id}/actions/{id}/" }),
) as unknown as Schema.Codec<ActionsUpdateInput>;

// Output Schema
export interface ActionsUpdateOutput {
  id?: number;
  name?: string | null;
  description?: string;
  tags?: unknown[];
...
export const ActionsUpdateOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  _create_in_folder: Schema.optional(Schema.String),
  user_access_level: Schema.optional(Schema.NullOr(Schema.String)),
}) as unknown as Schema.Codec<ActionsUpdateOutput>;
