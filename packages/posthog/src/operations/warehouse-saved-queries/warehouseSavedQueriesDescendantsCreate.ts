...
// Input Schema
export interface WarehouseSavedQueriesDescendantsCreateInput {
  id: string;
  project_id: string;
...
export const WarehouseSavedQueriesDescendantsCreateInput =
  ...
  ) as unknown as Schema.Codec<WarehouseSavedQueriesDescendantsCreateInput>;

// Output Schema
export interface WarehouseSavedQueriesDescendantsCreateOutput {
  id?: string;
  deleted?: boolean | null;
  name?: string;
  query?: { kind?: "HogQLQuery"; query: string };
...
export const WarehouseSavedQueriesDescendantsCreateOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    expires_at: Schema.optional(Schema.NullOr(Schema.String)),
    user_access_level: Schema.optional(Schema.NullOr(Schema.String)),
  }) as unknown as Schema.Codec<WarehouseSavedQueriesDescendantsCreateOutput>;
