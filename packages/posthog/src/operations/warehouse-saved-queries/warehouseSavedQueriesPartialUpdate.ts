...
// Input Schema
export interface WarehouseSavedQueriesPartialUpdateInput {
  id: string;
  project_id: string;
...
export const WarehouseSavedQueriesPartialUpdateInput =
  ...
  ) as unknown as Schema.Codec<WarehouseSavedQueriesPartialUpdateInput>;

// Output Schema
export interface WarehouseSavedQueriesPartialUpdateOutput {
  id?: string;
  deleted?: boolean | null;
  name?: string;
  query?: { kind?: "HogQLQuery"; query: string };
...
export const WarehouseSavedQueriesPartialUpdateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    expires_at: Schema.optional(Schema.NullOr(Schema.String)),
    user_access_level: Schema.optional(Schema.NullOr(Schema.String)),
  }) as unknown as Schema.Codec<WarehouseSavedQueriesPartialUpdateOutput>;
