...
// Input Schema
export interface WarehouseSavedQueriesRetrieveInput {
  id: string;
  project_id: string;
}
export const WarehouseSavedQueriesRetrieveInput =
  ...
  ) as unknown as Schema.Codec<WarehouseSavedQueriesRetrieveInput>;

// Output Schema
export interface WarehouseSavedQueriesRetrieveOutput {
  id?: string;
...
export const WarehouseSavedQueriesRetrieveOutput =
  ...
  }) as unknown as Schema.Codec<WarehouseSavedQueriesRetrieveOutput>;
