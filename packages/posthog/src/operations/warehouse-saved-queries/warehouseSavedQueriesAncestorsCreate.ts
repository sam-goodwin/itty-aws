...
// Input Schema
export interface WarehouseSavedQueriesAncestorsCreateInput {
  id: string;
  project_id: string;
...
export const WarehouseSavedQueriesAncestorsCreateInput =
  ...
  ) as unknown as Schema.Codec<WarehouseSavedQueriesAncestorsCreateInput>;

// Output Schema
export interface WarehouseSavedQueriesAncestorsCreateOutput {
  id?: string;
  deleted?: boolean | null;
  name?: string;
  query?: { kind?: "HogQLQuery"; query: string };
...
export const WarehouseSavedQueriesAncestorsCreateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    expires_at: Schema.optional(Schema.NullOr(Schema.String)),
    user_access_level: Schema.optional(Schema.NullOr(Schema.String)),
  }) as unknown as Schema.Codec<WarehouseSavedQueriesAncestorsCreateOutput>;
