...
// Input Schema
export interface WarehouseSavedQueriesActivityRetrieveInput {
  id: string;
  project_id: string;
}
export const WarehouseSavedQueriesActivityRetrieveInput =
  ...
  ) as unknown as Schema.Codec<WarehouseSavedQueriesActivityRetrieveInput>;

// Output Schema
export interface WarehouseSavedQueriesActivityRetrieveOutput {
  id?: string;
...
export const WarehouseSavedQueriesActivityRetrieveOutput =
  ...
  }) as unknown as Schema.Codec<WarehouseSavedQueriesActivityRetrieveOutput>;
