...
// Input Schema
export interface WarehouseSavedQueriesUpdateInput {
  id: string;
  project_id: string;
...
export const WarehouseSavedQueriesUpdateInput =
  ...
  ) as unknown as Schema.Codec<WarehouseSavedQueriesUpdateInput>;

// Output Schema
export interface WarehouseSavedQueriesUpdateOutput {
  id?: string;
  deleted?: boolean | null;
  name?: string;
  query?: { kind?: "HogQLQuery"; query: string };
...
export const WarehouseSavedQueriesUpdateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    expires_at: Schema.optional(Schema.NullOr(Schema.String)),
    user_access_level: Schema.optional(Schema.NullOr(Schema.String)),
  }) as unknown as Schema.Codec<WarehouseSavedQueriesUpdateOutput>;
 ...
 */
export const warehouseSavedQueriesUpdate = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: WarehouseSavedQueriesUpdateInput,
    outputSchema: WarehouseSavedQueriesUpdateOutput,
