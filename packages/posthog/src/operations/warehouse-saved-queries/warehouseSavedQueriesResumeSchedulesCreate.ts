...
// Input Schema
export interface WarehouseSavedQueriesResumeSchedulesCreateInput {
  project_id: string;
  id?: string;
...
export const WarehouseSavedQueriesResumeSchedulesCreateInput =
  ...
  ) as unknown as Schema.Codec<WarehouseSavedQueriesResumeSchedulesCreateInput>;

// Output Schema
export interface WarehouseSavedQueriesResumeSchedulesCreateOutput {
  id?: string;
  deleted?: boolean | null;
  name?: string;
  query?: { kind?: "HogQLQuery"; query: string };
...
export const WarehouseSavedQueriesResumeSchedulesCreateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    expires_at: Schema.optional(Schema.NullOr(Schema.String)),
    user_access_level: Schema.optional(Schema.NullOr(Schema.String)),
  }) as unknown as Schema.Codec<WarehouseSavedQueriesResumeSchedulesCreateOutput>;
