...
// Input Schema
export interface WarehouseSavedQueriesDependenciesRetrieveInput {
  id: string;
  project_id: string;
}
export const WarehouseSavedQueriesDependenciesRetrieveInput =
  ...
  ) as unknown as Schema.Codec<WarehouseSavedQueriesDependenciesRetrieveInput>;

// Output Schema
export interface WarehouseSavedQueriesDependenciesRetrieveOutput {
  id?: string;
...
export const WarehouseSavedQueriesDependenciesRetrieveOutput =
  ...
  }) as unknown as Schema.Codec<WarehouseSavedQueriesDependenciesRetrieveOutput>;
