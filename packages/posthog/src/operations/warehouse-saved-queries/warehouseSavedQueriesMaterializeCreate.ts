...
// Input Schema
export interface WarehouseSavedQueriesMaterializeCreateInput {
  id: string;
  project_id: string;
...
export const WarehouseSavedQueriesMaterializeCreateInput =
  ...
  ) as unknown as Schema.Codec<WarehouseSavedQueriesMaterializeCreateInput>;

// Output Schema
export interface WarehouseSavedQueriesMaterializeCreateOutput {
  id?: string;
  deleted?: boolean | null;
  name?: string;
  query?: { kind?: "HogQLQuery"; query: string };
...
export const WarehouseSavedQueriesMaterializeCreateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    expires_at: Schema.optional(Schema.NullOr(Schema.String)),
    user_access_level: Schema.optional(Schema.NullOr(Schema.String)),
  }) as unknown as Schema.Codec<WarehouseSavedQueriesMaterializeCreateOutput>;
