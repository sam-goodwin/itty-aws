...
// Input Schema
export const WebExperimentsDestroyInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const WebExperimentsDestroyOutput = /*@__PURE__*/ Schema.Void;
 ...
 */
export const webExperimentsDestroy = /*@__PURE__*/ API.make(() => ({
