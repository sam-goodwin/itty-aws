...
// Input Schema
export const WebExperimentsUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const WebExperimentsUpdateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const webExperimentsUpdate = /*@__PURE__*/ API.make(() => ({
