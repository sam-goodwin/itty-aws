...
// Input Schema
export interface FieldNotesCreateInput {
  project_id: string;
  id: string;
  comment: string;
...
export const FieldNotesCreateInput = /*@__PURE__*/ Schema.Struct({
...
) as unknown as Schema.Codec<FieldNotesCreateInput>;

// Output Schema
export interface FieldNotesCreateOutput {
  id: string;
  comment: string;
  field_note_status?: "pending" | "acknowledged" | "resolved" | "dismissed";
  resolution?: string | null;
...
export const FieldNotesCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.String,
  comment: Schema.String,
  field_note_status: Schema.optional(
    Schema.Literals(["pending", "acknowledged", "resolved", "dismissed"]),
...
}) as unknown as Schema.Codec<FieldNotesCreateOutput>;
 ...
 */
export const fieldNotesCreate = /*@__PURE__*/ API.make(() => ({
