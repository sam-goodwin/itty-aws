...
// Input Schema
export interface FieldNotesUpdateInput {
  id: string;
  project_id: string;
  comment: string;
...
export const FieldNotesUpdateInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
) as unknown as Schema.Codec<FieldNotesUpdateInput>;

// Output Schema
export interface FieldNotesUpdateOutput {
  id: string;
  comment: string;
  field_note_status?: "pending" | "acknowledged" | "resolved" | "dismissed";
  resolution?: string | null;
...
export const FieldNotesUpdateOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct(
  {
    id: Schema.String,
    comment: Schema.String,
    field_note_status: Schema.optional(
...
) as unknown as Schema.Codec<FieldNotesUpdateOutput>;
 ...
 */
export const fieldNotesUpdate = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: FieldNotesUpdateInput,
  outputSchema: FieldNotesUpdateOutput,
}));
