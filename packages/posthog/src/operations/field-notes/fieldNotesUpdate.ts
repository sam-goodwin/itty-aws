...
export const FieldNotesUpdateInput = /*@__PURE__*/ Schema.Struct({
...
export const FieldNotesUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.String,
  comment: Schema.String,
  field_note_status: Schema.optional(
    Schema.Literals(["pending", "acknowledged", "resolved", "dismissed"]),
 ...
 */
export const fieldNotesUpdate = /*@__PURE__*/ API.make(() => ({
