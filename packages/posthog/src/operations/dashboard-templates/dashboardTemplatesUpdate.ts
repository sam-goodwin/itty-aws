...
export type DashboardTemplatesUpdateInput =
  typeof DashboardTemplatesUpdateInput.Type;
...
export type DashboardTemplatesUpdateOutput =
  typeof DashboardTemplatesUpdateOutput.Type;
