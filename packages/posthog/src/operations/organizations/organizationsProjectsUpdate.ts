...
// Input Schema
export interface OrganizationsProjectsUpdateInput {
  id: number;
...
export const OrganizationsProjectsUpdateInput =
  ...
  ) as unknown as Schema.Codec<OrganizationsProjectsUpdateInput>;

// Output Schema
export interface OrganizationsProjectsUpdateOutput {
  id?: number;
  organization?: string;
  name?: string;
  product_description?: string | null;
...
export const OrganizationsProjectsUpdateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    event_retention_months: Schema.optional(Schema.Number),
    events_retention_enforced: Schema.optional(Schema.Boolean),
  }) as unknown as Schema.Codec<OrganizationsProjectsUpdateOutput>;
