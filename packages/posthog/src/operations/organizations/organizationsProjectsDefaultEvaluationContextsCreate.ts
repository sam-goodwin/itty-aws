...
// Input Schema
export interface OrganizationsProjectsDefaultEvaluationContextsCreateInput {
  id: number;
...
export const OrganizationsProjectsDefaultEvaluationContextsCreateInput =
  ...
  ) as unknown as Schema.Codec<OrganizationsProjectsDefaultEvaluationContextsCreateInput>;

// Output Schema
export interface OrganizationsProjectsDefaultEvaluationContextsCreateOutput {
  id?: number;
  organization?: string;
  name?: string;
  product_description?: string | null;
...
export const OrganizationsProjectsDefaultEvaluationContextsCreateOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    event_retention_months: Schema.optional(Schema.Number),
    events_retention_enforced: Schema.optional(Schema.Boolean),
  }) as unknown as Schema.Codec<OrganizationsProjectsDefaultEvaluationContextsCreateOutput>;
