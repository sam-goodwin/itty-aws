...
// Input Schema
export interface OrganizationsProjectsExperimentsConfigRetrieveInput {
  id: number;
...
export const OrganizationsProjectsExperimentsConfigRetrieveInput =
  ...
  ) as unknown as Schema.Codec<OrganizationsProjectsExperimentsConfigRetrieveInput>;

// Output Schema
export interface OrganizationsProjectsExperimentsConfigRetrieveOutput {
  id?: number;
  organization?: string;
  name?: string;
...
export const OrganizationsProjectsExperimentsConfigRetrieveOutput =
  ...
  }) as unknown as Schema.Codec<OrganizationsProjectsExperimentsConfigRetrieveOutput>;
