...
// Input Schema
export interface OrganizationsProjectsChangeOrganizationCreateInput {
  id: number;
...
export const OrganizationsProjectsChangeOrganizationCreateInput =
  ...
  ) as unknown as Schema.Codec<OrganizationsProjectsChangeOrganizationCreateInput>;

// Output Schema
export interface OrganizationsProjectsChangeOrganizationCreateOutput {
  id?: number;
  organization?: string;
  name?: string;
  product_description?: string | null;
...
export const OrganizationsProjectsChangeOrganizationCreateOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    event_retention_months: Schema.optional(Schema.Number),
    events_retention_enforced: Schema.optional(Schema.Boolean),
  }) as unknown as Schema.Codec<OrganizationsProjectsChangeOrganizationCreateOutput>;
 ...
 */
export const organizationsProjectsChangeOrganizationCreate =
  /*@__PURE__*/ API.make(() => ({
    inputSchema: OrganizationsProjectsChangeOrganizationCreateInput,
    outputSchema: OrganizationsProjectsChangeOrganizationCreateOutput,
