...
// Input Schema
export interface OrganizationsProjectsResetTokenPartialUpdateInput {
  id: number;
...
export const OrganizationsProjectsResetTokenPartialUpdateInput =
  ...
  ) as unknown as Schema.Codec<OrganizationsProjectsResetTokenPartialUpdateInput>;

// Output Schema
export interface OrganizationsProjectsResetTokenPartialUpdateOutput {
  id?: number;
  organization?: string;
  name?: string;
  product_description?: string | null;
...
export const OrganizationsProjectsResetTokenPartialUpdateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    event_retention_months: Schema.optional(Schema.Number),
    events_retention_enforced: Schema.optional(Schema.Boolean),
  }) as unknown as Schema.Codec<OrganizationsProjectsResetTokenPartialUpdateOutput>;
