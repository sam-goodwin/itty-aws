...
// Input Schema
export interface OrganizationsProjectsRotateSecretTokenPartialUpdateInput {
  id: number;
...
export const OrganizationsProjectsRotateSecretTokenPartialUpdateInput =
  ...
  ) as unknown as Schema.Codec<OrganizationsProjectsRotateSecretTokenPartialUpdateInput>;

// Output Schema
export interface OrganizationsProjectsRotateSecretTokenPartialUpdateOutput {
  id?: number;
  organization?: string;
  name?: string;
  product_description?: string | null;
...
export const OrganizationsProjectsRotateSecretTokenPartialUpdateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    event_retention_months: Schema.optional(Schema.Number),
    events_retention_enforced: Schema.optional(Schema.Boolean),
  }) as unknown as Schema.Codec<OrganizationsProjectsRotateSecretTokenPartialUpdateOutput>;
