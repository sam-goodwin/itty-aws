...
// Input Schema
export interface OrganizationsProjectsPartialUpdateInput {
  id: number;
...
export const OrganizationsProjectsPartialUpdateInput =
  ...
  ) as unknown as Schema.Codec<OrganizationsProjectsPartialUpdateInput>;

// Output Schema
export interface OrganizationsProjectsPartialUpdateOutput {
  id?: number;
  organization?: string;
  name?: string;
  product_description?: string | null;
...
export const OrganizationsProjectsPartialUpdateOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    event_retention_months: Schema.optional(Schema.Number),
    events_retention_enforced: Schema.optional(Schema.Boolean),
  }) as unknown as Schema.Codec<OrganizationsProjectsPartialUpdateOutput>;
