...
// Input Schema
export interface OrganizationsProjectsListInput {
...
export const OrganizationsProjectsListInput =
  ...
  ) as unknown as Schema.Codec<OrganizationsProjectsListInput>;

// Output Schema
export interface OrganizationsProjectsListOutput {
  count?: number;
  next?: string | null;
...
export const OrganizationsProjectsListOutput =
  ...
  }) as unknown as Schema.Codec<OrganizationsProjectsListOutput>;
