...
// Input Schema
export interface OrganizationsProjectsLogsConfigPartialUpdateInput {
  id: number;
...
export const OrganizationsProjectsLogsConfigPartialUpdateInput =
  ...
  ) as unknown as Schema.Codec<OrganizationsProjectsLogsConfigPartialUpdateInput>;

// Output Schema
export interface OrganizationsProjectsLogsConfigPartialUpdateOutput {
  id?: number;
  organization?: string;
  name?: string;
  product_description?: string | null;
...
export const OrganizationsProjectsLogsConfigPartialUpdateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    event_retention_months: Schema.optional(Schema.Number),
    events_retention_enforced: Schema.optional(Schema.Boolean),
  }) as unknown as Schema.Codec<OrganizationsProjectsLogsConfigPartialUpdateOutput>;
