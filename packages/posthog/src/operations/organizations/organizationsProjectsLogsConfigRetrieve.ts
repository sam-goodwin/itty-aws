...
// Input Schema
export interface OrganizationsProjectsLogsConfigRetrieveInput {
  id: number;
  organization_id: string;
}
export const OrganizationsProjectsLogsConfigRetrieveInput =
  /*@__PURE__*/ Schema.Struct({
    ...
    T.Http({
      method: "GET",
      path: "/api/organizations/{organization_id}/projects/{id}/logs_config/",
    }),
  ) as unknown as Schema.Codec<OrganizationsProjectsLogsConfigRetrieveInput>;

// Output Schema
export interface OrganizationsProjectsLogsConfigRetrieveOutput {
  id?: number;
  organization?: string;
  name?: string;
...
export const OrganizationsProjectsLogsConfigRetrieveOutput =
  /*@__PURE__*/ Schema.Struct({
  ...
  }) as unknown as Schema.Codec<OrganizationsProjectsLogsConfigRetrieveOutput>;
 ...
 */
export const organizationsProjectsLogsConfigRetrieve =
  /*@__PURE__*/ API.make(() => ({
    inputSchema: OrganizationsProjectsLogsConfigRetrieveInput,
    outputSchema: OrganizationsProjectsLogsConfigRetrieveOutput,
  }));
