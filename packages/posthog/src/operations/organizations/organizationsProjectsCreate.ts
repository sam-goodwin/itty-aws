...
// Input Schema
export interface OrganizationsProjectsCreateInput {
...
export const OrganizationsProjectsCreateInput =
  ...
  ) as unknown as Schema.Codec<OrganizationsProjectsCreateInput>;

// Output Schema
export interface OrganizationsProjectsCreateOutput {
  id?: number;
  organization?: string;
  name?: string;
  product_description?: string | null;
...
export const OrganizationsProjectsCreateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    event_retention_months: Schema.optional(Schema.Number),
    events_retention_enforced: Schema.optional(Schema.Boolean),
  }) as unknown as Schema.Codec<OrganizationsProjectsCreateOutput>;
