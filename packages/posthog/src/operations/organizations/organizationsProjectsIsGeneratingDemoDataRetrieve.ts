...
// Input Schema
export interface OrganizationsProjectsIsGeneratingDemoDataRetrieveInput {
  id: number;
...
export const OrganizationsProjectsIsGeneratingDemoDataRetrieveInput =
  ...
  ) as unknown as Schema.Codec<OrganizationsProjectsIsGeneratingDemoDataRetrieveInput>;

// Output Schema
export interface OrganizationsProjectsIsGeneratingDemoDataRetrieveOutput {
  id?: number;
  organization?: string;
  name?: string;
...
export const OrganizationsProjectsIsGeneratingDemoDataRetrieveOutput =
  ...
  }) as unknown as Schema.Codec<OrganizationsProjectsIsGeneratingDemoDataRetrieveOutput>;
