...
// Input Schema
export interface OrganizationsProjectsDefaultReleaseConditionsUpdateInput {
  id: number;
...
export const OrganizationsProjectsDefaultReleaseConditionsUpdateInput =
  /*@__PURE__*/ Schema.Struct({
    ...
    T.Http({
      method: "PUT",
      path: "/api/organizations/{organization_id}/projects/{id}/default_release_conditions/",
    }),
  ) as unknown as Schema.Codec<OrganizationsProjectsDefaultReleaseConditionsUpdateInput>;

// Output Schema
export interface OrganizationsProjectsDefaultReleaseConditionsUpdateOutput {
  id?: number;
  organization?: string;
  name?: string;
  product_description?: string | null;
...
export const OrganizationsProjectsDefaultReleaseConditionsUpdateOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    event_retention_months: Schema.optional(Schema.Number),
    events_retention_enforced: Schema.optional(Schema.Boolean),
  }) as unknown as Schema.Codec<OrganizationsProjectsDefaultReleaseConditionsUpdateOutput>;
 ...
 */
export const organizationsProjectsDefaultReleaseConditionsUpdate =
  /*@__PURE__*/ API.make(() => ({
    inputSchema: OrganizationsProjectsDefaultReleaseConditionsUpdateInput,
    outputSchema: OrganizationsProjectsDefaultReleaseConditionsUpdateOutput,
  }));
