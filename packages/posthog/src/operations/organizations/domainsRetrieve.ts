...
// Input Schema
export interface DomainsRetrieveInput {
  id: string;
...
) as unknown as Schema.Codec<DomainsRetrieveInput>;

// Output Schema
export interface DomainsRetrieveOutput {
  id?: string;
  domain?: string;
  is_verified?: boolean;
...
}) as unknown as Schema.Codec<DomainsRetrieveOutput>;
