...
// Input Schema
export interface OrganizationsProjectsExperimentsConfigPartialUpdateInput {
  id: number;
...
export const OrganizationsProjectsExperimentsConfigPartialUpdateInput =
  /*@__PURE__*/ Schema.Struct({
    ...
    T.Http({
      method: "PATCH",
      path: "/api/organizations/{organization_id}/projects/{id}/experiments_config/",
    }),
  ) as unknown as Schema.Codec<OrganizationsProjectsExperimentsConfigPartialUpdateInput>;

// Output Schema
export interface OrganizationsProjectsExperimentsConfigPartialUpdateOutput {
  id?: number;
  organization?: string;
  name?: string;
  product_description?: string | null;
...
export const OrganizationsProjectsExperimentsConfigPartialUpdateOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    event_retention_months: Schema.optional(Schema.Number),
    events_retention_enforced: Schema.optional(Schema.Boolean),
  }) as unknown as Schema.Codec<OrganizationsProjectsExperimentsConfigPartialUpdateOutput>;
 ...
 */
export const organizationsProjectsExperimentsConfigPartialUpdate =
  /*@__PURE__*/ API.make(() => ({
    inputSchema: OrganizationsProjectsExperimentsConfigPartialUpdateInput,
    outputSchema: OrganizationsProjectsExperimentsConfigPartialUpdateOutput,
  }));
