...
// Input Schema
export interface OrganizationsProjectsSettingsAsOfRetrieveInput {
  id: number;
  organization_id: string;
}
export const OrganizationsProjectsSettingsAsOfRetrieveInput =
  /*@__PURE__*/ Schema.Struct({
    ...
    T.Http({
      method: "GET",
      path: "/api/organizations/{organization_id}/projects/{id}/settings_as_of/",
    }),
  ) as unknown as Schema.Codec<OrganizationsProjectsSettingsAsOfRetrieveInput>;

// Output Schema
export interface OrganizationsProjectsSettingsAsOfRetrieveOutput {
  id?: number;
  organization?: string;
  name?: string;
...
export const OrganizationsProjectsSettingsAsOfRetrieveOutput =
  /*@__PURE__*/ Schema.Struct({
  ...
  }) as unknown as Schema.Codec<OrganizationsProjectsSettingsAsOfRetrieveOutput>;
 ...
 */
export const organizationsProjectsSettingsAsOfRetrieve =
  /*@__PURE__*/ API.make(() => ({
    inputSchema: OrganizationsProjectsSettingsAsOfRetrieveInput,
    outputSchema: OrganizationsProjectsSettingsAsOfRetrieveOutput,
  }));
