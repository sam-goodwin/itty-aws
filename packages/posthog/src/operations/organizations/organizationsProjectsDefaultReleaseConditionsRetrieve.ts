...
// Input Schema
export interface OrganizationsProjectsDefaultReleaseConditionsRetrieveInput {
  id: number;
...
export const OrganizationsProjectsDefaultReleaseConditionsRetrieveInput =
  ...
  ) as unknown as Schema.Codec<OrganizationsProjectsDefaultReleaseConditionsRetrieveInput>;

// Output Schema
export interface OrganizationsProjectsDefaultReleaseConditionsRetrieveOutput {
  id?: number;
  organization?: string;
  name?: string;
...
export const OrganizationsProjectsDefaultReleaseConditionsRetrieveOutput =
  ...
  }) as unknown as Schema.Codec<OrganizationsProjectsDefaultReleaseConditionsRetrieveOutput>;
