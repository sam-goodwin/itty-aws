...
// Input Schema
export interface OrganizationsProjectsRetrieveInput {
  id: number;
...
export const OrganizationsProjectsRetrieveInput =
  ...
  ) as unknown as Schema.Codec<OrganizationsProjectsRetrieveInput>;

// Output Schema
export interface OrganizationsProjectsRetrieveOutput {
  id?: number;
  organization?: string;
  name?: string;
...
export const OrganizationsProjectsRetrieveOutput =
  ...
  }) as unknown as Schema.Codec<OrganizationsProjectsRetrieveOutput>;
