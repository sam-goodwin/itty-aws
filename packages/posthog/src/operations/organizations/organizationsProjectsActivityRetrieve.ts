...
// Input Schema
export interface OrganizationsProjectsActivityRetrieveInput {
  id: number;
...
export const OrganizationsProjectsActivityRetrieveInput =
  ...
  ) as unknown as Schema.Codec<OrganizationsProjectsActivityRetrieveInput>;

// Output Schema
export interface OrganizationsProjectsActivityRetrieveOutput {
  id?: number;
  organization?: string;
  name?: string;
...
export const OrganizationsProjectsActivityRetrieveOutput =
  ...
  }) as unknown as Schema.Codec<OrganizationsProjectsActivityRetrieveOutput>;
