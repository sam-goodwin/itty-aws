...
// Input Schema
export const ApprovalPoliciesListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ApprovalPoliciesListOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const approvalPoliciesList = /*@__PURE__*/ API.make(() => ({
