...
// Input Schema
export const ApprovalPoliciesPartialUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ApprovalPoliciesPartialUpdateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const approvalPoliciesPartialUpdate = /*@__PURE__*/ API.make(() => ({
