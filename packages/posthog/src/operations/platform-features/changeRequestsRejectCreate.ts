...
// Input Schema
export const ChangeRequestsRejectCreateInput = /*@__PURE__*/ Schema.Struct({
...
export type ChangeRequestsRejectCreateInput =
  typeof ChangeRequestsRejectCreateInput.Type;

// Output Schema
export const ChangeRequestsRejectCreateOutput = /*@__PURE__*/ Schema.Struct({
...
export type ChangeRequestsRejectCreateOutput =
  typeof ChangeRequestsRejectCreateOutput.Type;
