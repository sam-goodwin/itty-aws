...
// Input Schema
export const RolesRoleMembershipsRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const RolesRoleMembershipsRetrieveOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const rolesRoleMembershipsRetrieve = /*@__PURE__*/ API.make(() => ({
