...
// Input Schema
export const ChangeRequestsApproveCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ChangeRequestsApproveCreateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const changeRequestsApproveCreate = /*@__PURE__*/ API.make(() => ({
