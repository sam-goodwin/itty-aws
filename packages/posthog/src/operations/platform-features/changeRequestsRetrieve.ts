...
// Input Schema
export const ChangeRequestsRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
export type ChangeRequestsRetrieveInput =
  typeof ChangeRequestsRetrieveInput.Type;

// Output Schema
export const ChangeRequestsRetrieveOutput = /*@__PURE__*/ Schema.Struct({
...
export type ChangeRequestsRetrieveOutput =
  typeof ChangeRequestsRetrieveOutput.Type;
