...
// Input Schema
export interface ChangeRequestsRetrieveInput {
  id: string;
  project_id: string;
}
export const ChangeRequestsRetrieveInput =
  /*@__PURE__*/ Schema.Struct({
    ...
    T.Http({
      method: "GET",
      path: "/api/projects/{project_id}/change_requests/{id}/",
    }),
  ) as unknown as Schema.Codec<ChangeRequestsRetrieveInput>;

// Output Schema
export interface ChangeRequestsRetrieveOutput {
  id?: string;
  action_key?: string;
...
export const ChangeRequestsRetrieveOutput =
  ...
  }) as unknown as Schema.Codec<ChangeRequestsRetrieveOutput>;
