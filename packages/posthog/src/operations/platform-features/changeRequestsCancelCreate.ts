...
// Input Schema
export interface ChangeRequestsCancelCreateInput {
  id: string;
  project_id: string;
  action_key?: string;
...
export const ChangeRequestsCancelCreateInput =
  ...
  ) as unknown as Schema.Codec<ChangeRequestsCancelCreateInput>;

// Output Schema
export interface ChangeRequestsCancelCreateOutput {
  id?: string;
  action_key?: string;
  action_version?: number;
  resource_type?: string;
...
export const ChangeRequestsCancelCreateOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    is_requester: Schema.optional(Schema.Boolean),
    user_decision: Schema.optional(Schema.NullOr(Schema.String)),
  }) as unknown as Schema.Codec<ChangeRequestsCancelCreateOutput>;
 ...
 */
export const changeRequestsCancelCreate = /*@__PURE__*/ API.make(() => ({
