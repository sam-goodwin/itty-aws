...
// Input Schema
export const EventSchemasCreateInput = /*@__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "POST", path: "/api/projects/{project_id}/event_schemas/" }),
);
export type EventSchemasCreateInput = typeof EventSchemasCreateInput.Type;

// Output Schema
export const EventSchemasCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  event_definition: Schema.optional(Schema.String),
  property_group: Schema.optional(
    Schema.Struct({
