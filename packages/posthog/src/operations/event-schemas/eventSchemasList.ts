...
// Input Schema
export interface EventSchemasListInput {
  project_id: string;
  limit?: number;
  offset?: number;
}
export const EventSchemasListInput = /*@__PURE__*/ Schema.Struct({
  project_id: Schema.String.pipe(T.PathParam()),
  limit: Schema.optional(Schema.Number),
  offset: Schema.optional(Schema.Number),
}).pipe(
  T.Http({ method: "GET", path: "/api/projects/{project_id}/event_schemas/" }),
) as unknown as Schema.Codec<EventSchemasListInput>;

// Output Schema
export interface EventSchemasListOutput {
  count?: number;
  next?: string | null;
...
export const EventSchemasListOutput = /*@__PURE__*/ Schema.Struct({
...
}) as unknown as Schema.Codec<EventSchemasListOutput>;
 ...
 */
export const eventSchemasList = /*@__PURE__*/ API.make(() => ({
