...
// Input Schema
export interface ExternalDataSourcesRevenueAnalyticsConfigPartialUpdateInput {
  id: string;
  project_id: string;
  created_at?: string;
...
export const ExternalDataSourcesRevenueAnalyticsConfigPartialUpdateInput =
  ...
  ) as unknown as Schema.Codec<ExternalDataSourcesRevenueAnalyticsConfigPartialUpdateInput>;

// Output Schema
export type ExternalDataSourcesRevenueAnalyticsConfigPartialUpdateOutput = void;
export const ExternalDataSourcesRevenueAnalyticsConfigPartialUpdateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Void as unknown as Schema.Codec<ExternalDataSourcesRevenueAnalyticsConfigPartialUpdateOutput>;
