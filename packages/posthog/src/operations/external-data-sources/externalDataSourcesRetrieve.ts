...
// Input Schema
export interface ExternalDataSourcesRetrieveInput {
  id: string;
  project_id: string;
}
export const ExternalDataSourcesRetrieveInput =
  ...
  ) as unknown as Schema.Codec<ExternalDataSourcesRetrieveInput>;

// Output Schema
export interface ExternalDataSourcesRetrieveOutput {
  id?: string;
  created_at?: string;
...
export const ExternalDataSourcesRetrieveOutput =
  ...
  }) as unknown as Schema.Codec<ExternalDataSourcesRetrieveOutput>;
