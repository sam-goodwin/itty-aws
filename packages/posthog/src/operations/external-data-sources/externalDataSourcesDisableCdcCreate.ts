...
// Input Schema
export interface ExternalDataSourcesDisableCdcCreateInput {
  id: string;
  project_id: string;
  created_at?: string;
...
export const ExternalDataSourcesDisableCdcCreateInput =
  /*@__PURE__*/ Schema.Struct({
    ...
    T.Http({
      method: "POST",
      path: "/api/projects/{project_id}/external_data_sources/{id}/disable_cdc/",
    }),
  ) as unknown as Schema.Codec<ExternalDataSourcesDisableCdcCreateInput>;
