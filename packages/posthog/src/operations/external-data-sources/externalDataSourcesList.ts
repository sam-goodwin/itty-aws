...
// Input Schema
export interface ExternalDataSourcesListInput {
  project_id: string;
  limit?: number;
  offset?: number;
  search?: string;
...
export const ExternalDataSourcesListInput =
  ...
  ) as unknown as Schema.Codec<ExternalDataSourcesListInput>;

// Output Schema
export interface ExternalDataSourcesListOutput {
  count?: number;
  next?: string | null;
...
export const ExternalDataSourcesListOutput =
  ...
  }) as unknown as Schema.Codec<ExternalDataSourcesListOutput>;
