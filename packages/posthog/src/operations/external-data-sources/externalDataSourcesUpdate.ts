...
// Input Schema
export interface ExternalDataSourcesUpdateInput {
  id: string;
  project_id: string;
  created_at?: string;
...
export const ExternalDataSourcesUpdateInput =
  ...
  ) as unknown as Schema.Codec<ExternalDataSourcesUpdateInput>;

// Output Schema
export interface ExternalDataSourcesUpdateOutput {
  id?: string;
  created_at?: string;
  created_by?: string | null;
  created_via?: "web" | "api" | "mcp" | null;
...
export const ExternalDataSourcesUpdateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    supports_webhooks: Schema.optional(Schema.Boolean),
    supports_column_selection: Schema.optional(Schema.Boolean),
  }) as unknown as Schema.Codec<ExternalDataSourcesUpdateOutput>;
