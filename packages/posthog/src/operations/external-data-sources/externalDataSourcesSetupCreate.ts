...
// Input Schema
export interface ExternalDataSourcesSetupCreateInput {
  project_id: string;
  source_type:
    | "Ashby"
    | "Supabase"
...
export const ExternalDataSourcesSetupCreateInput =
  /*@__PURE__*/ Schema.Struct({
    ...
    T.Http({
      method: "POST",
      path: "/api/projects/{project_id}/external_data_sources/setup/",
    }),
  ) as unknown as Schema.Codec<ExternalDataSourcesSetupCreateInput>;

// Output Schema
export interface ExternalDataSourcesSetupCreateOutput {
  id: string;
  webhook?: {
    success: boolean;
  ...
  /*@__PURE__*/ Schema.Struct({
    ...
    webhook: Schema.optional(
      Schema.Struct({
        ...
        pending_inputs: Schema.Array(Schema.String),
      }),
    ),
  }) as unknown as Schema.Codec<ExternalDataSourcesSetupCreateOutput>;
