...
// Input Schema
export interface ExternalDataSourcesStoreCredentialsCreateInput {
  project_id: string;
  source_type:
    | "Ashby"
    | "Supabase"
...
export const ExternalDataSourcesStoreCredentialsCreateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({
      method: "POST",
      path: "/api/projects/{project_id}/external_data_sources/store_credentials/",
    }),
  ) as unknown as Schema.Codec<ExternalDataSourcesStoreCredentialsCreateInput>;

// Output Schema
export interface ExternalDataSourcesStoreCredentialsCreateOutput {
...
export const ExternalDataSourcesStoreCredentialsCreateOutput =
  ...
  }) as unknown as Schema.Codec<ExternalDataSourcesStoreCredentialsCreateOutput>;
