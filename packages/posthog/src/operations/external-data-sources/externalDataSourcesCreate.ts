...
// Input Schema
export interface ExternalDataSourcesCreateInput {
  project_id: string;
  source_type?:
    | "Ashby"
    | "Supabase"
...
export const ExternalDataSourcesCreateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    created_via: Schema.optional(Schema.Literals(["web", "api", "mcp"])),
  ...
  ) as unknown as Schema.Codec<ExternalDataSourcesCreateInput>;

// Output Schema
export interface ExternalDataSourcesCreateOutput {
  id?: string;
  created_at?: string;
...
export const ExternalDataSourcesCreateOutput =
  ...
  }) as unknown as Schema.Codec<ExternalDataSourcesCreateOutput>;
