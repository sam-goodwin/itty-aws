...
// Input Schema
export interface MessagingTemplatesCreateInput {
  project_id: string;
  id: string;
  name: string;
  description?: string;
...
export const MessagingTemplatesCreateInput =
  ...
  ) as unknown as Schema.Codec<MessagingTemplatesCreateInput>;

// Output Schema
export interface MessagingTemplatesCreateOutput {
  id: string;
  name: string;
  description?: string;
  created_at: string;
...
export const MessagingTemplatesCreateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    message_category: Schema.optional(Schema.NullOr(Schema.String)),
    deleted: Schema.optional(Schema.Boolean),
  }) as unknown as Schema.Codec<MessagingTemplatesCreateOutput>;
