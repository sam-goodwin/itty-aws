...
export type MessagingTemplatesUpdateInput =
  typeof MessagingTemplatesUpdateInput.Type;
...
export type MessagingTemplatesUpdateOutput =
  typeof MessagingTemplatesUpdateOutput.Type;
 ...
 */
export const messagingTemplatesUpdate = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
