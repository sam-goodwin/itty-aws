...
export const WarehouseDagListInput = /*@__PURE__*/ Schema.Struct({
...
export const WarehouseDagListOutput =
  /*@__PURE__*/ Schema.Void as unknown as Schema.Codec<WarehouseDagListOutput>;
 ...
 */
export const warehouseDagList = /*@__PURE__*/ API.make(() => ({
