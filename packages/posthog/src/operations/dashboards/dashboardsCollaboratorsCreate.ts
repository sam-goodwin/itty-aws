...
// Input Schema
export const DashboardsCollaboratorsCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const DashboardsCollaboratorsCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
 ...
 */
export const dashboardsCollaboratorsCreate = /*@__PURE__*/ API.make(() => ({
