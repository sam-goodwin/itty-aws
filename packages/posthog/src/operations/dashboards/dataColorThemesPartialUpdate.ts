...
// Input Schema
export const DataColorThemesPartialUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const DataColorThemesPartialUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.Number),
  name: Schema.optional(Schema.String),
  colors: Schema.optional(Schema.Unknown),
  is_global: Schema.optional(Schema.Boolean),
 ...
 */
export const dataColorThemesPartialUpdate = /*@__PURE__*/ API.make(() => ({
