...
// Input Schema
export interface DashboardsCopyTileCreateInput {
  id: number;
  project_id: string;
  format?: "json" | "txt";
...
export const DashboardsCopyTileCreateInput =
  ...
  ) as unknown as Schema.Codec<DashboardsCopyTileCreateInput>;

// Output Schema
export interface DashboardsCopyTileCreateOutput {
  id?: number;
  name?: string | null;
  description?: string;
  pinned?: boolean;
...
export const DashboardsCopyTileCreateOutput =
  ...
  }) as unknown as Schema.Codec<DashboardsCopyTileCreateOutput>;
