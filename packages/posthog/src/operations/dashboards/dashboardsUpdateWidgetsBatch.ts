...
// Input Schema
export interface DashboardsUpdateWidgetsBatchInput {
  id: number;
  project_id: string;
  format?: "json" | "txt";
  widgets?: unknown[];
...
export const DashboardsUpdateWidgetsBatchInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    widgets: Schema.optional(Schema.Array(Schema.Unknown)),
  }).pipe(
    T.Http({
      method: "PATCH",
      path: "/api/projects/{project_id}/dashboards/{id}/widgets/batch_update/",
    }),
  ) as unknown as Schema.Codec<DashboardsUpdateWidgetsBatchInput>;

// Output Schema
export interface DashboardsUpdateWidgetsBatchOutput {
  tiles: {
    id?: number;
    insight: {
      id?: number;
...
export const DashboardsUpdateWidgetsBatchOutput =
  ...
  }) as unknown as Schema.Codec<DashboardsUpdateWidgetsBatchOutput>;
