...
// Input Schema
export interface DashboardsRetrieveInput {
  id: number;
  project_id: string;
...
export const DashboardsRetrieveInput =
  ...
  ) as unknown as Schema.Codec<DashboardsRetrieveInput>;

// Output Schema
export interface DashboardsRetrieveOutput {
  id?: number;
  name?: string | null;
  description?: string;
  pinned?: boolean;
...
export const DashboardsRetrieveOutput =
  ...
  }) as unknown as Schema.Codec<DashboardsRetrieveOutput>;
