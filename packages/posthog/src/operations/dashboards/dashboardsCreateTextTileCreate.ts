...
export type DashboardsCreateTextTileCreateInput =
  typeof DashboardsCreateTextTileCreateInput.Type;
...
export type DashboardsCreateTextTileCreateOutput =
  typeof DashboardsCreateTextTileCreateOutput.Type;
