...
// Input Schema
export const DataColorThemesCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const DataColorThemesCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.Number),
  name: Schema.optional(Schema.String),
  colors: Schema.optional(Schema.Unknown),
  is_global: Schema.optional(Schema.Boolean),
 ...
 */
export const dataColorThemesCreate = /*@__PURE__*/ API.make(() => ({
