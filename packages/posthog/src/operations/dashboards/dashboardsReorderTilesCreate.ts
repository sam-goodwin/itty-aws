...
// Input Schema
export interface DashboardsReorderTilesCreateInput {
  id: number;
  project_id: string;
  format?: "json" | "txt";
  tile_order?: number[];
...
export const DashboardsReorderTilesCreateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    layout: Schema.optional(
      Schema.Literals(["preserve", "two_column", "full_width"]),
    ),
  }).pipe(
    T.Http({
      method: "POST",
  ...
  ) as unknown as Schema.Codec<DashboardsReorderTilesCreateInput>;

// Output Schema
export interface DashboardsReorderTilesCreateOutput {
  id?: number;
  name?: string | null;
  description?: string;
  pinned?: boolean;
...
export const DashboardsReorderTilesCreateOutput =
  ...
  }) as unknown as Schema.Codec<DashboardsReorderTilesCreateOutput>;
