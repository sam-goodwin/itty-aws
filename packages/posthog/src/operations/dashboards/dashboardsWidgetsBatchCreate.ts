...
// Input Schema
export interface DashboardsWidgetsBatchCreateInput {
  id: number;
  project_id: string;
  format?: "json" | "txt";
  widgets: unknown[];
}
export const DashboardsWidgetsBatchCreateInput =
  /*@__PURE__*/ Schema.Struct({
    id: Schema.Number.pipe(T.PathParam()),
    project_id: Schema.String.pipe(T.PathParam()),
    format: Schema.optional(Schema.Literals(["json", "txt"])),
    widgets: Schema.Array(Schema.Unknown),
  }).pipe(
    T.Http({
      method: "POST",
      path: "/api/projects/{project_id}/dashboards/{id}/widgets/batch/",
    }),
  ) as unknown as Schema.Codec<DashboardsWidgetsBatchCreateInput>;

// Output Schema
export interface DashboardsWidgetsBatchCreateOutput {
  tiles: {
    id?: number;
    insight: {
      id?: number;
...
export const DashboardsWidgetsBatchCreateOutput =
  /*@__PURE__*/ Schema.Struct({
    tiles: Schema.Array(
      Schema.Struct({
        ...
        insight: Schema.Struct({
          ...
          effective_restriction_level: Schema.optional(
            Schema.Literals([21, 37]),
          ),
  ...
  }) as unknown as Schema.Codec<DashboardsWidgetsBatchCreateOutput>;
 ...
 */
export const dashboardsWidgetsBatchCreate =
  /*@__PURE__*/ API.make(() => ({
    inputSchema: DashboardsWidgetsBatchCreateInput,
    outputSchema: DashboardsWidgetsBatchCreateOutput,
  }));
