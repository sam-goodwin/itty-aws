...
// Input Schema
export const HogFlowsSchedulesPartialUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const HogFlowsSchedulesPartialUpdateOutput = /*@__PURE__*/ Schema.Struct(
  {
    id: Schema.optional(Schema.String),
    name: Schema.optional(Schema.NullOr(Schema.String)),
    description: Schema.optional(Schema.String),
 ...
 */
export const hogFlowsSchedulesPartialUpdate = /*@__PURE__*/ API.make(() => ({
