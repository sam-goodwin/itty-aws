...
// Input Schema
export const HogFlowsPartialUpdateInput = /*@__PURE__*/ Schema.Struct({
...
export type HogFlowsPartialUpdateInput = typeof HogFlowsPartialUpdateInput.Type;

// Output Schema
export const HogFlowsPartialUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.NullOr(Schema.String)),
  description: Schema.optional(Schema.String),
  version: Schema.optional(Schema.Number),
...
export type HogFlowsPartialUpdateOutput =
  typeof HogFlowsPartialUpdateOutput.Type;
