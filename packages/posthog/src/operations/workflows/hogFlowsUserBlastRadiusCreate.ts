...
// Input Schema
export const HogFlowsUserBlastRadiusCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const HogFlowsUserBlastRadiusCreateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const hogFlowsUserBlastRadiusCreate = /*@__PURE__*/ API.make(() => ({
