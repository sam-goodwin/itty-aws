...
// Input Schema
export const HogFlowsBatchJobsRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const HogFlowsBatchJobsRetrieveOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const hogFlowsBatchJobsRetrieve = /*@__PURE__*/ API.make(() => ({
