...
// Input Schema
export const SdkDoctorReportRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const SdkDoctorReportRetrieveOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const sdkDoctorReportRetrieve = /*@__PURE__*/ API.make(() => ({
