...
// Input Schema
export interface WarehouseViewLinkCreateInput {
  project_id: string;
  id: string;
...
export const WarehouseViewLinkCreateInput =
  ...
  ) as unknown as Schema.Codec<WarehouseViewLinkCreateInput>;

// Output Schema
export interface WarehouseViewLinkCreateOutput {
  id: string;
  deleted?: boolean | null;
  created_by: {
    id?: number;
...
export const WarehouseViewLinkCreateOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    field_name: Schema.String,
    configuration: Schema.optional(Schema.Unknown),
  }) as unknown as Schema.Codec<WarehouseViewLinkCreateOutput>;
