...
// Input Schema
export const PluginConfigsLogsListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const PluginConfigsLogsListOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const pluginConfigsLogsList = /*@__PURE__*/ API.make(() => ({
