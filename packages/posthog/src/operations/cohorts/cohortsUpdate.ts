...
// Input Schema
export interface CohortsUpdateInput {
  id: number;
  project_id: string;
  name?: string | null;
  description?: string;
...
export const CohortsUpdateInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "PUT", path: "/api/projects/{project_id}/cohorts/{id}/" }),
) as unknown as Schema.Codec<CohortsUpdateInput>;

// Output Schema
export interface CohortsUpdateOutput {
  id?: number;
  name?: string | null;
  description?: string;
  groups?: unknown;
...
export const CohortsUpdateOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  _create_in_folder: Schema.optional(Schema.String),
  _create_static_person_ids: Schema.optional(Schema.Array(Schema.String)),
}) as unknown as Schema.Codec<CohortsUpdateOutput>;
