...
// Input Schema
export interface CohortsPartialUpdateInput {
  id: number;
  project_id: string;
  name?: string | null;
  description?: string;
...
export const CohortsPartialUpdateInput =
  ...
  ) as unknown as Schema.Codec<CohortsPartialUpdateInput>;

// Output Schema
export interface CohortsPartialUpdateOutput {
  id?: number;
  name?: string | null;
  description?: string;
  groups?: unknown;
...
export const CohortsPartialUpdateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    _create_in_folder: Schema.optional(Schema.String),
    _create_static_person_ids: Schema.optional(Schema.Array(Schema.String)),
  }) as unknown as Schema.Codec<CohortsPartialUpdateOutput>;
