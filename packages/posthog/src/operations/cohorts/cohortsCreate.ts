...
// Input Schema
export interface CohortsCreateInput {
  project_id: string;
  id?: number;
  name?: string | null;
  description?: string;
...
) as unknown as Schema.Codec<CohortsCreateInput>;

// Output Schema
export interface CohortsCreateOutput {
  id?: number;
  name?: string | null;
  description?: string;
  groups?: unknown;
...
export const CohortsCreateOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  _create_in_folder: Schema.optional(Schema.String),
  _create_static_person_ids: Schema.optional(Schema.Array(Schema.String)),
}) as unknown as Schema.Codec<CohortsCreateOutput>;
