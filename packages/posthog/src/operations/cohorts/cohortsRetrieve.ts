...
export const CohortsRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
export const CohortsRetrieveOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const cohortsRetrieve = /*@__PURE__*/ API.make(() => ({
