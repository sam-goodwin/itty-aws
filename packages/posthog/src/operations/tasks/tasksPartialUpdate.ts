...
// Input Schema
export const TasksPartialUpdateInput = /*@__PURE__*/ Schema.Struct({
...
export type TasksPartialUpdateInput = typeof TasksPartialUpdateInput.Type;

// Output Schema
export const TasksPartialUpdateOutput = /*@__PURE__*/ Schema.Struct({
...
export type TasksPartialUpdateOutput = typeof TasksPartialUpdateOutput.Type;
 ...
 */
export const tasksPartialUpdate = /*@__PURE__*/ API.make(() => ({
