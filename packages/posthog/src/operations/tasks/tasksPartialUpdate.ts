...
// Input Schema
export interface TasksPartialUpdateInput {
  id: string;
  project_id: string;
  title?: string;
...
export const TasksPartialUpdateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "PATCH", path: "/api/projects/{project_id}/tasks/{id}/" }),
  ) as unknown as Schema.Codec<TasksPartialUpdateInput>;

// Output Schema
export interface TasksPartialUpdateOutput {
  id: string;
...
export const TasksPartialUpdateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.String,
  ...
  }) as unknown as Schema.Codec<TasksPartialUpdateOutput>;
 ...
 */
export const tasksPartialUpdate = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: TasksPartialUpdateInput,
  outputSchema: TasksPartialUpdateOutput,
