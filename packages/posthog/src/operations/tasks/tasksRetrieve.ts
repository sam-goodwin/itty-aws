...
// Input Schema
export interface TasksRetrieveInput {
  id: string;
  project_id: string;
}
...
) as unknown as Schema.Codec<TasksRetrieveInput>;

// Output Schema
export interface TasksRetrieveOutput {
  id: string;
...
}) as unknown as Schema.Codec<TasksRetrieveOutput>;
