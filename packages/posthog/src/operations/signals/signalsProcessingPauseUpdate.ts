...
// Input Schema
export const SignalsProcessingPauseUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const SignalsProcessingPauseUpdateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const signalsProcessingPauseUpdate = /*@__PURE__*/ API.make(() => ({
