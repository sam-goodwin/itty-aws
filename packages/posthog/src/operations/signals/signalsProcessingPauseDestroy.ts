...
// Input Schema
export const SignalsProcessingPauseDestroyInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const SignalsProcessingPauseDestroyOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const signalsProcessingPauseDestroy = /*@__PURE__*/ API.make(() => ({
