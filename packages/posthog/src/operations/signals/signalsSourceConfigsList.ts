...
// Input Schema
export const SignalsSourceConfigsListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const SignalsSourceConfigsListOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const signalsSourceConfigsList = /*@__PURE__*/ API.make(() => ({
