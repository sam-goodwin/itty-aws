...
// Input Schema
export const SignalsSourceConfigsRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const SignalsSourceConfigsRetrieveOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const signalsSourceConfigsRetrieve = /*@__PURE__*/ API.make(() => ({
