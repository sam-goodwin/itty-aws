...
// Input Schema
export const SignalsProcessingListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const SignalsProcessingListOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const signalsProcessingList = /*@__PURE__*/ API.make(() => ({
