...
export type DesktopFileSystemInstructionsUpdateInput =
  typeof DesktopFileSystemInstructionsUpdateInput.Type;
...
export type DesktopFileSystemInstructionsUpdateOutput =
  typeof DesktopFileSystemInstructionsUpdateOutput.Type;
