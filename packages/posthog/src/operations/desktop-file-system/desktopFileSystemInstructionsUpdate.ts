...
// Input Schema
export interface DesktopFileSystemInstructionsUpdateInput {
  id: string;
  project_id: string;
  content: string;
  base_version?: number;
...
export const DesktopFileSystemInstructionsUpdateInput =
  ...
  ) as unknown as Schema.Codec<DesktopFileSystemInstructionsUpdateInput>;

// Output Schema
export interface DesktopFileSystemInstructionsUpdateOutput {
  id: string;
  content: string;
  version: number;
  is_latest: boolean;
...
export const DesktopFileSystemInstructionsUpdateOutput =
  ...
  }) as unknown as Schema.Codec<DesktopFileSystemInstructionsUpdateOutput>;
