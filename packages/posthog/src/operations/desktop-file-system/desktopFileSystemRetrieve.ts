 ...
 */
export const desktopFileSystemRetrieve = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: DesktopFileSystemRetrieveInput,
    outputSchema: DesktopFileSystemRetrieveOutput,
  }),
);
