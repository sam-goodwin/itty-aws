...
// Input Schema
export const SessionRecordingsListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const SessionRecordingsListOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const sessionRecordingsList = /*@__PURE__*/ API.make(() => ({
