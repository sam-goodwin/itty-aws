...
// Input Schema
export const SessionRecordingsPartialUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const SessionRecordingsPartialUpdateOutput = /*@__PURE__*/ Schema.Struct(
  {
 ...
 */
export const sessionRecordingsPartialUpdate = /*@__PURE__*/ API.make(() => ({
