...
// Input Schema
export interface SessionRecordingPlaylistsPartialUpdateInput {
  project_id: string;
  short_id: string;
  id?: number;
  name?: string | null;
...
export const SessionRecordingPlaylistsPartialUpdateInput =
  ...
  ) as unknown as Schema.Codec<SessionRecordingPlaylistsPartialUpdateInput>;

// Output Schema
export interface SessionRecordingPlaylistsPartialUpdateOutput {
  id?: number;
  short_id?: string;
  name?: string | null;
  derived_name?: string | null;
...
export const SessionRecordingPlaylistsPartialUpdateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    is_synthetic: Schema.optional(Schema.Boolean),
    _create_in_folder: Schema.optional(Schema.String),
  }) as unknown as Schema.Codec<SessionRecordingPlaylistsPartialUpdateOutput>;
