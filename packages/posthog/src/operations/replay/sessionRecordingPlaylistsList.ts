...
// Input Schema
export const SessionRecordingPlaylistsListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const SessionRecordingPlaylistsListOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const sessionRecordingPlaylistsList = /*@__PURE__*/ API.make(() => ({
