...
// Input Schema
export const QueryUpgradeCreateInput = /*@__PURE__*/ Schema.Struct({
  project_id: Schema.String.pipe(T.PathParam()),
  query: Schema.optional(Schema.Unknown),
}).pipe(
  T.Http({ method: "POST", path: "/api/projects/{project_id}/query/upgrade/" }),
);
export type QueryUpgradeCreateInput = typeof QueryUpgradeCreateInput.Type;

// Output Schema
export const QueryUpgradeCreateOutput = /*@__PURE__*/ Schema.Struct({
  query: Schema.optional(Schema.Unknown),
});
