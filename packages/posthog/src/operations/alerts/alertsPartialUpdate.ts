...
// Input Schema
export const AlertsPartialUpdateInput = /*@__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "/api/projects/{project_id}/alerts/{id}/" }),
);
export type AlertsPartialUpdateInput = typeof AlertsPartialUpdateInput.Type;

// Output Schema
export const AlertsPartialUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  created_by: Schema.optional(
    Schema.NullOr(
      Schema.Struct({
