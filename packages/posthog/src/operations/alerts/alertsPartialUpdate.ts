...
// Input Schema
export interface AlertsPartialUpdateInput {
  id: string;
  project_id: string;
  created_by?: {
    id?: number;
...
export const AlertsPartialUpdateInput =
  ...
  ) as unknown as Schema.Codec<AlertsPartialUpdateInput>;

// Output Schema
export interface AlertsPartialUpdateOutput {
  id?: string;
  created_by?: {
    id?: number;
    uuid?: string;
...
export const AlertsPartialUpdateOutput =
  ...
  }) as unknown as Schema.Codec<AlertsPartialUpdateOutput>;
