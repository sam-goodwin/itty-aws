...
// Input Schema
export interface AlertsRetrieveInput {
  id: string;
  project_id: string;
...
) as unknown as Schema.Codec<AlertsRetrieveInput>;

// Output Schema
export interface AlertsRetrieveOutput {
  id?: string;
  created_by?: {
    id?: number;
    uuid?: string;
...
}) as unknown as Schema.Codec<AlertsRetrieveOutput>;
