...
// Input Schema
export interface AlertsCreateInput {
  project_id: string;
  id?: string;
  created_by?: {
    id?: number;
...
export const AlertsCreateInput = /*@__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "POST", path: "/api/projects/{project_id}/alerts/" }),
) as unknown as Schema.Codec<AlertsCreateInput>;

// Output Schema
export interface AlertsCreateOutput {
  id?: string;
  created_by?: {
    id?: number;
    uuid?: string;
...
export const AlertsCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  created_by: Schema.optional(
    Schema.NullOr(
      Schema.Struct({
...
}) as unknown as Schema.Codec<AlertsCreateOutput>;
 ...
 */
export const alertsCreate = /*@__PURE__*/ API.make(() => ({
