...
// Input Schema
export interface AlertsUpdateInput {
  id: string;
  project_id: string;
  created_by?: {
    id?: number;
...
) as unknown as Schema.Codec<AlertsUpdateInput>;

// Output Schema
export interface AlertsUpdateOutput {
  id?: string;
  created_by?: {
    id?: number;
    uuid?: string;
...
}) as unknown as Schema.Codec<AlertsUpdateOutput>;
