...
export type UsersOnboardingSkipCreateInput =
  typeof UsersOnboardingSkipCreateInput.Type;
...
export const UsersOnboardingSkipCreateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    onboarding_skipped_reason: Schema.optional(Schema.Unknown),
...
export type UsersOnboardingSkipCreateOutput =
  typeof UsersOnboardingSkipCreateOutput.Type;
