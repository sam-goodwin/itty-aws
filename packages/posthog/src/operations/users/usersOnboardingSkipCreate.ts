...
// Input Schema
export interface UsersOnboardingSkipCreateInput {
  uuid: string;
  reason: "later" | "other";
  step_at_skip?: string;
}
export const UsersOnboardingSkipCreateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "POST", path: "/api/users/{uuid}/onboarding/skip/" }),
  ) as unknown as Schema.Codec<UsersOnboardingSkipCreateInput>;

// Output Schema
export interface UsersOnboardingSkipCreateOutput {
  date_joined?: string;
  uuid?: string;
  ...
  current_password?: Redacted.Redacted<string>;
...
export const UsersOnboardingSkipCreateOutput =
  ...
  }) as unknown as Schema.Codec<UsersOnboardingSkipCreateOutput>;
