...
// Input Schema
export interface UsersPartialUpdateInput {
  uuid: string;
  date_joined?: string;
...
export const UsersPartialUpdateInput =
  /*@__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "PATCH", path: "/api/users/{uuid}/" }),
  ) as unknown as Schema.Codec<UsersPartialUpdateInput>;

// Output Schema
export interface UsersPartialUpdateOutput {
  date_joined?: string;
  uuid?: string;
  distinct_id?: string | null;
  first_name?: string;
...
export const UsersPartialUpdateOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    requires_credential_review: Schema.optional(Schema.Boolean),
  }) as unknown as Schema.Codec<UsersPartialUpdateOutput>;
