...
export const UsersListInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "GET", path: "/api/users/" }),
  ...
  results: Schema.optional(
    Schema.Array(
      Schema.Struct({
        ...
        is_impersonated_read_only: Schema.optional(
          Schema.NullOr(Schema.Boolean),
        ),
        sensitive_session_expires_at: Schema.optional(
        ...
        organization: Schema.optional(
          Schema.Struct({
            ...
            plugins_access_level: Schema.optional(
              Schema.Literals([0, 3, 6, 9]),
            ),
            ...
            is_ai_training_opted_in: Schema.optional(
              Schema.NullOr(Schema.Boolean),
            ),
            is_ai_training_locked: Schema.optional(
              Schema.NullOr(Schema.Boolean),
            ),
        ...
        organizations: Schema.optional(
          Schema.Array(
            Schema.Struct({
              ...
              logo_media_id: Schema.optional(Schema.NullOr(Schema.String)),
              membership_level: Schema.optional(Schema.Literals([1, 8, 15])),
              members_can_use_personal_api_keys: Schema.optional(
                Schema.Boolean,
              ),
              is_active: Schema.optional(Schema.NullOr(Schema.Boolean)),
              is_not_active_reason: Schema.optional(
                Schema.NullOr(Schema.String),
              ),
              is_pending_deletion: Schema.optional(
                Schema.NullOr(Schema.Boolean),
              ),
            }),
          ),
        ...
        allow_sidebar_suggestions: Schema.optional(
          Schema.NullOr(Schema.Boolean),
        ),
        ...
        passkeys_enabled_for_2fa: Schema.optional(
          Schema.NullOr(Schema.Boolean),
        ),
        ...
        is_organization_first_user: Schema.optional(
          Schema.NullOr(Schema.Boolean),
        ),
