...
// Input Schema
export interface UsersTwoFactorDisableCreateInput {
  uuid: string;
  date_joined?: string;
...
export const UsersTwoFactorDisableCreateInput =
  /*@__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "POST", path: "/api/users/{uuid}/two_factor_disable/" }),
  ) as unknown as Schema.Codec<UsersTwoFactorDisableCreateInput>;
