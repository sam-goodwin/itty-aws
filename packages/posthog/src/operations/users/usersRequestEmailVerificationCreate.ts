...
// Input Schema
export interface UsersRequestEmailVerificationCreateInput {
  date_joined?: string;
  uuid?: string;
...
export const UsersRequestEmailVerificationCreateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "POST", path: "/api/users/request_email_verification/" }),
  ) as unknown as Schema.Codec<UsersRequestEmailVerificationCreateInput>;
