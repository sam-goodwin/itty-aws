...
// Input Schema
export interface AccountsNotebooksCreateInput {
  account_id: string;
  project_id: string;
  id: string;
  short_id: string;
...
export const AccountsNotebooksCreateInput =
  ...
  ) as unknown as Schema.Codec<AccountsNotebooksCreateInput>;

// Output Schema
export interface AccountsNotebooksCreateOutput {
  id: string;
  short_id: string;
  title?: string | null;
  content?: unknown;
...
export const AccountsNotebooksCreateOutput =
  ...
  }) as unknown as Schema.Codec<AccountsNotebooksCreateOutput>;
