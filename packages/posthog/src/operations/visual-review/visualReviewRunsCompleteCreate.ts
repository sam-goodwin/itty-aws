...
// Input Schema
export interface VisualReviewRunsCompleteCreateInput {
  id: string;
  project_id: string;
}
export const VisualReviewRunsCompleteCreateInput =
  ...
  ) as unknown as Schema.Codec<VisualReviewRunsCompleteCreateInput>;

// Output Schema
export interface VisualReviewRunsCompleteCreateOutput {
...
export const VisualReviewRunsCompleteCreateOutput =
  ...
  }) as unknown as Schema.Codec<VisualReviewRunsCompleteCreateOutput>;
