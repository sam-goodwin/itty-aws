...
// Input Schema
export const VisualReviewRunsSnapshotsListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const VisualReviewRunsSnapshotsListOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const visualReviewRunsSnapshotsList = /*@__PURE__*/ API.make(() => ({
