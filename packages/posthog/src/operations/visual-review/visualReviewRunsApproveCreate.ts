...
// Input Schema
export const VisualReviewRunsApproveCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const VisualReviewRunsApproveCreateOutput = /*@__PURE__*/ Schema.Struct({
  run: Schema.optional(
    Schema.Struct({
 ...
 */
export const visualReviewRunsApproveCreate = /*@__PURE__*/ API.make(() => ({
