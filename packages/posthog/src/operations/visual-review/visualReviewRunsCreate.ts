...
// Input Schema
export const VisualReviewRunsCreateInput = /*@__PURE__*/ Schema.Struct({
  ...
  baseline_hashes: Schema.optional(Schema.Record(Schema.String, Schema.String)),
...
// Output Schema
export const VisualReviewRunsCreateOutput = /*@__PURE__*/ Schema.Struct({
