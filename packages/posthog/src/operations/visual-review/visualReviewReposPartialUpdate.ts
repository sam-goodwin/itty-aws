...
// Input Schema
export const VisualReviewReposPartialUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const VisualReviewReposPartialUpdateOutput = /*@__PURE__*/ Schema.Struct(
  {
 ...
 */
export const visualReviewReposPartialUpdate = /*@__PURE__*/ API.make(() => ({
