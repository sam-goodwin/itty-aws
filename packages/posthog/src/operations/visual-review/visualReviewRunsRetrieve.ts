...
// Input Schema
export interface VisualReviewRunsRetrieveInput {
  id: string;
  project_id: string;
}
export const VisualReviewRunsRetrieveInput =
  ...
  ) as unknown as Schema.Codec<VisualReviewRunsRetrieveInput>;

// Output Schema
export interface VisualReviewRunsRetrieveOutput {
...
export const VisualReviewRunsRetrieveOutput =
  ...
  }) as unknown as Schema.Codec<VisualReviewRunsRetrieveOutput>;
