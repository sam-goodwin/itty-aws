...
// Input Schema
export const VisualReviewReposCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const VisualReviewReposCreateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const visualReviewReposCreate = /*@__PURE__*/ API.make(() => ({
