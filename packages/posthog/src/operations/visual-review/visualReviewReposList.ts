...
// Input Schema
export const VisualReviewReposListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const VisualReviewReposListOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const visualReviewReposList = /*@__PURE__*/ API.make(() => ({
