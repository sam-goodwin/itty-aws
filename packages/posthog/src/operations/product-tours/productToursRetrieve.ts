...
// Input Schema
export const ProductToursRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
export type ProductToursRetrieveInput = typeof ProductToursRetrieveInput.Type;

// Output Schema
export const ProductToursRetrieveOutput = /*@__PURE__*/ Schema.Struct({
