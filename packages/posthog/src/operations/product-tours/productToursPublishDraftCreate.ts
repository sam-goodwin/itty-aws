...
// Input Schema
export const ProductToursPublishDraftCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ProductToursPublishDraftCreateOutput = /*@__PURE__*/ Schema.Struct(
  {
 ...
 */
export const productToursPublishDraftCreate = /*@__PURE__*/ API.make(() => ({
