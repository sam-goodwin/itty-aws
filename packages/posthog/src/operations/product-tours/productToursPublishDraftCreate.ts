...
// Input Schema
export interface ProductToursPublishDraftCreateInput {
  id: string;
  project_id: string;
  name?: string;
  description?: string;
...
export const ProductToursPublishDraftCreateInput =
  ...
  ) as unknown as Schema.Codec<ProductToursPublishDraftCreateInput>;

// Output Schema
export interface ProductToursPublishDraftCreateOutput {
  id?: string;
  name?: string;
  description?: string;
  internal_targeting_flag?: {
...
export const ProductToursPublishDraftCreateOutput =
  ...
  }) as unknown as Schema.Codec<ProductToursPublishDraftCreateOutput>;
