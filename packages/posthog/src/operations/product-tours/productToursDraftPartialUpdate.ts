...
// Input Schema
export interface ProductToursDraftPartialUpdateInput {
  id: string;
  project_id: string;
  name?: string;
  description?: string;
...
export const ProductToursDraftPartialUpdateInput =
  ...
  ) as unknown as Schema.Codec<ProductToursDraftPartialUpdateInput>;

// Output Schema
export interface ProductToursDraftPartialUpdateOutput {
  id?: string;
  name?: string;
  description?: string;
  internal_targeting_flag?: {
...
export const ProductToursDraftPartialUpdateOutput =
  ...
  }) as unknown as Schema.Codec<ProductToursDraftPartialUpdateOutput>;
