...
// Input Schema
export const ProductToursDraftPartialUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ProductToursDraftPartialUpdateOutput = /*@__PURE__*/ Schema.Struct(
  {
 ...
 */
export const productToursDraftPartialUpdate = /*@__PURE__*/ API.make(() => ({
