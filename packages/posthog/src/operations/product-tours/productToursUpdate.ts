...
// Input Schema
export interface ProductToursUpdateInput {
  id: string;
  project_id: string;
  name?: string;
  description?: string;
...
export const ProductToursUpdateInput =
  ...
  ) as unknown as Schema.Codec<ProductToursUpdateInput>;

// Output Schema
export interface ProductToursUpdateOutput {
  id?: string;
  name?: string;
  description?: string;
  internal_targeting_flag?: {
...
export const ProductToursUpdateOutput =
  ...
  }) as unknown as Schema.Codec<ProductToursUpdateOutput>;
