...
// Input Schema
export const ProductToursUpdateInput = /*@__PURE__*/ Schema.Struct({
...
export type ProductToursUpdateInput = typeof ProductToursUpdateInput.Type;

// Output Schema
export const ProductToursUpdateOutput = /*@__PURE__*/ Schema.Struct({
