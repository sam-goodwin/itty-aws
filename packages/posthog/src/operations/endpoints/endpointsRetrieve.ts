...
// Input Schema
export const EndpointsRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const EndpointsRetrieveOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const endpointsRetrieve = /*@__PURE__*/ API.make(() => ({
