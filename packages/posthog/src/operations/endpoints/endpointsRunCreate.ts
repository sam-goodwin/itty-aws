...
// Input Schema
export const EndpointsRunCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const EndpointsRunCreateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const endpointsRunCreate = /*@__PURE__*/ API.make(() => ({
