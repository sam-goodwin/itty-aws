...
// Input Schema
export const CustomerProfileConfigsUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const CustomerProfileConfigsUpdateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const customerProfileConfigsUpdate = /*@__PURE__*/ API.make(() => ({
