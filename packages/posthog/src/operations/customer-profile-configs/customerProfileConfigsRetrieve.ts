...
// Input Schema
export const CustomerProfileConfigsRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const CustomerProfileConfigsRetrieveOutput = /*@__PURE__*/ Schema.Struct(
  {
 ...
 */
export const customerProfileConfigsRetrieve = /*@__PURE__*/ API.make(() => ({
