...
// Input Schema
export const CustomerProfileConfigsCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const CustomerProfileConfigsCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  scope: Schema.optional(
    Schema.Literals([
      "person",
 ...
 */
export const customerProfileConfigsCreate = /*@__PURE__*/ API.make(() => ({
