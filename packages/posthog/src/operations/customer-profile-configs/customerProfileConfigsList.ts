...
// Input Schema
export const CustomerProfileConfigsListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const CustomerProfileConfigsListOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const customerProfileConfigsList = /*@__PURE__*/ API.make(() => ({
