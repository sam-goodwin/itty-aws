...
// Input Schema
export interface AnnotationsPartialUpdateInput {
  id: number;
  project_id: string;
  content?: string | null;
...
export const AnnotationsPartialUpdateInput =
  ...
  ) as unknown as Schema.Codec<AnnotationsPartialUpdateInput>;

// Output Schema
export interface AnnotationsPartialUpdateOutput {
  id?: number;
  content?: string | null;
  date_marker?: string | null;
  creation_type?: "USR" | "GIT";
...
export const AnnotationsPartialUpdateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    emoji: Schema.optional(Schema.NullOr(Schema.String)),
    hidden_in_user_interface: Schema.optional(Schema.NullOr(Schema.Boolean)),
  }) as unknown as Schema.Codec<AnnotationsPartialUpdateOutput>;
