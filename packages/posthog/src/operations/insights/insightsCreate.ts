...
// Input Schema
export interface InsightsCreateInput {
  project_id: string;
  format?: "csv" | "json";
  id?: number;
  short_id?: string;
...
) as unknown as Schema.Codec<InsightsCreateInput>;

// Output Schema
export interface InsightsCreateOutput {
  id?: number;
  short_id?: string;
  name?: string | null;
  derived_name?: string | null;
...
}) as unknown as Schema.Codec<InsightsCreateOutput>;
