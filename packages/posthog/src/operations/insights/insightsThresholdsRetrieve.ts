...
// Input Schema
export interface InsightsThresholdsRetrieveInput {
  id: string;
  insight_id: number;
  project_id: string;
}
export const InsightsThresholdsRetrieveInput =
  ...
  ) as unknown as Schema.Codec<InsightsThresholdsRetrieveInput>;

// Output Schema
export interface InsightsThresholdsRetrieveOutput {
  id?: string;
  created_at?: string;
  name?: string;
  configuration?: {
...
export const InsightsThresholdsRetrieveOutput =
  ...
  }) as unknown as Schema.Codec<InsightsThresholdsRetrieveOutput>;
