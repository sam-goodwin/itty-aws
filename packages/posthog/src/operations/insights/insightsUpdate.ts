...
// Input Schema
export interface InsightsUpdateInput {
  id: string;
  project_id: string;
  format?: "csv" | "json";
  short_id?: string;
...
) as unknown as Schema.Codec<InsightsUpdateInput>;

// Output Schema
export interface InsightsUpdateOutput {
  id?: number;
  short_id?: string;
  name?: string | null;
  derived_name?: string | null;
...
}) as unknown as Schema.Codec<InsightsUpdateOutput>;
