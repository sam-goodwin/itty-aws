...
// Input Schema
export const InsightsThresholdsListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const InsightsThresholdsListOutput = /*@__PURE__*/ Schema.Struct({
              ...
              checks: Schema.optional(
                Schema.Array(
                  Schema.Struct({
                    ...
                    anomaly_scores: Schema.optional(
                      Schema.NullOr(Schema.Unknown),
                    ),
                    triggered_points: Schema.optional(
                      Schema.NullOr(Schema.Unknown),
                    ),
                    triggered_dates: Schema.optional(
                      Schema.NullOr(Schema.Unknown),
                    ),
              ...
              config: Schema.optional(
                Schema.NullOr(
                  Schema.Struct({
                    ...
                    type: Schema.optional(
                      Schema.Literals(["TrendsAlertConfig"]),
                    ),
                  }),
                ),
              ),
