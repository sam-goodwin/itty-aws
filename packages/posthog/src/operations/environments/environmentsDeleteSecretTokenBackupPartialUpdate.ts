...
// Input Schema
export interface EnvironmentsDeleteSecretTokenBackupPartialUpdateInput {
  id: number;
  project_id: string;
  uuid?: string;
  name?: string;
...
export const EnvironmentsDeleteSecretTokenBackupPartialUpdateInput =
  ...
  ) as unknown as Schema.Codec<EnvironmentsDeleteSecretTokenBackupPartialUpdateInput>;
