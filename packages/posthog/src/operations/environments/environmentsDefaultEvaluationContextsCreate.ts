...
export const EnvironmentsDefaultEvaluationContextsCreateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    product_intents: Schema.Array(Schema.Record(Schema.String, Schema.Unknown)),
    managed_viewsets: Schema.Record(Schema.String, Schema.Boolean),
...
export type EnvironmentsDefaultEvaluationContextsCreateInput =
