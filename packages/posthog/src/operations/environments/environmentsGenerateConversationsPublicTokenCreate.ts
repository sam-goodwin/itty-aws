...
// Input Schema
export interface EnvironmentsGenerateConversationsPublicTokenCreateInput {
  id: number;
  project_id: string;
  uuid?: string;
  name?: string;
...
export const EnvironmentsGenerateConversationsPublicTokenCreateInput =
  ...
  ) as unknown as Schema.Codec<EnvironmentsGenerateConversationsPublicTokenCreateInput>;
