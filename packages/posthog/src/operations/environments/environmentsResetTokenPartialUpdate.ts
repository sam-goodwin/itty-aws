...
// Input Schema
export interface EnvironmentsResetTokenPartialUpdateInput {
  id: number;
  project_id: string;
  uuid?: string;
  name?: string;
  ...
  product_intents?: Record<string, unknown>[];
...
export const EnvironmentsResetTokenPartialUpdateInput =
  ...
  ) as unknown as Schema.Codec<EnvironmentsResetTokenPartialUpdateInput>;
