...
// Input Schema
export interface EnvironmentsCompleteProductOnboardingPartialUpdateInput {
  id: number;
  project_id: string;
  uuid?: string;
  name?: string;
...
export const EnvironmentsCompleteProductOnboardingPartialUpdateInput =
  ...
  ) as unknown as Schema.Codec<EnvironmentsCompleteProductOnboardingPartialUpdateInput>;
