...
// Input Schema
export const CreateSessionSummariesInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const CreateSessionSummariesOutput = /*@__PURE__*/ Schema.Struct({
  session_ids: Schema.optional(Schema.Array(Schema.String)),
  focus_area: Schema.optional(Schema.String),
});
 ...
 */
export const createSessionSummaries = /*@__PURE__*/ API.make(() => ({
