...
// Input Schema
export const PersonsPartialUpdateInput = /*@__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "/api/projects/{project_id}/persons/{id}/" }),
);
export type PersonsPartialUpdateInput = typeof PersonsPartialUpdateInput.Type;

// Output Schema
export const PersonsPartialUpdateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const personsPartialUpdate = /*@__PURE__*/ API.make(() => ({
