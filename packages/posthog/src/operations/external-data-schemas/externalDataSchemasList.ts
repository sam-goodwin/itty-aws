...
// Input Schema
export interface ExternalDataSchemasListInput {
  project_id: string;
  limit?: number;
  offset?: number;
  search?: string;
...
export const ExternalDataSchemasListInput =
  ...
  ) as unknown as Schema.Codec<ExternalDataSchemasListInput>;

// Output Schema
export interface ExternalDataSchemasListOutput {
  count?: number;
  next?: string | null;
...
export const ExternalDataSchemasListOutput =
  ...
  }) as unknown as Schema.Codec<ExternalDataSchemasListOutput>;
