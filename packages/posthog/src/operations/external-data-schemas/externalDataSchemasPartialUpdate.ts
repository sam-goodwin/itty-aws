...
// Input Schema
export interface ExternalDataSchemasPartialUpdateInput {
  id: string;
  project_id: string;
  name?: string;
  label?: string | null;
...
export const ExternalDataSchemasPartialUpdateInput =
  ...
  ) as unknown as Schema.Codec<ExternalDataSchemasPartialUpdateInput>;

// Output Schema
export interface ExternalDataSchemasPartialUpdateOutput {
  id?: string;
  name?: string;
  label?: string | null;
  table?: Record<string, unknown> | null;
...
export const ExternalDataSchemasPartialUpdateOutput =
  ...
  }) as unknown as Schema.Codec<ExternalDataSchemasPartialUpdateOutput>;
 ...
 */
export const externalDataSchemasPartialUpdate =
  /*@__PURE__*/ API.make(() => ({
    inputSchema: ExternalDataSchemasPartialUpdateInput,
    outputSchema: ExternalDataSchemasPartialUpdateOutput,
