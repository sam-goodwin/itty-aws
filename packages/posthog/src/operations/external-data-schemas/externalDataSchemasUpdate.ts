...
// Input Schema
export interface ExternalDataSchemasUpdateInput {
  id: string;
  project_id: string;
  name?: string;
  label?: string | null;
...
export const ExternalDataSchemasUpdateInput =
  ...
  ) as unknown as Schema.Codec<ExternalDataSchemasUpdateInput>;

// Output Schema
export interface ExternalDataSchemasUpdateOutput {
  id?: string;
  name?: string;
  label?: string | null;
  table?: Record<string, unknown> | null;
...
export const ExternalDataSchemasUpdateOutput =
  ...
  }) as unknown as Schema.Codec<ExternalDataSchemasUpdateOutput>;
