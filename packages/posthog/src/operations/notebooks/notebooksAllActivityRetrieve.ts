...
// Input Schema
export const NotebooksAllActivityRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
export type NotebooksAllActivityRetrieveInput =
 ...
 */
export const notebooksAllActivityRetrieve = /*@__PURE__*/ API.make(() => ({
