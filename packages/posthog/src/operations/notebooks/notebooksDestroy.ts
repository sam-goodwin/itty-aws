...
export const NotebooksDestroyInput = /*@__PURE__*/ Schema.Struct({
...
export const NotebooksDestroyOutput =
  /*@__PURE__*/ Schema.Void as unknown as Schema.Codec<NotebooksDestroyOutput>;
 ...
 */
export const notebooksDestroy = /*@__PURE__*/ API.make(() => ({
