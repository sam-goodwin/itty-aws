...
// Input Schema
export interface NotebooksKernelExecuteStreamCreateInput {
  project_id: string;
  short_id: string;
  id?: string;
  title?: string | null;
...
export const NotebooksKernelExecuteStreamCreateInput =
  ...
  ) as unknown as Schema.Codec<NotebooksKernelExecuteStreamCreateInput>;

// Output Schema
export type NotebooksKernelExecuteStreamCreateOutput = void;
export const NotebooksKernelExecuteStreamCreateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Void as unknown as Schema.Codec<NotebooksKernelExecuteStreamCreateOutput>;
