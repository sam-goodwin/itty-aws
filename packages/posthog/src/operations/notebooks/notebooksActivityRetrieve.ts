...
// Input Schema
export const NotebooksActivityRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const NotebooksActivityRetrieveOutput = /*@__PURE__*/ Schema.Void;
 ...
 */
export const notebooksActivityRetrieve = /*@__PURE__*/ API.make(() => ({
