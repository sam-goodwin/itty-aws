...
// Input Schema
export interface PropertyDefinitionsPartialUpdateInput {
  id: string;
  project_id: string;
  name?: string;
...
export const PropertyDefinitionsPartialUpdateInput =
  ...
  ) as unknown as Schema.Codec<PropertyDefinitionsPartialUpdateInput>;

// Output Schema
export interface PropertyDefinitionsPartialUpdateOutput {
  id?: string;
  name?: string;
  description?: string | null;
  tags?: unknown[];
...
export const PropertyDefinitionsPartialUpdateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    hidden: Schema.optional(Schema.NullOr(Schema.Boolean)),
  }) as unknown as Schema.Codec<PropertyDefinitionsPartialUpdateOutput>;
