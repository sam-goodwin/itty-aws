...
export type CustomPropertyDefinitionsListInput =
  typeof CustomPropertyDefinitionsListInput.Type;
...
export type CustomPropertyDefinitionsListOutput =
  typeof CustomPropertyDefinitionsListOutput.Type;
