...
// Input Schema
export const PersistedFolderUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const PersistedFolderUpdateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const persistedFolderUpdate = /*@__PURE__*/ API.make(() => ({
