...
// Input Schema
export const PersistedFolderRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const PersistedFolderRetrieveOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  type: Schema.optional(Schema.Literals(["home", "pinned", "custom_products"])),
 ...
 */
export const persistedFolderRetrieve = /*@__PURE__*/ API.make(() => ({
