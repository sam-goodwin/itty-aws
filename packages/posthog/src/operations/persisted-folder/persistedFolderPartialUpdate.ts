...
// Input Schema
export const PersistedFolderPartialUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const PersistedFolderPartialUpdateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const persistedFolderPartialUpdate = /*@__PURE__*/ API.make(() => ({
