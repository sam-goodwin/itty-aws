...
// Input Schema
export const PersistedFolderCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const PersistedFolderCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  type: Schema.optional(Schema.Literals(["home", "pinned", "custom_products"])),
  protocol: Schema.optional(Schema.String),
  path: Schema.optional(Schema.String),
 ...
 */
export const persistedFolderCreate = /*@__PURE__*/ API.make(() => ({
