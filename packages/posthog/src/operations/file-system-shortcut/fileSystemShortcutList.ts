...
// Input Schema
export const FileSystemShortcutListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const FileSystemShortcutListOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const fileSystemShortcutList = /*@__PURE__*/ API.make(() => ({
