...
// Input Schema
export const FileSystemShortcutRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const FileSystemShortcutRetrieveOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const fileSystemShortcutRetrieve = /*@__PURE__*/ API.make(() => ({
