...
// Input Schema
export const FileSystemShortcutUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const FileSystemShortcutUpdateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const fileSystemShortcutUpdate = /*@__PURE__*/ API.make(() => ({
