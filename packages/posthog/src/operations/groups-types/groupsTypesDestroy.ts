...
// Input Schema
export const GroupsTypesDestroyInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const GroupsTypesDestroyOutput = /*@__PURE__*/ Schema.Void;
 ...
 */
export const groupsTypesDestroy = /*@__PURE__*/ API.make(() => ({
