...
// Input Schema
export interface ExperimentsPauseCreateInput {
  id: number;
  project_id: string;
}
export const ExperimentsPauseCreateInput =
  ...
  ) as unknown as Schema.Codec<ExperimentsPauseCreateInput>;

// Output Schema
export interface ExperimentsPauseCreateOutput {
  id?: number;
  name?: string;
...
export const ExperimentsPauseCreateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    user_access_level: Schema.optional(Schema.NullOr(Schema.String)),
  }) as unknown as Schema.Codec<ExperimentsPauseCreateOutput>;
 ...
 */
export const experimentsPauseCreate = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: ExperimentsPauseCreateInput,
    outputSchema: ExperimentsPauseCreateOutput,
