    ...
    Schema.NullOr(
      Schema.Struct({
        exposure_estimate_config: Schema.optional(
          Schema.NullOr(
            Schema.Struct({
              conversionRateInputType: Schema.Literals(["manual", "automatic"]),
              manualBaselineValue: Schema.optional(
                Schema.NullOr(Schema.Number),
              ),
              manualExposureRate: Schema.optional(Schema.NullOr(Schema.Number)),
              manualMetricType: Schema.optional(
                Schema.NullOr(
                  Schema.Literals(["funnel", "mean_count", "mean_sum_or_avg"]),
                ),
              ),
            }),
          ),
        ...
        recommended_running_time: Schema.optional(Schema.NullOr(Schema.Number)),
        recommended_sample_size: Schema.optional(Schema.NullOr(Schema.Number)),
      }),
    ),
  ),
