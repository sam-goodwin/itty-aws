...
// Input Schema
export interface ExperimentsCreateFromPromptCreateInput {
  project_id: string;
  prompt_name: string;
  versions: number[];
...
export const ExperimentsCreateFromPromptCreateInput =
  /*@__PURE__*/ Schema.Struct({
    project_id: Schema.String.pipe(T.PathParam()),
    prompt_name: Schema.String,
    versions: Schema.Array(Schema.Number),
    templates: Schema.Array(
      Schema.Literals(["cost", "latency", "eval_pass_rate"]),
    ),
    ...
    T.Http({
      method: "POST",
      path: "/api/projects/{project_id}/experiments/create_from_prompt/",
    }),
  ) as unknown as Schema.Codec<ExperimentsCreateFromPromptCreateInput>;

// Output Schema
export interface ExperimentsCreateFromPromptCreateOutput {
  id?: number;
  name?: string;
...
export const ExperimentsCreateFromPromptCreateOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    user_access_level: Schema.optional(Schema.NullOr(Schema.String)),
  }) as unknown as Schema.Codec<ExperimentsCreateFromPromptCreateOutput>;
 ...
 */
export const experimentsCreateFromPromptCreate =
  /*@__PURE__*/ API.make(() => ({
    inputSchema: ExperimentsCreateFromPromptCreateInput,
    outputSchema: ExperimentsCreateFromPromptCreateOutput,
  }));
