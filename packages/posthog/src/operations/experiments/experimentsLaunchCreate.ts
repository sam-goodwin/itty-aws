...
// Input Schema
export interface ExperimentsLaunchCreateInput {
  id: number;
  project_id: string;
}
export const ExperimentsLaunchCreateInput =
  ...
  ) as unknown as Schema.Codec<ExperimentsLaunchCreateInput>;

// Output Schema
export interface ExperimentsLaunchCreateOutput {
  id?: number;
  name?: string;
...
export const ExperimentsLaunchCreateOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    user_access_level: Schema.optional(Schema.NullOr(Schema.String)),
  }) as unknown as Schema.Codec<ExperimentsLaunchCreateOutput>;
 ...
 */
export const experimentsLaunchCreate = /*@__PURE__*/ API.make(() => ({
