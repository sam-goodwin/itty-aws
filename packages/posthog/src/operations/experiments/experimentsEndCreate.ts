...
// Input Schema
export const ExperimentsEndCreateInput = /*@__PURE__*/ Schema.Struct({
...
export type ExperimentsEndCreateInput = typeof ExperimentsEndCreateInput.Type;

// Output Schema
export const ExperimentsEndCreateOutput = /*@__PURE__*/ Schema.Struct({
...
export type ExperimentsEndCreateOutput = typeof ExperimentsEndCreateOutput.Type;
