...
// Input Schema
export interface ExperimentsEndCreateInput {
  id: number;
  project_id: string;
  conclusion?:
    | "won"
...
export const ExperimentsEndCreateInput =
  ...
  ) as unknown as Schema.Codec<ExperimentsEndCreateInput>;

// Output Schema
export interface ExperimentsEndCreateOutput {
  id?: number;
  name?: string;
...
export const ExperimentsEndCreateOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    user_access_level: Schema.optional(Schema.NullOr(Schema.String)),
  }) as unknown as Schema.Codec<ExperimentsEndCreateOutput>;
