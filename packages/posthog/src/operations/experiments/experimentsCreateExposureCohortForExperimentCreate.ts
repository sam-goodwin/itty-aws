...
// Input Schema
export interface ExperimentsCreateExposureCohortForExperimentCreateInput {
  id: number;
  project_id: string;
  name?: string;
...
export const ExperimentsCreateExposureCohortForExperimentCreateInput =
  ...
  ) as unknown as Schema.Codec<ExperimentsCreateExposureCohortForExperimentCreateInput>;

// Output Schema
export type ExperimentsCreateExposureCohortForExperimentCreateOutput = void;
export const ExperimentsCreateExposureCohortForExperimentCreateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Void as unknown as Schema.Codec<ExperimentsCreateExposureCohortForExperimentCreateOutput>;
