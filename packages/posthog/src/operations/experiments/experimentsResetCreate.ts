...
// Input Schema
export interface ExperimentsResetCreateInput {
  id: number;
  project_id: string;
}
export const ExperimentsResetCreateInput =
  ...
  ) as unknown as Schema.Codec<ExperimentsResetCreateInput>;

// Output Schema
export interface ExperimentsResetCreateOutput {
  id?: number;
  name?: string;
...
export const ExperimentsResetCreateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    user_access_level: Schema.optional(Schema.NullOr(Schema.String)),
  }) as unknown as Schema.Codec<ExperimentsResetCreateOutput>;
