...
// Input Schema
export interface ExperimentsShipVariantCreateInput {
  id: number;
  project_id: string;
  conclusion?:
    | "won"
...
export const ExperimentsShipVariantCreateInput =
  ...
  ) as unknown as Schema.Codec<ExperimentsShipVariantCreateInput>;

// Output Schema
export interface ExperimentsShipVariantCreateOutput {
  id?: number;
  name?: string;
...
export const ExperimentsShipVariantCreateOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    user_access_level: Schema.optional(Schema.NullOr(Schema.String)),
  }) as unknown as Schema.Codec<ExperimentsShipVariantCreateOutput>;
