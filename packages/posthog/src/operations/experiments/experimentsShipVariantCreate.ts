...
// Input Schema
export const ExperimentsShipVariantCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ExperimentsShipVariantCreateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const experimentsShipVariantCreate = /*@__PURE__*/ API.make(() => ({
