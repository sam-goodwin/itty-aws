...
// Input Schema
export interface ExperimentsUnarchiveCreateInput {
  id: number;
  project_id: string;
}
export const ExperimentsUnarchiveCreateInput =
  ...
  ) as unknown as Schema.Codec<ExperimentsUnarchiveCreateInput>;

// Output Schema
export interface ExperimentsUnarchiveCreateOutput {
  id?: number;
  name?: string;
...
export const ExperimentsUnarchiveCreateOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    user_access_level: Schema.optional(Schema.NullOr(Schema.String)),
  }) as unknown as Schema.Codec<ExperimentsUnarchiveCreateOutput>;
 ...
 */
export const experimentsUnarchiveCreate = /*@__PURE__*/ API.make(() => ({
