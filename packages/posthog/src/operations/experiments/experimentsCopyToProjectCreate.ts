...
// Input Schema
export interface ExperimentsCopyToProjectCreateInput {
  id: number;
  project_id: string;
...
export const ExperimentsCopyToProjectCreateInput =
  ...
  ) as unknown as Schema.Codec<ExperimentsCopyToProjectCreateInput>;

// Output Schema
export interface ExperimentsCopyToProjectCreateOutput {
  id?: number;
  name?: string;
...
export const ExperimentsCopyToProjectCreateOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    user_access_level: Schema.optional(Schema.NullOr(Schema.String)),
  }) as unknown as Schema.Codec<ExperimentsCopyToProjectCreateOutput>;
