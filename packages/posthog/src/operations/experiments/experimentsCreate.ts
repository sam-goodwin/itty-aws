...
// Input Schema
export interface ExperimentsCreateInput {
  project_id: string;
  id?: number;
  name?: string;
...
) as unknown as Schema.Codec<ExperimentsCreateInput>;

// Output Schema
export interface ExperimentsCreateOutput {
  id?: number;
  name?: string;
  description?: string | null;
  start_date?: string | null;
...
export const ExperimentsCreateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    is_legacy: Schema.optional(Schema.Boolean),
    user_access_level: Schema.optional(Schema.NullOr(Schema.String)),
  }) as unknown as Schema.Codec<ExperimentsCreateOutput>;
