...
// Input Schema
export interface ExperimentsPartialUpdateInput {
  id: number;
  project_id: string;
  name?: string;
...
export const ExperimentsPartialUpdateInput =
  ...
  ) as unknown as Schema.Codec<ExperimentsPartialUpdateInput>;

// Output Schema
export interface ExperimentsPartialUpdateOutput {
  id?: number;
  name?: string;
  description?: string | null;
  start_date?: string | null;
...
export const ExperimentsPartialUpdateOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    is_legacy: Schema.optional(Schema.Boolean),
    user_access_level: Schema.optional(Schema.NullOr(Schema.String)),
  }) as unknown as Schema.Codec<ExperimentsPartialUpdateOutput>;
