...
// Input Schema
export interface ExperimentsResumeCreateInput {
  id: number;
  project_id: string;
}
export const ExperimentsResumeCreateInput =
  ...
  ) as unknown as Schema.Codec<ExperimentsResumeCreateInput>;

// Output Schema
export interface ExperimentsResumeCreateOutput {
  id?: number;
  name?: string;
...
export const ExperimentsResumeCreateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    user_access_level: Schema.optional(Schema.NullOr(Schema.String)),
  }) as unknown as Schema.Codec<ExperimentsResumeCreateOutput>;
 ...
 */
export const experimentsResumeCreate = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: ExperimentsResumeCreateInput,
    outputSchema: ExperimentsResumeCreateOutput,
