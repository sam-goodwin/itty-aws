...
// Input Schema
export interface ExperimentsArchiveCreateInput {
  id: number;
  project_id: string;
  disable_feature_flag?: boolean;
}
export const ExperimentsArchiveCreateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.Number.pipe(T.PathParam()),
    project_id: Schema.String.pipe(T.PathParam()),
    disable_feature_flag: Schema.optional(Schema.Boolean),
  }).pipe(
    T.Http({
      method: "POST",
      path: "/api/projects/{project_id}/experiments/{id}/archive/",
    }),
  ) as unknown as Schema.Codec<ExperimentsArchiveCreateInput>;

// Output Schema
export interface ExperimentsArchiveCreateOutput {
  id?: number;
  name?: string;
...
export const ExperimentsArchiveCreateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    user_access_level: Schema.optional(Schema.NullOr(Schema.String)),
  }) as unknown as Schema.Codec<ExperimentsArchiveCreateOutput>;
 ...
 */
export const experimentsArchiveCreate = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: ExperimentsArchiveCreateInput,
    outputSchema: ExperimentsArchiveCreateOutput,
