...
// Input Schema
export const FeatureFlagsCreateInput = /*@__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "POST", path: "/api/projects/{project_id}/feature_flags/" }),
);
export type FeatureFlagsCreateInput = typeof FeatureFlagsCreateInput.Type;

// Output Schema
export const FeatureFlagsCreateOutput = /*@__PURE__*/ Schema.Struct({
