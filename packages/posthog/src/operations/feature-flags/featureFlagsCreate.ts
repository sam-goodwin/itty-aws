...
// Input Schema
export interface FeatureFlagsCreateInput {
  project_id: string;
  key?: string;
  name?: string;
  filters?: {
...
export const FeatureFlagsCreateInput =
  ...
  ) as unknown as Schema.Codec<FeatureFlagsCreateInput>;

// Output Schema
export interface FeatureFlagsCreateOutput {
  id?: number;
  name?: string;
  key?: string;
...
export const FeatureFlagsCreateOutput =
  ...
  }) as unknown as Schema.Codec<FeatureFlagsCreateOutput>;
