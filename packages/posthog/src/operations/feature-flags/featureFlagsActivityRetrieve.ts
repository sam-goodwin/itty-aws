...
// Input Schema
export const FeatureFlagsActivityRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const FeatureFlagsActivityRetrieveOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const featureFlagsActivityRetrieve = /*@__PURE__*/ API.make(() => ({
