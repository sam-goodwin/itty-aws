...
// Input Schema
export const DesktopRecordingsUpdateInput = /*@__PURE__*/ Schema.Struct({
...
export type DesktopRecordingsUpdateInput =
  typeof DesktopRecordingsUpdateInput.Type;

// Output Schema
export const DesktopRecordingsUpdateOutput = /*@__PURE__*/ Schema.Struct({
...
export type DesktopRecordingsUpdateOutput =
  typeof DesktopRecordingsUpdateOutput.Type;
 ...
 */
export const desktopRecordingsUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: DesktopRecordingsUpdateInput,
  outputSchema: DesktopRecordingsUpdateOutput,
