...
// Input Schema
export const DesktopRecordingsListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const DesktopRecordingsListOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const desktopRecordingsList = /*@__PURE__*/ API.make(() => ({
