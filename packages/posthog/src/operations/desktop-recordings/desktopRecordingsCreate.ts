...
// Input Schema
export const DesktopRecordingsCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const DesktopRecordingsCreateOutput = /*@__PURE__*/ Schema.Struct({
  ...
  upload_token: Schema.optional(Schema.String),
});
 ...
 */
export const desktopRecordingsCreate = /*@__PURE__*/ API.make(() => ({
