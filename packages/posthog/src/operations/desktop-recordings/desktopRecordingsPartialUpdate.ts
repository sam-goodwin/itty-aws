...
// Input Schema
export const DesktopRecordingsPartialUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const DesktopRecordingsPartialUpdateOutput = /*@__PURE__*/ Schema.Struct(
  {
 ...
 */
export const desktopRecordingsPartialUpdate = /*@__PURE__*/ API.make(() => ({
