...
// Input Schema
export const DesktopRecordingsRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const DesktopRecordingsRetrieveOutput = /*@__PURE__*/ Schema.Struct({
  ...
  status: Schema.optional(
    Schema.Literals(["recording", "uploading", "processing", "ready", "error"]),
  ),
 ...
 */
export const desktopRecordingsRetrieve = /*@__PURE__*/ API.make(() => ({
