...
// Input Schema
export const ConversationsTicketsCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ConversationsTicketsCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  ticket_number: Schema.optional(Schema.Number),
  channel_source: Schema.optional(
    Schema.Literals(["widget", "email", "slack", "teams"]),
 ...
 */
export const conversationsTicketsCreate = /*@__PURE__*/ API.make(() => ({
