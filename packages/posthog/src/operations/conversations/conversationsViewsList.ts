...
// Input Schema
export const ConversationsViewsListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ConversationsViewsListOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const conversationsViewsList = /*@__PURE__*/ API.make(() => ({
