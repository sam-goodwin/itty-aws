...
// Input Schema
export const ConversationsViewsRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ConversationsViewsRetrieveOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const conversationsViewsRetrieve = /*@__PURE__*/ API.make(() => ({
