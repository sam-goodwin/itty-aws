...
// Input Schema
export const ConversationsTicketsUnreadCountRetrieveInput =
...
export type ConversationsTicketsUnreadCountRetrieveInput =
  typeof ConversationsTicketsUnreadCountRetrieveInput.Type;

// Output Schema
export const ConversationsTicketsUnreadCountRetrieveOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.String,
...
export type ConversationsTicketsUnreadCountRetrieveOutput =
  typeof ConversationsTicketsUnreadCountRetrieveOutput.Type;
 ...
 */
export const conversationsTicketsUnreadCountRetrieve =
  /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
    inputSchema: ConversationsTicketsUnreadCountRetrieveInput,
    outputSchema: ConversationsTicketsUnreadCountRetrieveOutput,
