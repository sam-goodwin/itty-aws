...
// Input Schema
export interface ConversationsTicketsRetrieveInput {
  id: string;
  project_id: string;
}
export const ConversationsTicketsRetrieveInput =
  ...
  ) as unknown as Schema.Codec<ConversationsTicketsRetrieveInput>;

// Output Schema
export interface ConversationsTicketsRetrieveOutput {
  id?: string;
...
export const ConversationsTicketsRetrieveOutput =
  ...
  }) as unknown as Schema.Codec<ConversationsTicketsRetrieveOutput>;
