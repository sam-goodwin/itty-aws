...
// Input Schema
export const ConversationsTicketsRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ConversationsTicketsRetrieveOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const conversationsTicketsRetrieve = /*@__PURE__*/ API.make(() => ({
