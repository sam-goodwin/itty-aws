...
// Input Schema
export interface ConversationsTicketsUpdateInput {
  id: string;
  project_id: string;
...
export const ConversationsTicketsUpdateInput =
  ...
  ) as unknown as Schema.Codec<ConversationsTicketsUpdateInput>;

// Output Schema
export interface ConversationsTicketsUpdateOutput {
  id?: string;
  ticket_number?: number;
  channel_source?: "widget" | "email" | "slack" | "teams" | "github";
  channel_detail?:
...
export const ConversationsTicketsUpdateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    tags: Schema.optional(Schema.Array(Schema.Unknown)),
  }) as unknown as Schema.Codec<ConversationsTicketsUpdateOutput>;
