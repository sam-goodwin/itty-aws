...
// Input Schema
export interface EvaluationsUpdateInput {
  id: string;
  project_id: string;
  name?: string;
  description?: string;
...
) as unknown as Schema.Codec<EvaluationsUpdateInput>;

// Output Schema
export interface EvaluationsUpdateOutput {
  id?: string;
  name?: string;
  description?: string;
  enabled?: boolean;
...
export const EvaluationsUpdateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    deleted: Schema.optional(Schema.Boolean),
  }) as unknown as Schema.Codec<EvaluationsUpdateOutput>;
