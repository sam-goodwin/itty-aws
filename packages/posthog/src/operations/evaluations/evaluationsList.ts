...
// Input Schema
export interface EvaluationsListInput {
  project_id: string;
  enabled?: boolean;
...
) as unknown as Schema.Codec<EvaluationsListInput>;

// Output Schema
export interface EvaluationsListOutput {
  count?: number;
  next?: string | null;
...
}) as unknown as Schema.Codec<EvaluationsListOutput>;
