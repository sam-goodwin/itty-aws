...
// Input Schema
export const LogsViewsPartialUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const LogsViewsPartialUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
 ...
 */
export const logsViewsPartialUpdate = /*@__PURE__*/ API.make(() => ({
