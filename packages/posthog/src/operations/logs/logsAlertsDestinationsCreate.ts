...
// Input Schema
export const LogsAlertsDestinationsCreateInput = /*@__PURE__*/ Schema.Struct({
  id: Schema.String.pipe(T.PathParam()),
  project_id: Schema.String.pipe(T.PathParam()),
  type: Schema.optional(Schema.Literals(["slack", "webhook"])),
...
// Output Schema
export const LogsAlertsDestinationsCreateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const logsAlertsDestinationsCreate = /*@__PURE__*/ API.make(() => ({
