...
// Input Schema
export interface LogsAlertsResetCreateInput {
  id: string;
  project_id: string;
}
export const LogsAlertsResetCreateInput =
  ...
  ) as unknown as Schema.Codec<LogsAlertsResetCreateInput>;

// Output Schema
export interface LogsAlertsResetCreateOutput {
  id?: string;
  name?: string;
  enabled?: boolean;
  filters?: {
...
export const LogsAlertsResetCreateOutput =
  ...
  }) as unknown as Schema.Codec<LogsAlertsResetCreateOutput>;
