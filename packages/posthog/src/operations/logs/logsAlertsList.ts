...
// Input Schema
export interface LogsAlertsListInput {
  project_id: string;
  limit?: number;
  offset?: number;
}
...
) as unknown as Schema.Codec<LogsAlertsListInput>;

// Output Schema
export interface LogsAlertsListOutput {
  count?: number;
  next?: string | null;
...
}) as unknown as Schema.Codec<LogsAlertsListOutput>;
