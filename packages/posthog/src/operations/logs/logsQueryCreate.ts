...
// Input Schema
export const LogsQueryCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const LogsQueryCreateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const logsQueryCreate = /*@__PURE__*/ API.make(() => ({
