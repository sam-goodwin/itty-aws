...
// Input Schema
export const LogsAlertsUpdateInput = /*@__PURE__*/ Schema.Struct({
...
export type LogsAlertsUpdateInput = typeof LogsAlertsUpdateInput.Type;

// Output Schema
export const LogsAlertsUpdateOutput = /*@__PURE__*/ Schema.Struct({
...
export type LogsAlertsUpdateOutput = typeof LogsAlertsUpdateOutput.Type;
 ...
 */
export const logsAlertsUpdate = /*@__PURE__*/ API.make(() => ({
