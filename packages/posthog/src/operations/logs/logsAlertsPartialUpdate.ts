...
// Input Schema
export interface LogsAlertsPartialUpdateInput {
  id: string;
  project_id: string;
  name?: string;
  enabled?: boolean;
...
export const LogsAlertsPartialUpdateInput =
  ...
  ) as unknown as Schema.Codec<LogsAlertsPartialUpdateInput>;

// Output Schema
export interface LogsAlertsPartialUpdateOutput {
  id?: string;
  name?: string;
  enabled?: boolean;
  filters?: {
...
export const LogsAlertsPartialUpdateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    updated_at: Schema.optional(Schema.NullOr(Schema.String)),
  }) as unknown as Schema.Codec<LogsAlertsPartialUpdateOutput>;
