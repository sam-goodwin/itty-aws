...
// Input Schema
export const LogsServicesCreateInput = /*@__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "POST", path: "/api/projects/{project_id}/logs/services/" }),
);
export type LogsServicesCreateInput = typeof LogsServicesCreateInput.Type;

// Output Schema
export const LogsServicesCreateOutput = /*@__PURE__*/ Schema.Struct({
