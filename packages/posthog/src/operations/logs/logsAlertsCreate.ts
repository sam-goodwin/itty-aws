...
export const LogsAlertsCreateInput = /*@__PURE__*/ Schema.Struct({
...
export const LogsAlertsCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  enabled: Schema.optional(Schema.Boolean),
  filters: Schema.optional(
 ...
 */
export const logsAlertsCreate = /*@__PURE__*/ API.make(() => ({
