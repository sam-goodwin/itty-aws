...
// Input Schema
export const LogsAlertsRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const LogsAlertsRetrieveOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const logsAlertsRetrieve = /*@__PURE__*/ API.make(() => ({
  inputSchema: LogsAlertsRetrieveInput,
  outputSchema: LogsAlertsRetrieveOutput,
