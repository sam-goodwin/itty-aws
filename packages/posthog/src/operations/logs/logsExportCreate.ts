...
// Input Schema
export const LogsExportCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const LogsExportCreateOutput = /*@__PURE__*/ Schema.Record(
  Schema.String,
  Schema.Unknown,
);
 ...
 */
export const logsExportCreate = /*@__PURE__*/ API.make(() => ({
