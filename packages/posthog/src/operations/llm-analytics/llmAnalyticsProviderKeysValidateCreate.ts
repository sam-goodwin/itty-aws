...
// Input Schema
export interface LlmAnalyticsProviderKeysValidateCreateInput {
  id: string;
  project_id: string;
  provider?:
    | "openai"
...
export const LlmAnalyticsProviderKeysValidateCreateInput =
  /*@__PURE__*/ Schema.Struct({
    ...
    T.Http({
      method: "POST",
      path: "/api/projects/{project_id}/llm_analytics/provider_keys/{id}/validate/",
    }),
  ) as unknown as Schema.Codec<LlmAnalyticsProviderKeysValidateCreateInput>;

// Output Schema
export interface LlmAnalyticsProviderKeysValidateCreateOutput {
  id?: string;
  provider?:
    | "openai"
    | "anthropic"
...
export const LlmAnalyticsProviderKeysValidateCreateOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    last_used_at: Schema.optional(Schema.NullOr(Schema.String)),
  }) as unknown as Schema.Codec<LlmAnalyticsProviderKeysValidateCreateOutput>;
