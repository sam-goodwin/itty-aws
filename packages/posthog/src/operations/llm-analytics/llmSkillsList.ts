...
// Input Schema
export const LlmSkillsListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const LlmSkillsListOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const llmSkillsList = /*@__PURE__*/ API.make(() => ({
