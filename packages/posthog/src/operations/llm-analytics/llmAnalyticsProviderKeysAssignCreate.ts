...
// Input Schema
export interface LlmAnalyticsProviderKeysAssignCreateInput {
  id: string;
  project_id: string;
  provider?:
    | "openai"
...
export const LlmAnalyticsProviderKeysAssignCreateInput =
  ...
  ) as unknown as Schema.Codec<LlmAnalyticsProviderKeysAssignCreateInput>;

// Output Schema
export interface LlmAnalyticsProviderKeysAssignCreateOutput {
  id?: string;
  provider?:
    | "openai"
    | "anthropic"
...
export const LlmAnalyticsProviderKeysAssignCreateOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    last_used_at: Schema.optional(Schema.NullOr(Schema.String)),
  }) as unknown as Schema.Codec<LlmAnalyticsProviderKeysAssignCreateOutput>;
