...
// Input Schema
export const LlmAnalyticsProviderKeysListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const LlmAnalyticsProviderKeysListOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const llmAnalyticsProviderKeysList = /*@__PURE__*/ API.make(() => ({
