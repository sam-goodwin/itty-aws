...
// Input Schema
export const LlmPromptsCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const LlmPromptsCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  prompt: Schema.optional(Schema.Unknown),
  version: Schema.optional(Schema.Number),
 ...
 */
export const llmPromptsCreate = /*@__PURE__*/ API.make(() => ({
