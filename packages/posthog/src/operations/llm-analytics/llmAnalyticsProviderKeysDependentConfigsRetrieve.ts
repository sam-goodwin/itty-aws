...
// Input Schema
export interface LlmAnalyticsProviderKeysDependentConfigsRetrieveInput {
  id: string;
  project_id: string;
}
export const LlmAnalyticsProviderKeysDependentConfigsRetrieveInput =
  ...
  ) as unknown as Schema.Codec<LlmAnalyticsProviderKeysDependentConfigsRetrieveInput>;

// Output Schema
export interface LlmAnalyticsProviderKeysDependentConfigsRetrieveOutput {
  id?: string;
  provider?:
    | "openai"
    | "anthropic"
...
export const LlmAnalyticsProviderKeysDependentConfigsRetrieveOutput =
  /*@__PURE__*/ Schema.Struct({
  ...
  }) as unknown as Schema.Codec<LlmAnalyticsProviderKeysDependentConfigsRetrieveOutput>;
 ...
 */
export const llmAnalyticsProviderKeysDependentConfigsRetrieve =
  /*@__PURE__*/ API.make(() => ({
