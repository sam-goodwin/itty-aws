...
// Input Schema
export interface LlmAnalyticsProviderKeysRetrieveInput {
  id: string;
  project_id: string;
}
export const LlmAnalyticsProviderKeysRetrieveInput =
  ...
  ) as unknown as Schema.Codec<LlmAnalyticsProviderKeysRetrieveInput>;

// Output Schema
export interface LlmAnalyticsProviderKeysRetrieveOutput {
  id?: string;
  provider?:
    | "openai"
    | "anthropic"
...
export const LlmAnalyticsProviderKeysRetrieveOutput =
  /*@__PURE__*/ Schema.Struct({
  ...
  }) as unknown as Schema.Codec<LlmAnalyticsProviderKeysRetrieveOutput>;
 ...
 */
export const llmAnalyticsProviderKeysRetrieve =
  /*@__PURE__*/ API.make(() => ({
    inputSchema: LlmAnalyticsProviderKeysRetrieveInput,
    outputSchema: LlmAnalyticsProviderKeysRetrieveOutput,
  }));
