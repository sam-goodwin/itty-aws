...
export type LlmAnalyticsProviderKeysRetrieveInput =
  typeof LlmAnalyticsProviderKeysRetrieveInput.Type;
...
export type LlmAnalyticsProviderKeysRetrieveOutput =
  typeof LlmAnalyticsProviderKeysRetrieveOutput.Type;
 ...
 */
export const llmAnalyticsProviderKeysRetrieve = /*@__PURE__*/ API.make(() => ({
