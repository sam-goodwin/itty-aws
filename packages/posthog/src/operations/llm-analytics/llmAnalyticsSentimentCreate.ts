...
// Input Schema
export const LlmAnalyticsSentimentCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const LlmAnalyticsSentimentCreateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const llmAnalyticsSentimentCreate = /*@__PURE__*/ API.make(() => ({
