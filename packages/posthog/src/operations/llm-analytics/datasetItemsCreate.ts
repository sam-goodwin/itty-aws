...
// Input Schema
export const DatasetItemsCreateInput = /*@__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "POST", path: "/api/projects/{project_id}/dataset_items/" }),
);
export type DatasetItemsCreateInput = typeof DatasetItemsCreateInput.Type;

// Output Schema
export const DatasetItemsCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  dataset: Schema.optional(Schema.String),
  input: Schema.optional(Schema.NullOr(Schema.Unknown)),
  output: Schema.optional(Schema.NullOr(Schema.Unknown)),
 ...
 */
export const datasetItemsCreate = /*@__PURE__*/ API.make(() => ({
