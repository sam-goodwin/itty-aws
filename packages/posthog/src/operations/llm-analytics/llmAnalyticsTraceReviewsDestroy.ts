...
// Input Schema
export const LlmAnalyticsTraceReviewsDestroyInput = /*@__PURE__*/ Schema.Struct(
  {
...
// Output Schema
export const LlmAnalyticsTraceReviewsDestroyOutput = /*@__PURE__*/ Schema.Void;
 ...
 */
export const llmAnalyticsTraceReviewsDestroy = /*@__PURE__*/ API.make(() => ({
