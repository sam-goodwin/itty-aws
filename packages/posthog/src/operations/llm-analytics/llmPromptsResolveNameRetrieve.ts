...
// Input Schema
export const LlmPromptsResolveNameRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const LlmPromptsResolveNameRetrieveOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const llmPromptsResolveNameRetrieve = /*@__PURE__*/ API.make(() => ({
