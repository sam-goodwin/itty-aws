...
// Input Schema
export const LlmAnalyticsReviewQueuesDestroyInput = /*@__PURE__*/ Schema.Struct(
  {
...
// Output Schema
export const LlmAnalyticsReviewQueuesDestroyOutput = /*@__PURE__*/ Schema.Void;
 ...
 */
export const llmAnalyticsReviewQueuesDestroy = /*@__PURE__*/ API.make(() => ({
