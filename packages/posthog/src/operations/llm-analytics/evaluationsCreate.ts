...
// Input Schema
export const EvaluationsCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const EvaluationsCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  description: Schema.optional(Schema.String),
  enabled: Schema.optional(Schema.Boolean),
...
export const evaluationsCreate = /*@__PURE__*/ API.make(() => ({
  inputSchema: EvaluationsCreateInput,
  outputSchema: EvaluationsCreateOutput,
