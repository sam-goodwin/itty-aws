...
// Input Schema
export const LlmSkillsNameDuplicateCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const LlmSkillsNameDuplicateCreateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const llmSkillsNameDuplicateCreate = /*@__PURE__*/ API.make(() => ({
