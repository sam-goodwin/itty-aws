...
// Input Schema
export const LlmPromptsNameDuplicateCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const LlmPromptsNameDuplicateCreateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const llmPromptsNameDuplicateCreate = /*@__PURE__*/ API.make(() => ({
