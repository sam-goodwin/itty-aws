...
// Input Schema
export const LlmSkillsResolveNameRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const LlmSkillsResolveNameRetrieveOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const llmSkillsResolveNameRetrieve = /*@__PURE__*/ API.make(() => ({
