...
// Input Schema
export interface LlmAnalyticsEvaluationConfigRetrieveInput {
  project_id: string;
}
export const LlmAnalyticsEvaluationConfigRetrieveInput =
  ...
  ) as unknown as Schema.Codec<LlmAnalyticsEvaluationConfigRetrieveInput>;

// Output Schema
export interface LlmAnalyticsEvaluationConfigRetrieveOutput {
...
export const LlmAnalyticsEvaluationConfigRetrieveOutput =
  ...
  }) as unknown as Schema.Codec<LlmAnalyticsEvaluationConfigRetrieveOutput>;
