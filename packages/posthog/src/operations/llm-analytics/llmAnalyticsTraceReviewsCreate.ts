...
// Input Schema
export interface LlmAnalyticsTraceReviewsCreateInput {
  project_id: string;
  trace_id?: string;
  comment?: string | null;
  scores?: {
...
export const LlmAnalyticsTraceReviewsCreateInput =
  ...
  ) as unknown as Schema.Codec<LlmAnalyticsTraceReviewsCreateInput>;

// Output Schema
export interface LlmAnalyticsTraceReviewsCreateOutput {
  id?: string;
  trace_id?: string;
  trace_url?: string;
  comment?: string | null;
...
export const LlmAnalyticsTraceReviewsCreateOutput =
  ...
  }) as unknown as Schema.Codec<LlmAnalyticsTraceReviewsCreateOutput>;
