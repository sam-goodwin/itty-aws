...
// Input Schema
export interface TasksRunsAppendLogCreateInput {
  id: string;
  project_id: string;
  task_id: string;
...
export const TasksRunsAppendLogCreateInput =
  ...
  ) as unknown as Schema.Codec<TasksRunsAppendLogCreateInput>;

// Output Schema
export interface TasksRunsAppendLogCreateOutput {
  id: string;
  task: string;
  stage: string | null;
  branch: string | null;
...
export const TasksRunsAppendLogCreateOutput =
  ...
  }) as unknown as Schema.Codec<TasksRunsAppendLogCreateOutput>;
