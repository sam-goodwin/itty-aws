...
// Input Schema
export interface TasksRunsSetOutputPartialUpdateInput {
  id: string;
  project_id: string;
  task_id: string;
  output?: unknown;
...
export const TasksRunsSetOutputPartialUpdateInput =
  ...
  ) as unknown as Schema.Codec<TasksRunsSetOutputPartialUpdateInput>;

// Output Schema
export interface TasksRunsSetOutputPartialUpdateOutput {
  id: string;
  task: string;
  stage: string | null;
  branch: string | null;
...
export const TasksRunsSetOutputPartialUpdateOutput =
  ...
  }) as unknown as Schema.Codec<TasksRunsSetOutputPartialUpdateOutput>;
