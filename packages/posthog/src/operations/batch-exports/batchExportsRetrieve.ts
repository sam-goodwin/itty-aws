...
// Input Schema
export interface BatchExportsRetrieveInput {
  id: string;
  project_id: string;
}
export const BatchExportsRetrieveInput =
  ...
  ) as unknown as Schema.Codec<BatchExportsRetrieveInput>;

// Output Schema
export interface BatchExportsRetrieveOutput {
  id?: string;
  team_id?: number;
  name?: string;
...
export const BatchExportsRetrieveOutput =
  ...
  }) as unknown as Schema.Codec<BatchExportsRetrieveOutput>;
 ...
 */
export const batchExportsRetrieve = /*@__PURE__*/ API.make(() => ({
