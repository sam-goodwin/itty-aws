...
// Input Schema
export interface BatchExportsUpdateInput {
  id: string;
  project_id: string;
  name: string;
...
export const BatchExportsUpdateInput =
  ...
  ) as unknown as Schema.Codec<BatchExportsUpdateInput>;

// Output Schema
export interface BatchExportsUpdateOutput {
  id?: string;
  team_id?: number;
  name?: string;
...
export const BatchExportsUpdateOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    offset_day: Schema.optional(Schema.NullOr(Schema.Number)),
    offset_hour: Schema.optional(Schema.NullOr(Schema.Number)),
  }) as unknown as Schema.Codec<BatchExportsUpdateOutput>;
 ...
 */
export const batchExportsUpdate = /*@__PURE__*/ API.make(() => ({
