...
// Input Schema
export interface BatchExportsCreateInput {
  project_id: string;
  name: string;
...
export const BatchExportsCreateInput =
  ...
  ) as unknown as Schema.Codec<BatchExportsCreateInput>;

// Output Schema
export interface BatchExportsCreateOutput {
  id?: string;
  team_id?: number;
  name?: string;
...
export const BatchExportsCreateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    offset_day: Schema.optional(Schema.NullOr(Schema.Number)),
    offset_hour: Schema.optional(Schema.NullOr(Schema.Number)),
  }) as unknown as Schema.Codec<BatchExportsCreateOutput>;
