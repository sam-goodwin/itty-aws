...
// Input Schema
export const BatchExportsCreateInput = /*@__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "POST", path: "/api/projects/{project_id}/batch_exports/" }),
);
export type BatchExportsCreateInput = typeof BatchExportsCreateInput.Type;

// Output Schema
export const BatchExportsCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  team_id: Schema.optional(Schema.Number),
  name: Schema.optional(Schema.String),
  model: Schema.optional(Schema.Unknown),
