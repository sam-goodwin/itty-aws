...
export const BatchExportsListInput = /*@__PURE__*/ Schema.Struct({
...
export const BatchExportsListOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const batchExportsList = /*@__PURE__*/ API.make(() => ({
