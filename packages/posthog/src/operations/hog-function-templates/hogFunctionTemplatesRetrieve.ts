...
// Input Schema
export const HogFunctionTemplatesRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const HogFunctionTemplatesRetrieveOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const hogFunctionTemplatesRetrieve = /*@__PURE__*/ API.make(() => ({
