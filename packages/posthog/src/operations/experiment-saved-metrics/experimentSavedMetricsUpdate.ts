...
// Input Schema
export const ExperimentSavedMetricsUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ExperimentSavedMetricsUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.Number),
  name: Schema.optional(Schema.String),
  description: Schema.optional(Schema.NullOr(Schema.String)),
  query: Schema.optional(Schema.Unknown),
 ...
 */
export const experimentSavedMetricsUpdate = /*@__PURE__*/ API.make(() => ({
