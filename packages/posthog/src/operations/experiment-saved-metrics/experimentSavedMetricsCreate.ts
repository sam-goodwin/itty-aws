...
// Input Schema
export const ExperimentSavedMetricsCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ExperimentSavedMetricsCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.Number),
  name: Schema.optional(Schema.String),
  description: Schema.optional(Schema.NullOr(Schema.String)),
  query: Schema.optional(Schema.Unknown),
 ...
 */
export const experimentSavedMetricsCreate = /*@__PURE__*/ API.make(() => ({
