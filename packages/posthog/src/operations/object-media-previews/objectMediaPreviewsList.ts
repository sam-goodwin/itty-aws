...
// Input Schema
export const ObjectMediaPreviewsListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ObjectMediaPreviewsListOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const objectMediaPreviewsList = /*@__PURE__*/ API.make(() => ({
