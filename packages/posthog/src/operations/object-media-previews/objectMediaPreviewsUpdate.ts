...
// Input Schema
export const ObjectMediaPreviewsUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ObjectMediaPreviewsUpdateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const objectMediaPreviewsUpdate = /*@__PURE__*/ API.make(() => ({
