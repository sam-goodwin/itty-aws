...
// Input Schema
export interface AgentApplicationsRevisionsSetEnvCreateInput {
...
export const AgentApplicationsRevisionsSetEnvCreateInput =
  ...
  ) as unknown as Schema.Codec<AgentApplicationsRevisionsSetEnvCreateInput>;

// Output Schema
export interface AgentApplicationsRevisionsSetEnvCreateOutput {
  id: string;
  application: string;
...
export const AgentApplicationsRevisionsSetEnvCreateOutput =
  ...
  }) as unknown as Schema.Codec<AgentApplicationsRevisionsSetEnvCreateOutput>;
