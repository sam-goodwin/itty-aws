...
// Input Schema
export interface AgentApplicationsRevisionsCloneFromCreateInput {
  application_id: string;
  id: string;
  project_id: string;
  source_revision_id: string;
}
export const AgentApplicationsRevisionsCloneFromCreateInput =
  /*@__PURE__*/ Schema.Struct({
    ...
    T.Http({
      method: "POST",
      path: "/api/projects/{project_id}/agent_applications/{application_id}/revisions/{id}/clone_from/",
    }),
  ) as unknown as Schema.Codec<AgentApplicationsRevisionsCloneFromCreateInput>;

// Output Schema
export interface AgentApplicationsRevisionsCloneFromCreateOutput {
  id: string;
  application: string;
...
export const AgentApplicationsRevisionsCloneFromCreateOutput =
  /*@__PURE__*/ Schema.Struct({
    id: Schema.String,
  ...
  }) as unknown as Schema.Codec<AgentApplicationsRevisionsCloneFromCreateOutput>;
 ...
 */
export const agentApplicationsRevisionsCloneFromCreate =
  /*@__PURE__*/ API.make(() => ({
    inputSchema: AgentApplicationsRevisionsCloneFromCreateInput,
    outputSchema: AgentApplicationsRevisionsCloneFromCreateOutput,
  }));
