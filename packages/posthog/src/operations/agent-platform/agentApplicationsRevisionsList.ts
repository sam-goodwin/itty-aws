...
export type AgentApplicationsRevisionsListInput =
  typeof AgentApplicationsRevisionsListInput.Type;
...
export type AgentApplicationsRevisionsListOutput =
  typeof AgentApplicationsRevisionsListOutput.Type;
