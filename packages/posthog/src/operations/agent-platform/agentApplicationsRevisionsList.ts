...
// Input Schema
export interface AgentApplicationsRevisionsListInput {
...
export const AgentApplicationsRevisionsListInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({
      method: "GET",
      path: "/api/projects/{project_id}/agent_applications/{application_id}/revisions/",
    }),
  ) as unknown as Schema.Codec<AgentApplicationsRevisionsListInput>;

// Output Schema
export interface AgentApplicationsRevisionsListOutput {
  count: number;
  next?: string | null;
...
export const AgentApplicationsRevisionsListOutput =
  ...
  }) as unknown as Schema.Codec<AgentApplicationsRevisionsListOutput>;
