...
// Input Schema
export interface AgentApplicationsRevisionsBundleRetrieveInput {
  application_id: string;
  id: string;
  project_id: string;
}
export const AgentApplicationsRevisionsBundleRetrieveInput =
  /*@__PURE__*/ Schema.Struct({
    ...
    T.Http({
      method: "GET",
      path: "/api/projects/{project_id}/agent_applications/{application_id}/revisions/{id}/bundle/",
    }),
  ) as unknown as Schema.Codec<AgentApplicationsRevisionsBundleRetrieveInput>;

// Output Schema
export interface AgentApplicationsRevisionsBundleRetrieveOutput {
  id: string;
  application: string;
...
export const AgentApplicationsRevisionsBundleRetrieveOutput =
  /*@__PURE__*/ Schema.Struct({
    id: Schema.String,
  ...
  }) as unknown as Schema.Codec<AgentApplicationsRevisionsBundleRetrieveOutput>;
 ...
 */
export const agentApplicationsRevisionsBundleRetrieve =
  /*@__PURE__*/ API.make(() => ({
    inputSchema: AgentApplicationsRevisionsBundleRetrieveInput,
    outputSchema: AgentApplicationsRevisionsBundleRetrieveOutput,
  }));
