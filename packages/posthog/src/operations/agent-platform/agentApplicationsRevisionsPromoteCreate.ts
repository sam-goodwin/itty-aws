...
export type AgentApplicationsRevisionsPromoteCreateInput =
  typeof AgentApplicationsRevisionsPromoteCreateInput.Type;
...
export type AgentApplicationsRevisionsPromoteCreateOutput =
  typeof AgentApplicationsRevisionsPromoteCreateOutput.Type;
