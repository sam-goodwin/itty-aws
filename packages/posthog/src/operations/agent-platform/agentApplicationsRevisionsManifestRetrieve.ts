...
// Input Schema
export interface AgentApplicationsRevisionsManifestRetrieveInput {
  application_id: string;
  id: string;
  project_id: string;
}
export const AgentApplicationsRevisionsManifestRetrieveInput =
  /*@__PURE__*/ Schema.Struct({
    ...
    T.Http({
      method: "GET",
      path: "/api/projects/{project_id}/agent_applications/{application_id}/revisions/{id}/manifest/",
    }),
  ) as unknown as Schema.Codec<AgentApplicationsRevisionsManifestRetrieveInput>;

// Output Schema
export interface AgentApplicationsRevisionsManifestRetrieveOutput {
  id: string;
  application: string;
...
export const AgentApplicationsRevisionsManifestRetrieveOutput =
  /*@__PURE__*/ Schema.Struct({
    id: Schema.String,
  ...
  }) as unknown as Schema.Codec<AgentApplicationsRevisionsManifestRetrieveOutput>;
 ...
 */
export const agentApplicationsRevisionsManifestRetrieve =
  /*@__PURE__*/ API.make(() => ({
    inputSchema: AgentApplicationsRevisionsManifestRetrieveInput,
    outputSchema: AgentApplicationsRevisionsManifestRetrieveOutput,
  }));
