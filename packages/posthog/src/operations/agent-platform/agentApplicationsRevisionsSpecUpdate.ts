...
// Input Schema
export interface AgentApplicationsRevisionsSpecUpdateInput {
...
export const AgentApplicationsRevisionsSpecUpdateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({
      method: "PUT",
      path: "/api/projects/{project_id}/agent_applications/{application_id}/revisions/{id}/spec/",
    }),
  ) as unknown as Schema.Codec<AgentApplicationsRevisionsSpecUpdateInput>;

// Output Schema
export interface AgentApplicationsRevisionsSpecUpdateOutput {
  id: string;
  application: string;
...
export const AgentApplicationsRevisionsSpecUpdateOutput =
  ...
  }) as unknown as Schema.Codec<AgentApplicationsRevisionsSpecUpdateOutput>;
