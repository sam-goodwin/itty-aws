...
// Input Schema
export interface AgentApplicationsRevisionsToolsUpdateInput {
...
export const AgentApplicationsRevisionsToolsUpdateInput =
  ...
  ) as unknown as Schema.Codec<AgentApplicationsRevisionsToolsUpdateInput>;

// Output Schema
export interface AgentApplicationsRevisionsToolsUpdateOutput {
  id: string;
  application: string;
...
export const AgentApplicationsRevisionsToolsUpdateOutput =
  ...
  }) as unknown as Schema.Codec<AgentApplicationsRevisionsToolsUpdateOutput>;
