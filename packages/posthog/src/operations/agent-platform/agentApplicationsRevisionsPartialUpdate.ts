...
// Input Schema
export interface AgentApplicationsRevisionsPartialUpdateInput {
...
export const AgentApplicationsRevisionsPartialUpdateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    state: Schema.optional(
      Schema.Literals(["draft", "ready", "live", "archived"]),
    ),
    bundle_uri: Schema.optional(Schema.String),
    bundle_sha256: Schema.optional(Schema.NullOr(Schema.String)),
  ...
  ) as unknown as Schema.Codec<AgentApplicationsRevisionsPartialUpdateInput>;

// Output Schema
export interface AgentApplicationsRevisionsPartialUpdateOutput {
  id: string;
  application: string;
  parent_revision?: string | null;
  state: "draft" | "ready" | "live" | "archived";
...
export const AgentApplicationsRevisionsPartialUpdateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.String,
  ...
  }) as unknown as Schema.Codec<AgentApplicationsRevisionsPartialUpdateOutput>;
 ...
 */
export const agentApplicationsRevisionsPartialUpdate =
  /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
    inputSchema: AgentApplicationsRevisionsPartialUpdateInput,
    outputSchema: AgentApplicationsRevisionsPartialUpdateOutput,
  }));
