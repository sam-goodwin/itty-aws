...
// Input Schema
export interface AgentApplicationsRevisionsRetrieveInput {
...
export const AgentApplicationsRevisionsRetrieveInput =
  ...
  ) as unknown as Schema.Codec<AgentApplicationsRevisionsRetrieveInput>;

// Output Schema
export interface AgentApplicationsRevisionsRetrieveOutput {
  id: string;
  application: string;
...
export const AgentApplicationsRevisionsRetrieveOutput =
  ...
  }) as unknown as Schema.Codec<AgentApplicationsRevisionsRetrieveOutput>;
