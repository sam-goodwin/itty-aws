...
export type AgentApplicationsRevisionsRetrieveInput =
  typeof AgentApplicationsRevisionsRetrieveInput.Type;
...
export type AgentApplicationsRevisionsRetrieveOutput =
  typeof AgentApplicationsRevisionsRetrieveOutput.Type;
