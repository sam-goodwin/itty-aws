...
// Input Schema
export interface AgentApplicationsRevisionsUpdateInput {
...
export const AgentApplicationsRevisionsUpdateInput =
  ...
  ) as unknown as Schema.Codec<AgentApplicationsRevisionsUpdateInput>;

// Output Schema
export interface AgentApplicationsRevisionsUpdateOutput {
  id: string;
  application: string;
  parent_revision?: string | null;
  state: "draft" | "ready" | "live" | "archived";
...
export const AgentApplicationsRevisionsUpdateOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    created_at: Schema.String,
    updated_at: Schema.String,
  }) as unknown as Schema.Codec<AgentApplicationsRevisionsUpdateOutput>;
