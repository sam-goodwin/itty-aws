...
// Input Schema
export interface AgentApplicationsRevisionsNewDraftCreateInput {
...
export const AgentApplicationsRevisionsNewDraftCreateInput =
  /*@__PURE__*/ Schema.Struct({
    ...
    T.Http({
      method: "POST",
      path: "/api/projects/{project_id}/agent_applications/{application_id}/revisions/new_draft/",
    }),
  ) as unknown as Schema.Codec<AgentApplicationsRevisionsNewDraftCreateInput>;

// Output Schema
export interface AgentApplicationsRevisionsNewDraftCreateOutput {
  id: string;
  application: string;
...
export const AgentApplicationsRevisionsNewDraftCreateOutput =
  ...
  }) as unknown as Schema.Codec<AgentApplicationsRevisionsNewDraftCreateOutput>;
