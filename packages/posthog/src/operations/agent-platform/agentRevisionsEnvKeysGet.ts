...
export type AgentRevisionsEnvKeysGetInput =
  typeof AgentRevisionsEnvKeysGetInput.Type;
...
export type AgentRevisionsEnvKeysGetOutput =
  typeof AgentRevisionsEnvKeysGetOutput.Type;
