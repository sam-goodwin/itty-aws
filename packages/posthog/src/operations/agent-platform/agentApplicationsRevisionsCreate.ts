...
// Input Schema
export interface AgentApplicationsRevisionsCreateInput {
...
export const AgentApplicationsRevisionsCreateInput =
  ...
  ) as unknown as Schema.Codec<AgentApplicationsRevisionsCreateInput>;

// Output Schema
export interface AgentApplicationsRevisionsCreateOutput {
  id: string;
  application: string;
  parent_revision?: string | null;
  state: "draft" | "ready" | "live" | "archived";
...
export const AgentApplicationsRevisionsCreateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.String,
    application: Schema.String,
    parent_revision: Schema.optional(Schema.NullOr(Schema.String)),
    ...
    created_at: Schema.String,
    updated_at: Schema.String,
  }) as unknown as Schema.Codec<AgentApplicationsRevisionsCreateOutput>;
 ...
 */
export const agentApplicationsRevisionsCreate =
  /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
    inputSchema: AgentApplicationsRevisionsCreateInput,
    outputSchema: AgentApplicationsRevisionsCreateOutput,
  }));
