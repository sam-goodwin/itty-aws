...
// Input Schema
export interface AgentApplicationsRevisionsSkillRefsUpdateInput {
...
export const AgentApplicationsRevisionsSkillRefsUpdateInput =
  ...
  ) as unknown as Schema.Codec<AgentApplicationsRevisionsSkillRefsUpdateInput>;

// Output Schema
export interface AgentApplicationsRevisionsSkillRefsUpdateOutput {
  id: string;
  application: string;
...
export const AgentApplicationsRevisionsSkillRefsUpdateOutput =
  ...
  }) as unknown as Schema.Codec<AgentApplicationsRevisionsSkillRefsUpdateOutput>;
