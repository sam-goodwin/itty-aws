...
export type AgentMemoryListTablesInput = typeof AgentMemoryListTablesInput.Type;
...
export type AgentMemoryListTablesOutput =
  typeof AgentMemoryListTablesOutput.Type;
