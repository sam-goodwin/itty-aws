...
// Input Schema
export const JsSnippetResolveRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const JsSnippetResolveRetrieveOutput = /*@__PURE__*/ Schema.Record(
  Schema.String,
  Schema.Unknown,
);
 ...
 */
export const jsSnippetResolveRetrieve = /*@__PURE__*/ API.make(() => ({
