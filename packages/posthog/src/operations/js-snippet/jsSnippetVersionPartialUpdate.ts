...
// Input Schema
export const JsSnippetVersionPartialUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const JsSnippetVersionPartialUpdateOutput = /*@__PURE__*/ Schema.Record(
  Schema.String,
  Schema.Unknown,
);
 ...
 */
export const jsSnippetVersionPartialUpdate = /*@__PURE__*/ API.make(() => ({
