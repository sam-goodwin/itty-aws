...
// Input Schema
export const JsSnippetVersionRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const JsSnippetVersionRetrieveOutput = /*@__PURE__*/ Schema.Record(
  Schema.String,
  Schema.Unknown,
);
 ...
 */
export const jsSnippetVersionRetrieve = /*@__PURE__*/ API.make(() => ({
