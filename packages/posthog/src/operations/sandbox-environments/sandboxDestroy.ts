...
export const SandboxDestroyInput = /*@__PURE__*/ Schema.Struct({
...
export const SandboxDestroyOutput =
  /*@__PURE__*/ Schema.Void as unknown as Schema.Codec<SandboxDestroyOutput>;
 ...
 */
export const sandboxDestroy = /*@__PURE__*/ API.make(() => ({
