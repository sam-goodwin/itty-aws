...
// Input Schema
export interface DataColorThemesUpdateInput {
  id: number;
  project_id: string;
  name?: string;
  colors?: unknown;
...
export const DataColorThemesUpdateInput =
  ...
  ) as unknown as Schema.Codec<DataColorThemesUpdateInput>;

// Output Schema
export interface DataColorThemesUpdateOutput {
  id?: number;
  name?: string;
  colors?: unknown;
  is_global?: boolean;
...
export const DataColorThemesUpdateOutput =
  ...
  }) as unknown as Schema.Codec<DataColorThemesUpdateOutput>;
