...
// Input Schema
export interface DataColorThemesPartialUpdateInput {
  id: number;
  project_id: string;
  name?: string;
  colors?: unknown;
...
export const DataColorThemesPartialUpdateInput =
  ...
  ) as unknown as Schema.Codec<DataColorThemesPartialUpdateInput>;

// Output Schema
export interface DataColorThemesPartialUpdateOutput {
  id?: number;
  name?: string;
  colors?: unknown;
  is_global?: boolean;
...
export const DataColorThemesPartialUpdateOutput =
  ...
  }) as unknown as Schema.Codec<DataColorThemesPartialUpdateOutput>;
