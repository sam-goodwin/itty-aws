...
// Input Schema
export interface WarehouseTablesListInput {
  project_id: string;
  limit?: number;
  offset?: number;
  search?: string;
...
export const WarehouseTablesListInput =
  ...
  ) as unknown as Schema.Codec<WarehouseTablesListInput>;

// Output Schema
export interface WarehouseTablesListOutput {
  count?: number;
  next?: string | null;
...
export const WarehouseTablesListOutput =
  ...
  }) as unknown as Schema.Codec<WarehouseTablesListOutput>;
 ...
 */
export const warehouseTablesList = /*@__PURE__*/ API.make(() => ({
