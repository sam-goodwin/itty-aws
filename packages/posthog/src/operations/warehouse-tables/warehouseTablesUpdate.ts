...
// Input Schema
export interface WarehouseTablesUpdateInput {
  id: string;
  project_id: string;
...
export const WarehouseTablesUpdateInput =
  ...
  ) as unknown as Schema.Codec<WarehouseTablesUpdateInput>;

// Output Schema
export interface WarehouseTablesUpdateOutput {
  id?: string;
  deleted?: boolean | null;
  name?: string;
  format?:
...
export const WarehouseTablesUpdateOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    options: Schema.optional(Schema.Record(Schema.String, Schema.Unknown)),
    user_access_level: Schema.optional(Schema.NullOr(Schema.String)),
  }) as unknown as Schema.Codec<WarehouseTablesUpdateOutput>;
