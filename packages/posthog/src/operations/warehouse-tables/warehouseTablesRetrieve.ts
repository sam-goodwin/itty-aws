...
// Input Schema
export interface WarehouseTablesRetrieveInput {
  id: string;
  project_id: string;
}
export const WarehouseTablesRetrieveInput =
  ...
  ) as unknown as Schema.Codec<WarehouseTablesRetrieveInput>;

// Output Schema
export interface WarehouseTablesRetrieveOutput {
  id?: string;
  ...
  credential?: {
    ...
    created_at?: string;
    access_key?: string;
    access_secret?: Redacted.Redacted<string>;
  };
...
export const WarehouseTablesRetrieveOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  }) as unknown as Schema.Codec<WarehouseTablesRetrieveOutput>;
 ...
 */
export const warehouseTablesRetrieve = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: WarehouseTablesRetrieveInput,
    outputSchema: WarehouseTablesRetrieveOutput,
