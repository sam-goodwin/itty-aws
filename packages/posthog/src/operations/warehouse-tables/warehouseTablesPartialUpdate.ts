...
// Input Schema
export interface WarehouseTablesPartialUpdateInput {
  id: string;
  project_id: string;
...
export const WarehouseTablesPartialUpdateInput =
  ...
  ) as unknown as Schema.Codec<WarehouseTablesPartialUpdateInput>;

// Output Schema
export interface WarehouseTablesPartialUpdateOutput {
  id?: string;
  deleted?: boolean | null;
  name?: string;
  format?:
...
export const WarehouseTablesPartialUpdateOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    options: Schema.optional(Schema.Record(Schema.String, Schema.Unknown)),
    user_access_level: Schema.optional(Schema.NullOr(Schema.String)),
  }) as unknown as Schema.Codec<WarehouseTablesPartialUpdateOutput>;
