...
// Input Schema
export const WarehouseTablesPartialUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const WarehouseTablesPartialUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  deleted: Schema.optional(Schema.NullOr(Schema.Boolean)),
  name: Schema.optional(Schema.String),
  format: Schema.optional(
 ...
 */
export const warehouseTablesPartialUpdate = /*@__PURE__*/ API.make(() => ({
