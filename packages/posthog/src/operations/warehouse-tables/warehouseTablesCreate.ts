...
// Input Schema
export interface WarehouseTablesCreateInput {
  project_id: string;
  id?: string;
...
export const WarehouseTablesCreateInput =
  ...
  ) as unknown as Schema.Codec<WarehouseTablesCreateInput>;

// Output Schema
export interface WarehouseTablesCreateOutput {
  id?: string;
  deleted?: boolean | null;
  name?: string;
  format?:
...
export const WarehouseTablesCreateOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    options: Schema.optional(Schema.Record(Schema.String, Schema.Unknown)),
    user_access_level: Schema.optional(Schema.NullOr(Schema.String)),
  }) as unknown as Schema.Codec<WarehouseTablesCreateOutput>;
 ...
 */
export const warehouseTablesCreate = /*@__PURE__*/ API.make(() => ({
