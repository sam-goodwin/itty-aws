...
// Input Schema
export const LiveDebuggerBreakpointsCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const LiveDebuggerBreakpointsCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  repository: Schema.optional(Schema.NullOr(Schema.String)),
  filename: Schema.optional(Schema.String),
  line_number: Schema.optional(Schema.Number),
 ...
 */
export const liveDebuggerBreakpointsCreate = /*@__PURE__*/ API.make(() => ({
