...
// Input Schema
export const SessionGroupSummariesListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const SessionGroupSummariesListOutput = /*@__PURE__*/ Schema.Struct({
  ...
  results: Schema.optional(
    Schema.Array(
      Schema.Struct({
        ...
        session_count: Schema.optional(Schema.Number),
 ...
 */
export const sessionGroupSummariesList = /*@__PURE__*/ API.make(() => ({
