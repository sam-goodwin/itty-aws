...
// Input Schema
export const SessionGroupSummariesRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
export type SessionGroupSummariesRetrieveInput =
  typeof SessionGroupSummariesRetrieveInput.Type;

// Output Schema
export const SessionGroupSummariesRetrieveOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const sessionGroupSummariesRetrieve = /*@__PURE__*/ API.make(() => ({
