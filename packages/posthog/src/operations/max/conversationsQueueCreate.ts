...
// Input Schema
export interface ConversationsQueueCreateInput {
  conversation: string;
  project_id: string;
  id?: string;
...
export const ConversationsQueueCreateInput =
  ...
  ) as unknown as Schema.Codec<ConversationsQueueCreateInput>;

// Output Schema
export interface ConversationsQueueCreateOutput {
  id?: string;
  status?: "idle" | "in_progress" | "canceling";
  title?: string | null;
  topic?:
...
export const ConversationsQueueCreateOutput =
  ...
  }) as unknown as Schema.Codec<ConversationsQueueCreateOutput>;
 ...
 */
export const conversationsQueueCreate = /*@__PURE__*/ API.make(() => ({
