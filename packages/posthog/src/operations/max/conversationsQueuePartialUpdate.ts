...
// Input Schema
export interface ConversationsQueuePartialUpdateInput {
  conversation: string;
  project_id: string;
  queue_id: string;
  id?: string;
...
export const ConversationsQueuePartialUpdateInput =
  ...
  ) as unknown as Schema.Codec<ConversationsQueuePartialUpdateInput>;

// Output Schema
export interface ConversationsQueuePartialUpdateOutput {
  id?: string;
  status?: "idle" | "in_progress" | "canceling";
  title?: string | null;
  topic?:
...
export const ConversationsQueuePartialUpdateOutput =
  ...
  }) as unknown as Schema.Codec<ConversationsQueuePartialUpdateOutput>;
