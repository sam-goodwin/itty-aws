...
// Input Schema
export interface ConversationsQueueClearCreateInput {
  conversation: string;
  project_id: string;
  id?: string;
...
export const ConversationsQueueClearCreateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({
      method: "POST",
      path: "/api/projects/{project_id}/conversations/{conversation}/queue/clear/",
    }),
  ) as unknown as Schema.Codec<ConversationsQueueClearCreateInput>;

// Output Schema
export interface ConversationsQueueClearCreateOutput {
  id?: string;
  status?: "idle" | "in_progress" | "canceling";
  title?: string | null;
  topic?:
...
export const ConversationsQueueClearCreateOutput =
  ...
  }) as unknown as Schema.Codec<ConversationsQueueClearCreateOutput>;
