...
// Input Schema
export const ConversationsQueueClearCreateInput = /*@__PURE__*/ Schema.Struct({
...
export type ConversationsQueueClearCreateInput =
  typeof ConversationsQueueClearCreateInput.Type;

// Output Schema
export const ConversationsQueueClearCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  status: Schema.optional(
    Schema.Literals(["idle", "in_progress", "canceling"]),
  ),
...
export type ConversationsQueueClearCreateOutput =
  typeof ConversationsQueueClearCreateOutput.Type;
 ...
 */
export const conversationsQueueClearCreate = /*@__PURE__*/ API.make(() => ({
