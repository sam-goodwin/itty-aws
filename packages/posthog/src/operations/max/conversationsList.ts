...
// Input Schema
export const ConversationsListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ConversationsListOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const conversationsList = /*@__PURE__*/ API.make(() => ({
