...
// Input Schema
export interface ConversationsQueueRetrieveInput {
  conversation: string;
  project_id: string;
}
export const ConversationsQueueRetrieveInput =
  ...
  ) as unknown as Schema.Codec<ConversationsQueueRetrieveInput>;

// Output Schema
export interface ConversationsQueueRetrieveOutput {
  id?: string;
...
export const ConversationsQueueRetrieveOutput =
  ...
  }) as unknown as Schema.Codec<ConversationsQueueRetrieveOutput>;
 ...
 */
export const conversationsQueueRetrieve = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
