...
// Input Schema
export const HogFunctionsMetricsRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
export type HogFunctionsMetricsRetrieveInput =
  typeof HogFunctionsMetricsRetrieveInput.Type;

// Output Schema
export const HogFunctionsMetricsRetrieveOutput = /*@__PURE__*/ Schema.Struct({
...
export type HogFunctionsMetricsRetrieveOutput =
  typeof HogFunctionsMetricsRetrieveOutput.Type;
 ...
 */
export const hogFunctionsMetricsRetrieve = /*@__PURE__*/ API.make(() => ({
