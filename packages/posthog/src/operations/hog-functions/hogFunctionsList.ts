...
// Input Schema
export const HogFunctionsListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const HogFunctionsListOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const hogFunctionsList = /*@__PURE__*/ API.make(() => ({
