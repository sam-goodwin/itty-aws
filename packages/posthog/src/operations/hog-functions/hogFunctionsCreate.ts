...
// Input Schema
export interface HogFunctionsCreateInput {
  project_id: string;
  id?: string;
  type?:
    | "destination"
...
export const HogFunctionsCreateInput =
  ...
  ) as unknown as Schema.Codec<HogFunctionsCreateInput>;

// Output Schema
export interface HogFunctionsCreateOutput {
  id?: string;
  type?:
    | "destination"
    | "site_destination"
...
export const HogFunctionsCreateOutput =
  ...
  }) as unknown as Schema.Codec<HogFunctionsCreateOutput>;
 ...
 */
export const hogFunctionsCreate = /*@__PURE__*/ API.make(() => ({
