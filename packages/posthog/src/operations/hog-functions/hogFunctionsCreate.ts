...
// Input Schema
export const HogFunctionsCreateInput = /*@__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "POST", path: "/api/projects/{project_id}/hog_functions/" }),
);
export type HogFunctionsCreateInput = typeof HogFunctionsCreateInput.Type;

// Output Schema
export const HogFunctionsCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  type: Schema.optional(Schema.Unknown),
  name: Schema.optional(Schema.NullOr(Schema.String)),
  description: Schema.optional(Schema.String),
