...
// Input Schema
export const HogFunctionsRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
export type HogFunctionsRetrieveInput = typeof HogFunctionsRetrieveInput.Type;

// Output Schema
export const HogFunctionsRetrieveOutput = /*@__PURE__*/ Schema.Struct({
...
export type HogFunctionsRetrieveOutput = typeof HogFunctionsRetrieveOutput.Type;
 ...
 */
export const hogFunctionsRetrieve = /*@__PURE__*/ API.make(() => ({
