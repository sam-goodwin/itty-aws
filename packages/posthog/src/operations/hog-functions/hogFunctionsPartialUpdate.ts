...
// Input Schema
export interface HogFunctionsPartialUpdateInput {
  id: string;
  project_id: string;
  type?:
    | "destination"
...
export const HogFunctionsPartialUpdateInput =
  ...
  ) as unknown as Schema.Codec<HogFunctionsPartialUpdateInput>;

// Output Schema
export interface HogFunctionsPartialUpdateOutput {
  id?: string;
  type?:
    | "destination"
    | "site_destination"
...
export const HogFunctionsPartialUpdateOutput =
  ...
  }) as unknown as Schema.Codec<HogFunctionsPartialUpdateOutput>;
 ...
 */
export const hogFunctionsPartialUpdate = /*@__PURE__*/ API.make(() => ({
