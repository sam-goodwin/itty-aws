...
// Input Schema
export const TaskAutomationsPartialUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const TaskAutomationsPartialUpdateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const taskAutomationsPartialUpdate = /*@__PURE__*/ API.make(() => ({
