...
// Input Schema
export const McpServerInstallationsCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const McpServerInstallationsCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  template_id: Schema.optional(Schema.NullOr(Schema.String)),
  name: Schema.optional(Schema.String),
  icon_key: Schema.optional(Schema.String),
 ...
 */
export const mcpServerInstallationsCreate = /*@__PURE__*/ API.make(() => ({
