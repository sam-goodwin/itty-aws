...
// Input Schema
export const McpServerInstallationsUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const McpServerInstallationsUpdateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const mcpServerInstallationsUpdate = /*@__PURE__*/ API.make(() => ({
