...
// Input Schema
export const UserHomeSettingsPartialUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const UserHomeSettingsPartialUpdateOutput = /*@__PURE__*/ Schema.Struct({
  tabs: Schema.optional(
    Schema.Array(
      Schema.Struct({
        id: Schema.optional(Schema.String),
...
// The operation
export const userHomeSettingsPartialUpdate = /*@__PURE__*/ API.make(() => ({
