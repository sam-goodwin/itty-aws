...
// Input Schema
export const ElementsRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ElementsRetrieveOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const elementsRetrieve = /*@__PURE__*/ API.make(() => ({
