...
// Input Schema
export const ElementsListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ElementsListOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const elementsList = /*@__PURE__*/ API.make(() => ({
