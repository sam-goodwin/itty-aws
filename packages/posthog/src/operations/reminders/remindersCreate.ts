...
}).pipe(T.Http({ method: "POST", path: "/api/reminders/" }));
export type RemindersCreateInput = typeof RemindersCreateInput.Type;
...
export type RemindersCreateOutput = typeof RemindersCreateOutput.Type;
