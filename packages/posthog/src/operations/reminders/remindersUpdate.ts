...
export const RemindersUpdateInput = /*@__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "PUT", path: "/api/reminders/{id}/" }),
) as unknown as Schema.Codec<RemindersUpdateInput>;

// Output Schema
export interface RemindersUpdateOutput {
  id: string;
  organization: string;
  team?: number | null;
  title: string;
...
export const RemindersUpdateOutput = /*@__PURE__*/ Schema.Struct({
  ...
  created_at: Schema.String,
  updated_at: Schema.NullOr(Schema.String),
}) as unknown as Schema.Codec<RemindersUpdateOutput>;
