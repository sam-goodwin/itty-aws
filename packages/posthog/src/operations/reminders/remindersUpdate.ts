...
}).pipe(T.Http({ method: "PUT", path: "/api/reminders/{id}/" }));
export type RemindersUpdateInput = typeof RemindersUpdateInput.Type;
...
export type RemindersUpdateOutput = typeof RemindersUpdateOutput.Type;
