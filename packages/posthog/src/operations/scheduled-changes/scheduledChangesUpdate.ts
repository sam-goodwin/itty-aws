...
// Input Schema
export interface ScheduledChangesUpdateInput {
  id: number;
  project_id: string;
  team_id: number;
  record_id: string;
...
export const ScheduledChangesUpdateInput =
  ...
  ) as unknown as Schema.Codec<ScheduledChangesUpdateInput>;

// Output Schema
export interface ScheduledChangesUpdateOutput {
  id: number;
  team_id: number;
  record_id: string;
  model_name: "FeatureFlag";
...
export const ScheduledChangesUpdateOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    end_date: Schema.optional(Schema.NullOr(Schema.String)),
    timezone: Schema.NullOr(Schema.String),
  }) as unknown as Schema.Codec<ScheduledChangesUpdateOutput>;
 ...
 */
export const scheduledChangesUpdate = /*@__PURE__*/ API.make(() => ({
