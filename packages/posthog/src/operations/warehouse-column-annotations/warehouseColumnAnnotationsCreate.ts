...
// Input Schema
export interface WarehouseColumnAnnotationsCreateInput {
  project_id: string;
  id: string;
  table: string;
  column_name?: string;
...
export const WarehouseColumnAnnotationsCreateInput =
  ...
  ) as unknown as Schema.Codec<WarehouseColumnAnnotationsCreateInput>;

// Output Schema
export interface WarehouseColumnAnnotationsCreateOutput {
  id: string;
  table: string;
  column_name?: string;
  description: string;
...
export const WarehouseColumnAnnotationsCreateOutput =
  /*@__PURE__*/ Schema.Struct({
    id: Schema.String,
    table: Schema.String,
    column_name: Schema.optional(Schema.String),
    ...
    created_at: Schema.String,
    updated_at: Schema.NullOr(Schema.String),
  }) as unknown as Schema.Codec<WarehouseColumnAnnotationsCreateOutput>;
 ...
 */
export const warehouseColumnAnnotationsCreate =
  /*@__PURE__*/ API.make(() => ({
    inputSchema: WarehouseColumnAnnotationsCreateInput,
    outputSchema: WarehouseColumnAnnotationsCreateOutput,
  }));
