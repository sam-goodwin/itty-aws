...
export type WarehouseColumnAnnotationsCreateInput =
  typeof WarehouseColumnAnnotationsCreateInput.Type;
...
export type WarehouseColumnAnnotationsCreateOutput =
  typeof WarehouseColumnAnnotationsCreateOutput.Type;
