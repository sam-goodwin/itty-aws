...
// Input Schema
export const ExperimentHoldoutsCreateInput = /*@__PURE__*/ Schema.Struct({
...
export type ExperimentHoldoutsCreateInput =
  typeof ExperimentHoldoutsCreateInput.Type;

// Output Schema
export const ExperimentHoldoutsCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.Number),
  name: Schema.optional(Schema.String),
  description: Schema.optional(Schema.NullOr(Schema.String)),
  filters: Schema.optional(Schema.Unknown),
