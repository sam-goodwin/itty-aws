...
// Input Schema
export interface ExperimentHoldoutsPartialUpdateInput {
  id: number;
  project_id: string;
  name?: string;
...
export const ExperimentHoldoutsPartialUpdateInput =
  ...
  ) as unknown as Schema.Codec<ExperimentHoldoutsPartialUpdateInput>;

// Output Schema
export interface ExperimentHoldoutsPartialUpdateOutput {
  id?: number;
  name?: string;
  description?: string | null;
  filters?: {
...
export const ExperimentHoldoutsPartialUpdateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    updated_at: Schema.optional(Schema.String),
    user_access_level: Schema.optional(Schema.NullOr(Schema.String)),
  }) as unknown as Schema.Codec<ExperimentHoldoutsPartialUpdateOutput>;
