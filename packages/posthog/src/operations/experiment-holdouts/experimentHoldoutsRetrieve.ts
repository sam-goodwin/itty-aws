...
// Input Schema
export interface ExperimentHoldoutsRetrieveInput {
  id: number;
  project_id: string;
}
export const ExperimentHoldoutsRetrieveInput =
  ...
  ) as unknown as Schema.Codec<ExperimentHoldoutsRetrieveInput>;

// Output Schema
export interface ExperimentHoldoutsRetrieveOutput {
  id?: number;
  name?: string;
...
export const ExperimentHoldoutsRetrieveOutput =
  ...
  }) as unknown as Schema.Codec<ExperimentHoldoutsRetrieveOutput>;
 ...
 */
export const experimentHoldoutsRetrieve = /*@__PURE__*/ API.make(() => ({
