...
// Input Schema
export interface ExperimentHoldoutsListInput {
  project_id: string;
  limit?: number;
  offset?: number;
}
export const ExperimentHoldoutsListInput =
  ...
  ) as unknown as Schema.Codec<ExperimentHoldoutsListInput>;

// Output Schema
export interface ExperimentHoldoutsListOutput {
  count?: number;
  next?: string | null;
...
export const ExperimentHoldoutsListOutput =
  ...
  }) as unknown as Schema.Codec<ExperimentHoldoutsListOutput>;
 ...
 */
export const experimentHoldoutsList = /*@__PURE__*/ API.make(() => ({
