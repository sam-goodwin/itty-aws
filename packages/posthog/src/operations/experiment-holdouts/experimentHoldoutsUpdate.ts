...
// Input Schema
export interface ExperimentHoldoutsUpdateInput {
  id: number;
  project_id: string;
  name?: string;
...
export const ExperimentHoldoutsUpdateInput =
  ...
  ) as unknown as Schema.Codec<ExperimentHoldoutsUpdateInput>;

// Output Schema
export interface ExperimentHoldoutsUpdateOutput {
  id?: number;
  name?: string;
  description?: string | null;
  filters?: {
...
export const ExperimentHoldoutsUpdateOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    updated_at: Schema.optional(Schema.String),
    user_access_level: Schema.optional(Schema.NullOr(Schema.String)),
  }) as unknown as Schema.Codec<ExperimentHoldoutsUpdateOutput>;
 ...
 */
export const experimentHoldoutsUpdate = /*@__PURE__*/ API.make(() => ({
