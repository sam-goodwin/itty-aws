...
// Input Schema
export interface EarlyAccessFeatureRetrieveInput {
  id: string;
  project_id: string;
}
export const EarlyAccessFeatureRetrieveInput =
  ...
  ) as unknown as Schema.Codec<EarlyAccessFeatureRetrieveInput>;

// Output Schema
export interface EarlyAccessFeatureRetrieveOutput {
  id?: string;
  feature_flag?: {
    id?: number;
    team_id?: number;
...
export const EarlyAccessFeatureRetrieveOutput =
  ...
  }) as unknown as Schema.Codec<EarlyAccessFeatureRetrieveOutput>;
 ...
 */
export const earlyAccessFeatureRetrieve = /*@__PURE__*/ API.make(() => ({
