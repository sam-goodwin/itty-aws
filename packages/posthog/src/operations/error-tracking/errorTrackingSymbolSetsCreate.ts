...
// Input Schema
export const ErrorTrackingSymbolSetsCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ErrorTrackingSymbolSetsCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  ref: Schema.optional(Schema.String),
  team_id: Schema.optional(Schema.Number),
  created_at: Schema.optional(Schema.String),
 ...
 */
export const errorTrackingSymbolSetsCreate = /*@__PURE__*/ API.make(() => ({
