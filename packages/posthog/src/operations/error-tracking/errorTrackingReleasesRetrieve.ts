...
// Input Schema
export const ErrorTrackingReleasesRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ErrorTrackingReleasesRetrieveOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const errorTrackingReleasesRetrieve = /*@__PURE__*/ API.make(() => ({
