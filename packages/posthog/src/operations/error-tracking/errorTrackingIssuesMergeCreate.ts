...
// Input Schema
export const ErrorTrackingIssuesMergeCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ErrorTrackingIssuesMergeCreateOutput = /*@__PURE__*/ Schema.Struct(
  {
 ...
 */
export const errorTrackingIssuesMergeCreate = /*@__PURE__*/ API.make(() => ({
