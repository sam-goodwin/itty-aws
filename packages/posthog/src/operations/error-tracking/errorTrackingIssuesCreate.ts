...
// Input Schema
export const ErrorTrackingIssuesCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ErrorTrackingIssuesCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  status: Schema.optional(
    Schema.Literals([
      "archived",
 ...
 */
export const errorTrackingIssuesCreate = /*@__PURE__*/ API.make(() => ({
