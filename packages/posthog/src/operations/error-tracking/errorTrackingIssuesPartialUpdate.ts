...
// Input Schema
export interface ErrorTrackingIssuesPartialUpdateInput {
  id: string;
  project_id: string;
...
export const ErrorTrackingIssuesPartialUpdateInput =
  ...
  ) as unknown as Schema.Codec<ErrorTrackingIssuesPartialUpdateInput>;

// Output Schema
export interface ErrorTrackingIssuesPartialUpdateOutput {
  id: string;
  status: string;
  name: string | null;
  description: string | null;
...
export const ErrorTrackingIssuesPartialUpdateOutput =
  ...
  }) as unknown as Schema.Codec<ErrorTrackingIssuesPartialUpdateOutput>;
