...
// Input Schema
export const ErrorTrackingReleasesListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ErrorTrackingReleasesListOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const errorTrackingReleasesList = /*@__PURE__*/ API.make(() => ({
