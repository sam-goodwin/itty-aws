...
// Input Schema
export const ErrorTrackingSpikeEventsListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ErrorTrackingSpikeEventsListOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const errorTrackingSpikeEventsList = /*@__PURE__*/ API.make(() => ({
