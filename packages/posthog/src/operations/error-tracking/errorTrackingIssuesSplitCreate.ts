...
// Input Schema
export const ErrorTrackingIssuesSplitCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ErrorTrackingIssuesSplitCreateOutput = /*@__PURE__*/ Schema.Struct(
  {
 ...
 */
export const errorTrackingIssuesSplitCreate = /*@__PURE__*/ API.make(() => ({
