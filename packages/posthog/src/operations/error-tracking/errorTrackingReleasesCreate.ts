...
// Input Schema
export const ErrorTrackingReleasesCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ErrorTrackingReleasesCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  hash_id: Schema.optional(Schema.String),
  team_id: Schema.optional(Schema.Number),
  created_at: Schema.optional(Schema.String),
 ...
 */
export const errorTrackingReleasesCreate = /*@__PURE__*/ API.make(() => ({
