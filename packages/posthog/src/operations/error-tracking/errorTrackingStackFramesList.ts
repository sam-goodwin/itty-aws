...
// Input Schema
export const ErrorTrackingStackFramesListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ErrorTrackingStackFramesListOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const errorTrackingStackFramesList = /*@__PURE__*/ API.make(() => ({
