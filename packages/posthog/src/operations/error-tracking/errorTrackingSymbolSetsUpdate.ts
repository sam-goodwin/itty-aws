...
// Input Schema
export const ErrorTrackingSymbolSetsUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ErrorTrackingSymbolSetsUpdateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const errorTrackingSymbolSetsUpdate = /*@__PURE__*/ API.make(() => ({
