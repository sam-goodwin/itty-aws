...
// Input Schema
export const ErrorTrackingIssuesListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ErrorTrackingIssuesListOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const errorTrackingIssuesList = /*@__PURE__*/ API.make(() => ({
