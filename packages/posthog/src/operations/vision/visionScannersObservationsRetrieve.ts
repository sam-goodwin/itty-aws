...
// Input Schema
export interface VisionScannersObservationsRetrieveInput {
  id: string;
  project_id: string;
  scanner_id: string;
}
export const VisionScannersObservationsRetrieveInput =
  ...
  ) as unknown as Schema.Codec<VisionScannersObservationsRetrieveInput>;

// Output Schema
export interface VisionScannersObservationsRetrieveOutput {
  id: string;
  scanner_id: string;
  session_id: string;
...
export const VisionScannersObservationsRetrieveOutput =
  ...
  }) as unknown as Schema.Codec<VisionScannersObservationsRetrieveOutput>;
