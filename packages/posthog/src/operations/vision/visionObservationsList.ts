...
// Input Schema
export interface VisionObservationsListInput {
  project_id: string;
  limit?: number;
  offset?: number;
  order_by?:
...
export const VisionObservationsListInput =
  ...
  ) as unknown as Schema.Codec<VisionObservationsListInput>;

// Output Schema
export interface VisionObservationsListOutput {
  count: number;
  next?: string | null;
...
export const VisionObservationsListOutput =
  ...
  }) as unknown as Schema.Codec<VisionObservationsListOutput>;
