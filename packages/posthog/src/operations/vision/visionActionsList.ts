...
// Input Schema
export interface VisionActionsListInput {
  project_id: string;
  limit?: number;
  offset?: number;
  scanner?: string;
}
export const VisionActionsListInput = /*@__PURE__*/ Schema.Struct({
...
) as unknown as Schema.Codec<VisionActionsListInput>;

// Output Schema
export interface VisionActionsListOutput {
  count: number;
  next?: string | null;
...
export const VisionActionsListOutput =
  ...
  }) as unknown as Schema.Codec<VisionActionsListOutput>;
 ...
 */
export const visionActionsList = /*@__PURE__*/ API.make(() => ({
