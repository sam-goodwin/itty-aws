...
// Input Schema
export interface SchemaPropertyGroupsListInput {
  project_id: string;
  limit?: number;
  offset?: number;
}
export const SchemaPropertyGroupsListInput =
  ...
  ) as unknown as Schema.Codec<SchemaPropertyGroupsListInput>;

// Output Schema
export interface SchemaPropertyGroupsListOutput {
  count?: number;
  next?: string | null;
...
export const SchemaPropertyGroupsListOutput =
  ...
  }) as unknown as Schema.Codec<SchemaPropertyGroupsListOutput>;
 ...
 */
export const schemaPropertyGroupsList = /*@__PURE__*/ API.make(() => ({
