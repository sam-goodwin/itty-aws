...
// Input Schema
export const LegalDocumentsCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const LegalDocumentsCreateOutput = /*@__PURE__*/ Schema.Struct({
...
// The operation
export const legalDocumentsCreate = /*@__PURE__*/ API.make(() => ({
