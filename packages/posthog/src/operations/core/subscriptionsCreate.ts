...
// Input Schema
export const SubscriptionsCreateInput = /*@__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "POST", path: "/api/projects/{project_id}/subscriptions/" }),
);
export type SubscriptionsCreateInput = typeof SubscriptionsCreateInput.Type;

// Output Schema
export const SubscriptionsCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.Number),
  dashboard: Schema.optional(Schema.NullOr(Schema.Number)),
  insight: Schema.optional(Schema.NullOr(Schema.Number)),
  insight_short_id: Schema.optional(Schema.NullOr(Schema.String)),
