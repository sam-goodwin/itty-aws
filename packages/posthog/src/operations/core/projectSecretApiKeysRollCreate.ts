...
// Input Schema
export const ProjectSecretApiKeysRollCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ProjectSecretApiKeysRollCreateOutput = /*@__PURE__*/ Schema.Struct(
  {
 ...
 */
export const projectSecretApiKeysRollCreate = /*@__PURE__*/ API.make(() => ({
