...
// Input Schema
export const DashboardsReorderTilesCreateInput = /*@__PURE__*/ Schema.Struct({
  id: Schema.Number.pipe(T.PathParam()),
  project_id: Schema.String.pipe(T.PathParam()),
  format: Schema.optional(Schema.Literals(["json", "txt"])),
  tile_order: Schema.optional(Schema.Array(Schema.Number)),
}).pipe(
  T.Http({
    method: "POST",
...
export type DashboardsReorderTilesCreateInput =
  typeof DashboardsReorderTilesCreateInput.Type;

// Output Schema
export const DashboardsReorderTilesCreateOutput = /*@__PURE__*/ Schema.Struct({
...
export type DashboardsReorderTilesCreateOutput =
  typeof DashboardsReorderTilesCreateOutput.Type;
 ...
 */
export const dashboardsReorderTilesCreate = /*@__PURE__*/ API.make(() => ({
