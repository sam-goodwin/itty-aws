...
// Input Schema
export const DashboardsCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const DashboardsCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.Number),
  name: Schema.optional(Schema.NullOr(Schema.String)),
  description: Schema.optional(Schema.String),
  pinned: Schema.optional(Schema.Boolean),
 ...
 */
export const dashboardsCreate = /*@__PURE__*/ API.make(() => ({
  inputSchema: DashboardsCreateInput,
  outputSchema: DashboardsCreateOutput,
