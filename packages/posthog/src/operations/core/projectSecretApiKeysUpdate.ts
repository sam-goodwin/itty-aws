...
// Input Schema
export const ProjectSecretApiKeysUpdateInput = /*@__PURE__*/ Schema.Struct({
...
export type ProjectSecretApiKeysUpdateInput =
  typeof ProjectSecretApiKeysUpdateInput.Type;

// Output Schema
export const ProjectSecretApiKeysUpdateOutput = /*@__PURE__*/ Schema.Struct({
