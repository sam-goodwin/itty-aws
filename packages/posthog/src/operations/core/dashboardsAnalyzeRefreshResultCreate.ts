...
// Input Schema
export const DashboardsAnalyzeRefreshResultCreateInput =
...
export type DashboardsAnalyzeRefreshResultCreateInput =
  typeof DashboardsAnalyzeRefreshResultCreateInput.Type;

// Output Schema
export const DashboardsAnalyzeRefreshResultCreateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type DashboardsAnalyzeRefreshResultCreateOutput =
  typeof DashboardsAnalyzeRefreshResultCreateOutput.Type;
 ...
 */
export const dashboardsAnalyzeRefreshResultCreate =
  /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
    inputSchema: DashboardsAnalyzeRefreshResultCreateInput,
    outputSchema: DashboardsAnalyzeRefreshResultCreateOutput,
