...
// Input Schema
export const SessionRecordingsSharingListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const SessionRecordingsSharingListOutput = /*@__PURE__*/ Schema.Array(
  Schema.Struct({
 ...
 */
export const sessionRecordingsSharingList = /*@__PURE__*/ API.make(() => ({
