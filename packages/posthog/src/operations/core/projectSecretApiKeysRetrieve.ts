...
// Input Schema
export const ProjectSecretApiKeysRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ProjectSecretApiKeysRetrieveOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const projectSecretApiKeysRetrieve = /*@__PURE__*/ API.make(() => ({
