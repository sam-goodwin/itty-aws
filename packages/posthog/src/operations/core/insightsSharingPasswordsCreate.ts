...
// Input Schema
export const InsightsSharingPasswordsCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const InsightsSharingPasswordsCreateOutput = /*@__PURE__*/ Schema.Struct(
  {
    created_at: Schema.optional(Schema.String),
    enabled: Schema.optional(Schema.Boolean),
 ...
 */
export const insightsSharingPasswordsCreate = /*@__PURE__*/ API.make(() => ({
