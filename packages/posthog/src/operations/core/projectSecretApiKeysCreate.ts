...
// Input Schema
export const ProjectSecretApiKeysCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ProjectSecretApiKeysCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  label: Schema.optional(Schema.String),
  value: Schema.optional(Schema.String),
  mask_value: Schema.optional(Schema.NullOr(Schema.String)),
 ...
 */
export const projectSecretApiKeysCreate = /*@__PURE__*/ API.make(() => ({
