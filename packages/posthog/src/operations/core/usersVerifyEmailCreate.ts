...
// Input Schema
export const UsersVerifyEmailCreateInput =
  ...
  }).pipe(T.Http({ method: "POST", path: "/api/users/verify_email/" }));
export type UsersVerifyEmailCreateInput =
  typeof UsersVerifyEmailCreateInput.Type;

// Output Schema
export const UsersVerifyEmailCreateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type UsersVerifyEmailCreateOutput =
  typeof UsersVerifyEmailCreateOutput.Type;

// The operation
export const usersVerifyEmailCreate = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: UsersVerifyEmailCreateInput,
    outputSchema: UsersVerifyEmailCreateOutput,
