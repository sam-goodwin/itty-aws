...
// Input Schema
export const EventDefinitionsPartialUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const EventDefinitionsPartialUpdateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const eventDefinitionsPartialUpdate = /*@__PURE__*/ API.make(() => ({
