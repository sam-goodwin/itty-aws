...
// Input Schema
export const DashboardsCopyTileCreateInput = /*@__PURE__*/ Schema.Struct({
  id: Schema.Number.pipe(T.PathParam()),
  project_id: Schema.String.pipe(T.PathParam()),
  format: Schema.optional(Schema.Literals(["json", "txt"])),
  fromDashboardId: Schema.optional(Schema.Number),
  tileId: Schema.optional(Schema.Number),
}).pipe(
  T.Http({
    method: "POST",
...
// Output Schema
export const DashboardsCopyTileCreateOutput = /*@__PURE__*/ Schema.Struct({
