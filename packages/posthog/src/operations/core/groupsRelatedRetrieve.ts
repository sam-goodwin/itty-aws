...
// Input Schema
export const GroupsRelatedRetrieveInput = /*@__PURE__*/ Schema.Struct({
  project_id: Schema.String.pipe(T.PathParam()),
  group_type_index: Schema.Number,
  id: Schema.String,
}).pipe(
  T.Http({ method: "GET", path: "/api/projects/{project_id}/groups/related/" }),
);
 ...
 */
export const groupsRelatedRetrieve = /*@__PURE__*/ API.make(() => ({
