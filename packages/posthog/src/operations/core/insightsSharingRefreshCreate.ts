...
// Input Schema
export const InsightsSharingRefreshCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const InsightsSharingRefreshCreateOutput = /*@__PURE__*/ Schema.Struct({
  created_at: Schema.optional(Schema.String),
  enabled: Schema.optional(Schema.Boolean),
 ...
 */
export const insightsSharingRefreshCreate = /*@__PURE__*/ API.make(() => ({
