...
// Input Schema
export const DashboardsSharingRefreshCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const DashboardsSharingRefreshCreateOutput = /*@__PURE__*/ Schema.Struct(
  {
    created_at: Schema.optional(Schema.String),
    enabled: Schema.optional(Schema.Boolean),
 ...
 */
export const dashboardsSharingRefreshCreate = /*@__PURE__*/ API.make(() => ({
