...
// Input Schema
export const OrganizationsProjectsRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const OrganizationsProjectsRetrieveOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const organizationsProjectsRetrieve = /*@__PURE__*/ API.make(() => ({
