...
export type OrganizationsProjectsRetrieveInput =
  typeof OrganizationsProjectsRetrieveInput.Type;
...
export type OrganizationsProjectsRetrieveOutput =
  typeof OrganizationsProjectsRetrieveOutput.Type;
