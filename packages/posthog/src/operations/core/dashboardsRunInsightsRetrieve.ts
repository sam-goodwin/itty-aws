...
// Input Schema
export const DashboardsRunInsightsRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const DashboardsRunInsightsRetrieveOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const dashboardsRunInsightsRetrieve = /*@__PURE__*/ API.make(() => ({
