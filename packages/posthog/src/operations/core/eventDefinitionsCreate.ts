...
// Input Schema
export const EventDefinitionsCreateInput = /*@__PURE__*/ Schema.Struct({
...
export type EventDefinitionsCreateInput =
  typeof EventDefinitionsCreateInput.Type;

// Output Schema
export const EventDefinitionsCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  owner: Schema.optional(Schema.NullOr(Schema.Number)),
  description: Schema.optional(Schema.NullOr(Schema.String)),
...
export type EventDefinitionsCreateOutput =
  typeof EventDefinitionsCreateOutput.Type;
 ...
 */
export const eventDefinitionsCreate = /*@__PURE__*/ API.make(() => ({
  inputSchema: EventDefinitionsCreateInput,
  outputSchema: EventDefinitionsCreateOutput,
