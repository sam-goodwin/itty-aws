...
// Input Schema
export const CohortsPartialUpdateInput = /*@__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "/api/projects/{project_id}/cohorts/{id}/" }),
);
export type CohortsPartialUpdateInput = typeof CohortsPartialUpdateInput.Type;

// Output Schema
export const CohortsPartialUpdateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.Number),
  name: Schema.optional(Schema.NullOr(Schema.String)),
  description: Schema.optional(Schema.String),
  groups: Schema.optional(Schema.Unknown),
