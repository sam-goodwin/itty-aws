...
// Input Schema
export const EventDefinitionsRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const EventDefinitionsRetrieveOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const eventDefinitionsRetrieve = /*@__PURE__*/ API.make(() => ({
