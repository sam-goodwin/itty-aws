...
// Input Schema
export const DashboardsCreateFromTemplateJsonCreateInput =
...
export type DashboardsCreateFromTemplateJsonCreateInput =
  typeof DashboardsCreateFromTemplateJsonCreateInput.Type;

// Output Schema
export const DashboardsCreateFromTemplateJsonCreateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type DashboardsCreateFromTemplateJsonCreateOutput =
  typeof DashboardsCreateFromTemplateJsonCreateOutput.Type;
 ...
 */
export const dashboardsCreateFromTemplateJsonCreate =
  /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
    inputSchema: DashboardsCreateFromTemplateJsonCreateInput,
    outputSchema: DashboardsCreateFromTemplateJsonCreateOutput,
