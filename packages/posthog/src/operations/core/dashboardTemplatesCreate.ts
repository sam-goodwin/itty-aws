...
// Input Schema
export const DashboardTemplatesCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const DashboardTemplatesCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  template_name: Schema.optional(Schema.NullOr(Schema.String)),
  dashboard_description: Schema.optional(Schema.NullOr(Schema.String)),
  dashboard_filters: Schema.optional(Schema.NullOr(Schema.Unknown)),
 ...
 */
export const dashboardTemplatesCreate = /*@__PURE__*/ API.make(() => ({
