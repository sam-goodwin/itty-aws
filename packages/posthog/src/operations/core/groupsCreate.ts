...
// Input Schema
export const GroupsCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const GroupsCreateOutput = /*@__PURE__*/ Schema.Struct({
  group_type_index: Schema.optional(Schema.Number),
  group_key: Schema.optional(Schema.String),
 ...
 */
export const groupsCreate = /*@__PURE__*/ API.make(() => ({
