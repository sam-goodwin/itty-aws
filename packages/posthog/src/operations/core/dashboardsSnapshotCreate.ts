...
// Input Schema
export const DashboardsSnapshotCreateInput =
...
export type DashboardsSnapshotCreateInput =
  typeof DashboardsSnapshotCreateInput.Type;

// Output Schema
export const DashboardsSnapshotCreateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type DashboardsSnapshotCreateOutput =
  typeof DashboardsSnapshotCreateOutput.Type;
 ...
 */
export const dashboardsSnapshotCreate = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: DashboardsSnapshotCreateInput,
    outputSchema: DashboardsSnapshotCreateOutput,
