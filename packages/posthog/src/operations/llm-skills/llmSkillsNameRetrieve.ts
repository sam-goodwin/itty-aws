...
export type LlmSkillsNameRetrieveInput = typeof LlmSkillsNameRetrieveInput.Type;
...
export type LlmSkillsNameRetrieveOutput =
  typeof LlmSkillsNameRetrieveOutput.Type;
