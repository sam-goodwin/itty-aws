...
// Input Schema
export const ExternalDataSourcesRetrieveInput =
...
export type ExternalDataSourcesRetrieveInput =
  typeof ExternalDataSourcesRetrieveInput.Type;

// Output Schema
export const ExternalDataSourcesRetrieveOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.String,
...
export type ExternalDataSourcesRetrieveOutput =
  typeof ExternalDataSourcesRetrieveOutput.Type;
 ...
 */
export const externalDataSourcesRetrieve = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: ExternalDataSourcesRetrieveInput,
    outputSchema: ExternalDataSourcesRetrieveOutput,
