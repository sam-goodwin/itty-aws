...
// Input Schema
export const ExternalDataSourcesRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ExternalDataSourcesRetrieveOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const externalDataSourcesRetrieve = /*@__PURE__*/ API.make(() => ({
