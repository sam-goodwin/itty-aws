...
// Input Schema
export const ExternalDataSchemasCancelCreateInput = /*@__PURE__*/ Schema.Struct(
  {
...
export type ExternalDataSchemasCancelCreateInput =
 ...
 */
export const externalDataSchemasCancelCreate = /*@__PURE__*/ API.make(() => ({
