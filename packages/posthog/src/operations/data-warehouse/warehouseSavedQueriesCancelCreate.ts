...
export type WarehouseSavedQueriesCancelCreateInput =
  typeof WarehouseSavedQueriesCancelCreateInput.Type;
...
export type WarehouseSavedQueriesCancelCreateOutput =
  typeof WarehouseSavedQueriesCancelCreateOutput.Type;
 ...
 */
export const warehouseSavedQueriesCancelCreate = /*@__PURE__*/ API.make(() => ({
