...
// Input Schema
export const InsightVariablesCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const InsightVariablesCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  type: Schema.optional(
    Schema.Literals(["String", "Number", "Boolean", "List", "Date"]),
 ...
 */
export const insightVariablesCreate = /*@__PURE__*/ API.make(() => ({
