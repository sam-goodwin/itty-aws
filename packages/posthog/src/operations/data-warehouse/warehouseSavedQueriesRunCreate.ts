...
// Input Schema
export const WarehouseSavedQueriesRunCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const WarehouseSavedQueriesRunCreateOutput = /*@__PURE__*/ Schema.Struct(
  {
 ...
 */
export const warehouseSavedQueriesRunCreate = /*@__PURE__*/ API.make(() => ({
  inputSchema: WarehouseSavedQueriesRunCreateInput,
  outputSchema: WarehouseSavedQueriesRunCreateOutput,
