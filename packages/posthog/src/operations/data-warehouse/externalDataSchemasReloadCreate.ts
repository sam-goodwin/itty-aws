...
// Input Schema
export const ExternalDataSchemasReloadCreateInput = /*@__PURE__*/ Schema.Struct(
  {
...
// Output Schema
export const ExternalDataSchemasReloadCreateOutput = /*@__PURE__*/ Schema.Void;
 ...
 */
export const externalDataSchemasReloadCreate = /*@__PURE__*/ API.make(() => ({
