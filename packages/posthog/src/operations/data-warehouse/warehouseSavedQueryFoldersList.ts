...
// Input Schema
export const WarehouseSavedQueryFoldersListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const WarehouseSavedQueryFoldersListOutput = /*@__PURE__*/ Schema.Array(
  Schema.Struct({
 ...
 */
export const warehouseSavedQueryFoldersList = /*@__PURE__*/ API.make(() => ({
