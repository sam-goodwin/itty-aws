...
// Input Schema
export const WarehouseSavedQueriesUpdateInput = /*@__PURE__*/ Schema.Struct({
...
export type WarehouseSavedQueriesUpdateInput =
  typeof WarehouseSavedQueriesUpdateInput.Type;

// Output Schema
export const WarehouseSavedQueriesUpdateOutput = /*@__PURE__*/ Schema.Struct({
...
export type WarehouseSavedQueriesUpdateOutput =
  typeof WarehouseSavedQueriesUpdateOutput.Type;
 ...
 */
export const warehouseSavedQueriesUpdate = /*@__PURE__*/ API.make(() => ({
