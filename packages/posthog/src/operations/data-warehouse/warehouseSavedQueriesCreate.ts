...
// Input Schema
export const WarehouseSavedQueriesCreateInput = /*@__PURE__*/ Schema.Struct({
...
export type WarehouseSavedQueriesCreateInput =
  typeof WarehouseSavedQueriesCreateInput.Type;

// Output Schema
export const WarehouseSavedQueriesCreateOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  deleted: Schema.optional(Schema.NullOr(Schema.Boolean)),
  name: Schema.optional(Schema.String),
  query: Schema.optional(Schema.NullOr(Schema.Unknown)),
...
export type WarehouseSavedQueriesCreateOutput =
  typeof WarehouseSavedQueriesCreateOutput.Type;
