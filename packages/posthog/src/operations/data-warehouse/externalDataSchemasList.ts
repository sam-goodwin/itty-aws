...
// Input Schema
export const ExternalDataSchemasListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ExternalDataSchemasListOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const externalDataSchemasList = /*@__PURE__*/ API.make(() => ({
