...
// Input Schema
export const InsightVariablesPartialUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const InsightVariablesPartialUpdateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const insightVariablesPartialUpdate = /*@__PURE__*/ API.make(() => ({
