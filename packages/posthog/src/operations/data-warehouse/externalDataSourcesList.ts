...
// Input Schema
export const ExternalDataSourcesListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ExternalDataSourcesListOutput = /*@__PURE__*/ Schema.Struct({
  ...
  results: Schema.optional(
    Schema.Array(
      Schema.Struct({
        ...
        access_method: Schema.optional(
          Schema.Literals(["warehouse", "direct"]),
        ),
 ...
 */
export const externalDataSourcesList = /*@__PURE__*/ API.make(() => ({
