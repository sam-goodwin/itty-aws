...
export type WarehouseSavedQueriesRunHistoryRetrieveInput =
  typeof WarehouseSavedQueriesRunHistoryRetrieveInput.Type;
...
export type WarehouseSavedQueriesRunHistoryRetrieveOutput =
  typeof WarehouseSavedQueriesRunHistoryRetrieveOutput.Type;
 ...
 */
export const warehouseSavedQueriesRunHistoryRetrieve = /*@__PURE__*/ API.make(
  () => ({
