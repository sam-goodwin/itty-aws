...
// Input Schema
export const ExternalDataSchemasUpdateInput = /*@__PURE__*/ Schema.Struct({
...
export type ExternalDataSchemasUpdateInput =
  typeof ExternalDataSchemasUpdateInput.Type;

// Output Schema
export const ExternalDataSchemasUpdateOutput = /*@__PURE__*/ Schema.Struct({
...
export type ExternalDataSchemasUpdateOutput =
  typeof ExternalDataSchemasUpdateOutput.Type;
 ...
 */
export const externalDataSchemasUpdate = /*@__PURE__*/ API.make(() => ({
  inputSchema: ExternalDataSchemasUpdateInput,
  outputSchema: ExternalDataSchemasUpdateOutput,
