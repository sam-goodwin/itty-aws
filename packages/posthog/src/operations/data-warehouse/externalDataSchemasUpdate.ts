...
// Input Schema
export const ExternalDataSchemasUpdateInput =
...
// Output Schema
export const ExternalDataSchemasUpdateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.String,
    name: Schema.String,
    label: Schema.NullOr(Schema.String),
 ...
 */
export const externalDataSchemasUpdate = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
