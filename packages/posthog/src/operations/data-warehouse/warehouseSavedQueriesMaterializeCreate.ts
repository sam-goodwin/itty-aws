...
// Input Schema
export const WarehouseSavedQueriesMaterializeCreateInput =
...
export type WarehouseSavedQueriesMaterializeCreateInput =
  typeof WarehouseSavedQueriesMaterializeCreateInput.Type;

// Output Schema
export const WarehouseSavedQueriesMaterializeCreateOutput =
  /*@__PURE__*/ Schema.Struct({
...
export type WarehouseSavedQueriesMaterializeCreateOutput =
  typeof WarehouseSavedQueriesMaterializeCreateOutput.Type;
 ...
 */
export const warehouseSavedQueriesMaterializeCreate = /*@__PURE__*/ API.make(
  () => ({
    inputSchema: WarehouseSavedQueriesMaterializeCreateInput,
    outputSchema: WarehouseSavedQueriesMaterializeCreateOutput,
