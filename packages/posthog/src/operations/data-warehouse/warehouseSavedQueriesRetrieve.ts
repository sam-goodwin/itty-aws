...
// Input Schema
export const WarehouseSavedQueriesRetrieveInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const WarehouseSavedQueriesRetrieveOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const warehouseSavedQueriesRetrieve = /*@__PURE__*/ API.make(() => ({
