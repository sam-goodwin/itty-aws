...
// Input Schema
export const CustomerJourneysUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const CustomerJourneysUpdateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const customerJourneysUpdate = /*@__PURE__*/ API.make(() => ({
