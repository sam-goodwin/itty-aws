...
// Input Schema
export const CustomerJourneysPartialUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const CustomerJourneysPartialUpdateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const customerJourneysPartialUpdate = /*@__PURE__*/ API.make(() => ({
