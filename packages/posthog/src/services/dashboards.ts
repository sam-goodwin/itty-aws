...
export const DashboardCollaborator = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.optional(S.String),
  ...
  identifier: "DashboardCollaborator",
}) as any as S.Schema<DashboardCollaborator>;
...
export interface DashboardsCopyTileCreateRequest {
  ...
  id: number;
  format?: DashboardsCopyTileCreateRequestFormat;
...
export type DashboardFiltersMap = { [key: string]: unknown | undefined };
export const DashboardFiltersMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
) as any as S.Schema<DashboardFiltersMap>;

export type DashboardVariablesMap = { [key: string]: unknown | undefined };
export const DashboardVariablesMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
) as any as S.Schema<DashboardVariablesMap>;

export type DashboardTagsList = unknown[];
export const DashboardTagsList = /*@__PURE__*/ S.Array(
  S.Unknown,
) as any as S.Schema<DashboardTagsList>;

export type DashboardPersistedFiltersMap = {
  [key: string]: unknown | undefined;
};
export const DashboardPersistedFiltersMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
) as any as S.Schema<DashboardPersistedFiltersMap>;

export type DashboardPersistedVariablesMap = {
  [key: string]: unknown | undefined;
};
export const DashboardPersistedVariablesMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
) as any as S.Schema<DashboardPersistedVariablesMap>;

/** List of quick filter IDs associated with this dashboard */
export type DashboardQuickFilterIdsList = string[];
export const DashboardQuickFilterIdsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<DashboardQuickFilterIdsList>;

export type DashboardTilesItemMap = { [key: string]: unknown | undefined };
export const DashboardTilesItemMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
) as any as S.Schema<DashboardTilesItemMap>;

export type DashboardTilesList = DashboardTilesItemMap[];
export const DashboardTilesList = /*@__PURE__*/ S.Array(
  DashboardTilesItemMap,
) as any as S.Schema<DashboardTilesList>;
...
export interface Dashboard {
  ...
  filters?: DashboardFiltersMap;
  variables?: DashboardVariablesMap | null;
  ...
  persisted_filters?: DashboardPersistedFiltersMap | null;
  persisted_variables?: DashboardPersistedVariablesMap | null;
  team_id?: number;
  /** List of quick filter IDs associated with this dashboard */
  quick_filter_ids?: DashboardQuickFilterIdsList | null;
  tiles?: DashboardTilesList | null;
...
export const Dashboard = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    filters: S.optional(DashboardFiltersMap),
    variables: S.optional(S.NullOr(DashboardVariablesMap)),
    breakdown_colors: S.optional(S.Unknown),
    data_color_theme_id: S.optional(S.NullOr(S.Number)),
    tags: S.optional(DashboardTagsList),
    ...
    persisted_filters: S.optional(S.NullOr(DashboardPersistedFiltersMap)),
    persisted_variables: S.optional(S.NullOr(DashboardPersistedVariablesMap)),
    team_id: S.optional(S.Number),
    quick_filter_ids: S.optional(S.NullOr(DashboardQuickFilterIdsList)),
    tiles: S.optional(S.NullOr(DashboardTilesList)),
...
export type DashboardsCreateRequestFiltersMap = {
  [key: string]: unknown | undefined;
};
export const DashboardsCreateRequestFiltersMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
) as any as S.Schema<DashboardsCreateRequestFiltersMap>;

export type DashboardsCreateRequestVariablesMap = {
  [key: string]: unknown | undefined;
};
export const DashboardsCreateRequestVariablesMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
) as any as S.Schema<DashboardsCreateRequestVariablesMap>;

export type DashboardsCreateRequestTagsList = unknown[];
export const DashboardsCreateRequestTagsList = /*@__PURE__*/ S.Array(
  S.Unknown,
) as any as S.Schema<DashboardsCreateRequestTagsList>;

export type DashboardsCreateRequestPersistedFiltersMap = {
  [key: string]: unknown | undefined;
};
export const DashboardsCreateRequestPersistedFiltersMap =
  /*@__PURE__*/ S.Record(
    S.String,
    S.Unknown,
  ) as any as S.Schema<DashboardsCreateRequestPersistedFiltersMap>;

export type DashboardsCreateRequestPersistedVariablesMap = {
  [key: string]: unknown | undefined;
};
export const DashboardsCreateRequestPersistedVariablesMap =
  /*@__PURE__*/ S.Record(
    S.String,
    S.Unknown,
  ) as any as S.Schema<DashboardsCreateRequestPersistedVariablesMap>;

/** List of quick filter IDs associated with this dashboard */
export type DashboardsCreateRequestQuickFilterIdsList = string[];
...
export type DashboardsCreateRequestTilesItemMap = {
  [key: string]: unknown | undefined;
};
export const DashboardsCreateRequestTilesItemMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
) as any as S.Schema<DashboardsCreateRequestTilesItemMap>;

export type DashboardsCreateRequestTilesList =
  DashboardsCreateRequestTilesItemMap[];
export const DashboardsCreateRequestTilesList = /*@__PURE__*/ S.Array(
  DashboardsCreateRequestTilesItemMap,
) as any as S.Schema<DashboardsCreateRequestTilesList>;

export interface DashboardsCreateRequest {
  /** Project ID of the project you're trying to access. To find the ID of the project, make a call to /api/projects/. */
  project_id: string;
  format?: DashboardsCreateRequestFormat;
  ...
  deleted?: boolean;
  creation_mode?: CreationModeEnum;
  filters?: DashboardsCreateRequestFiltersMap;
  variables?: DashboardsCreateRequestVariablesMap | null;
  /** Custom color mapping for breakdown values. */
  breakdown_colors?: unknown;
  /** ID of the color theme used for chart visualizations. */
  data_color_theme_id?: number | null;
  ...
  access_control_version?: string;
  last_refresh?: string | null;
  persisted_filters?: DashboardsCreateRequestPersistedFiltersMap | null;
  persisted_variables?: DashboardsCreateRequestPersistedVariablesMap | null;
  team_id?: number;
  /** List of quick filter IDs associated with this dashboard */
  quick_filter_ids?: DashboardsCreateRequestQuickFilterIdsList | null;
  tiles?: DashboardsCreateRequestTilesList | null;
  /** Template key to create the dashboard from a predefined template. */
  use_template?: string;
  /** ID of an existing dashboard to duplicate. */
  use_dashboard?: number | null;
...
export const DashboardsCreateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    deleted: S.optional(S.Boolean),
    creation_mode: S.optional(CreationModeEnum),
    filters: S.optional(DashboardsCreateRequestFiltersMap),
    variables: S.optional(S.NullOr(DashboardsCreateRequestVariablesMap)),
    breakdown_colors: S.optional(S.Unknown),
    data_color_theme_id: S.optional(S.NullOr(S.Number)),
    ...
    access_control_version: S.optional(S.String),
    last_refresh: S.optional(S.NullOr(S.String)),
    persisted_filters: S.optional(
      S.NullOr(DashboardsCreateRequestPersistedFiltersMap),
    ),
    persisted_variables: S.optional(
      S.NullOr(DashboardsCreateRequestPersistedVariablesMap),
    ),
    team_id: S.optional(S.Number),
    quick_filter_ids: S.optional(
      S.NullOr(DashboardsCreateRequestQuickFilterIdsList),
    ),
    tiles: S.optional(S.NullOr(DashboardsCreateRequestTilesList)),
    use_template: S.optional(S.String),
    use_dashboard: S.optional(S.NullOr(S.Number)),
    delete_insights: S.optional(S.Boolean),
    _create_in_folder: S.optional(S.String),
...
export interface DashboardsCreateTextTileCreateRequest {
  ...
  /** A unique integer value identifying this dashboard. */
  id: number;
  format?: DashboardsCreateTextTileCreateRequestFormat;
...
export type TextDashboardTilesList = DashboardTileBasic[];
...
export type ButtonTileDashboardTilesList = DashboardTileBasic[];
...
export interface WidgetDateRange {
  date_from?: WidgetDateRangeDateFrom | null;
}
...
export type WidgetFilterEntryValueCase1List = string[];
...
export type LogsListWidgetConfigSeverityLevelsList =
...
export type LogsListWidgetConfigServiceNamesList = string[];
...
export type DashboardWidgetDashboardTilesList = DashboardTileBasic[];
...
export const DashboardTile = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.optional(S.Number),
    insight: Insight,
    text: Text,
...
).annotate({ identifier: "DashboardTile" }) as any as S.Schema<DashboardTile>;
...
export interface DashboardsDeleteTileRequest {
  ...
  /** A unique integer value identifying this dashboard. */
  id: number;
  format?: DashboardsDeleteTileRequestFormat;
...
export interface DashboardsDestroyRequest {
  ...
  /** A unique integer value identifying this dashboard. */
  id: number;
  format?: DashboardsDestroyRequestFormat;
}
...
export interface DashboardsListRequest {
  ...
  folder?: string;
  format?: DashboardsListRequestFormat;
...
export type DashboardBasicTagsList = unknown[];
...
export type PaginatedDashboardBasicListResultsList = DashboardBasic[];
...
export interface DashboardsMoveTileCreateRequest {
  ...
  /** A unique integer value identifying this dashboard. */
  id: number;
  format?: DashboardsMoveTileCreateRequestFormat;
...
export type DashboardsPartialUpdateRequestTagsList = string[];
...
/** List of quick filter IDs associated with this dashboard. */
export type DashboardsPartialUpdateRequestQuickFilterIdsList = string[];
...
/** * `activity_events_list` - activity_events_list * `error_tracking_list` - error_tracking_list * `experiment_results` - experiment_results * `experiments_list` - experiments_list * `logs_list` - logs_list * `session_replay_list` - session_replay_list * `survey_results` - survey_results */
...
export interface DashboardPatchWidgetOpenApi {
  ...
  id?: string;
  /** Widget type identifier (cannot be changed on update). * `activity_events_list` - activity_events_list * `error_tracking_list` - error_tracking_list * `experiment_results` - experiment_results * `experiments_list` - experiments_list * `logs_list` - logs_list * `session_replay_list` - session_replay_list * `survey_results` - survey_results */
...
export interface DashboardsPartialUpdateRequest {
  ...
  /** A unique integer value identifying this dashboard. */
  id: number;
  format?: DashboardsPartialUpdateRequestFormat;
  /** Opt in to receiving the deprecated `dashboards` field in insight payloads. Once opt-in enforcement is enabled, API-token callers stop receiving it by default; use `dashboard_tiles` instead. */
  include_dashboards?: boolean;
  name?: string | null;
  description?: string;
...
export type DashboardsReorderTilesCreateRequestTileOrderList = number[];
...
export interface DashboardsReorderTilesCreateRequest {
  ...
  /** A unique integer value identifying this dashboard. */
  id: number;
  format?: DashboardsReorderTilesCreateRequestFormat;
  /** Array of tile IDs in the desired display order (top to bottom, left to right). */
...
export interface DashboardsRetrieveRequest {
  ...
  format?: DashboardsRetrieveRequestFormat;
  /** Opt in to receiving the deprecated `dashboards` field in insight payloads. Once opt-in enforcement is enabled, API-token callers stop receiving it by default; use `dashboard_tiles` instead. */
  include_dashboards?: boolean;
...
export interface DashboardsRunInsightsRetrieveRequest {
  ...
  /** Object (or pre-encoded JSON string) to override dashboard filters for this request only (not persisted). Top-level keys replace; nested values are not deep-merged — pass the complete value for any key you override. Accepts the same keys as the dashboard filters schema (e.g., `date_from`, `date_to`, `properties`). Ignored when accessed via a sharing token. */
  filters_override?: string;
  format?: DashboardsRunInsightsRetrieveRequestFormat;
  /** 'optimized' (default) returns LLM-friendly formatted text per insight. 'json' returns the raw query result objects. */
  output_format?: DashboardsRunInsightsRetrieveRequestOutputFormat;
  ...
  refresh?: DashboardsRunInsightsRetrieveRequestRefresh;
  /** Object (or pre-encoded JSON string) to override dashboard variables for this request only (not persisted). Format: {"<variable_id>": {"code_name": "<code_name>", "variableId": "<variable_id>", "value": <new_value>}}. Each entry must include `code_name` — partial entries are silently dropped. The simplest workflow is to call `dashboard-get` first, copy the matching entry from the response, and mutate `value`. Top-level keys replace; nested values are not deep-merged. Ignored when accessed via a sharing token. */
  variables_override?: string;
}
...
export type RunInsightsResponseResultsList = DashboardTileResult[];
...
export interface DashboardsRunWidgetsRetrieveRequest {
  ...
  /** A unique integer value identifying this dashboard. */
  id: number;
  format?: DashboardsRunWidgetsRetrieveRequestFormat;
...
export type RunWidgetsResponseResultsList = DashboardWidgetRunResult[];
...
export type DashboardsSharingListResponseBodyList = SharingConfiguration[];
...
export type DashboardsSharingPasswordsCreateRequestSharePasswordsList =
  SharePassword[];
export const DashboardsSharingPasswordsCreateRequestSharePasswordsList =
  /*@__PURE__*/ S.Array(
    SharePassword,
  ) as any as S.Schema<DashboardsSharingPasswordsCreateRequestSharePasswordsList>;
...
export interface DashboardsSharingPasswordsCreateRequest {
  ...
  settings?: unknown;
  password_required?: boolean;
  share_passwords?: DashboardsSharingPasswordsCreateRequestSharePasswordsList;
  /** The effective access level the user has for this object */
  user_access_level?: string | null;
}
  ...
  () =>
    S.Struct({
      ...
      share_passwords: S.optional(
        DashboardsSharingPasswordsCreateRequestSharePasswordsList,
      ),
      user_access_level: S.optional(S.NullOr(S.String)),
    }).pipe(
      T.Http({
...
export type DashboardsSharingRefreshCreateRequestSharePasswordsList =
  SharePassword[];
export const DashboardsSharingRefreshCreateRequestSharePasswordsList =
  /*@__PURE__*/ S.Array(
    SharePassword,
  ) as any as S.Schema<DashboardsSharingRefreshCreateRequestSharePasswordsList>;
...
export interface DashboardsSharingRefreshCreateRequest {
  ...
  settings?: unknown;
  password_required?: boolean;
  share_passwords?: DashboardsSharingRefreshCreateRequestSharePasswordsList;
  /** The effective access level the user has for this object */
  user_access_level?: string | null;
}
export const DashboardsSharingRefreshCreateRequest = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      ...
      password_required: S.optional(S.Boolean),
      share_passwords: S.optional(
        DashboardsSharingRefreshCreateRequestSharePasswordsList,
      ),
      user_access_level: S.optional(S.NullOr(S.String)),
    }).pipe(
      T.Http({
...
export interface DashboardsStreamTilesRetrieveRequest {
  ...
  /** Object (or pre-encoded JSON string) to override dashboard filters for this request only (not persisted). Top-level keys replace; nested values are not deep-merged — pass the complete value for any key you override. Accepts the same keys as the dashboard filters schema (e.g., `date_from`, `date_to`, `properties`). Ignored when accessed via a sharing token. */
  filters_override?: string;
  format?: DashboardsStreamTilesRetrieveRequestFormat;
  ...
  layoutSize?: DashboardsStreamTilesRetrieveRequestLayoutSize;
  /** Object (or pre-encoded JSON string) to override dashboard variables for this request only (not persisted). Format: {"<variable_id>": {"code_name": "<code_name>", "variableId": "<variable_id>", "value": <new_value>}}. Each entry must include `code_name` — partial entries are silently dropped. The simplest workflow is to call `dashboard-get` first, copy the matching entry from the response, and mutate `value`. Top-level keys replace; nested values are not deep-merged. Ignored when accessed via a sharing token. */
  variables_override?: string;
}
...
export interface DashboardsSubscribeNudgeCreateRequest {
  ...
  /** A unique integer value identifying this dashboard. */
  id: number;
  format?: DashboardsSubscribeNudgeCreateRequestFormat;
}
...
export type DashboardsUpdateRequestFiltersMap = {
  [key: string]: unknown | undefined;
};
export const DashboardsUpdateRequestFiltersMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
) as any as S.Schema<DashboardsUpdateRequestFiltersMap>;

export type DashboardsUpdateRequestVariablesMap = {
  [key: string]: unknown | undefined;
};
export const DashboardsUpdateRequestVariablesMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
) as any as S.Schema<DashboardsUpdateRequestVariablesMap>;

export type DashboardsUpdateRequestTagsList = unknown[];
export const DashboardsUpdateRequestTagsList = /*@__PURE__*/ S.Array(
  S.Unknown,
) as any as S.Schema<DashboardsUpdateRequestTagsList>;

export type DashboardsUpdateRequestPersistedFiltersMap = {
  [key: string]: unknown | undefined;
};
export const DashboardsUpdateRequestPersistedFiltersMap =
  /*@__PURE__*/ S.Record(
    S.String,
    S.Unknown,
  ) as any as S.Schema<DashboardsUpdateRequestPersistedFiltersMap>;

export type DashboardsUpdateRequestPersistedVariablesMap = {
  [key: string]: unknown | undefined;
};
export const DashboardsUpdateRequestPersistedVariablesMap =
  /*@__PURE__*/ S.Record(
    S.String,
    S.Unknown,
  ) as any as S.Schema<DashboardsUpdateRequestPersistedVariablesMap>;

/** List of quick filter IDs associated with this dashboard */
export type DashboardsUpdateRequestQuickFilterIdsList = string[];
...
export type DashboardsUpdateRequestTilesItemMap = {
  [key: string]: unknown | undefined;
};
export const DashboardsUpdateRequestTilesItemMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
) as any as S.Schema<DashboardsUpdateRequestTilesItemMap>;

export type DashboardsUpdateRequestTilesList =
  DashboardsUpdateRequestTilesItemMap[];
export const DashboardsUpdateRequestTilesList = /*@__PURE__*/ S.Array(
  DashboardsUpdateRequestTilesItemMap,
) as any as S.Schema<DashboardsUpdateRequestTilesList>;
...
export interface DashboardsUpdateRequest {
  ...
  /** A unique integer value identifying this dashboard. */
  id: number;
  format?: DashboardsUpdateRequestFormat;
  /** Opt in to receiving the deprecated `dashboards` field in insight payloads. Once opt-in enforcement is enabled, API-token callers stop receiving it by default; use `dashboard_tiles` instead. */
  include_dashboards?: boolean;
  name?: string | null;
  description?: string;
  ...
  deleted?: boolean;
  creation_mode?: CreationModeEnum;
  filters?: DashboardsUpdateRequestFiltersMap;
  variables?: DashboardsUpdateRequestVariablesMap | null;
  /** Custom color mapping for breakdown values. */
  breakdown_colors?: unknown;
  /** ID of the color theme used for chart visualizations. */
  data_color_theme_id?: number | null;
  ...
  access_control_version?: string;
  last_refresh?: string | null;
  persisted_filters?: DashboardsUpdateRequestPersistedFiltersMap | null;
  persisted_variables?: DashboardsUpdateRequestPersistedVariablesMap | null;
  team_id?: number;
  /** List of quick filter IDs associated with this dashboard */
  quick_filter_ids?: DashboardsUpdateRequestQuickFilterIdsList | null;
  tiles?: DashboardsUpdateRequestTilesList | null;
  /** Template key to create the dashboard from a predefined template. */
  use_template?: string;
  /** ID of an existing dashboard to duplicate. */
  use_dashboard?: number | null;
...
export const DashboardsUpdateRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    deleted: S.optional(S.Boolean),
    creation_mode: S.optional(CreationModeEnum),
    filters: S.optional(DashboardsUpdateRequestFiltersMap),
    variables: S.optional(S.NullOr(DashboardsUpdateRequestVariablesMap)),
    breakdown_colors: S.optional(S.Unknown),
    data_color_theme_id: S.optional(S.NullOr(S.Number)),
    ...
    last_refresh: S.optional(S.NullOr(S.String)),
    persisted_filters: S.optional(
      S.NullOr(DashboardsUpdateRequestPersistedFiltersMap),
    ),
    persisted_variables: S.optional(
      S.NullOr(DashboardsUpdateRequestPersistedVariablesMap),
    ),
    team_id: S.optional(S.Number),
    quick_filter_ids: S.optional(
      S.NullOr(DashboardsUpdateRequestQuickFilterIdsList),
    ),
    tiles: S.optional(S.NullOr(DashboardsUpdateRequestTilesList)),
    use_template: S.optional(S.String),
    use_dashboard: S.optional(S.NullOr(S.Number)),
    delete_insights: S.optional(S.Boolean),
    _create_in_folder: S.optional(S.String),
...
export interface DashboardsUpdateTextTileCreateRequest {
  ...
  /** A unique integer value identifying this dashboard. */
  id: number;
  format?: DashboardsUpdateTextTileCreateRequestFormat;
...
export interface DashboardsUpdateWidgetsBatchRequest {
  ...
  /** A unique integer value identifying this dashboard. */
  id: number;
  format?: DashboardsUpdateWidgetsBatchRequestFormat;
  /** Widget tiles to update atomically, each identified by its tile_id. config shape is per widget_type; see dashboard-widget-catalog-list for per-type config_schema (1–10 per request). */
...
export type UpdateDashboardWidgetsBatchResponseTilesList = DashboardTile[];
export const UpdateDashboardWidgetsBatchResponseTilesList =
  /*@__PURE__*/ S.Array(
    DashboardTile,
  ) as any as S.Schema<UpdateDashboardWidgetsBatchResponseTilesList>;

export interface UpdateDashboardWidgetsBatchResponse {
  /** Updated dashboard widget tiles in request order. */
  tiles: UpdateDashboardWidgetsBatchResponseTilesList;
}
export const UpdateDashboardWidgetsBatchResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    tiles: UpdateDashboardWidgetsBatchResponseTilesList,
  }),
).annotate({
  identifier: "UpdateDashboardWidgetsBatchResponse",
}) as any as S.Schema<UpdateDashboardWidgetsBatchResponse>;
...
export interface DashboardsWidgetCatalogRetrieveRequest {
  /** Project ID of the project you're trying to access. To find the ID of the project, make a call to /api/projects/. */
  project_id: string;
  format?: DashboardsWidgetCatalogRetrieveRequestFormat;
}
...
export type WidgetCatalogResponseResultsList = WidgetCatalogEntry[];
...
export interface DashboardsWidgetsBatchCreateRequest {
  ...
  /** A unique integer value identifying this dashboard. */
  id: number;
  format?: DashboardsWidgetsBatchCreateRequestFormat;
  /** Widget tiles to add atomically. Supported widget_type values: activity_events_list, error_tracking_list, experiment_results, experiments_list, logs_list, session_replay_list, survey_results. Use dashboard-widget-catalog-list for per-type config_schema documentation. (1–10 per request). */
...
export type AddDashboardWidgetsBatchResponseTilesList = DashboardTile[];
export const AddDashboardWidgetsBatchResponseTilesList = /*@__PURE__*/ S.Array(
  DashboardTile,
) as any as S.Schema<AddDashboardWidgetsBatchResponseTilesList>;

export interface AddDashboardWidgetsBatchResponse {
  /** Created dashboard widget tiles in request order. */
  tiles: AddDashboardWidgetsBatchResponseTilesList;
}
export const AddDashboardWidgetsBatchResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    tiles: AddDashboardWidgetsBatchResponseTilesList,
  }),
).annotate({
  identifier: "AddDashboardWidgetsBatchResponse",
}) as any as S.Schema<AddDashboardWidgetsBatchResponse>;
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  output: UpdateDashboardWidgetsBatchResponse,
  errors: [],
  protocol: PosthogProtocol,
  retry: Retry.Retry,
}));
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  output: AddDashboardWidgetsBatchResponse,
  errors: [],
  protocol: PosthogProtocol,
  retry: Retry.Retry,
}));
