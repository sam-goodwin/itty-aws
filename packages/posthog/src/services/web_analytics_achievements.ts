...
export interface UpdateWebAnalyticAchievementPreferenceRequest {
...
export const UpdateWebAnalyticAchievementPreferenceRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
    ...
    identifier: "UpdateWebAnalyticAchievementPreferenceRequest",
  }) as any as S.Schema<UpdateWebAnalyticAchievementPreferenceRequest>;
...
export const WebAnalyticsAchievementsPreferencesRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      project_id: S.String.pipe(T.Label()),
    }).pipe(
...
export type UpdateWebAnalyticAchievementPreferenceError = PosthogOpError;
...
export const updateWebAnalyticAchievementPreference: API.OperationMethod<
  UpdateWebAnalyticAchievementPreferenceRequest,
  WebAnalyticsUserPreferences,
  UpdateWebAnalyticAchievementPreferenceError,
  PosthogOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: UpdateWebAnalyticAchievementPreferenceRequest,
...
export type WebAnalyticsAchievementsPreferencesError = PosthogOpError;
/** Get Web analytics achievements preferences Returns the requesting user's per-project Web analytics achievements preferences. */
export const webAnalyticsAchievementsPreferences: API.OperationMethod<
  WebAnalyticsAchievementsPreferencesRequest,
  WebAnalyticsUserPreferences,
  WebAnalyticsAchievementsPreferencesError,
  PosthogOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: WebAnalyticsAchievementsPreferencesRequest,
  output: WebAnalyticsUserPreferences,
  errors: [],
  protocol: PosthogProtocol,
  retry: Retry.Retry,
