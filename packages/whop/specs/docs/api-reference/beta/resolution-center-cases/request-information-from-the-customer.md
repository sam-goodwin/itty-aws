...
<!-- OpenAPI source: `post /resolution_center_cases/{id}/request_info` in specs/api-v1-native.json (inlined by docs.whop.com; stripped by scripts/download-api-docs.ts) -->