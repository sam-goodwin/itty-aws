...
<!-- OpenAPI source: `get /users/me/preferences/notifications/topics` in specs/api-v1-native.json (inlined by docs.whop.com; stripped by scripts/download-api-docs.ts) -->