...
<div data-whop-demo-shell style={{ position: "relative", minHeight: "480px", transition: "min-height 200ms ease" }}>
  ...
  <div data-whop-demo-native="playground:payments" data-whop-elements-version="" style={{ position: "relative" }} />
</div>
...
<CardGroup cols={2}>
  <Card title="PaymentRequest" href="/elements/upcoming/payments/paymentRequest">
...
<CardGroup cols={2}>
  ...
  <Card title="EmailElement" href="/elements/upcoming/payments/email">
  ...
  <Card title="TaxIdElement" href="/elements/upcoming/payments/taxId">
  ...
  <Card title="BrandingElement" href="/elements/upcoming/payments/branding">
