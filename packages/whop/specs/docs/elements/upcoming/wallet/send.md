...
Mounts inside [`Wallet`](/elements/upcoming/wallet/overview). Pass props and callbacks through the create options or React props. Keep the created handle, or React `ref`, to call `refresh()`.
