...
<div data-whop-platform="web">
  ...
  <div data-whop-demo-shell style={{ position: "relative", minHeight: "40px", transition: "min-height 200ms ease" }}>
    ...
    <div data-whop-demo-native="toast:button" data-whop-elements-version="" style={{ position: "relative" }} />
  </div>
  ...
  <CardGroup cols={2}>
    ...
    <Card title="Tracking" href="/elements/upcoming/tracking/overview">
      An account's tracked audience: everyone its pixel has seen, and every event they performed.
    </Card>

    <Card title="Wallet" href="/elements/upcoming/wallet/overview">
