...
// Input Schema
export const OrganizationsControllerCreateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const OrganizationsControllerCreateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const OrganizationsControllerCreate = /*@__PURE__*/ API.make(() => ({
