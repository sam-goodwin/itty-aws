...
// Input Schema
export const DirectoryGroupsControllerFindInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const DirectoryGroupsControllerFindOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const DirectoryGroupsControllerFind = /*@__PURE__*/ API.make(() => ({
