...
export const JumpWireWebDataVaultControllerversionsInput =
  ...
  }).pipe(T.Http({ method: "GET", path: "/vault/v1/kv/{id}/versions" }));
export type JumpWireWebDataVaultControllerversionsInput =
  typeof JumpWireWebDataVaultControllerversionsInput.Type;
...
export type JumpWireWebDataVaultControllerversionsOutput =
  typeof JumpWireWebDataVaultControllerversionsOutput.Type;
