...
// Input Schema
export interface RedirectUrisControllerListInput {
  before?: string;
  after?: string;
  limit?: number;
  order?: string;
...
export const RedirectUrisControllerListInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "GET", path: "/user_management/redirect_uris" }),
  ) as unknown as Schema.Codec<RedirectUrisControllerListInput>;

// Output Schema
export interface RedirectUrisControllerListOutput {
  object?: string;
...
export const RedirectUrisControllerListOutput =
  ...
  }) as unknown as Schema.Codec<RedirectUrisControllerListOutput>;
