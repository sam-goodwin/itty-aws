...
// Input Schema
export const UserlandUsersControllerCreateInput = /*@__PURE__*/ Schema.Struct({
  email: Schema.String,
...
// Output Schema
export const UserlandUsersControllerCreateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const UserlandUsersControllerCreate = /*@__PURE__*/ API.make(() => ({
