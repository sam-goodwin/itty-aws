...
// Input Schema
export const DirectoryUsersControllerListInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const DirectoryUsersControllerListOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const DirectoryUsersControllerList = /*@__PURE__*/ API.make(() => ({
