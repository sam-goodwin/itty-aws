...
// Input Schema
export const SsoControllerLogoutAuthorizeInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const SsoControllerLogoutAuthorizeOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const SsoControllerLogoutAuthorize = /*@__PURE__*/ API.make(() => ({
