...
// Input Schema
export const UserlandUsersControllerUpdateInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const UserlandUsersControllerUpdateOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const UserlandUsersControllerUpdate = /*@__PURE__*/ API.make(() => ({
