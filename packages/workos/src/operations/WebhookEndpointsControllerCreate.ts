...
export const WebhookEndpointsControllerCreateInput =
  ...
  }).pipe(T.Http({ method: "POST", path: "/webhook_endpoints" }));
export type WebhookEndpointsControllerCreateInput =
  typeof WebhookEndpointsControllerCreateInput.Type;
...
export type WebhookEndpointsControllerCreateOutput =
  typeof WebhookEndpointsControllerCreateOutput.Type;
