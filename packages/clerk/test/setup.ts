...
/**
 * Main layer providing Platform + Backend credentials and an HTTP client for
 * all Clerk tests.
 */
export const MainLayer = Layer.merge(CredentialsFromEnv, FetchHttpClient.layer);

/**
 * Short random hex string generated once per test run. Append this to resource
 * names so parallel test runs don't collide.
 */
