...
// Input Schema
export const UpdateRoleSetInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type UpdateRoleSetInput = typeof UpdateRoleSetInput.Type;

// Output Schema
export const UpdateRoleSetOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type UpdateRoleSetOutput = typeof UpdateRoleSetOutput.Type;
 ...
 */
export const UpdateRoleSet = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: UpdateRoleSetInput,
  outputSchema: UpdateRoleSetOutput,
