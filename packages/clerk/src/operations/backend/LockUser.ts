...
// Input Schema
export const LockUserInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  user_id: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "POST", path: "/users/{user_id}/lock" }));
export type LockUserInput = typeof LockUserInput.Type;

// Output Schema
export const LockUserOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String,
...
export type LockUserOutput = typeof LockUserOutput.Type;
 ...
 */
export const LockUser = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: LockUserInput,
  outputSchema: LockUserOutput,
