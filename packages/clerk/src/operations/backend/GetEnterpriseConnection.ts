...
// Input Schema
export const GetEnterpriseConnectionInput =
...
export type GetEnterpriseConnectionInput =
  typeof GetEnterpriseConnectionInput.Type;

// Output Schema
export const GetEnterpriseConnectionOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.String,
    name: Schema.String,
...
export type GetEnterpriseConnectionOutput =
  typeof GetEnterpriseConnectionOutput.Type;
 ...
 */
export const GetEnterpriseConnection = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: GetEnterpriseConnectionInput,
    outputSchema: GetEnterpriseConnectionOutput,
