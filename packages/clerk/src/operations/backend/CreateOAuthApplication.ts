...
// Input Schema
export const CreateOAuthApplicationInput =
...
export type CreateOAuthApplicationInput =
  typeof CreateOAuthApplicationInput.Type;

// Output Schema
export const CreateOAuthApplicationOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type CreateOAuthApplicationOutput =
  typeof CreateOAuthApplicationOutput.Type;
 ...
 */
export const CreateOAuthApplication = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: CreateOAuthApplicationInput,
    outputSchema: CreateOAuthApplicationOutput,
