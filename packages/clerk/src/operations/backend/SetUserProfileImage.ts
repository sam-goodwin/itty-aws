...
// Input Schema
export const SetUserProfileImageInput =
...
export type SetUserProfileImageInput = typeof SetUserProfileImageInput.Type;

// Output Schema
export const SetUserProfileImageOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.String,
...
export type SetUserProfileImageOutput = typeof SetUserProfileImageOutput.Type;
 ...
 */
export const SetUserProfileImage = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: SetUserProfileImageInput,
  outputSchema: SetUserProfileImageOutput,
