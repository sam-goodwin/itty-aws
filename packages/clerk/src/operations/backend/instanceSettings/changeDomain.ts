...
// Input Schema
export const ChangeDomainInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type ChangeDomainInput = typeof ChangeDomainInput.Type;

// Output Schema
export const ChangeDomainOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type ChangeDomainOutput = typeof ChangeDomainOutput.Type;
 ...
 */
export const changeDomain = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: ChangeDomainInput,
  outputSchema: ChangeDomainOutput,
