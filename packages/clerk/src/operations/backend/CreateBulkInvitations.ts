...
// Input Schema
export const CreateBulkInvitationsInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({}).pipe(
    T.Http({ method: "POST", path: "/invitations/bulk" }),
  );
export type CreateBulkInvitationsInput = typeof CreateBulkInvitationsInput.Type;

// Output Schema
export const CreateBulkInvitationsOutput =
...
export type CreateBulkInvitationsOutput =
  typeof CreateBulkInvitationsOutput.Type;
 ...
 */
export const CreateBulkInvitations = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: CreateBulkInvitationsInput,
    outputSchema: CreateBulkInvitationsOutput,
