...
// Input Schema
export const ReplaceUserMetadataInput =
...
export type ReplaceUserMetadataInput = typeof ReplaceUserMetadataInput.Type;

// Output Schema
export const ReplaceUserMetadataOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.String,
...
export type ReplaceUserMetadataOutput = typeof ReplaceUserMetadataOutput.Type;
 ...
 */
export const ReplaceUserMetadata = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: ReplaceUserMetadataInput,
  outputSchema: ReplaceUserMetadataOutput,
