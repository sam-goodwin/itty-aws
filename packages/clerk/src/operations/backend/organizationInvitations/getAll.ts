...
// Input Schema
export const GetAllInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type GetAllInput = typeof GetAllInput.Type;

// Output Schema
export const GetAllOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  data: Schema.Array(
    Schema.Struct({
...
export type GetAllOutput = typeof GetAllOutput.Type;
 ...
 */
export const getAll = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: GetAllInput,
  outputSchema: GetAllOutput,
