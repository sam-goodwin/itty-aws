...
// Input Schema
export const CreateOrganizationInvitationInput =
...
export type CreateOrganizationInvitationInput =
  typeof CreateOrganizationInvitationInput.Type;

// Output Schema
export const CreateOrganizationInvitationOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type CreateOrganizationInvitationOutput =
  typeof CreateOrganizationInvitationOutput.Type;
...
export const CreateOrganizationInvitation =
  /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
    inputSchema: CreateOrganizationInvitationInput,
    outputSchema: CreateOrganizationInvitationOutput,
    errors: [
      BadRequest,
      PaymentRequired,
      Forbidden,
