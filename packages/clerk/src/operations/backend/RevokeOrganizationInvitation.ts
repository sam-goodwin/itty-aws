...
// Input Schema
export const RevokeOrganizationInvitationInput =
...
export type RevokeOrganizationInvitationInput =
  typeof RevokeOrganizationInvitationInput.Type;

// Output Schema
export const RevokeOrganizationInvitationOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type RevokeOrganizationInvitationOutput =
  typeof RevokeOrganizationInvitationOutput.Type;
...
export const RevokeOrganizationInvitation =
  /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
    inputSchema: RevokeOrganizationInvitationInput,
    outputSchema: RevokeOrganizationInvitationOutput,
