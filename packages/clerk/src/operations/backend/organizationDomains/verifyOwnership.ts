...
// Input Schema
export const VerifyOwnershipInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type VerifyOwnershipInput = typeof VerifyOwnershipInput.Type;

// Output Schema
export const VerifyOwnershipOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type VerifyOwnershipOutput = typeof VerifyOwnershipOutput.Type;
 ...
 */
export const verifyOwnership = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: VerifyOwnershipInput,
  outputSchema: VerifyOwnershipOutput,
