...
// Input Schema
export const ListAllInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type ListAllInput = typeof ListAllInput.Type;

// Output Schema
export const ListAllOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  data: Schema.Array(
    Schema.Struct({
...
export type ListAllOutput = typeof ListAllOutput.Type;
 ...
 */
export const listAll = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: ListAllInput,
  outputSchema: ListAllOutput,
