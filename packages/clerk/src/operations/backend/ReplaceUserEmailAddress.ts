...
// Input Schema
export const ReplaceUserEmailAddressInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    user_id: Schema.String.pipe(T.PathParam()),
    email_address: Schema.String,
  }).pipe(T.Http({ method: "PUT", path: "/users/{user_id}/email_address" }));
export type ReplaceUserEmailAddressInput =
  typeof ReplaceUserEmailAddressInput.Type;

// Output Schema
export const ReplaceUserEmailAddressOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type ReplaceUserEmailAddressOutput =
  typeof ReplaceUserEmailAddressOutput.Type;
 ...
 */
export const ReplaceUserEmailAddress = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: ReplaceUserEmailAddressInput,
    outputSchema: ReplaceUserEmailAddressOutput,
