...
// Input Schema
export const ListStatementsInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  paginated: Schema.optional(Schema.Boolean),
  limit: Schema.optional(Schema.Number),
  offset: Schema.optional(Schema.Number),
}).pipe(T.Http({ method: "GET", path: "/billing/statements" }));
export type ListStatementsInput = typeof ListStatementsInput.Type;

// Output Schema
export const ListStatementsOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  data: Schema.Array(
    Schema.Struct({
...
export type ListStatementsOutput = typeof ListStatementsOutput.Type;
...
export const listStatements = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: ListStatementsInput,
  outputSchema: ListStatementsOutput,
