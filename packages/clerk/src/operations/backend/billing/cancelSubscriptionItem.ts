...
// Input Schema
export const CancelSubscriptionItemInput =
...
export type CancelSubscriptionItemInput =
  typeof CancelSubscriptionItemInput.Type;

// Output Schema
export const CancelSubscriptionItemOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type CancelSubscriptionItemOutput =
  typeof CancelSubscriptionItemOutput.Type;
 ...
 */
export const cancelSubscriptionItem = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: CancelSubscriptionItemInput,
    outputSchema: CancelSubscriptionItemOutput,
