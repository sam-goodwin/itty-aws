...
// Input Schema
export const GetStatementInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  statementID: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "GET", path: "/billing/statements/{statementID}" }));
export type GetStatementInput = typeof GetStatementInput.Type;

// Output Schema
export const GetStatementOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type GetStatementOutput = typeof GetStatementOutput.Type;
...
export const getStatement = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: GetStatementInput,
  outputSchema: GetStatementOutput,
