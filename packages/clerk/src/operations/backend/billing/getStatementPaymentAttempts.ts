...
// Input Schema
export const GetStatementPaymentAttemptsInput =
...
export type GetStatementPaymentAttemptsInput =
  typeof GetStatementPaymentAttemptsInput.Type;

// Output Schema
export const GetStatementPaymentAttemptsOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    data: Schema.Array(
      Schema.Struct({
...
export type GetStatementPaymentAttemptsOutput =
  typeof GetStatementPaymentAttemptsOutput.Type;
 ...
 */
export const getStatementPaymentAttempts = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: GetStatementPaymentAttemptsInput,
    outputSchema: GetStatementPaymentAttemptsOutput,
