...
// Input Schema
export const CreateBulkWaitlistEntriesInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({}).pipe(
    T.Http({ method: "POST", path: "/waitlist_entries/bulk" }),
  );
export type CreateBulkWaitlistEntriesInput =
  typeof CreateBulkWaitlistEntriesInput.Type;

// Output Schema
export const CreateBulkWaitlistEntriesOutput =
...
export type CreateBulkWaitlistEntriesOutput =
  typeof CreateBulkWaitlistEntriesOutput.Type;
 ...
 */
export const CreateBulkWaitlistEntries = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: CreateBulkWaitlistEntriesInput,
    outputSchema: CreateBulkWaitlistEntriesOutput,
