...
// Input Schema
export const DeleteMachineScopeInput =
...
export type DeleteMachineScopeInput = typeof DeleteMachineScopeInput.Type;

// Output Schema
export const DeleteMachineScopeOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type DeleteMachineScopeOutput = typeof DeleteMachineScopeOutput.Type;
 ...
 */
export const DeleteMachineScope = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: DeleteMachineScopeInput,
  outputSchema: DeleteMachineScopeOutput,
