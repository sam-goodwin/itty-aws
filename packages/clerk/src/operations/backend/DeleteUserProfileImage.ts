...
// Input Schema
export const DeleteUserProfileImageInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    user_id: Schema.String.pipe(T.PathParam()),
  }).pipe(T.Http({ method: "DELETE", path: "/users/{user_id}/profile_image" }));
export type DeleteUserProfileImageInput =
  typeof DeleteUserProfileImageInput.Type;

// Output Schema
export const DeleteUserProfileImageOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.String,
...
export type DeleteUserProfileImageOutput =
  typeof DeleteUserProfileImageOutput.Type;
 ...
 */
export const DeleteUserProfileImage = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: DeleteUserProfileImageInput,
    outputSchema: DeleteUserProfileImageOutput,
