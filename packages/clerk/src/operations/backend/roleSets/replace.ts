...
// Input Schema
export const ReplaceInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
// Output Schema
export const ReplaceOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type ReplaceOutput = typeof ReplaceOutput.Type;
 ...
 */
export const replace = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: ReplaceInput,
  outputSchema: ReplaceOutput,
