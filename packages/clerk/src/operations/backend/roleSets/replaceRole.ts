...
// Input Schema
export const ReplaceRoleInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type ReplaceRoleInput = typeof ReplaceRoleInput.Type;

// Output Schema
export const ReplaceRoleOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type ReplaceRoleOutput = typeof ReplaceRoleOutput.Type;
 ...
 */
export const replaceRole = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: ReplaceRoleInput,
  outputSchema: ReplaceRoleOutput,
