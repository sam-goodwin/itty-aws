...
// Input Schema
export const AddRolesInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type AddRolesInput = typeof AddRolesInput.Type;

// Output Schema
export const AddRolesOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type AddRolesOutput = typeof AddRolesOutput.Type;
 ...
 */
export const addRoles = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: AddRolesInput,
  outputSchema: AddRolesOutput,
