...
// Input Schema
export const UpdateMetadataInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
// Output Schema
export const UpdateMetadataOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String,
...
export type UpdateMetadataOutput = typeof UpdateMetadataOutput.Type;
 ...
 */
export const updateMetadata = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: UpdateMetadataInput,
  outputSchema: UpdateMetadataOutput,
