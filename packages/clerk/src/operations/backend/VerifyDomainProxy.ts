...
// Input Schema
export const VerifyDomainProxyInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct(
  {
    domain_id: Schema.optional(Schema.String),
    proxy_url: Schema.optional(Schema.String),
  },
).pipe(T.Http({ method: "POST", path: "/proxy_checks" }));
export type VerifyDomainProxyInput = typeof VerifyDomainProxyInput.Type;

// Output Schema
export const VerifyDomainProxyOutput =
...
export type VerifyDomainProxyOutput = typeof VerifyDomainProxyOutput.Type;
 ...
 */
export const VerifyDomainProxy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: VerifyDomainProxyInput,
  outputSchema: VerifyDomainProxyOutput,
