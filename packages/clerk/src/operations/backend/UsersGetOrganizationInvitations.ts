...
// Input Schema
export const UsersGetOrganizationInvitationsInput =
...
export type UsersGetOrganizationInvitationsInput =
  typeof UsersGetOrganizationInvitationsInput.Type;

// Output Schema
export const UsersGetOrganizationInvitationsOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    data: Schema.Array(
      Schema.Struct({
...
export type UsersGetOrganizationInvitationsOutput =
  typeof UsersGetOrganizationInvitationsOutput.Type;
 ...
 */
export const UsersGetOrganizationInvitations =
  /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
    inputSchema: UsersGetOrganizationInvitationsInput,
    outputSchema: UsersGetOrganizationInvitationsOutput,
