...
// Input Schema
export const UpdateEmailAddressInput =
...
export type UpdateEmailAddressInput = typeof UpdateEmailAddressInput.Type;

// Output Schema
export const UpdateEmailAddressOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type UpdateEmailAddressOutput = typeof UpdateEmailAddressOutput.Type;
 ...
 */
export const UpdateEmailAddress = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: UpdateEmailAddressInput,
  outputSchema: UpdateEmailAddressOutput,
