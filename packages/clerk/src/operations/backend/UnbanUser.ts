...
// Input Schema
export const UnbanUserInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  user_id: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "POST", path: "/users/{user_id}/unban" }));
export type UnbanUserInput = typeof UnbanUserInput.Type;

// Output Schema
export const UnbanUserOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String,
...
export type UnbanUserOutput = typeof UnbanUserOutput.Type;
 ...
 */
export const UnbanUser = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: UnbanUserInput,
  outputSchema: UnbanUserOutput,
