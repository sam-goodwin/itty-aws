...
// Input Schema
export const UpdateUserMetadataInput =
  ...
  }).pipe(T.Http({ method: "PATCH", path: "/users/{user_id}/metadata" }));
export type UpdateUserMetadataInput = typeof UpdateUserMetadataInput.Type;

// Output Schema
export const UpdateUserMetadataOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.String,
...
export type UpdateUserMetadataOutput = typeof UpdateUserMetadataOutput.Type;
 ...
 */
export const UpdateUserMetadata = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: UpdateUserMetadataInput,
  outputSchema: UpdateUserMetadataOutput,
