...
// Input Schema
export const CreateOrganizationInvitationBulkInput =
...
export type CreateOrganizationInvitationBulkInput =
  typeof CreateOrganizationInvitationBulkInput.Type;

// Output Schema
export const CreateOrganizationInvitationBulkOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    data: Schema.Array(
      Schema.Struct({
...
export type CreateOrganizationInvitationBulkOutput =
  typeof CreateOrganizationInvitationBulkOutput.Type;
 ...
 */
export const CreateOrganizationInvitationBulk =
  /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
    inputSchema: CreateOrganizationInvitationBulkInput,
    outputSchema: CreateOrganizationInvitationBulkOutput,
