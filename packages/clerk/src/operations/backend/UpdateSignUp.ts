...
// Input Schema
export const UpdateSignUpInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String.pipe(T.PathParam()),
  external_id: Schema.optional(Schema.NullOr(Schema.String)),
  custom_action: Schema.optional(Schema.NullOr(Schema.Boolean)),
}).pipe(T.Http({ method: "PATCH", path: "/sign_ups/{id}" }));
export type UpdateSignUpInput = typeof UpdateSignUpInput.Type;

// Output Schema
export const UpdateSignUpOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type UpdateSignUpOutput = typeof UpdateSignUpOutput.Type;
 ...
 */
export const UpdateSignUp = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: UpdateSignUpInput,
  outputSchema: UpdateSignUpOutput,
