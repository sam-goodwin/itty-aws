...
// Input Schema
export const ListOrganizationRolesInput =
...
export type ListOrganizationRolesInput = typeof ListOrganizationRolesInput.Type;

// Output Schema
export const ListOrganizationRolesOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    data: Schema.Array(
      Schema.Struct({
...
export type ListOrganizationRolesOutput =
  typeof ListOrganizationRolesOutput.Type;
 ...
 */
export const ListOrganizationRoles = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: ListOrganizationRolesInput,
    outputSchema: ListOrganizationRolesOutput,
