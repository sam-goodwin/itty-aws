...
// Input Schema
export const RotateOAuthApplicationSecretInput =
...
export type RotateOAuthApplicationSecretInput =
  typeof RotateOAuthApplicationSecretInput.Type;

// Output Schema
export const RotateOAuthApplicationSecretOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type RotateOAuthApplicationSecretOutput =
  typeof RotateOAuthApplicationSecretOutput.Type;
 ...
 */
export const RotateOAuthApplicationSecret =
  /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
    inputSchema: RotateOAuthApplicationSecretInput,
    outputSchema: RotateOAuthApplicationSecretOutput,
