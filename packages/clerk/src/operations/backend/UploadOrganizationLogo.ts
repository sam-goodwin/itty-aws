...
// Input Schema
export const UploadOrganizationLogoInput =
...
export type UploadOrganizationLogoInput =
  typeof UploadOrganizationLogoInput.Type;

// Output Schema
export const UploadOrganizationLogoOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type UploadOrganizationLogoOutput =
  typeof UploadOrganizationLogoOutput.Type;
 ...
 */
export const UploadOrganizationLogo = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: UploadOrganizationLogoInput,
    outputSchema: UploadOrganizationLogoOutput,
