...
// Input Schema
export const RevokeTokenInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
// Output Schema
export const RevokeTokenOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type RevokeTokenOutput = typeof RevokeTokenOutput.Type;
...
export const revokeToken = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  ...
  outputSchema: RevokeTokenOutput,
