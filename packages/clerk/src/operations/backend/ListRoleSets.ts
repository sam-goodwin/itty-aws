...
// Input Schema
export const ListRoleSetsInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  query: Schema.optional(Schema.String),
  order_by: Schema.optional(Schema.String),
  limit: Schema.optional(Schema.Number),
  offset: Schema.optional(Schema.Number),
}).pipe(T.Http({ method: "GET", path: "/role_sets" }));
export type ListRoleSetsInput = typeof ListRoleSetsInput.Type;

// Output Schema
export const ListRoleSetsOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  data: Schema.Array(
    Schema.Struct({
...
export type ListRoleSetsOutput = typeof ListRoleSetsOutput.Type;
 ...
 */
export const ListRoleSets = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: ListRoleSetsInput,
  outputSchema: ListRoleSetsOutput,
