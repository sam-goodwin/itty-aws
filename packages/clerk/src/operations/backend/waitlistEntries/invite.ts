...
// Input Schema
export const InviteInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
// Output Schema
export const InviteOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type InviteOutput = typeof InviteOutput.Type;
 ...
 */
export const invite = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: InviteInput,
  outputSchema: InviteOutput,
