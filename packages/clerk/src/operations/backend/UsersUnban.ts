...
import { BadRequest, PaymentRequired } from "../../errors.ts";

// Input Schema
export const UsersUnbanInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  user_ids: Schema.Array(Schema.String),
}).pipe(T.Http({ method: "POST", path: "/users/unban" }));
export type UsersUnbanInput = typeof UsersUnbanInput.Type;

// Output Schema
export const UsersUnbanOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Array(
  Schema.Struct({
    id: Schema.String,
...
export type UsersUnbanOutput = typeof UsersUnbanOutput.Type;
 ...
 */
export const UsersUnban = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: UsersUnbanInput,
  outputSchema: UsersUnbanOutput,
  errors: [BadRequest, PaymentRequired] as const,
}));
