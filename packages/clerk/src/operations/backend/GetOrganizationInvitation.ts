...
// Input Schema
export const GetOrganizationInvitationInput =
...
export type GetOrganizationInvitationInput =
  typeof GetOrganizationInvitationInput.Type;

// Output Schema
export const GetOrganizationInvitationOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type GetOrganizationInvitationOutput =
  typeof GetOrganizationInvitationOutput.Type;
 ...
 */
export const GetOrganizationInvitation = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: GetOrganizationInvitationInput,
    outputSchema: GetOrganizationInvitationOutput,
