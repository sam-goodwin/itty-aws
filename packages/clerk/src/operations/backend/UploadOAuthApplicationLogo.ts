...
// Input Schema
export const UploadOAuthApplicationLogoInput =
...
export type UploadOAuthApplicationLogoInput =
  typeof UploadOAuthApplicationLogoInput.Type;

// Output Schema
export const UploadOAuthApplicationLogoOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type UploadOAuthApplicationLogoOutput =
  typeof UploadOAuthApplicationLogoOutput.Type;
 ...
 */
export const UploadOAuthApplicationLogo = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: UploadOAuthApplicationLogoInput,
    outputSchema: UploadOAuthApplicationLogoOutput,
