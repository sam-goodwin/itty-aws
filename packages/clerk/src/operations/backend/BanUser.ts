...
// Input Schema
export const BanUserInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  user_id: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "POST", path: "/users/{user_id}/ban" }));
export type BanUserInput = typeof BanUserInput.Type;

// Output Schema
export const BanUserOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String,
...
export type BanUserOutput = typeof BanUserOutput.Type;
 ...
 */
export const BanUser = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: BanUserInput,
  outputSchema: BanUserOutput,
