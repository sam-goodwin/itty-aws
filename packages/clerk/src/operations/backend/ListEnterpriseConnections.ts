...
// Input Schema
export const ListEnterpriseConnectionsInput =
...
export type ListEnterpriseConnectionsInput =
  typeof ListEnterpriseConnectionsInput.Type;

// Output Schema
export const ListEnterpriseConnectionsOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    data: Schema.Array(
      Schema.Struct({
        id: Schema.String,
...
export type ListEnterpriseConnectionsOutput =
  typeof ListEnterpriseConnectionsOutput.Type;
 ...
 */
export const ListEnterpriseConnections = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: ListEnterpriseConnectionsInput,
    outputSchema: ListEnterpriseConnectionsOutput,
