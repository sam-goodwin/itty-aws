...
// Input Schema
export const UnsetUserPasswordCompromisedInput =
...
export type UnsetUserPasswordCompromisedInput =
  typeof UnsetUserPasswordCompromisedInput.Type;

// Output Schema
export const UnsetUserPasswordCompromisedOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.String,
...
export type UnsetUserPasswordCompromisedOutput =
  typeof UnsetUserPasswordCompromisedOutput.Type;
 ...
 */
export const UnsetUserPasswordCompromised =
  /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
    inputSchema: UnsetUserPasswordCompromisedInput,
    outputSchema: UnsetUserPasswordCompromisedOutput,
