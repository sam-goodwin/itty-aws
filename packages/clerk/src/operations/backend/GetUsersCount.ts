...
// Input Schema
export const GetUsersCountInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type GetUsersCountInput = typeof GetUsersCountInput.Type;

// Output Schema
export const GetUsersCountOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  object: Schema.Literals(["total_count"]),
  total_count: Schema.Number,
});
export type GetUsersCountOutput = typeof GetUsersCountOutput.Type;
...
export const GetUsersCount = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: GetUsersCountInput,
  outputSchema: GetUsersCountOutput,
