...
// Input Schema
export const GetSignUpInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "GET", path: "/sign_ups/{id}" }));
export type GetSignUpInput = typeof GetSignUpInput.Type;

// Output Schema
export const GetSignUpOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type GetSignUpOutput = typeof GetSignUpOutput.Type;
 ...
 */
export const GetSignUp = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: GetSignUpInput,
  outputSchema: GetSignUpOutput,
