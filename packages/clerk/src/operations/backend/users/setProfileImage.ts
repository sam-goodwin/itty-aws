...
// Input Schema
export const SetProfileImageInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type SetProfileImageInput = typeof SetProfileImageInput.Type;

// Output Schema
export const SetProfileImageOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String,
...
export type SetProfileImageOutput = typeof SetProfileImageOutput.Type;
 ...
 */
export const setProfileImage = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: SetProfileImageInput,
  outputSchema: SetProfileImageOutput,
