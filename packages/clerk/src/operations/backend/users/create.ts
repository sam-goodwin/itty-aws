...
export const CreateInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  email_address: Schema.optional(Schema.Array(Schema.String)),
  phone_number: Schema.optional(Schema.Array(Schema.String)),
  web3_wallet: Schema.optional(Schema.Array(Schema.String)),
  username: Schema.optional(Schema.NullOr(Schema.String)),
  password: Schema.optional(SensitiveNullableString),
  password_digest: Schema.optional(SensitiveNullableString),
  password_hasher: Schema.optional(Schema.String),
  skip_password_checks: Schema.optional(Schema.NullOr(Schema.Boolean)),
  skip_password_requirement: Schema.optional(Schema.NullOr(Schema.Boolean)),
  ...
  skip_user_requirement: Schema.optional(Schema.NullOr(Schema.Boolean)),
