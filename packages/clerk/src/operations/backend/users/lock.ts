...
// Input Schema
export const LockInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  user_id: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "POST", path: "/users/{user_id}/lock" }));
export type LockInput = typeof LockInput.Type;

// Output Schema
export const LockOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String,
...
export type LockOutput = typeof LockOutput.Type;
 ...
 */
export const lock = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: LockInput,
  outputSchema: LockOutput,
