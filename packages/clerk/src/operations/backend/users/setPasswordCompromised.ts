...
// Input Schema
export const SetPasswordCompromisedInput =
...
export type SetPasswordCompromisedInput =
  typeof SetPasswordCompromisedInput.Type;

// Output Schema
export const SetPasswordCompromisedOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.String,
...
export type SetPasswordCompromisedOutput =
  typeof SetPasswordCompromisedOutput.Type;
 ...
 */
export const setPasswordCompromised = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: SetPasswordCompromisedInput,
    outputSchema: SetPasswordCompromisedOutput,
