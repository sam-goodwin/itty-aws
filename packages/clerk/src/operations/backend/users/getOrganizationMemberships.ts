...
// Input Schema
export const GetOrganizationMembershipsInput =
...
export type GetOrganizationMembershipsInput =
  typeof GetOrganizationMembershipsInput.Type;

// Output Schema
export const GetOrganizationMembershipsOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    data: Schema.Array(
      Schema.Struct({
        id: Schema.String,
...
export type GetOrganizationMembershipsOutput =
  typeof GetOrganizationMembershipsOutput.Type;
 ...
 */
export const getOrganizationMemberships = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: GetOrganizationMembershipsInput,
    outputSchema: GetOrganizationMembershipsOutput,
