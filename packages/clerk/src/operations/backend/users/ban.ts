...
// Input Schema
export const BanInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  user_id: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "POST", path: "/users/{user_id}/ban" }));
export type BanInput = typeof BanInput.Type;

// Output Schema
export const BanOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String,
...
export type BanOutput = typeof BanOutput.Type;
 ...
 */
export const ban = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: BanInput,
  outputSchema: BanOutput,
