...
// Input Schema
export const BulkUnbanInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  user_ids: Schema.Array(Schema.String),
}).pipe(T.Http({ method: "POST", path: "/users/unban" }));
export type BulkUnbanInput = typeof BulkUnbanInput.Type;

// Output Schema
export const BulkUnbanOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Array(
  Schema.Struct({
    id: Schema.String,
...
export type BulkUnbanOutput = typeof BulkUnbanOutput.Type;
 ...
 */
export const bulkUnban = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: BulkUnbanInput,
  outputSchema: BulkUnbanOutput,
