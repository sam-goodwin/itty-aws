...
// Input Schema
export const ReplaceMetadataInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "PUT", path: "/users/{user_id}/metadata" }));
export type ReplaceMetadataInput = typeof ReplaceMetadataInput.Type;

// Output Schema
export const ReplaceMetadataOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String,
...
export type ReplaceMetadataOutput = typeof ReplaceMetadataOutput.Type;
 ...
 */
export const replaceMetadata = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: ReplaceMetadataInput,
  outputSchema: ReplaceMetadataOutput,
