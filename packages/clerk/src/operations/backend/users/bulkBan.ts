...
// Input Schema
export const BulkBanInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  user_ids: Schema.Array(Schema.String),
}).pipe(T.Http({ method: "POST", path: "/users/ban" }));
export type BulkBanInput = typeof BulkBanInput.Type;

// Output Schema
export const BulkBanOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Array(
  Schema.Struct({
    id: Schema.String,
...
export type BulkBanOutput = typeof BulkBanOutput.Type;
 ...
 */
export const bulkBan = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: BulkBanInput,
  outputSchema: BulkBanOutput,
