...
// Input Schema
export const UnlockInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  user_id: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "POST", path: "/users/{user_id}/unlock" }));
export type UnlockInput = typeof UnlockInput.Type;

// Output Schema
export const UnlockOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String,
...
export type UnlockOutput = typeof UnlockOutput.Type;
 ...
 */
export const unlock = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: UnlockInput,
  outputSchema: UnlockOutput,
