...
// Input Schema
export const UnbanInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  user_id: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "POST", path: "/users/{user_id}/unban" }));
export type UnbanInput = typeof UnbanInput.Type;

// Output Schema
export const UnbanOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String,
...
export type UnbanOutput = typeof UnbanOutput.Type;
 ...
 */
export const unban = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: UnbanInput,
  outputSchema: UnbanOutput,
