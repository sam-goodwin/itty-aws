...
// Input Schema
export const UnsetPasswordCompromisedInput =
...
export type UnsetPasswordCompromisedInput =
  typeof UnsetPasswordCompromisedInput.Type;

// Output Schema
export const UnsetPasswordCompromisedOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.String,
...
export type UnsetPasswordCompromisedOutput =
  typeof UnsetPasswordCompromisedOutput.Type;
 ...
 */
export const unsetPasswordCompromised = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: UnsetPasswordCompromisedInput,
    outputSchema: UnsetPasswordCompromisedOutput,
