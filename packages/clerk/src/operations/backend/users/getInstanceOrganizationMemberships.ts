...
// Input Schema
export const GetInstanceOrganizationMembershipsInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    order_by: Schema.optional(Schema.String),
    limit: Schema.optional(Schema.Number),
    offset: Schema.optional(Schema.Number),
  }).pipe(T.Http({ method: "GET", path: "/organization_memberships" }));
export type GetInstanceOrganizationMembershipsInput =
  typeof GetInstanceOrganizationMembershipsInput.Type;

// Output Schema
export const GetInstanceOrganizationMembershipsOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    data: Schema.Array(
      Schema.Struct({
        id: Schema.String,
...
export type GetInstanceOrganizationMembershipsOutput =
  typeof GetInstanceOrganizationMembershipsOutput.Type;
 ...
 */
export const getInstanceOrganizationMemberships =
  /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
    inputSchema: GetInstanceOrganizationMembershipsInput,
    outputSchema: GetInstanceOrganizationMembershipsOutput,
