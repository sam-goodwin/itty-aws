...
// Input Schema
export const DeleteProfileImageInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    user_id: Schema.String.pipe(T.PathParam()),
  }).pipe(T.Http({ method: "DELETE", path: "/users/{user_id}/profile_image" }));
export type DeleteProfileImageInput = typeof DeleteProfileImageInput.Type;

// Output Schema
export const DeleteProfileImageOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.String,
...
export type DeleteProfileImageOutput = typeof DeleteProfileImageOutput.Type;
 ...
 */
export const deleteProfileImage = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: DeleteProfileImageInput,
  outputSchema: DeleteProfileImageOutput,
