...
// Input Schema
export const GetClientInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  client_id: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "GET", path: "/clients/{client_id}" }));
export type GetClientInput = typeof GetClientInput.Type;

// Output Schema
export const GetClientOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type GetClientOutput = typeof GetClientOutput.Type;
 ...
 */
export const GetClient = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
