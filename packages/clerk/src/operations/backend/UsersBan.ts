...
// Input Schema
export const UsersBanInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  user_ids: Schema.Array(Schema.String),
}).pipe(T.Http({ method: "POST", path: "/users/ban" }));
export type UsersBanInput = typeof UsersBanInput.Type;

// Output Schema
export const UsersBanOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Array(
  Schema.Struct({
    id: Schema.String,
...
export type UsersBanOutput = typeof UsersBanOutput.Type;
 ...
 */
export const UsersBan = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: UsersBanInput,
  outputSchema: UsersBanOutput,
