...
// Input Schema
export const CreateRoleSetInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  name: Schema.String,
...
export type CreateRoleSetInput = typeof CreateRoleSetInput.Type;

// Output Schema
export const CreateRoleSetOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type CreateRoleSetOutput = typeof CreateRoleSetOutput.Type;
 ...
 */
export const CreateRoleSet = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: CreateRoleSetInput,
  outputSchema: CreateRoleSetOutput,
  errors: [
    BadRequest,
    PaymentRequired,
    Forbidden,
