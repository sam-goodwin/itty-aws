...
// Input Schema
export const MergeOrganizationMetadataInput =
...
export type MergeOrganizationMetadataInput =
  typeof MergeOrganizationMetadataInput.Type;

// Output Schema
export const MergeOrganizationMetadataOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type MergeOrganizationMetadataOutput =
  typeof MergeOrganizationMetadataOutput.Type;
 ...
 */
export const MergeOrganizationMetadata = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: MergeOrganizationMetadataInput,
    outputSchema: MergeOrganizationMetadataOutput,
