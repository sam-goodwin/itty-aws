...
// Input Schema
export const DeleteOrganizationMembershipInput =
...
export type DeleteOrganizationMembershipInput =
  typeof DeleteOrganizationMembershipInput.Type;

// Output Schema
export const DeleteOrganizationMembershipOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.String,
...
export type DeleteOrganizationMembershipOutput =
  typeof DeleteOrganizationMembershipOutput.Type;
...
export const DeleteOrganizationMembership =
  /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
    inputSchema: DeleteOrganizationMembershipInput,
    outputSchema: DeleteOrganizationMembershipOutput,
