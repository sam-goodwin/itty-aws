...
// Input Schema
export const UpdateOrganizationMembershipMetadataInput =
...
export type UpdateOrganizationMembershipMetadataInput =
  typeof UpdateOrganizationMembershipMetadataInput.Type;

// Output Schema
export const UpdateOrganizationMembershipMetadataOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.String,
...
export type UpdateOrganizationMembershipMetadataOutput =
  typeof UpdateOrganizationMembershipMetadataOutput.Type;
 ...
 */
export const UpdateOrganizationMembershipMetadata =
  /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
    inputSchema: UpdateOrganizationMembershipMetadataInput,
    outputSchema: UpdateOrganizationMembershipMetadataOutput,
