...
// Input Schema
export const UpdateOrganizationDomainInput =
...
export type UpdateOrganizationDomainInput =
  typeof UpdateOrganizationDomainInput.Type;

// Output Schema
export const UpdateOrganizationDomainOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type UpdateOrganizationDomainOutput =
  typeof UpdateOrganizationDomainOutput.Type;
 ...
 */
export const UpdateOrganizationDomain = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: UpdateOrganizationDomainInput,
    outputSchema: UpdateOrganizationDomainOutput,
