...
// Input Schema
export const VerifyClientInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  token: Schema.String,
}).pipe(T.Http({ method: "POST", path: "/clients/verify" }));
export type VerifyClientInput = typeof VerifyClientInput.Type;

// Output Schema
export const VerifyClientOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type VerifyClientOutput = typeof VerifyClientOutput.Type;
 ...
 */
export const VerifyClient = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: VerifyClientInput,
  outputSchema: VerifyClientOutput,
