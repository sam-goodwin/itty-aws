...
// Input Schema
export const ListInstanceUsersInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct(
  {
...
export type ListInstanceUsersInput = typeof ListInstanceUsersInput.Type;

// Output Schema
export const ListInstanceUsersOutput =
...
export type ListInstanceUsersOutput = typeof ListInstanceUsersOutput.Type;
 ...
 */
export const listInstanceUsers = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: ListInstanceUsersInput,
  outputSchema: ListInstanceUsersOutput,
