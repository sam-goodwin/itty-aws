...
// Input Schema
export const PlatformPutConfigInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct(
  {
...
export type PlatformPutConfigInput = typeof PlatformPutConfigInput.Type;

// Output Schema
export const PlatformPutConfigOutput =
...
export type PlatformPutConfigOutput = typeof PlatformPutConfigOutput.Type;
 ...
 */
export const PlatformPutConfig = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: PlatformPutConfigInput,
  outputSchema: PlatformPutConfigOutput,
  errors: [
    BadRequest,
    PaymentRequired,
    Forbidden,
