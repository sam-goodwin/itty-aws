...
// Input Schema
export const PlatformGetApplicationInput =
...
export type PlatformGetApplicationInput =
  typeof PlatformGetApplicationInput.Type;

// Output Schema
export const PlatformGetApplicationOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type PlatformGetApplicationOutput =
  typeof PlatformGetApplicationOutput.Type;
 ...
 */
export const PlatformGetApplication = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: PlatformGetApplicationInput,
    outputSchema: PlatformGetApplicationOutput,
