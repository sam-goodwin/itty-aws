...
// Input Schema
export const PlatformListInstanceUsersInput =
...
export type PlatformListInstanceUsersInput =
  typeof PlatformListInstanceUsersInput.Type;

// Output Schema
export const PlatformListInstanceUsersOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    data: Schema.Array(
      Schema.Struct({
        id: Schema.String,
        ...
        external_accounts: Schema.Array(
          Schema.Struct({
            ...
            email_address: Schema.String,
            email_address_verified: Schema.optional(
        ...
        saml_accounts: Schema.Array(
          Schema.Struct({
            ...
            last_authenticated_at: Schema.optional(
        ...
        enterprise_accounts: Schema.Array(
          Schema.Struct({
            ...
            last_name: Schema.optional(Schema.NullOr(Schema.String)),
            provider_user_id: Schema.optional(Schema.NullOr(Schema.String)),
            enterprise_connection_id: Schema.optional(
        ...
        create_organizations_limit: Schema.optional(
          Schema.NullOr(Schema.Number),
        ),
...
export type PlatformListInstanceUsersOutput =
  typeof PlatformListInstanceUsersOutput.Type;
 ...
 * @param query - A search query to filter users. Searches across email addresses, phone numbers,
usernames, web3 wallets, user IDs, first names, and last names.

 * @param order_by - Field to order results by. Prefix with `+` for ascending or `-` for descending order.
 ...
 */
export const PlatformListInstanceUsers = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: PlatformListInstanceUsersInput,
    outputSchema: PlatformListInstanceUsersOutput,
