...
// Input Schema
export const TriggerDNSCheckInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type TriggerDNSCheckInput = typeof TriggerDNSCheckInput.Type;

// Output Schema
export const TriggerDNSCheckOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  dns: Schema.Struct({
...
export type TriggerDNSCheckOutput = typeof TriggerDNSCheckOutput.Type;
 ...
 */
export const triggerDNSCheck = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: TriggerDNSCheckInput,
  outputSchema: TriggerDNSCheckOutput,
