...
// Input Schema
export const CreateApplicationDomainInput =
...
export type CreateApplicationDomainInput =
  typeof CreateApplicationDomainInput.Type;

// Output Schema
export const CreateApplicationDomainOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type CreateApplicationDomainOutput =
  typeof CreateApplicationDomainOutput.Type;
 ...
 */
export const createApplicationDomain = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: CreateApplicationDomainInput,
    outputSchema: CreateApplicationDomainOutput,
    errors: [
      BadRequest,
      Forbidden,
      NotFound,
