...
// Input Schema
export const ListApplicationDomainsInput =
...
export type ListApplicationDomainsInput =
  typeof ListApplicationDomainsInput.Type;

// Output Schema
export const ListApplicationDomainsOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    data: Schema.Array(
      Schema.Struct({
...
export type ListApplicationDomainsOutput =
  typeof ListApplicationDomainsOutput.Type;
 ...
 */
export const listApplicationDomains = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: ListApplicationDomainsInput,
