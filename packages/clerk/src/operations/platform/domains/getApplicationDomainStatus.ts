...
// Input Schema
export const GetApplicationDomainStatusInput =
...
export type GetApplicationDomainStatusInput =
  typeof GetApplicationDomainStatusInput.Type;

// Output Schema
export const GetApplicationDomainStatusOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    dns: Schema.Struct({
...
export type GetApplicationDomainStatusOutput =
  typeof GetApplicationDomainStatusOutput.Type;
 ...
 */
export const getApplicationDomainStatus = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: GetApplicationDomainStatusInput,
    outputSchema: GetApplicationDomainStatusOutput,
