...
// Input Schema
export const UpdateApplicationDomainInput =
...
export type UpdateApplicationDomainInput =
  typeof UpdateApplicationDomainInput.Type;

// Output Schema
export const UpdateApplicationDomainOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type UpdateApplicationDomainOutput =
  typeof UpdateApplicationDomainOutput.Type;
 ...
 */
export const updateApplicationDomain = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: UpdateApplicationDomainInput,
