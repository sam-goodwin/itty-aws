...
// Input Schema
export const PlatformUnbanUserInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct(
  {
...
export type PlatformUnbanUserInput = typeof PlatformUnbanUserInput.Type;

// Output Schema
export const PlatformUnbanUserOutput =
...
export type PlatformUnbanUserOutput = typeof PlatformUnbanUserOutput.Type;
 ...
 */
export const PlatformUnbanUser = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: PlatformUnbanUserInput,
  outputSchema: PlatformUnbanUserOutput,
