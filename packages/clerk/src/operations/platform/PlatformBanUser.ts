...
// Input Schema
export const PlatformBanUserInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type PlatformBanUserInput = typeof PlatformBanUserInput.Type;

// Output Schema
export const PlatformBanUserOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String,
...
export type PlatformBanUserOutput = typeof PlatformBanUserOutput.Type;
 ...
 */
export const PlatformBanUser = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: PlatformBanUserInput,
  outputSchema: PlatformBanUserOutput,
