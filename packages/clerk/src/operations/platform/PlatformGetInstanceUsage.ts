...
// Input Schema
export const PlatformGetInstanceUsageInput =
...
export type PlatformGetInstanceUsageInput =
  typeof PlatformGetInstanceUsageInput.Type;

// Output Schema
export const PlatformGetInstanceUsageOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type PlatformGetInstanceUsageOutput =
  typeof PlatformGetInstanceUsageOutput.Type;
 ...
 */
export const PlatformGetInstanceUsage = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: PlatformGetInstanceUsageInput,
    outputSchema: PlatformGetInstanceUsageOutput,
