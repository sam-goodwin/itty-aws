...
// Input Schema
export const PlatformUpdateJWTTemplateInput =
...
export type PlatformUpdateJWTTemplateInput =
  typeof PlatformUpdateJWTTemplateInput.Type;

// Output Schema
export const PlatformUpdateJWTTemplateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type PlatformUpdateJWTTemplateOutput =
  typeof PlatformUpdateJWTTemplateOutput.Type;
 ...
 */
export const PlatformUpdateJWTTemplate = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: PlatformUpdateJWTTemplateInput,
    outputSchema: PlatformUpdateJWTTemplateOutput,
    errors: [
      BadRequest,
      PaymentRequired,
      Forbidden,
