...
// Input Schema
export const PlatformClaimAccountlessApplicationInput =
...
export type PlatformClaimAccountlessApplicationInput =
  typeof PlatformClaimAccountlessApplicationInput.Type;

// Output Schema
export const PlatformClaimAccountlessApplicationOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type PlatformClaimAccountlessApplicationOutput =
  typeof PlatformClaimAccountlessApplicationOutput.Type;
 ...
 */
export const PlatformClaimAccountlessApplication =
  /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
    inputSchema: PlatformClaimAccountlessApplicationInput,
    outputSchema: PlatformClaimAccountlessApplicationOutput,
