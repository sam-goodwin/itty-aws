...
// Input Schema
export const PlatformCreateApplicationTransferInput =
...
export type PlatformCreateApplicationTransferInput =
  typeof PlatformCreateApplicationTransferInput.Type;

// Output Schema
export const PlatformCreateApplicationTransferOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type PlatformCreateApplicationTransferOutput =
  typeof PlatformCreateApplicationTransferOutput.Type;
 ...
 */
export const PlatformCreateApplicationTransfer =
  /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
    inputSchema: PlatformCreateApplicationTransferInput,
    outputSchema: PlatformCreateApplicationTransferOutput,
