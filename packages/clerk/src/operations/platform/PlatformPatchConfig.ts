...
// Input Schema
export const PlatformPatchConfigInput =
...
export type PlatformPatchConfigInput = typeof PlatformPatchConfigInput.Type;

// Output Schema
export const PlatformPatchConfigOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type PlatformPatchConfigOutput = typeof PlatformPatchConfigOutput.Type;
 ...
 */
export const PlatformPatchConfig = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: PlatformPatchConfigInput,
  outputSchema: PlatformPatchConfigOutput,
  errors: [
    BadRequest,
    PaymentRequired,
    Forbidden,
