...
// Input Schema
export const PlatformListApplicationTransfersInput =
...
export type PlatformListApplicationTransfersInput =
  typeof PlatformListApplicationTransfersInput.Type;

// Output Schema
export const PlatformListApplicationTransfersOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    data: Schema.Array(
      Schema.Struct({
...
export type PlatformListApplicationTransfersOutput =
  typeof PlatformListApplicationTransfersOutput.Type;
...
export const PlatformListApplicationTransfers =
  /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
    inputSchema: PlatformListApplicationTransfersInput,
    outputSchema: PlatformListApplicationTransfersOutput,
