 ...
 *
 * Re-exports the common HTTP errors from core and adds the Temporal fallback
...
/** Unknown Temporal error — returned when nothing else matches the failure. */
export class UnknownTemporalError extends Schema.TaggedError<UnknownTemporalError>()(
...
export class TemporalParseError extends Schema.TaggedError<TemporalParseError>()(
  "TemporalParseError",
  {
    body: Schema.Unknown,
