...
export const V2Key: Schema.Schema<V2Key> = /*@__PURE__*/ Schema.Struct({
...
export const CreateProjectsLocationsKeysRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetProjectsLocationsKeysRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
...
export const UndeleteProjectsLocationsKeysRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
...
export const ListProjectsLocationsKeysRequest = /*@__PURE__*/ Schema.Struct({
...
export const PatchProjectsLocationsKeysRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const DeleteProjectsLocationsKeysRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
