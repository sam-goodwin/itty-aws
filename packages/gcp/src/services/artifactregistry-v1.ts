...
export const PlatformLogsConfig: Schema.Schema<PlatformLogsConfig> =
  ...
  }) as any as Schema.Schema<PlatformLogsConfig>;
...
export const ProjectConfig: Schema.Schema<ProjectConfig> =
  ...
  }) as any as Schema.Schema<ProjectConfig>;
...
export const UpdateProjectConfigProjectsLocationsRequest =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({
      method: "PATCH",
      path: "v1/projects/{projectsId}/locations/{locationsId}/projectConfig",
      hasBody: true,
    }),
    svc,
...
export type UpdateProjectConfigProjectsLocationsError = DefaultErrors;
...
export type GetProjectConfigProjectsLocationsError = DefaultErrors;
