...
export const GroupItem: Schema.Schema<GroupItem> = /*@__PURE__*/ Schema.Struct({
  kind: Schema.optional(Schema.String),
...
export const DeleteGroupItemsRequest = /*@__PURE__*/ Schema.Struct({
...
export const InsertGroupItemsRequest = /*@__PURE__*/ Schema.Struct({
  onBehalfOfContentOwner: Schema.optional(Schema.String).pipe(
    T.HttpQuery("onBehalfOfContentOwner"),
  ),
