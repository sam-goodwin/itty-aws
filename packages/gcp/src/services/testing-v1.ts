...
export const LabInfo: Schema.Schema<LabInfo> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const Locale: Schema.Schema<Locale> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
  tags: Schema.optional(Schema.Array(Schema.String)),
  id: Schema.optional(Schema.String),
...
export const IosDevice: Schema.Schema<IosDevice> = /*@__PURE__*/ Schema.Struct({
...
export const NoActivityIntent: Schema.Schema<NoActivityIntent> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "NoActivityIntent" });
...
export const ApkSplits: Schema.Schema<ApkSplits> = /*@__PURE__*/ Schema.Struct({
...
export const AppBundle: Schema.Schema<AppBundle> = /*@__PURE__*/ Schema.Struct({
...
export const GoogleAuto: Schema.Schema<GoogleAuto> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "GoogleAuto" });
...
export const ObbFile: Schema.Schema<ObbFile> = /*@__PURE__*/ Schema.Struct({
...
export const TestSetup: Schema.Schema<TestSetup> = /*@__PURE__*/ Schema.Struct({
...
export const Shard: Schema.Schema<Shard> = /*@__PURE__*/ Schema.Struct({
...
export const ApkDetail: Schema.Schema<ApkDetail> = /*@__PURE__*/ Schema.Struct({
...
export const IosModel: Schema.Schema<IosModel> = /*@__PURE__*/ Schema.Struct({
  supportedVersionIds: Schema.optional(Schema.Array(Schema.String)),
...
export const GetTestEnvironmentCatalogRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetProjectsTestMatricesRequest = /*@__PURE__*/ Schema.Struct({
...
export const CancelProjectsTestMatricesRequest = /*@__PURE__*/ Schema.Struct({
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
  testMatrixId: Schema.String.pipe(T.HttpPath("testMatrixId")),
}).pipe(
  T.Http({
...
export const CreateProjectsTestMatricesRequest = /*@__PURE__*/ Schema.Struct({
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
...
export const ListProjectsDeviceSessionsRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetProjectsDeviceSessionsRequest = /*@__PURE__*/ Schema.Struct({
...
export const CancelProjectsDeviceSessionsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const PatchProjectsDeviceSessionsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const CreateProjectsDeviceSessionsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(DeviceSession).pipe(T.HttpBody()),
}).pipe(
  T.Http({
