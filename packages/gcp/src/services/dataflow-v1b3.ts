...
export const Parameter: Schema.Schema<Parameter> = /*@__PURE__*/ Schema.Struct({
  key: Schema.optional(Schema.String),
...
export const Stack: Schema.Schema<Stack> = /*@__PURE__*/ Schema.Struct({
...
export const SdkBug: Schema.Schema<SdkBug> = /*@__PURE__*/ Schema.Struct({
...
export const Point: Schema.Schema<Point> = /*@__PURE__*/ Schema.Struct({
  time: Schema.optional(Schema.String),
...
export const Position: Schema.Schema<Position> = /*@__PURE__*/ Schema.suspend(
  () =>
    Schema.Struct({
...
export const ShellTask: Schema.Schema<ShellTask> = /*@__PURE__*/ Schema.Struct({
...
export const Sink: Schema.Schema<Sink> = /*@__PURE__*/ Schema.Struct({
  codec: Schema.optional(Schema.Record(Schema.String, Schema.Unknown)),
  spec: Schema.optional(Schema.Record(Schema.String, Schema.Unknown)),
...
export const MapTask: Schema.Schema<MapTask> = /*@__PURE__*/ Schema.Struct({
  instructions: Schema.optional(Schema.Array(ParallelInstruction)),
  systemName: Schema.optional(Schema.String),
  stageName: Schema.optional(Schema.String),
...
export const WorkItem: Schema.Schema<WorkItem> = /*@__PURE__*/ Schema.Struct({
  projectId: Schema.optional(Schema.String),
...
export const GPUUsage: Schema.Schema<GPUUsage> = /*@__PURE__*/ Schema.Struct({
...
export const CPUTime: Schema.Schema<CPUTime> = /*@__PURE__*/ Schema.Struct({
  timestamp: Schema.optional(Schema.String),
...
export const MemInfo: Schema.Schema<MemInfo> = /*@__PURE__*/ Schema.Struct({
...
export const Histogram: Schema.Schema<Histogram> = /*@__PURE__*/ Schema.Struct({
  bucketCounts: Schema.optional(Schema.Array(Schema.String)),
...
export const SDKInfo: Schema.Schema<SDKInfo> = /*@__PURE__*/ Schema.Struct({
...
export const Straggler: Schema.Schema<Straggler> = /*@__PURE__*/ Schema.Struct({
...
export const Sdk: Schema.Schema<Sdk> = /*@__PURE__*/ Schema.Struct({
...
export const DeleteSnapshotsProjectsRequest = /*@__PURE__*/ Schema.Struct({
...
export const WorkerMessagesProjectsRequest = /*@__PURE__*/ Schema.Struct({
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
...
export const UpdateProjectsLocationsJobsRequest = /*@__PURE__*/ Schema.Struct({
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
  location: Schema.String.pipe(T.HttpPath("location")),
...
export const SnapshotProjectsLocationsJobsRequest = /*@__PURE__*/ Schema.Struct(
  {
    location: Schema.String.pipe(T.HttpPath("location")),
    jobId: Schema.String.pipe(T.HttpPath("jobId")),
    projectId: Schema.String.pipe(T.HttpPath("projectId")),
...
export const GetProjectsLocationsSnapshotsRequest = /*@__PURE__*/ Schema.Struct(
  {
    location: Schema.String.pipe(T.HttpPath("location")),
    snapshotId: Schema.String.pipe(T.HttpPath("snapshotId")),
    projectId: Schema.String.pipe(T.HttpPath("projectId")),
...
export const SnapshotProjectsJobsRequest = /*@__PURE__*/ Schema.Struct({
  jobId: Schema.String.pipe(T.HttpPath("jobId")),
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
  body: Schema.optional(SnapshotJobRequest).pipe(T.HttpBody()),
}).pipe(
...
export const AggregatedProjectsJobsRequest = /*@__PURE__*/ Schema.Struct({
  location: Schema.optional(Schema.String).pipe(T.HttpQuery("location")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  name: Schema.optional(Schema.String).pipe(T.HttpQuery("name")),
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
...
export const GetMetricsProjectsJobsRequest = /*@__PURE__*/ Schema.Struct({
  startTime: Schema.optional(Schema.String).pipe(T.HttpQuery("startTime")),
  jobId: Schema.String.pipe(T.HttpPath("jobId")),
  location: Schema.optional(Schema.String).pipe(T.HttpQuery("location")),
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
...
export const CreateProjectsJobsRequest = /*@__PURE__*/ Schema.Struct({
  replaceJobId: Schema.optional(Schema.String).pipe(
    T.HttpQuery("replaceJobId"),
  ),
  location: Schema.optional(Schema.String).pipe(T.HttpQuery("location")),
...
export const ListProjectsJobsRequest = /*@__PURE__*/ Schema.Struct({
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
  view: Schema.optional(Schema.String).pipe(T.HttpQuery("view")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  name: Schema.optional(Schema.String).pipe(T.HttpQuery("name")),
...
export const UpdateProjectsJobsRequest = /*@__PURE__*/ Schema.Struct({
  jobId: Schema.String.pipe(T.HttpPath("jobId")),
  location: Schema.optional(Schema.String).pipe(T.HttpQuery("location")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
...
export const ListProjectsJobsMessagesRequest = /*@__PURE__*/ Schema.Struct({
  startTime: Schema.optional(Schema.String).pipe(T.HttpQuery("startTime")),
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  endTime: Schema.optional(Schema.String).pipe(T.HttpQuery("endTime")),
...
export const SendCaptureProjectsJobsDebugRequest = /*@__PURE__*/ Schema.Struct({
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
  jobId: Schema.String.pipe(T.HttpPath("jobId")),
  body: Schema.optional(SendDebugCaptureRequest).pipe(T.HttpBody()),
}).pipe(
...
export const GetConfigProjectsJobsDebugRequest = /*@__PURE__*/ Schema.Struct({
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
  jobId: Schema.String.pipe(T.HttpPath("jobId")),
  body: Schema.optional(GetDebugConfigRequest).pipe(T.HttpBody()),
}).pipe(
...
export const LeaseProjectsJobsWorkItemsRequest = /*@__PURE__*/ Schema.Struct({
  jobId: Schema.String.pipe(T.HttpPath("jobId")),
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
  body: Schema.optional(LeaseWorkItemRequest).pipe(T.HttpBody()),
}).pipe(
...
export const CreateProjectsTemplatesRequest = /*@__PURE__*/ Schema.Struct({
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
  body: Schema.optional(CreateJobFromTemplateRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({
...
export const LaunchProjectsTemplatesRequest = /*@__PURE__*/ Schema.Struct({
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
  validateOnly: Schema.optional(Schema.Boolean).pipe(
    T.HttpQuery("validateOnly"),
  ),
...
export const GetProjectsTemplatesRequest = /*@__PURE__*/ Schema.Struct({
  gcsPath: Schema.optional(Schema.String).pipe(T.HttpQuery("gcsPath")),
  location: Schema.optional(Schema.String).pipe(T.HttpQuery("location")),
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
  view: Schema.optional(Schema.String).pipe(T.HttpQuery("view")),
