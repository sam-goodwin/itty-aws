...
export const RunAccessReportAccountsRequest = /*@__PURE__*/ Schema.Struct({
...
export const ListAccountSummariesRequest = /*@__PURE__*/ Schema.Struct({
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
}).pipe(
...
export const CreatePropertiesRequest = /*@__PURE__*/ Schema.Struct({
...
export const RunAccessReportPropertiesRequest = /*@__PURE__*/ Schema.Struct({
  entity: Schema.String.pipe(T.HttpPath("entity")),
  body: Schema.optional(GoogleAnalyticsAdminV1betaRunAccessReportRequest).pipe(
    T.HttpBody(),
  ),
...
export const DeletePropertiesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "DELETE", path: "v1beta/{+name}" }),
  svc,
...
export const GetPropertiesCustomDimensionsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
  },
).pipe(
...
export const ListPropertiesGoogleAdsLinksRequest = /*@__PURE__*/ Schema.Struct({
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
}).pipe(
...
export const PatchPropertiesGoogleAdsLinksRequest = /*@__PURE__*/ Schema.Struct(
  {
    updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
    name: Schema.String.pipe(T.HttpPath("name")),
    body: Schema.optional(GoogleAnalyticsAdminV1betaGoogleAdsLink).pipe(
...
export const GetPropertiesConversionEventsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
  },
).pipe(
...
export const ListPropertiesFirebaseLinksRequest = /*@__PURE__*/ Schema.Struct({
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
}).pipe(
...
export const CreatePropertiesFirebaseLinksRequest = /*@__PURE__*/ Schema.Struct(
  {
    parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const DeletePropertiesFirebaseLinksRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
  },
).pipe(
...
export const CreatePropertiesCustomMetricsRequest = /*@__PURE__*/ Schema.Struct(
  {
    parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const PatchPropertiesCustomMetricsRequest = /*@__PURE__*/ Schema.Struct({
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(GoogleAnalyticsAdminV1betaCustomMetric).pipe(
    T.HttpBody(),
...
export const GetPropertiesCustomMetricsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta/{+name}" }),
  svc,
...
export const ListPropertiesCustomMetricsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
}).pipe(
...
export const PatchPropertiesDataStreamsRequest = /*@__PURE__*/ Schema.Struct({
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const GetPropertiesDataStreamsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta/{+name}" }),
  svc,
...
export const DeletePropertiesDataStreamsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "DELETE", path: "v1beta/{+name}" }),
  svc,
...
export const ListPropertiesDataStreamsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
}).pipe(
...
export const CreatePropertiesDataStreamsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleAnalyticsAdminV1betaDataStream).pipe(
    T.HttpBody(),
  ),
...
export const PatchPropertiesKeyEventsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
...
export const GetPropertiesKeyEventsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta/{+name}" }),
  svc,
...
export const DeletePropertiesKeyEventsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "DELETE", path: "v1beta/{+name}" }),
  svc,
...
export const ListPropertiesKeyEventsRequest = /*@__PURE__*/ Schema.Struct({
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
}).pipe(
...
export const CreatePropertiesKeyEventsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleAnalyticsAdminV1betaKeyEvent).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1beta/{+parent}/keyEvents", hasBody: true }),
  svc,
