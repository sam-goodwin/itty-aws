...
export type NotificationChannelStrategyList = NotificationChannelStrategy[];
...
export type CollectdValueList = CollectdValue[];
...
export type CollectdPayloadList = CollectdPayload[];
...
export type CollectdValueErrorList = CollectdValueError[];
...
export type CollectdPayloadErrorList = CollectdPayloadError[];
...
export type Monitoring_ErrorList = Monitoring_Error[];
...
export type MutationRecordList = MutationRecord[];
...
export type InternalCheckerList = InternalChecker[];
...
export type ResponseStatusCodeList = ResponseStatusCode[];
...
export type ContentMatcherList = ContentMatcher[];
...
export type AlertPolicyList = AlertPolicy[];
...
export type NotificationChannelDescriptorList = NotificationChannelDescriptor[];
...
export type UptimeCheckConfigList = UptimeCheckConfig[];
...
export type ServiceLevelObjectiveList = ServiceLevelObjective[];
...
export type UptimeCheckIpList = UptimeCheckIp[];
...
export type ValueDescriptorList = ValueDescriptor[];
...
export type TypedValueList = TypedValue[];
...
export type PointDataList = PointData[];
...
export type TimeSeriesDataList = TimeSeriesData[];
