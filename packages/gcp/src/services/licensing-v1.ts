...
export const UpdateLicenseAssignmentsRequest = /*@__PURE__*/ Schema.Struct({
...
export const PatchLicenseAssignmentsRequest = /*@__PURE__*/ Schema.Struct({
  productId: Schema.String.pipe(T.HttpPath("productId")),
  skuId: Schema.String.pipe(T.HttpPath("skuId")),
  userId: Schema.String.pipe(T.HttpPath("userId")),
  body: Schema.optional(LicenseAssignment).pipe(T.HttpBody()),
...
export const InsertLicenseAssignmentsRequest = /*@__PURE__*/ Schema.Struct({
  productId: Schema.String.pipe(T.HttpPath("productId")),
  skuId: Schema.String.pipe(T.HttpPath("skuId")),
...
export const DeleteLicenseAssignmentsRequest = /*@__PURE__*/ Schema.Struct({
  skuId: Schema.String.pipe(T.HttpPath("skuId")),
  userId: Schema.String.pipe(T.HttpPath("userId")),
  productId: Schema.String.pipe(T.HttpPath("productId")),
}).pipe(
...
export const GetLicenseAssignmentsRequest = /*@__PURE__*/ Schema.Struct({
  productId: Schema.String.pipe(T.HttpPath("productId")),
  skuId: Schema.String.pipe(T.HttpPath("skuId")),
  userId: Schema.String.pipe(T.HttpPath("userId")),
}).pipe(
