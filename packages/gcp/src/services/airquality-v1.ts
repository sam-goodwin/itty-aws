...
export const Pollutant: Schema.Schema<Pollutant> = /*@__PURE__*/ Schema.Struct({
...
export const HourInfo: Schema.Schema<HourInfo> = /*@__PURE__*/ Schema.Struct({
  pollutants: Schema.optional(Schema.Array(Pollutant)),
  dateTime: Schema.optional(Schema.String),
  indexes: Schema.optional(Schema.Array(AirQualityIndex)),
  healthRecommendations: Schema.optional(HealthRecommendations),
...
export const LookupCurrentConditionsRequest_Op = /*@__PURE__*/ Schema.Struct({
...
export const LookupHistoryRequest_Op = /*@__PURE__*/ Schema.Struct({
...
export const LookupForecastRequest_Op = /*@__PURE__*/ Schema.Struct({
