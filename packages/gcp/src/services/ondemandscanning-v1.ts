...
export const ListVulnerabilitiesResponseV1: Schema.Codec<ListVulnerabilitiesResponseV1> =
  /*@__PURE__*/ Schema.Struct({
...
export const AnalyzePackagesRequestV1: Schema.Codec<AnalyzePackagesRequestV1> =
  /*@__PURE__*/ Schema.Struct({
