...
export const TableCell: Schema.Schema<TableCell> = /*@__PURE__*/ Schema.suspend(
  () =>
    Schema.Struct({
...
export const TableRow: Schema.Schema<TableRow> = /*@__PURE__*/ Schema.suspend(
  () =>
    Schema.Struct({
      suggestedInsertionIds: Schema.optional(Schema.Array(Schema.String)),
      endIndex: Schema.optional(Schema.Number),
...
export const Table: Schema.Schema<Table> = /*@__PURE__*/ Schema.suspend(() =>
  Schema.Struct({
...
export const Equation: Schema.Schema<Equation> = /*@__PURE__*/ Schema.Struct({
  suggestedInsertionIds: Schema.optional(Schema.Array(Schema.String)),
  suggestedDeletionIds: Schema.optional(Schema.Array(Schema.String)),
...
export const RichLink: Schema.Schema<RichLink> = /*@__PURE__*/ Schema.Struct({
  suggestedDeletionIds: Schema.optional(Schema.Array(Schema.String)),
  textStyle: Schema.optional(TextStyle),
...
export const PageBreak: Schema.Schema<PageBreak> = /*@__PURE__*/ Schema.Struct({
  suggestedDeletionIds: Schema.optional(Schema.Array(Schema.String)),
  textStyle: Schema.optional(TextStyle),
  suggestedTextStyleChanges: Schema.optional(
    Schema.Record(Schema.String, SuggestedTextStyle),
...
export const TabStop: Schema.Schema<TabStop> = /*@__PURE__*/ Schema.Struct({
...
export const Shading: Schema.Schema<Shading> = /*@__PURE__*/ Schema.Struct({
  backgroundColor: Schema.optional(OptionalColor),
...
export const Body: Schema.Schema<Body> = /*@__PURE__*/ Schema.Struct({
  content: Schema.optional(Schema.Array(StructuralElement)),
...
export const Footer: Schema.Schema<Footer> = /*@__PURE__*/ Schema.Struct({
...
export const Footnote: Schema.Schema<Footnote> = /*@__PURE__*/ Schema.Struct({
  content: Schema.optional(Schema.Array(StructuralElement)),
  footnoteId: Schema.optional(Schema.String),
...
export const Tab: Schema.Schema<Tab> = /*@__PURE__*/ Schema.suspend(() =>
  Schema.Struct({
...
export const BatchUpdateDocumentsRequest = /*@__PURE__*/ Schema.Struct({
  documentId: Schema.String.pipe(T.HttpPath("documentId")),
