...
export const TimeEvent: Schema.Schema<TimeEvent> = /*@__PURE__*/ Schema.Struct({
...
export const Module: Schema.Schema<Module> = /*@__PURE__*/ Schema.Struct({
...
export const Links: Schema.Schema<Links> = /*@__PURE__*/ Schema.Struct({
...
export const Span: Schema.Schema<Span> = /*@__PURE__*/ Schema.Struct({
...
export const BatchWriteProjectsTracesRequest = /*@__PURE__*/ Schema.Struct({
...
export const CreateSpanProjectsTracesSpansRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
