...
export const AppIcons: Schema.Schema<AppIcons> = /*@__PURE__*/ Schema.Struct({
...
export const App: Schema.Schema<App> = /*@__PURE__*/ Schema.Struct({
...
export const AppList: Schema.Schema<AppList> = /*@__PURE__*/ Schema.Struct({
...
export const Reply: Schema.Schema<Reply> = /*@__PURE__*/ Schema.Struct({
...
export const ReplyList: Schema.Schema<ReplyList> = /*@__PURE__*/ Schema.Struct({
  kind: Schema.optional(Schema.String),
...
export const Change: Schema.Schema<Change> = /*@__PURE__*/ Schema.Struct({
...
export const Approval: Schema.Schema<Approval> = /*@__PURE__*/ Schema.Struct({
...
export const DriveList: Schema.Schema<DriveList> = /*@__PURE__*/ Schema.Struct({
...
export const LabelList: Schema.Schema<LabelList> = /*@__PURE__*/ Schema.Struct({
...
export const ExportFilesResponse: Schema.Schema<ExportFilesResponse> =
  /*@__PURE__*/ Schema.Struct({}) as any as Schema.Schema<ExportFilesResponse>;
...
export const ModifyLabelsFilesRequest = /*@__PURE__*/ Schema.Struct({
  fileId: Schema.String.pipe(T.HttpPath("fileId")),
...
export const DeleteFilesResponse: Schema.Schema<DeleteFilesResponse> =
  /*@__PURE__*/ Schema.Struct({}) as any as Schema.Schema<DeleteFilesResponse>;
...
export const GenerateCseTokenFilesRequest = /*@__PURE__*/ Schema.Struct({
...
export const GenerateIdsFilesRequest = /*@__PURE__*/ Schema.Struct({
...
export const UpdateTeamdrivesRequest = /*@__PURE__*/ Schema.Struct({
...
export const CreateTeamdrivesRequest = /*@__PURE__*/ Schema.Struct({
...
export const DeleteTeamdrivesRequest = /*@__PURE__*/ Schema.Struct({
  teamDriveId: Schema.String.pipe(T.HttpPath("teamDriveId")),
}).pipe(
...
export const GetStartPageTokenChangesRequest = /*@__PURE__*/ Schema.Struct({
  supportsAllDrives: Schema.optional(Schema.Boolean).pipe(
    T.HttpQuery("supportsAllDrives"),
  ),
  supportsTeamDrives: Schema.optional(Schema.Boolean).pipe(
...
export const DeletePermissionsRequest = /*@__PURE__*/ Schema.Struct({
  supportsTeamDrives: Schema.optional(Schema.Boolean).pipe(
    T.HttpQuery("supportsTeamDrives"),
  ),
  useDomainAdminAccess: Schema.optional(Schema.Boolean).pipe(
...
export const CreatePermissionsRequest = /*@__PURE__*/ Schema.Struct({
  enforceSingleParent: Schema.optional(Schema.Boolean).pipe(
    T.HttpQuery("enforceSingleParent"),
  ),
...
export const UpdatePermissionsRequest = /*@__PURE__*/ Schema.Struct({
  supportsTeamDrives: Schema.optional(Schema.Boolean).pipe(
    T.HttpQuery("supportsTeamDrives"),
  ),
  useDomainAdminAccess: Schema.optional(Schema.Boolean).pipe(
...
export const ResolveAccessproposalsRequest = /*@__PURE__*/ Schema.Struct({
  fileId: Schema.String.pipe(T.HttpPath("fileId")),
...
export const GetAccessproposalsRequest = /*@__PURE__*/ Schema.Struct({
  proposalId: Schema.String.pipe(T.HttpPath("proposalId")),
  fileId: Schema.String.pipe(T.HttpPath("fileId")),
}).pipe(
  T.Http({
...
export const ListAccessproposalsRequest = /*@__PURE__*/ Schema.Struct({
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  fileId: Schema.String.pipe(T.HttpPath("fileId")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
}).pipe(
...
export const DeleteDrivesResponse: Schema.Schema<DeleteDrivesResponse> =
  /*@__PURE__*/ Schema.Struct({}) as any as Schema.Schema<DeleteDrivesResponse>;
