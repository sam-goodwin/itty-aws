...
export const QueryVitalsAnrrateRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetVitalsAnrrateRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
...
export const QueryVitalsLmkrateRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(
    GooglePlayDeveloperReportingV1beta1QueryLmkRateMetricSetRequest,
  ).pipe(T.HttpBody()),
...
export const GetVitalsLmkrateRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta1/{+name}" }),
  svc,
...
export const QueryVitalsSlowstartrateRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(
    GooglePlayDeveloperReportingV1beta1QuerySlowStartRateMetricSetRequest,
  ).pipe(T.HttpBody()),
...
export const GetVitalsSlowstartrateRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta1/{+name}" }),
  svc,
...
export const QueryVitalsSlowrenderingrateRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(
    GooglePlayDeveloperReportingV1beta1QuerySlowRenderingRateMetricSetRequest,
  ).pipe(T.HttpBody()),
...
export const GetVitalsSlowrenderingrateRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta1/{+name}" }),
  svc,
...
export const GetVitalsExcessivewakeuprateRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta1/{+name}" }),
  svc,
...
export const GetVitalsCrashrateRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta1/{+name}" }),
  svc,
...
export const QueryVitalsCrashrateRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(
    GooglePlayDeveloperReportingV1beta1QueryCrashRateMetricSetRequest,
  ).pipe(T.HttpBody()),
...
export const SearchVitalsErrorsIssuesRequest = /*@__PURE__*/ Schema.Struct({
...
export const SearchVitalsErrorsReportsRequest = /*@__PURE__*/ Schema.Struct({
  "interval.startTime.year": Schema.optional(Schema.Number).pipe(
    T.HttpQuery("interval.startTime.year"),
  ),
  "interval.startTime.nanos": Schema.optional(Schema.Number).pipe(
...
export const QueryVitalsErrorsCountsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(
    GooglePlayDeveloperReportingV1beta1QueryErrorCountMetricSetRequest,
  ).pipe(T.HttpBody()),
...
export const GetVitalsErrorsCountsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta1/{+name}" }),
  svc,
...
export const FetchReleaseFilterOptionsAppsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
  },
).pipe(
