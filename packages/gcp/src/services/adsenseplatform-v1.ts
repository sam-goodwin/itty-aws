...
export const EventInfo: Schema.Schema<EventInfo> = /*@__PURE__*/ Schema.Struct({
...
export const ClosePlatformsAccountsRequest = /*@__PURE__*/ Schema.Struct({
...
export const ListPlatformsAccountsRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetPlatformsAccountsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
...
export const CreatePlatformsAccountsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const LookupPlatformsAccountsRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetPlatformsAccountsSitesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const CreatePlatformsAccountsSitesRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const DeletePlatformsAccountsSitesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
...
export const ListPlatformsAccountsSitesRequest = /*@__PURE__*/ Schema.Struct({
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
}).pipe(
...
export const CreatePlatformsAccountsEventsRequest = /*@__PURE__*/ Schema.Struct(
  {
    parent: Schema.String.pipe(T.HttpPath("parent")),
