...
export const Cluster: Schema.Schema<Cluster> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const RowAffinity: Schema.Schema<RowAffinity> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "RowAffinity" });
...
export const MemoryConfig: Schema.Schema<MemoryConfig> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "MemoryConfig" });
...
export const HotTablet: Schema.Schema<HotTablet> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const Union: Schema.Schema<Union> = /*@__PURE__*/ Schema.suspend(() =>
  Schema.Struct({
    rules: Schema.optional(Schema.Array(GcRule)),
  }),
...
export const GcRule: Schema.Schema<GcRule> = /*@__PURE__*/ Schema.suspend(() =>
  Schema.Struct({
...
export const Split: Schema.Schema<Split> = /*@__PURE__*/ Schema.Struct({
...
export const UpdateProjectsInstancesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const GetProjectsInstancesClustersRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v2/{+name}" }),
  svc,
...
export const ListProjectsInstancesClustersRequest = /*@__PURE__*/ Schema.Struct(
  {
    parent: Schema.String.pipe(T.HttpPath("parent")),
    pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  },
...
export const CreateProjectsInstancesTablesRequest = /*@__PURE__*/ Schema.Struct(
  {
    parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const ListProjectsInstancesTablesRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  view: Schema.optional(Schema.String).pipe(T.HttpQuery("view")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
...
export const GetProjectsInstancesTablesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  view: Schema.optional(Schema.String).pipe(T.HttpQuery("view")),
}).pipe(
  T.Http({ method: "GET", path: "v2/{+name}" }),
...
export const PatchProjectsInstancesTablesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  ignoreWarnings: Schema.optional(Schema.Boolean).pipe(
    T.HttpQuery("ignoreWarnings"),
...
export const DeleteProjectsInstancesTablesRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
  },
).pipe(
