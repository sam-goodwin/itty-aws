...
export type GoogleCloudDocumentaiV1Vertex =
  GoogleCloudDocumentaiV1NormalizedVertex;
...
export interface GoogleCloudContentwarehouseV1PropertyDefinition {
  ...
  name?: string;
  /** Integer property. */
  integerTypeOptions?: GoogleCloudContentwarehouseV1DateTimeTypeOptions;
  /** Float property. */
  floatTypeOptions?: GoogleCloudContentwarehouseV1DateTimeTypeOptions;
  /** The retrieval importance of the property during search. */
  retrievalImportance?:
    | GoogleCloudContentwarehouseV1PropertyDefinitionRetrievalImportanceEnum
    | (string & {});
  /** Text/string property. */
  textTypeOptions?: GoogleCloudContentwarehouseV1DateTimeTypeOptions;
  /** Whether the property can be filtered. If this is a sub-property, all the parent properties must be marked filterable. */
  isFilterable?: boolean;
  /** Timestamp property. It is not supported by CMEK compliant deployment. */
  timestampTypeOptions?: GoogleCloudContentwarehouseV1DateTimeTypeOptions;
  ...
  /** Map property. */
  mapTypeOptions?: GoogleCloudContentwarehouseV1DateTimeTypeOptions;
