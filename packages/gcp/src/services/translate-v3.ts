...
export const Example: Schema.Schema<Example> = /*@__PURE__*/ Schema.Struct({
  sourceText: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
...
export const Glossary: Schema.Schema<Glossary> = /*@__PURE__*/ Schema.Struct({
...
export const InputFile: Schema.Schema<InputFile> = /*@__PURE__*/ Schema.Struct({
...
export const Model: Schema.Schema<Model> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
  dataset: Schema.optional(Schema.String),
  createTime: Schema.optional(Schema.String),
  updateTime: Schema.optional(Schema.String),
...
export const TranslateTextProjectsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(TranslateTextRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v3/{+parent}:translateText", hasBody: true }),
  svc,
...
export const RomanizeTextProjectsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const DetectLanguageProjectsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const GetSupportedLanguagesProjectsRequest = /*@__PURE__*/ Schema.Struct(
  {
    parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const RefineTextProjectsLocationsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const RomanizeTextProjectsLocationsRequest = /*@__PURE__*/ Schema.Struct(
  {
    parent: Schema.String.pipe(T.HttpPath("parent")),
    body: Schema.optional(RomanizeTextRequest).pipe(T.HttpBody()),
  },
...
export const GetProjectsLocationsDatasetsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v3/{+name}" }),
  svc,
...
export const ListProjectsLocationsDatasetsRequest = /*@__PURE__*/ Schema.Struct(
  {
    parent: Schema.String.pipe(T.HttpPath("parent")),
    pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
    pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
...
export const CreateProjectsLocationsModelsRequest = /*@__PURE__*/ Schema.Struct(
  {
    parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const GetProjectsLocationsModelsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v3/{+name}" }),
  svc,
...
export const DeleteProjectsLocationsModelsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
  },
).pipe(
...
export const ListProjectsLocationsModelsRequest = /*@__PURE__*/ Schema.Struct({
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
