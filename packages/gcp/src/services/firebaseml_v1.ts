...
}).pipe(T.Http({"method":"POST","uri":"v1/{+name}:cancel","baseUrl":"https://firebaseml.googleapis.com/"})),
...
S.Struct({
  "name": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"DELETE","uri":"v1/{+name}","baseUrl":"https://firebaseml.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v1/{+name}","baseUrl":"https://firebaseml.googleapis.com/"})),
