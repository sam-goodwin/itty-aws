...
}).pipe(T.Http({"method":"POST","uri":"v1/{+registration}:configureContactSettings","baseUrl":"https://domains.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1/{+registration}:configureDnsSettings","baseUrl":"https://domains.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1/{+registration}:configureManagementSettings","baseUrl":"https://domains.googleapis.com/"})),
...
}).pipe(T.Http({"method":"DELETE","uri":"v1/{+name}","baseUrl":"https://domains.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1/{+name}:export","baseUrl":"https://domains.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v1/{+resource}:getIamPolicy","baseUrl":"https://domains.googleapis.com/"})),
...
S.Struct({
  "name": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v1/{+name}","baseUrl":"https://domains.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1/{+parent}/registrations:import","baseUrl":"https://domains.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1/{+registration}:initiatePushTransfer","baseUrl":"https://domains.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v1/{+name}/locations","baseUrl":"https://domains.googleapis.com/"})),
...
S.Struct({
  ...
  "filter": S.optional(S.String.pipe(T.Query())),
  "pageToken": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1/{+name}/operations","baseUrl":"https://domains.googleapis.com/"})),
...
S.Struct({
  ...
  "pageSize": S.optional(S.Number.pipe(T.Query())),
  "filter": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1/{+parent}/registrations","baseUrl":"https://domains.googleapis.com/"})),
...
}).pipe(T.Http({"method":"PATCH","uri":"v1/{+name}","baseUrl":"https://domains.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1/{+parent}/registrations:register","baseUrl":"https://domains.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1/{+registration}:renewDomain","baseUrl":"https://domains.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1/{+registration}:resetAuthorizationCode","baseUrl":"https://domains.googleapis.com/"})),
...
S.Struct({
  "registration": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v1/{+registration}:retrieveAuthorizationCode","baseUrl":"https://domains.googleapis.com/"})),
...
S.Struct({
  ...
  "registration": S.String.pipe(T.Label()),
  "pageToken": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1/{+registration}:retrieveGoogleDomainsDnsRecords","baseUrl":"https://domains.googleapis.com/"})),
...
S.Struct({
  "registration": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v1/{+registration}:retrieveGoogleDomainsForwardingConfig","baseUrl":"https://domains.googleapis.com/"})),
...
S.Struct({
  ...
  "pageSize": S.optional(S.Number.pipe(T.Query())),
  "pageToken": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1/{+location}/registrations:retrieveImportableDomains","baseUrl":"https://domains.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v1/{+location}/registrations:retrieveRegisterParameters","baseUrl":"https://domains.googleapis.com/"})),
...
S.Struct({
  "location": S.String.pipe(T.Label()),
  "domainName": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1/{+location}/registrations:retrieveTransferParameters","baseUrl":"https://domains.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v1/{+location}/registrations:searchDomains","baseUrl":"https://domains.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1/{+resource}:setIamPolicy","baseUrl":"https://domains.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1/{+resource}:testIamPermissions","baseUrl":"https://domains.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1/{+parent}/registrations:transfer","baseUrl":"https://domains.googleapis.com/"})),
