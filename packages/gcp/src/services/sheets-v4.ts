...
export const GridRange: Schema.Schema<GridRange> = /*@__PURE__*/ Schema.Struct({
...
export const ChartData: Schema.Schema<ChartData> = /*@__PURE__*/ Schema.Struct({
...
export const DataLabel: Schema.Schema<DataLabel> = /*@__PURE__*/ Schema.Struct({
  type: Schema.optional(Schema.String),
...
export const Chip: Schema.Schema<Chip> = /*@__PURE__*/ Schema.Struct({
...
export const SortSpec: Schema.Schema<SortSpec> = /*@__PURE__*/ Schema.Struct({
  dataSourceColumnReference: Schema.optional(DataSourceColumnReference),
...
export const Border: Schema.Schema<Border> = /*@__PURE__*/ Schema.Struct({
...
export const Borders: Schema.Schema<Borders> = /*@__PURE__*/ Schema.Struct({
...
export const Padding: Schema.Schema<Padding> = /*@__PURE__*/ Schema.Struct({
...
export const ChipRun: Schema.Schema<ChipRun> = /*@__PURE__*/ Schema.Struct({
  startIndex: Schema.optional(Schema.Number),
...
export const CellData: Schema.Schema<CellData> = /*@__PURE__*/ Schema.Struct({
...
export const RowData: Schema.Schema<RowData> = /*@__PURE__*/ Schema.Struct({
...
export const LineStyle: Schema.Schema<LineStyle> = /*@__PURE__*/ Schema.Struct({
  width: Schema.optional(Schema.Number),
  type: Schema.optional(Schema.String),
...
export const ChartSpec: Schema.Schema<ChartSpec> = /*@__PURE__*/ Schema.Struct({
...
export const Editors: Schema.Schema<Editors> = /*@__PURE__*/ Schema.Struct({
...
export const Slicer: Schema.Schema<Slicer> = /*@__PURE__*/ Schema.Struct({
  spec: Schema.optional(SlicerSpec),
  position: Schema.optional(EmbeddedObjectPosition),
  slicerId: Schema.optional(Schema.Number),
...
export const GridData: Schema.Schema<GridData> = /*@__PURE__*/ Schema.Struct({
...
export const Sheet: Schema.Schema<Sheet> = /*@__PURE__*/ Schema.Struct({
...
export const GetByDataFilterSpreadsheetsRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetByDataFilterSpreadsheetsResponse = /*@__PURE__*/ Spreadsheet;
...
export const BatchUpdateSpreadsheetsRequest = /*@__PURE__*/ Schema.Struct({
  spreadsheetId: Schema.String.pipe(T.HttpPath("spreadsheetId")),
...
export const BatchUpdateSpreadsheetsResponse =
  /*@__PURE__*/ BatchUpdateSpreadsheetResponse;
...
export const CreateSpreadsheetsRequest = /*@__PURE__*/ Schema.Struct({
...
export const CreateSpreadsheetsResponse = /*@__PURE__*/ Spreadsheet;
...
export const GetSpreadsheetsRequest = /*@__PURE__*/ Schema.Struct({
  spreadsheetId: Schema.String.pipe(T.HttpPath("spreadsheetId")),
...
export const GetSpreadsheetsResponse = /*@__PURE__*/ Spreadsheet;
...
export const UpdateSpreadsheetsValuesRequest = /*@__PURE__*/ Schema.Struct({
...
export const BatchGetSpreadsheetsValuesRequest = /*@__PURE__*/ Schema.Struct({
...
export const BatchGetSpreadsheetsValuesResponse =
  /*@__PURE__*/ BatchGetValuesResponse;
...
export const BatchClearSpreadsheetsValuesRequest = /*@__PURE__*/ Schema.Struct({
  spreadsheetId: Schema.String.pipe(T.HttpPath("spreadsheetId")),
...
export const BatchClearSpreadsheetsValuesResponse =
  /*@__PURE__*/ BatchClearValuesResponse;
...
export const BatchUpdateSpreadsheetsValuesRequest = /*@__PURE__*/ Schema.Struct(
  {
    spreadsheetId: Schema.String.pipe(T.HttpPath("spreadsheetId")),
...
export const BatchUpdateSpreadsheetsValuesResponse =
  /*@__PURE__*/ BatchUpdateValuesResponse;
...
export const BatchGetByDataFilterSpreadsheetsValuesResponse =
  /*@__PURE__*/ BatchGetValuesByDataFilterResponse;
...
export const GetSpreadsheetsValuesRequest = /*@__PURE__*/ Schema.Struct({
  range: Schema.String.pipe(T.HttpPath("range")),
  majorDimension: Schema.optional(Schema.String).pipe(
    T.HttpQuery("majorDimension"),
  ),
...
export const GetSpreadsheetsValuesResponse = /*@__PURE__*/ ValueRange;
...
export const AppendSpreadsheetsValuesRequest = /*@__PURE__*/ Schema.Struct({
  spreadsheetId: Schema.String.pipe(T.HttpPath("spreadsheetId")),
  range: Schema.String.pipe(T.HttpPath("range")),
  includeValuesInResponse: Schema.optional(Schema.Boolean).pipe(
    T.HttpQuery("includeValuesInResponse"),
...
export const ClearSpreadsheetsValuesRequest = /*@__PURE__*/ Schema.Struct({
  spreadsheetId: Schema.String.pipe(T.HttpPath("spreadsheetId")),
  range: Schema.String.pipe(T.HttpPath("range")),
...
export const BatchUpdateByDataFilterSpreadsheetsValuesResponse =
  /*@__PURE__*/ BatchUpdateValuesByDataFilterResponse;
...
export const BatchClearByDataFilterSpreadsheetsValuesResponse =
  /*@__PURE__*/ BatchClearValuesByDataFilterResponse;
...
export const SearchSpreadsheetsDeveloperMetadataResponse =
  /*@__PURE__*/ SearchDeveloperMetadataResponse;
...
export const CopyToSpreadsheetsSheetsRequest = /*@__PURE__*/ Schema.Struct({
  spreadsheetId: Schema.String.pipe(T.HttpPath("spreadsheetId")),
...
export const CopyToSpreadsheetsSheetsResponse = /*@__PURE__*/ SheetProperties;
