...
export const Interface: Schema.Schema<Interface> = /*@__PURE__*/ Schema.Struct({
...
export const Protocol: Schema.Schema<Protocol> = /*@__PURE__*/ Schema.Struct({
...
export const McpServer: Schema.Schema<McpServer> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const AgentSpec: Schema.Schema<AgentSpec> = /*@__PURE__*/ Schema.Struct({
  type: Schema.optional(Schema.String),
  content: Schema.optional(Schema.Record(Schema.String, Schema.Unknown)),
...
export const SearchProjectsLocationsAgentsRequest = /*@__PURE__*/ Schema.Struct(
  {
    parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const ListProjectsLocationsBindingsRequest = /*@__PURE__*/ Schema.Struct(
  {
    parent: Schema.String.pipe(T.HttpPath("parent")),
    pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
    pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
...
export const GetProjectsLocationsBindingsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1alpha/{+name}" }),
  svc,
