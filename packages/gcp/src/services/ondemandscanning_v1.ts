...
}).pipe(T.Http({"method":"POST","uri":"v1/{+parent}/scans:analyzePackages","baseUrl":"https://ondemandscanning.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1/{+name}:cancel","baseUrl":"https://ondemandscanning.googleapis.com/"})),
...
S.Struct({
  "name": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"DELETE","uri":"v1/{+name}","baseUrl":"https://ondemandscanning.googleapis.com/"})),
...
S.Struct({
  "name": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v1/{+name}","baseUrl":"https://ondemandscanning.googleapis.com/"})),
...
S.Struct({
  ...
  "name": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v1/{+name}/operations","baseUrl":"https://ondemandscanning.googleapis.com/"})),
...
S.Struct({
  ...
  "pageToken": S.optional(S.String.pipe(T.Query())),
  "pageSize": S.optional(S.Number.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1/{+parent}/vulnerabilities","baseUrl":"https://ondemandscanning.googleapis.com/"})),
...
).annotate({ identifier: "ListVulnerabilitiesResponseV1" }) as any as S.Schema<ListVulnerabilitiesResponseV1>;
...
}).pipe(T.Http({"method":"POST","uri":"v1/{+name}:wait","baseUrl":"https://ondemandscanning.googleapis.com/"})),
