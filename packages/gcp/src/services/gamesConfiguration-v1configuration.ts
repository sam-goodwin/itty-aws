...
export const GetAchievementConfigurationsRequest = /*@__PURE__*/ Schema.Struct({
  achievementId: Schema.String.pipe(T.HttpPath("achievementId")),
}).pipe(
  T.Http({
    method: "GET",
...
export const ListAchievementConfigurationsRequest = /*@__PURE__*/ Schema.Struct(
  {
    applicationId: Schema.String.pipe(T.HttpPath("applicationId")),
...
export const GetLeaderboardConfigurationsRequest = /*@__PURE__*/ Schema.Struct({
  leaderboardId: Schema.String.pipe(T.HttpPath("leaderboardId")),
}).pipe(
  T.Http({
    method: "GET",
...
export const ListLeaderboardConfigurationsRequest = /*@__PURE__*/ Schema.Struct(
  {
    applicationId: Schema.String.pipe(T.HttpPath("applicationId")),
    maxResults: Schema.optional(Schema.Number).pipe(T.HttpQuery("maxResults")),
    pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
