...
export const GetMetricsProjectsRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetContentProjectsRequest = /*@__PURE__*/ Schema.Struct({
  scriptId: Schema.String.pipe(T.HttpPath("scriptId")),
...
export const UpdateContentProjectsRequest = /*@__PURE__*/ Schema.Struct({
  scriptId: Schema.String.pipe(T.HttpPath("scriptId")),
...
export const CreateProjectsDeploymentsRequest = /*@__PURE__*/ Schema.Struct({
  scriptId: Schema.String.pipe(T.HttpPath("scriptId")),
...
export const UpdateProjectsDeploymentsRequest = /*@__PURE__*/ Schema.Struct({
  scriptId: Schema.String.pipe(T.HttpPath("scriptId")),
...
export const DeleteProjectsDeploymentsRequest = /*@__PURE__*/ Schema.Struct({
  scriptId: Schema.String.pipe(T.HttpPath("scriptId")),
  deploymentId: Schema.String.pipe(T.HttpPath("deploymentId")),
}).pipe(
  T.Http({
...
export const GetProjectsDeploymentsRequest = /*@__PURE__*/ Schema.Struct({
  scriptId: Schema.String.pipe(T.HttpPath("scriptId")),
  deploymentId: Schema.String.pipe(T.HttpPath("deploymentId")),
}).pipe(
  T.Http({
...
export const ListProjectsDeploymentsRequest = /*@__PURE__*/ Schema.Struct({
  scriptId: Schema.String.pipe(T.HttpPath("scriptId")),
...
export const CreateProjectsVersionsRequest = /*@__PURE__*/ Schema.Struct({
  scriptId: Schema.String.pipe(T.HttpPath("scriptId")),
...
export const GetProjectsVersionsRequest = /*@__PURE__*/ Schema.Struct({
  scriptId: Schema.String.pipe(T.HttpPath("scriptId")),
...
export const ListProjectsVersionsRequest = /*@__PURE__*/ Schema.Struct({
  scriptId: Schema.String.pipe(T.HttpPath("scriptId")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
}).pipe(
...
export const ListScriptProcessesProcessesRequest = /*@__PURE__*/ Schema.Struct({
