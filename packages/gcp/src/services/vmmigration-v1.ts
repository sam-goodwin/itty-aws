...
export const CycleStep: Schema.Schema<CycleStep> = /*@__PURE__*/ Schema.Struct({
...
export const AdaptingOSStep: Schema.Schema<AdaptingOSStep> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "AdaptingOSStep" });

export interface CreatingImageStep {}

export const CreatingImageStep: Schema.Schema<CreatingImageStep> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "CreatingImageStep" });
...
export const SkipOsAdaptation: Schema.Schema<SkipOsAdaptation> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "SkipOsAdaptation" });
...
export const CloneStep: Schema.Schema<CloneStep> = /*@__PURE__*/ Schema.Struct({
...
export const OSDisk: Schema.Schema<OSDisk> = /*@__PURE__*/ Schema.Struct({
  type: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  sizeGb: Schema.optional(Schema.Number),
...
export const CloneJob: Schema.Schema<CloneJob> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
  error: Schema.optional(Status),
...
export const PatchProjectsLocationsGroupsRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetProjectsLocationsGroupsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const CreateProjectsLocationsGroupsRequest = /*@__PURE__*/ Schema.Struct(
  {
...
export const DeleteProjectsLocationsGroupsRequest = /*@__PURE__*/ Schema.Struct(
  {
    requestId: Schema.optional(Schema.String).pipe(T.HttpQuery("requestId")),
    name: Schema.String.pipe(T.HttpPath("name")),
  },
...
export const ListProjectsLocationsGroupsRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetProjectsLocationsSourcesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const ListProjectsLocationsSourcesRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  orderBy: Schema.optional(Schema.String).pipe(T.HttpQuery("orderBy")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
...
export const PatchProjectsLocationsSourcesRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
    updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
    requestId: Schema.optional(Schema.String).pipe(T.HttpQuery("requestId")),
