...
export const TimeOfDay: Schema.Schema<TimeOfDay> = /*@__PURE__*/ Schema.Struct({
...
export const Verify: Schema.Schema<Verify> = /*@__PURE__*/ Schema.Struct({
  tasks: Schema.optional(Schema.Array(Task)),
...
export const Analysis: Schema.Schema<Analysis> = /*@__PURE__*/ Schema.Struct({
...
export const Predeploy: Schema.Schema<Predeploy> = /*@__PURE__*/ Schema.Struct({
  tasks: Schema.optional(Schema.Array(Task)),
  actions: Schema.optional(Schema.Array(Schema.String)),
...
export const Canary: Schema.Schema<Canary> = /*@__PURE__*/ Schema.Struct({
...
export const Standard: Schema.Schema<Standard> = /*@__PURE__*/ Schema.Struct({
  verify: Schema.optional(Schema.Boolean),
  verifyConfig: Schema.optional(Verify),
  predeploy: Schema.optional(Predeploy),
  postdeploy: Schema.optional(Postdeploy),
...
export const Strategy: Schema.Schema<Strategy> = /*@__PURE__*/ Schema.Struct({
...
export const Stage: Schema.Schema<Stage> = /*@__PURE__*/ Schema.Struct({
...
export const Rollback: Schema.Schema<Rollback> = /*@__PURE__*/ Schema.Struct({
...
export const Retry: Schema.Schema<Retry> = /*@__PURE__*/ Schema.Struct({
...
export const Targets: Schema.Schema<Targets> = /*@__PURE__*/ Schema.Struct({
...
export const VerifyJob: Schema.Schema<VerifyJob> = /*@__PURE__*/ Schema.Struct({
  tasks: Schema.optional(Schema.Array(Task)),
...
export const DeployJob: Schema.Schema<DeployJob> = /*@__PURE__*/ Schema.Struct(
  {},
).annotate({ identifier: "DeployJob" });
...
export const Phase: Schema.Schema<Phase> = /*@__PURE__*/ Schema.Struct({
...
export const IgnoreJobResponse: Schema.Schema<IgnoreJobResponse> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "IgnoreJobResponse" });
...
export const JobRun: Schema.Schema<JobRun> = /*@__PURE__*/ Schema.Struct({
...
export const Config: Schema.Schema<Config> = /*@__PURE__*/ Schema.Struct({
...
export const RetryJobResponse: Schema.Schema<RetryJobResponse> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "RetryJobResponse" });
...
export const GetConfigProjectsLocationsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const PatchProjectsLocationsTargetsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
    allowMissing: Schema.optional(Schema.Boolean).pipe(
      T.HttpQuery("allowMissing"),
...
export const ListProjectsLocationsTargetsRequest = /*@__PURE__*/ Schema.Struct({
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
  orderBy: Schema.optional(Schema.String).pipe(T.HttpQuery("orderBy")),
...
export const GetProjectsLocationsTargetsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
