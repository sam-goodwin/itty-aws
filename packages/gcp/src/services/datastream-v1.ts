...
export const Merge: Schema.Schema<Merge> = /*@__PURE__*/ Schema.Struct(
  {},
...
export const AppendOnly: Schema.Schema<AppendOnly> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "AppendOnly" });
...
export const AvroFileFormat: Schema.Schema<AvroFileFormat> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "AvroFileFormat" });
...
export const BasicEncryption: Schema.Schema<BasicEncryption> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "BasicEncryption" });
...
export const DropLargeObjects: Schema.Schema<DropLargeObjects> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "DropLargeObjects" });
...
export const BinaryLogPosition: Schema.Schema<BinaryLogPosition> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "BinaryLogPosition" });

export interface Gtid {}

export const Gtid: Schema.Schema<Gtid> = /*@__PURE__*/ Schema.Struct(
  {},
).annotate({ identifier: "Gtid" });
...
export const Stream: Schema.Schema<Stream> = /*@__PURE__*/ Schema.Struct({
...
export const BigQueryProfile: Schema.Schema<BigQueryProfile> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "BigQueryProfile" });
...
export const RunProjectsLocationsStreamsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const ListProjectsLocationsStreamsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  orderBy: Schema.optional(Schema.String).pipe(T.HttpQuery("orderBy")),
...
export const GetProjectsLocationsStreamsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const PatchProjectsLocationsStreamsRequest = /*@__PURE__*/ Schema.Struct(
  {
    validateOnly: Schema.optional(Schema.Boolean).pipe(
      T.HttpQuery("validateOnly"),
    ),
