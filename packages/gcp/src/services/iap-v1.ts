...
export const OAuth2: Schema.Schema<OAuth2> = /*@__PURE__*/ Schema.Struct({
  clientSecret: Schema.optional(Schema.String),
  clientSecretSha256: Schema.optional(Schema.String),
  clientId: Schema.optional(Schema.String),
...
export const GetIapSettingsV1Request = /*@__PURE__*/ Schema.Struct({
...
export const UpdateIapSettingsV1Request = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const ValidateAttributeExpressionV1Request = /*@__PURE__*/ Schema.Struct(
  {
...
export const TestIamPermissionsV1Request = /*@__PURE__*/ Schema.Struct({
  resource: Schema.String.pipe(T.HttpPath("resource")),
...
export const GetProjectsBrandsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const CreateProjectsBrandsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const ListProjectsBrandsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
}).pipe(
