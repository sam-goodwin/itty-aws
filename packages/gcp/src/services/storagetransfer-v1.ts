...
export const GcsData: Schema.Schema<GcsData> = /*@__PURE__*/ Schema.Struct({
...
export const AwsS3Data: Schema.Schema<AwsS3Data> = /*@__PURE__*/ Schema.Struct({
  bucketName: Schema.optional(Schema.String),
...
export const HttpData: Schema.Schema<HttpData> = /*@__PURE__*/ Schema.Struct({
...
export const HdfsData: Schema.Schema<HdfsData> = /*@__PURE__*/ Schema.Struct({
  path: Schema.optional(Schema.String),
...
export const AgentPool: Schema.Schema<AgentPool> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const ListTransferOperationsRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetTransferOperationsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const CancelTransferOperationsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const PauseTransferOperationsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const ResumeTransferOperationsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const GetGoogleServiceAccountsRequest = /*@__PURE__*/ Schema.Struct({
...
export const CreateTransferJobsRequest = /*@__PURE__*/ Schema.Struct({
...
export const PatchTransferJobsRequest = /*@__PURE__*/ Schema.Struct({
...
export const ListTransferJobsRequest = /*@__PURE__*/ Schema.Struct({
  filter: Schema.String.pipe(T.HttpQuery("filter")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
}).pipe(
...
export const DeleteTransferJobsRequest = /*@__PURE__*/ Schema.Struct({
  jobName: Schema.String.pipe(T.HttpPath("jobName")),
  projectId: Schema.String.pipe(T.HttpQuery("projectId")),
}).pipe(
...
export const CreateProjectsAgentPoolsRequest = /*@__PURE__*/ Schema.Struct({
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
...
export const PatchProjectsAgentPoolsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const GetProjectsAgentPoolsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const ListProjectsAgentPoolsRequest = /*@__PURE__*/ Schema.Struct({
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
...
export const DeleteProjectsAgentPoolsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
