...
export const Skill: Schema.Schema<Skill> = /*@__PURE__*/ Schema.Struct({
...
export const FileAs: Schema.Schema<FileAs> = /*@__PURE__*/ Schema.Struct({
  value: Schema.optional(Schema.String),
  metadata: Schema.optional(FieldMetadata),
...
export const ImClient: Schema.Schema<ImClient> = /*@__PURE__*/ Schema.Struct({
  formattedType: Schema.optional(Schema.String),
...
export const Gender: Schema.Schema<Gender> = /*@__PURE__*/ Schema.Struct({
  metadata: Schema.optional(FieldMetadata),
  formattedValue: Schema.optional(Schema.String),
...
export const Nickname: Schema.Schema<Nickname> = /*@__PURE__*/ Schema.Struct({
  metadata: Schema.optional(FieldMetadata),
  value: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
...
export const Url: Schema.Schema<Url> = /*@__PURE__*/ Schema.Struct({
  formattedType: Schema.optional(Schema.String),
  value: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
  metadata: Schema.optional(FieldMetadata),
...
export const Interest: Schema.Schema<Interest> = /*@__PURE__*/ Schema.Struct({
  metadata: Schema.optional(FieldMetadata),
  value: Schema.optional(Schema.String),
...
export const Residence: Schema.Schema<Residence> = /*@__PURE__*/ Schema.Struct({
  value: Schema.optional(Schema.String),
...
export const Biography: Schema.Schema<Biography> = /*@__PURE__*/ Schema.Struct({
  metadata: Schema.optional(FieldMetadata),
  value: Schema.optional(Schema.String),
...
export const Birthday: Schema.Schema<Birthday> = /*@__PURE__*/ Schema.Struct({
  metadata: Schema.optional(FieldMetadata),
  date: Schema.optional(People_Date),
...
export const Tagline: Schema.Schema<Tagline> = /*@__PURE__*/ Schema.Struct({
  metadata: Schema.optional(FieldMetadata),
  value: Schema.optional(Schema.String),
...
export const BatchUpdateContactsPeopleRequest = /*@__PURE__*/ Schema.Struct({
...
export const BatchDeleteContactsPeopleRequest = /*@__PURE__*/ Schema.Struct({
...
export const CreateContactPeopleRequest = /*@__PURE__*/ Schema.Struct({
  personFields: Schema.optional(Schema.String).pipe(
    T.HttpQuery("personFields"),
  ),
  sources: Schema.optional(Schema.Array(Schema.String)).pipe(
...
export const UpdateContactPhotoPeopleRequest = /*@__PURE__*/ Schema.Struct({
  resourceName: Schema.String.pipe(T.HttpPath("resourceName")),
...
export const SearchContactsPeopleRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetBatchGetPeopleRequest = /*@__PURE__*/ Schema.Struct({
  "requestMask.includeField": Schema.optional(Schema.String).pipe(
    T.HttpQuery("requestMask.includeField"),
  ),
  sources: Schema.optional(Schema.Array(Schema.String)).pipe(
...
export const DeleteContactPhotoPeopleRequest = /*@__PURE__*/ Schema.Struct({
  personFields: Schema.optional(Schema.String).pipe(
    T.HttpQuery("personFields"),
  ),
  resourceName: Schema.String.pipe(T.HttpPath("resourceName")),
...
export const ListDirectoryPeoplePeopleRequest = /*@__PURE__*/ Schema.Struct({
...
export const BatchCreateContactsPeopleRequest = /*@__PURE__*/ Schema.Struct({
...
export const UpdateContactPeopleRequest = /*@__PURE__*/ Schema.Struct({
...
export const SearchDirectoryPeoplePeopleRequest = /*@__PURE__*/ Schema.Struct({
  query: Schema.optional(Schema.String).pipe(T.HttpQuery("query")),
  readMask: Schema.optional(Schema.String).pipe(T.HttpQuery("readMask")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  sources: Schema.optional(Schema.Array(Schema.String)).pipe(
...
export const DeleteContactPeopleRequest = /*@__PURE__*/ Schema.Struct({
  resourceName: Schema.String.pipe(T.HttpPath("resourceName")),
}).pipe(
...
export const ListPeopleConnectionsRequest = /*@__PURE__*/ Schema.Struct({
  sources: Schema.optional(Schema.Array(Schema.String)).pipe(
    T.HttpQuery("sources"),
  ),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
...
export const ListOtherContactsRequest = /*@__PURE__*/ Schema.Struct({
  requestSyncToken: Schema.optional(Schema.Boolean).pipe(
    T.HttpQuery("requestSyncToken"),
  ),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
...
export const SearchOtherContactsRequest = /*@__PURE__*/ Schema.Struct({
  query: Schema.optional(Schema.String).pipe(T.HttpQuery("query")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  readMask: Schema.optional(Schema.String).pipe(T.HttpQuery("readMask")),
}).pipe(
...
export const DeleteContactGroupsRequest = /*@__PURE__*/ Schema.Struct({
  resourceName: Schema.String.pipe(T.HttpPath("resourceName")),
...
export const GetContactGroupsRequest = /*@__PURE__*/ Schema.Struct({
  resourceName: Schema.String.pipe(T.HttpPath("resourceName")),
...
export const UpdateContactGroupsRequest = /*@__PURE__*/ Schema.Struct({
  resourceName: Schema.String.pipe(T.HttpPath("resourceName")),
...
export const ListContactGroupsRequest = /*@__PURE__*/ Schema.Struct({
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  syncToken: Schema.optional(Schema.String).pipe(T.HttpQuery("syncToken")),
  groupFields: Schema.optional(Schema.String).pipe(T.HttpQuery("groupFields")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
...
export const CreateContactGroupsRequest = /*@__PURE__*/ Schema.Struct({
...
export const BatchGetContactGroupsRequest = /*@__PURE__*/ Schema.Struct({
  maxMembers: Schema.optional(Schema.Number).pipe(T.HttpQuery("maxMembers")),
  groupFields: Schema.optional(Schema.String).pipe(T.HttpQuery("groupFields")),
  resourceNames: Schema.optional(Schema.Array(Schema.String)).pipe(
    T.HttpQuery("resourceNames"),
...
export const ModifyContactGroupsMembersRequest = /*@__PURE__*/ Schema.Struct({
  resourceName: Schema.String.pipe(T.HttpPath("resourceName")),
