...
export const IdMappingFile: Schema.Schema<IdMappingFile> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "IdMappingFile" });
...
export const ReportRow: Schema.Schema<ReportRow> = /*@__PURE__*/ Schema.Record(
  Schema.String,
  Schema.Unknown,
...
export const GetIdMappingFileReportsRequest = /*@__PURE__*/ Schema.Struct({
...
export const InsertConversionRequest = /*@__PURE__*/ Schema.Struct({
...
export const UpdateConversionRequest = /*@__PURE__*/ Schema.Struct({
  body: Schema.optional(ConversionList).pipe(T.HttpBody()),
}).pipe(
  T.Http({
    method: "PUT",
...
export const GetByCustomerIdConversionRequest = /*@__PURE__*/ Schema.Struct({
  adGroupId: Schema.optional(Schema.String).pipe(T.HttpQuery("adGroupId")),
...
export const UpdateAvailabilityConversionRequest = /*@__PURE__*/ Schema.Struct({
...
export const ListSavedColumnsRequest = /*@__PURE__*/ Schema.Struct({
  agencyId: Schema.String.pipe(T.HttpPath("agencyId")),
  advertiserId: Schema.String.pipe(T.HttpPath("advertiserId")),
}).pipe(
  T.Http({
