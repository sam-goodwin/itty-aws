...
export const GetAccountsMerchantReviewsRequest = /*@__PURE__*/ Schema.Struct({
...
export const DeleteAccountsMerchantReviewsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
  },
).pipe(
...
export const ListAccountsMerchantReviewsRequest = /*@__PURE__*/ Schema.Struct({
...
export const InsertAccountsMerchantReviewsRequest = /*@__PURE__*/ Schema.Struct(
  {
...
export const InsertAccountsProductReviewsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  dataSource: Schema.optional(Schema.String).pipe(T.HttpQuery("dataSource")),
...
export const ListAccountsProductReviewsRequest = /*@__PURE__*/ Schema.Struct({
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
}).pipe(
...
export const GetAccountsProductReviewsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "reviews/v1beta/{+name}" }),
  svc,
...
export const DeleteAccountsProductReviewsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "DELETE", path: "reviews/v1beta/{+name}" }),
  svc,
