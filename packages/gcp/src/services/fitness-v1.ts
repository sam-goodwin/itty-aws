...
export const DataType: Schema.Schema<DataType> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const MapValue: Schema.Schema<MapValue> = /*@__PURE__*/ Schema.Struct({
...
export const DataPoint: Schema.Schema<DataPoint> = /*@__PURE__*/ Schema.Struct({
...
export const AggregateUsersDatasetRequest = /*@__PURE__*/ Schema.Struct({
...
export const UpdateUsersSessionsRequest = /*@__PURE__*/ Schema.Struct({
  userId: Schema.String.pipe(T.HttpPath("userId")),
...
export const ListUsersSessionsRequest = /*@__PURE__*/ Schema.Struct({
...
export const DeleteUsersSessionsRequest = /*@__PURE__*/ Schema.Struct({
  userId: Schema.String.pipe(T.HttpPath("userId")),
  sessionId: Schema.String.pipe(T.HttpPath("sessionId")),
}).pipe(
...
export const ListUsersDataSourcesRequest = /*@__PURE__*/ Schema.Struct({
  userId: Schema.String.pipe(T.HttpPath("userId")),
...
export const UpdateUsersDataSourcesRequest = /*@__PURE__*/ Schema.Struct({
...
export const DeleteUsersDataSourcesRequest = /*@__PURE__*/ Schema.Struct({
  dataSourceId: Schema.String.pipe(T.HttpPath("dataSourceId")),
  userId: Schema.String.pipe(T.HttpPath("userId")),
}).pipe(
...
export const GetUsersDataSourcesRequest = /*@__PURE__*/ Schema.Struct({
  userId: Schema.String.pipe(T.HttpPath("userId")),
  dataSourceId: Schema.String.pipe(T.HttpPath("dataSourceId")),
}).pipe(
...
export const CreateUsersDataSourcesRequest = /*@__PURE__*/ Schema.Struct({
  userId: Schema.String.pipe(T.HttpPath("userId")),
  body: Schema.optional(DataSource).pipe(T.HttpBody()),
}).pipe(
...
export const PatchUsersDataSourcesDatasetsRequest = /*@__PURE__*/ Schema.Struct(
  {
    userId: Schema.String.pipe(T.HttpPath("userId")),
    datasetId: Schema.String.pipe(T.HttpPath("datasetId")),
    dataSourceId: Schema.String.pipe(T.HttpPath("dataSourceId")),
...
export const GetUsersDataSourcesDatasetsRequest = /*@__PURE__*/ Schema.Struct({
  userId: Schema.String.pipe(T.HttpPath("userId")),
  dataSourceId: Schema.String.pipe(T.HttpPath("dataSourceId")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
