...
export const Vp9ColorFormatHLG: Schema.Schema<Vp9ColorFormatHLG> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "Vp9ColorFormatHLG" });

export interface Vp9ColorFormatSDR {}

export const Vp9ColorFormatSDR: Schema.Schema<Vp9ColorFormatSDR> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "Vp9ColorFormatSDR" });
...
export const Output: Schema.Schema<Output> = /*@__PURE__*/ Schema.Struct({
...
export const Animation: Schema.Schema<Animation> = /*@__PURE__*/ Schema.Struct({
...
export const EditAtom: Schema.Schema<EditAtom> = /*@__PURE__*/ Schema.Struct({
  key: Schema.optional(Schema.String),
...
export const Aes128Encryption: Schema.Schema<Aes128Encryption> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "Aes128Encryption" });
...
export const Fairplay: Schema.Schema<Fairplay> = /*@__PURE__*/ Schema.Struct(
  {},
).annotate({ identifier: "Fairplay" });

export interface Playready {}

export const Playready: Schema.Schema<Playready> = /*@__PURE__*/ Schema.Struct(
  {},
).annotate({ identifier: "Playready" });

export interface Clearkey {}

export const Clearkey: Schema.Schema<Clearkey> = /*@__PURE__*/ Schema.Struct(
  {},
).annotate({ identifier: "Clearkey" });

export interface Widevine {}

export const Widevine: Schema.Schema<Widevine> = /*@__PURE__*/ Schema.Struct(
  {},
).annotate({ identifier: "Widevine" });
...
export const Audio: Schema.Schema<Audio> = /*@__PURE__*/ Schema.Struct({
...
export const Pad: Schema.Schema<Pad> = /*@__PURE__*/ Schema.Struct({
...
export const Denoise: Schema.Schema<Denoise> = /*@__PURE__*/ Schema.Struct({
  tune: Schema.optional(Schema.String),
...
export const Deblock: Schema.Schema<Deblock> = /*@__PURE__*/ Schema.Struct({
  strength: Schema.optional(Schema.Number),
...
export const Crop: Schema.Schema<Crop> = /*@__PURE__*/ Schema.Struct({
  rightPixels: Schema.optional(Schema.Number),
  topPixels: Schema.optional(Schema.Number),
  bottomPixels: Schema.optional(Schema.Number),
  leftPixels: Schema.optional(Schema.Number),
...
export const Input: Schema.Schema<Input> = /*@__PURE__*/ Schema.Struct({
  uri: Schema.optional(Schema.String),
...
export const AdBreak: Schema.Schema<AdBreak> = /*@__PURE__*/ Schema.Struct({
  startTimeOffset: Schema.optional(Schema.String),
...
export const Overlay: Schema.Schema<Overlay> = /*@__PURE__*/ Schema.Struct({
...
export const MuxStream: Schema.Schema<MuxStream> = /*@__PURE__*/ Schema.Struct({
...
export const JobConfig: Schema.Schema<JobConfig> = /*@__PURE__*/ Schema.Struct({
