...
export const OsInfo: Schema.Schema<OsInfo> = /*@__PURE__*/ Schema.Struct({
...
export const Item: Schema.Schema<Item> = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
...
export const Inventory: Schema.Schema<Inventory> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const Feed: Schema.Schema<Feed> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const Options: Schema.Schema<Options> = /*@__PURE__*/ Schema.Struct({
...
export const BatchGetAssetsHistoryV1Request = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const SearchAllResourcesV1Request = /*@__PURE__*/ Schema.Struct({
...
export const SearchAllIamPoliciesV1Request = /*@__PURE__*/ Schema.Struct({
  scope: Schema.String.pipe(T.HttpPath("scope")),
  query: Schema.optional(Schema.String).pipe(T.HttpQuery("query")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
...
export const AnalyzeIamPolicyV1Request = /*@__PURE__*/ Schema.Struct({
  scope: Schema.String.pipe(T.HttpPath("scope")),
  ...
  "analysisQuery.options.expandResources": Schema.optional(Schema.Boolean).pipe(
    T.HttpQuery("analysisQuery.options.expandResources"),
  ),
...
export const AnalyzeIamPolicyLongrunningV1Request = /*@__PURE__*/ Schema.Struct(
  {
    scope: Schema.String.pipe(T.HttpPath("scope")),
...
export const AnalyzeOrgPoliciesV1Request = /*@__PURE__*/ Schema.Struct({
  scope: Schema.String.pipe(T.HttpPath("scope")),
...
export const CreateSavedQueriesRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const ListSavedQueriesRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
...
export const PatchSavedQueriesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const DeleteSavedQueriesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "DELETE", path: "v1/{+name}" }),
  svc,
...
export const BatchGetEffectiveIamPoliciesRequest = /*@__PURE__*/ Schema.Struct({
  scope: Schema.String.pipe(T.HttpPath("scope")),
