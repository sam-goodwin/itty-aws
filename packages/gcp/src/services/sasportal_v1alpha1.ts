...
}).pipe(T.Http({"method":"POST","uri":"v1alpha1/{+parent}/deployments","baseUrl":"https://sasportal.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1alpha1/{+parent}/devices","baseUrl":"https://sasportal.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1alpha1/{+parent}/nodes","baseUrl":"https://sasportal.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1alpha1/{+parent}/devices:createSigned","baseUrl":"https://sasportal.googleapis.com/"})),
...
}).pipe(T.Http({"method":"DELETE","uri":"v1alpha1/{+name}","baseUrl":"https://sasportal.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1alpha1/installer:generateSecret","baseUrl":"https://sasportal.googleapis.com/"})),
...
S.Struct({
  "name": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v1alpha1/{+name}","baseUrl":"https://sasportal.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1alpha1/policies:get","baseUrl":"https://sasportal.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v1alpha1/customers","baseUrl":"https://sasportal.googleapis.com/"})),
...
S.Struct({
  ...
  "pageSize": S.optional(S.Number.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1alpha1/{+parent}/deployments","baseUrl":"https://sasportal.googleapis.com/"})),
...
S.Struct({
  ...
  "filter": S.optional(S.String.pipe(T.Query())),
  "pageSize": S.optional(S.Number.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1alpha1/{+parent}/devices","baseUrl":"https://sasportal.googleapis.com/"})),
...
S.Struct({
  ...
  "pageToken": S.optional(S.String.pipe(T.Query())),
  "filter": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1alpha1/{+parent}/nodes","baseUrl":"https://sasportal.googleapis.com/"})),
...
S.Struct({}).pipe(T.Http({"method":"GET","uri":"v1alpha1/customers:listGcpProjectDeployments","baseUrl":"https://sasportal.googleapis.com/"})),
...
S.Struct({}).pipe(T.Http({"method":"GET","uri":"v1alpha1/customers:listLegacyOrganizations","baseUrl":"https://sasportal.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1alpha1/customers:migrateOrganization","baseUrl":"https://sasportal.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1alpha1/{+name}:move","baseUrl":"https://sasportal.googleapis.com/"})),
...
}).pipe(T.Http({"method":"PATCH","uri":"v1alpha1/{+name}","baseUrl":"https://sasportal.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1alpha1/customers:provisionDeployment","baseUrl":"https://sasportal.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1alpha1/policies:set","baseUrl":"https://sasportal.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1alpha1/customers:setupSasAnalytics","baseUrl":"https://sasportal.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1alpha1/{+name}:signDevice","baseUrl":"https://sasportal.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1alpha1/policies:test","baseUrl":"https://sasportal.googleapis.com/"})),
...
}).pipe(T.Http({"method":"PATCH","uri":"v1alpha1/{+name}:updateSigned","baseUrl":"https://sasportal.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1alpha1/installer:validate","baseUrl":"https://sasportal.googleapis.com/"})),
