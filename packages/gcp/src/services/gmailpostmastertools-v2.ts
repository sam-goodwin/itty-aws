...
export const TimeQuery: Schema.Schema<TimeQuery> = /*@__PURE__*/ Schema.Struct({
...
export const GetComplianceStatusDomainsRequest = /*@__PURE__*/ Schema.Struct({
...
export const QueryDomainsDomainStatsRequest = /*@__PURE__*/ Schema.Struct({
...
export const BatchQueryDomainStatsRequest_Op = /*@__PURE__*/ Schema.Struct({
