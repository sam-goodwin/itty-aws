...
export const CNAME: Schema.Schema<CNAME> = /*@__PURE__*/ Schema.Struct({
...
export const IPs: Schema.Schema<IPs> = /*@__PURE__*/ Schema.Struct({
...
export const UsedBy: Schema.Schema<UsedBy> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const IpConfig: Schema.Schema<IpConfig> = /*@__PURE__*/ Schema.Struct({
