...
export type GoogleAppsScriptTypeFunctionList = GoogleAppsScriptTypeFunction[];
...
export type MetricsValueList = MetricsValue[];
...
export type GoogleAppsScriptTypeProcessList = GoogleAppsScriptTypeProcess[];
...
export type GetContentProjectsError = NotFound | Forbidden | GcpOpError;
...
export type GetMetricsProjectsError = NotFound | Forbidden | GcpOpError;
...
export type GetProjectsDeploymentsError = NotFound | Forbidden | GcpOpError;
...
export type GetProjectsVersionsError = NotFound | Forbidden | GcpOpError;
...
export type ListProcessesError = NotFound | Forbidden | GcpOpError;
