...
export const GetPasswordResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    password: S.optional(S.String),
  }),
).annotate({
  identifier: "GetPasswordResponse",
}) as any as S.Schema<GetPasswordResponse>;
...
export type DomainSettingStateEnum =
  | "STATE_UNSPECIFIED"
  | "PENDING"
  | "VERIFIED";
