...
export const Lun: Schema.Schema<Lun> = /*@__PURE__*/ Schema.Struct({
...
export const QosPolicy: Schema.Schema<QosPolicy> = /*@__PURE__*/ Schema.Struct({
...
export const VRF: Schema.Schema<VRF> = /*@__PURE__*/ Schema.Struct({
  qosPolicy: Schema.optional(QosPolicy),
  state: Schema.optional(Schema.String),
...
export const NfsShare: Schema.Schema<NfsShare> = /*@__PURE__*/ Schema.Struct({
...
export const OSImage: Schema.Schema<OSImage> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const SSHKey: Schema.Schema<SSHKey> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const LunRange: Schema.Schema<LunRange> = /*@__PURE__*/ Schema.Struct({
...
export const EvictLunRequest: Schema.Schema<EvictLunRequest> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "EvictLunRequest" });
...
export const GetProjectsLocationsNetworksRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v2/{+name}" }),
  svc,
...
export const ListProjectsLocationsNetworksRequest = /*@__PURE__*/ Schema.Struct(
  {
    pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
...
export const ListProjectsLocationsOsImagesRequest = /*@__PURE__*/ Schema.Struct(
  {
    pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
    pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
    parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const GetProjectsLocationsOsImagesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v2/{+name}" }),
  svc,
...
export const EvictProjectsLocationsVolumesRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
...
export const ListProjectsLocationsSshKeysRequest = /*@__PURE__*/ Schema.Struct({
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
}).pipe(
...
export const GetProjectsLocationsNfsSharesRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
  },
).pipe(
