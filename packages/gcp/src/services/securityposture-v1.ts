...
export const PolicySet: Schema.Schema<PolicySet> = /*@__PURE__*/ Schema.Struct({
  description: Schema.optional(Schema.String),
...
export const Posture: Schema.Schema<Posture> = /*@__PURE__*/ Schema.Struct({
  description: Schema.optional(Schema.String),
...
export const IaC: Schema.Schema<IaC> = /*@__PURE__*/ Schema.Struct({
