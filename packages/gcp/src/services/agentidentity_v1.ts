...
}).pipe(T.Http({"method":"POST","uri":"v1/{+parent}/authProviders","baseUrl":"https://agentidentity.googleapis.com/"})),
...
S.Struct({
  ...
  "requestId": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"DELETE","uri":"v1/{+name}","baseUrl":"https://agentidentity.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1/{+name}:disable","baseUrl":"https://agentidentity.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1/{+name}:enable","baseUrl":"https://agentidentity.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v1/{+resource}:getIamPolicy","baseUrl":"https://agentidentity.googleapis.com/"})),
...
S.Struct({
  "name": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v1/{+name}","baseUrl":"https://agentidentity.googleapis.com/"})),
...
S.Struct({
  ...
  "name": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v1/{+name}/locations","baseUrl":"https://agentidentity.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v1/{+parent}/accessSummaries","baseUrl":"https://agentidentity.googleapis.com/"})),
...
S.Struct({
  ...
  "filter": S.optional(S.String.pipe(T.Query())),
  "parent": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v1/{+parent}/authProviders","baseUrl":"https://agentidentity.googleapis.com/"})),
...
S.Struct({
  ...
  "orderBy": S.optional(S.String.pipe(T.Query())),
  "parent": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v1/{+parent}/authorizations","baseUrl":"https://agentidentity.googleapis.com/"})),
...
S.Struct({
  ...
  "name": S.String.pipe(T.Label()),
  "body": S.optional(AuthProvider.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"PATCH","uri":"v1/{+name}","baseUrl":"https://agentidentity.googleapis.com/"})),
...
S.Struct({
  ...
  "pageSize": S.optional(S.Number.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1/{+parent}/authProviders:query","baseUrl":"https://agentidentity.googleapis.com/"})),
...
S.Struct({
  ...
  "name": S.String.pipe(T.Label()),
  "pageSize": S.optional(S.Number.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1/{+name}:queryWorkloads","baseUrl":"https://agentidentity.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1/{+name}:revokeAuthorization","baseUrl":"https://agentidentity.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1/{+resource}:setIamPolicy","baseUrl":"https://agentidentity.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1/{+resource}:testIamPermissions","baseUrl":"https://agentidentity.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1/{+name}:undelete","baseUrl":"https://agentidentity.googleapis.com/"})),
