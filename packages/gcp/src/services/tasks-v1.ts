...
export const SpaceInfo: Schema.Schema<SpaceInfo> = /*@__PURE__*/ Schema.Struct({
...
export const Tasks: Schema.Schema<Tasks> = /*@__PURE__*/ Schema.Struct({
...
export const TaskList: Schema.Schema<TaskList> = /*@__PURE__*/ Schema.Struct({
  kind: Schema.optional(Schema.String),
  selfLink: Schema.optional(Schema.String),
  etag: Schema.optional(Schema.String),
  title: Schema.optional(Schema.String),
...
export const TaskLists: Schema.Schema<TaskLists> = /*@__PURE__*/ Schema.Struct({
  nextPageToken: Schema.optional(Schema.String),
...
export const DeleteTasksResponse: Schema.Schema<DeleteTasksResponse> =
  /*@__PURE__*/ Schema.Struct({}) as any as Schema.Schema<DeleteTasksResponse>;
...
export const ClearTasksResponse: Schema.Schema<ClearTasksResponse> =
  /*@__PURE__*/ Schema.Struct({}) as any as Schema.Schema<ClearTasksResponse>;
