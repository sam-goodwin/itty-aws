...
export const GoogleRE2: Schema.Schema<GoogleRE2> = /*@__PURE__*/ Schema.Struct({
...
export const Pipe: Schema.Schema<Pipe> = /*@__PURE__*/ Schema.Struct({
...
export const OrMatcher: Schema.Schema<OrMatcher> = /*@__PURE__*/ Schema.suspend(
  () =>
    Schema.Struct({
...
export const NullMatch: Schema.Schema<NullMatch> = /*@__PURE__*/ Schema.Struct(
  {},
).annotate({ identifier: "NullMatch" });
...
export const Locality: Schema.Schema<Locality> = /*@__PURE__*/ Schema.Struct({
...
export const Extension: Schema.Schema<Extension> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const Client_statusDiscoveryRequest = /*@__PURE__*/ Schema.Struct({
