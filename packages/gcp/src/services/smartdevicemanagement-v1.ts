...
export const GetEnterprisesStructuresRequest = /*@__PURE__*/ Schema.Struct({
...
export const ListEnterprisesStructuresRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetEnterprisesStructuresRoomsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
  },
).pipe(
