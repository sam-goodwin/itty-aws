...
export const ListProjectsGroupsRequest = /*@__PURE__*/ Schema.Struct({
...
export const BatchLeaveProjectsGroupsRequest = /*@__PURE__*/ Schema.Struct({
...
export const DeleteProjectsGroupsRequest = /*@__PURE__*/ Schema.Struct({
...
export const CreateProjectsGroupsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const PatchProjectsGroupsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const BatchJoinProjectsGroupsRequest = /*@__PURE__*/ Schema.Struct({
  group: Schema.String.pipe(T.HttpPath("group")),
...
export const ListProjectsTestersRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const BatchRemoveProjectsTestersRequest = /*@__PURE__*/ Schema.Struct({
...
export const PatchProjectsTestersRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
...
export const BatchAddProjectsTestersRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
...
export const GetAabInfoProjectsAppsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const GetProjectsAppsReleasesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const ListProjectsAppsReleasesRequest = /*@__PURE__*/ Schema.Struct({
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
...
export const PatchProjectsAppsReleasesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
