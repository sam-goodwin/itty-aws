...
export interface GetThumbnailPresentationsPagesRequest {
  ...
  "thumbnailProperties.mimeType"?: GetThumbnailPresentationsPagesThumbnailProperties_mimeTypeEnum;
  /** The optional thumbnail image size. If you don't specify the size, the server chooses a default size of the image. */
  "thumbnailProperties.thumbnailSize"?: GetThumbnailPresentationsPagesThumbnailProperties_thumbnailSizeEnum;
  /** The ID of the presentation to retrieve. */
  presentationId: string;
