...
export interface ComposeObjectsRequest {
  ...
  destinationPredefinedAcl?: ComposeObjectsDestinationPredefinedAclEnum;
...
export interface CopyObjectsRequest {
  ...
  destinationObject: string;
  /** Apply a predefined set of access controls to the destination object. */
  destinationPredefinedAcl?: CopyObjectsDestinationPredefinedAclEnum;
  ...
  projection?: CopyObjectsProjectionEnum;
...
export interface GetBucketsRequest {
  ...
  projection?: GetBucketsProjectionEnum;
  /** The project to be billed for this request. Required for Requester Pays buckets. */
  userProject?: string;
}
...
export interface GetObjectsRequest {
  ...
  object: string;
  /** Set of properties to return. Defaults to noAcl. */
  projection?: GetObjectsProjectionEnum;
  /** The project to be billed for this request. Required for Requester Pays buckets. */
  userProject?: string;
...
export interface BucketStorageLayout {
  ...
  bucket?: string;
  /** The bucket's custom placement configuration for Custom Dual Regions. */
  customPlacementConfig?: BucketStorageLayoutCustomPlacementConfig;
  /** The bucket's hierarchical namespace configuration. */
  hierarchicalNamespace?: BucketStorageLayoutHierarchicalNamespace;
...
export interface InsertBucketsRequest {
  ...
  predefinedAcl?: InsertBucketsPredefinedAclEnum;
  /** Apply a predefined set of default object access controls to this bucket. */
  predefinedDefaultObjectAcl?: InsertBucketsPredefinedDefaultObjectAclEnum;
  /** A valid API project identifier. */
  project: string;
  /** Set of properties to return. Defaults to noAcl, unless the bucket resource specifies acl or defaultObjectAcl properties, when it defaults to full. */
  projection?: InsertBucketsProjectionEnum;
  /** The project to be billed for this request. */
  userProject?: string;
...
export interface InsertObjectsRequest {
  ...
  predefinedAcl?: InsertObjectsPredefinedAclEnum;
  /** Set of properties to return. Defaults to noAcl, unless the object resource specifies the acl property, when it defaults to full. */
  projection?: InsertObjectsProjectionEnum;
  /** The project to be billed for this request. Required for Requester Pays buckets. */
  userProject?: string;
  /** Request body */
  body?: Storage_Object;
...
export interface ListBucketsRequest {
  ...
  project: string;
  /** Set of properties to return. Defaults to noAcl. */
  projection?: ListBucketsProjectionEnum;
  /** The project to be billed for this request. */
  userProject?: string;
...
export interface ListObjectsRequest {
  ...
  prefix?: string;
  /** Set of properties to return. Defaults to noAcl. */
  projection?: ListObjectsProjectionEnum;
...
export interface MoveObjectsRequest {
  ...
  ifMetagenerationNotMatch?: string;
  /** Set of properties to return. Defaults to noAcl. */
  projection?: MoveObjectsProjectionEnum;
  /** The project to be billed for this request. Required for Requester Pays buckets. */
  userProject?: string;
}
...
export interface PatchBucketsRequest {
  ...
  ifMetagenerationNotMatch?: string;
  /** Apply a predefined set of access controls to this bucket. */
  predefinedAcl?: PatchBucketsPredefinedAclEnum;
  /** Apply a predefined set of default object access controls to this bucket. */
  predefinedDefaultObjectAcl?: PatchBucketsPredefinedDefaultObjectAclEnum;
  /** Set of properties to return. Defaults to full. */
  projection?: PatchBucketsProjectionEnum;
  /** The project to be billed for this request. Required for Requester Pays buckets. */
  userProject?: string;
  /** Request body */
  body?: Bucket;
...
export interface PatchObjectsRequest {
  ...
  object: string;
  /** Apply a predefined set of access controls to this object. */
  predefinedAcl?: PatchObjectsPredefinedAclEnum;
  /** Set of properties to return. Defaults to full. */
  projection?: PatchObjectsProjectionEnum;
...
export interface RelocateBucketRequest {
  ...
  destinationCustomPlacementConfig?: RelocateBucketRequestDestinationCustomPlacementConfig;
...
export interface RestoreBucketsRequest {
  ...
  generation: string;
  /** Set of properties to return. Defaults to full. */
  projection?: RestoreBucketsProjectionEnum;
  /** The project to be billed for this request. Required for Requester Pays buckets. */
  userProject?: string;
}
...
export interface RestoreObjectsRequest {
  ...
  copySourceAcl?: boolean;
  /** Set of properties to return. Defaults to full. */
  projection?: RestoreObjectsProjectionEnum;
  /** The project to be billed for this request. Required for Requester Pays buckets. */
  userProject?: string;
...
export interface RewriteObjectsRequest {
  ...
  destinationObject: string;
  /** Apply a predefined set of access controls to the destination object. */
  destinationPredefinedAcl?: RewriteObjectsDestinationPredefinedAclEnum;
  ...
  /** Set of properties to return. Defaults to noAcl, unless the object resource specifies the acl property, when it defaults to full. */
  projection?: RewriteObjectsProjectionEnum;
...
export interface UpdateBucketsRequest {
  ...
  ifMetagenerationNotMatch?: string;
  /** Apply a predefined set of access controls to this bucket. */
  predefinedAcl?: UpdateBucketsPredefinedAclEnum;
  /** Apply a predefined set of default object access controls to this bucket. */
  predefinedDefaultObjectAcl?: UpdateBucketsPredefinedDefaultObjectAclEnum;
  /** Set of properties to return. Defaults to full. */
  projection?: UpdateBucketsProjectionEnum;
  /** The project to be billed for this request. Required for Requester Pays buckets. */
  userProject?: string;
  /** Request body */
  body?: Bucket;
...
export interface UpdateObjectsRequest {
  ...
  object: string;
  /** Apply a predefined set of access controls to this object. */
  predefinedAcl?: UpdateObjectsPredefinedAclEnum;
  /** Set of properties to return. Defaults to full. */
  projection?: UpdateObjectsProjectionEnum;
  /** The project to be billed for this request. Required for Requester Pays buckets. */
  userProject?: string;
  /** Request body */
  body?: Storage_Object;
