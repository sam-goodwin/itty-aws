...
export type ReferenceSentencePairList_ = ReferenceSentencePair[];
...
export type ReferenceSentencePairListList = ReferenceSentencePairList[];
...
export type AdaptiveMtTranslationList = AdaptiveMtTranslation[];
...
export type BatchDocumentInputConfigList = BatchDocumentInputConfig[];
...
export type InputConfigList = InputConfig[];
...
export type GlossaryTermList = GlossaryTerm[];
...
export type SupportedLanguageList = SupportedLanguage[];
...
export type InputFileList = InputFile[];
...
export type AdaptiveMtDatasetList = AdaptiveMtDataset[];
...
export type AdaptiveMtFileList = AdaptiveMtFile[];
...
export type AdaptiveMtSentenceList = AdaptiveMtSentence[];
...
export type GlossaryList = Glossary[];
...
export type GlossaryEntryList = GlossaryEntry[];
...
export type RefinementEntryList = RefinementEntry[];
...
export type RomanizationList = Romanization[];
