...
export const GetFoldersLocationsReplaysRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const CreateFoldersLocationsReplaysRequest = /*@__PURE__*/ Schema.Struct(
  {
...
export const GetProjectsLocationsReplaysRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
