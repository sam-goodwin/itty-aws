...
export const Seats: Schema.Schema<Seats> = /*@__PURE__*/ Schema.Struct({
...
export const GetwatchdetailsResellernotifyRequest = /*@__PURE__*/ Schema.Struct(
  {},
).pipe(
  T.Http({
    method: "GET",
...
export const RegisterResellernotifyRequest = /*@__PURE__*/ Schema.Struct({
...
export const UnregisterResellernotifyRequest = /*@__PURE__*/ Schema.Struct({
  serviceAccountEmailAddress: Schema.optional(Schema.String).pipe(
    T.HttpQuery("serviceAccountEmailAddress"),
  ),
}).pipe(
...
export const ActivateSubscriptionsRequest = /*@__PURE__*/ Schema.Struct({
  customerId: Schema.String.pipe(T.HttpPath("customerId")),
...
export const ChangePlanSubscriptionsRequest = /*@__PURE__*/ Schema.Struct({
  customerId: Schema.String.pipe(T.HttpPath("customerId")),
  subscriptionId: Schema.String.pipe(T.HttpPath("subscriptionId")),
...
export const ChangeSeatsSubscriptionsRequest = /*@__PURE__*/ Schema.Struct({
  customerId: Schema.String.pipe(T.HttpPath("customerId")),
  subscriptionId: Schema.String.pipe(T.HttpPath("subscriptionId")),
...
export const StartPaidServiceSubscriptionsRequest = /*@__PURE__*/ Schema.Struct(
  {
    customerId: Schema.String.pipe(T.HttpPath("customerId")),
    subscriptionId: Schema.String.pipe(T.HttpPath("subscriptionId")),
  },
...
export const SuspendSubscriptionsRequest = /*@__PURE__*/ Schema.Struct({
  customerId: Schema.String.pipe(T.HttpPath("customerId")),
  subscriptionId: Schema.String.pipe(T.HttpPath("subscriptionId")),
}).pipe(
  T.Http({
