...
export const BootDisk: Schema.Schema<BootDisk> = /*@__PURE__*/ Schema.Struct({
...
export const UpdateLoginNode: Schema.Schema<UpdateLoginNode> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "UpdateLoginNode" });
...
export const CreateLoginNode: Schema.Schema<CreateLoginNode> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "CreateLoginNode" });
...
export const DeleteLoginNode: Schema.Schema<DeleteLoginNode> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "DeleteLoginNode" });
