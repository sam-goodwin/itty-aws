...
export interface ListCommentsRequest {
  ...
  postId: string;
  maxResults?: number;
  status?: ListCommentsStatusEnum;
  fetchBodies?: boolean;
  blogId: string;
  endDate?: string;
  startDate?: string;
  view?: ListCommentsViewEnum;
}
...
export interface ListPostsRequest {
  ...
  fetchBodies?: boolean;
  orderBy?: ListPostsOrderByEnum;
  startDate?: string;
  view?: ListPostsViewEnum;
  fetchImages?: boolean;
  pageToken?: string;
  labels?: string;
  maxResults?: number;
  /** Sort direction applied to post list. */
  sortOption?: ListPostsSortOptionEnum;
}
...
export interface ListPostUserInfosRequest {
  ...
  maxResults?: number;
  pageToken?: string;
  orderBy?: ListPostUserInfosOrderByEnum;
  startDate?: string;
  view?: ListPostUserInfosViewEnum;
  userId: string;
  endDate?: string;
  blogId: string;
  fetchBodies?: boolean;
...
export interface SearchPostsRequest {
  fetchBodies?: boolean;
  q: string;
  orderBy?: SearchPostsOrderByEnum;
  blogId: string;
}
