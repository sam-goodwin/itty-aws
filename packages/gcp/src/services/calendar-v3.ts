...
export const Colors: Schema.Schema<Colors> = /*@__PURE__*/ Schema.Struct({
...
export const Calendar: Schema.Schema<Calendar> = /*@__PURE__*/ Schema.Struct({
...
export const Events: Schema.Schema<Events> = /*@__PURE__*/ Schema.Struct({
  nextPageToken: Schema.optional(Schema.String),
  etag: Schema.optional(Schema.String),
  summary: Schema.optional(Schema.String),
  description: Schema.optional(Schema.String),
...
export const DeleteAclResponse: Schema.Schema<DeleteAclResponse> =
  /*@__PURE__*/ Schema.Struct({}) as any as Schema.Schema<DeleteAclResponse>;
...
export const DeleteCalendarListRequest = /*@__PURE__*/ Schema.Struct({
  calendarId: Schema.String.pipe(T.HttpPath("calendarId")),
}).pipe(
...
export const InsertCalendarListRequest = /*@__PURE__*/ Schema.Struct({
...
export const UpdateCalendarListRequest = /*@__PURE__*/ Schema.Struct({
  calendarId: Schema.String.pipe(T.HttpPath("calendarId")),
  colorRgbFormat: Schema.optional(Schema.Boolean).pipe(
    T.HttpQuery("colorRgbFormat"),
  ),
...
export const WatchCalendarListRequest = /*@__PURE__*/ Schema.Struct({
...
export const PatchCalendarListRequest = /*@__PURE__*/ Schema.Struct({
  calendarId: Schema.String.pipe(T.HttpPath("calendarId")),
  colorRgbFormat: Schema.optional(Schema.Boolean).pipe(
    T.HttpQuery("colorRgbFormat"),
  ),
...
export const ListCalendarListRequest = /*@__PURE__*/ Schema.Struct({
  minAccessRole: Schema.optional(Schema.String).pipe(
    T.HttpQuery("minAccessRole"),
  ),
  showDeleted: Schema.optional(Schema.Boolean).pipe(T.HttpQuery("showDeleted")),
...
export const DeleteEventsResponse: Schema.Schema<DeleteEventsResponse> =
  /*@__PURE__*/ Schema.Struct({}) as any as Schema.Schema<DeleteEventsResponse>;
