...
export const Bin: Schema.Schema<Bin> = /*@__PURE__*/ Schema.Struct({
  end: Schema.optional(Schema.Unknown),
...
export const QueryHistoryRecordRecordsRequest = /*@__PURE__*/ Schema.Struct({
...
export const QueryRecordRecordsRequest = /*@__PURE__*/ Schema.Struct({
