...
export const Setting: Schema.Schema<Setting> = /*@__PURE__*/ Schema.Struct({
...
export const EntityKey: Schema.Schema<EntityKey> = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
...
export const UpdateSecuritySettingsGroupsRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetSecuritySettingsGroupsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const LookupGroupsMembershipsRequest = /*@__PURE__*/ Schema.Struct({
...
export const CreateGroupsMembershipsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const GetGroupsMembershipsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const DeleteGroupsMembershipsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "DELETE", path: "v1/{+name}" }),
  svc,
...
export const ListGroupsMembershipsRequest = /*@__PURE__*/ Schema.Struct({
  view: Schema.optional(Schema.String).pipe(T.HttpQuery("view")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const GetCustomersUserinvitationsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const ListCustomersUserinvitationsRequest = /*@__PURE__*/ Schema.Struct({
...
export const SendCustomersUserinvitationsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const PatchInboundSamlSsoProfilesRequest = /*@__PURE__*/ Schema.Struct({
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const GetInboundSamlSsoProfilesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const ListInboundSamlSsoProfilesRequest = /*@__PURE__*/ Schema.Struct({
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
}).pipe(
...
export const CreateInboundSamlSsoProfilesRequest = /*@__PURE__*/ Schema.Struct({
  body: Schema.optional(InboundSamlSsoProfile).pipe(T.HttpBody()),
}).pipe(
...
export const DeleteInboundSamlSsoProfilesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "DELETE", path: "v1/{+name}" }),
  svc,
...
export const DeleteInboundSsoAssignmentsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "DELETE", path: "v1/{+name}" }),
  svc,
...
export const CreateInboundSsoAssignmentsRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetInboundSsoAssignmentsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const ListInboundSsoAssignmentsRequest = /*@__PURE__*/ Schema.Struct({
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
}).pipe(
...
export const PatchInboundSsoAssignmentsRequest = /*@__PURE__*/ Schema.Struct({
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(InboundSsoAssignment).pipe(T.HttpBody()),
}).pipe(
...
export const CreateInboundOidcSsoProfilesRequest = /*@__PURE__*/ Schema.Struct({
...
export const DeleteInboundOidcSsoProfilesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "DELETE", path: "v1/{+name}" }),
  svc,
...
export const PatchInboundOidcSsoProfilesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(InboundOidcSsoProfile).pipe(T.HttpBody()),
}).pipe(
...
export const GetInboundOidcSsoProfilesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const ListInboundOidcSsoProfilesRequest = /*@__PURE__*/ Schema.Struct({
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
}).pipe(
...
export const CancelWipeDevicesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const GetDevicesResponse =
  /*@__PURE__*/ GoogleAppsCloudidentityDevicesV1Device;
...
export const ListDevicesResponse =
  /*@__PURE__*/ GoogleAppsCloudidentityDevicesV1ListDevicesResponse;
...
export const CancelWipeDevicesDeviceUsersRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(
...
export const GetDevicesDeviceUsersRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  customer: Schema.optional(Schema.String).pipe(T.HttpQuery("customer")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
...
export const GetDevicesDeviceUsersResponse =
  /*@__PURE__*/ GoogleAppsCloudidentityDevicesV1DeviceUser;
...
export const ListDevicesDeviceUsersRequest = /*@__PURE__*/ Schema.Struct({
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
  customer: Schema.optional(Schema.String).pipe(T.HttpQuery("customer")),
  orderBy: Schema.optional(Schema.String).pipe(T.HttpQuery("orderBy")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const ListDevicesDeviceUsersResponse =
  /*@__PURE__*/ GoogleAppsCloudidentityDevicesV1ListDeviceUsersResponse;
...
export const ApproveDevicesDeviceUsersRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(
...
export const WipeDevicesDeviceUsersRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(
...
export const DeleteDevicesDeviceUsersRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  customer: Schema.optional(Schema.String).pipe(T.HttpQuery("customer")),
}).pipe(
  T.Http({ method: "DELETE", path: "v1/{+name}" }),
...
export const LookupDevicesDeviceUsersRequest = /*@__PURE__*/ Schema.Struct({
...
export const LookupDevicesDeviceUsersResponse =
  /*@__PURE__*/ GoogleAppsCloudidentityDevicesV1LookupSelfDeviceUsersResponse;
...
export const BlockDevicesDeviceUsersRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(
...
export const GetDevicesDeviceUsersClientStatesResponse =
  /*@__PURE__*/ GoogleAppsCloudidentityDevicesV1ClientState;
...
export const ListDevicesDeviceUsersClientStatesResponse =
  /*@__PURE__*/ GoogleAppsCloudidentityDevicesV1ListClientStatesResponse;
