...
export const Selection: Schema.Schema<Selection> = /*@__PURE__*/ Schema.Struct({
...
export const Rename: Schema.Schema<Rename> = /*@__PURE__*/ Schema.Struct({
...
export const NoConsolidation: Schema.Schema<NoConsolidation> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "NoConsolidation" });
...
export const Restore: Schema.Schema<Restore> = /*@__PURE__*/ Schema.Struct({
  type: Schema.optional(Schema.String),
...
export const DriveFile: Schema.Schema<DriveFile> = /*@__PURE__*/ Schema.Struct(
  {},
...
export const Move: Schema.Schema<Move> = /*@__PURE__*/ Schema.Struct({
...
export const Copy: Schema.Schema<Copy> = /*@__PURE__*/ Schema.Struct({
  originalObject: Schema.optional(TargetReference),
}).annotate({ identifier: "Copy" });

export interface New {}

export const New: Schema.Schema<New> = /*@__PURE__*/ Schema.Struct({}).annotate(
  { identifier: "New" },
);

export interface Upload {}

export const Upload: Schema.Schema<Upload> = /*@__PURE__*/ Schema.Struct(
  {},
...
export const Create: Schema.Schema<Create> = /*@__PURE__*/ Schema.Struct({
...
export const Anyone: Schema.Schema<Anyone> = /*@__PURE__*/ Schema.Struct(
  {},
).annotate({ identifier: "Anyone" });

export interface DeletedUser {}

export const DeletedUser: Schema.Schema<DeletedUser> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "DeletedUser" });
...
export const KnownUser: Schema.Schema<KnownUser> = /*@__PURE__*/ Schema.Struct({
...
export const UnknownUser: Schema.Schema<UnknownUser> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "UnknownUser" });
...
export const Domain: Schema.Schema<Domain> = /*@__PURE__*/ Schema.Struct({
...
export const Edit: Schema.Schema<Edit> = /*@__PURE__*/ Schema.Struct(
  {},
).annotate({ identifier: "Edit" });
...
export const Post: Schema.Schema<Post> = /*@__PURE__*/ Schema.Struct({
...
export const Text: Schema.Schema<Text> = /*@__PURE__*/ Schema.Struct({
  value: Schema.optional(Schema.String),
...
export const Integer: Schema.Schema<Integer> = /*@__PURE__*/ Schema.Struct({
  value: Schema.optional(Schema.String),
...
export const TextList: Schema.Schema<TextList> = /*@__PURE__*/ Schema.Struct({
...
export const Administrator: Schema.Schema<Administrator> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "Administrator" });

export interface AnonymousUser {}

export const AnonymousUser: Schema.Schema<AnonymousUser> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "AnonymousUser" });
...
export const Actor: Schema.Schema<Actor> = /*@__PURE__*/ Schema.Struct({
  user: Schema.optional(User),
...
export const Owner: Schema.Schema<Owner> = /*@__PURE__*/ Schema.Struct({
  user: Schema.optional(User),
  teamDrive: Schema.optional(TeamDriveReference),
  drive: Schema.optional(DriveReference),
  domain: Schema.optional(Domain),
...
export const DriveItem: Schema.Schema<DriveItem> = /*@__PURE__*/ Schema.Struct({
...
export const TeamDrive: Schema.Schema<TeamDrive> = /*@__PURE__*/ Schema.Struct({
...
export const Drive: Schema.Schema<Drive> = /*@__PURE__*/ Schema.Struct({
  root: Schema.optional(DriveItem),
  name: Schema.optional(Schema.String),
  title: Schema.optional(Schema.String),
...
export const Target: Schema.Schema<Target> = /*@__PURE__*/ Schema.Struct({
...
export const TimeRange: Schema.Schema<TimeRange> = /*@__PURE__*/ Schema.Struct({
...
export const Legacy: Schema.Schema<Legacy> = /*@__PURE__*/ Schema.Struct(
  {},
).annotate({ identifier: "Legacy" });
