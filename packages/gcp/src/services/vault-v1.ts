...
export const Matter: Schema.Schema<Matter> = /*@__PURE__*/ Schema.Struct({
...
export const GeminiOptions: Schema.Schema<GeminiOptions> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "GeminiOptions" });
...
export const Export: Schema.Schema<Export> = /*@__PURE__*/ Schema.Struct({
...
export const HeldCalendarQuery: Schema.Schema<HeldCalendarQuery> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "HeldCalendarQuery" });
...
export const Hold: Schema.Schema<Hold> = /*@__PURE__*/ Schema.Struct({
...
export const AddPermissionsMattersRequest = /*@__PURE__*/ Schema.Struct({
  matterId: Schema.String.pipe(T.HttpPath("matterId")),
...
export const RemovePermissionsMattersRequest = /*@__PURE__*/ Schema.Struct({
  matterId: Schema.String.pipe(T.HttpPath("matterId")),
...
export const CreateMattersExportsRequest = /*@__PURE__*/ Schema.Struct({
  matterId: Schema.String.pipe(T.HttpPath("matterId")),
...
export const DeleteMattersExportsRequest = /*@__PURE__*/ Schema.Struct({
  matterId: Schema.String.pipe(T.HttpPath("matterId")),
...
export const GetMattersExportsRequest = /*@__PURE__*/ Schema.Struct({
  matterId: Schema.String.pipe(T.HttpPath("matterId")),
  exportId: Schema.String.pipe(T.HttpPath("exportId")),
}).pipe(
...
export const ListMattersExportsRequest = /*@__PURE__*/ Schema.Struct({
  matterId: Schema.String.pipe(T.HttpPath("matterId")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
}).pipe(
...
export const CreateMattersHoldsRequest = /*@__PURE__*/ Schema.Struct({
  matterId: Schema.String.pipe(T.HttpPath("matterId")),
...
export const UpdateMattersHoldsRequest = /*@__PURE__*/ Schema.Struct({
  matterId: Schema.String.pipe(T.HttpPath("matterId")),
...
export const DeleteMattersHoldsRequest = /*@__PURE__*/ Schema.Struct({
  matterId: Schema.String.pipe(T.HttpPath("matterId")),
  holdId: Schema.String.pipe(T.HttpPath("holdId")),
}).pipe(
...
export const ListMattersHoldsRequest = /*@__PURE__*/ Schema.Struct({
  matterId: Schema.String.pipe(T.HttpPath("matterId")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  view: Schema.optional(Schema.String).pipe(T.HttpQuery("view")),
...
export const AddHeldAccountsMattersHoldsRequest = /*@__PURE__*/ Schema.Struct({
  matterId: Schema.String.pipe(T.HttpPath("matterId")),
  holdId: Schema.String.pipe(T.HttpPath("holdId")),
...
export const CreateMattersHoldsAccountsRequest = /*@__PURE__*/ Schema.Struct({
  matterId: Schema.String.pipe(T.HttpPath("matterId")),
  holdId: Schema.String.pipe(T.HttpPath("holdId")),
...
export const DeleteMattersHoldsAccountsRequest = /*@__PURE__*/ Schema.Struct({
  matterId: Schema.String.pipe(T.HttpPath("matterId")),
  holdId: Schema.String.pipe(T.HttpPath("holdId")),
...
export const ListMattersHoldsAccountsRequest = /*@__PURE__*/ Schema.Struct({
  matterId: Schema.String.pipe(T.HttpPath("matterId")),
  holdId: Schema.String.pipe(T.HttpPath("holdId")),
}).pipe(
  T.Http({
...
export const CreateMattersSavedQueriesRequest = /*@__PURE__*/ Schema.Struct({
  matterId: Schema.String.pipe(T.HttpPath("matterId")),
...
export const DeleteMattersSavedQueriesRequest = /*@__PURE__*/ Schema.Struct({
  matterId: Schema.String.pipe(T.HttpPath("matterId")),
...
export const GetMattersSavedQueriesRequest = /*@__PURE__*/ Schema.Struct({
  matterId: Schema.String.pipe(T.HttpPath("matterId")),
  savedQueryId: Schema.String.pipe(T.HttpPath("savedQueryId")),
}).pipe(
  T.Http({
...
export const ListMattersSavedQueriesRequest = /*@__PURE__*/ Schema.Struct({
  matterId: Schema.String.pipe(T.HttpPath("matterId")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
}).pipe(
