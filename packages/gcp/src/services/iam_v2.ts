...
S.Struct({
  ...
  "body": S.optional(GoogleIamV2Policy.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"POST","uri":"v2/{+parent}","baseUrl":"https://iam.googleapis.com/"})),
...
}).pipe(T.Http({"method":"DELETE","uri":"v2/{+name}","baseUrl":"https://iam.googleapis.com/"})),
...
S.Struct({
  "name": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v2/{+name}","baseUrl":"https://iam.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v2/{+parent}","baseUrl":"https://iam.googleapis.com/"})),
...
export const GoogleIamV2PolicyList = /*@__PURE__*/ S.Array(GoogleIamV2Policy) as any as S.Schema<GoogleIamV2PolicyList>;

/** Response message for `ListPolicies`. */
export interface GoogleIamV2ListPoliciesResponse {
  /** Metadata for the policies that are attached to the resource. */
  policies?: GoogleIamV2PolicyList;
...
export const GoogleIamV2ListPoliciesResponse = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "policies": S.optional(GoogleIamV2PolicyList),
  "nextPageToken": S.optional(S.String),
}),
).annotate({ identifier: "GoogleIamV2ListPoliciesResponse" }) as any as S.Schema<GoogleIamV2ListPoliciesResponse>;
...
S.Struct({
  "name": S.String.pipe(T.Label()),
  "body": S.optional(GoogleIamV2Policy.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"PUT","uri":"v2/{+name}","baseUrl":"https://iam.googleapis.com/"})),
