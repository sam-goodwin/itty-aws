...
}).pipe(T.Http({"method":"POST","uri":"v2/{+name}:abortFunctionUpgrade","baseUrl":"https://cloudfunctions.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v2/{+name}:commitFunctionUpgradeAsGen2","baseUrl":"https://cloudfunctions.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v2/{+name}:commitFunctionUpgrade","baseUrl":"https://cloudfunctions.googleapis.com/"})),
...
export type GoogleCloudFunctionsV2StateMessageSeverityEnum = "SEVERITY_UNSPECIFIED" | "ERROR" | "WARNING" | "INFO";
export const GoogleCloudFunctionsV2StateMessageSeverityEnum = /*@__PURE__*/ S.String;
...
).annotate({ identifier: "GoogleCloudFunctionsV2StateMessage" }) as any as S.Schema<GoogleCloudFunctionsV2StateMessage>;

export type GoogleCloudFunctionsV2StateMessageList = ReadonlyArray<GoogleCloudFunctionsV2StateMessage>;
export const GoogleCloudFunctionsV2StateMessageList = /*@__PURE__*/ S.Array(GoogleCloudFunctionsV2StateMessage) as any as S.Schema<GoogleCloudFunctionsV2StateMessageList>;
...
}).pipe(T.Http({"method":"POST","uri":"v2/{+parent}/functions","baseUrl":"https://cloudfunctions.googleapis.com/"})),
...
S.Struct({
  "name": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"DELETE","uri":"v2/{+name}","baseUrl":"https://cloudfunctions.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v2/{+name}:detachFunction","baseUrl":"https://cloudfunctions.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v2/{+name}:generateDownloadUrl","baseUrl":"https://cloudfunctions.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v2/{+parent}/functions:generateUploadUrl","baseUrl":"https://cloudfunctions.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v2/{+resource}:getIamPolicy","baseUrl":"https://cloudfunctions.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v2/{+name}","baseUrl":"https://cloudfunctions.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v2/{+name}/locations","baseUrl":"https://cloudfunctions.googleapis.com/"})),
...
S.Struct({
  ...
  "pageToken": S.optional(S.String.pipe(T.Query())),
  "pageSize": S.optional(S.Number.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v2/{+parent}/functions","baseUrl":"https://cloudfunctions.googleapis.com/"})),
...
S.Struct({
  ...
  "name": S.String.pipe(T.Label()),
  "filter": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v2/{+name}/operations","baseUrl":"https://cloudfunctions.googleapis.com/"})),
...
S.Struct({
  "parent": S.String.pipe(T.Label()),
  "filter": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v2/{+parent}/runtimes","baseUrl":"https://cloudfunctions.googleapis.com/"})),
...
S.Struct({
  ...
  "body": S.optional(Cloudfunctions_Function.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"PATCH","uri":"v2/{+name}","baseUrl":"https://cloudfunctions.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v2/{+name}:redirectFunctionUpgradeTraffic","baseUrl":"https://cloudfunctions.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v2/{+name}:rollbackFunctionUpgradeTraffic","baseUrl":"https://cloudfunctions.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v2/{+resource}:setIamPolicy","baseUrl":"https://cloudfunctions.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v2/{+name}:setupFunctionUpgradeConfig","baseUrl":"https://cloudfunctions.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v2/{+resource}:testIamPermissions","baseUrl":"https://cloudfunctions.googleapis.com/"})),
