...
export interface PostureDeployment {
  ...
  state?: PostureDeploymentStateEnum;
...
export interface SecurityHealthAnalyticsCustomModule {
  ...
  moduleEnablementState?: SecurityHealthAnalyticsCustomModuleModuleEnablementStateEnum;
...
export interface GoogleCloudSecuritypostureV1CustomConstraint {
  ...
  actionType?: GoogleCloudSecuritypostureV1CustomConstraintActionTypeEnum;
