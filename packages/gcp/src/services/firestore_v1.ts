...
export const GoogleFirestoreAdminV1CollectionGroupScope =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      collectionGroupId: S.optional(S.String),
    }),
  ).annotate({
...
export const CreateProjectsDatabasesChangeStreamsRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      parent: S.String.pipe(T.Label()),
...
export interface DeleteProjectsDatabasesChangeStreamsRequest {
...
export const DeleteProjectsDatabasesChangeStreamsRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      name: S.String.pipe(T.Label()),
      etag: S.optional(S.String.pipe(T.Query())),
  ...
  }) as any as S.Schema<DeleteProjectsDatabasesChangeStreamsRequest>;
...
export interface GetProjectsDatabasesChangeStreamsRequest {
...
export const GetProjectsDatabasesChangeStreamsRequest = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      name: S.String.pipe(T.Label()),
    }).pipe(
...
}) as any as S.Schema<GetProjectsDatabasesChangeStreamsRequest>;
...
export interface ListProjectsDatabasesChangeStreamsRequest {
  /** Required. The parent database to list change streams from. Format is `projects/{project}/databases/{database}`. */
  parent: string;
}
export const ListProjectsDatabasesChangeStreamsRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      parent: S.String.pipe(T.Label()),
    }).pipe(
    ...
    identifier: "ListProjectsDatabasesChangeStreamsRequest",
  }) as any as S.Schema<ListProjectsDatabasesChangeStreamsRequest>;

export type GoogleFirestoreAdminV1ChangeStreamList =
  Array<GoogleFirestoreAdminV1ChangeStream>;
export const GoogleFirestoreAdminV1ChangeStreamList = /*@__PURE__*/ S.Array(
  GoogleFirestoreAdminV1ChangeStream,
) as any as S.Schema<GoogleFirestoreAdminV1ChangeStreamList>;

/** Response to FirestoreAdmin.ListChangeStreams. */
export interface GoogleFirestoreAdminV1ListChangeStreamsResponse {
  /** The list of change streams. */
  changeStreams?: GoogleFirestoreAdminV1ChangeStreamList;
}
export const GoogleFirestoreAdminV1ListChangeStreamsResponse =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      changeStreams: S.optional(GoogleFirestoreAdminV1ChangeStreamList),
    }),
  ).annotate({
    identifier: "GoogleFirestoreAdminV1ListChangeStreamsResponse",
...
export type CreateProjectsDatabasesChangeStreamsError =
  | NotFound
  | Forbidden
  | BadRequest
  | Conflict
...
export const createProjectsDatabasesChangeStreams: API.OperationMethod<
  CreateProjectsDatabasesChangeStreamsRequest,
  GoogleFirestoreAdminV1ChangeStream,
  CreateProjectsDatabasesChangeStreamsError,
  GcpOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: CreateProjectsDatabasesChangeStreamsRequest,
  output: GoogleFirestoreAdminV1ChangeStream,
  errors: [NotFound, Forbidden, BadRequest, Conflict, UnknownGCPError],
  protocol: GcpProtocol,
  retry: Retry.Retry,
}));
...
export type DeleteProjectsDatabasesChangeStreamsError =
  | NotFound
  | Forbidden
  | BadRequest
  | Conflict
...
export const deleteProjectsDatabasesChangeStreams: API.OperationMethod<
  DeleteProjectsDatabasesChangeStreamsRequest,
  Empty,
  DeleteProjectsDatabasesChangeStreamsError,
  GcpOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: DeleteProjectsDatabasesChangeStreamsRequest,
  output: Empty,
  errors: [NotFound, Forbidden, BadRequest, Conflict, UnknownGCPError],
  protocol: GcpProtocol,
  retry: Retry.Retry,
...
export type GetProjectsDatabasesChangeStreamsError =
  | NotFound
  | Forbidden
  | GcpOpError;
/** Gets information about a change stream. */
export const getProjectsDatabasesChangeStreams: API.OperationMethod<
  GetProjectsDatabasesChangeStreamsRequest,
  GoogleFirestoreAdminV1ChangeStream,
  GetProjectsDatabasesChangeStreamsError,
  GcpOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetProjectsDatabasesChangeStreamsRequest,
  output: GoogleFirestoreAdminV1ChangeStream,
  errors: [NotFound, Forbidden, UnknownGCPError],
  protocol: GcpProtocol,
  retry: Retry.Retry,
...
export type ListProjectsDatabasesChangeStreamsError =
  | NotFound
  | Forbidden
  | GcpOpError;
/** Lists all change streams in a database. */
export const listProjectsDatabasesChangeStreams: API.OperationMethod<
  ListProjectsDatabasesChangeStreamsRequest,
  GoogleFirestoreAdminV1ListChangeStreamsResponse,
  ListProjectsDatabasesChangeStreamsError,
  GcpOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: ListProjectsDatabasesChangeStreamsRequest,
  output: GoogleFirestoreAdminV1ListChangeStreamsResponse,
  errors: [NotFound, Forbidden, UnknownGCPError],
  protocol: GcpProtocol,
  retry: Retry.Retry,
}));
