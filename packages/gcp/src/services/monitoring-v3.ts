...
export const BasicSli: Schema.Schema<BasicSli> = /*@__PURE__*/ Schema.Struct({
...
export const Daily: Schema.Schema<Daily> = /*@__PURE__*/ Schema.Struct({
...
export const Minutes: Schema.Schema<Minutes> = /*@__PURE__*/ Schema.Struct({
  periodicity: Schema.optional(Schema.Number),
...
export const Hourly: Schema.Schema<Hourly> = /*@__PURE__*/ Schema.Struct({
  periodicity: Schema.optional(Schema.Number),
...
export const LogMatch: Schema.Schema<LogMatch> = /*@__PURE__*/ Schema.Struct({
...
export const HttpCheck: Schema.Schema<HttpCheck> = /*@__PURE__*/ Schema.Struct({
...
export const TcpCheck: Schema.Schema<TcpCheck> = /*@__PURE__*/ Schema.Struct({
  port: Schema.optional(Schema.Number),
  pingConfig: Schema.optional(PingConfig),
...
export const PointData: Schema.Schema<PointData> = /*@__PURE__*/ Schema.Struct({
...
export const Custom: Schema.Schema<Custom> = /*@__PURE__*/ Schema.Struct(
  {},
).annotate({ identifier: "Custom" });
...
export const AppEngine: Schema.Schema<AppEngine> = /*@__PURE__*/ Schema.Struct({
...
export const Telemetry: Schema.Schema<Telemetry> = /*@__PURE__*/ Schema.Struct({
...
export const MeshIstio: Schema.Schema<MeshIstio> = /*@__PURE__*/ Schema.Struct({
  serviceName: Schema.optional(Schema.String),
  meshUid: Schema.optional(Schema.String),
  serviceNamespace: Schema.optional(Schema.String),
...
export const Criteria: Schema.Schema<Criteria> = /*@__PURE__*/ Schema.Struct({
...
export const Snooze: Schema.Schema<Snooze> = /*@__PURE__*/ Schema.Struct({
  interval: Schema.optional(TimeInterval),
  name: Schema.optional(Schema.String),
  displayName: Schema.optional(Schema.String),
...
export const GetProjectsMetricDescriptorsRequest = /*@__PURE__*/ Schema.Struct({
...
export const ListProjectsMetricDescriptorsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
...
export const QueryProjectsTimeSeriesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const ListProjectsTimeSeriesRequest = /*@__PURE__*/ Schema.Struct({
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
...
export const CreateProjectsTimeSeriesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(CreateTimeSeriesRequest).pipe(T.HttpBody()),
}).pipe(
...
export const CreateProjectsSnoozesRequest = /*@__PURE__*/ Schema.Struct({
...
export const ListProjectsSnoozesRequest = /*@__PURE__*/ Schema.Struct({
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
...
export const PatchProjectsSnoozesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const GetProjectsSnoozesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v3/{+name}" }),
  svc,
...
export const GetProjectsUptimeCheckConfigsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
  },
).pipe(
...
export const ListProjectsGroupsMembersRequest = /*@__PURE__*/ Schema.Struct({
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
  "interval.startTime": Schema.optional(Schema.String).pipe(
    T.HttpQuery("interval.startTime"),
...
export const DeleteProjectsAlertPoliciesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "DELETE", path: "v3/{+name}" }),
  svc,
...
export const GetProjectsAlertPoliciesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v3/{+name}" }),
  svc,
...
export const ListProjectsAlertPoliciesRequest = /*@__PURE__*/ Schema.Struct({
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
  name: Schema.String.pipe(T.HttpPath("name")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  orderBy: Schema.optional(Schema.String).pipe(T.HttpQuery("orderBy")),
...
export const CreateProjectsAlertPoliciesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const PatchProjectsAlertPoliciesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(AlertPolicy).pipe(T.HttpBody()),
}).pipe(
...
export const ListOrganizationsTimeSeriesRequest = /*@__PURE__*/ Schema.Struct({
  "aggregation.perSeriesAligner": Schema.optional(Schema.String).pipe(
    T.HttpQuery("aggregation.perSeriesAligner"),
  ),
  "secondaryAggregation.alignmentPeriod": Schema.optional(Schema.String).pipe(
...
export const ListFoldersTimeSeriesRequest = /*@__PURE__*/ Schema.Struct({
  "aggregation.perSeriesAligner": Schema.optional(Schema.String).pipe(
    T.HttpQuery("aggregation.perSeriesAligner"),
  ),
  "secondaryAggregation.alignmentPeriod": Schema.optional(Schema.String).pipe(
...
export const ListUptimeCheckIpsRequest = /*@__PURE__*/ Schema.Struct({
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
}).pipe(
