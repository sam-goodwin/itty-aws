...
export const Amount: Schema.Schema<Amount> = /*@__PURE__*/ Schema.Struct({
...
export const ListPartnersProductsRequest = /*@__PURE__*/ Schema.Struct({
...
export const ListPartnersPromotionsRequest = /*@__PURE__*/ Schema.Struct({
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
...
export const ExtendPartnersSubscriptionsRequest = /*@__PURE__*/ Schema.Struct({
...
export const EntitlePartnersSubscriptionsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const SuspendPartnersSubscriptionsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const ResumePartnersSubscriptionsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const CancelPartnersSubscriptionsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const GetPartnersSubscriptionsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
...
export const CreatePartnersSubscriptionsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  subscriptionId: Schema.optional(Schema.String).pipe(
    T.HttpQuery("subscriptionId"),
  ),
  ...
  T.Http({ method: "POST", path: "v1/{+parent}/subscriptions", hasBody: true }),
  svc,
...
export const GeneratePartnersUserSessionsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
