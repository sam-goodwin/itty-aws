...
export const DeleteWebResourceRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetTokenWebResourceRequest = /*@__PURE__*/ Schema.Struct({
...
export const InsertWebResourceRequest = /*@__PURE__*/ Schema.Struct({
...
export const PatchWebResourceRequest = /*@__PURE__*/ Schema.Struct({
  id: Schema.String.pipe(T.HttpPath("id")),
  body: Schema.optional(SiteVerificationWebResourceResource).pipe(T.HttpBody()),
}).pipe(
...
export const UpdateWebResourceRequest = /*@__PURE__*/ Schema.Struct({
  id: Schema.String.pipe(T.HttpPath("id")),
  body: Schema.optional(SiteVerificationWebResourceResource).pipe(T.HttpBody()),
}).pipe(
