...
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}:audit","baseUrl":"https://displayvideo.googleapis.com/"})),
...
export type AdAssetAdAssetTypeEnum = "AD_ASSET_TYPE_UNSPECIFIED" | "AD_ASSET_TYPE_IMAGE" | "AD_ASSET_TYPE_YOUTUBE_VIDEO";
export const AdAssetAdAssetTypeEnum = /*@__PURE__*/ S.String;

export type AdAssetSyntheticContentAttestationStatusEnum = "SYNTHETIC_CONTENT_ATTESTATION_STATUS_UNSPECIFIED" | "NOT_SYNTHETIC" | "IS_SYNTHETIC";
export const AdAssetSyntheticContentAttestationStatusEnum = /*@__PURE__*/ S.String;

export type AdAssetEntityStatusEnum = "ENTITY_STATUS_UNSPECIFIED" | "ENTITY_STATUS_ACTIVE" | "ENTITY_STATUS_ARCHIVED" | "ENTITY_STATUS_DRAFT" | "ENTITY_STATUS_PAUSED" | "ENTITY_STATUS_SCHEDULED_FOR_DELETION";
...
).annotate({ identifier: "YoutubeVideoAsset" }) as any as S.Schema<YoutubeVideoAsset>;
...
export interface AdAsset {
  ...
  adAssetType?: AdAssetAdAssetTypeEnum;
  /** Optional. Whether the asset contains synthetic content or was created using AI. */
  syntheticContentAttestationStatus?: AdAssetSyntheticContentAttestationStatusEnum;
  /** Output only. The entity status of the ad asset. */
  entityStatus?: AdAssetEntityStatusEnum;
...
S.Struct({
  ...
  "syntheticContentAttestationStatus": S.optional(AdAssetSyntheticContentAttestationStatusEnum),
...
export type AdAssetList = ReadonlyArray<AdAsset>;
export const AdAssetList = /*@__PURE__*/ S.Array(AdAsset) as any as S.Schema<AdAssetList>;
...
).annotate({ identifier: "BulkCreateAdAssetsRequest" }) as any as S.Schema<BulkCreateAdAssetsRequest>;
...
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{+advertiserId}/adAssets:bulkCreate","baseUrl":"https://displayvideo.googleapis.com/"})),
).annotate({ identifier: "BulkCreateAdvertisersAdAssetsRequest" }) as any as S.Schema<BulkCreateAdvertisersAdAssetsRequest>;
...
).annotate({ identifier: "BulkCreateAdAssetsResponse" }) as any as S.Schema<BulkCreateAdAssetsResponse>;
...
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{advertiserId}/channels/{+channelId}/sites:bulkEdit","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{advertiserId}/locationLists/{+locationListId}/assignedLocations:bulkEdit","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{advertiserId}/negativeKeywordLists/{+negativeKeywordListId}/negativeKeywords:bulkEdit","baseUrl":"https://displayvideo.googleapis.com/"})),
...
export interface IntegralAdScience {
  ...
  qualitySyncCustomSegmentId?: StringList;
...
export interface Adloox {
  ...
  onlinePiracyContent?: AdlooxOnlinePiracyContentEnum;
  ...
  hateSpeechActsAggressionContent?: AdlooxHateSpeechActsAggressionContentEnum;
  ...
  crimeHarmfulActsIndividualsSocietyHumanRightsViolationsContent?: AdlooxCrimeHarmfulActsIndividualsSocietyHumanRightsViolationsContentEnum;
  /** Optional. Debated Sensitive Social Issue Content [GARM](https://wfanet.org/leadership/garm/about-garm) risk ranges to exclude. */
  debatedSensitiveSocialIssueContent?: AdlooxDebatedSensitiveSocialIssueContentEnum;
  /** Optional. Arms and Ammunition Content [GARM](https://wfanet.org/leadership/garm/about-garm) risk ranges to exclude. */
  armsAmmunitionContent?: AdlooxArmsAmmunitionContentEnum;
  /** Optional. IAB viewability threshold for video ads. */
  videoIabViewability?: AdlooxVideoIabViewabilityEnum;
  /** Optional. Scope3's fraud IVT MFA categories to exclude. */
  excludedFraudIvtMfaCategories?: AdlooxExcludedFraudIvtMfaCategoriesItemEnumList;
  /** Optional. Adult and Explicit Sexual Content [GARM](https://wfanet.org/leadership/garm/about-garm) risk ranges to exclude. */
  adultExplicitSexualContent?: AdlooxAdultExplicitSexualContentEnum;
  ...
  terrorismContent?: AdlooxTerrorismContentEnum;
}
...
export interface ContentThemeAssignedTargetingOptionDetails {
  ...
  excludedContentTheme?: ContentThemeAssignedTargetingOptionDetailsExcludedContentThemeEnum;
  /** Output only. An enum for the DV360 content theme classifier. */
  contentTheme?: ContentThemeAssignedTargetingOptionDetailsContentThemeEnum;
}
...
export interface FirstPartyAndPartnerAudienceTargetingSetting {
  ...
  recency?: FirstPartyAndPartnerAudienceTargetingSettingRecencyEnum;
...
export const FirstPartyAndPartnerAudienceTargetingSetting = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "recency": S.optional(FirstPartyAndPartnerAudienceTargetingSettingRecencyEnum),
  "firstPartyAndPartnerAudienceId": S.optional(S.String),
}),
).annotate({ identifier: "FirstPartyAndPartnerAudienceTargetingSetting" }) as any as S.Schema<FirstPartyAndPartnerAudienceTargetingSetting>;

export type FirstPartyAndPartnerAudienceTargetingSettingList = ReadonlyArray<FirstPartyAndPartnerAudienceTargetingSetting>;
export const FirstPartyAndPartnerAudienceTargetingSettingList = /*@__PURE__*/ S.Array(FirstPartyAndPartnerAudienceTargetingSetting) as any as S.Schema<FirstPartyAndPartnerAudienceTargetingSettingList>;
...
export interface FirstPartyAndPartnerAudienceGroup {
  ...
  settings?: FirstPartyAndPartnerAudienceTargetingSettingList;
}
export const FirstPartyAndPartnerAudienceGroup = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "settings": S.optional(FirstPartyAndPartnerAudienceTargetingSettingList),
}),
).annotate({ identifier: "FirstPartyAndPartnerAudienceGroup" }) as any as S.Schema<FirstPartyAndPartnerAudienceGroup>;

export type FirstPartyAndPartnerAudienceGroupList = ReadonlyArray<FirstPartyAndPartnerAudienceGroup>;
export const FirstPartyAndPartnerAudienceGroupList = /*@__PURE__*/ S.Array(FirstPartyAndPartnerAudienceGroup) as any as S.Schema<FirstPartyAndPartnerAudienceGroupList>;
...
export interface AudienceGroupAssignedTargetingOptionDetails {
  ...
  includedFirstPartyAndPartnerAudienceGroups?: FirstPartyAndPartnerAudienceGroupList;
...
S.Struct({
  ...
  "includedFirstPartyAndPartnerAudienceGroups": S.optional(FirstPartyAndPartnerAudienceGroupList),
  "includedCombinedAudienceGroup": S.optional(CombinedAudienceGroup),
  "includedGoogleAudienceGroup": S.optional(GoogleAudienceGroup),
  "excludedFirstPartyAndPartnerAudienceGroup": S.optional(FirstPartyAndPartnerAudienceGroup),
}),
...
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{+advertiserId}/adGroups:bulkEditAssignedTargetingOptions","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{+advertiserId}/lineItems:bulkEditAssignedTargetingOptions","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v4/users/{+userId}:bulkEditAssignedUserRoles","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v4/inventorySourceGroups/{+inventorySourceGroupId}/assignedInventorySources:bulkEdit","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "channelId": S.String.pipe(T.Label()),
  "body": S.optional(BulkEditSitesRequest.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"POST","uri":"v4/partners/{partnerId}/channels/{+channelId}/sites:bulkEdit","baseUrl":"https://displayvideo.googleapis.com/"})),
...
export const BulkListAssignedTargetingOptionsAdvertisersAdGroupsRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
...
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/adGroups:bulkListAssignedTargetingOptions","baseUrl":"https://displayvideo.googleapis.com/"})),
).annotate({ identifier: "BulkListAssignedTargetingOptionsAdvertisersAdGroupsRequest" }) as any as S.Schema<BulkListAssignedTargetingOptionsAdvertisersAdGroupsRequest>;
...
S.Struct({
  ...
  "filter": S.optional(S.String.pipe(T.Query())),
  "advertiserId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/lineItems:bulkListAssignedTargetingOptions","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{+advertiserId}/lineItems:bulkUpdate","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers","baseUrl":"https://displayvideo.googleapis.com/"})),
...
export const CreateAdAssetRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "adAsset": S.optional(AdAsset),
}),
).annotate({ identifier: "CreateAdAssetRequest" }) as any as S.Schema<CreateAdAssetRequest>;
...
export const CreateAdvertisersAdAssetsRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "advertiserId": S.String.pipe(T.Label()),
  "body": S.optional(CreateAdAssetRequest.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{+advertiserId}/adAssets","baseUrl":"https://displayvideo.googleapis.com/"})),
).annotate({ identifier: "CreateAdvertisersAdAssetsRequest" }) as any as S.Schema<CreateAdvertisersAdAssetsRequest>;
...
export interface AdPolicyTopicEvidenceTrademark {
  ...
  countryRestrictions?: AdPolicyCriterionRestrictionList;
...
export interface AdPolicyTopicEvidenceDestinationNotWorking {
  ...
  device?: AdPolicyTopicEvidenceDestinationNotWorkingDeviceEnum;
  /** The HTTP error code. */
  httpErrorCode?: string;
  /** The last time the error was seen when navigating to URL. */
  lastCheckedTime?: string;
  /** The type of DNS error. */
  dnsErrorType?: AdPolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum;
}
...
export interface AdPolicyTopicEvidenceLegalRemoval {
  ...
  complaintType?: AdPolicyTopicEvidenceLegalRemovalComplaintTypeEnum;
...
export interface AdPolicyTopicAppealInfo {
  ...
  appealType?: AdPolicyTopicAppealInfoAppealTypeEnum;
...
export interface AdPolicyTopicEntry {
  ...
  policyTopicType?: AdPolicyTopicEntryPolicyTopicTypeEnum;
  /** Ad policy help center link for the policy topic. */
  helpCenterLink?: string;
  /** The evidence used in the policy decision. */
  policyTopicEvidences?: AdPolicyTopicEvidenceList;
  ...
  policyEnforcementMeans?: AdPolicyTopicEntryPolicyEnforcementMeansEnum;
  ...
  policyTopicConstraints?: AdPolicyTopicConstraintList;
...
export interface AdPolicy {
  ...
  adPolicyReviewStatus?: AdPolicyAdPolicyReviewStatusEnum;
  ...
  adPolicyTopicEntry?: AdPolicyTopicEntryList;
}
...
export interface DemandGenImageAd {
  ...
  logoImages?: ImageAssetList;
  /** The list of portrait marketing images shown on the ad. */
  portraitMarketingImages?: ImageAssetList;
  ...
  marketingImages?: ImageAssetList;
  ...
  squareMarketingImages?: ImageAssetList;
  /** Optional. The suffix to append to landing page URLs. */
  finalUrlSuffix?: string;
}
...
export interface DemandGenVideoAd {
  ...
  callToAction?: DemandGenVideoAdCallToActionEnum;
  /** Required. The URL address of the webpage that people reach after they click the ad. */
  finalUrl?: string;
  /** Required. The list of descriptions shown on the ad. */
  descriptions?: StringList;
...
export interface AdGroupAd {
  ...
  entityStatus?: AdGroupAdEntityStatusEnum;
...
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{+advertiserId}/adGroupAds","baseUrl":"https://displayvideo.googleapis.com/"})),
...
export interface AdGroup {
  ...
  adGroupFormat?: AdGroupAdGroupFormatEnum;
}
...
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{+advertiserId}/adGroups","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{+advertiserId}/adGroups/{+adGroupId}/targetingTypes/{+targetingType}/assignedTargetingOptions","baseUrl":"https://displayvideo.googleapis.com/"})),
...
export type CreateAdvertisersAdGroupsYoutubeAssetTypesYoutubeAssetAssociationsYoutubeAssetTypeEnum = "YOUTUBE_ASSET_TYPE_UNSPECIFIED" | "YOUTUBE_ASSET_TYPE_LOCATION" | "YOUTUBE_ASSET_TYPE_AFFILIATE_LOCATION" | "YOUTUBE_ASSET_TYPE_SITELINK";
export const CreateAdvertisersAdGroupsYoutubeAssetTypesYoutubeAssetAssociationsYoutubeAssetTypeEnum = /*@__PURE__*/ S.String;
...
export interface YoutubeAssetAssociationLocationAssetFilterLocationMatchingFunction {
  ...
  locationAssetIds?: StringList;
}
export const YoutubeAssetAssociationLocationAssetFilterLocationMatchingFunction = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "business": S.optional(S.String),
  "labels": S.optional(StringList),
  "locationAssetIds": S.optional(StringList),
}),
).annotate({ identifier: "YoutubeAssetAssociationLocationAssetFilterLocationMatchingFunction" }) as any as S.Schema<YoutubeAssetAssociationLocationAssetFilterLocationMatchingFunction>;

export type YoutubeAssetAssociationLocationAssetFilterLocationMatchingTypeEnum = "LOCATION_MATCHING_TYPE_UNSPECIFIED" | "SELECT_ALL" | "FILTER" | "SELECTED_ASSETS" | "DISABLED";
export const YoutubeAssetAssociationLocationAssetFilterLocationMatchingTypeEnum = /*@__PURE__*/ S.String;
...
export interface YoutubeAssetAssociationLocationAssetFilter {
  ...
  locationMatchingType?: YoutubeAssetAssociationLocationAssetFilterLocationMatchingTypeEnum;
  /** Output only. The ID of the asset set that matches the location assets eligible for serving. */
  assetSetId?: string;
}
export const YoutubeAssetAssociationLocationAssetFilter = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "locationMatchingFunction": S.optional(YoutubeAssetAssociationLocationAssetFilterLocationMatchingFunction),
  "locationMatchingType": S.optional(YoutubeAssetAssociationLocationAssetFilterLocationMatchingTypeEnum),
  "assetSetId": S.optional(S.String),
}),
).annotate({ identifier: "YoutubeAssetAssociationLocationAssetFilter" }) as any as S.Schema<YoutubeAssetAssociationLocationAssetFilter>;
...
export const YoutubeAssetAssociationSitelinkAsset = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "assetId": S.optional(S.String),
}),
).annotate({ identifier: "YoutubeAssetAssociationSitelinkAsset" }) as any as S.Schema<YoutubeAssetAssociationSitelinkAsset>;

export type YoutubeAssetAssociationAffiliateLocationAssetFilterAffiliateLocationMatchingTypeEnum = "AFFILIATE_LOCATION_MATCHING_TYPE_UNSPECIFIED" | "SELECT_ALL" | "SELECTED_CHAINS" | "DISABLED";
export const YoutubeAssetAssociationAffiliateLocationAssetFilterAffiliateLocationMatchingTypeEnum = /*@__PURE__*/ S.String;
...
export const YoutubeAssetAssociationAffiliateLocationAssetFilterAffiliateLocationChain = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "chainId": S.optional(S.String),
}),
).annotate({ identifier: "YoutubeAssetAssociationAffiliateLocationAssetFilterAffiliateLocationChain" }) as any as S.Schema<YoutubeAssetAssociationAffiliateLocationAssetFilterAffiliateLocationChain>;

export type YoutubeAssetAssociationAffiliateLocationAssetFilterAffiliateLocationChainList = ReadonlyArray<YoutubeAssetAssociationAffiliateLocationAssetFilterAffiliateLocationChain>;
export const YoutubeAssetAssociationAffiliateLocationAssetFilterAffiliateLocationChainList = /*@__PURE__*/ S.Array(YoutubeAssetAssociationAffiliateLocationAssetFilterAffiliateLocationChain) as any as S.Schema<YoutubeAssetAssociationAffiliateLocationAssetFilterAffiliateLocationChainList>;
...
export interface YoutubeAssetAssociationAffiliateLocationAssetFilterAffiliateLocationMatchingFunction {
  ...
  chains?: YoutubeAssetAssociationAffiliateLocationAssetFilterAffiliateLocationChainList;
}
export const YoutubeAssetAssociationAffiliateLocationAssetFilterAffiliateLocationMatchingFunction = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "chains": S.optional(YoutubeAssetAssociationAffiliateLocationAssetFilterAffiliateLocationChainList),
}),
).annotate({ identifier: "YoutubeAssetAssociationAffiliateLocationAssetFilterAffiliateLocationMatchingFunction" }) as any as S.Schema<YoutubeAssetAssociationAffiliateLocationAssetFilterAffiliateLocationMatchingFunction>;
...
export interface YoutubeAssetAssociationAffiliateLocationAssetFilter {
  ...
  affiliateLocationMatchingType?: YoutubeAssetAssociationAffiliateLocationAssetFilterAffiliateLocationMatchingTypeEnum;
...
export const YoutubeAssetAssociationAffiliateLocationAssetFilter = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "affiliateLocationMatchingType": S.optional(YoutubeAssetAssociationAffiliateLocationAssetFilterAffiliateLocationMatchingTypeEnum),
  "assetSetId": S.optional(S.String),
  "affiliateLocationMatchingFunction": S.optional(YoutubeAssetAssociationAffiliateLocationAssetFilterAffiliateLocationMatchingFunction),
}),
).annotate({ identifier: "YoutubeAssetAssociationAffiliateLocationAssetFilter" }) as any as S.Schema<YoutubeAssetAssociationAffiliateLocationAssetFilter>;
...
export const YoutubeAssetAssociationLinkedYouTubeAsset = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "locationAssetFilter": S.optional(YoutubeAssetAssociationLocationAssetFilter),
  "sitelinkAsset": S.optional(YoutubeAssetAssociationSitelinkAsset),
  "affiliateLocationAssetFilter": S.optional(YoutubeAssetAssociationAffiliateLocationAssetFilter),
}),
).annotate({ identifier: "YoutubeAssetAssociationLinkedYouTubeAsset" }) as any as S.Schema<YoutubeAssetAssociationLinkedYouTubeAsset>;

export type YoutubeAssetAssociationYoutubeAssetTypeEnum = "YOUTUBE_ASSET_TYPE_UNSPECIFIED" | "YOUTUBE_ASSET_TYPE_LOCATION" | "YOUTUBE_ASSET_TYPE_AFFILIATE_LOCATION" | "YOUTUBE_ASSET_TYPE_SITELINK";
export const YoutubeAssetAssociationYoutubeAssetTypeEnum = /*@__PURE__*/ S.String;
...
export interface YoutubeAssetAssociation {
  ...
  youtubeAssetType?: YoutubeAssetAssociationYoutubeAssetTypeEnum;
}
export const YoutubeAssetAssociation = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "linkedYoutubeAsset": S.optional(YoutubeAssetAssociationLinkedYouTubeAsset),
  "name": S.optional(S.String),
  "youtubeAssetType": S.optional(YoutubeAssetAssociationYoutubeAssetTypeEnum),
}),
).annotate({ identifier: "YoutubeAssetAssociation" }) as any as S.Schema<YoutubeAssetAssociation>;
...
export interface CreateAdvertisersAdGroupsYoutubeAssetTypesYoutubeAssetAssociationsRequest {
  ...
  advertiserId: string;
  /** Required. The type of YouTube asset associated with the resource. */
  youtubeAssetType: CreateAdvertisersAdGroupsYoutubeAssetTypesYoutubeAssetAssociationsYoutubeAssetTypeEnum | (string & {});
  /** The ID of an ad group. */
  adGroupId: string;
  /** Request body */
  body?: YoutubeAssetAssociation;
}
export const CreateAdvertisersAdGroupsYoutubeAssetTypesYoutubeAssetAssociationsRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "linkedEntity.lineItemId": S.optional(S.String.pipe(T.Query())),
  "advertiserId": S.String.pipe(T.Label()),
  "youtubeAssetType": CreateAdvertisersAdGroupsYoutubeAssetTypesYoutubeAssetAssociationsYoutubeAssetTypeEnum.pipe(T.Label()),
  "adGroupId": S.String.pipe(T.Label()),
  "body": S.optional(YoutubeAssetAssociation.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{+advertiserId}/adGroups/{+adGroupId}/youtubeAssetTypes/{+youtubeAssetType}/youtubeAssetAssociations","baseUrl":"https://displayvideo.googleapis.com/"})),
).annotate({ identifier: "CreateAdvertisersAdGroupsYoutubeAssetTypesYoutubeAssetAssociationsRequest" }) as any as S.Schema<CreateAdvertisersAdGroupsYoutubeAssetTypesYoutubeAssetAssociationsRequest>;
...
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{+advertiserId}/campaigns","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{+advertiserId}/channels","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{advertiserId}/channels/{+channelId}/sites","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{+advertiserId}/creatives","baseUrl":"https://displayvideo.googleapis.com/"})),
...
export interface InsertionOrder {
  ...
  optimizationObjective?: InsertionOrderOptimizationObjectiveEnum;
...
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{+advertiserId}/insertionOrders","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{+advertiserId}/lineItems","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "advertiserId": S.String.pipe(T.Label()),
  "body": S.optional(AssignedTargetingOption.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{+advertiserId}/lineItems/{+lineItemId}/targetingTypes/{+targetingType}/assignedTargetingOptions","baseUrl":"https://displayvideo.googleapis.com/"})),
...
export type CreateAdvertisersLineItemsYoutubeAssetTypesYoutubeAssetAssociationsYoutubeAssetTypeEnum = "YOUTUBE_ASSET_TYPE_UNSPECIFIED" | "YOUTUBE_ASSET_TYPE_LOCATION" | "YOUTUBE_ASSET_TYPE_AFFILIATE_LOCATION" | "YOUTUBE_ASSET_TYPE_SITELINK";
export const CreateAdvertisersLineItemsYoutubeAssetTypesYoutubeAssetAssociationsYoutubeAssetTypeEnum = /*@__PURE__*/ S.String;

export interface CreateAdvertisersLineItemsYoutubeAssetTypesYoutubeAssetAssociationsRequest {
  /** The ID of a line item. */
  lineItemId: string;
  /** Required. The type of YouTube asset associated with the resource. */
  youtubeAssetType: CreateAdvertisersLineItemsYoutubeAssetTypesYoutubeAssetAssociationsYoutubeAssetTypeEnum | (string & {});
  /** Required. The ID of the advertiser that the linked entity belongs to. */
  advertiserId: string;
  /** The ID of an ad group. */
...
export const CreateAdvertisersLineItemsYoutubeAssetTypesYoutubeAssetAssociationsRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "lineItemId": S.String.pipe(T.Label()),
  "youtubeAssetType": CreateAdvertisersLineItemsYoutubeAssetTypesYoutubeAssetAssociationsYoutubeAssetTypeEnum.pipe(T.Label()),
  "advertiserId": S.String.pipe(T.Label()),
  "linkedEntity.adGroupId": S.optional(S.String.pipe(T.Query())),
  "body": S.optional(YoutubeAssetAssociation.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{+advertiserId}/lineItems/{+lineItemId}/youtubeAssetTypes/{+youtubeAssetType}/youtubeAssetAssociations","baseUrl":"https://displayvideo.googleapis.com/"})),
).annotate({ identifier: "CreateAdvertisersLineItemsYoutubeAssetTypesYoutubeAssetAssociationsRequest" }) as any as S.Schema<CreateAdvertisersLineItemsYoutubeAssetTypesYoutubeAssetAssociationsRequest>;
...
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{+advertiserId}/locationLists","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{advertiserId}/locationLists/{locationListId}/assignedLocations","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{+advertiserId}/negativeKeywordLists","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{advertiserId}/negativeKeywordLists/{+negativeKeywordListId}/negativeKeywords","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "advertiserId": S.String.pipe(T.Label()),
  "body": S.optional(AssignedTargetingOption.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{+advertiserId}/targetingTypes/{+targetingType}/assignedTargetingOptions","baseUrl":"https://displayvideo.googleapis.com/"})),
...
export type CustomBiddingAlgorithmCustomBiddingAlgorithmTypeEnum = "CUSTOM_BIDDING_ALGORITHM_TYPE_UNSPECIFIED" | "SCRIPT_BASED" | "RULE_BASED";
export const CustomBiddingAlgorithmCustomBiddingAlgorithmTypeEnum = /*@__PURE__*/ S.String;

export type CustomBiddingAlgorithmThirdPartyOptimizationPartnerEnum = "UNKNOWN" | "SCIBIDS" | "ADELAIDE";
export const CustomBiddingAlgorithmThirdPartyOptimizationPartnerEnum = /*@__PURE__*/ S.String;
...
export interface CustomBiddingAlgorithm {
  ...
  thirdPartyOptimizationPartner?: CustomBiddingAlgorithmThirdPartyOptimizationPartnerEnum;
...
S.Struct({
  ...
  "displayName": S.optional(S.String),
  "name": S.optional(S.String),
  "thirdPartyOptimizationPartner": S.optional(CustomBiddingAlgorithmThirdPartyOptimizationPartnerEnum),
...
}).pipe(T.Http({"method":"POST","uri":"v4/customBiddingAlgorithms","baseUrl":"https://displayvideo.googleapis.com/"})),
...
export interface CustomBiddingAlgorithmRules {
  ...
  state?: CustomBiddingAlgorithmRulesStateEnum;
...
}).pipe(T.Http({"method":"POST","uri":"v4/customBiddingAlgorithms/{+customBiddingAlgorithmId}/rules","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v4/customBiddingAlgorithms/{+customBiddingAlgorithmId}/scripts","baseUrl":"https://displayvideo.googleapis.com/"})),
...
export type FirstPartyAndPartnerAudienceFirstPartyAndPartnerAudienceTypeEnum = "FIRST_PARTY_AND_PARTNER_AUDIENCE_TYPE_UNSPECIFIED" | "TYPE_FIRST_PARTY" | "TYPE_PARTNER";
export const FirstPartyAndPartnerAudienceFirstPartyAndPartnerAudienceTypeEnum = /*@__PURE__*/ S.String;

export type FirstPartyAndPartnerAudienceAudienceSourceEnum = "AUDIENCE_SOURCE_UNSPECIFIED" | "DISPLAY_VIDEO_360" | "CAMPAIGN_MANAGER" | "AD_MANAGER" | "SEARCH_ADS_360" | "YOUTUBE" | "ADS_DATA_HUB";
export const FirstPartyAndPartnerAudienceAudienceSourceEnum = /*@__PURE__*/ S.String;

export type FirstPartyAndPartnerAudienceAudienceTypeEnum = "AUDIENCE_TYPE_UNSPECIFIED" | "CUSTOMER_MATCH_CONTACT_INFO" | "CUSTOMER_MATCH_DEVICE_ID" | "CUSTOMER_MATCH_USER_ID" | "ACTIVITY_BASED" | "FREQUENCY_CAP" | "TAG_BASED" | "YOUTUBE_USERS" | "THIRD_PARTY" | "COMMERCE" | "LINEAR" | "AGENCY";
export const FirstPartyAndPartnerAudienceAudienceTypeEnum = /*@__PURE__*/ S.String;
...
S.Struct({
  ...
  "hashedEmails": S.optional(StringList),
  "hashedPhoneNumbers": S.optional(StringList),
  "hashedLastName": S.optional(S.String),
  "countryCode": S.optional(S.String),
  "zipCodes": S.optional(StringList),
}),
).annotate({ identifier: "ContactInfo" }) as any as S.Schema<ContactInfo>;

export type ContactInfoList_ = ReadonlyArray<ContactInfo>;
export const ContactInfoList_ = /*@__PURE__*/ S.Array(ContactInfo) as any as S.Schema<ContactInfoList_>;

export type ConsentAdUserDataEnum = "CONSENT_STATUS_UNSPECIFIED" | "CONSENT_STATUS_GRANTED" | "CONSENT_STATUS_DENIED";
export const ConsentAdUserDataEnum = /*@__PURE__*/ S.String;

export type ConsentAdPersonalizationEnum = "CONSENT_STATUS_UNSPECIFIED" | "CONSENT_STATUS_GRANTED" | "CONSENT_STATUS_DENIED";
...
export const ContactInfoList = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "contactInfos": S.optional(ContactInfoList_),
  "consent": S.optional(Consent),
}),
).annotate({ identifier: "ContactInfoList" }) as any as S.Schema<ContactInfoList>;
...
export interface MobileDeviceIdList {
  ...
  mobileDeviceIds?: StringList;
}
export const MobileDeviceIdList = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "consent": S.optional(Consent),
  "mobileDeviceIds": S.optional(StringList),
}),
).annotate({ identifier: "MobileDeviceIdList" }) as any as S.Schema<MobileDeviceIdList>;
...
export interface FirstPartyAndPartnerAudience {
  ...
  firstPartyAndPartnerAudienceType?: FirstPartyAndPartnerAudienceFirstPartyAndPartnerAudienceTypeEnum;
  ...
  audienceSource?: FirstPartyAndPartnerAudienceAudienceSourceEnum;
  /** Immutable. The type of the audience. */
  audienceType?: FirstPartyAndPartnerAudienceAudienceTypeEnum;
...
export const FirstPartyAndPartnerAudience = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "displayMobileWebAudienceSize": S.optional(S.String),
  "appId": S.optional(S.String),
  "membershipDurationDays": S.optional(S.String),
  "firstPartyAndPartnerAudienceType": S.optional(FirstPartyAndPartnerAudienceFirstPartyAndPartnerAudienceTypeEnum),
  "firstPartyAndPartnerAudienceId": S.optional(S.String),
  "displayName": S.optional(S.String),
  "name": S.optional(S.String),
  "activeDisplayAudienceSize": S.optional(S.String),
  "displayDesktopAudienceSize": S.optional(S.String),
  "audienceSource": S.optional(FirstPartyAndPartnerAudienceAudienceSourceEnum),
  "audienceType": S.optional(FirstPartyAndPartnerAudienceAudienceTypeEnum),
  "contactInfoList": S.optional(ContactInfoList),
  "description": S.optional(S.String),
  "mobileDeviceIdList": S.optional(MobileDeviceIdList),
  "gmailAudienceSize": S.optional(S.String),
  "displayMobileAppAudienceSize": S.optional(S.String),
  "displayAudienceSize": S.optional(S.String),
  "youtubeAudienceSize": S.optional(S.String),
}),
).annotate({ identifier: "FirstPartyAndPartnerAudience" }) as any as S.Schema<FirstPartyAndPartnerAudience>;
...
export const CreateFirstPartyAndPartnerAudiencesRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "advertiserId": S.optional(S.String.pipe(T.Query())),
  "body": S.optional(FirstPartyAndPartnerAudience.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"POST","uri":"v4/firstPartyAndPartnerAudiences","baseUrl":"https://displayvideo.googleapis.com/"})),
).annotate({ identifier: "CreateFirstPartyAndPartnerAudiencesRequest" }) as any as S.Schema<CreateFirstPartyAndPartnerAudiencesRequest>;
...
}).pipe(T.Http({"method":"POST","uri":"v4/guaranteedOrders","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v4/inventorySourceGroups","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v4/inventorySourceGroups/{+inventorySourceGroupId}/assignedInventorySources","baseUrl":"https://displayvideo.googleapis.com/"})),
...
export type InventorySourceStatusEntityStatusEnum = "ENTITY_STATUS_UNSPECIFIED" | "ENTITY_STATUS_ACTIVE" | "ENTITY_STATUS_ARCHIVED" | "ENTITY_STATUS_DRAFT" | "ENTITY_STATUS_PAUSED" | "ENTITY_STATUS_SCHEDULED_FOR_DELETION";
export const InventorySourceStatusEntityStatusEnum = /*@__PURE__*/ S.String;

export type InventorySourceStatusConfigStatusEnum = "INVENTORY_SOURCE_CONFIG_STATUS_UNSPECIFIED" | "INVENTORY_SOURCE_CONFIG_STATUS_PENDING" | "INVENTORY_SOURCE_CONFIG_STATUS_COMPLETED";
export const InventorySourceStatusConfigStatusEnum = /*@__PURE__*/ S.String;

export type InventorySourceStatusSellerStatusEnum = "ENTITY_STATUS_UNSPECIFIED" | "ENTITY_STATUS_ACTIVE" | "ENTITY_STATUS_ARCHIVED" | "ENTITY_STATUS_DRAFT" | "ENTITY_STATUS_PAUSED" | "ENTITY_STATUS_SCHEDULED_FOR_DELETION";
...
export const InventorySourceStatus = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "entityStatus": S.optional(InventorySourceStatusEntityStatusEnum),
  "entityPauseReason": S.optional(S.String),
  "sellerPauseReason": S.optional(S.String),
  "configStatus": S.optional(InventorySourceStatusConfigStatusEnum),
  "sellerStatus": S.optional(InventorySourceStatusSellerStatusEnum),
}),
).annotate({ identifier: "InventorySourceStatus" }) as any as S.Schema<InventorySourceStatus>;
...
export type InventorySourceDeliveryMethodEnum = "INVENTORY_SOURCE_DELIVERY_METHOD_UNSPECIFIED" | "INVENTORY_SOURCE_DELIVERY_METHOD_PROGRAMMATIC" | "INVENTORY_SOURCE_DELIVERY_METHOD_TAG";
export const InventorySourceDeliveryMethodEnum = /*@__PURE__*/ S.String;

export type InventorySourceInventorySourceTypeEnum = "INVENTORY_SOURCE_TYPE_UNSPECIFIED" | "INVENTORY_SOURCE_TYPE_PRIVATE" | "INVENTORY_SOURCE_TYPE_AUCTION_PACKAGE";
...
export const InventorySourceAccessorsPartnerAccessor = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "partnerId": S.optional(S.String),
}),
).annotate({ identifier: "InventorySourceAccessorsPartnerAccessor" }) as any as S.Schema<InventorySourceAccessorsPartnerAccessor>;
...
export const InventorySourceAccessorsAdvertiserAccessors = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "advertiserIds": S.optional(StringList),
}),
).annotate({ identifier: "InventorySourceAccessorsAdvertiserAccessors" }) as any as S.Schema<InventorySourceAccessorsAdvertiserAccessors>;
...
export const InventorySourceAccessors = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "partner": S.optional(InventorySourceAccessorsPartnerAccessor),
  "advertisers": S.optional(InventorySourceAccessorsAdvertiserAccessors),
}),
).annotate({ identifier: "InventorySourceAccessors" }) as any as S.Schema<InventorySourceAccessors>;

export type InventorySourceCommitmentEnum = "INVENTORY_SOURCE_COMMITMENT_UNSPECIFIED" | "INVENTORY_SOURCE_COMMITMENT_GUARANTEED" | "INVENTORY_SOURCE_COMMITMENT_NON_GUARANTEED";
export const InventorySourceCommitmentEnum = /*@__PURE__*/ S.String;

export type CreativeConfigCreativeTypeEnum = "CREATIVE_TYPE_UNSPECIFIED" | "CREATIVE_TYPE_STANDARD" | "CREATIVE_TYPE_EXPANDABLE" | "CREATIVE_TYPE_VIDEO" | "CREATIVE_TYPE_NATIVE" | "CREATIVE_TYPE_TEMPLATED_APP_INSTALL" | "CREATIVE_TYPE_NATIVE_SITE_SQUARE" | "CREATIVE_TYPE_TEMPLATED_APP_INSTALL_INTERSTITIAL" | "CREATIVE_TYPE_LIGHTBOX" | "CREATIVE_TYPE_NATIVE_APP_INSTALL" | "CREATIVE_TYPE_NATIVE_APP_INSTALL_SQUARE" | "CREATIVE_TYPE_AUDIO" | "CREATIVE_TYPE_PUBLISHER_HOSTED" | "CREATIVE_TYPE_NATIVE_VIDEO" | "CREATIVE_TYPE_TEMPLATED_APP_INSTALL_VIDEO" | "CREATIVE_TYPE_ASSET_BASED_CREATIVE";
...
export const InventorySourceDisplayCreativeConfig = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "creativeSize": S.optional(Dimensions),
}),
).annotate({ identifier: "InventorySourceDisplayCreativeConfig" }) as any as S.Schema<InventorySourceDisplayCreativeConfig>;
...
export const InventorySourceVideoCreativeConfig = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "duration": S.optional(S.String),
}),
).annotate({ identifier: "InventorySourceVideoCreativeConfig" }) as any as S.Schema<InventorySourceVideoCreativeConfig>;
...
export const CreativeConfig = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "creativeType": S.optional(CreativeConfigCreativeTypeEnum),
  "displayCreativeConfig": S.optional(InventorySourceDisplayCreativeConfig),
  "videoCreativeConfig": S.optional(InventorySourceVideoCreativeConfig),
}),
).annotate({ identifier: "CreativeConfig" }) as any as S.Schema<CreativeConfig>;

export type CreativeConfigList = ReadonlyArray<CreativeConfig>;
export const CreativeConfigList = /*@__PURE__*/ S.Array(CreativeConfig) as any as S.Schema<CreativeConfigList>;

export type InventorySourceExchangeEnum = "EXCHANGE_UNSPECIFIED" | "EXCHANGE_GOOGLE_AD_MANAGER" | "EXCHANGE_APPNEXUS" | "EXCHANGE_BRIGHTROLL" | "EXCHANGE_ADFORM" | "EXCHANGE_ADMETA" | "EXCHANGE_ADMIXER" | "EXCHANGE_ADSMOGO" | "EXCHANGE_ADSWIZZ" | "EXCHANGE_BIDSWITCH" | "EXCHANGE_BRIGHTROLL_DISPLAY" | "EXCHANGE_CADREON" | "EXCHANGE_DAILYMOTION" | "EXCHANGE_FIVE" | "EXCHANGE_FLUCT" | "EXCHANGE_FREEWHEEL" | "EXCHANGE_GENIEE" | "EXCHANGE_GUMGUM" | "EXCHANGE_IMOBILE" | "EXCHANGE_IBILLBOARD" | "EXCHANGE_IMPROVE_DIGITAL" | "EXCHANGE_INDEX" | "EXCHANGE_KARGO" | "EXCHANGE_MICROAD" | "EXCHANGE_MOPUB" | "EXCHANGE_NEND" | "EXCHANGE_ONE_BY_AOL_DISPLAY" | "EXCHANGE_ONE_BY_AOL_MOBILE" | "EXCHANGE_ONE_BY_AOL_VIDEO" | "EXCHANGE_OOYALA" | "EXCHANGE_OPENX" | "EXCHANGE_PERMODO" | "EXCHANGE_PLATFORMONE" | "EXCHANGE_PLATFORMID" | "EXCHANGE_PUBMATIC" | "EXCHANGE_PULSEPOINT" | "EXCHANGE_REVENUEMAX" | "EXCHANGE_RUBICON" | "EXCHANGE_SMARTCLIP" | "EXCHANGE_SMARTRTB" | "EXCHANGE_SMARTSTREAMTV" | "EXCHANGE_SOVRN" | "EXCHANGE_SPOTXCHANGE" | "EXCHANGE_STROER" | "EXCHANGE_TEADSTV" | "EXCHANGE_TELARIA" | "EXCHANGE_TVN" | "EXCHANGE_UNITED" | "EXCHANGE_YIELDLAB" | "EXCHANGE_YIELDMO" | "EXCHANGE_UNRULYX" | "EXCHANGE_OPEN8" | "EXCHANGE_TRITON" | "EXCHANGE_TRIPLELIFT" | "EXCHANGE_TABOOLA" | "EXCHANGE_INMOBI" | "EXCHANGE_SMAATO" | "EXCHANGE_AJA" | "EXCHANGE_SUPERSHIP" | "EXCHANGE_NEXSTAR_DIGITAL" | "EXCHANGE_WAZE" | "EXCHANGE_SOUNDCAST" | "EXCHANGE_SHARETHROUGH" | "EXCHANGE_FYBER" | "EXCHANGE_RED_FOR_PUBLISHERS" | "EXCHANGE_MEDIANET" | "EXCHANGE_TAPJOY" | "EXCHANGE_VISTAR" | "EXCHANGE_DAX" | "EXCHANGE_JCD" | "EXCHANGE_PLACE_EXCHANGE" | "EXCHANGE_APPLOVIN" | "EXCHANGE_CONNATIX" | "EXCHANGE_RESET_DIGITAL" | "EXCHANGE_HIVESTACK" | "EXCHANGE_DRAX" | "EXCHANGE_APPLOVIN_GBID" | "EXCHANGE_FYBER_GBID" | "EXCHANGE_UNITY_GBID" | "EXCHANGE_CHARTBOOST_GBID" | "EXCHANGE_ADMOST_GBID" | "EXCHANGE_TOPON_GBID" | "EXCHANGE_NETFLIX" | "EXCHANGE_CORE" | "EXCHANGE_COMMERCE_GRID" | "EXCHANGE_SPOTIFY" | "EXCHANGE_TUBI" | "EXCHANGE_SNAP" | "EXCHANGE_CADENT" | "EXCHANGE_EXTE";
export const InventorySourceExchangeEnum = /*@__PURE__*/ S.String;

export type InventorySourceInventorySourceProductTypeEnum = "INVENTORY_SOURCE_PRODUCT_TYPE_UNSPECIFIED" | "PREFERRED_DEAL" | "PRIVATE_AUCTION" | "PROGRAMMATIC_GUARANTEED" | "TAG_GUARANTEED" | "YOUTUBE_RESERVE" | "INSTANT_RESERVE" | "GUARANTEED_PACKAGE" | "PROGRAMMATIC_TV" | "AUCTION_PACKAGE";
export const InventorySourceInventorySourceProductTypeEnum = /*@__PURE__*/ S.String;
...
export type RateDetailsInventorySourceRateTypeEnum = "INVENTORY_SOURCE_RATE_TYPE_UNSPECIFIED" | "INVENTORY_SOURCE_RATE_TYPE_CPM_FIXED" | "INVENTORY_SOURCE_RATE_TYPE_CPM_FLOOR" | "INVENTORY_SOURCE_RATE_TYPE_CPD" | "INVENTORY_SOURCE_RATE_TYPE_CPH" | "INVENTORY_SOURCE_RATE_TYPE_FLAT";
...
export const RateDetails = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "minimumSpend": S.optional(Money),
  "inventorySourceRateType": S.optional(RateDetailsInventorySourceRateTypeEnum),
  "rate": S.optional(Money),
  "unitsPurchased": S.optional(S.String),
}),
).annotate({ identifier: "RateDetails" }) as any as S.Schema<RateDetails>;
...
export const InventorySource = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "status": S.optional(InventorySourceStatus),
  "readAdvertiserIds": S.optional(StringList),
  "publisherName": S.optional(S.String),
  "timeRange": S.optional(TimeRange),
  "guaranteedOrderId": S.optional(S.String),
  "dealId": S.optional(S.String),
  "deliveryMethod": S.optional(InventorySourceDeliveryMethodEnum),
  "inventorySourceType": S.optional(InventorySourceInventorySourceTypeEnum),
  "readWriteAccessors": S.optional(InventorySourceAccessors),
  "commitment": S.optional(InventorySourceCommitmentEnum),
  "updateTime": S.optional(S.String),
  "inventorySourceId": S.optional(S.String),
  "readPartnerIds": S.optional(StringList),
  "creativeConfigs": S.optional(CreativeConfigList),
  "exchange": S.optional(InventorySourceExchangeEnum),
  "inventorySourceProductType": S.optional(InventorySourceInventorySourceProductTypeEnum),
  "displayName": S.optional(S.String),
  "name": S.optional(S.String),
  "rateDetails": S.optional(RateDetails),
}),
).annotate({ identifier: "InventorySource" }) as any as S.Schema<InventorySource>;
...
export const CreateInventorySourcesRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "advertiserId": S.optional(S.String.pipe(T.Query())),
  "partnerId": S.optional(S.String.pipe(T.Query())),
  "body": S.optional(InventorySource.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"POST","uri":"v4/inventorySources","baseUrl":"https://displayvideo.googleapis.com/"})),
).annotate({ identifier: "CreateInventorySourcesRequest" }) as any as S.Schema<CreateInventorySourcesRequest>;
...
S.Struct({
  ...
  "partnerId": S.String.pipe(T.Label()),
  "body": S.optional(Channel.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"POST","uri":"v4/partners/{+partnerId}/channels","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "partnerId": S.String.pipe(T.Label()),
  "body": S.optional(Site.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"POST","uri":"v4/partners/{partnerId}/channels/{+channelId}/sites","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "body": S.optional(AssignedTargetingOption.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"POST","uri":"v4/partners/{+partnerId}/targetingTypes/{+targetingType}/assignedTargetingOptions","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v4/sdfdownloadtasks","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v4/users","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  "advertiserId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"DELETE","uri":"v4/advertisers/{+advertiserId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "advertiserId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"DELETE","uri":"v4/advertisers/{+advertiserId}/adGroupAds/{+adGroupAdId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  "advertiserId": S.String.pipe(T.Label()),
  "adGroupId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"DELETE","uri":"v4/advertisers/{+advertiserId}/adGroups/{+adGroupId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "adGroupId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"DELETE","uri":"v4/advertisers/{+advertiserId}/adGroups/{+adGroupId}/targetingTypes/{+targetingType}/assignedTargetingOptions/{+assignedTargetingOptionId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
export type DeleteAdvertisersAdGroupsYoutubeAssetTypesYoutubeAssetAssociationsYoutubeAssetTypeEnum = "YOUTUBE_ASSET_TYPE_UNSPECIFIED" | "YOUTUBE_ASSET_TYPE_LOCATION" | "YOUTUBE_ASSET_TYPE_AFFILIATE_LOCATION" | "YOUTUBE_ASSET_TYPE_SITELINK";
export const DeleteAdvertisersAdGroupsYoutubeAssetTypesYoutubeAssetAssociationsYoutubeAssetTypeEnum = /*@__PURE__*/ S.String;
...
export interface DeleteAdvertisersAdGroupsYoutubeAssetTypesYoutubeAssetAssociationsRequest {
  ...
  advertiserId: string;
  /** Required. The type of YouTube asset associated with the resource. */
  youtubeAssetType: DeleteAdvertisersAdGroupsYoutubeAssetTypesYoutubeAssetAssociationsYoutubeAssetTypeEnum | (string & {});
}
export const DeleteAdvertisersAdGroupsYoutubeAssetTypesYoutubeAssetAssociationsRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "youtubeAssetAssociationId": S.String.pipe(T.Label()),
  "adGroupId": S.String.pipe(T.Label()),
  "linkedEntity.lineItemId": S.optional(S.String.pipe(T.Query())),
  "advertiserId": S.String.pipe(T.Label()),
  "youtubeAssetType": DeleteAdvertisersAdGroupsYoutubeAssetTypesYoutubeAssetAssociationsYoutubeAssetTypeEnum.pipe(T.Label()),
}).pipe(T.Http({"method":"DELETE","uri":"v4/advertisers/{+advertiserId}/adGroups/{+adGroupId}/youtubeAssetTypes/{+youtubeAssetType}/youtubeAssetAssociations/{+youtubeAssetAssociationId}","baseUrl":"https://displayvideo.googleapis.com/"})),
).annotate({ identifier: "DeleteAdvertisersAdGroupsYoutubeAssetTypesYoutubeAssetAssociationsRequest" }) as any as S.Schema<DeleteAdvertisersAdGroupsYoutubeAssetTypesYoutubeAssetAssociationsRequest>;
...
}).pipe(T.Http({"method":"DELETE","uri":"v4/advertisers/{+advertiserId}/campaigns/{+campaignId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "partnerId": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"DELETE","uri":"v4/advertisers/{advertiserId}/channels/{+channelId}/sites/{+urlOrAppId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"DELETE","uri":"v4/advertisers/{+advertiserId}/creatives/{+creativeId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"DELETE","uri":"v4/advertisers/{+advertiserId}/insertionOrders/{+insertionOrderId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  "advertiserId": S.String.pipe(T.Label()),
  "lineItemId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"DELETE","uri":"v4/advertisers/{+advertiserId}/lineItems/{+lineItemId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "advertiserId": S.String.pipe(T.Label()),
  "assignedTargetingOptionId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"DELETE","uri":"v4/advertisers/{+advertiserId}/lineItems/{+lineItemId}/targetingTypes/{+targetingType}/assignedTargetingOptions/{+assignedTargetingOptionId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
export type DeleteAdvertisersLineItemsYoutubeAssetTypesYoutubeAssetAssociationsYoutubeAssetTypeEnum = "YOUTUBE_ASSET_TYPE_UNSPECIFIED" | "YOUTUBE_ASSET_TYPE_LOCATION" | "YOUTUBE_ASSET_TYPE_AFFILIATE_LOCATION" | "YOUTUBE_ASSET_TYPE_SITELINK";
export const DeleteAdvertisersLineItemsYoutubeAssetTypesYoutubeAssetAssociationsYoutubeAssetTypeEnum = /*@__PURE__*/ S.String;

export interface DeleteAdvertisersLineItemsYoutubeAssetTypesYoutubeAssetAssociationsRequest {
  /** Required. The ID of the advertiser that the linked entity belongs to. */
  advertiserId: string;
  /** Required. The type of YouTube asset associated with the resource. */
  youtubeAssetType: DeleteAdvertisersLineItemsYoutubeAssetTypesYoutubeAssetAssociationsYoutubeAssetTypeEnum | (string & {});
  /** The ID of a line item. */
  lineItemId: string;
  /** Required. The ID of the YouTube asset in the association. For `YOUTUBE_ASSET_TYPE_LOCATION` and `YOUTUBE_ASSET_TYPE_AFFILIATE_LOCATION` associations: This should be the ID of the asset set linked, or 0 if the location_asset_filter or affiliate_location_asset_filter is `DISABLED`. For `YOUTUBE_ASSET_TYPE_SITELINK` associations: This should be the ID of the sitelink asset linked. */
  youtubeAssetAssociationId: string;
...
export const DeleteAdvertisersLineItemsYoutubeAssetTypesYoutubeAssetAssociationsRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "advertiserId": S.String.pipe(T.Label()),
  "youtubeAssetType": DeleteAdvertisersLineItemsYoutubeAssetTypesYoutubeAssetAssociationsYoutubeAssetTypeEnum.pipe(T.Label()),
  "lineItemId": S.String.pipe(T.Label()),
  "youtubeAssetAssociationId": S.String.pipe(T.Label()),
  "linkedEntity.adGroupId": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"DELETE","uri":"v4/advertisers/{+advertiserId}/lineItems/{+lineItemId}/youtubeAssetTypes/{+youtubeAssetType}/youtubeAssetAssociations/{+youtubeAssetAssociationId}","baseUrl":"https://displayvideo.googleapis.com/"})),
).annotate({ identifier: "DeleteAdvertisersLineItemsYoutubeAssetTypesYoutubeAssetAssociationsRequest" }) as any as S.Schema<DeleteAdvertisersLineItemsYoutubeAssetTypesYoutubeAssetAssociationsRequest>;
...
}).pipe(T.Http({"method":"DELETE","uri":"v4/advertisers/{advertiserId}/locationLists/{locationListId}/assignedLocations/{+assignedLocationId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  "advertiserId": S.String.pipe(T.Label()),
  "negativeKeywordListId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"DELETE","uri":"v4/advertisers/{+advertiserId}/negativeKeywordLists/{+negativeKeywordListId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"DELETE","uri":"v4/advertisers/{advertiserId}/negativeKeywordLists/{+negativeKeywordListId}/negativeKeywords/{+keywordValue}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "advertiserId": S.String.pipe(T.Label()),
  "assignedTargetingOptionId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"DELETE","uri":"v4/advertisers/{+advertiserId}/targetingTypes/{+targetingType}/assignedTargetingOptions/{+assignedTargetingOptionId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "advertiserId": S.optional(S.String.pipe(T.Query())),
  "partnerId": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"DELETE","uri":"v4/inventorySourceGroups/{+inventorySourceGroupId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "inventorySourceGroupId": S.String.pipe(T.Label()),
  "advertiserId": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"DELETE","uri":"v4/inventorySourceGroups/{+inventorySourceGroupId}/assignedInventorySources/{+assignedInventorySourceId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "advertiserId": S.optional(S.String.pipe(T.Query())),
  "partnerId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"DELETE","uri":"v4/partners/{partnerId}/channels/{+channelId}/sites/{+urlOrAppId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "assignedTargetingOptionId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"DELETE","uri":"v4/partners/{+partnerId}/targetingTypes/{+targetingType}/assignedTargetingOptions/{+assignedTargetingOptionId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  "userId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"DELETE","uri":"v4/users/{+userId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{+advertiserId}/lineItems/{+lineItemId}:duplicate","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{+advertiserId}:editAssignedTargetingOptions","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v4/partners/{+partnerId}:editAssignedTargetingOptions","baseUrl":"https://displayvideo.googleapis.com/"})),
...
export const EditCustomerMatchMembersRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "addedMobileDeviceIdList": S.optional(MobileDeviceIdList),
  "removedMobileDeviceIdList": S.optional(MobileDeviceIdList),
  "advertiserId": S.optional(S.String),
  "removedContactInfoList": S.optional(ContactInfoList),
  "addedContactInfoList": S.optional(ContactInfoList),
}),
).annotate({ identifier: "EditCustomerMatchMembersRequest" }) as any as S.Schema<EditCustomerMatchMembersRequest>;
...
export const EditCustomerMatchMembersFirstPartyAndPartnerAudiencesRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "firstPartyAndPartnerAudienceId": S.String.pipe(T.Label()),
  "body": S.optional(EditCustomerMatchMembersRequest.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"POST","uri":"v4/firstPartyAndPartnerAudiences/{+firstPartyAndPartnerAudienceId}:editCustomerMatchMembers","baseUrl":"https://displayvideo.googleapis.com/"})),
).annotate({ identifier: "EditCustomerMatchMembersFirstPartyAndPartnerAudiencesRequest" }) as any as S.Schema<EditCustomerMatchMembersFirstPartyAndPartnerAudiencesRequest>;
...
export const EditCustomerMatchMembersResponse = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "firstPartyAndPartnerAudienceId": S.optional(S.String),
}),
).annotate({ identifier: "EditCustomerMatchMembersResponse" }) as any as S.Schema<EditCustomerMatchMembersResponse>;
...
}).pipe(T.Http({"method":"POST","uri":"v4/guaranteedOrders/{+guaranteedOrderId}:editGuaranteedOrderReadAccessors","baseUrl":"https://displayvideo.googleapis.com/"})),
...
export const EditInventorySourceReadWriteAccessorsRequestAdvertisersUpdate = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "addedAdvertisers": S.optional(StringList),
  "removedAdvertisers": S.optional(StringList),
}),
).annotate({ identifier: "EditInventorySourceReadWriteAccessorsRequestAdvertisersUpdate" }) as any as S.Schema<EditInventorySourceReadWriteAccessorsRequestAdvertisersUpdate>;
...
export const EditInventorySourceReadWriteAccessorsRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "assignPartner": S.optional(S.Boolean),
  "advertisersUpdate": S.optional(EditInventorySourceReadWriteAccessorsRequestAdvertisersUpdate),
  "partnerId": S.optional(S.String),
}),
).annotate({ identifier: "EditInventorySourceReadWriteAccessorsRequest" }) as any as S.Schema<EditInventorySourceReadWriteAccessorsRequest>;
...
export const EditInventorySourceReadWriteAccessorsInventorySourcesRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "inventorySourceId": S.String.pipe(T.Label()),
  "body": S.optional(EditInventorySourceReadWriteAccessorsRequest.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"POST","uri":"v4/inventorySources/{+inventorySourceId}:editInventorySourceReadWriteAccessors","baseUrl":"https://displayvideo.googleapis.com/"})),
).annotate({ identifier: "EditInventorySourceReadWriteAccessorsInventorySourcesRequest" }) as any as S.Schema<EditInventorySourceReadWriteAccessorsInventorySourcesRequest>;
...
export interface Targeting {
  ...
  plannableLocationIds?: StringList;
}
export const Targeting = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "ageRange": S.optional(TargetingAgeRangeEnum),
  "genders": S.optional(TargetingGendersItemEnumList),
  "devices": S.optional(TargetingDevicesItemEnumList),
  "plannableLocationIds": S.optional(StringList),
}),
).annotate({ identifier: "Targeting" }) as any as S.Schema<Targeting>;

export type AdvancedProductTargetingGendersItemEnum = "GENDER_UNSPECIFIED" | "GENDER_MALE" | "GENDER_FEMALE" | "GENDER_UNKNOWN";
export const AdvancedProductTargetingGendersItemEnum = /*@__PURE__*/ S.String;

export type AdvancedProductTargetingGendersItemEnumList = ReadonlyArray<AdvancedProductTargetingGendersItemEnum | (string & {})>;
export const AdvancedProductTargetingGendersItemEnumList = /*@__PURE__*/ S.Array(AdvancedProductTargetingGendersItemEnum) as any as S.Schema<AdvancedProductTargetingGendersItemEnumList>;

export type AdvancedProductTargetingAgeRangeEnum = "PLANNABLE_AGE_RANGE_UNSPECIFIED" | "PLANNABLE_AGE_RANGE_18_24" | "PLANNABLE_AGE_RANGE_18_34" | "PLANNABLE_AGE_RANGE_18_44" | "PLANNABLE_AGE_RANGE_18_49" | "PLANNABLE_AGE_RANGE_18_54" | "PLANNABLE_AGE_RANGE_18_64" | "PLANNABLE_AGE_RANGE_18_65_UP" | "PLANNABLE_AGE_RANGE_21_34" | "PLANNABLE_AGE_RANGE_21_44" | "PLANNABLE_AGE_RANGE_21_49" | "PLANNABLE_AGE_RANGE_21_54" | "PLANNABLE_AGE_RANGE_21_64" | "PLANNABLE_AGE_RANGE_21_65_UP" | "PLANNABLE_AGE_RANGE_25_34" | "PLANNABLE_AGE_RANGE_25_44" | "PLANNABLE_AGE_RANGE_25_49" | "PLANNABLE_AGE_RANGE_25_54" | "PLANNABLE_AGE_RANGE_25_64" | "PLANNABLE_AGE_RANGE_25_65_UP" | "PLANNABLE_AGE_RANGE_35_44" | "PLANNABLE_AGE_RANGE_35_49" | "PLANNABLE_AGE_RANGE_35_54" | "PLANNABLE_AGE_RANGE_35_64" | "PLANNABLE_AGE_RANGE_35_65_UP" | "PLANNABLE_AGE_RANGE_45_54" | "PLANNABLE_AGE_RANGE_45_64" | "PLANNABLE_AGE_RANGE_45_65_UP" | "PLANNABLE_AGE_RANGE_50_65_UP" | "PLANNABLE_AGE_RANGE_55_64" | "PLANNABLE_AGE_RANGE_55_65_UP" | "PLANNABLE_AGE_RANGE_65_UP";
export const AdvancedProductTargetingAgeRangeEnum = /*@__PURE__*/ S.String;

export type AdvancedProductTargetingDevicesItemEnum = "DEVICE_TYPE_UNSPECIFIED" | "DEVICE_TYPE_COMPUTER" | "DEVICE_TYPE_CONNECTED_TV" | "DEVICE_TYPE_SMART_PHONE" | "DEVICE_TYPE_TABLET" | "DEVICE_TYPE_CONNECTED_DEVICE";
export const AdvancedProductTargetingDevicesItemEnum = /*@__PURE__*/ S.String;

export type AdvancedProductTargetingDevicesItemEnumList = ReadonlyArray<AdvancedProductTargetingDevicesItemEnum | (string & {})>;
export const AdvancedProductTargetingDevicesItemEnumList = /*@__PURE__*/ S.Array(AdvancedProductTargetingDevicesItemEnum) as any as S.Schema<AdvancedProductTargetingDevicesItemEnumList>;

export type AdvancedProductTargetingNetworkEnum = "PLANNABLE_NETWORK_UNSPECIFIED" | "PLANNABLE_NETWORK_YOUTUBE" | "PLANNABLE_NETWORK_GOOGLE_VIDEO_PARTNERS" | "PLANNABLE_NETWORK_YOUTUBE_AND_GOOGLE_VIDEO_PARTNERS";
...
export const YouTubeSelectSettings = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "lineupId": S.optional(S.String),
}),
).annotate({ identifier: "YouTubeSelectSettings" }) as any as S.Schema<YouTubeSelectSettings>;

export type SurfaceTargetingSettingsSurfacesItemEnum = "PLANNABLE_SURFACE_UNSPECIFIED" | "PLANNABLE_SURFACE_IN_FEED" | "PLANNABLE_SURFACE_IN_STREAM_BUMPER" | "PLANNABLE_SURFACE_IN_STREAM_NON_SKIPPABLE" | "PLANNABLE_SURFACE_IN_STREAM_SKIPPABLE" | "PLANNABLE_SURFACE_SHORTS" | "PLANNABLE_SURFACE_DISCOVER_FEED" | "PLANNABLE_SURFACE_GMAIL" | "PLANNABLE_SURFACE_GOOGLE_DISPLAY_NETWORK" | "PLANNABLE_SURFACE_IN_STREAM_NON_SKIPPABLE_THIRTY_SECONDS";
export const SurfaceTargetingSettingsSurfacesItemEnum = /*@__PURE__*/ S.String;

export type SurfaceTargetingSettingsSurfacesItemEnumList = ReadonlyArray<SurfaceTargetingSettingsSurfacesItemEnum | (string & {})>;
export const SurfaceTargetingSettingsSurfacesItemEnumList = /*@__PURE__*/ S.Array(SurfaceTargetingSettingsSurfacesItemEnum) as any as S.Schema<SurfaceTargetingSettingsSurfacesItemEnumList>;

/** Surface targeting selection. */
export interface SurfaceTargetingSettings {
  /** Optional. The surfaces to target. */
  surfaces?: SurfaceTargetingSettingsSurfacesItemEnumList;
}
export const SurfaceTargetingSettings = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "surfaces": S.optional(SurfaceTargetingSettingsSurfacesItemEnumList),
}),
).annotate({ identifier: "SurfaceTargetingSettings" }) as any as S.Schema<SurfaceTargetingSettings>;
...
export interface AdvancedProductTargeting {
  ...
  frequencyCap?: FrequencyCap;
  /** Optional. The gender options to target. */
  genders?: AdvancedProductTargetingGendersItemEnumList;
  ...
  userListIds?: StringList;
  /** Optional. Plannable location IDs to target. */
  plannableLocationIds?: StringList;
  /** Optional. The age range to target. */
  ageRange?: AdvancedProductTargetingAgeRangeEnum | (string & {});
  /** Optional. The devices to target. */
  devices?: AdvancedProductTargetingDevicesItemEnumList;
  ...
  userInterestIds?: StringList;
  /** Optional. The network to target. */
  network?: AdvancedProductTargetingNetworkEnum | (string & {});
...
export const AdvancedProductTargeting = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "frequencyCap": S.optional(FrequencyCap),
  "genders": S.optional(AdvancedProductTargetingGendersItemEnumList),
  "userListIds": S.optional(StringList),
  "plannableLocationIds": S.optional(StringList),
  "ageRange": S.optional(AdvancedProductTargetingAgeRangeEnum),
  "devices": S.optional(AdvancedProductTargetingDevicesItemEnumList),
  "targetFrequency": S.optional(TargetFrequency),
  "userInterestIds": S.optional(StringList),
  "network": S.optional(AdvancedProductTargetingNetworkEnum),
  "youtubeSelectSettings": S.optional(YouTubeSelectSettings),
  "dateRange": S.optional(DateRange),
  "surfaceTargetingSettings": S.optional(SurfaceTargetingSettings),
}),
).annotate({ identifier: "AdvancedProductTargeting" }) as any as S.Schema<AdvancedProductTargeting>;
...
export const PlannedProduct = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "plannableProductCode": S.optional(S.String),
  "advancedProductTargeting": S.optional(AdvancedProductTargeting),
  "budgetMicros": S.optional(S.String),
}),
).annotate({ identifier: "PlannedProduct" }) as any as S.Schema<PlannedProduct>;

export type PlannedProductList = ReadonlyArray<PlannedProduct>;
export const PlannedProductList = /*@__PURE__*/ S.Array(PlannedProduct) as any as S.Schema<PlannedProductList>;
...
export interface GenerateReachForecastRequest {
  ...
  plannedProducts?: PlannedProductList;
  /** Required. The currency code for the plan in ISO 4217 format. */
  currencyCode?: string;
}
export const GenerateReachForecastRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "minEffectiveFrequency": S.optional(S.Number),
  "campaignDuration": S.optional(CampaignDuration),
  "targeting": S.optional(Targeting),
  "plannedProducts": S.optional(PlannedProductList),
  "currencyCode": S.optional(S.String),
}),
).annotate({ identifier: "GenerateReachForecastRequest" }) as any as S.Schema<GenerateReachForecastRequest>;
...
export const GenerateReachForecastAdvertisersReachForecastRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "advertiserId": S.String.pipe(T.Label()),
  "body": S.optional(GenerateReachForecastRequest.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{+advertiserId}/reachForecast:generateReachForecast","baseUrl":"https://displayvideo.googleapis.com/"})),
).annotate({ identifier: "GenerateReachForecastAdvertisersReachForecastRequest" }) as any as S.Schema<GenerateReachForecastAdvertisersReachForecastRequest>;
...
export const OnTargetAudienceMetrics = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "youtubeAudienceSize": S.optional(S.String),
  "censusAudienceSize": S.optional(S.String),
}),
).annotate({ identifier: "OnTargetAudienceMetrics" }) as any as S.Schema<OnTargetAudienceMetrics>;
...
export const PlannedProductForecast = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "onTargetImpressions": S.optional(S.String),
  "totalImpressions": S.optional(S.String),
  "viewableImpressions": S.optional(S.String),
  "totalReach": S.optional(S.String),
  "onTargetCoviewImpressions": S.optional(S.String),
  "trueviewViews": S.optional(S.String),
  "onTargetReach": S.optional(S.String),
  "onTargetCoviewReach": S.optional(S.String),
  "totalCoviewImpressions": S.optional(S.String),
  "totalCoviewReach": S.optional(S.String),
}),
).annotate({ identifier: "PlannedProductForecast" }) as any as S.Schema<PlannedProductForecast>;
...
export const PlannedProductReachForecast = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "plannableProductCode": S.optional(S.String),
  "costMicros": S.optional(S.String),
  "plannedProductForecast": S.optional(PlannedProductForecast),
}),
).annotate({ identifier: "PlannedProductReachForecast" }) as any as S.Schema<PlannedProductReachForecast>;

export type PlannedProductReachForecastList = ReadonlyArray<PlannedProductReachForecast>;
export const PlannedProductReachForecastList = /*@__PURE__*/ S.Array(PlannedProductReachForecast) as any as S.Schema<PlannedProductReachForecastList>;
...
export interface ReachForecast {
  ...
  plannedProductReachForecasts?: PlannedProductReachForecastList;
}
export const ReachForecast = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "forecast": S.optional(PlannedProductForecast),
  "costMicros": S.optional(S.String),
  "plannedProductReachForecasts": S.optional(PlannedProductReachForecastList),
}),
).annotate({ identifier: "ReachForecast" }) as any as S.Schema<ReachForecast>;

export type ReachForecastList = ReadonlyArray<ReachForecast>;
export const ReachForecastList = /*@__PURE__*/ S.Array(ReachForecast) as any as S.Schema<ReachForecastList>;

/** The generated reach curve. */
export interface ReachCurve {
  /** Points along the curve, ordered by cost. */
  reachForecasts?: ReachForecastList;
}
export const ReachCurve = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "reachForecasts": S.optional(ReachForecastList),
}),
).annotate({ identifier: "ReachCurve" }) as any as S.Schema<ReachCurve>;
...
export const GenerateReachForecastResponse = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "onTargetAudienceMetrics": S.optional(OnTargetAudienceMetrics),
  "reachCurve": S.optional(ReachCurve),
}),
).annotate({ identifier: "GenerateReachForecastResponse" }) as any as S.Schema<GenerateReachForecastResponse>;
...
S.Struct({
  "advertiserId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
export const GetAdvertisersAdAssetsRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "advertiserId": S.String.pipe(T.Label()),
  "adAssetId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/adAssets/{+adAssetId}","baseUrl":"https://displayvideo.googleapis.com/"})),
).annotate({ identifier: "GetAdvertisersAdAssetsRequest" }) as any as S.Schema<GetAdvertisersAdAssetsRequest>;
...
S.Struct({
  "adGroupAdId": S.String.pipe(T.Label()),
  "advertiserId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/adGroupAds/{+adGroupAdId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  "advertiserId": S.String.pipe(T.Label()),
  "adGroupId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/adGroups/{+adGroupId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "advertiserId": S.String.pipe(T.Label()),
  "assignedTargetingOptionId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/adGroups/{+adGroupId}/targetingTypes/{+targetingType}/assignedTargetingOptions/{+assignedTargetingOptionId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  "advertiserId": S.String.pipe(T.Label()),
  "campaignId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/campaigns/{+campaignId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "advertiserId": S.String.pipe(T.Label()),
  "channelId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/channels/{+channelId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  "advertiserId": S.String.pipe(T.Label()),
  "creativeId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/creatives/{+creativeId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  "advertiserId": S.String.pipe(T.Label()),
  "insertionOrderId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/insertionOrders/{+insertionOrderId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  "advertiserId": S.String.pipe(T.Label()),
  "lineItemId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/lineItems/{+lineItemId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "lineItemId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/lineItems/{+lineItemId}/targetingTypes/{+targetingType}/assignedTargetingOptions/{+assignedTargetingOptionId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  "advertiserId": S.String.pipe(T.Label()),
  "locationListId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/locationLists/{+locationListId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  "advertiserId": S.String.pipe(T.Label()),
  "negativeKeywordListId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/negativeKeywordLists/{+negativeKeywordListId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/targetingTypes/{+targetingType}/assignedTargetingOptions/{+assignedTargetingOptionId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v4/combinedAudiences/{+combinedAudienceId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "partnerId": S.optional(S.String.pipe(T.Query())),
  "advertiserId": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/customBiddingAlgorithms/{+customBiddingAlgorithmId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "partnerId": S.optional(S.String.pipe(T.Query())),
  "advertiserId": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/customBiddingAlgorithms/{+customBiddingAlgorithmId}/rules/{+customBiddingAlgorithmRulesId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "customBiddingAlgorithmId": S.String.pipe(T.Label()),
  "partnerId": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/customBiddingAlgorithms/{+customBiddingAlgorithmId}/scripts/{+customBiddingScriptId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v4/customLists/{+customListId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
export const GetFirstPartyAndPartnerAudiencesRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "partnerId": S.optional(S.String.pipe(T.Query())),
  "firstPartyAndPartnerAudienceId": S.String.pipe(T.Label()),
  "advertiserId": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/firstPartyAndPartnerAudiences/{+firstPartyAndPartnerAudienceId}","baseUrl":"https://displayvideo.googleapis.com/"})),
).annotate({ identifier: "GetFirstPartyAndPartnerAudiencesRequest" }) as any as S.Schema<GetFirstPartyAndPartnerAudiencesRequest>;
...
}).pipe(T.Http({"method":"GET","uri":"v4/floodlightGroups/{+floodlightGroupId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "partnerId": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/floodlightGroups/{+floodlightGroupId}/floodlightActivities/{+floodlightActivityId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v4/googleAudiences/{+googleAudienceId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "guaranteedOrderId": S.String.pipe(T.Label()),
  "partnerId": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/guaranteedOrders/{+guaranteedOrderId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "advertiserId": S.optional(S.String.pipe(T.Query())),
  "partnerId": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/inventorySourceGroups/{+inventorySourceGroupId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
export const GetInventorySourcesRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "partnerId": S.optional(S.String.pipe(T.Query())),
  "inventorySourceId": S.String.pipe(T.Label()),
  "advertiserId": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/inventorySources/{+inventorySourceId}","baseUrl":"https://displayvideo.googleapis.com/"})),
).annotate({ identifier: "GetInventorySourcesRequest" }) as any as S.Schema<GetInventorySourcesRequest>;
...
S.Struct({
  "partnerId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v4/partners/{+partnerId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "channelId": S.String.pipe(T.Label()),
  "advertiserId": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/partners/{+partnerId}/channels/{+channelId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "assignedTargetingOptionId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v4/partners/{+partnerId}/targetingTypes/{+targetingType}/assignedTargetingOptions/{+assignedTargetingOptionId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v4/{+name}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
export const GetSdfuploadtasksOperationsRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "name": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v4/{+name}","baseUrl":"https://displayvideo.googleapis.com/"})),
).annotate({ identifier: "GetSdfuploadtasksOperationsRequest" }) as any as S.Schema<GetSdfuploadtasksOperationsRequest>;
...
}).pipe(T.Http({"method":"GET","uri":"v4/targetingTypes/{+targetingType}/targetingOptions/{+targetingOptionId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  "userId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v4/users/{+userId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "pageToken": S.optional(S.String.pipe(T.Query())),
  "filter": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers","baseUrl":"https://displayvideo.googleapis.com/"})),
...
export const ListAdvertisersAdAssetsRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "pageSize": S.optional(S.Number.pipe(T.Query())),
  "pageToken": S.optional(S.String.pipe(T.Query())),
  "filter": S.optional(S.String.pipe(T.Query())),
  "advertiserId": S.String.pipe(T.Label()),
  "orderBy": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/adAssets","baseUrl":"https://displayvideo.googleapis.com/"})),
).annotate({ identifier: "ListAdvertisersAdAssetsRequest" }) as any as S.Schema<ListAdvertisersAdAssetsRequest>;
...
export const ListAdAssetsResponse = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "adAssets": S.optional(AdAssetList),
  "nextPageToken": S.optional(S.String),
}),
).annotate({ identifier: "ListAdAssetsResponse" }) as any as S.Schema<ListAdAssetsResponse>;
...
S.Struct({
  ...
  "filter": S.optional(S.String.pipe(T.Query())),
  "orderBy": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/adGroupAds","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "advertiserId": S.String.pipe(T.Label()),
  "orderBy": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/adGroups","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "adGroupId": S.String.pipe(T.Label()),
  "orderBy": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/adGroups/{+adGroupId}/targetingTypes/{+targetingType}/assignedTargetingOptions","baseUrl":"https://displayvideo.googleapis.com/"})),
...
export type ListAdvertisersAdGroupsYoutubeAssetTypesYoutubeAssetAssociationsYoutubeAssetTypeEnum = "YOUTUBE_ASSET_TYPE_UNSPECIFIED" | "YOUTUBE_ASSET_TYPE_LOCATION" | "YOUTUBE_ASSET_TYPE_AFFILIATE_LOCATION" | "YOUTUBE_ASSET_TYPE_SITELINK";
export const ListAdvertisersAdGroupsYoutubeAssetTypesYoutubeAssetAssociationsYoutubeAssetTypeEnum = /*@__PURE__*/ S.String;
...
export interface ListAdvertisersAdGroupsYoutubeAssetTypesYoutubeAssetAssociationsRequest {
  ...
  youtubeAssetType: ListAdvertisersAdGroupsYoutubeAssetTypesYoutubeAssetAssociationsYoutubeAssetTypeEnum | (string & {});
...
export const ListAdvertisersAdGroupsYoutubeAssetTypesYoutubeAssetAssociationsRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "youtubeAssetType": ListAdvertisersAdGroupsYoutubeAssetTypesYoutubeAssetAssociationsYoutubeAssetTypeEnum.pipe(T.Label()),
  "pageSize": S.optional(S.Number.pipe(T.Query())),
  "pageToken": S.optional(S.String.pipe(T.Query())),
  "advertiserId": S.String.pipe(T.Label()),
  "linkedEntity.lineItemId": S.optional(S.String.pipe(T.Query())),
  "adGroupId": S.String.pipe(T.Label()),
  "orderBy": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/adGroups/{+adGroupId}/youtubeAssetTypes/{+youtubeAssetType}/youtubeAssetAssociations","baseUrl":"https://displayvideo.googleapis.com/"})),
).annotate({ identifier: "ListAdvertisersAdGroupsYoutubeAssetTypesYoutubeAssetAssociationsRequest" }) as any as S.Schema<ListAdvertisersAdGroupsYoutubeAssetTypesYoutubeAssetAssociationsRequest>;

export type YoutubeAssetAssociationList = ReadonlyArray<YoutubeAssetAssociation>;
export const YoutubeAssetAssociationList = /*@__PURE__*/ S.Array(YoutubeAssetAssociation) as any as S.Schema<YoutubeAssetAssociationList>;
...
export interface ListYoutubeAssetAssociationsResponse {
  ...
  youtubeAssetAssociations?: YoutubeAssetAssociationList;
...
export const ListYoutubeAssetAssociationsResponse = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "youtubeAssetAssociations": S.optional(YoutubeAssetAssociationList),
  "nextPageToken": S.optional(S.String),
}),
).annotate({ identifier: "ListYoutubeAssetAssociationsResponse" }) as any as S.Schema<ListYoutubeAssetAssociationsResponse>;
...
S.Struct({
  ...
  "filter": S.optional(S.String.pipe(T.Query())),
  "orderBy": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/campaigns","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "pageToken": S.optional(S.String.pipe(T.Query())),
  "filter": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/channels","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "advertiserId": S.String.pipe(T.Label()),
  "channelId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/channels/{+channelId}/sites","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "filter": S.optional(S.String.pipe(T.Query())),
  "advertiserId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/creatives","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "filter": S.optional(S.String.pipe(T.Query())),
  "orderBy": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/insertionOrders","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/invoices","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "filter": S.optional(S.String.pipe(T.Query())),
  "orderBy": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/lineItems","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "pageToken": S.optional(S.String.pipe(T.Query())),
  "filter": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/lineItems/{+lineItemId}/targetingTypes/{+targetingType}/assignedTargetingOptions","baseUrl":"https://displayvideo.googleapis.com/"})),
...
export type ListAdvertisersLineItemsYoutubeAssetTypesYoutubeAssetAssociationsYoutubeAssetTypeEnum = "YOUTUBE_ASSET_TYPE_UNSPECIFIED" | "YOUTUBE_ASSET_TYPE_LOCATION" | "YOUTUBE_ASSET_TYPE_AFFILIATE_LOCATION" | "YOUTUBE_ASSET_TYPE_SITELINK";
export const ListAdvertisersLineItemsYoutubeAssetTypesYoutubeAssetAssociationsYoutubeAssetTypeEnum = /*@__PURE__*/ S.String;
...
export interface ListAdvertisersLineItemsYoutubeAssetTypesYoutubeAssetAssociationsRequest {
  ...
  "linkedEntity.adGroupId"?: string;
  /** Required. The type of YouTube asset being associated with the resource. */
  youtubeAssetType: ListAdvertisersLineItemsYoutubeAssetTypesYoutubeAssetAssociationsYoutubeAssetTypeEnum | (string & {});
  /** Optional. Requested page size. Must be between `1` and `10000`. If unspecified will default to `100`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified. */
  pageSize?: number;
  /** Optional. A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListYoutubeAssetAssociations` method. If not specified, the first page of results will be returned. */
  pageToken?: string;
...
export const ListAdvertisersLineItemsYoutubeAssetTypesYoutubeAssetAssociationsRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "orderBy": S.optional(S.String.pipe(T.Query())),
  "linkedEntity.adGroupId": S.optional(S.String.pipe(T.Query())),
  "youtubeAssetType": ListAdvertisersLineItemsYoutubeAssetTypesYoutubeAssetAssociationsYoutubeAssetTypeEnum.pipe(T.Label()),
  "pageSize": S.optional(S.Number.pipe(T.Query())),
  "pageToken": S.optional(S.String.pipe(T.Query())),
  "lineItemId": S.String.pipe(T.Label()),
  "advertiserId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/lineItems/{+lineItemId}/youtubeAssetTypes/{+youtubeAssetType}/youtubeAssetAssociations","baseUrl":"https://displayvideo.googleapis.com/"})),
).annotate({ identifier: "ListAdvertisersLineItemsYoutubeAssetTypesYoutubeAssetAssociationsRequest" }) as any as S.Schema<ListAdvertisersLineItemsYoutubeAssetTypesYoutubeAssetAssociationsRequest>;
...
S.Struct({
  ...
  "advertiserId": S.String.pipe(T.Label()),
  "orderBy": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/locationLists","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "filter": S.optional(S.String.pipe(T.Query())),
  "orderBy": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{advertiserId}/locationLists/{locationListId}/assignedLocations","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "pageSize": S.optional(S.Number.pipe(T.Query())),
  "pageToken": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/negativeKeywordLists","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "negativeKeywordListId": S.String.pipe(T.Label()),
  "orderBy": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/negativeKeywordLists/{+negativeKeywordListId}/negativeKeywords","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "advertiserId": S.String.pipe(T.Label()),
  "orderBy": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/targetingTypes/{+targetingType}/assignedTargetingOptions","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "filter": S.optional(S.String.pipe(T.Query())),
  "advertiserId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}:listAssignedTargetingOptions","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "pageToken": S.optional(S.String.pipe(T.Query())),
  "filter": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/combinedAudiences","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "filter": S.optional(S.String.pipe(T.Query())),
  "advertiserId": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/customBiddingAlgorithms","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "pageSize": S.optional(S.Number.pipe(T.Query())),
  "pageToken": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/customBiddingAlgorithms/{+customBiddingAlgorithmId}/rules","baseUrl":"https://displayvideo.googleapis.com/"})),
...
export interface ListCustomBiddingAlgorithmRulesResponse {
  ...
  customBiddingRules?: CustomBiddingAlgorithmRulesList;
}
...
S.Struct({
  ...
  "orderBy": S.optional(S.String.pipe(T.Query())),
  "customBiddingAlgorithmId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v4/customBiddingAlgorithms/{+customBiddingAlgorithmId}/scripts","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "filter": S.optional(S.String.pipe(T.Query())),
  "advertiserId": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/customLists","baseUrl":"https://displayvideo.googleapis.com/"})),
...
export const ListFirstPartyAndPartnerAudiencesRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "orderBy": S.optional(S.String.pipe(T.Query())),
  "partnerId": S.optional(S.String.pipe(T.Query())),
  "pageSize": S.optional(S.Number.pipe(T.Query())),
  ...
  "filter": S.optional(S.String.pipe(T.Query())),
  "advertiserId": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/firstPartyAndPartnerAudiences","baseUrl":"https://displayvideo.googleapis.com/"})),
).annotate({ identifier: "ListFirstPartyAndPartnerAudiencesRequest" }) as any as S.Schema<ListFirstPartyAndPartnerAudiencesRequest>;

export type FirstPartyAndPartnerAudienceList = ReadonlyArray<FirstPartyAndPartnerAudience>;
export const FirstPartyAndPartnerAudienceList = /*@__PURE__*/ S.Array(FirstPartyAndPartnerAudience) as any as S.Schema<FirstPartyAndPartnerAudienceList>;
...
export interface ListFirstPartyAndPartnerAudiencesResponse {
  ...
  firstPartyAndPartnerAudiences?: FirstPartyAndPartnerAudienceList;
...
export const ListFirstPartyAndPartnerAudiencesResponse = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "firstPartyAndPartnerAudiences": S.optional(FirstPartyAndPartnerAudienceList),
  "nextPageToken": S.optional(S.String),
}),
).annotate({ identifier: "ListFirstPartyAndPartnerAudiencesResponse" }) as any as S.Schema<ListFirstPartyAndPartnerAudiencesResponse>;
...
S.Struct({
  ...
  "pageSize": S.optional(S.Number.pipe(T.Query())),
  "pageToken": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/floodlightGroups/{+floodlightGroupId}/floodlightActivities","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "pageToken": S.optional(S.String.pipe(T.Query())),
  "filter": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/googleAudiences","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "filter": S.optional(S.String.pipe(T.Query())),
  "advertiserId": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/guaranteedOrders","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "filter": S.optional(S.String.pipe(T.Query())),
  "advertiserId": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/inventorySourceGroups","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "inventorySourceGroupId": S.String.pipe(T.Label()),
  "orderBy": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/inventorySourceGroups/{+inventorySourceGroupId}/assignedInventorySources","baseUrl":"https://displayvideo.googleapis.com/"})),
...
export const ListInventorySourcesRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "orderBy": S.optional(S.String.pipe(T.Query())),
  "advertiserId": S.optional(S.String.pipe(T.Query())),
  "partnerId": S.optional(S.String.pipe(T.Query())),
  ...
  "pageToken": S.optional(S.String.pipe(T.Query())),
  "filter": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/inventorySources","baseUrl":"https://displayvideo.googleapis.com/"})),
).annotate({ identifier: "ListInventorySourcesRequest" }) as any as S.Schema<ListInventorySourcesRequest>;

export type InventorySourceList = ReadonlyArray<InventorySource>;
export const InventorySourceList = /*@__PURE__*/ S.Array(InventorySource) as any as S.Schema<InventorySourceList>;

export interface ListInventorySourcesResponse {
  /** The list of inventory sources. This list will be absent if empty. */
  inventorySources?: InventorySourceList;
...
export const ListInventorySourcesResponse = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "inventorySources": S.optional(InventorySourceList),
  "nextPageToken": S.optional(S.String),
}),
).annotate({ identifier: "ListInventorySourcesResponse" }) as any as S.Schema<ListInventorySourcesResponse>;
...
S.Struct({
  ...
  "filter": S.optional(S.String.pipe(T.Query())),
  "orderBy": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/partners","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "filter": S.optional(S.String.pipe(T.Query())),
  "advertiserId": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/partners/{+partnerId}/channels","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "filter": S.optional(S.String.pipe(T.Query())),
  "orderBy": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/partners/{+partnerId}/channels/{+channelId}/sites","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "filter": S.optional(S.String.pipe(T.Query())),
  "orderBy": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/partners/{+partnerId}/targetingTypes/{+targetingType}/assignedTargetingOptions","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "filter": S.optional(S.String.pipe(T.Query())),
  "advertiserId": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/targetingTypes/{+targetingType}/targetingOptions","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "pageToken": S.optional(S.String.pipe(T.Query())),
  "filter": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/users","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/invoices:lookupInvoiceCurrency","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "advertiserId": S.String.pipe(T.Label()),
  "body": S.optional(Advertiser.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"PATCH","uri":"v4/advertisers/{+advertiserId}","baseUrl":"https://displayvideo.googleapis.com/"})),
).annotate({ identifier: "PatchAdvertisersRequest" }) as any as S.Schema<PatchAdvertisersRequest>;

export interface PatchAdvertisersAdAssetsRequest {
  /** Required. The ID of the advertiser this ad asset belongs to. */
  advertiserId: string;
  /** Output only. The ID of the ad asset. Referred to as the asset ID when assigned to an ad. */
  adAssetId: string;
...
export const PatchAdvertisersAdAssetsRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "advertiserId": S.String.pipe(T.Label()),
  "adAssetId": S.String.pipe(T.Label()),
  "updateMask": S.optional(S.String.pipe(T.Query())),
  "body": S.optional(AdAsset.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"PATCH","uri":"v4/advertisers/{+advertiserId}/adAssets/{+adAssetId}","baseUrl":"https://displayvideo.googleapis.com/"})),
).annotate({ identifier: "PatchAdvertisersAdAssetsRequest" }) as any as S.Schema<PatchAdvertisersAdAssetsRequest>;
...
S.Struct({
  ...
  "advertiserId": S.String.pipe(T.Label()),
  "body": S.optional(AdGroupAd.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"PATCH","uri":"v4/advertisers/{+advertiserId}/adGroupAds/{+adGroupAdId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "adGroupId": S.String.pipe(T.Label()),
  "body": S.optional(AdGroup.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"PATCH","uri":"v4/advertisers/{+advertiserId}/adGroups/{+adGroupId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "updateMask": S.optional(S.String.pipe(T.Query())),
  "body": S.optional(Campaign.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"PATCH","uri":"v4/advertisers/{+advertiserId}/campaigns/{+campaignId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "partnerId": S.optional(S.String.pipe(T.Query())),
  "body": S.optional(Channel.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"PATCH","uri":"v4/advertisers/{+advertiserId}/channels/{channelId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "creativeId": S.String.pipe(T.Label()),
  "body": S.optional(Creative.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"PATCH","uri":"v4/advertisers/{+advertiserId}/creatives/{+creativeId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "insertionOrderId": S.String.pipe(T.Label()),
  "body": S.optional(InsertionOrder.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"PATCH","uri":"v4/advertisers/{+advertiserId}/insertionOrders/{+insertionOrderId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "lineItemId": S.String.pipe(T.Label()),
  "body": S.optional(LineItem.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"PATCH","uri":"v4/advertisers/{+advertiserId}/lineItems/{+lineItemId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "advertiserId": S.String.pipe(T.Label()),
  "body": S.optional(LocationList.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"PATCH","uri":"v4/advertisers/{+advertiserId}/locationLists/{locationListId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "updateMask": S.optional(S.String.pipe(T.Query())),
  "body": S.optional(NegativeKeywordList.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"PATCH","uri":"v4/advertisers/{+advertiserId}/negativeKeywordLists/{negativeKeywordListId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "updateMask": S.optional(S.String.pipe(T.Query())),
  "body": S.optional(CustomBiddingAlgorithm.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"PATCH","uri":"v4/customBiddingAlgorithms/{+customBiddingAlgorithmId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
export const PatchFirstPartyAndPartnerAudiencesRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "firstPartyAndPartnerAudienceId": S.String.pipe(T.Label()),
  "advertiserId": S.optional(S.String.pipe(T.Query())),
  "updateMask": S.optional(S.String.pipe(T.Query())),
  "body": S.optional(FirstPartyAndPartnerAudience.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"PATCH","uri":"v4/firstPartyAndPartnerAudiences/{+firstPartyAndPartnerAudienceId}","baseUrl":"https://displayvideo.googleapis.com/"})),
).annotate({ identifier: "PatchFirstPartyAndPartnerAudiencesRequest" }) as any as S.Schema<PatchFirstPartyAndPartnerAudiencesRequest>;
...
}).pipe(T.Http({"method":"PATCH","uri":"v4/floodlightGroups/{floodlightGroupId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "partnerId": S.optional(S.String.pipe(T.Query())),
  "body": S.optional(GuaranteedOrder.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"PATCH","uri":"v4/guaranteedOrders/{+guaranteedOrderId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "updateMask": S.optional(S.String.pipe(T.Query())),
  "body": S.optional(InventorySourceGroup.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"PATCH","uri":"v4/inventorySourceGroups/{inventorySourceGroupId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
export const PatchInventorySourcesRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "inventorySourceId": S.String.pipe(T.Label()),
  "partnerId": S.optional(S.String.pipe(T.Query())),
  "advertiserId": S.optional(S.String.pipe(T.Query())),
  "updateMask": S.optional(S.String.pipe(T.Query())),
  "body": S.optional(InventorySource.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"PATCH","uri":"v4/inventorySources/{+inventorySourceId}","baseUrl":"https://displayvideo.googleapis.com/"})),
).annotate({ identifier: "PatchInventorySourcesRequest" }) as any as S.Schema<PatchInventorySourcesRequest>;
...
S.Struct({
  ...
  "partnerId": S.String.pipe(T.Label()),
  "body": S.optional(Channel.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"PATCH","uri":"v4/partners/{+partnerId}/channels/{channelId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "updateMask": S.optional(S.String.pipe(T.Query())),
  "body": S.optional(User.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"PATCH","uri":"v4/users/{+userId}","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{advertiserId}/channels/{+channelId}/sites:replace","baseUrl":"https://displayvideo.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{advertiserId}/negativeKeywordLists/{+negativeKeywordListId}/negativeKeywords:replace","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "channelId": S.String.pipe(T.Label()),
  "body": S.optional(ReplaceSitesRequest.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"POST","uri":"v4/partners/{partnerId}/channels/{+channelId}/sites:replace","baseUrl":"https://displayvideo.googleapis.com/"})),
...
export const RetrievePlannableLocationsAdvertisersReachForecastRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "advertiserId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/reachForecast:retrievePlannableLocations","baseUrl":"https://displayvideo.googleapis.com/"})),
).annotate({ identifier: "RetrievePlannableLocationsAdvertisersReachForecastRequest" }) as any as S.Schema<RetrievePlannableLocationsAdvertisersReachForecastRequest>;

export type PlannableLocationGeoRegionTypeEnum = "GEO_REGION_TYPE_UNKNOWN" | "GEO_REGION_TYPE_OTHER" | "GEO_REGION_TYPE_COUNTRY" | "GEO_REGION_TYPE_REGION" | "GEO_REGION_TYPE_TERRITORY" | "GEO_REGION_TYPE_PROVINCE" | "GEO_REGION_TYPE_STATE" | "GEO_REGION_TYPE_PREFECTURE" | "GEO_REGION_TYPE_GOVERNORATE" | "GEO_REGION_TYPE_CANTON" | "GEO_REGION_TYPE_UNION_TERRITORY" | "GEO_REGION_TYPE_AUTONOMOUS_COMMUNITY" | "GEO_REGION_TYPE_DMA_REGION" | "GEO_REGION_TYPE_METRO" | "GEO_REGION_TYPE_CONGRESSIONAL_DISTRICT" | "GEO_REGION_TYPE_COUNTY" | "GEO_REGION_TYPE_MUNICIPALITY" | "GEO_REGION_TYPE_CITY" | "GEO_REGION_TYPE_POSTAL_CODE" | "GEO_REGION_TYPE_DEPARTMENT" | "GEO_REGION_TYPE_AIRPORT" | "GEO_REGION_TYPE_TV_REGION" | "GEO_REGION_TYPE_OKRUG" | "GEO_REGION_TYPE_BOROUGH" | "GEO_REGION_TYPE_CITY_REGION" | "GEO_REGION_TYPE_ARRONDISSEMENT" | "GEO_REGION_TYPE_NEIGHBORHOOD" | "GEO_REGION_TYPE_UNIVERSITY" | "GEO_REGION_TYPE_DISTRICT" | "GEO_REGION_TYPE_NATIONAL_PARK" | "GEO_REGION_TYPE_BARRIO" | "GEO_REGION_TYPE_SUB_WARD" | "GEO_REGION_TYPE_MUNICIPALITY_DISTRICT" | "GEO_REGION_TYPE_SUB_DISTRICT" | "GEO_REGION_TYPE_QUARTER" | "GEO_REGION_TYPE_DIVISION" | "GEO_REGION_TYPE_COMMUNE" | "GEO_REGION_TYPE_COLLOQUIAL_AREA" | "GEO_REGION_TYPE_POST_TOWN" | "GEO_REGION_TYPE_WARD";
...
export interface PlannableLocation {
  ...
  geoRegionType?: PlannableLocationGeoRegionTypeEnum;
...
export const PlannableLocation = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "displayName": S.optional(S.String),
  "geoRegionType": S.optional(PlannableLocationGeoRegionTypeEnum),
  "name": S.optional(S.String),
  "plannableLocationId": S.optional(S.String),
  "parentPlannableLocationId": S.optional(S.String),
  "regionCode": S.optional(S.String),
}),
).annotate({ identifier: "PlannableLocation" }) as any as S.Schema<PlannableLocation>;

export type PlannableLocationList = ReadonlyArray<PlannableLocation>;
export const PlannableLocationList = /*@__PURE__*/ S.Array(PlannableLocation) as any as S.Schema<PlannableLocationList>;
...
export interface RetrievePlannableLocationsResponse {
  ...
  plannableLocations?: PlannableLocationList;
}
export const RetrievePlannableLocationsResponse = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "plannableLocations": S.optional(PlannableLocationList),
}),
).annotate({ identifier: "RetrievePlannableLocationsResponse" }) as any as S.Schema<RetrievePlannableLocationsResponse>;
...
export const RetrievePlannableProductsAdvertisersReachForecastRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "advertiserId": S.String.pipe(T.Label()),
  "plannableLocationId": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/reachForecast:retrievePlannableProducts","baseUrl":"https://displayvideo.googleapis.com/"})),
).annotate({ identifier: "RetrievePlannableProductsAdvertisersReachForecastRequest" }) as any as S.Schema<RetrievePlannableProductsAdvertisersReachForecastRequest>;

export type PlannableTargetingGendersItemEnum = "GENDER_UNSPECIFIED" | "GENDER_MALE" | "GENDER_FEMALE" | "GENDER_UNKNOWN";
export const PlannableTargetingGendersItemEnum = /*@__PURE__*/ S.String;

export type PlannableTargetingGendersItemEnumList = ReadonlyArray<PlannableTargetingGendersItemEnum>;
export const PlannableTargetingGendersItemEnumList = /*@__PURE__*/ S.Array(PlannableTargetingGendersItemEnum) as any as S.Schema<PlannableTargetingGendersItemEnumList>;

export type SurfaceTargetingCombinationsDefaultSurfaceTypesItemEnum = "PLANNABLE_SURFACE_UNSPECIFIED" | "PLANNABLE_SURFACE_IN_FEED" | "PLANNABLE_SURFACE_IN_STREAM_BUMPER" | "PLANNABLE_SURFACE_IN_STREAM_NON_SKIPPABLE" | "PLANNABLE_SURFACE_IN_STREAM_SKIPPABLE" | "PLANNABLE_SURFACE_SHORTS" | "PLANNABLE_SURFACE_DISCOVER_FEED" | "PLANNABLE_SURFACE_GMAIL" | "PLANNABLE_SURFACE_GOOGLE_DISPLAY_NETWORK" | "PLANNABLE_SURFACE_IN_STREAM_NON_SKIPPABLE_THIRTY_SECONDS";
export const SurfaceTargetingCombinationsDefaultSurfaceTypesItemEnum = /*@__PURE__*/ S.String;

export type SurfaceTargetingCombinationsDefaultSurfaceTypesItemEnumList = ReadonlyArray<SurfaceTargetingCombinationsDefaultSurfaceTypesItemEnum>;
export const SurfaceTargetingCombinationsDefaultSurfaceTypesItemEnumList = /*@__PURE__*/ S.Array(SurfaceTargetingCombinationsDefaultSurfaceTypesItemEnum) as any as S.Schema<SurfaceTargetingCombinationsDefaultSurfaceTypesItemEnumList>;

export type SurfaceTargetingCombinationsAvailableSurfaceTypesItemEnum = "PLANNABLE_SURFACE_UNSPECIFIED" | "PLANNABLE_SURFACE_IN_FEED" | "PLANNABLE_SURFACE_IN_STREAM_BUMPER" | "PLANNABLE_SURFACE_IN_STREAM_NON_SKIPPABLE" | "PLANNABLE_SURFACE_IN_STREAM_SKIPPABLE" | "PLANNABLE_SURFACE_SHORTS" | "PLANNABLE_SURFACE_DISCOVER_FEED" | "PLANNABLE_SURFACE_GMAIL" | "PLANNABLE_SURFACE_GOOGLE_DISPLAY_NETWORK" | "PLANNABLE_SURFACE_IN_STREAM_NON_SKIPPABLE_THIRTY_SECONDS";
export const SurfaceTargetingCombinationsAvailableSurfaceTypesItemEnum = /*@__PURE__*/ S.String;

export type SurfaceTargetingCombinationsAvailableSurfaceTypesItemEnumList = ReadonlyArray<SurfaceTargetingCombinationsAvailableSurfaceTypesItemEnum>;
export const SurfaceTargetingCombinationsAvailableSurfaceTypesItemEnumList = /*@__PURE__*/ S.Array(SurfaceTargetingCombinationsAvailableSurfaceTypesItemEnum) as any as S.Schema<SurfaceTargetingCombinationsAvailableSurfaceTypesItemEnumList>;

export type SurfaceTargetingCombinationChoicesItemEnum = "PLANNABLE_SURFACE_UNSPECIFIED" | "PLANNABLE_SURFACE_IN_FEED" | "PLANNABLE_SURFACE_IN_STREAM_BUMPER" | "PLANNABLE_SURFACE_IN_STREAM_NON_SKIPPABLE" | "PLANNABLE_SURFACE_IN_STREAM_SKIPPABLE" | "PLANNABLE_SURFACE_SHORTS" | "PLANNABLE_SURFACE_DISCOVER_FEED" | "PLANNABLE_SURFACE_GMAIL" | "PLANNABLE_SURFACE_GOOGLE_DISPLAY_NETWORK" | "PLANNABLE_SURFACE_IN_STREAM_NON_SKIPPABLE_THIRTY_SECONDS";
export const SurfaceTargetingCombinationChoicesItemEnum = /*@__PURE__*/ S.String;

export type SurfaceTargetingCombinationChoicesItemEnumList = ReadonlyArray<SurfaceTargetingCombinationChoicesItemEnum>;
export const SurfaceTargetingCombinationChoicesItemEnumList = /*@__PURE__*/ S.Array(SurfaceTargetingCombinationChoicesItemEnum) as any as S.Schema<SurfaceTargetingCombinationChoicesItemEnumList>;

/** A valid combination of surfaces. */
export interface SurfaceTargetingCombination {
  /** Output only. The combination of surfaces. */
  choices?: SurfaceTargetingCombinationChoicesItemEnumList;
}
export const SurfaceTargetingCombination = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "choices": S.optional(SurfaceTargetingCombinationChoicesItemEnumList),
}),
).annotate({ identifier: "SurfaceTargetingCombination" }) as any as S.Schema<SurfaceTargetingCombination>;

export type SurfaceTargetingCombinationList = ReadonlyArray<SurfaceTargetingCombination>;
export const SurfaceTargetingCombinationList = /*@__PURE__*/ S.Array(SurfaceTargetingCombination) as any as S.Schema<SurfaceTargetingCombinationList>;
...
export interface SurfaceTargetingCombinations {
  ...
  defaultSurfaceTypes?: SurfaceTargetingCombinationsDefaultSurfaceTypesItemEnumList;
  /** Output only. The surface types available. */
  availableSurfaceTypes?: SurfaceTargetingCombinationsAvailableSurfaceTypesItemEnumList;
  /** Output only. Valid combinations of surfaces that can be selected together. */
  validSurfaceCombinations?: SurfaceTargetingCombinationList;
}
export const SurfaceTargetingCombinations = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "defaultSurfaceTypes": S.optional(SurfaceTargetingCombinationsDefaultSurfaceTypesItemEnumList),
  "availableSurfaceTypes": S.optional(SurfaceTargetingCombinationsAvailableSurfaceTypesItemEnumList),
  "validSurfaceCombinations": S.optional(SurfaceTargetingCombinationList),
}),
).annotate({ identifier: "SurfaceTargetingCombinations" }) as any as S.Schema<SurfaceTargetingCombinations>;

export type PlannableTargetingNetworksItemEnum = "PLANNABLE_NETWORK_UNSPECIFIED" | "PLANNABLE_NETWORK_YOUTUBE" | "PLANNABLE_NETWORK_GOOGLE_VIDEO_PARTNERS" | "PLANNABLE_NETWORK_YOUTUBE_AND_GOOGLE_VIDEO_PARTNERS";
export const PlannableTargetingNetworksItemEnum = /*@__PURE__*/ S.String;

export type PlannableTargetingNetworksItemEnumList = ReadonlyArray<PlannableTargetingNetworksItemEnum>;
export const PlannableTargetingNetworksItemEnumList = /*@__PURE__*/ S.Array(PlannableTargetingNetworksItemEnum) as any as S.Schema<PlannableTargetingNetworksItemEnumList>;

export type PlannableTargetingDevicesItemEnum = "DEVICE_TYPE_UNSPECIFIED" | "DEVICE_TYPE_COMPUTER" | "DEVICE_TYPE_CONNECTED_TV" | "DEVICE_TYPE_SMART_PHONE" | "DEVICE_TYPE_TABLET" | "DEVICE_TYPE_CONNECTED_DEVICE";
export const PlannableTargetingDevicesItemEnum = /*@__PURE__*/ S.String;

export type PlannableTargetingDevicesItemEnumList = ReadonlyArray<PlannableTargetingDevicesItemEnum>;
export const PlannableTargetingDevicesItemEnumList = /*@__PURE__*/ S.Array(PlannableTargetingDevicesItemEnum) as any as S.Schema<PlannableTargetingDevicesItemEnumList>;

export type PlannableTargetingAgeRangesItemEnum = "PLANNABLE_AGE_RANGE_UNSPECIFIED" | "PLANNABLE_AGE_RANGE_18_24" | "PLANNABLE_AGE_RANGE_18_34" | "PLANNABLE_AGE_RANGE_18_44" | "PLANNABLE_AGE_RANGE_18_49" | "PLANNABLE_AGE_RANGE_18_54" | "PLANNABLE_AGE_RANGE_18_64" | "PLANNABLE_AGE_RANGE_18_65_UP" | "PLANNABLE_AGE_RANGE_21_34" | "PLANNABLE_AGE_RANGE_21_44" | "PLANNABLE_AGE_RANGE_21_49" | "PLANNABLE_AGE_RANGE_21_54" | "PLANNABLE_AGE_RANGE_21_64" | "PLANNABLE_AGE_RANGE_21_65_UP" | "PLANNABLE_AGE_RANGE_25_34" | "PLANNABLE_AGE_RANGE_25_44" | "PLANNABLE_AGE_RANGE_25_49" | "PLANNABLE_AGE_RANGE_25_54" | "PLANNABLE_AGE_RANGE_25_64" | "PLANNABLE_AGE_RANGE_25_65_UP" | "PLANNABLE_AGE_RANGE_35_44" | "PLANNABLE_AGE_RANGE_35_49" | "PLANNABLE_AGE_RANGE_35_54" | "PLANNABLE_AGE_RANGE_35_64" | "PLANNABLE_AGE_RANGE_35_65_UP" | "PLANNABLE_AGE_RANGE_45_54" | "PLANNABLE_AGE_RANGE_45_64" | "PLANNABLE_AGE_RANGE_45_65_UP" | "PLANNABLE_AGE_RANGE_50_65_UP" | "PLANNABLE_AGE_RANGE_55_64" | "PLANNABLE_AGE_RANGE_55_65_UP" | "PLANNABLE_AGE_RANGE_65_UP";
export const PlannableTargetingAgeRangesItemEnum = /*@__PURE__*/ S.String;

export type PlannableTargetingAgeRangesItemEnumList = ReadonlyArray<PlannableTargetingAgeRangesItemEnum>;
export const PlannableTargetingAgeRangesItemEnumList = /*@__PURE__*/ S.Array(PlannableTargetingAgeRangesItemEnum) as any as S.Schema<PlannableTargetingAgeRangesItemEnumList>;
...
export const YouTubeSelectLineUp = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "lineupId": S.optional(S.String),
  "displayName": S.optional(S.String),
}),
).annotate({ identifier: "YouTubeSelectLineUp" }) as any as S.Schema<YouTubeSelectLineUp>;

export type YouTubeSelectLineUpList = ReadonlyArray<YouTubeSelectLineUp>;
export const YouTubeSelectLineUpList = /*@__PURE__*/ S.Array(YouTubeSelectLineUp) as any as S.Schema<YouTubeSelectLineUpList>;
...
export interface PlannableTargeting {
  ...
  genders?: PlannableTargetingGendersItemEnumList;
  ...
  networks?: PlannableTargetingNetworksItemEnumList;
  /** Output only. Targetable devices for the ad product. */
  devices?: PlannableTargetingDevicesItemEnumList;
  ...
  ageRanges?: PlannableTargetingAgeRangesItemEnumList;
  /** Output only. Targetable YouTube Select Lineups for the ad product. */
  youtubeSelectLineups?: YouTubeSelectLineUpList;
...
export const PlannableTargeting = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "genders": S.optional(PlannableTargetingGendersItemEnumList),
  "surfaceTargetingCombinations": S.optional(SurfaceTargetingCombinations),
  "networks": S.optional(PlannableTargetingNetworksItemEnumList),
  "devices": S.optional(PlannableTargetingDevicesItemEnumList),
  "ageRanges": S.optional(PlannableTargetingAgeRangesItemEnumList),
  "youtubeSelectLineups": S.optional(YouTubeSelectLineUpList),
  "defaultYoutubeSelectLineup": S.optional(YouTubeSelectLineUp),
}),
).annotate({ identifier: "PlannableTargeting" }) as any as S.Schema<PlannableTargeting>;

export type PlannableProductCoreAttributesBuyingMethodEnum = "PLANNABLE_BUYING_METHOD_UNSPECIFIED" | "PLANNABLE_BUYING_METHOD_AUCTION" | "PLANNABLE_BUYING_METHOD_RESERVATION";
export const PlannableProductCoreAttributesBuyingMethodEnum = /*@__PURE__*/ S.String;

export type PlannableProductCoreAttributesCostModelEnum = "PLANNABLE_COST_MODEL_UNSPECIFIED" | "PLANNABLE_COST_MODEL_CPM" | "PLANNABLE_COST_MODEL_CPV" | "PLANNABLE_COST_MODEL_CPC" | "PLANNABLE_COST_MODEL_CPA";
export const PlannableProductCoreAttributesCostModelEnum = /*@__PURE__*/ S.String;

export type PlannableProductCoreAttributesProductCategoryEnum = "PLANNABLE_PRODUCT_CATEGORY_UNSPECIFIED" | "YOUTUBE" | "OPEN_AUCTION";
export const PlannableProductCoreAttributesProductCategoryEnum = /*@__PURE__*/ S.String;

/** Core attributes for a plannable product. */
export interface PlannableProductCoreAttributes {
  /** Output only. The buying method. */
  buyingMethod?: PlannableProductCoreAttributesBuyingMethodEnum;
  /** Output only. The cost model. */
  costModel?: PlannableProductCoreAttributesCostModelEnum;
  /** Output only. The product category. */
  productCategory?: PlannableProductCoreAttributesProductCategoryEnum;
}
export const PlannableProductCoreAttributes = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "buyingMethod": S.optional(PlannableProductCoreAttributesBuyingMethodEnum),
  "costModel": S.optional(PlannableProductCoreAttributesCostModelEnum),
  "productCategory": S.optional(PlannableProductCoreAttributesProductCategoryEnum),
}),
).annotate({ identifier: "PlannableProductCoreAttributes" }) as any as S.Schema<PlannableProductCoreAttributes>;
...
export const ProductMetadata = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "plannableProductDescription": S.optional(S.String),
  "plannableTargeting": S.optional(PlannableTargeting),
  "displayName": S.optional(S.String),
  "plannableProductCoreAttributes": S.optional(PlannableProductCoreAttributes),
  "plannableProductCode": S.optional(S.String),
}),
).annotate({ identifier: "ProductMetadata" }) as any as S.Schema<ProductMetadata>;

export type ProductMetadataList = ReadonlyArray<ProductMetadata>;
export const ProductMetadataList = /*@__PURE__*/ S.Array(ProductMetadata) as any as S.Schema<ProductMetadataList>;
...
export interface RetrievePlannableProductsResponse {
  ...
  productMetadata?: ProductMetadataList;
}
export const RetrievePlannableProductsResponse = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "productMetadata": S.optional(ProductMetadataList),
}),
).annotate({ identifier: "RetrievePlannableProductsResponse" }) as any as S.Schema<RetrievePlannableProductsResponse>;

export type RetrievePlannableUserInterestsAdvertisersReachForecastProductCategoryEnum = "PLANNABLE_PRODUCT_CATEGORY_UNSPECIFIED" | "YOUTUBE" | "OPEN_AUCTION";
export const RetrievePlannableUserInterestsAdvertisersReachForecastProductCategoryEnum = /*@__PURE__*/ S.String;
...
export interface RetrievePlannableUserInterestsAdvertisersReachForecastRequest {
  ...
  productCategory?: RetrievePlannableUserInterestsAdvertisersReachForecastProductCategoryEnum | (string & {});
  /** Required. The ID of the advertiser to list plannable user interests for. */
  advertiserId: string;
}
export const RetrievePlannableUserInterestsAdvertisersReachForecastRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "productCategory": S.optional(RetrievePlannableUserInterestsAdvertisersReachForecastProductCategoryEnum.pipe(T.Query())),
  "advertiserId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/reachForecast:retrievePlannableUserInterests","baseUrl":"https://displayvideo.googleapis.com/"})),
).annotate({ identifier: "RetrievePlannableUserInterestsAdvertisersReachForecastRequest" }) as any as S.Schema<RetrievePlannableUserInterestsAdvertisersReachForecastRequest>;
...
export const UserInterest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "userInterestCategory": S.optional(S.String),
  "userInterestUserList": S.optional(S.String),
}),
).annotate({ identifier: "UserInterest" }) as any as S.Schema<UserInterest>;
...
export const PlannableUserInterest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "userInterestDisplayName": S.optional(S.String),
  "userInterestPath": S.optional(S.String),
  "userInterestType": S.optional(S.String),
  "userInterest": S.optional(UserInterest),
}),
).annotate({ identifier: "PlannableUserInterest" }) as any as S.Schema<PlannableUserInterest>;

export type PlannableUserInterestList = ReadonlyArray<PlannableUserInterest>;
export const PlannableUserInterestList = /*@__PURE__*/ S.Array(PlannableUserInterest) as any as S.Schema<PlannableUserInterestList>;
...
export interface RetrievePlannableUserInterestsResponse {
  ...
  plannableUserInterests?: PlannableUserInterestList;
}
export const RetrievePlannableUserInterestsResponse = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "plannableUserInterests": S.optional(PlannableUserInterestList),
}),
).annotate({ identifier: "RetrievePlannableUserInterestsResponse" }) as any as S.Schema<RetrievePlannableUserInterestsResponse>;
...
export const RetrievePlannableUserListsAdvertisersReachForecastRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "pageSize": S.optional(S.Number.pipe(T.Query())),
  "pageToken": S.optional(S.String.pipe(T.Query())),
  "filter": S.optional(S.String.pipe(T.Query())),
  "advertiserId": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v4/advertisers/{+advertiserId}/reachForecast:retrievePlannableUserLists","baseUrl":"https://displayvideo.googleapis.com/"})),
).annotate({ identifier: "RetrievePlannableUserListsAdvertisersReachForecastRequest" }) as any as S.Schema<RetrievePlannableUserListsAdvertisersReachForecastRequest>;

export type PlannableUserListUserListTypeEnum = "USER_LIST_TYPE_UNSPECIFIED" | "FIRST_PARTY" | "THIRD_PARTY";
export const PlannableUserListUserListTypeEnum = /*@__PURE__*/ S.String;

export type PlannableUserListPlannableStatusEnum = "PLANNABLE_STATUS_UNSPECIFIED" | "PLANNABLE" | "UNPLANNABLE";
...
export interface PlannableUserList {
  ...
  userListType?: PlannableUserListUserListTypeEnum;
  ...
  plannableStatus?: PlannableUserListPlannableStatusEnum;
}
export const PlannableUserList = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "userListType": S.optional(PlannableUserListUserListTypeEnum),
  "name": S.optional(S.String),
  "displayName": S.optional(S.String),
  "plannableStatus": S.optional(PlannableUserListPlannableStatusEnum),
}),
).annotate({ identifier: "PlannableUserList" }) as any as S.Schema<PlannableUserList>;

export type PlannableUserListList = ReadonlyArray<PlannableUserList>;
export const PlannableUserListList = /*@__PURE__*/ S.Array(PlannableUserList) as any as S.Schema<PlannableUserListList>;
...
export interface RetrievePlannableUserListsResponse {
  ...
  plannableUserLists?: PlannableUserListList;
  /** Output only. A token to retrieve the next page of results. */
  nextPageToken?: string;
}
export const RetrievePlannableUserListsResponse = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "plannableUserLists": S.optional(PlannableUserListList),
  "nextPageToken": S.optional(S.String),
}),
).annotate({ identifier: "RetrievePlannableUserListsResponse" }) as any as S.Schema<RetrievePlannableUserListsResponse>;
...
}).pipe(T.Http({"method":"POST","uri":"v4/targetingTypes/{+targetingType}/targetingOptions:search","baseUrl":"https://displayvideo.googleapis.com/"})),
...
export type UploadAdAssetRequestAdAssetTypeEnum = "AD_ASSET_TYPE_UNSPECIFIED" | "AD_ASSET_TYPE_IMAGE" | "AD_ASSET_TYPE_YOUTUBE_VIDEO";
export const UploadAdAssetRequestAdAssetTypeEnum = /*@__PURE__*/ S.String;

export type UploadAdAssetRequestSyntheticContentAttestationStatusEnum = "SYNTHETIC_CONTENT_ATTESTATION_STATUS_UNSPECIFIED" | "NOT_SYNTHETIC" | "IS_SYNTHETIC";
export const UploadAdAssetRequestSyntheticContentAttestationStatusEnum = /*@__PURE__*/ S.String;
...
export interface UploadAdAssetRequest {
  ...
  adAssetType?: UploadAdAssetRequestAdAssetTypeEnum | (string & {});
  /** Optional. Whether the asset contains synthetic content or was created using AI. */
  syntheticContentAttestationStatus?: UploadAdAssetRequestSyntheticContentAttestationStatusEnum | (string & {});
}
export const UploadAdAssetRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "filename": S.optional(S.String),
  "adAssetType": S.optional(UploadAdAssetRequestAdAssetTypeEnum),
  "syntheticContentAttestationStatus": S.optional(UploadAdAssetRequestSyntheticContentAttestationStatusEnum),
}),
).annotate({ identifier: "UploadAdAssetRequest" }) as any as S.Schema<UploadAdAssetRequest>;
...
export const UploadAdvertisersAdAssetsRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "advertiserId": S.String.pipe(T.Label()),
  "body": S.optional(UploadAdAssetRequest.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{+advertiserId}/adAssets:uploadAdAsset","baseUrl":"https://displayvideo.googleapis.com/"})),
).annotate({ identifier: "UploadAdvertisersAdAssetsRequest" }) as any as S.Schema<UploadAdvertisersAdAssetsRequest>;
...
export const UploadAdAssetResponse = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "adAsset": S.optional(AdAsset),
}),
).annotate({ identifier: "UploadAdAssetResponse" }) as any as S.Schema<UploadAdAssetResponse>;
...
}).pipe(T.Http({"method":"POST","uri":"v4/advertisers/{+advertiserId}/assets","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "partnerId": S.optional(S.String.pipe(T.Query())),
  "advertiserId": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/customBiddingAlgorithms/{+customBiddingAlgorithmId}:uploadRules","baseUrl":"https://displayvideo.googleapis.com/"})),
...
S.Struct({
  ...
  "partnerId": S.optional(S.String.pipe(T.Query())),
  "advertiserId": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v4/customBiddingAlgorithms/{+customBiddingAlgorithmId}:uploadScript","baseUrl":"https://displayvideo.googleapis.com/"})),
...
export type BulkCreateAdvertisersAdAssetsError = NotFound | Forbidden | BadRequest | Conflict | GcpOpError;
...
export type BulkListAssignedTargetingOptionsAdvertisersAdGroupsError = NotFound | Forbidden | GcpOpError;
...
export type CreateAdvertisersAdAssetsError = NotFound | Forbidden | BadRequest | Conflict | GcpOpError;
...
export type CreateAdvertisersAdGroupsYoutubeAssetTypesYoutubeAssetAssociationsError = NotFound | Forbidden | BadRequest | Conflict | GcpOpError;
...
export type CreateAdvertisersLineItemsYoutubeAssetTypesYoutubeAssetAssociationsError = NotFound | Forbidden | BadRequest | Conflict | GcpOpError;
/** Creates a new association between the identified resource and a YouTube asset. Returns the newly-created association. *Warning:* This method is only available to an informed subset of users. */
...
export type CreateFirstPartyAndPartnerAudiencesError = NotFound | Forbidden | BadRequest | Conflict | GcpOpError;
...
export type CreateInventorySourcesError = NotFound | Forbidden | BadRequest | Conflict | GcpOpError;
...
export type DeleteAdvertisersAdGroupsYoutubeAssetTypesYoutubeAssetAssociationsError = NotFound | Forbidden | BadRequest | Conflict | GcpOpError;
...
export type DeleteAdvertisersLineItemsYoutubeAssetTypesYoutubeAssetAssociationsError = NotFound | Forbidden | BadRequest | Conflict | GcpOpError;
/** Deletes an existing association between the identified resource and a YouTube asset. *Warning:* This method is only available to an informed subset of users. */
...
export type EditCustomerMatchMembersFirstPartyAndPartnerAudiencesError = NotFound | Forbidden | BadRequest | Conflict | GcpOpError;
...
export type EditInventorySourceReadWriteAccessorsInventorySourcesError = NotFound | Forbidden | BadRequest | Conflict | GcpOpError;
...
export type GenerateReachForecastAdvertisersReachForecastError = NotFound | Forbidden | BadRequest | Conflict | GcpOpError;
...
export type GetFirstPartyAndPartnerAudiencesError = NotFound | Forbidden | GcpOpError;
...
export type GetSdfuploadtasksOperationsError = NotFound | Forbidden | GcpOpError;
/** Gets the latest state of an asynchronous SDF download task operation. Clients should poll this method at intervals of 30 seconds. */
...
export type ListAdvertisersAdGroupsYoutubeAssetTypesYoutubeAssetAssociationsError = NotFound | Forbidden | GcpOpError;
...
export type ListAdvertisersLineItemsYoutubeAssetTypesYoutubeAssetAssociationsError = NotFound | Forbidden | GcpOpError;
/** Lists the YouTube asset associations linked to the given resource. */
...
export type ListFirstPartyAndPartnerAudiencesError = NotFound | Forbidden | GcpOpError;
...
export type PatchAdvertisersAdAssetsError = NotFound | Forbidden | BadRequest | Conflict | GcpOpError;
...
export const patchAdvertisersAdAssets: API.OperationMethod<
  PatchAdvertisersAdAssetsRequest,
  AdAsset,
  PatchAdvertisersAdAssetsError,
  GcpOpContext
> = /*@__PURE__*/ API.make(() => ({
...
export type PatchFirstPartyAndPartnerAudiencesError = NotFound | Forbidden | BadRequest | Conflict | GcpOpError;
...
export type PatchInventorySourcesError = NotFound | Forbidden | BadRequest | Conflict | GcpOpError;
...
export type RetrievePlannableLocationsAdvertisersReachForecastError = NotFound | Forbidden | GcpOpError;
...
export type RetrievePlannableProductsAdvertisersReachForecastError = NotFound | Forbidden | GcpOpError;
...
export type RetrievePlannableUserInterestsAdvertisersReachForecastError = NotFound | Forbidden | GcpOpError;
...
export type RetrievePlannableUserListsAdvertisersReachForecastError = NotFound | Forbidden | GcpOpError;
...
export type UploadAdvertisersAdAssetsError = NotFound | Forbidden | BadRequest | Conflict | GcpOpError;
