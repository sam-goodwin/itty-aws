...
export const Session: Schema.Schema<Session> = /*@__PURE__*/ Schema.Struct({
...
export const DualRegionQuorum: Schema.Schema<DualRegionQuorum> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "DualRegionQuorum" });
...
export const ChildLink: Schema.Schema<ChildLink> = /*@__PURE__*/ Schema.Struct({
...
export const PlanNode: Schema.Schema<PlanNode> = /*@__PURE__*/ Schema.Struct({
...
export const QueryPlan: Schema.Schema<QueryPlan> = /*@__PURE__*/ Schema.Struct({
...
export const Type: Schema.Schema<Type> = /*@__PURE__*/ Schema.suspend(() =>
  Schema.Struct({
...
export const Field: Schema.Schema<Field> = /*@__PURE__*/ Schema.suspend(() =>
  Schema.Struct({
    name: Schema.optional(Schema.String),
...
export const ResultSet: Schema.Schema<ResultSet> = /*@__PURE__*/ Schema.Struct({
...
export const Write: Schema.Schema<Write> = /*@__PURE__*/ Schema.Struct({
...
export const ReadOnly: Schema.Schema<ReadOnly> = /*@__PURE__*/ Schema.Struct({
...
export const ReadWrite: Schema.Schema<ReadWrite> = /*@__PURE__*/ Schema.Struct({
...
export const PartitionedDml: Schema.Schema<PartitionedDml> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "PartitionedDml" });
...
export const ScanData: Schema.Schema<ScanData> = /*@__PURE__*/ Schema.Struct({
...
export const Scan: Schema.Schema<Scan> = /*@__PURE__*/ Schema.Struct({
  startTime: Schema.optional(Schema.String),
...
export const Instance: Schema.Schema<Instance> = /*@__PURE__*/ Schema.Struct({
...
export const Key: Schema.Schema<Key> = /*@__PURE__*/ Schema.Struct({
...
export const Send: Schema.Schema<Send> = /*@__PURE__*/ Schema.Struct({
...
export const Ack: Schema.Schema<Ack> = /*@__PURE__*/ Schema.Struct({
  queue: Schema.optional(Schema.String),
  key: Schema.optional(Schema.Array(Schema.Unknown)),
...
export const KeyRange: Schema.Schema<KeyRange> = /*@__PURE__*/ Schema.Struct({
...
export const KeySet: Schema.Schema<KeySet> = /*@__PURE__*/ Schema.Struct({
...
export const Delete: Schema.Schema<Delete> = /*@__PURE__*/ Schema.Struct({
  table: Schema.optional(Schema.String),
...
export const Mutation: Schema.Schema<Mutation> = /*@__PURE__*/ Schema.Struct({
...
export const Backup: Schema.Schema<Backup> = /*@__PURE__*/ Schema.Struct({
...
export const Partition: Schema.Schema<Partition> = /*@__PURE__*/ Schema.Struct({
...
export const FullBackupSpec: Schema.Schema<FullBackupSpec> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "FullBackupSpec" });
...
export const ModValue: Schema.Schema<ModValue> = /*@__PURE__*/ Schema.Struct({
...
export const Mod: Schema.Schema<Mod> = /*@__PURE__*/ Schema.Struct({
...
export const Statement: Schema.Schema<Statement> = /*@__PURE__*/ Schema.Struct({
  sql: Schema.optional(Schema.String),
  params: Schema.optional(Schema.Record(Schema.String, Schema.Unknown)),
  paramTypes: Schema.optional(Schema.Record(Schema.String, Type)),
...
export const ListProjectsInstanceConfigsRequest = /*@__PURE__*/ Schema.Struct({
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
}).pipe(
...
export const GetProjectsInstanceConfigsRequest = /*@__PURE__*/ Schema.Struct({
...
export const CreateProjectsInstanceConfigsRequest = /*@__PURE__*/ Schema.Struct(
  {
    parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const DeleteProjectsInstanceConfigsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
...
export const PatchProjectsInstanceConfigsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const ListProjectsInstancesRequest = /*@__PURE__*/ Schema.Struct({
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
...
export const GetProjectsInstancesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const CreateProjectsInstancesRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const PatchProjectsInstancesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const MoveProjectsInstancesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const DeleteProjectsInstancesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "DELETE", path: "v1/{+name}" }),
  svc,
...
export const SetIamPolicyProjectsInstancesRequest = /*@__PURE__*/ Schema.Struct(
  {
    resource: Schema.String.pipe(T.HttpPath("resource")),
...
export const GetIamPolicyProjectsInstancesRequest = /*@__PURE__*/ Schema.Struct(
  {
    resource: Schema.String.pipe(T.HttpPath("resource")),
...
export const PatchProjectsInstancesBackupsRequest = /*@__PURE__*/ Schema.Struct(
  {
...
export const CopyProjectsInstancesBackupsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const GetProjectsInstancesBackupsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const ListProjectsInstancesBackupsRequest = /*@__PURE__*/ Schema.Struct({
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
...
export const GetProjectsInstancesDatabasesRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
  },
).pipe(
