...
export const UpdateParametersProjectsLocationsInstancesRequest =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({
      method: "PATCH",
      path: "v1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}:updateParameters",
      hasBody: true,
    }),
    svc,
...
export const ApplyParametersProjectsLocationsInstancesRequest =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({
      method: "POST",
      path: "v1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}:applyParameters",
      hasBody: true,
    }),
    svc,
...
export const SetTagsProjectsLocationsInstancesRequest =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({
      method: "POST",
      path: "v1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}:setTags",
      hasBody: true,
    }),
    svc,
...
export type SetTagsProjectsLocationsInstancesError = DefaultErrors;
...
export const GetTagsProjectsLocationsInstancesRequest =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({
      method: "GET",
      path: "v1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}:getTags",
    }),
    svc,
...
export type GetTagsProjectsLocationsInstancesError = DefaultErrors;
