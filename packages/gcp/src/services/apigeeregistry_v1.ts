...
export type ApiDeploymentList = ApiDeployment[];
...
export type ApiVersionList = ApiVersion[];
...
export type ApiSpecList = ApiSpec[];
...
}) as any as S.Schema<TagApiSpecRevisionRequest>;
