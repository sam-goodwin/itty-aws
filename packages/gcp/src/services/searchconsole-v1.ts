...
export const AmpIssue: Schema.Schema<AmpIssue> = /*@__PURE__*/ Schema.Struct({
...
export const WmxSite: Schema.Schema<WmxSite> = /*@__PURE__*/ Schema.Struct({
...
export const InspectUrlInspectionIndexRequest = /*@__PURE__*/ Schema.Struct({
...
export const DeleteSitesResponse: Schema.Schema<DeleteSitesResponse> =
  /*@__PURE__*/ Schema.Struct({}) as any as Schema.Schema<DeleteSitesResponse>;
...
export const AddSitesResponse: Schema.Schema<AddSitesResponse> =
  /*@__PURE__*/ Schema.Struct({}) as any as Schema.Schema<AddSitesResponse>;
...
export const QuerySearchanalyticsRequest = /*@__PURE__*/ Schema.Struct({
  siteUrl: Schema.String.pipe(T.HttpPath("siteUrl")),
