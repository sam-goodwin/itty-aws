...
export const Admin: Schema.Schema<Admin> = /*@__PURE__*/ Schema.Struct({
  role: Schema.optional(Schema.String),
...
export const AcceptAccountsInvitationsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const ListAccountsInvitationsRequest = /*@__PURE__*/ Schema.Struct({
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
...
export const DeclineAccountsInvitationsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const DeleteAccountsAdminsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
...
export const CreateAccountsAdminsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const PatchAccountsAdminsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(Admin).pipe(T.HttpBody()),
}).pipe(
...
export const ListAccountsAdminsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
}).pipe(
...
export const TransferLocationsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const DeleteLocationsAdminsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "DELETE", path: "v1/{+name}" }),
  svc,
...
export const CreateLocationsAdminsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(Admin).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1/{+parent}/admins", hasBody: true }),
...
export const PatchLocationsAdminsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(Admin).pipe(T.HttpBody()),
}).pipe(
...
export const ListLocationsAdminsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+parent}/admins" }),
  svc,
