...
export const Label: Schema.Schema<Label> = /*@__PURE__*/ Schema.Struct({
...
export const Container: Schema.Schema<Container> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const Control: Schema.Schema<Control> = /*@__PURE__*/ Schema.Struct({
  displayName: Schema.optional(Schema.String),
...
export const OrgPolicy: Schema.Schema<OrgPolicy> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const Node: Schema.Schema<Node> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const Folder: Schema.Schema<Folder> = /*@__PURE__*/ Schema.Struct({
  resourceFolder: Schema.optional(Schema.String),
  resourceFolderDisplayName: Schema.optional(Schema.String),
...
export const DiskPath: Schema.Schema<DiskPath> = /*@__PURE__*/ Schema.Struct({
...
export const Pod: Schema.Schema<Pod> = /*@__PURE__*/ Schema.Struct({
...
export const Role: Schema.Schema<Role> = /*@__PURE__*/ Schema.Struct({
...
export const Subject: Schema.Schema<Subject> = /*@__PURE__*/ Schema.Struct({
  ns: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  kind: Schema.optional(Schema.String),
...
export const NodePool: Schema.Schema<NodePool> = /*@__PURE__*/ Schema.Struct({
...
export const Contact: Schema.Schema<Contact> = /*@__PURE__*/ Schema.Struct({
  email: Schema.optional(Schema.String),
...
export const MuteInfo: Schema.Schema<MuteInfo> = /*@__PURE__*/ Schema.Struct({
...
export const PortRange: Schema.Schema<PortRange> = /*@__PURE__*/ Schema.Struct({
  min: Schema.optional(Schema.String),
  max: Schema.optional(Schema.String),
...
export const IpRule: Schema.Schema<IpRule> = /*@__PURE__*/ Schema.Struct({
...
export const Allowed: Schema.Schema<Allowed> = /*@__PURE__*/ Schema.Struct({
...
export const Denied: Schema.Schema<Denied> = /*@__PURE__*/ Schema.Struct({
  ipRules: Schema.optional(Schema.Array(IpRule)),
...
export const IpRules: Schema.Schema<IpRules> = /*@__PURE__*/ Schema.Struct({
...
export const Requests: Schema.Schema<Requests> = /*@__PURE__*/ Schema.Struct({
...
export const Attack: Schema.Schema<Attack> = /*@__PURE__*/ Schema.Struct({
...
export const Access: Schema.Schema<Access> = /*@__PURE__*/ Schema.Struct({
...
export const Disk: Schema.Schema<Disk> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const Reference: Schema.Schema<Reference> = /*@__PURE__*/ Schema.Struct({
  source: Schema.optional(Schema.String),
  uri: Schema.optional(Schema.String),
...
export const Cwe: Schema.Schema<Cwe> = /*@__PURE__*/ Schema.Struct({
...
export const Package: Schema.Schema<Package> = /*@__PURE__*/ Schema.Struct({
...
export const Cvssv3: Schema.Schema<Cvssv3> = /*@__PURE__*/ Schema.Struct({
...
export const Cve: Schema.Schema<Cve> = /*@__PURE__*/ Schema.Struct({
...
export const Pipeline: Schema.Schema<Pipeline> = /*@__PURE__*/ Schema.Struct({
  displayName: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
...
export const Dataset: Schema.Schema<Dataset> = /*@__PURE__*/ Schema.Struct({
  displayName: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  source: Schema.optional(Schema.String),
...
export const VertexAi: Schema.Schema<VertexAi> = /*@__PURE__*/ Schema.Struct({
...
export const Job: Schema.Schema<Job> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const Detection: Schema.Schema<Detection> = /*@__PURE__*/ Schema.Struct({
...
export const Indicator: Schema.Schema<Indicator> = /*@__PURE__*/ Schema.Struct({
...
export const Framework: Schema.Schema<Framework> = /*@__PURE__*/ Schema.Struct({
  displayName: Schema.optional(Schema.String),
...
export const Database: Schema.Schema<Database> = /*@__PURE__*/ Schema.Struct({
...
export const Notebook: Schema.Schema<Notebook> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
  service: Schema.optional(Schema.String),
...
export const Process: Schema.Schema<Process> = /*@__PURE__*/ Schema.Struct({
...
export const Secret: Schema.Schema<Secret> = /*@__PURE__*/ Schema.Struct({
  type: Schema.optional(Schema.String),
...
export const InfoType: Schema.Schema<InfoType> = /*@__PURE__*/ Schema.Struct({
  version: Schema.optional(Schema.String),
...
export const AiModel: Schema.Schema<AiModel> = /*@__PURE__*/ Schema.Struct({
  location: Schema.optional(Schema.String),
...
export const Network: Schema.Schema<Network> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const Finding: Schema.Schema<Finding> = /*@__PURE__*/ Schema.Struct({
...
export const Position: Schema.Schema<Position> = /*@__PURE__*/ Schema.Struct({
...
export const IamPolicy: Schema.Schema<IamPolicy> = /*@__PURE__*/ Schema.Struct({
...
export const Asset: Schema.Schema<Asset> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
  securityMarks: Schema.optional(SecurityMarks),
...
export const PatchOrganizationsMuteConfigsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
    updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
...
export const GetOrganizationsMuteConfigsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const ListOrganizationsMuteConfigsRequest = /*@__PURE__*/ Schema.Struct({
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
}).pipe(
...
export const ListOrganizationsAttackPathsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const GetOrganizationsSourcesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const PatchOrganizationsSourcesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
...
export const CreateOrganizationsSourcesRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(Source).pipe(T.HttpBody()),
}).pipe(
...
export const ListOrganizationsSourcesRequest = /*@__PURE__*/ Schema.Struct({
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
}).pipe(
...
export const GroupOrganizationsAssetsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const ListOrganizationsAssetsRequest = /*@__PURE__*/ Schema.Struct({
  readTime: Schema.optional(Schema.String).pipe(T.HttpQuery("readTime")),
  fieldMask: Schema.optional(Schema.String).pipe(T.HttpQuery("fieldMask")),
  compareDuration: Schema.optional(Schema.String).pipe(
    T.HttpQuery("compareDuration"),
...
export const DeleteOrganizationsOperationsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
  },
).pipe(
...
export const CancelOrganizationsOperationsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
  },
).pipe(
...
export const GetOrganizationsOperationsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const ListOrganizationsOperationsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
...
export const GetOrganizationsSimulationsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const BulkMuteOrganizationsFindingsRequest = /*@__PURE__*/ Schema.Struct(
  {
    parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const BulkMuteFoldersFindingsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(BulkMuteFindingsRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({
...
export const ListFoldersSourcesRequest = /*@__PURE__*/ Schema.Struct({
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
}).pipe(
...
export const GroupFoldersSourcesFindingsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GroupFindingsRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({
...
export const ListFoldersSourcesFindingsRequest = /*@__PURE__*/ Schema.Struct({
  orderBy: Schema.optional(Schema.String).pipe(T.HttpQuery("orderBy")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
...
export const SetMuteFoldersSourcesFindingsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
    body: Schema.optional(SetMuteRequest).pipe(T.HttpBody()),
  },
...
export const PatchFoldersSourcesFindingsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(Finding).pipe(T.HttpBody()),
}).pipe(
...
export const GroupFoldersAssetsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GroupAssetsRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1/{+parent}/assets:group", hasBody: true }),
...
export const ListFoldersAssetsRequest = /*@__PURE__*/ Schema.Struct({
  orderBy: Schema.optional(Schema.String).pipe(T.HttpQuery("orderBy")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
...
export const GetFoldersNotificationConfigsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
  },
).pipe(
...
export const DeleteFoldersMuteConfigsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "DELETE", path: "v1/{+name}" }),
  svc,
...
export const GetFoldersMuteConfigsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const PatchFoldersMuteConfigsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(GoogleCloudSecuritycenterV1MuteConfig).pipe(
    T.HttpBody(),
...
export const CreateFoldersMuteConfigsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  muteConfigId: Schema.optional(Schema.String).pipe(
    T.HttpQuery("muteConfigId"),
  ),
...
export const ListFoldersMuteConfigsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
}).pipe(
...
export const GetFoldersBigQueryExportsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const PatchFoldersBigQueryExportsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(GoogleCloudSecuritycenterV1BigQueryExport).pipe(
    T.HttpBody(),
...
export const DeleteFoldersBigQueryExportsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "DELETE", path: "v1/{+name}" }),
  svc,
...
export const CreateFoldersBigQueryExportsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  bigQueryExportId: Schema.optional(Schema.String).pipe(
    T.HttpQuery("bigQueryExportId"),
  ),
...
export const ListFoldersBigQueryExportsRequest = /*@__PURE__*/ Schema.Struct({
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
}).pipe(
...
export const PatchProjectsMuteConfigsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(GoogleCloudSecuritycenterV1MuteConfig).pipe(
    T.HttpBody(),
...
export const GetProjectsMuteConfigsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const DeleteProjectsMuteConfigsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "DELETE", path: "v1/{+name}" }),
  svc,
...
export const CreateProjectsMuteConfigsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  muteConfigId: Schema.optional(Schema.String).pipe(
    T.HttpQuery("muteConfigId"),
  ),
...
export const ListProjectsMuteConfigsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
}).pipe(
...
export const GetProjectsBigQueryExportsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const PatchProjectsBigQueryExportsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(GoogleCloudSecuritycenterV1BigQueryExport).pipe(
    T.HttpBody(),
...
export const DeleteProjectsBigQueryExportsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
  },
).pipe(
...
export const CreateProjectsBigQueryExportsRequest = /*@__PURE__*/ Schema.Struct(
  {
    parent: Schema.String.pipe(T.HttpPath("parent")),
    bigQueryExportId: Schema.optional(Schema.String).pipe(
      T.HttpQuery("bigQueryExportId"),
...
export const ListProjectsBigQueryExportsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
}).pipe(
...
export const BulkMuteProjectsFindingsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(BulkMuteFindingsRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({
...
export const ListProjectsSourcesRequest = /*@__PURE__*/ Schema.Struct({
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
}).pipe(
...
export const GroupProjectsSourcesFindingsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GroupFindingsRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({
...
export const ListProjectsSourcesFindingsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  orderBy: Schema.optional(Schema.String).pipe(T.HttpQuery("orderBy")),
...
export const PatchProjectsSourcesFindingsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(Finding).pipe(T.HttpBody()),
}).pipe(
...
export const GroupProjectsAssetsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GroupAssetsRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1/{+parent}/assets:group", hasBody: true }),
...
export const ListProjectsAssetsRequest = /*@__PURE__*/ Schema.Struct({
  readTime: Schema.optional(Schema.String).pipe(T.HttpQuery("readTime")),
  fieldMask: Schema.optional(Schema.String).pipe(T.HttpQuery("fieldMask")),
  compareDuration: Schema.optional(Schema.String).pipe(
    T.HttpQuery("compareDuration"),
