...
export const NestedParameter: Schema.Schema<NestedParameter> = /*@__PURE__*/ /*#__PURE__*/ Schema.suspend(() => Schema.Struct({
...
export const ActivityEventsStatus: Schema.Schema<ActivityEventsStatus> = /*@__PURE__*/ /*#__PURE__*/ Schema.suspend(() => Schema.Struct({
...
export const ActivityNetworkInfo: Schema.Schema<ActivityNetworkInfo> = /*@__PURE__*/ /*#__PURE__*/ Schema.suspend(() => Schema.Struct({
...
export const FieldValueTextListValue: Schema.Schema<FieldValueTextListValue> = /*@__PURE__*/ /*#__PURE__*/ Schema.suspend(() => Schema.Struct({
...
export const FieldValueSelectionValue: Schema.Schema<FieldValueSelectionValue> = /*@__PURE__*/ /*#__PURE__*/ Schema.suspend(() => Schema.Struct({
...
export const FieldValueSelectionListValue: Schema.Schema<FieldValueSelectionListValue> = /*@__PURE__*/ /*#__PURE__*/ Schema.suspend(() => Schema.Struct({
...
export const FieldValueUserValue: Schema.Schema<FieldValueUserValue> = /*@__PURE__*/ /*#__PURE__*/ Schema.suspend(() => Schema.Struct({
...
export const FieldValueUserListValue: Schema.Schema<FieldValueUserListValue> = /*@__PURE__*/ /*#__PURE__*/ Schema.suspend(() => Schema.Struct({
...
export const Admin_Date: Schema.Schema<Admin_Date> = /*@__PURE__*/ /*#__PURE__*/ Schema.suspend(() => Schema.Struct({
...
export const Reason: Schema.Schema<Reason> = /*@__PURE__*/ /*#__PURE__*/ Schema.suspend(() => Schema.Struct({
...
export const FieldValue: Schema.Schema<FieldValue> = /*@__PURE__*/ /*#__PURE__*/ Schema.suspend(() => Schema.Struct({
  id: Schema.optional(Schema.String),
  displayName: Schema.optional(Schema.String),
...
export const AppliedLabel: Schema.Schema<AppliedLabel> = /*@__PURE__*/ /*#__PURE__*/ Schema.suspend(() => Schema.Struct({
  id: Schema.optional(Schema.String),
...
export const ResourceDetails: Schema.Schema<ResourceDetails> = /*@__PURE__*/ /*#__PURE__*/ Schema.suspend(() => Schema.Struct({
  id: Schema.optional(Schema.String),
  title: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
...
export const Activity: Schema.Schema<Activity> = /*@__PURE__*/ /*#__PURE__*/ Schema.suspend(() => Schema.Struct({
...
export const Activities: Schema.Schema<Activities> = /*@__PURE__*/ /*#__PURE__*/ Schema.suspend(() => Schema.Struct({
  kind: Schema.optional(Schema.String),
  etag: Schema.optional(Schema.String),
...
export const Channel: Schema.Schema<Channel> = /*@__PURE__*/ /*#__PURE__*/ Schema.suspend(() => Schema.Struct({
  id: Schema.optional(Schema.String),
...
export const UsageReport: Schema.Schema<UsageReport> = /*@__PURE__*/ /*#__PURE__*/ Schema.suspend(() => Schema.Struct({
  kind: Schema.optional(Schema.String),
...
export const UsageReports: Schema.Schema<UsageReports> = /*@__PURE__*/ /*#__PURE__*/ Schema.suspend(() => Schema.Struct({
  kind: Schema.optional(Schema.String),
  etag: Schema.optional(Schema.String),
...
export const listActivities: API.PaginatedOperationMethod<ListActivitiesRequest, ListActivitiesResponse, ListActivitiesError, Credentials | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.makePaginated(() => ({
...
export const watchActivities: API.OperationMethod<WatchActivitiesRequest, WatchActivitiesResponse, WatchActivitiesError, Credentials | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
...
export const StopChannelsResponse: Schema.Schema<StopChannelsResponse> = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({}) as any as Schema.Schema<StopChannelsResponse>;

export type StopChannelsError = DefaultErrors;

/** Stop watching resources through this channel. */
export const stopChannels: API.OperationMethod<StopChannelsRequest, StopChannelsResponse, StopChannelsError, Credentials | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
...
export const GetCustomerUsageReportsRequest = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export const GetCustomerUsageReportsResponse = /*@__PURE__*/ /*#__PURE__*/ UsageReports;

export type GetCustomerUsageReportsError = DefaultErrors;

/** Retrieves a report which is a collection of properties and statistics for a specific customer's account. For more information, see the Customers Usage Report guide. For more information about the customer report's parameters, see the Customers Usage parameters reference guides. */
export const getCustomerUsageReports: API.PaginatedOperationMethod<GetCustomerUsageReportsRequest, GetCustomerUsageReportsResponse, GetCustomerUsageReportsError, Credentials | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.makePaginated(() => ({
...
export const GetEntityUsageReportsRequest = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export const GetEntityUsageReportsResponse = /*@__PURE__*/ /*#__PURE__*/ UsageReports;

export type GetEntityUsageReportsError = DefaultErrors;

/** Retrieves a report which is a collection of properties and statistics for entities used by users within the account. For more information, see the Entities Usage Report guide. For more information about the entities report's parameters, see the Entities Usage parameters reference guides. */
export const getEntityUsageReports: API.PaginatedOperationMethod<GetEntityUsageReportsRequest, GetEntityUsageReportsResponse, GetEntityUsageReportsError, Credentials | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.makePaginated(() => ({
...
export const GetUserUsageReportRequest = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  userKey: Schema.String.pipe(T.HttpPath("userKey")),
  date: Schema.String.pipe(T.HttpPath("date")),
  customerId: Schema.optional(Schema.String).pipe(T.HttpQuery("customerId")),
  filters: Schema.optional(Schema.String).pipe(T.HttpQuery("filters")),
...
export const GetUserUsageReportResponse = /*@__PURE__*/ /*#__PURE__*/ UsageReports;

export type GetUserUsageReportError = DefaultErrors;

/** Retrieves a report which is a collection of properties and statistics for a set of users with the account. For more information, see the User Usage Report guide. For more information about the user report's parameters, see the Users Usage parameters reference guides. */
export const getUserUsageReport: API.PaginatedOperationMethod<GetUserUsageReportRequest, GetUserUsageReportResponse, GetUserUsageReportError, Credentials | HttpClient.HttpClient> = /*@__PURE__*/ /*#__PURE__*/ API.makePaginated(() => ({
