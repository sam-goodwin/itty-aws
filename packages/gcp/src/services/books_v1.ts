...
export interface AddVolumeMylibraryBookshelvesRequest {
  ...
  reason?: AddVolumeMylibraryBookshelvesReasonEnum;
  /** ID of volume to add. */
  volumeId: string;
...
export const DictlayerdataDictWordsItemSensesItemSynonymsItemSource =
  /*@__PURE__*/ S.suspend(() =>
    ...
    identifier: "DictlayerdataDictWordsItemSensesItemSynonymsItemSource",
  }) as any as S.Schema<DictlayerdataDictWordsItemSensesItemSynonymsItemSource>;
...
export const DictlayerdataDictWordsItemSensesItemDefinitionsItemExamplesItemSource =
  ...
  }) as any as S.Schema<DictlayerdataDictWordsItemSensesItemDefinitionsItemExamplesItemSource>;
...
export const DictlayerdataDictWordsItemSensesItemSource =
  /*@__PURE__*/ S.suspend(() =>
    ...
    identifier: "DictlayerdataDictWordsItemSensesItemSource",
  }) as any as S.Schema<DictlayerdataDictWordsItemSensesItemSource>;
...
export const DictlayerdataDictWordsItemDerivativesItemSource =
  /*@__PURE__*/ S.suspend(() =>
    ...
    identifier: "DictlayerdataDictWordsItemDerivativesItemSource",
  }) as any as S.Schema<DictlayerdataDictWordsItemDerivativesItemSource>;
...
export type DictlayerdataDictWordsItemList = DictlayerdataDictWordsItem[];
...
export interface GetPersonalizedstreamRequest {
  ...
  maxAllowedMaturityRating?: GetPersonalizedstreamMaxAllowedMaturityRatingEnum;
}
...
export type VolumeSaleInfoOffersItemList = VolumeSaleInfoOffersItem[];
...
export type VolumeLayerInfoLayersItemList = VolumeLayerInfoLayersItem[];
...
export type DiscoveryclustersClustersItemList = DiscoveryclustersClustersItem[];
...
export type OffersItemsItemItemsItemList = OffersItemsItemItemsItem[];
...
export type OffersItemsItemList = OffersItemsItem[];
...
export type SeriesSeriesItemList = SeriesSeriesItem[];
...
export const UsersettingsNotificationMoreFromAuthors = /*@__PURE__*/ S.suspend(
  ...
  identifier: "UsersettingsNotificationMoreFromAuthors",
}) as any as S.Schema<UsersettingsNotificationMoreFromAuthors>;
...
export const UsersettingsNotificationRewardExpirations =
  /*@__PURE__*/ S.suspend(() =>
    ...
    identifier: "UsersettingsNotificationRewardExpirations",
  }) as any as S.Schema<UsersettingsNotificationRewardExpirations>;
...
export interface GetVolumesRequest {
  ...
  projection?: GetVolumesProjectionEnum;
...
export type BookshelfList = Bookshelf[];
...
export type CategoryItemsItemList = CategoryItemsItem[];
...
export interface ListCategoryVolumesOnboardingRequest {
  ...
  maxAllowedMaturityRating?: ListCategoryVolumesOnboardingMaxAllowedMaturityRatingEnum;
  /** Number of maximum results per page to be included in the response. */
  pageSize?: number;
  /** ISO-639-1 language and ISO-3166-1 country code. Default is en-US if unset. */
  locale?: string;
...
export type LayersummaryList = Layersummary[];
...
export type GeoAnnotationdataList = GeoAnnotationdata[];
...
export type VolumeannotationList = Volumeannotation[];
...
export interface ListMylibraryBookshelvesVolumesRequest {
  ...
  showPreorders?: boolean;
  /** Restrict information returned to a set of selected fields. */
  projection?: ListMylibraryBookshelvesVolumesProjectionEnum;
...
export type MetadataItemsItemList = MetadataItemsItem[];
...
export interface ListVolumesRequest {
  ...
  printType?: ListVolumesPrintTypeEnum;
  /** Restrict results to books with this language code. */
  langRestrict?: string;
  /** Set to true to show books available for preorder. Defaults to false. */
  showPreorders?: boolean;
  /** Filter search results. */
  filter?: ListVolumesFilterEnum;
  /** Sort search results. */
  orderBy?: ListVolumesOrderByEnum;
  /** Restrict search to this user's library. */
  libraryRestrict?: ListVolumesLibraryRestrictEnum;
  /** Full-text search query string. */
  q: string;
  /** Restrict to volumes by download availability. */
  download?: ListVolumesDownloadEnum;
  /** String to identify the originator of this request. */
  source?: string;
  /** Restrict information returned to a set of selected fields. */
  projection?: ListVolumesProjectionEnum;
  /** Maximum number of results to return. */
  maxResults?: number;
  /** The maximum allowed maturity rating of returned recommendations. Books with a higher maturity rating are filtered out. */
  maxAllowedMaturityRating?: ListVolumesMaxAllowedMaturityRatingEnum;
...
export interface ListVolumesAssociatedRequest {
  /** Association type. */
  association?: ListVolumesAssociatedAssociationEnum;
  /** ID of the source volume. */
  volumeId: string;
  /** The maximum allowed maturity rating of returned recommendations. Books with a higher maturity rating are filtered out. */
  maxAllowedMaturityRating?: ListVolumesAssociatedMaxAllowedMaturityRatingEnum;
  /** ISO-639-1 language and ISO-3166-1 country code. Ex: 'en_US'. Used for generating recommendations. */
  locale?: string;
  /** String to identify the originator of this request. */
  source?: string;
...
export interface ListVolumesRecommendedRequest {
  /** The maximum allowed maturity rating of returned recommendations. Books with a higher maturity rating are filtered out. */
  maxAllowedMaturityRating?: ListVolumesRecommendedMaxAllowedMaturityRatingEnum;
  /** ISO-639-1 language and ISO-3166-1 country code. Ex: 'en_US'. Used for generating recommendations. */
  locale?: string;
  /** String to identify the originator of this request. */
  source?: string;
...
export type ListVolumesUseruploadedProcessingStateEnumList =
...
export interface RateVolumesRecommendedRequest {
  ...
  rating: RateVolumesRecommendedRatingEnum;
  /** String to identify the originator of this request. */
  source?: string;
}
...
export type DownloadAccessRestrictionList = DownloadAccessRestriction[];
...
export interface RemoveVolumeMylibraryBookshelvesRequest {
  ...
  reason?: RemoveVolumeMylibraryBookshelvesReasonEnum;
...
export interface RequestAccessMyconfigRequest {
  ...
  licenseTypes?: RequestAccessMyconfigLicenseTypesEnum;
...
export interface SetPositionMylibraryReadingpositionsRequest {
  ...
  action?: SetPositionMylibraryReadingpositionsActionEnum;
...
export type AnnotationsSummaryLayersItemList = AnnotationsSummaryLayersItem[];
