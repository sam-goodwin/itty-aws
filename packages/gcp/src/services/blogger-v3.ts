...
export const PageList: Schema.Schema<PageList> = /*@__PURE__*/ Schema.Struct({
...
export const Blog: Schema.Schema<Blog> = /*@__PURE__*/ Schema.Struct({
  status: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  kind: Schema.optional(Schema.String),
  id: Schema.optional(Schema.String),
...
export const Pageviews: Schema.Schema<Pageviews> = /*@__PURE__*/ Schema.Struct({
  kind: Schema.optional(Schema.String),
  blogId: Schema.optional(Schema.String),
...
export const BlogList: Schema.Schema<BlogList> = /*@__PURE__*/ Schema.Struct({
...
export const PostList: Schema.Schema<PostList> = /*@__PURE__*/ Schema.Struct({
  etag: Schema.optional(Schema.String),
  nextPageToken: Schema.optional(Schema.String),
  prevPageToken: Schema.optional(Schema.String),
  kind: Schema.optional(Schema.String),
...
export const GetPostUserInfosRequest = /*@__PURE__*/ Schema.Struct({
...
export const ListPostUserInfosRequest = /*@__PURE__*/ Schema.Struct({
  userId: Schema.String.pipe(T.HttpPath("userId")),
...
export const DeletePostsResponse: Schema.Schema<DeletePostsResponse> =
  /*@__PURE__*/ Schema.Struct({}) as any as Schema.Schema<DeletePostsResponse>;
...
export const GetBlogUserInfosRequest = /*@__PURE__*/ Schema.Struct({
  blogId: Schema.String.pipe(T.HttpPath("blogId")),
  userId: Schema.String.pipe(T.HttpPath("userId")),
...
export const DeletePagesResponse: Schema.Schema<DeletePagesResponse> =
  /*@__PURE__*/ Schema.Struct({}) as any as Schema.Schema<DeletePagesResponse>;
...
export const ListByBlogCommentsRequest = /*@__PURE__*/ Schema.Struct({
  blogId: Schema.String.pipe(T.HttpPath("blogId")),
  maxResults: Schema.optional(Schema.Number).pipe(T.HttpQuery("maxResults")),
  fetchBodies: Schema.optional(Schema.Boolean).pipe(T.HttpQuery("fetchBodies")),
  startDate: Schema.optional(Schema.String).pipe(T.HttpQuery("startDate")),
...
export const RemoveContentCommentsRequest = /*@__PURE__*/ Schema.Struct({
  blogId: Schema.String.pipe(T.HttpPath("blogId")),
