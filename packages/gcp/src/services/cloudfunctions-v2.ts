...
export const Runtime: Schema.Schema<Runtime> = /*@__PURE__*/ Schema.Struct({
...
export const GetProjectsLocationsFunctionsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
...
export const ListProjectsLocationsRuntimesRequest = /*@__PURE__*/ Schema.Struct(
  {
    filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
    parent: Schema.String.pipe(T.HttpPath("parent")),
  },
