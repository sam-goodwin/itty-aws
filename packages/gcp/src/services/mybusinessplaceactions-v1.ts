...
export const ListPlaceActionTypeMetadataRequest = /*@__PURE__*/ Schema.Struct({
...
export const ListLocationsPlaceActionLinksRequest = /*@__PURE__*/ Schema.Struct(
  {
...
export const GetLocationsPlaceActionLinksRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
