...
export const Saas: Schema.Schema<Saas> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const Tenant: Schema.Schema<Tenant> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const ToMapping: Schema.Schema<ToMapping> = /*@__PURE__*/ Schema.Struct({
  dependency: Schema.optional(Schema.String),
...
export const UnitKind: Schema.Schema<UnitKind> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const Unit: Schema.Schema<Unit> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
  unitKind: Schema.optional(Schema.String),
...
export const Provision: Schema.Schema<Provision> = /*@__PURE__*/ Schema.Struct({
  release: Schema.optional(Schema.String),
  inputVariables: Schema.optional(Schema.Array(UnitVariable)),
...
export const Upgrade: Schema.Schema<Upgrade> = /*@__PURE__*/ Schema.Struct({
  release: Schema.optional(Schema.String),
  inputVariables: Schema.optional(Schema.Array(UnitVariable)),
...
export const Deprovision: Schema.Schema<Deprovision> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "Deprovision" });
...
export const Blueprint: Schema.Schema<Blueprint> = /*@__PURE__*/ Schema.Struct({
...
export const Aggregate: Schema.Schema<Aggregate> = /*@__PURE__*/ Schema.Struct({
...
export const ListProjectsLocationsSaasRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetProjectsLocationsSaasRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const CreateProjectsLocationsSaasRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const PatchProjectsLocationsSaasRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  validateOnly: Schema.optional(Schema.Boolean).pipe(
    T.HttpQuery("validateOnly"),
  ),
...
export const DeleteProjectsLocationsSaasRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const ListProjectsLocationsTenantsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
...
export const GetProjectsLocationsTenantsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const PatchProjectsLocationsTenantsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
    validateOnly: Schema.optional(Schema.Boolean).pipe(
      T.HttpQuery("validateOnly"),
...
export const GetProjectsLocationsUnitKindsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
  },
).pipe(
...
export const ListProjectsLocationsUnitsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
...
export const GetProjectsLocationsUnitsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const CreateProjectsLocationsUnitsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const PatchProjectsLocationsUnitsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  validateOnly: Schema.optional(Schema.Boolean).pipe(
    T.HttpQuery("validateOnly"),
  ),
...
export const DeleteProjectsLocationsUnitsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  etag: Schema.optional(Schema.String).pipe(T.HttpQuery("etag")),
  validateOnly: Schema.optional(Schema.Boolean).pipe(
    T.HttpQuery("validateOnly"),
...
export const ListProjectsLocationsReleasesRequest = /*@__PURE__*/ Schema.Struct(
  {
    parent: Schema.String.pipe(T.HttpPath("parent")),
    pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
    pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
...
export const GetProjectsLocationsReleasesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const ListProjectsLocationsRolloutsRequest = /*@__PURE__*/ Schema.Struct(
  {
    parent: Schema.String.pipe(T.HttpPath("parent")),
    pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
    pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
...
export const GetProjectsLocationsRolloutsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
