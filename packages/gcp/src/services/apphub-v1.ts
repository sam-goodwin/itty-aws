...
export const Scope: Schema.Schema<Scope> = /*@__PURE__*/ Schema.Struct({
  type: Schema.optional(Schema.String),
...
export const Boundary: Schema.Schema<Boundary> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const Workload: Schema.Schema<Workload> = /*@__PURE__*/ Schema.Struct({
  workloadProperties: Schema.optional(WorkloadProperties),
...
export const GetBoundaryProjectsLocationsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
