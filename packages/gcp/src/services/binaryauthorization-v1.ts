...
export const SlsaCheck: Schema.Schema<SlsaCheck> = /*@__PURE__*/ Schema.Struct({
...
export const Check: Schema.Schema<Check> = /*@__PURE__*/ Schema.Struct({
...
export const CheckSet: Schema.Schema<CheckSet> = /*@__PURE__*/ Schema.Struct({
  displayName: Schema.optional(Schema.String),
  imageAllowlist: Schema.optional(ImageAllowlist),
...
export const GkePolicy: Schema.Schema<GkePolicy> = /*@__PURE__*/ Schema.Struct({
  imageAllowlist: Schema.optional(ImageAllowlist),
...
export const PodResult: Schema.Schema<PodResult> = /*@__PURE__*/ Schema.Struct({
...
export const Attestor: Schema.Schema<Attestor> = /*@__PURE__*/ Schema.Struct({
  etag: Schema.optional(Schema.String),
  updateTime: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  description: Schema.optional(Schema.String),
...
export const GetPolicyProjectsRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetPolicyProjectsResponse = /*@__PURE__*/ Policy;
...
export const UpdatePolicyProjectsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const UpdatePolicyProjectsResponse = /*@__PURE__*/ Policy;
...
export const UpdateProjectsAttestorsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const UpdateProjectsAttestorsResponse = /*@__PURE__*/ Attestor;
...
export const ListProjectsAttestorsRequest = /*@__PURE__*/ Schema.Struct({
...
export const ListProjectsAttestorsResponse =
  /*@__PURE__*/ ListAttestorsResponse;
...
export const GetIamPolicyProjectsAttestorsRequest = /*@__PURE__*/ Schema.Struct(
  {
...
export const GetIamPolicyProjectsAttestorsResponse = /*@__PURE__*/ IamPolicy;
...
export const SetIamPolicyProjectsAttestorsRequest = /*@__PURE__*/ Schema.Struct(
  {
    resource: Schema.String.pipe(T.HttpPath("resource")),
...
export const SetIamPolicyProjectsAttestorsResponse = /*@__PURE__*/ IamPolicy;
...
export const GetProjectsAttestorsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const GetProjectsAttestorsResponse = /*@__PURE__*/ Attestor;
...
export const ValidateAttestationOccurrenceProjectsAttestorsResponse =
  /*@__PURE__*/ ValidateAttestationOccurrenceResponse;
...
export const CreateProjectsAttestorsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const CreateProjectsAttestorsResponse = /*@__PURE__*/ Attestor;
...
export const DeleteProjectsAttestorsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
...
export const DeleteProjectsAttestorsResponse = /*@__PURE__*/ Empty;
...
export const SetIamPolicyProjectsPolicyRequest = /*@__PURE__*/ Schema.Struct({
  resource: Schema.String.pipe(T.HttpPath("resource")),
  body: Schema.optional(SetIamPolicyRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({
...
export const SetIamPolicyProjectsPolicyResponse = /*@__PURE__*/ IamPolicy;
...
export const GetIamPolicyProjectsPolicyRequest = /*@__PURE__*/ Schema.Struct({
  "options.requestedPolicyVersion": Schema.optional(Schema.Number).pipe(
    T.HttpQuery("options.requestedPolicyVersion"),
  ),
  resource: Schema.String.pipe(T.HttpPath("resource")),
...
export const GetIamPolicyProjectsPolicyResponse = /*@__PURE__*/ IamPolicy;
...
export const EvaluateProjectsPlatformsGkePoliciesResponse =
  /*@__PURE__*/ EvaluateGkePolicyResponse;
...
export const DeleteProjectsPlatformsPoliciesResponse = /*@__PURE__*/ Empty;
...
export const ListProjectsPlatformsPoliciesRequest = /*@__PURE__*/ Schema.Struct(
  {
    parent: Schema.String.pipe(T.HttpPath("parent")),
    pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
    pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
...
export const ListProjectsPlatformsPoliciesResponse =
  /*@__PURE__*/ ListPlatformPoliciesResponse;
...
export const GetProjectsPlatformsPoliciesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const GetPolicySystempolicyRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const GetPolicySystempolicyResponse = /*@__PURE__*/ Policy;
