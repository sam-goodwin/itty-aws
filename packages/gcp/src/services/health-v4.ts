...
export const Floors: Schema.Schema<Floors> = /*@__PURE__*/ Schema.Struct({
  interval: Schema.optional(ObservationTimeInterval),
...
export const Steps: Schema.Schema<Steps> = /*@__PURE__*/ Schema.Struct({
  interval: Schema.optional(ObservationTimeInterval),
  count: Schema.optional(Schema.String),
...
export const HeartRate: Schema.Schema<HeartRate> = /*@__PURE__*/ Schema.Struct({
...
export const BodyFat: Schema.Schema<BodyFat> = /*@__PURE__*/ Schema.Struct({
  sampleTime: Schema.optional(ObservationSampleTime),
...
export const Altitude: Schema.Schema<Altitude> = /*@__PURE__*/ Schema.Struct({
  interval: Schema.optional(ObservationTimeInterval),
...
export const VO2Max: Schema.Schema<VO2Max> = /*@__PURE__*/ Schema.Struct({
  sampleTime: Schema.optional(ObservationSampleTime),
  vo2Max: Schema.optional(Schema.Number),
...
export const Sleep: Schema.Schema<Sleep> = /*@__PURE__*/ Schema.Struct({
  type: Schema.optional(Schema.String),
...
export const Exercise: Schema.Schema<Exercise> = /*@__PURE__*/ Schema.Struct({
...
export const RunVO2Max: Schema.Schema<RunVO2Max> = /*@__PURE__*/ Schema.Struct({
  sampleTime: Schema.optional(ObservationSampleTime),
  runVo2Max: Schema.optional(Schema.Number),
...
export const GetSettingsUsersRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetIdentityUsersRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v4/{+name}" }),
  svc,
...
export const UpdateSettingsUsersRequest = /*@__PURE__*/ Schema.Struct({
...
export const UpdateProfileUsersRequest = /*@__PURE__*/ Schema.Struct({
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const ListUsersDataTypesDataPointsRequest = /*@__PURE__*/ Schema.Struct({
...
export const PatchUsersDataTypesDataPointsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
    body: Schema.optional(DataPoint).pipe(T.HttpBody()),
  },
