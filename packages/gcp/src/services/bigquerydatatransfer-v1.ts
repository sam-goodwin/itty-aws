...
export const ManualSchedule: Schema.Schema<ManualSchedule> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "ManualSchedule" });
...
export const EnrollDataSourcesProjectsRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetProjectsDataSourcesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
...
export const ListProjectsDataSourcesRequest = /*@__PURE__*/ Schema.Struct({
...
export const DeleteProjectsTransferConfigsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
  },
).pipe(
...
export const GetProjectsTransferConfigsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const PatchProjectsTransferConfigsRequest = /*@__PURE__*/ Schema.Struct({
  authorizationCode: Schema.optional(Schema.String).pipe(
    T.HttpQuery("authorizationCode"),
  ),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
...
export const ListProjectsTransferConfigsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  dataSourceIds: Schema.optional(Schema.Array(Schema.String)).pipe(
    T.HttpQuery("dataSourceIds"),
...
export const CreateProjectsTransferConfigsRequest = /*@__PURE__*/ Schema.Struct(
  {
    authorizationCode: Schema.optional(Schema.String).pipe(
      T.HttpQuery("authorizationCode"),
    ),
