...
export const WriteFile: Schema.Schema<WriteFile> = /*@__PURE__*/ Schema.Struct({
...
export const DeleteFile: Schema.Schema<DeleteFile> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "DeleteFile" });
...
export const Workspace: Schema.Schema<Workspace> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
  createTime: Schema.optional(Schema.String),
  dataEncryptionState: Schema.optional(DataEncryptionState),
  internalMetadata: Schema.optional(Schema.String),
...
export const MoveFileResponse: Schema.Schema<MoveFileResponse> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "MoveFileResponse" });
...
export const WriteFileResponse: Schema.Schema<WriteFileResponse> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "WriteFileResponse" });
...
export const Relation: Schema.Schema<Relation> = /*@__PURE__*/ Schema.Struct({
...
export const Assertion: Schema.Schema<Assertion> = /*@__PURE__*/ Schema.Struct({
  dependencyTargets: Schema.optional(Schema.Array(Target)),
...
export const SimpleLoadMode: Schema.Schema<SimpleLoadMode> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "SimpleLoadMode" });
...
export const Interval: Schema.Schema<Interval> = /*@__PURE__*/ Schema.Struct({
...
export const UpdateConfigProjectsLocationsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
...
export const GetProjectsLocationsFoldersRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const PatchProjectsLocationsFoldersRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
    updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
    body: Schema.optional(Folder).pipe(T.HttpBody()),
...
export const MoveProjectsLocationsFoldersRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
