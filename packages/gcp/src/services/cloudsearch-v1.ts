...
export const Principal: Schema.Schema<Principal> = /*@__PURE__*/ Schema.Struct({
...
export const ItemAcl: Schema.Schema<ItemAcl> = /*@__PURE__*/ Schema.Struct({
...
export const PushItem: Schema.Schema<PushItem> = /*@__PURE__*/ Schema.Struct({
  type: Schema.optional(Schema.String),
...
export const Filter: Schema.Schema<Filter> = /*@__PURE__*/ Schema.suspend(() =>
  Schema.Struct({
...
export const Photo: Schema.Schema<Photo> = /*@__PURE__*/ Schema.Struct({
...
export const Person: Schema.Schema<Person> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const Snippet: Schema.Schema<Snippet> = /*@__PURE__*/ Schema.Struct({
...
export const ErrorInfo: Schema.Schema<ErrorInfo> = /*@__PURE__*/ Schema.Struct({
...
export const Metaline: Schema.Schema<Metaline> = /*@__PURE__*/ Schema.Struct({
...
export const QueryItem: Schema.Schema<QueryItem> = /*@__PURE__*/ Schema.Struct({
...
export const Action: Schema.Schema<Action> = /*@__PURE__*/ Schema.Struct({
  title: Schema.optional(Schema.String),
  url: Schema.optional(Schema.String),
...
export const Content: Schema.Schema<Content> = /*@__PURE__*/ Schema.Struct({
...
export const MapTile: Schema.Schema<MapTile> = /*@__PURE__*/ Schema.Struct({
...
export const MapInfo: Schema.Schema<MapInfo> = /*@__PURE__*/ Schema.Struct({
...
export const ListOperationsLroRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const GetCustomerSettingsRequest = /*@__PURE__*/ Schema.Struct({}).pipe(
...
export const UpdateCustomerSettingsRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetSettingsSearchapplicationsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
    "debugOptions.enableDebugging": Schema.optional(Schema.Boolean).pipe(
      T.HttpQuery("debugOptions.enableDebugging"),
...
export const CreateSettingsDatasourcesRequest = /*@__PURE__*/ Schema.Struct({
...
export const DeleteSettingsDatasourcesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  "debugOptions.enableDebugging": Schema.optional(Schema.Boolean).pipe(
    T.HttpQuery("debugOptions.enableDebugging"),
  ),
...
export const GetSettingsDatasourcesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  "debugOptions.enableDebugging": Schema.optional(Schema.Boolean).pipe(
    T.HttpQuery("debugOptions.enableDebugging"),
  ),
...
export const UpdateSettingsDatasourcesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const PatchSettingsDatasourcesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  "debugOptions.enableDebugging": Schema.optional(Schema.Boolean).pipe(
    T.HttpQuery("debugOptions.enableDebugging"),
  ),
...
export const ListSettingsDatasourcesRequest = /*@__PURE__*/ Schema.Struct({
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  "debugOptions.enableDebugging": Schema.optional(Schema.Boolean).pipe(
    T.HttpQuery("debugOptions.enableDebugging"),
...
export const InitializeCustomerV1Request = /*@__PURE__*/ Schema.Struct({
...
export const GetSchemaIndexingDatasourcesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  "debugOptions.enableDebugging": Schema.optional(Schema.Boolean).pipe(
    T.HttpQuery("debugOptions.enableDebugging"),
  ),
...
export const GetIndexingDatasourcesItemsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  connectorName: Schema.optional(Schema.String).pipe(
    T.HttpQuery("connectorName"),
  ),
...
export const ListIndexingDatasourcesItemsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  connectorName: Schema.optional(Schema.String).pipe(
    T.HttpQuery("connectorName"),
  ),
...
export const IndexIndexingDatasourcesItemsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
...
export const PollIndexingDatasourcesItemsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const PushIndexingDatasourcesItemsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const RemoveActivityQueryRequest = /*@__PURE__*/ Schema.Struct({
...
export const ListQuerySourcesRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetSearchapplicationStatsRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetStatsIndexDatasourcesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  "fromDate.year": Schema.optional(Schema.Number).pipe(
    T.HttpQuery("fromDate.year"),
  ),
