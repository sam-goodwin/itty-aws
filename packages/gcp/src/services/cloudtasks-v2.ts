...
export const Header: Schema.Schema<Header> = /*@__PURE__*/ Schema.Struct({
...
export const StackdriverLoggingConfig: Schema.Schema<StackdriverLoggingConfig> =
  /*@__PURE__*/ Schema.Struct({
...
export const Queue: Schema.Schema<Queue> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const PurgeQueueRequest: Schema.Schema<PurgeQueueRequest> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "PurgeQueueRequest" });

export interface PauseQueueRequest {}

export const PauseQueueRequest: Schema.Schema<PauseQueueRequest> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "PauseQueueRequest" });
...
export const Attempt: Schema.Schema<Attempt> = /*@__PURE__*/ Schema.Struct({
...
export const Task: Schema.Schema<Task> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const HttpBody: Schema.Schema<HttpBody> = /*@__PURE__*/ Schema.Struct({
...
export const ListProjectsLocationsQueuesRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetProjectsLocationsQueuesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v2/{+name}" }),
  svc,
...
export const CreateProjectsLocationsQueuesRequest = /*@__PURE__*/ Schema.Struct(
  {
    parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const PatchProjectsLocationsQueuesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(Queue).pipe(T.HttpBody()),
}).pipe(
...
export const DeleteProjectsLocationsQueuesRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
  },
).pipe(
...
export const PurgeProjectsLocationsQueuesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const PauseProjectsLocationsQueuesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const ResumeProjectsLocationsQueuesRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
