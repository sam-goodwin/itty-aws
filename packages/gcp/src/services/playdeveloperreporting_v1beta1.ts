...
}).pipe(T.Http({"method":"GET","uri":"v1beta1/{+name}:fetchReleaseFilterOptions","baseUrl":"https://playdeveloperreporting.googleapis.com/"})),
...
export const GooglePlayDeveloperReportingV1beta1Release = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "displayName": S.optional(S.String),
  "versionCodes": S.optional(StringList),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1Release" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1Release>;

export type GooglePlayDeveloperReportingV1beta1ReleaseList = ReadonlyArray<GooglePlayDeveloperReportingV1beta1Release>;
export const GooglePlayDeveloperReportingV1beta1ReleaseList = /*@__PURE__*/ S.Array(GooglePlayDeveloperReportingV1beta1Release) as any as S.Schema<GooglePlayDeveloperReportingV1beta1ReleaseList>;
...
S.Struct({
  "displayName": S.optional(S.String),
  "servingReleases": S.optional(GooglePlayDeveloperReportingV1beta1ReleaseList),
  "type": S.optional(S.String),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1Track" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1Track>;

export type GooglePlayDeveloperReportingV1beta1TrackList = ReadonlyArray<GooglePlayDeveloperReportingV1beta1Track>;
export const GooglePlayDeveloperReportingV1beta1TrackList = /*@__PURE__*/ S.Array(GooglePlayDeveloperReportingV1beta1Track) as any as S.Schema<GooglePlayDeveloperReportingV1beta1TrackList>;
...
export const GooglePlayDeveloperReportingV1beta1ReleaseFilterOptions = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "tracks": S.optional(GooglePlayDeveloperReportingV1beta1TrackList),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1ReleaseFilterOptions" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1ReleaseFilterOptions>;
...
S.Struct({
  "name": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v1beta1/{+name}","baseUrl":"https://playdeveloperreporting.googleapis.com/"})),
...
export type GooglePlayDeveloperReportingV1beta1FreshnessInfoFreshnessAggregationPeriodEnum = "AGGREGATION_PERIOD_UNSPECIFIED" | "HOURLY" | "DAILY" | "FULL_RANGE";
export const GooglePlayDeveloperReportingV1beta1FreshnessInfoFreshnessAggregationPeriodEnum = /*@__PURE__*/ S.String;
...
export const GooglePlayDeveloperReportingV1beta1FreshnessInfoFreshness = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "latestEndTime": S.optional(GoogleTypeDateTime),
  "aggregationPeriod": S.optional(GooglePlayDeveloperReportingV1beta1FreshnessInfoFreshnessAggregationPeriodEnum),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1FreshnessInfoFreshness" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1FreshnessInfoFreshness>;

export type GooglePlayDeveloperReportingV1beta1FreshnessInfoFreshnessList = ReadonlyArray<GooglePlayDeveloperReportingV1beta1FreshnessInfoFreshness>;
export const GooglePlayDeveloperReportingV1beta1FreshnessInfoFreshnessList = /*@__PURE__*/ S.Array(GooglePlayDeveloperReportingV1beta1FreshnessInfoFreshness) as any as S.Schema<GooglePlayDeveloperReportingV1beta1FreshnessInfoFreshnessList>;
...
export interface GooglePlayDeveloperReportingV1beta1FreshnessInfo {
  ...
  freshnesses?: GooglePlayDeveloperReportingV1beta1FreshnessInfoFreshnessList;
}
export const GooglePlayDeveloperReportingV1beta1FreshnessInfo = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "freshnesses": S.optional(GooglePlayDeveloperReportingV1beta1FreshnessInfoFreshnessList),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1FreshnessInfo" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1FreshnessInfo>;
...
export const GooglePlayDeveloperReportingV1beta1AnrRateMetricSet = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "name": S.optional(S.String),
  "freshnessInfo": S.optional(GooglePlayDeveloperReportingV1beta1FreshnessInfo),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1AnrRateMetricSet" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1AnrRateMetricSet>;
...
export const GooglePlayDeveloperReportingV1beta1CrashRateMetricSet = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "name": S.optional(S.String),
  "freshnessInfo": S.optional(GooglePlayDeveloperReportingV1beta1FreshnessInfo),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1CrashRateMetricSet" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1CrashRateMetricSet>;
...
export const GooglePlayDeveloperReportingV1beta1ErrorCountMetricSet = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "name": S.optional(S.String),
  "freshnessInfo": S.optional(GooglePlayDeveloperReportingV1beta1FreshnessInfo),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1ErrorCountMetricSet" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1ErrorCountMetricSet>;
...
export const GooglePlayDeveloperReportingV1beta1ExcessiveWakeupRateMetricSet = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "name": S.optional(S.String),
  "freshnessInfo": S.optional(GooglePlayDeveloperReportingV1beta1FreshnessInfo),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1ExcessiveWakeupRateMetricSet" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1ExcessiveWakeupRateMetricSet>;
...
export const GooglePlayDeveloperReportingV1beta1LmkRateMetricSet = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "name": S.optional(S.String),
  "freshnessInfo": S.optional(GooglePlayDeveloperReportingV1beta1FreshnessInfo),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1LmkRateMetricSet" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1LmkRateMetricSet>;
...
export const GooglePlayDeveloperReportingV1beta1SlowRenderingRateMetricSet = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "name": S.optional(S.String),
  "freshnessInfo": S.optional(GooglePlayDeveloperReportingV1beta1FreshnessInfo),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1SlowRenderingRateMetricSet" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1SlowRenderingRateMetricSet>;
...
export const GooglePlayDeveloperReportingV1beta1SlowStartRateMetricSet = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "name": S.optional(S.String),
  "freshnessInfo": S.optional(GooglePlayDeveloperReportingV1beta1FreshnessInfo),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1SlowStartRateMetricSet" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1SlowStartRateMetricSet>;
...
export const GooglePlayDeveloperReportingV1beta1StuckBackgroundWakelockRateMetricSet = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "name": S.optional(S.String),
  "freshnessInfo": S.optional(GooglePlayDeveloperReportingV1beta1FreshnessInfo),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1StuckBackgroundWakelockRateMetricSet" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1StuckBackgroundWakelockRateMetricSet>;
...
}).pipe(T.Http({"method":"GET","uri":"v1beta1/{+parent}/anomalies","baseUrl":"https://playdeveloperreporting.googleapis.com/"})),
...
export const GooglePlayDeveloperReportingV1beta1DimensionValue = /*@__PURE__*/ S.suspend(() =>
S.Struct({
...
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1DimensionValue" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1DimensionValue>;

export type GooglePlayDeveloperReportingV1beta1DimensionValueList = ReadonlyArray<GooglePlayDeveloperReportingV1beta1DimensionValue>;
export const GooglePlayDeveloperReportingV1beta1DimensionValueList = /*@__PURE__*/ S.Array(GooglePlayDeveloperReportingV1beta1DimensionValue) as any as S.Schema<GooglePlayDeveloperReportingV1beta1DimensionValueList>;
...
export const GooglePlayDeveloperReportingV1beta1DecimalConfidenceInterval = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "lowerBound": S.optional(GoogleTypeDecimal),
  "upperBound": S.optional(GoogleTypeDecimal),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1DecimalConfidenceInterval" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1DecimalConfidenceInterval>;
...
export const GooglePlayDeveloperReportingV1beta1MetricValue = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "decimalValueConfidenceInterval": S.optional(GooglePlayDeveloperReportingV1beta1DecimalConfidenceInterval),
  "metric": S.optional(S.String),
  "decimalValue": S.optional(GoogleTypeDecimal),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1MetricValue" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1MetricValue>;

export type GooglePlayDeveloperReportingV1beta1TimelineSpecAggregationPeriodEnum = "AGGREGATION_PERIOD_UNSPECIFIED" | "HOURLY" | "DAILY" | "FULL_RANGE";
export const GooglePlayDeveloperReportingV1beta1TimelineSpecAggregationPeriodEnum = /*@__PURE__*/ S.String;
...
export const GooglePlayDeveloperReportingV1beta1TimelineSpec = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "aggregationPeriod": S.optional(GooglePlayDeveloperReportingV1beta1TimelineSpecAggregationPeriodEnum),
  "endTime": S.optional(GoogleTypeDateTime),
  "startTime": S.optional(GoogleTypeDateTime),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1TimelineSpec" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1TimelineSpec>;
...
export interface GooglePlayDeveloperReportingV1beta1Anomaly {
  ...
  dimensions?: GooglePlayDeveloperReportingV1beta1DimensionValueList;
...
export const GooglePlayDeveloperReportingV1beta1Anomaly = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "metricSet": S.optional(S.String),
  "dimensions": S.optional(GooglePlayDeveloperReportingV1beta1DimensionValueList),
  "name": S.optional(S.String),
  "metric": S.optional(GooglePlayDeveloperReportingV1beta1MetricValue),
  "timelineSpec": S.optional(GooglePlayDeveloperReportingV1beta1TimelineSpec),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1Anomaly" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1Anomaly>;

export type GooglePlayDeveloperReportingV1beta1AnomalyList = ReadonlyArray<GooglePlayDeveloperReportingV1beta1Anomaly>;
export const GooglePlayDeveloperReportingV1beta1AnomalyList = /*@__PURE__*/ S.Array(GooglePlayDeveloperReportingV1beta1Anomaly) as any as S.Schema<GooglePlayDeveloperReportingV1beta1AnomalyList>;
...
export interface GooglePlayDeveloperReportingV1beta1ListAnomaliesResponse {
  ...
  anomalies?: GooglePlayDeveloperReportingV1beta1AnomalyList;
  /** Continuation token to fetch the next page of data. */
  nextPageToken?: string;
}
export const GooglePlayDeveloperReportingV1beta1ListAnomaliesResponse = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "anomalies": S.optional(GooglePlayDeveloperReportingV1beta1AnomalyList),
  "nextPageToken": S.optional(S.String),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1ListAnomaliesResponse" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1ListAnomaliesResponse>;

export type GooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetRequestUserCohortEnum = "USER_COHORT_UNSPECIFIED" | "OS_PUBLIC" | "OS_BETA" | "APP_TESTERS";
export const GooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetRequestUserCohortEnum = /*@__PURE__*/ S.String;
...
export interface GooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetRequest {
  ...
  userCohort?: GooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetRequestUserCohortEnum | (string & {});
}
export const GooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  ...
  "userCohort": S.optional(GooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetRequestUserCohortEnum),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetRequest" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetRequest>;
...
S.Struct({
  "name": S.String.pipe(T.Label()),
  "body": S.optional(GooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetRequest.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"POST","uri":"v1beta1/{+name}:query","baseUrl":"https://playdeveloperreporting.googleapis.com/"})),
).annotate({ identifier: "QueryVitalsAnrrateRequest" }) as any as S.Schema<QueryVitalsAnrrateRequest>;

export type GooglePlayDeveloperReportingV1beta1MetricValueList = ReadonlyArray<GooglePlayDeveloperReportingV1beta1MetricValue>;
export const GooglePlayDeveloperReportingV1beta1MetricValueList = /*@__PURE__*/ S.Array(GooglePlayDeveloperReportingV1beta1MetricValue) as any as S.Schema<GooglePlayDeveloperReportingV1beta1MetricValueList>;

export type GooglePlayDeveloperReportingV1beta1MetricsRowAggregationPeriodEnum = "AGGREGATION_PERIOD_UNSPECIFIED" | "HOURLY" | "DAILY" | "FULL_RANGE";
export const GooglePlayDeveloperReportingV1beta1MetricsRowAggregationPeriodEnum = /*@__PURE__*/ S.String;
...
export interface GooglePlayDeveloperReportingV1beta1MetricsRow {
  ...
  metrics?: GooglePlayDeveloperReportingV1beta1MetricValueList;
...
export const GooglePlayDeveloperReportingV1beta1MetricsRow = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "startTime": S.optional(GoogleTypeDateTime),
  "metrics": S.optional(GooglePlayDeveloperReportingV1beta1MetricValueList),
  "dimensions": S.optional(GooglePlayDeveloperReportingV1beta1DimensionValueList),
  "aggregationPeriod": S.optional(GooglePlayDeveloperReportingV1beta1MetricsRowAggregationPeriodEnum),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1MetricsRow" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1MetricsRow>;

export type GooglePlayDeveloperReportingV1beta1MetricsRowList = ReadonlyArray<GooglePlayDeveloperReportingV1beta1MetricsRow>;
export const GooglePlayDeveloperReportingV1beta1MetricsRowList = /*@__PURE__*/ S.Array(GooglePlayDeveloperReportingV1beta1MetricsRow) as any as S.Schema<GooglePlayDeveloperReportingV1beta1MetricsRowList>;
...
export interface GooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetResponse {
  ...
  rows?: GooglePlayDeveloperReportingV1beta1MetricsRowList;
  /** Continuation token to fetch the next page of data. */
  nextPageToken?: string;
}
export const GooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetResponse = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "rows": S.optional(GooglePlayDeveloperReportingV1beta1MetricsRowList),
  "nextPageToken": S.optional(S.String),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetResponse" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetResponse>;

export type GooglePlayDeveloperReportingV1beta1QueryCrashRateMetricSetRequestUserCohortEnum = "USER_COHORT_UNSPECIFIED" | "OS_PUBLIC" | "OS_BETA" | "APP_TESTERS";
export const GooglePlayDeveloperReportingV1beta1QueryCrashRateMetricSetRequestUserCohortEnum = /*@__PURE__*/ S.String;
...
export interface GooglePlayDeveloperReportingV1beta1QueryCrashRateMetricSetRequest {
  ...
  dimensions?: StringList;
  /** Optional. User view to select. The output data will correspond to the selected view. **Supported values:** * `OS_PUBLIC` To select data from all publicly released Android versions. This is the default. Supports all the above dimensions. * `APP_TESTERS` To select data from users who have opted in to be testers. Supports all the above dimensions. * `OS_BETA` To select data from beta android versions only, excluding data from released android versions. Only the following dimensions are supported: * `versionCode` (int64): version of the app that was running on the user's device. * `osBuild` (string): OS build of the user's device, e.g., "T1B2.220916.004". */
  userCohort?: GooglePlayDeveloperReportingV1beta1QueryCrashRateMetricSetRequestUserCohortEnum | (string & {});
}
export const GooglePlayDeveloperReportingV1beta1QueryCrashRateMetricSetRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "metrics": S.optional(StringList),
  "timelineSpec": S.optional(GooglePlayDeveloperReportingV1beta1TimelineSpec),
  "pageToken": S.optional(S.String),
  ...
  "filter": S.optional(S.String),
  "dimensions": S.optional(StringList),
  "userCohort": S.optional(GooglePlayDeveloperReportingV1beta1QueryCrashRateMetricSetRequestUserCohortEnum),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1QueryCrashRateMetricSetRequest" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1QueryCrashRateMetricSetRequest>;
...
S.Struct({
  "name": S.String.pipe(T.Label()),
  "body": S.optional(GooglePlayDeveloperReportingV1beta1QueryCrashRateMetricSetRequest.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"POST","uri":"v1beta1/{+name}:query","baseUrl":"https://playdeveloperreporting.googleapis.com/"})),
...
export const GooglePlayDeveloperReportingV1beta1QueryCrashRateMetricSetResponse = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "rows": S.optional(GooglePlayDeveloperReportingV1beta1MetricsRowList),
  "nextPageToken": S.optional(S.String),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1QueryCrashRateMetricSetResponse" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1QueryCrashRateMetricSetResponse>;
...
export const GooglePlayDeveloperReportingV1beta1QueryErrorCountMetricSetRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "filter": S.optional(S.String),
  "dimensions": S.optional(StringList),
  "pageSize": S.optional(S.Number),
...
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1QueryErrorCountMetricSetRequest" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1QueryErrorCountMetricSetRequest>;
...
S.Struct({
  "name": S.String.pipe(T.Label()),
  "body": S.optional(GooglePlayDeveloperReportingV1beta1QueryErrorCountMetricSetRequest.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"POST","uri":"v1beta1/{+name}:query","baseUrl":"https://playdeveloperreporting.googleapis.com/"})),
...
export const GooglePlayDeveloperReportingV1beta1QueryErrorCountMetricSetResponse = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "rows": S.optional(GooglePlayDeveloperReportingV1beta1MetricsRowList),
  "nextPageToken": S.optional(S.String),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1QueryErrorCountMetricSetResponse" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1QueryErrorCountMetricSetResponse>;

export type GooglePlayDeveloperReportingV1beta1QueryExcessiveWakeupRateMetricSetRequestUserCohortEnum = "USER_COHORT_UNSPECIFIED" | "OS_PUBLIC" | "OS_BETA" | "APP_TESTERS";
export const GooglePlayDeveloperReportingV1beta1QueryExcessiveWakeupRateMetricSetRequestUserCohortEnum = /*@__PURE__*/ S.String;
...
export interface GooglePlayDeveloperReportingV1beta1QueryExcessiveWakeupRateMetricSetRequest {
  ...
  userCohort?: GooglePlayDeveloperReportingV1beta1QueryExcessiveWakeupRateMetricSetRequestUserCohortEnum | (string & {});
  /** Optional. Filters to apply to data. The filtering expression follows [AIP-160](https://google.aip.dev/160) standard and supports filtering by equality of all breakdown dimensions. */
  filter?: string;
  /** Optional. Dimensions to slice the data by. **Supported dimensions:** * `apiLevel` (string): the API level of Android that was running on the user's device, e.g., 26. * `versionCode` (int64): version of the app that was running on the user's device. * `deviceModel` (string): unique identifier of the user's device model. The form of the identifier is 'deviceBrand/device', where deviceBrand corresponds to Build.BRAND and device corresponds to Build.DEVICE, e.g., google/coral. * `deviceBrand` (string): unique identifier of the user's device brand, e.g., google. * `deviceType` (string): the type (also known as form factor) of the user's device, e.g., PHONE. * `countryCode` (string): the country or region of the user's device based on their IP address, represented as a 2-letter ISO-3166 code (e.g. US for the United States). * `deviceRamBucket` (int64): RAM of the device, in MB, in buckets (3GB, 4GB, etc.). * `deviceSocMake` (string): Make of the device's primary system-on-chip, e.g., Samsung. [Reference](https://developer.android.com/reference/android/os/Build#SOC_MANUFACTURER) * `deviceSocModel` (string): Model of the device's primary system-on-chip, e.g., "Exynos 2100". [Reference](https://developer.android.com/reference/android/os/Build#SOC_MODEL) * `deviceCpuMake` (string): Make of the device's CPU, e.g., Qualcomm. * `deviceCpuModel` (string): Model of the device's CPU, e.g., "Kryo 240". * `deviceGpuMake` (string): Make of the device's GPU, e.g., ARM. * `deviceGpuModel` (string): Model of the device's GPU, e.g., Mali. * `deviceGpuVersion` (string): Version of the device's GPU, e.g., T750. * `deviceVulkanVersion` (string): Vulkan version of the device, e.g., "4198400". * `deviceGlEsVersion` (string): OpenGL ES version of the device, e.g., "196610". * `deviceScreenSize` (string): Screen size of the device, e.g., NORMAL, LARGE. * `deviceScreenDpi` (string): Screen density of the device, e.g., mdpi, hdpi. */
  dimensions?: StringList;
...
export const GooglePlayDeveloperReportingV1beta1QueryExcessiveWakeupRateMetricSetRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "userCohort": S.optional(GooglePlayDeveloperReportingV1beta1QueryExcessiveWakeupRateMetricSetRequestUserCohortEnum),
  "filter": S.optional(S.String),
  "dimensions": S.optional(StringList),
  "pageSize": S.optional(S.Number),
  "metrics": S.optional(StringList),
...
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1QueryExcessiveWakeupRateMetricSetRequest" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1QueryExcessiveWakeupRateMetricSetRequest>;
...
S.Struct({
  "name": S.String.pipe(T.Label()),
  "body": S.optional(GooglePlayDeveloperReportingV1beta1QueryExcessiveWakeupRateMetricSetRequest.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"POST","uri":"v1beta1/{+name}:query","baseUrl":"https://playdeveloperreporting.googleapis.com/"})),
...
export const GooglePlayDeveloperReportingV1beta1QueryExcessiveWakeupRateMetricSetResponse = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "rows": S.optional(GooglePlayDeveloperReportingV1beta1MetricsRowList),
  "nextPageToken": S.optional(S.String),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1QueryExcessiveWakeupRateMetricSetResponse" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1QueryExcessiveWakeupRateMetricSetResponse>;

export type GooglePlayDeveloperReportingV1beta1QueryLmkRateMetricSetRequestUserCohortEnum = "USER_COHORT_UNSPECIFIED" | "OS_PUBLIC" | "OS_BETA" | "APP_TESTERS";
export const GooglePlayDeveloperReportingV1beta1QueryLmkRateMetricSetRequestUserCohortEnum = /*@__PURE__*/ S.String;
...
export interface GooglePlayDeveloperReportingV1beta1QueryLmkRateMetricSetRequest {
  /** Optional. User view to select. The output data will correspond to the selected view. **Supported values:** * `OS_PUBLIC` To select data from all publicly released Android versions. This is the default. Supports all the above dimensions. * `APP_TESTERS` To select data from users who have opted in to be testers. Supports all the above dimensions. * `OS_BETA` To select data from beta android versions only, excluding data from released android versions. Only the following dimensions are supported: * `versionCode` (int64): version of the app that was running on the user's device. * `osBuild` (string): OS build of the user's device, e.g., "T1B2.220916.004". */
  userCohort?: GooglePlayDeveloperReportingV1beta1QueryLmkRateMetricSetRequestUserCohortEnum | (string & {});
  /** Optional. Filters to apply to data. The filtering expression follows [AIP-160](https://google.aip.dev/160) standard and supports filtering by equality of all breakdown dimensions. */
  filter?: string;
  /** Optional. Dimensions to slice the metrics by. **Supported dimensions:** * `apiLevel` (string): the API level of Android that was running on the user's device, e.g., 26. * `versionCode` (int64): version of the app that was running on the user's device. * `deviceModel` (string): unique identifier of the user's device model. The form of the identifier is 'deviceBrand/device', where deviceBrand corresponds to Build.BRAND and device corresponds to Build.DEVICE, e.g., google/coral. * `deviceBrand` (string): unique identifier of the user's device brand, e.g., google. * `deviceType` (string): the type (also known as form factor) of the user's device, e.g., PHONE. * `countryCode` (string): the country or region of the user's device based on their IP address, represented as a 2-letter ISO-3166 code (e.g. US for the United States). * `deviceRamBucket` (int64): RAM of the device, in MB, in buckets (3GB, 4GB, etc.). * `deviceSocMake` (string): Make of the device's primary system-on-chip, e.g., Samsung. [Reference](https://developer.android.com/reference/android/os/Build#SOC_MANUFACTURER) * `deviceSocModel` (string): Model of the device's primary system-on-chip, e.g., "Exynos 2100". [Reference](https://developer.android.com/reference/android/os/Build#SOC_MODEL) * `deviceCpuMake` (string): Make of the device's CPU, e.g., Qualcomm. * `deviceCpuModel` (string): Model of the device's CPU, e.g., "Kryo 240". * `deviceGpuMake` (string): Make of the device's GPU, e.g., ARM. * `deviceGpuModel` (string): Model of the device's GPU, e.g., Mali. * `deviceGpuVersion` (string): Version of the device's GPU, e.g., T750. * `deviceVulkanVersion` (string): Vulkan version of the device, e.g., "4198400". * `deviceGlEsVersion` (string): OpenGL ES version of the device, e.g., "196610". * `deviceScreenSize` (string): Screen size of the device, e.g., NORMAL, LARGE. * `deviceScreenDpi` (string): Screen density of the device, e.g., mdpi, hdpi. */
  dimensions?: StringList;
...
export const GooglePlayDeveloperReportingV1beta1QueryLmkRateMetricSetRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "userCohort": S.optional(GooglePlayDeveloperReportingV1beta1QueryLmkRateMetricSetRequestUserCohortEnum),
  "filter": S.optional(S.String),
  "dimensions": S.optional(StringList),
  "pageSize": S.optional(S.Number),
  "metrics": S.optional(StringList),
...
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1QueryLmkRateMetricSetRequest" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1QueryLmkRateMetricSetRequest>;
...
S.Struct({
  "name": S.String.pipe(T.Label()),
  "body": S.optional(GooglePlayDeveloperReportingV1beta1QueryLmkRateMetricSetRequest.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"POST","uri":"v1beta1/{+name}:query","baseUrl":"https://playdeveloperreporting.googleapis.com/"})),
...
export const GooglePlayDeveloperReportingV1beta1QueryLmkRateMetricSetResponse = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "rows": S.optional(GooglePlayDeveloperReportingV1beta1MetricsRowList),
  "nextPageToken": S.optional(S.String),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1QueryLmkRateMetricSetResponse" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1QueryLmkRateMetricSetResponse>;

export type GooglePlayDeveloperReportingV1beta1QuerySlowRenderingRateMetricSetRequestUserCohortEnum = "USER_COHORT_UNSPECIFIED" | "OS_PUBLIC" | "OS_BETA" | "APP_TESTERS";
export const GooglePlayDeveloperReportingV1beta1QuerySlowRenderingRateMetricSetRequestUserCohortEnum = /*@__PURE__*/ S.String;
...
export interface GooglePlayDeveloperReportingV1beta1QuerySlowRenderingRateMetricSetRequest {
  ...
  filter?: string;
  /** Optional. User view to select. The output data will correspond to the selected view. The only supported value is `OS_PUBLIC`. */
  userCohort?: GooglePlayDeveloperReportingV1beta1QuerySlowRenderingRateMetricSetRequestUserCohortEnum | (string & {});
  /** Optional. Specification of the timeline aggregation parameters. **Supported aggregation periods:** * DAILY: metrics are aggregated in calendar date intervals. Due to historical constraints, the only supported timezone is `America/Los_Angeles`. */
  timelineSpec?: GooglePlayDeveloperReportingV1beta1TimelineSpec;
  /** Optional. A page token, received from a previous call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to the request must match the call that provided the page token. */
  pageToken?: string;
...
export const GooglePlayDeveloperReportingV1beta1QuerySlowRenderingRateMetricSetRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "dimensions": S.optional(StringList),
  "filter": S.optional(S.String),
  "userCohort": S.optional(GooglePlayDeveloperReportingV1beta1QuerySlowRenderingRateMetricSetRequestUserCohortEnum),
  "timelineSpec": S.optional(GooglePlayDeveloperReportingV1beta1TimelineSpec),
  "pageToken": S.optional(S.String),
  "metrics": S.optional(StringList),
  "pageSize": S.optional(S.Number),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1QuerySlowRenderingRateMetricSetRequest" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1QuerySlowRenderingRateMetricSetRequest>;
...
S.Struct({
  "name": S.String.pipe(T.Label()),
  "body": S.optional(GooglePlayDeveloperReportingV1beta1QuerySlowRenderingRateMetricSetRequest.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"POST","uri":"v1beta1/{+name}:query","baseUrl":"https://playdeveloperreporting.googleapis.com/"})),
...
export const GooglePlayDeveloperReportingV1beta1QuerySlowRenderingRateMetricSetResponse = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "rows": S.optional(GooglePlayDeveloperReportingV1beta1MetricsRowList),
  "nextPageToken": S.optional(S.String),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1QuerySlowRenderingRateMetricSetResponse" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1QuerySlowRenderingRateMetricSetResponse>;

export type GooglePlayDeveloperReportingV1beta1QuerySlowStartRateMetricSetRequestUserCohortEnum = "USER_COHORT_UNSPECIFIED" | "OS_PUBLIC" | "OS_BETA" | "APP_TESTERS";
export const GooglePlayDeveloperReportingV1beta1QuerySlowStartRateMetricSetRequestUserCohortEnum = /*@__PURE__*/ S.String;
...
export interface GooglePlayDeveloperReportingV1beta1QuerySlowStartRateMetricSetRequest {
  ...
  filter?: string;
  /** Optional. User view to select. The output data will correspond to the selected view. The only supported value is `OS_PUBLIC`. */
  userCohort?: GooglePlayDeveloperReportingV1beta1QuerySlowStartRateMetricSetRequestUserCohortEnum | (string & {});
}
export const GooglePlayDeveloperReportingV1beta1QuerySlowStartRateMetricSetRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "timelineSpec": S.optional(GooglePlayDeveloperReportingV1beta1TimelineSpec),
  "pageToken": S.optional(S.String),
  "metrics": S.optional(StringList),
  ...
  "dimensions": S.optional(StringList),
  "filter": S.optional(S.String),
  "userCohort": S.optional(GooglePlayDeveloperReportingV1beta1QuerySlowStartRateMetricSetRequestUserCohortEnum),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1QuerySlowStartRateMetricSetRequest" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1QuerySlowStartRateMetricSetRequest>;
...
S.Struct({
  "name": S.String.pipe(T.Label()),
  "body": S.optional(GooglePlayDeveloperReportingV1beta1QuerySlowStartRateMetricSetRequest.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"POST","uri":"v1beta1/{+name}:query","baseUrl":"https://playdeveloperreporting.googleapis.com/"})),
...
export const GooglePlayDeveloperReportingV1beta1QuerySlowStartRateMetricSetResponse = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "rows": S.optional(GooglePlayDeveloperReportingV1beta1MetricsRowList),
  "nextPageToken": S.optional(S.String),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1QuerySlowStartRateMetricSetResponse" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1QuerySlowStartRateMetricSetResponse>;

export type GooglePlayDeveloperReportingV1beta1QueryStuckBackgroundWakelockRateMetricSetRequestUserCohortEnum = "USER_COHORT_UNSPECIFIED" | "OS_PUBLIC" | "OS_BETA" | "APP_TESTERS";
export const GooglePlayDeveloperReportingV1beta1QueryStuckBackgroundWakelockRateMetricSetRequestUserCohortEnum = /*@__PURE__*/ S.String;
...
export interface GooglePlayDeveloperReportingV1beta1QueryStuckBackgroundWakelockRateMetricSetRequest {
  ...
  filter?: string;
  /** Optional. User view to select. The output data will correspond to the selected view. The only supported value is `OS_PUBLIC`. */
  userCohort?: GooglePlayDeveloperReportingV1beta1QueryStuckBackgroundWakelockRateMetricSetRequestUserCohortEnum | (string & {});
}
export const GooglePlayDeveloperReportingV1beta1QueryStuckBackgroundWakelockRateMetricSetRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "timelineSpec": S.optional(GooglePlayDeveloperReportingV1beta1TimelineSpec),
  "pageToken": S.optional(S.String),
  "metrics": S.optional(StringList),
  ...
  "dimensions": S.optional(StringList),
  "filter": S.optional(S.String),
  "userCohort": S.optional(GooglePlayDeveloperReportingV1beta1QueryStuckBackgroundWakelockRateMetricSetRequestUserCohortEnum),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1QueryStuckBackgroundWakelockRateMetricSetRequest" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1QueryStuckBackgroundWakelockRateMetricSetRequest>;
...
S.Struct({
  "name": S.String.pipe(T.Label()),
  "body": S.optional(GooglePlayDeveloperReportingV1beta1QueryStuckBackgroundWakelockRateMetricSetRequest.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"POST","uri":"v1beta1/{+name}:query","baseUrl":"https://playdeveloperreporting.googleapis.com/"})),
...
export const GooglePlayDeveloperReportingV1beta1QueryStuckBackgroundWakelockRateMetricSetResponse = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "rows": S.optional(GooglePlayDeveloperReportingV1beta1MetricsRowList),
  "nextPageToken": S.optional(S.String),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1QueryStuckBackgroundWakelockRateMetricSetResponse" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1QueryStuckBackgroundWakelockRateMetricSetResponse>;
...
S.Struct({
  "pageSize": S.optional(S.Number.pipe(T.Query())),
  "pageToken": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1beta1/apps:search","baseUrl":"https://playdeveloperreporting.googleapis.com/"})),
...
export const GooglePlayDeveloperReportingV1beta1App = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "name": S.optional(S.String),
  "displayName": S.optional(S.String),
  "packageName": S.optional(S.String),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1App" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1App>;

export type GooglePlayDeveloperReportingV1beta1AppList = ReadonlyArray<GooglePlayDeveloperReportingV1beta1App>;
export const GooglePlayDeveloperReportingV1beta1AppList = /*@__PURE__*/ S.Array(GooglePlayDeveloperReportingV1beta1App) as any as S.Schema<GooglePlayDeveloperReportingV1beta1AppList>;
...
export interface GooglePlayDeveloperReportingV1beta1SearchAccessibleAppsResponse {
  ...
  apps?: GooglePlayDeveloperReportingV1beta1AppList;
  /** A token, which can be sent as `page_token` to retrieve the next page. If this field is omitted, there are no subsequent pages. */
  nextPageToken?: string;
}
export const GooglePlayDeveloperReportingV1beta1SearchAccessibleAppsResponse = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "apps": S.optional(GooglePlayDeveloperReportingV1beta1AppList),
  "nextPageToken": S.optional(S.String),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1SearchAccessibleAppsResponse" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1SearchAccessibleAppsResponse>;
...
}).pipe(T.Http({"method":"GET","uri":"v1beta1/{+parent}/errorIssues:search","baseUrl":"https://playdeveloperreporting.googleapis.com/"})),
...
export const GooglePlayDeveloperReportingV1beta1OsVersion = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "apiLevel": S.optional(S.String),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1OsVersion" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1OsVersion>;
...
export const GooglePlayDeveloperReportingV1beta1IssueAnnotation = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "category": S.optional(S.String),
  "title": S.optional(S.String),
  "body": S.optional(S.String),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1IssueAnnotation" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1IssueAnnotation>;

export type GooglePlayDeveloperReportingV1beta1IssueAnnotationList = ReadonlyArray<GooglePlayDeveloperReportingV1beta1IssueAnnotation>;
export const GooglePlayDeveloperReportingV1beta1IssueAnnotationList = /*@__PURE__*/ S.Array(GooglePlayDeveloperReportingV1beta1IssueAnnotation) as any as S.Schema<GooglePlayDeveloperReportingV1beta1IssueAnnotationList>;
...
export const GooglePlayDeveloperReportingV1beta1AppVersion = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "versionCode": S.optional(S.String),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1AppVersion" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1AppVersion>;

export type GooglePlayDeveloperReportingV1beta1ErrorIssueTypeEnum = "ERROR_TYPE_UNSPECIFIED" | "APPLICATION_NOT_RESPONDING" | "CRASH" | "NON_FATAL";
export const GooglePlayDeveloperReportingV1beta1ErrorIssueTypeEnum = /*@__PURE__*/ S.String;
...
export interface GooglePlayDeveloperReportingV1beta1ErrorIssue {
  ...
  annotations?: GooglePlayDeveloperReportingV1beta1IssueAnnotationList;
...
export const GooglePlayDeveloperReportingV1beta1ErrorIssue = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "name": S.optional(S.String),
  "cause": S.optional(S.String),
  "lastOsVersion": S.optional(GooglePlayDeveloperReportingV1beta1OsVersion),
  "annotations": S.optional(GooglePlayDeveloperReportingV1beta1IssueAnnotationList),
  "sampleErrorReports": S.optional(StringList),
  "lastAppVersion": S.optional(GooglePlayDeveloperReportingV1beta1AppVersion),
  "distinctUsers": S.optional(S.String),
  "firstAppVersion": S.optional(GooglePlayDeveloperReportingV1beta1AppVersion),
  ...
  "type": S.optional(GooglePlayDeveloperReportingV1beta1ErrorIssueTypeEnum),
  "firstOsVersion": S.optional(GooglePlayDeveloperReportingV1beta1OsVersion),
  "location": S.optional(S.String),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1ErrorIssue" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1ErrorIssue>;

export type GooglePlayDeveloperReportingV1beta1ErrorIssueList = ReadonlyArray<GooglePlayDeveloperReportingV1beta1ErrorIssue>;
export const GooglePlayDeveloperReportingV1beta1ErrorIssueList = /*@__PURE__*/ S.Array(GooglePlayDeveloperReportingV1beta1ErrorIssue) as any as S.Schema<GooglePlayDeveloperReportingV1beta1ErrorIssueList>;
...
export interface GooglePlayDeveloperReportingV1beta1SearchErrorIssuesResponse {
  ...
  errorIssues?: GooglePlayDeveloperReportingV1beta1ErrorIssueList;
  /** Continuation token to fetch the next page of data. */
  nextPageToken?: string;
}
export const GooglePlayDeveloperReportingV1beta1SearchErrorIssuesResponse = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "errorIssues": S.optional(GooglePlayDeveloperReportingV1beta1ErrorIssueList),
  "nextPageToken": S.optional(S.String),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1SearchErrorIssuesResponse" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1SearchErrorIssuesResponse>;
...
S.Struct({
  ...
  "pageSize": S.optional(S.Number.pipe(T.Query())),
  "pageToken": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1beta1/{+parent}/errorReports:search","baseUrl":"https://playdeveloperreporting.googleapis.com/"})),
).annotate({ identifier: "SearchVitalsErrorsReportsRequest" }) as any as S.Schema<SearchVitalsErrorsReportsRequest>;

export type GooglePlayDeveloperReportingV1beta1ErrorReportTypeEnum = "ERROR_TYPE_UNSPECIFIED" | "APPLICATION_NOT_RESPONDING" | "CRASH" | "NON_FATAL";
export const GooglePlayDeveloperReportingV1beta1ErrorReportTypeEnum = /*@__PURE__*/ S.String;
...
export const GooglePlayDeveloperReportingV1beta1DeviceId = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "buildDevice": S.optional(S.String),
  "buildBrand": S.optional(S.String),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1DeviceId" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1DeviceId>;
...
export const GooglePlayDeveloperReportingV1beta1DeviceModelSummary = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "deviceId": S.optional(GooglePlayDeveloperReportingV1beta1DeviceId),
  "deviceUri": S.optional(S.String),
  "marketingName": S.optional(S.String),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1DeviceModelSummary" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1DeviceModelSummary>;
...
export const GooglePlayDeveloperReportingV1beta1ErrorReport = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "osVersion": S.optional(GooglePlayDeveloperReportingV1beta1OsVersion),
  "appVersion": S.optional(GooglePlayDeveloperReportingV1beta1AppVersion),
  "issue": S.optional(S.String),
  "type": S.optional(GooglePlayDeveloperReportingV1beta1ErrorReportTypeEnum),
  "name": S.optional(S.String),
  "reportText": S.optional(S.String),
  "vcsInformation": S.optional(S.String),
  "eventTime": S.optional(S.String),
  "deviceModel": S.optional(GooglePlayDeveloperReportingV1beta1DeviceModelSummary),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1ErrorReport" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1ErrorReport>;

export type GooglePlayDeveloperReportingV1beta1ErrorReportList = ReadonlyArray<GooglePlayDeveloperReportingV1beta1ErrorReport>;
export const GooglePlayDeveloperReportingV1beta1ErrorReportList = /*@__PURE__*/ S.Array(GooglePlayDeveloperReportingV1beta1ErrorReport) as any as S.Schema<GooglePlayDeveloperReportingV1beta1ErrorReportList>;
...
export interface GooglePlayDeveloperReportingV1beta1SearchErrorReportsResponse {
  ...
  errorReports?: GooglePlayDeveloperReportingV1beta1ErrorReportList;
  /** Page token to fetch the next page of reports. */
  nextPageToken?: string;
}
export const GooglePlayDeveloperReportingV1beta1SearchErrorReportsResponse = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "errorReports": S.optional(GooglePlayDeveloperReportingV1beta1ErrorReportList),
  "nextPageToken": S.optional(S.String),
}),
).annotate({ identifier: "GooglePlayDeveloperReportingV1beta1SearchErrorReportsResponse" }) as any as S.Schema<GooglePlayDeveloperReportingV1beta1SearchErrorReportsResponse>;
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  output: GooglePlayDeveloperReportingV1beta1AnrRateMetricSet,
  errors: [NotFound, Forbidden, UnknownGCPError],
  protocol: GcpProtocol,
  retry: Retry.Retry,
}));
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  output: GooglePlayDeveloperReportingV1beta1CrashRateMetricSet,
  errors: [NotFound, Forbidden, UnknownGCPError],
  protocol: GcpProtocol,
  retry: Retry.Retry,
}));
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  output: GooglePlayDeveloperReportingV1beta1ErrorCountMetricSet,
  errors: [NotFound, Forbidden, UnknownGCPError],
  protocol: GcpProtocol,
  retry: Retry.Retry,
}));
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  output: GooglePlayDeveloperReportingV1beta1ExcessiveWakeupRateMetricSet,
  errors: [NotFound, Forbidden, UnknownGCPError],
  protocol: GcpProtocol,
  retry: Retry.Retry,
}));
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  output: GooglePlayDeveloperReportingV1beta1LmkRateMetricSet,
  errors: [NotFound, Forbidden, UnknownGCPError],
  protocol: GcpProtocol,
  retry: Retry.Retry,
}));
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  output: GooglePlayDeveloperReportingV1beta1SlowRenderingRateMetricSet,
  errors: [NotFound, Forbidden, UnknownGCPError],
  protocol: GcpProtocol,
  retry: Retry.Retry,
}));
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  output: GooglePlayDeveloperReportingV1beta1SlowStartRateMetricSet,
  errors: [NotFound, Forbidden, UnknownGCPError],
  protocol: GcpProtocol,
  retry: Retry.Retry,
}));
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  output: GooglePlayDeveloperReportingV1beta1StuckBackgroundWakelockRateMetricSet,
  errors: [NotFound, Forbidden, UnknownGCPError],
  protocol: GcpProtocol,
  retry: Retry.Retry,
}));
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  output: GooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetResponse,
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  output: GooglePlayDeveloperReportingV1beta1QueryCrashRateMetricSetResponse,
  errors: [NotFound, Forbidden, BadRequest, Conflict, UnknownGCPError],
  protocol: GcpProtocol,
  retry: Retry.Retry,
}));
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  output: GooglePlayDeveloperReportingV1beta1QueryErrorCountMetricSetResponse,
  errors: [NotFound, Forbidden, BadRequest, Conflict, UnknownGCPError],
  protocol: GcpProtocol,
  retry: Retry.Retry,
}));
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  output: GooglePlayDeveloperReportingV1beta1QueryExcessiveWakeupRateMetricSetResponse,
  errors: [NotFound, Forbidden, BadRequest, Conflict, UnknownGCPError],
  protocol: GcpProtocol,
  retry: Retry.Retry,
}));
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  output: GooglePlayDeveloperReportingV1beta1QueryLmkRateMetricSetResponse,
  errors: [NotFound, Forbidden, BadRequest, Conflict, UnknownGCPError],
  protocol: GcpProtocol,
  retry: Retry.Retry,
}));
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  output: GooglePlayDeveloperReportingV1beta1QuerySlowRenderingRateMetricSetResponse,
  errors: [NotFound, Forbidden, BadRequest, Conflict, UnknownGCPError],
  protocol: GcpProtocol,
  retry: Retry.Retry,
}));
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  output: GooglePlayDeveloperReportingV1beta1QuerySlowStartRateMetricSetResponse,
  errors: [NotFound, Forbidden, BadRequest, Conflict, UnknownGCPError],
  protocol: GcpProtocol,
  retry: Retry.Retry,
}));
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  output: GooglePlayDeveloperReportingV1beta1QueryStuckBackgroundWakelockRateMetricSetResponse,
  errors: [NotFound, Forbidden, BadRequest, Conflict, UnknownGCPError],
  protocol: GcpProtocol,
  retry: Retry.Retry,
}));
