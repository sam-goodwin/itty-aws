...
export interface BaseMetric {
  ...
  standardMetric?: BaseMetricStandardMetricEnum;
}
...
export interface QueryDomainStatsRequest {
  ...
  aggregationGranularity?: QueryDomainStatsRequestAggregationGranularityEnum;
...
export interface CreateUserRequest {
  ...
  permission?: CreateUserRequestPermissionEnum;
}
...
export interface GetVerificationTokenDomainsRequest {
  ...
  verificationMethod?: GetVerificationTokenDomainsVerificationMethodEnum;
...
export interface VerifyDomainRequest {
  /** Required. The verification method used. Must be specified, i.e. TXT or CNAME. */
  verificationMethod?: VerifyDomainRequestVerificationMethodEnum;
}
