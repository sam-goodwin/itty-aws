...
export const PlaceInfo: Schema.Schema<PlaceInfo> = /*@__PURE__*/ Schema.Struct({
...
export const Places: Schema.Schema<Places> = /*@__PURE__*/ Schema.Struct({
...
export const Attribute: Schema.Schema<Attribute> = /*@__PURE__*/ Schema.Struct({
...
export const ChainName: Schema.Schema<ChainName> = /*@__PURE__*/ Schema.Struct({
  languageCode: Schema.optional(Schema.String),
  displayName: Schema.optional(Schema.String),
...
export const OpenInfo: Schema.Schema<OpenInfo> = /*@__PURE__*/ Schema.Struct({
...
export const MoreHours: Schema.Schema<MoreHours> = /*@__PURE__*/ Schema.Struct({
  periods: Schema.optional(Schema.Array(TimePeriod)),
  hoursTypeId: Schema.optional(Schema.String),
...
export const ChainUri: Schema.Schema<ChainUri> = /*@__PURE__*/ Schema.Struct({
  uri: Schema.optional(Schema.String),
...
export const Chain: Schema.Schema<Chain> = /*@__PURE__*/ Schema.Struct({
...
export const GetGoogleUpdatedLocationsRequest = /*@__PURE__*/ Schema.Struct({
  readMask: Schema.optional(Schema.String).pipe(T.HttpQuery("readMask")),
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
...
export const UpdateAttributesLocationsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const GetAttributesLocationsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const ListAccountsLocationsRequest = /*@__PURE__*/ Schema.Struct({
...
export const CreateAccountsLocationsRequest = /*@__PURE__*/ Schema.Struct({
  validateOnly: Schema.optional(Schema.Boolean).pipe(
    T.HttpQuery("validateOnly"),
  ),
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const BatchGetCategoriesRequest = /*@__PURE__*/ Schema.Struct({
...
export const SearchGoogleLocationsRequest_Op = /*@__PURE__*/ Schema.Struct({
