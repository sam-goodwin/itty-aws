...
export const Circle: Schema.Schema<Circle> = /*@__PURE__*/ Schema.Struct({
...
export const Polygon: Schema.Schema<Polygon> = /*@__PURE__*/ Schema.Struct({
...
export const ComputeInsightsV1Request = /*@__PURE__*/ Schema.Struct({
