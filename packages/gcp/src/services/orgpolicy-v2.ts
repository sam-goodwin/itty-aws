...
export const GetProjectsPoliciesRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetProjectsPoliciesResponse =
  /*@__PURE__*/ GoogleCloudOrgpolicyV2Policy;
...
export const CreateProjectsPoliciesRequest = /*@__PURE__*/ Schema.Struct({
...
export const DeleteProjectsPoliciesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const DeleteProjectsPoliciesResponse = /*@__PURE__*/ GoogleProtobufEmpty;
...
export const PatchProjectsPoliciesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const ListProjectsPoliciesRequest = /*@__PURE__*/ Schema.Struct({
...
export const ListProjectsPoliciesResponse =
  /*@__PURE__*/ GoogleCloudOrgpolicyV2ListPoliciesResponse;
...
export const ListProjectsConstraintsRequest = /*@__PURE__*/ Schema.Struct({
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
}).pipe(
...
export const ListProjectsConstraintsResponse =
  /*@__PURE__*/ GoogleCloudOrgpolicyV2ListConstraintsResponse;
...
export const PatchFoldersPoliciesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(GoogleCloudOrgpolicyV2Policy).pipe(T.HttpBody()),
}).pipe(
...
export const ListFoldersPoliciesRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
}).pipe(
...
export const GetFoldersPoliciesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v2/{+name}" }),
  svc,
...
export const CreateFoldersPoliciesRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudOrgpolicyV2Policy).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/{+parent}/policies", hasBody: true }),
...
export const DeleteFoldersPoliciesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  etag: Schema.optional(Schema.String).pipe(T.HttpQuery("etag")),
}).pipe(
  T.Http({ method: "DELETE", path: "v2/{+name}" }),
...
export const DeleteFoldersPoliciesResponse = /*@__PURE__*/ GoogleProtobufEmpty;
...
export const ListFoldersConstraintsRequest = /*@__PURE__*/ Schema.Struct({
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
}).pipe(
...
export const ListOrganizationsConstraintsRequest = /*@__PURE__*/ Schema.Struct({
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
}).pipe(
...
export const PatchOrganizationsCustomConstraintsResponse =
  /*@__PURE__*/ GoogleCloudOrgpolicyV2CustomConstraint;
...
export const ListOrganizationsCustomConstraintsResponse =
  /*@__PURE__*/ GoogleCloudOrgpolicyV2ListCustomConstraintsResponse;
...
export const GetOrganizationsPoliciesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v2/{+name}" }),
  svc,
...
export const CreateOrganizationsPoliciesRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(GoogleCloudOrgpolicyV2Policy).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v2/{+parent}/policies", hasBody: true }),
...
export const DeleteOrganizationsPoliciesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  etag: Schema.optional(Schema.String).pipe(T.HttpQuery("etag")),
}).pipe(
  T.Http({ method: "DELETE", path: "v2/{+name}" }),
...
export const ListOrganizationsPoliciesRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
}).pipe(
...
export const PatchOrganizationsPoliciesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(GoogleCloudOrgpolicyV2Policy).pipe(T.HttpBody()),
}).pipe(
