...
export const ClassItem: Schema.Schema<ClassItem> = /*@__PURE__*/ Schema.Struct({
...
export const WordInfo: Schema.Schema<WordInfo> = /*@__PURE__*/ Schema.Struct({
...
export const Phrase: Schema.Schema<Phrase> = /*@__PURE__*/ Schema.Struct({
  value: Schema.optional(Schema.String),
...
export const PhraseSet: Schema.Schema<PhraseSet> = /*@__PURE__*/ Schema.Struct({
  kmsKeyVersionName: Schema.optional(Schema.String),
  kmsKeyName: Schema.optional(Schema.String),
...
export const LongrunningrecognizeSpeechRequest = /*@__PURE__*/ Schema.Struct({
