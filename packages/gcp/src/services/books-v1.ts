...
export const Bookshelf: Schema.Schema<Bookshelf> = /*@__PURE__*/ Schema.Struct({
...
export const Volumes: Schema.Schema<Volumes> = /*@__PURE__*/ Schema.Struct({
  kind: Schema.optional(Schema.String),
...
export const Volume2: Schema.Schema<Volume2> = /*@__PURE__*/ Schema.Struct({
  kind: Schema.optional(Schema.String),
  items: Schema.optional(Schema.Array(Volume)),
  nextPageToken: Schema.optional(Schema.String),
...
export const Offers: Schema.Schema<Offers> = /*@__PURE__*/ Schema.Struct({
  kind: Schema.optional(Schema.String),
  items: Schema.optional(
    Schema.Array(
      Schema.Struct({
...
export const Series: Schema.Schema<Series> = /*@__PURE__*/ Schema.Struct({
...
export const ListBookshelvesVolumesRequest = /*@__PURE__*/ Schema.Struct({
  userId: Schema.String.pipe(T.HttpPath("userId")),
  shelf: Schema.String.pipe(T.HttpPath("shelf")),
...
export const AddBookCloudloadingRequest = /*@__PURE__*/ Schema.Struct({
...
export const DeleteBookCloudloadingRequest = /*@__PURE__*/ Schema.Struct({
...
export const UpdateBookCloudloadingRequest = /*@__PURE__*/ Schema.Struct({
...
export const ListOfflineMetadataDictionaryRequest = /*@__PURE__*/ Schema.Struct(
  {
...
export const GetFamilyInfoFamilysharingRequest = /*@__PURE__*/ Schema.Struct({
  source: Schema.optional(Schema.String).pipe(T.HttpQuery("source")),
}).pipe(
...
export const ShareFamilysharingRequest = /*@__PURE__*/ Schema.Struct({
...
export const UnshareFamilysharingRequest = /*@__PURE__*/ Schema.Struct({
  docId: Schema.optional(Schema.String).pipe(T.HttpQuery("docId")),
  source: Schema.optional(Schema.String).pipe(T.HttpQuery("source")),
  volumeId: Schema.optional(Schema.String).pipe(T.HttpQuery("volumeId")),
}).pipe(
...
export const GetLayersAnnotationDataRequest = /*@__PURE__*/ Schema.Struct({
  volumeId: Schema.String.pipe(T.HttpPath("volumeId")),
...
export const ListLayersAnnotationDataRequest = /*@__PURE__*/ Schema.Struct({
  volumeId: Schema.String.pipe(T.HttpPath("volumeId")),
  layerId: Schema.String.pipe(T.HttpPath("layerId")),
...
export const GetLayersVolumeAnnotationsRequest = /*@__PURE__*/ Schema.Struct({
  volumeId: Schema.String.pipe(T.HttpPath("volumeId")),
  layerId: Schema.String.pipe(T.HttpPath("layerId")),
...
export const ListLayersVolumeAnnotationsRequest = /*@__PURE__*/ Schema.Struct({
  volumeId: Schema.String.pipe(T.HttpPath("volumeId")),
  layerId: Schema.String.pipe(T.HttpPath("layerId")),
  contentVersion: Schema.String.pipe(T.HttpQuery("contentVersion")),
...
export const GetUserSettingsMyconfigRequest = /*@__PURE__*/ Schema.Struct({
...
export const ReleaseDownloadAccessMyconfigRequest = /*@__PURE__*/ Schema.Struct(
  {
    cpksver: Schema.String.pipe(T.HttpQuery("cpksver")),
    locale: Schema.optional(Schema.String).pipe(T.HttpQuery("locale")),
    source: Schema.optional(Schema.String).pipe(T.HttpQuery("source")),
...
export const RequestAccessMyconfigRequest = /*@__PURE__*/ Schema.Struct({
  cpksver: Schema.String.pipe(T.HttpQuery("cpksver")),
...
export const SyncVolumeLicensesMyconfigRequest = /*@__PURE__*/ Schema.Struct({
  cpksver: Schema.String.pipe(T.HttpQuery("cpksver")),
...
export const UpdateUserSettingsMyconfigRequest = /*@__PURE__*/ Schema.Struct({
...
export const DeleteMylibraryAnnotationsRequest = /*@__PURE__*/ Schema.Struct({
  annotationId: Schema.String.pipe(T.HttpPath("annotationId")),
  source: Schema.optional(Schema.String).pipe(T.HttpQuery("source")),
}).pipe(
  T.Http({
...
export const InsertMylibraryAnnotationsRequest = /*@__PURE__*/ Schema.Struct({
...
export const ListMylibraryAnnotationsRequest = /*@__PURE__*/ Schema.Struct({
  contentVersion: Schema.optional(Schema.String).pipe(
    T.HttpQuery("contentVersion"),
  ),
...
export const SummaryMylibraryAnnotationsRequest = /*@__PURE__*/ Schema.Struct({
...
export const UpdateMylibraryAnnotationsRequest = /*@__PURE__*/ Schema.Struct({
  annotationId: Schema.String.pipe(T.HttpPath("annotationId")),
  source: Schema.optional(Schema.String).pipe(T.HttpQuery("source")),
  body: Schema.optional(Annotation).pipe(T.HttpBody()),
}).pipe(
...
export const AddVolumeMylibraryBookshelvesRequest = /*@__PURE__*/ Schema.Struct(
  {
    shelf: Schema.String.pipe(T.HttpPath("shelf")),
...
export const GetMylibraryBookshelvesRequest = /*@__PURE__*/ Schema.Struct({
  shelf: Schema.String.pipe(T.HttpPath("shelf")),
  source: Schema.optional(Schema.String).pipe(T.HttpQuery("source")),
}).pipe(
...
export const ListMylibraryBookshelvesRequest = /*@__PURE__*/ Schema.Struct({
  source: Schema.optional(Schema.String).pipe(T.HttpQuery("source")),
}).pipe(
...
export const GetMylibraryReadingpositionsRequest = /*@__PURE__*/ Schema.Struct({
  volumeId: Schema.String.pipe(T.HttpPath("volumeId")),
  contentVersion: Schema.optional(Schema.String).pipe(
    T.HttpQuery("contentVersion"),
  ),
...
export const ListCategoriesOnboardingRequest = /*@__PURE__*/ Schema.Struct({
  locale: Schema.optional(Schema.String).pipe(T.HttpQuery("locale")),
}).pipe(
...
export const ListCategoryVolumesOnboardingRequest = /*@__PURE__*/ Schema.Struct(
  {
...
export const GetPersonalizedstreamRequest = /*@__PURE__*/ Schema.Struct({
  locale: Schema.optional(Schema.String).pipe(T.HttpQuery("locale")),
  maxAllowedMaturityRating: Schema.optional(Schema.String).pipe(
    T.HttpQuery("maxAllowedMaturityRating"),
  ),
...
export const AcceptPromoofferRequest = /*@__PURE__*/ Schema.Struct({
...
export const DismissPromoofferRequest = /*@__PURE__*/ Schema.Struct({
  androidId: Schema.optional(Schema.String).pipe(T.HttpQuery("androidId")),
  device: Schema.optional(Schema.String).pipe(T.HttpQuery("device")),
  manufacturer: Schema.optional(Schema.String).pipe(
    T.HttpQuery("manufacturer"),
...
export const GetSeriesMembershipRequest = /*@__PURE__*/ Schema.Struct({
...
export const ListVolumesAssociatedRequest = /*@__PURE__*/ Schema.Struct({
  volumeId: Schema.String.pipe(T.HttpPath("volumeId")),
...
export const ListVolumesMybooksRequest = /*@__PURE__*/ Schema.Struct({
...
export const ListVolumesRecommendedRequest = /*@__PURE__*/ Schema.Struct({
  locale: Schema.optional(Schema.String).pipe(T.HttpQuery("locale")),
  maxAllowedMaturityRating: Schema.optional(Schema.String).pipe(
    T.HttpQuery("maxAllowedMaturityRating"),
  ),
...
export const RateVolumesRecommendedRequest = /*@__PURE__*/ Schema.Struct({
  locale: Schema.optional(Schema.String).pipe(T.HttpQuery("locale")),
...
export const ListVolumesUseruploadedRequest = /*@__PURE__*/ Schema.Struct({
  locale: Schema.optional(Schema.String).pipe(T.HttpQuery("locale")),
  maxResults: Schema.optional(Schema.Number).pipe(T.HttpQuery("maxResults")),
  processingState: Schema.optional(Schema.Array(Schema.String)).pipe(
    T.HttpQuery("processingState"),
