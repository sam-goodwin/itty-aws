...
export const GeoPolicy: Schema.Schema<GeoPolicy> = /*@__PURE__*/ Schema.Struct({
...
export const WrrPolicy: Schema.Schema<WrrPolicy> = /*@__PURE__*/ Schema.Struct({
...
export const DsRecord: Schema.Schema<DsRecord> = /*@__PURE__*/ Schema.Struct({
...
export const CustomDns: Schema.Schema<CustomDns> = /*@__PURE__*/ Schema.Struct({
  nameServers: Schema.optional(Schema.Array(Schema.String)),
  dsRecords: Schema.optional(Schema.Array(DsRecord)),
