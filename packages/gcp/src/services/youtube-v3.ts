...
export const TestItem: Schema.Schema<TestItem> = /*@__PURE__*/ Schema.Struct({
...
export const AbuseType: Schema.Schema<AbuseType> = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
...
export const TokenPagination: Schema.Schema<TokenPagination> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "TokenPagination" });
...
export const Thumbnail: Schema.Schema<Thumbnail> = /*@__PURE__*/ Schema.Struct({
  height: Schema.optional(Schema.Number),
...
export const Entity: Schema.Schema<Entity> = /*@__PURE__*/ Schema.Struct({
...
export const GeoPoint: Schema.Schema<GeoPoint> = /*@__PURE__*/ Schema.Struct({
...
export const Video: Schema.Schema<Video> = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
...
export const Caption: Schema.Schema<Caption> = /*@__PURE__*/ Schema.Struct({
  kind: Schema.optional(Schema.String),
  id: Schema.optional(Schema.String),
...
export const Activity: Schema.Schema<Activity> = /*@__PURE__*/ Schema.Struct({
  etag: Schema.optional(Schema.String),
  kind: Schema.optional(Schema.String),
...
export const Cuepoint: Schema.Schema<Cuepoint> = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
...
export const Playlist: Schema.Schema<Playlist> = /*@__PURE__*/ Schema.Struct({
  kind: Schema.optional(Schema.String),
...
export const ListVideoAbuseReportReasonsRequest = /*@__PURE__*/ Schema.Struct({
...
export const ListVideoCategoriesRequest = /*@__PURE__*/ Schema.Struct({
  part: Schema.Array(Schema.String).pipe(T.HttpQuery("part")),
...
export const ListThirdPartyLinksRequest = /*@__PURE__*/ Schema.Struct({
...
export const UpdateThirdPartyLinksRequest = /*@__PURE__*/ Schema.Struct({
  externalChannelId: Schema.optional(Schema.String).pipe(
    T.HttpQuery("externalChannelId"),
  ),
  part: Schema.Array(Schema.String).pipe(T.HttpQuery("part")),
...
export const DeleteThirdPartyLinksRequest = /*@__PURE__*/ Schema.Struct({
  externalChannelId: Schema.optional(Schema.String).pipe(
    T.HttpQuery("externalChannelId"),
  ),
...
export const InsertThirdPartyLinksRequest = /*@__PURE__*/ Schema.Struct({
  externalChannelId: Schema.optional(Schema.String).pipe(
    T.HttpQuery("externalChannelId"),
  ),
  part: Schema.Array(Schema.String).pipe(T.HttpQuery("part")),
...
export const UpdateCommentThreadsYoutubeV3Request = /*@__PURE__*/ Schema.Struct(
  {
...
export const ListI18nLanguagesRequest = /*@__PURE__*/ Schema.Struct({
  part: Schema.Array(Schema.String).pipe(T.HttpQuery("part")),
  hl: Schema.optional(Schema.String).pipe(T.HttpQuery("hl")),
}).pipe(
...
export const InsertAbuseReportsRequest = /*@__PURE__*/ Schema.Struct({
  part: Schema.Array(Schema.String).pipe(T.HttpQuery("part")),
...
export const ListChannelSectionsRequest = /*@__PURE__*/ Schema.Struct({
  onBehalfOfContentOwner: Schema.optional(Schema.String).pipe(
    T.HttpQuery("onBehalfOfContentOwner"),
  ),
  part: Schema.Array(Schema.String).pipe(T.HttpQuery("part")),
...
export const UpdateChannelSectionsRequest = /*@__PURE__*/ Schema.Struct({
  part: Schema.Array(Schema.String).pipe(T.HttpQuery("part")),
  onBehalfOfContentOwner: Schema.optional(Schema.String).pipe(
    T.HttpQuery("onBehalfOfContentOwner"),
  ),
...
export const DeleteChannelSectionsRequest = /*@__PURE__*/ Schema.Struct({
  onBehalfOfContentOwner: Schema.optional(Schema.String).pipe(
    T.HttpQuery("onBehalfOfContentOwner"),
  ),
  id: Schema.String.pipe(T.HttpQuery("id")),
...
export const InsertChannelSectionsRequest = /*@__PURE__*/ Schema.Struct({
  onBehalfOfContentOwnerChannel: Schema.optional(Schema.String).pipe(
    T.HttpQuery("onBehalfOfContentOwnerChannel"),
  ),
  part: Schema.Array(Schema.String).pipe(T.HttpQuery("part")),
...
export const ListLiveBroadcastsRequest = /*@__PURE__*/ Schema.Struct({
  mine: Schema.optional(Schema.Boolean).pipe(T.HttpQuery("mine")),
...
export const BindLiveBroadcastsRequest = /*@__PURE__*/ Schema.Struct({
...
export const TransitionLiveBroadcastsRequest = /*@__PURE__*/ Schema.Struct({
...
export const UpdateLiveBroadcastsRequest = /*@__PURE__*/ Schema.Struct({
  onBehalfOfContentOwner: Schema.optional(Schema.String).pipe(
    T.HttpQuery("onBehalfOfContentOwner"),
  ),
  onBehalfOfContentOwnerChannel: Schema.optional(Schema.String).pipe(
...
export const DeleteLiveBroadcastsRequest = /*@__PURE__*/ Schema.Struct({
  onBehalfOfContentOwner: Schema.optional(Schema.String).pipe(
    T.HttpQuery("onBehalfOfContentOwner"),
  ),
  id: Schema.String.pipe(T.HttpQuery("id")),
...
export const InsertLiveBroadcastsRequest = /*@__PURE__*/ Schema.Struct({
  onBehalfOfContentOwner: Schema.optional(Schema.String).pipe(
    T.HttpQuery("onBehalfOfContentOwner"),
  ),
  onBehalfOfContentOwnerChannel: Schema.optional(Schema.String).pipe(
...
export const InsertCuepointLiveBroadcastsRequest = /*@__PURE__*/ Schema.Struct({
  onBehalfOfContentOwner: Schema.optional(Schema.String).pipe(
    T.HttpQuery("onBehalfOfContentOwner"),
  ),
  part: Schema.optional(Schema.Array(Schema.String)).pipe(T.HttpQuery("part")),
...
export const DeleteLiveChatBansRequest = /*@__PURE__*/ Schema.Struct({
  id: Schema.String.pipe(T.HttpQuery("id")),
}).pipe(
...
export const InsertLiveChatBansRequest = /*@__PURE__*/ Schema.Struct({
  part: Schema.Array(Schema.String).pipe(T.HttpQuery("part")),
...
export const ListSuperChatEventsRequest = /*@__PURE__*/ Schema.Struct({
  maxResults: Schema.optional(Schema.Number).pipe(T.HttpQuery("maxResults")),
  hl: Schema.optional(Schema.String).pipe(T.HttpQuery("hl")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  part: Schema.Array(Schema.String).pipe(T.HttpQuery("part")),
...
export const ListMembershipsLevelsRequest = /*@__PURE__*/ Schema.Struct({
  part: Schema.Array(Schema.String).pipe(T.HttpQuery("part")),
}).pipe(
...
export const DeleteSubscriptionsRequest = /*@__PURE__*/ Schema.Struct({
  id: Schema.String.pipe(T.HttpQuery("id")),
}).pipe(
...
export const ListSubscriptionsRequest = /*@__PURE__*/ Schema.Struct({
  onBehalfOfContentOwner: Schema.optional(Schema.String).pipe(
    T.HttpQuery("onBehalfOfContentOwner"),
  ),
  mySubscribers: Schema.optional(Schema.Boolean).pipe(
...
export const InsertSubscriptionsRequest = /*@__PURE__*/ Schema.Struct({
  part: Schema.Array(Schema.String).pipe(T.HttpQuery("part")),
...
export const ReportAbuseVideosRequest = /*@__PURE__*/ Schema.Struct({
  onBehalfOfContentOwner: Schema.optional(Schema.String).pipe(
    T.HttpQuery("onBehalfOfContentOwner"),
  ),
...
export const DeleteVideosResponse: Schema.Schema<DeleteVideosResponse> =
  /*@__PURE__*/ Schema.Struct({}) as any as Schema.Schema<DeleteVideosResponse>;
...
export const RateVideosResponse: Schema.Schema<RateVideosResponse> =
  /*@__PURE__*/ Schema.Struct({}) as any as Schema.Schema<RateVideosResponse>;
...
export const DeleteLiveChatMessagesRequest = /*@__PURE__*/ Schema.Struct({
  id: Schema.String.pipe(T.HttpQuery("id")),
}).pipe(
...
export const ListLiveChatMessagesRequest = /*@__PURE__*/ Schema.Struct({
  profileImageSize: Schema.optional(Schema.Number).pipe(
    T.HttpQuery("profileImageSize"),
  ),
  part: Schema.Array(Schema.String).pipe(T.HttpQuery("part")),
...
export const TransitionLiveChatMessagesRequest = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String).pipe(T.HttpQuery("id")),
...
export const InsertLiveChatMessagesRequest = /*@__PURE__*/ Schema.Struct({
  part: Schema.Array(Schema.String).pipe(T.HttpQuery("part")),
...
export const DownloadCaptionsRequest = /*@__PURE__*/ Schema.Struct({
  onBehalfOfContentOwner: Schema.optional(Schema.String).pipe(
    T.HttpQuery("onBehalfOfContentOwner"),
  ),
...
export const InsertLiveStreamsRequest = /*@__PURE__*/ Schema.Struct({
  onBehalfOfContentOwner: Schema.optional(Schema.String).pipe(
    T.HttpQuery("onBehalfOfContentOwner"),
  ),
  part: Schema.Array(Schema.String).pipe(T.HttpQuery("part")),
...
export const UpdateLiveStreamsRequest = /*@__PURE__*/ Schema.Struct({
  part: Schema.Array(Schema.String).pipe(T.HttpQuery("part")),
  onBehalfOfContentOwnerChannel: Schema.optional(Schema.String).pipe(
    T.HttpQuery("onBehalfOfContentOwnerChannel"),
  ),
...
export const DeleteLiveStreamsRequest = /*@__PURE__*/ Schema.Struct({
  onBehalfOfContentOwner: Schema.optional(Schema.String).pipe(
    T.HttpQuery("onBehalfOfContentOwner"),
  ),
  id: Schema.String.pipe(T.HttpQuery("id")),
...
export const InsertLiveChatModeratorsRequest = /*@__PURE__*/ Schema.Struct({
  part: Schema.Array(Schema.String).pipe(T.HttpQuery("part")),
...
export const DeleteLiveChatModeratorsRequest = /*@__PURE__*/ Schema.Struct({
  id: Schema.String.pipe(T.HttpQuery("id")),
}).pipe(
...
export const ListLiveChatModeratorsRequest = /*@__PURE__*/ Schema.Struct({
  liveChatId: Schema.String.pipe(T.HttpQuery("liveChatId")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  part: Schema.Array(Schema.String).pipe(T.HttpQuery("part")),
  maxResults: Schema.optional(Schema.Number).pipe(T.HttpQuery("maxResults")),
...
export const ListCommentThreadsRequest = /*@__PURE__*/ Schema.Struct({
...
export const InsertCommentThreadsRequest = /*@__PURE__*/ Schema.Struct({
  part: Schema.Array(Schema.String).pipe(T.HttpQuery("part")),
  body: Schema.optional(CommentThread).pipe(T.HttpBody()),
}).pipe(
...
export const InsertChannelBannersRequest = /*@__PURE__*/ Schema.Struct({
  onBehalfOfContentOwnerChannel: Schema.optional(Schema.String).pipe(
    T.HttpQuery("onBehalfOfContentOwnerChannel"),
  ),
  channelId: Schema.optional(Schema.String).pipe(T.HttpQuery("channelId")),
...
export const GetVideoTrainabilityRequest = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String).pipe(T.HttpQuery("id")),
}).pipe(
...
export const InsertPlaylistImagesRequest = /*@__PURE__*/ Schema.Struct({
  part: Schema.optional(Schema.Array(Schema.String)).pipe(T.HttpQuery("part")),
  onBehalfOfContentOwnerChannel: Schema.optional(Schema.String).pipe(
    T.HttpQuery("onBehalfOfContentOwnerChannel"),
  ),
...
export const ListPlaylistImagesRequest = /*@__PURE__*/ Schema.Struct({
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  onBehalfOfContentOwnerChannel: Schema.optional(Schema.String).pipe(
    T.HttpQuery("onBehalfOfContentOwnerChannel"),
  ),
...
export const UpdatePlaylistImagesRequest = /*@__PURE__*/ Schema.Struct({
  part: Schema.optional(Schema.Array(Schema.String)).pipe(T.HttpQuery("part")),
  onBehalfOfContentOwner: Schema.optional(Schema.String).pipe(
    T.HttpQuery("onBehalfOfContentOwner"),
  ),
...
export const DeletePlaylistImagesRequest = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String).pipe(T.HttpQuery("id")),
  onBehalfOfContentOwner: Schema.optional(Schema.String).pipe(
    T.HttpQuery("onBehalfOfContentOwner"),
  ),
...
export const SetModerationStatusCommentsRequest = /*@__PURE__*/ Schema.Struct({
...
export const MarkAsSpamCommentsRequest = /*@__PURE__*/ Schema.Struct({
  id: Schema.Array(Schema.String).pipe(T.HttpQuery("id")),
}).pipe(
  T.Http({
    method: "POST",
...
export const ListPlaylistItemsRequest = /*@__PURE__*/ Schema.Struct({
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
...
export const DeletePlaylistItemsRequest = /*@__PURE__*/ Schema.Struct({
  id: Schema.String.pipe(T.HttpQuery("id")),
  onBehalfOfContentOwner: Schema.optional(Schema.String).pipe(
    T.HttpQuery("onBehalfOfContentOwner"),
  ),
...
export const UpdatePlaylistItemsRequest = /*@__PURE__*/ Schema.Struct({
  part: Schema.Array(Schema.String).pipe(T.HttpQuery("part")),
  onBehalfOfContentOwner: Schema.optional(Schema.String).pipe(
    T.HttpQuery("onBehalfOfContentOwner"),
  ),
...
export const InsertPlaylistItemsRequest = /*@__PURE__*/ Schema.Struct({
  part: Schema.Array(Schema.String).pipe(T.HttpQuery("part")),
  onBehalfOfContentOwner: Schema.optional(Schema.String).pipe(
    T.HttpQuery("onBehalfOfContentOwner"),
  ),
