...
export const CheckExchangeDeviceTokenProjectAppRequest =
  /*@__PURE__*/ S.suspend(() =>
    ...
    identifier: "CheckExchangeDeviceTokenProjectAppRequest",
  }) as any as S.Schema<CheckExchangeDeviceTokenProjectAppRequest>;
...
export interface GoogleFirebaseAppcheckV1LimitedUseConfig {
...
export const GoogleFirebaseAppcheckV1LimitedUseConfig = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      jti: S.optional(S.String),
    }),
).annotate({
  identifier: "GoogleFirebaseAppcheckV1LimitedUseConfig",
}) as any as S.Schema<GoogleFirebaseAppcheckV1LimitedUseConfig>;

/** Request message for the MintAppCheckToken method. */
export interface GoogleFirebaseAppcheckV1MintAppCheckTokenRequest {
  ...
  limitedUseConfig?: GoogleFirebaseAppcheckV1LimitedUseConfig;
}
export const GoogleFirebaseAppcheckV1MintAppCheckTokenRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      tokenTtl: S.optional(S.String),
      limitedUseConfig: S.optional(GoogleFirebaseAppcheckV1LimitedUseConfig),
    }),
  ).annotate({
    identifier: "GoogleFirebaseAppcheckV1MintAppCheckTokenRequest",
  }) as any as S.Schema<GoogleFirebaseAppcheckV1MintAppCheckTokenRequest>;

export interface CheckMintAppTokenProjectAppRequest {
  /** Required. The relative resource name of the app, in the format: ``` projects/{project_number}/apps/{app_id} ``` If necessary, the `project_number` element can be replaced with the project ID of the Firebase project. Learn more about using project identifiers in Google's [AIP 2510](https://google.aip.dev/cloud/2510) standard. */
  app: string;
  /** Request body */
  body?: GoogleFirebaseAppcheckV1MintAppCheckTokenRequest;
}
export const CheckMintAppTokenProjectAppRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    app: S.String.pipe(T.Label()),
    body: S.optional(
      GoogleFirebaseAppcheckV1MintAppCheckTokenRequest.pipe(T.HttpBody()),
    ),
  }).pipe(
    T.Http({
      method: "POST",
      uri: "v1/{+app}:mintAppCheckToken",
      baseUrl: "https://firebaseappcheck.googleapis.com/",
    }),
  ),
).annotate({
  identifier: "CheckMintAppTokenProjectAppRequest",
}) as any as S.Schema<CheckMintAppTokenProjectAppRequest>;

/** Response message for the MintAppCheckToken method. */
export interface GoogleFirebaseAppcheckV1MintAppCheckTokenResponse {
  /** The duration from the time this token is minted until its expiration. This field is intended to ease client-side token management, since the client may have clock skew, but is still able to accurately measure a duration. */
  ttl?: string;
...
export const GoogleFirebaseAppcheckV1MintAppCheckTokenResponse =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ttl: S.optional(S.String),
      token: S.optional(S.String),
    ...
    identifier: "GoogleFirebaseAppcheckV1MintAppCheckTokenResponse",
  }) as any as S.Schema<GoogleFirebaseAppcheckV1MintAppCheckTokenResponse>;
...
export interface GetBatchProjectAppAppAttestConfigRequest {
...
export const GetBatchProjectAppAppAttestConfigRequest = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      names: S.optional(StringList.pipe(T.Query())),
      parent: S.String.pipe(T.Label()),
  ...
  identifier: "GetBatchProjectAppAppAttestConfigRequest",
}) as any as S.Schema<GetBatchProjectAppAppAttestConfigRequest>;
...
export interface GetBatchProjectAppPlayIntegrityConfigRequest {
...
export const GetBatchProjectAppPlayIntegrityConfigRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      names: S.optional(StringList.pipe(T.Query())),
      parent: S.String.pipe(T.Label()),
    ...
    identifier: "GetBatchProjectAppPlayIntegrityConfigRequest",
  }) as any as S.Schema<GetBatchProjectAppPlayIntegrityConfigRequest>;
...
export interface GetBatchProjectAppRecaptchaEnterpriseConfigRequest {
...
export const GetBatchProjectAppRecaptchaEnterpriseConfigRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      parent: S.String.pipe(T.Label()),
      names: S.optional(StringList.pipe(T.Query())),
    ...
    identifier: "GetBatchProjectAppRecaptchaEnterpriseConfigRequest",
  }) as any as S.Schema<GetBatchProjectAppRecaptchaEnterpriseConfigRequest>;
...
export interface GetBatchProjectAppRecaptchaV3ConfigRequest {
...
export const GetBatchProjectAppRecaptchaV3ConfigRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      names: S.optional(StringList.pipe(T.Query())),
      parent: S.String.pipe(T.Label()),
    ...
    identifier: "GetBatchProjectAppRecaptchaV3ConfigRequest",
  }) as any as S.Schema<GetBatchProjectAppRecaptchaV3ConfigRequest>;
...
export interface UpdateBatchProjectServiceRequest {
...
export const UpdateBatchProjectServiceRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    parent: S.String.pipe(T.Label()),
    body: S.optional(
  ...
  identifier: "UpdateBatchProjectServiceRequest",
}) as any as S.Schema<UpdateBatchProjectServiceRequest>;
...
export interface UpdateBatchProjectServiceResourcePolicyRequest {
...
export const UpdateBatchProjectServiceResourcePolicyRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      parent: S.String.pipe(T.Label()),
      body: S.optional(
    ...
    identifier: "UpdateBatchProjectServiceResourcePolicyRequest",
  }) as any as S.Schema<UpdateBatchProjectServiceResourcePolicyRequest>;
...
export type CheckExchangeDeviceTokenProjectAppError =
  | NotFound
  | Forbidden
  | BadRequest
  | Conflict
...
export const checkExchangeDeviceTokenProjectApp: API.OperationMethod<
  CheckExchangeDeviceTokenProjectAppRequest,
  GoogleFirebaseAppcheckV1AppCheckToken,
  CheckExchangeDeviceTokenProjectAppError,
  GcpOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: CheckExchangeDeviceTokenProjectAppRequest,
...
export type CheckMintAppTokenProjectAppError =
  | NotFound
  | Forbidden
  | BadRequest
  | Conflict
...
export const checkMintAppTokenProjectApp: API.OperationMethod<
  CheckMintAppTokenProjectAppRequest,
  GoogleFirebaseAppcheckV1MintAppCheckTokenResponse,
  CheckMintAppTokenProjectAppError,
  GcpOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: CheckMintAppTokenProjectAppRequest,
...
export type GetBatchProjectAppAppAttestConfigError =
  | NotFound
  | Forbidden
  | GcpOpError;
/** Atomically gets the AppAttestConfigs for the specified list of apps. */
export const getBatchProjectAppAppAttestConfig: API.OperationMethod<
  GetBatchProjectAppAppAttestConfigRequest,
  GoogleFirebaseAppcheckV1BatchGetAppAttestConfigsResponse,
  GetBatchProjectAppAppAttestConfigError,
  GcpOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetBatchProjectAppAppAttestConfigRequest,
...
export type GetBatchProjectAppPlayIntegrityConfigError =
  | NotFound
  | Forbidden
  | GcpOpError;
/** Atomically gets the PlayIntegrityConfigs for the specified list of apps. */
export const getBatchProjectAppPlayIntegrityConfig: API.OperationMethod<
  GetBatchProjectAppPlayIntegrityConfigRequest,
  GoogleFirebaseAppcheckV1BatchGetPlayIntegrityConfigsResponse,
  GetBatchProjectAppPlayIntegrityConfigError,
  GcpOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetBatchProjectAppPlayIntegrityConfigRequest,
...
export type GetBatchProjectAppRecaptchaEnterpriseConfigError =
  | NotFound
  | Forbidden
  | GcpOpError;
/** Atomically gets the RecaptchaEnterpriseConfigs for the specified list of apps. */
export const getBatchProjectAppRecaptchaEnterpriseConfig: API.OperationMethod<
  GetBatchProjectAppRecaptchaEnterpriseConfigRequest,
  GoogleFirebaseAppcheckV1BatchGetRecaptchaEnterpriseConfigsResponse,
  GetBatchProjectAppRecaptchaEnterpriseConfigError,
  GcpOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetBatchProjectAppRecaptchaEnterpriseConfigRequest,
...
export type GetBatchProjectAppRecaptchaV3ConfigError =
  | NotFound
  | Forbidden
  | GcpOpError;
/** Atomically gets the RecaptchaV3Configs for the specified list of apps. For security reasons, the `site_secret` field is never populated in the response. */
export const getBatchProjectAppRecaptchaV3Config: API.OperationMethod<
  GetBatchProjectAppRecaptchaV3ConfigRequest,
  GoogleFirebaseAppcheckV1BatchGetRecaptchaV3ConfigsResponse,
  GetBatchProjectAppRecaptchaV3ConfigError,
  GcpOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetBatchProjectAppRecaptchaV3ConfigRequest,
...
export type UpdateBatchProjectServiceError =
  | NotFound
  | Forbidden
  | BadRequest
  | Conflict
...
export const updateBatchProjectService: API.OperationMethod<
  UpdateBatchProjectServiceRequest,
  GoogleFirebaseAppcheckV1BatchUpdateServicesResponse,
  UpdateBatchProjectServiceError,
  GcpOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: UpdateBatchProjectServiceRequest,
...
export type UpdateBatchProjectServiceResourcePolicyError =
  | NotFound
  | Forbidden
  | BadRequest
  | Conflict
...
export const updateBatchProjectServiceResourcePolicy: API.OperationMethod<
  UpdateBatchProjectServiceResourcePolicyRequest,
  GoogleFirebaseAppcheckV1BatchUpdateResourcePoliciesResponse,
  UpdateBatchProjectServiceResourcePolicyError,
  GcpOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: UpdateBatchProjectServiceResourcePolicyRequest,
