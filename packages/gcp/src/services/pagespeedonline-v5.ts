...
export const StackPack: Schema.Schema<StackPack> = /*@__PURE__*/ Schema.Struct({
...
export const AuditRefs: Schema.Schema<AuditRefs> = /*@__PURE__*/ Schema.Struct({
...
export const Timing: Schema.Schema<Timing> = /*@__PURE__*/ Schema.Struct({
...
export const LhrEntity: Schema.Schema<LhrEntity> = /*@__PURE__*/ Schema.Struct({
...
export const I18n: Schema.Schema<I18n> = /*@__PURE__*/ Schema.Struct({
...
export const RunpagespeedPagespeedapiRequest = /*@__PURE__*/ Schema.Struct({
...
export const RunpagespeedPagespeedapiResponse =
  /*@__PURE__*/ PagespeedApiPagespeedResponseV5;
