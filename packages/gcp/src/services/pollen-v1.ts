...
export const IndexInfo: Schema.Schema<IndexInfo> = /*@__PURE__*/ Schema.Struct({
...
export const PlantInfo: Schema.Schema<PlantInfo> = /*@__PURE__*/ Schema.Struct({
...
export const DayInfo: Schema.Schema<DayInfo> = /*@__PURE__*/ Schema.Struct({
