...
export const CancelPreviewDeploymentsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    T.Http({
      method: "POST",
      uri: "deploymentmanager/v2beta/projects/{project}/global/deployments/{deployment}/cancelPreview",
...
export const DeleteCompositeTypesRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    T.Http({
      method: "DELETE",
      uri: "deploymentmanager/v2beta/projects/{project}/global/compositeTypes/{compositeType}",
      baseUrl: "https://deploymentmanager.googleapis.com/",
    }),
  ),
).annotate({
...
export interface DeleteDeploymentsRequest {
  ...
  deletePolicy?: DeleteDeploymentsDeletePolicyEnum;
  "header.bypassBillingFilter"?: boolean;
}
export const DeleteDeploymentsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    T.Http({
      method: "DELETE",
      uri: "deploymentmanager/v2beta/projects/{project}/global/deployments/{deployment}",
      baseUrl: "https://deploymentmanager.googleapis.com/",
    }),
  ),
).annotate({
...
export const DeleteTypeProvidersRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    T.Http({
      method: "DELETE",
      uri: "deploymentmanager/v2beta/projects/{project}/global/typeProviders/{typeProvider}",
      baseUrl: "https://deploymentmanager.googleapis.com/",
    }),
  ),
).annotate({
...
export type CompositeTypeLabelEntryList =
  ReadonlyArray<CompositeTypeLabelEntry>;
...
export const GetIamPolicyDeploymentsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    T.Http({
      method: "GET",
      uri: "deploymentmanager/v2beta/projects/{project}/global/deployments/{resource}/getIamPolicy",
      baseUrl: "https://deploymentmanager.googleapis.com/",
    }),
  ),
).annotate({
...
export const GetManifestsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    T.Http({
      method: "GET",
      uri: "deploymentmanager/v2beta/projects/{project}/global/deployments/{deployment}/manifests/{manifest}",
      baseUrl: "https://deploymentmanager.googleapis.com/",
    }),
  ),
).annotate({
...
export const GetOperationsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    T.Http({
      method: "GET",
      uri: "deploymentmanager/v2beta/projects/{project}/global/operations/{operation}",
      baseUrl: "https://deploymentmanager.googleapis.com/",
    }),
  ),
).annotate({
...
export const GetResourcesRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    T.Http({
      method: "GET",
      uri: "deploymentmanager/v2beta/projects/{project}/global/deployments/{deployment}/resources/{resource}",
      baseUrl: "https://deploymentmanager.googleapis.com/",
    }),
  ),
).annotate({
...
export const ResourceUpdateWarningsItemDataItem = /*@__PURE__*/ S.suspend(() =>
  ...
  identifier: "ResourceUpdateWarningsItemDataItem",
...
}) as any as S.Schema<TypeProviderLabelEntry>;
...
export const GetTypeTypeProvidersRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    T.Http({
      method: "GET",
      uri: "deploymentmanager/v2beta/projects/{project}/global/typeProviders/{typeProvider}/types/{type}",
      baseUrl: "https://deploymentmanager.googleapis.com/",
    }),
  ),
).annotate({
...
export const InsertCompositeTypesRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    T.Http({
      method: "POST",
      uri: "deploymentmanager/v2beta/projects/{project}/global/compositeTypes",
      baseUrl: "https://deploymentmanager.googleapis.com/",
    }),
  ),
).annotate({
...
export interface InsertDeploymentsRequest {
  ...
  createPolicy?: InsertDeploymentsCreatePolicyEnum;
  "header.bypassBillingFilter"?: boolean;
  /** Request body */
  body?: Deployment;
}
export const InsertDeploymentsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    T.Http({
      method: "POST",
      uri: "deploymentmanager/v2beta/projects/{project}/global/deployments",
      baseUrl: "https://deploymentmanager.googleapis.com/",
    }),
  ),
).annotate({
...
export const InsertTypeProvidersRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    T.Http({
      method: "POST",
      uri: "deploymentmanager/v2beta/projects/{project}/global/typeProviders",
      baseUrl: "https://deploymentmanager.googleapis.com/",
    }),
  ),
).annotate({
...
export const ListManifestsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    T.Http({
      method: "GET",
      uri: "deploymentmanager/v2beta/projects/{project}/global/deployments/{deployment}/manifests",
      baseUrl: "https://deploymentmanager.googleapis.com/",
    }),
  ),
).annotate({
...
export const ListOperationsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    T.Http({
      method: "GET",
      uri: "deploymentmanager/v2beta/projects/{project}/global/operations",
      baseUrl: "https://deploymentmanager.googleapis.com/",
    }),
  ),
).annotate({
...
export const ListResourcesRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    T.Http({
      method: "GET",
      uri: "deploymentmanager/v2beta/projects/{project}/global/deployments/{deployment}/resources",
      baseUrl: "https://deploymentmanager.googleapis.com/",
    }),
  ),
).annotate({
...
export const ListTypesRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    T.Http({
      method: "GET",
      uri: "deploymentmanager/v2beta/projects/{project}/global/types",
      baseUrl: "https://deploymentmanager.googleapis.com/",
    }),
  ),
).annotate({
...
export const ListTypesTypeProvidersRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    T.Http({
      method: "GET",
      uri: "deploymentmanager/v2beta/projects/{project}/global/typeProviders/{typeProvider}/types",
      baseUrl: "https://deploymentmanager.googleapis.com/",
    }),
  ),
).annotate({
...
export interface PatchDeploymentsRequest {
  ...
  deployment: string;
  /** Sets the policy to use for creating new resources. */
  createPolicy?: PatchDeploymentsCreatePolicyEnum;
  /** Sets the policy to use for deleting resources. */
  deletePolicy?: PatchDeploymentsDeletePolicyEnum;
...
export const SetIamPolicyDeploymentsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    T.Http({
      method: "POST",
      uri: "deploymentmanager/v2beta/projects/{project}/global/deployments/{resource}/setIamPolicy",
      baseUrl: "https://deploymentmanager.googleapis.com/",
    }),
  ),
).annotate({
...
export const StopDeploymentsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    T.Http({
      method: "POST",
      uri: "deploymentmanager/v2beta/projects/{project}/global/deployments/{deployment}/stop",
      baseUrl: "https://deploymentmanager.googleapis.com/",
    }),
  ),
).annotate({
...
export const TestIamPermissionsDeploymentsRequest = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      ...
      T.Http({
        method: "POST",
        uri: "deploymentmanager/v2beta/projects/{project}/global/deployments/{resource}/testIamPermissions",
        baseUrl: "https://deploymentmanager.googleapis.com/",
      }),
    ),
).annotate({
...
export interface UpdateDeploymentsRequest {
  ...
  deployment: string;
  /** Sets the policy to use for creating new resources. */
  createPolicy?: UpdateDeploymentsCreatePolicyEnum;
  /** Sets the policy to use for deleting resources. */
  deletePolicy?: UpdateDeploymentsDeletePolicyEnum;
  /** If set to true, updates the deployment and creates and updates the "shell" resources but does not actually alter or instantiate these resources. This allows you to preview what your deployment will look like. You can use this intent to preview how an update would affect your deployment. You must provide a `target.config` with a configuration if this is set to true. After previewing a deployment, you can deploy your resources by making a request with the `update()` or you can `cancelPreview()` to remove the preview altogether. Note that the deployment will still exist after you cancel the preview and you must separately delete this deployment if you want to remove it. */
  preview?: boolean;
  "header.bypassBillingFilter"?: boolean;
  /** Request body */
