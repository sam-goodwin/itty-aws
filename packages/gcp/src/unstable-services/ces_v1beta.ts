...
export type EvaluationResultOutcomeMetadataEnum =
  ...
  | "GRACEFUL_HANDOFF";
export const EvaluationResultOutcomeMetadataEnum = /*@__PURE__*/ S.String;
...
export type RunEvaluationResultMetricsRequest = CancelOperationRequest;
export const RunEvaluationResultMetricsRequest = CancelOperationRequest;
...
export const StreamProjectsLocationsAppsDeploymentsMessageRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "POST",
        uri: "v1beta/{+tenant}/message:stream",
        baseUrl: "https://ces.googleapis.com/",
      }),
    ),
  ).annotate({
