...
export const Turn: Schema.Schema<Turn> = /*@__PURE__*/ Schema.Struct({
...
export const Timepoint: Schema.Schema<Timepoint> = /*@__PURE__*/ Schema.Struct({
...
export const Voice: Schema.Schema<Voice> = /*@__PURE__*/ Schema.Struct({
