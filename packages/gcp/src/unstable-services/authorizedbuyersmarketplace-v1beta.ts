...
export const AdSize: Schema.Schema<AdSize> = /*@__PURE__*/ Schema.Struct({
...
export const CreateCuratorsCuratedPackagesRequest = /*@__PURE__*/ Schema.Struct(
  {
...
export const PatchCuratorsCuratedPackagesRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetCuratorsCuratedPackagesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
...
export const ListCuratorsCuratedPackagesRequest = /*@__PURE__*/ Schema.Struct({
...
export const ListCuratorsDataSegmentsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
}).pipe(
...
export const ActivateCuratorsDataSegmentsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const CreateCuratorsDataSegmentsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const PatchCuratorsDataSegmentsRequest = /*@__PURE__*/ Schema.Struct({
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(DataSegment).pipe(T.HttpBody()),
}).pipe(
...
export const GetCuratorsDataSegmentsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta/{+name}" }),
  svc,
...
export const ListMediaPlannersRequest = /*@__PURE__*/ Schema.Struct({
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
}).pipe(
