...
}).pipe(T.Http({"method":"POST","uri":"v1beta/{+parent}/customers","baseUrl":"https://cloudcontrolspartner.googleapis.com/"})),
...
}).pipe(T.Http({"method":"DELETE","uri":"v1beta/{+name}","baseUrl":"https://cloudcontrolspartner.googleapis.com/"})),
...
S.Struct({
  "name": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v1beta/{+name}","baseUrl":"https://cloudcontrolspartner.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v1beta/{+parent}/customers","baseUrl":"https://cloudcontrolspartner.googleapis.com/"})),
...
S.Struct({
  ...
  "filter": S.optional(S.String.pipe(T.Query())),
  "pageToken": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1beta/{+parent}/workloads","baseUrl":"https://cloudcontrolspartner.googleapis.com/"})),
...
S.Struct({
  ...
  "parent": S.String.pipe(T.Label()),
  "orderBy": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1beta/{+parent}/accessApprovalRequests","baseUrl":"https://cloudcontrolspartner.googleapis.com/"})),
...
S.Struct({
  ...
  "filter": S.optional(S.String.pipe(T.Query())),
  "pageSize": S.optional(S.Number.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1beta/{+parent}/violations","baseUrl":"https://cloudcontrolspartner.googleapis.com/"})),
...
S.Struct({
  ...
  "name": S.String.pipe(T.Label()),
  "body": S.optional(Customer.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"PATCH","uri":"v1beta/{+name}","baseUrl":"https://cloudcontrolspartner.googleapis.com/"})),
