...
export const HelpLink: Schema.Schema<HelpLink> = /*@__PURE__*/ Schema.Struct({
...
export const BasicAuth: Schema.Schema<BasicAuth> = /*@__PURE__*/ Schema.Struct({
  user: Schema.optional(Schema.String),
...
export const DeploymentOutputEntry: Schema.Schema<DeploymentOutputEntry> =
  /*@__PURE__*/ Schema.Struct({
    key: Schema.optional(Schema.String),
    value: Schema.optional(Schema.String),
  }).annotate({ identifier: "DeploymentOutputEntry" });
...
export interface Deployment {
  ...
  outputs?: ReadonlyArray<DeploymentOutputEntry>;
...
export const Manifest: Schema.Schema<Manifest> = /*@__PURE__*/ Schema.Struct({
  selfLink: Schema.optional(Schema.String),
  id: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  config: Schema.optional(ConfigFile),
...
export const MethodMap: Schema.Schema<MethodMap> = /*@__PURE__*/ Schema.Struct({
...
export const TypeInfo: Schema.Schema<TypeInfo> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
  title: Schema.optional(Schema.String),
  description: Schema.optional(Schema.String),
...
export const BaseType: Schema.Schema<BaseType> = /*@__PURE__*/ Schema.Struct({
  descriptorUrl: Schema.optional(Schema.String),
  credential: Schema.optional(Credential),
  options: Schema.optional(Options),
  collectionOverrides: Schema.optional(Schema.Array(CollectionOverride)),
...
export const InsertCompositeTypesRequest = /*@__PURE__*/ Schema.Struct({
...
export const UpdateCompositeTypesRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
...
export const PatchCompositeTypesRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  compositeType: Schema.String.pipe(T.HttpPath("compositeType")),
  "header.bypassBillingFilter": Schema.optional(Schema.Boolean).pipe(
    T.HttpQuery("header.bypassBillingFilter"),
...
export const DeleteCompositeTypesRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  compositeType: Schema.String.pipe(T.HttpPath("compositeType")),
  "header.bypassBillingFilter": Schema.optional(Schema.Boolean).pipe(
    T.HttpQuery("header.bypassBillingFilter"),
...
export const GetCompositeTypesRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  compositeType: Schema.String.pipe(T.HttpPath("compositeType")),
  "header.bypassBillingFilter": Schema.optional(Schema.Boolean).pipe(
    T.HttpQuery("header.bypassBillingFilter"),
...
export const ListCompositeTypesRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
...
export const InsertDeploymentsRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
...
export const UpdateDeploymentsRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
...
export const PatchDeploymentsRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  deployment: Schema.String.pipe(T.HttpPath("deployment")),
  createPolicy: Schema.optional(Schema.String).pipe(
    T.HttpQuery("createPolicy"),
...
export const DeleteDeploymentsRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  deployment: Schema.String.pipe(T.HttpPath("deployment")),
  deletePolicy: Schema.optional(Schema.String).pipe(
    T.HttpQuery("deletePolicy"),
...
export const CancelPreviewDeploymentsRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  deployment: Schema.String.pipe(T.HttpPath("deployment")),
...
export const GetIamPolicyDeploymentsRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
...
export const SetIamPolicyDeploymentsRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  resource: Schema.String.pipe(T.HttpPath("resource")),
...
export const TestIamPermissionsDeploymentsRequest = /*@__PURE__*/ Schema.Struct(
  {
    project: Schema.String.pipe(T.HttpPath("project")),
    resource: Schema.String.pipe(T.HttpPath("resource")),
    "header.bypassBillingFilter": Schema.optional(Schema.Boolean).pipe(
...
export const InsertTypeProvidersRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  "header.bypassBillingFilter": Schema.optional(Schema.Boolean).pipe(
    T.HttpQuery("header.bypassBillingFilter"),
  ),
...
export const UpdateTypeProvidersRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
...
export const PatchTypeProvidersRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  typeProvider: Schema.String.pipe(T.HttpPath("typeProvider")),
  "header.bypassBillingFilter": Schema.optional(Schema.Boolean).pipe(
    T.HttpQuery("header.bypassBillingFilter"),
...
export const DeleteTypeProvidersRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  typeProvider: Schema.String.pipe(T.HttpPath("typeProvider")),
  "header.bypassBillingFilter": Schema.optional(Schema.Boolean).pipe(
    T.HttpQuery("header.bypassBillingFilter"),
...
export const GetTypeProvidersRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  typeProvider: Schema.String.pipe(T.HttpPath("typeProvider")),
  "header.bypassBillingFilter": Schema.optional(Schema.Boolean).pipe(
    T.HttpQuery("header.bypassBillingFilter"),
...
export const ListTypeProvidersRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  maxResults: Schema.optional(Schema.Number).pipe(T.HttpQuery("maxResults")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
...
export const ListTypesTypeProvidersRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  typeProvider: Schema.String.pipe(T.HttpPath("typeProvider")),
  maxResults: Schema.optional(Schema.Number).pipe(T.HttpQuery("maxResults")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
...
export const GetTypeTypeProvidersRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  typeProvider: Schema.String.pipe(T.HttpPath("typeProvider")),
...
export const GetTypesRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  type: Schema.String.pipe(T.HttpPath("type")),
  "header.bypassBillingFilter": Schema.optional(Schema.Boolean).pipe(
    T.HttpQuery("header.bypassBillingFilter"),
...
export const GetTypesResponse = /*@__PURE__*/ Type;
