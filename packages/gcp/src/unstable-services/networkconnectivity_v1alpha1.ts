...
export type InternalRangeOverlapsItemEnumList = InternalRangeOverlapsItemEnum[];
...
export type RouterApplianceInstanceList = RouterApplianceInstance[];
...
export type InternalRangeList = InternalRange[];
