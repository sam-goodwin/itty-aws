...
export const Blob: Schema.Schema<Blob> = /*@__PURE__*/ Schema.Struct({
...
export const ToolCall: Schema.Schema<ToolCall> = /*@__PURE__*/ Schema.Struct({
...
export const Chunk: Schema.Schema<Chunk> = /*@__PURE__*/ Schema.Struct({
...
export const Event: Schema.Schema<Event> = /*@__PURE__*/ Schema.Struct({
...
export const ToolCalls: Schema.Schema<ToolCalls> = /*@__PURE__*/ Schema.Struct({
...
export const Citations: Schema.Schema<Citations> = /*@__PURE__*/ Schema.Struct({
...
export const Span: Schema.Schema<Span> = /*@__PURE__*/ Schema.suspend(() =>
  Schema.Struct({
    name: Schema.optional(Schema.String),
...
export const AgentLlmAgent: Schema.Schema<AgentLlmAgent> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "AgentLlmAgent" });
...
export const Callback: Schema.Schema<Callback> = /*@__PURE__*/ Schema.Struct({
...
export const Agent: Schema.Schema<Agent> = /*@__PURE__*/ Schema.Struct({
...
export const TlsConfig: Schema.Schema<TlsConfig> = /*@__PURE__*/ Schema.Struct({
...
export const DataStore: Schema.Schema<DataStore> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
...
export const McpTool: Schema.Schema<McpTool> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
  description: Schema.optional(Schema.String),
...
export const AgentTool: Schema.Schema<AgentTool> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
  description: Schema.optional(Schema.String),
  rootAgent: Schema.optional(Schema.String),
  agent: Schema.optional(Schema.String),
...
export const CodeBlock: Schema.Schema<CodeBlock> = /*@__PURE__*/ Schema.Struct({
  pythonCode: Schema.optional(Schema.String),
...
export const Tool: Schema.Schema<Tool> = /*@__PURE__*/ Schema.Struct({
...
export const Guardrail: Schema.Schema<Guardrail> = /*@__PURE__*/ Schema.Struct({
...
export const Toolset: Schema.Schema<Toolset> = /*@__PURE__*/ Schema.Struct({
...
export const ListProjectsLocationsAppsRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetProjectsLocationsAppsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta/{+name}" }),
  svc,
...
export const CreateProjectsLocationsAppsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const PatchProjectsLocationsAppsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(App).pipe(T.HttpBody()),
}).pipe(
...
export const DeleteProjectsLocationsAppsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const GetProjectsLocationsAppsToolsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
  },
).pipe(
