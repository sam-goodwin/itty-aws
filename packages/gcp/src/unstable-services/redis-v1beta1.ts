...
export const GoogleCloudRedisV1beta1ZoneMetadata: Schema.Codec<GoogleCloudRedisV1beta1ZoneMetadata> =
  /*@__PURE__*/ Schema.Struct({}).annotate({
...
export const GoogleCloudRedisV1beta1LocationMetadata: Schema.Codec<GoogleCloudRedisV1beta1LocationMetadata> =
  /*@__PURE__*/ Schema.Struct({
