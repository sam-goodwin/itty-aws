...
export const LfpStore: Schema.Schema<LfpStore> = /*@__PURE__*/ Schema.Struct({
...
export const LfpSale: Schema.Schema<LfpSale> = /*@__PURE__*/ Schema.Struct({
  storeCode: Schema.optional(Schema.String),
  targetAccount: Schema.optional(Schema.String),
...
export const InsertAccountsLfpInventoriesRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetAccountsLfpMerchantStatesRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetAccountsLfpStoresRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "lfp/v1/{+name}" }),
  svc,
...
export const ListAccountsLfpStoresRequest = /*@__PURE__*/ Schema.Struct({
...
export const InsertAccountsLfpStoresRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const DeleteAccountsLfpStoresRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
...
export const InsertAccountsLfpSalesRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
