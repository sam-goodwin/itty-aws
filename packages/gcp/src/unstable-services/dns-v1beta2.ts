...
export const DnsKey: Schema.Schema<DnsKey> = /*@__PURE__*/ Schema.Struct({
...
export const CreateResponsePolicyRulesRequest = /*@__PURE__*/ Schema.Struct({
...
export const PatchResponsePolicyRulesRequest = /*@__PURE__*/ Schema.Struct({
...
export const UpdateResponsePolicyRulesRequest = /*@__PURE__*/ Schema.Struct({
  responsePolicyRule: Schema.String.pipe(T.HttpPath("responsePolicyRule")),
  project: Schema.String.pipe(T.HttpPath("project")),
  responsePolicy: Schema.String.pipe(T.HttpPath("responsePolicy")),
  clientOperationId: Schema.optional(Schema.String).pipe(
...
export const DeleteResponsePolicyRulesRequest = /*@__PURE__*/ Schema.Struct({
  responsePolicy: Schema.String.pipe(T.HttpPath("responsePolicy")),
  clientOperationId: Schema.optional(Schema.String).pipe(
    T.HttpQuery("clientOperationId"),
  ),
...
export const GetResponsePolicyRulesRequest = /*@__PURE__*/ Schema.Struct({
  responsePolicy: Schema.String.pipe(T.HttpPath("responsePolicy")),
  clientOperationId: Schema.optional(Schema.String).pipe(
    T.HttpQuery("clientOperationId"),
  ),
...
export const ListResponsePolicyRulesRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  responsePolicy: Schema.String.pipe(T.HttpPath("responsePolicy")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  maxResults: Schema.optional(Schema.Number).pipe(T.HttpQuery("maxResults")),
...
export const GetManagedZoneOperationsRequest = /*@__PURE__*/ Schema.Struct({
...
export const ListManagedZoneOperationsRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  managedZone: Schema.String.pipe(T.HttpPath("managedZone")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  maxResults: Schema.optional(Schema.Number).pipe(T.HttpQuery("maxResults")),
...
export const ListResourceRecordSetsRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetResourceRecordSetsRequest = /*@__PURE__*/ Schema.Struct({
...
export const DeleteResourceRecordSetsRequest = /*@__PURE__*/ Schema.Struct({
  type: Schema.String.pipe(T.HttpPath("type")),
  clientOperationId: Schema.optional(Schema.String).pipe(
    T.HttpQuery("clientOperationId"),
  ),
...
export const CreateResourceRecordSetsRequest = /*@__PURE__*/ Schema.Struct({
  clientOperationId: Schema.optional(Schema.String).pipe(
    T.HttpQuery("clientOperationId"),
  ),
  project: Schema.String.pipe(T.HttpPath("project")),
...
export const PatchResourceRecordSetsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  clientOperationId: Schema.optional(Schema.String).pipe(
    T.HttpQuery("clientOperationId"),
  ),
...
export const ListManagedZonesRequest = /*@__PURE__*/ Schema.Struct({
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  project: Schema.String.pipe(T.HttpPath("project")),
...
export const CreateManagedZonesRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  clientOperationId: Schema.optional(Schema.String).pipe(
    T.HttpQuery("clientOperationId"),
  ),
...
export const PatchManagedZonesRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  managedZone: Schema.String.pipe(T.HttpPath("managedZone")),
  clientOperationId: Schema.optional(Schema.String).pipe(
    T.HttpQuery("clientOperationId"),
...
export const UpdateManagedZonesRequest = /*@__PURE__*/ Schema.Struct({
  clientOperationId: Schema.optional(Schema.String).pipe(
    T.HttpQuery("clientOperationId"),
  ),
  project: Schema.String.pipe(T.HttpPath("project")),
...
export const GetIamPolicyManagedZonesRequest = /*@__PURE__*/ Schema.Struct({
...
export const DeleteManagedZonesRequest = /*@__PURE__*/ Schema.Struct({
  clientOperationId: Schema.optional(Schema.String).pipe(
    T.HttpQuery("clientOperationId"),
  ),
  project: Schema.String.pipe(T.HttpPath("project")),
...
export const SetIamPolicyManagedZonesRequest = /*@__PURE__*/ Schema.Struct({
  resource: Schema.String.pipe(T.HttpPath("resource")),
...
export const CreateResponsePoliciesRequest = /*@__PURE__*/ Schema.Struct({
  clientOperationId: Schema.optional(Schema.String).pipe(
    T.HttpQuery("clientOperationId"),
  ),
  project: Schema.String.pipe(T.HttpPath("project")),
...
export const PatchResponsePoliciesRequest = /*@__PURE__*/ Schema.Struct({
  responsePolicy: Schema.String.pipe(T.HttpPath("responsePolicy")),
  clientOperationId: Schema.optional(Schema.String).pipe(
    T.HttpQuery("clientOperationId"),
  ),
...
export const UpdateResponsePoliciesRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  responsePolicy: Schema.String.pipe(T.HttpPath("responsePolicy")),
  clientOperationId: Schema.optional(Schema.String).pipe(
    T.HttpQuery("clientOperationId"),
...
export const DeleteResponsePoliciesRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  responsePolicy: Schema.String.pipe(T.HttpPath("responsePolicy")),
  clientOperationId: Schema.optional(Schema.String).pipe(
    T.HttpQuery("clientOperationId"),
...
export const GetResponsePoliciesRequest = /*@__PURE__*/ Schema.Struct({
  responsePolicy: Schema.String.pipe(T.HttpPath("responsePolicy")),
  clientOperationId: Schema.optional(Schema.String).pipe(
    T.HttpQuery("clientOperationId"),
  ),
...
export const ListResponsePoliciesRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  maxResults: Schema.optional(Schema.Number).pipe(T.HttpQuery("maxResults")),
}).pipe(
