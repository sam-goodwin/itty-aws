...
export const RemoveIamPolicyProjectsLocationsRequest =
  /*@__PURE__*/ Schema.Struct({
    ...
    svc,
  ) as unknown as Schema.Codec<RemoveIamPolicyProjectsLocationsRequest>;
...
export const SetIamPolicyProjectsLocationsInstancesNamespacesRequest =
  /*@__PURE__*/ Schema.Struct({
    ...
    svc,
  ) as unknown as Schema.Codec<SetIamPolicyProjectsLocationsInstancesNamespacesRequest>;
...
export const ListProjectsLocationsInstancesNamespacesRequest =
  /*@__PURE__*/ Schema.Struct({
    ...
    svc,
  ) as unknown as Schema.Codec<ListProjectsLocationsInstancesNamespacesRequest>;
...
export const ListProjectsLocationsInstancesNamespacesResponse =
  /*@__PURE__*/ ListNamespacesResponse;
...
export const GetIamPolicyProjectsLocationsInstancesNamespacesRequest =
  /*@__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "GET", path: "v1beta1/{+resource}:getIamPolicy" }),
    svc,
  ) as unknown as Schema.Codec<GetIamPolicyProjectsLocationsInstancesNamespacesRequest>;
...
export const TestIamPermissionsProjectsLocationsInstancesNamespacesRequest =
  /*@__PURE__*/ Schema.Struct({
    ...
    svc,
  ) as unknown as Schema.Codec<TestIamPermissionsProjectsLocationsInstancesNamespacesRequest>;
