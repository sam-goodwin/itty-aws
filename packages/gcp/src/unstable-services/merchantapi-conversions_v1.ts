...
export const GetAccountsConversionSourcesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
...
export const ListAccountsConversionSourcesRequest = /*@__PURE__*/ Schema.Struct(
  {
  ...
  T.Http({ method: "GET", path: "conversions/v1/{+parent}/conversionSources" }),
  svc,
