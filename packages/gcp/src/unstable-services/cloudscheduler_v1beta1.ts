...
}).pipe(T.Http({"method":"POST","uri":"v1beta1/{+name}:cancel","baseUrl":"https://cloudscheduler.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1beta1/{+parent}/jobs","baseUrl":"https://cloudscheduler.googleapis.com/"})),
...
}).pipe(T.Http({"method":"DELETE","uri":"v1beta1/{+name}","baseUrl":"https://cloudscheduler.googleapis.com/"})),
...
S.Struct({
  "name": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v1beta1/{+name}","baseUrl":"https://cloudscheduler.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v1beta1/{+name}/locations","baseUrl":"https://cloudscheduler.googleapis.com/"})),
...
S.Struct({
  ...
  "parent": S.String.pipe(T.Label()),
  "pageSize": S.optional(S.Number.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1beta1/{+parent}/jobs","baseUrl":"https://cloudscheduler.googleapis.com/"})),
...
S.Struct({
  ...
  "filter": S.optional(S.String.pipe(T.Query())),
  "pageToken": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1beta1/{+name}/operations","baseUrl":"https://cloudscheduler.googleapis.com/"})),
...
S.Struct({
  ...
  "body": S.optional(Job.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"PATCH","uri":"v1beta1/{+name}","baseUrl":"https://cloudscheduler.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1beta1/{+name}:pause","baseUrl":"https://cloudscheduler.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1beta1/{+name}:resume","baseUrl":"https://cloudscheduler.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1beta1/{+name}:run","baseUrl":"https://cloudscheduler.googleapis.com/"})),
