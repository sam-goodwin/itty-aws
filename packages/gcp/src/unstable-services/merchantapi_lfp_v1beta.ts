...
}).pipe(T.Http({"method":"DELETE","uri":"lfp/v1beta/{+name}","baseUrl":"https://merchantapi.googleapis.com/"})),
...
S.Struct({
  "name": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"lfp/v1beta/{+name}","baseUrl":"https://merchantapi.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"lfp/v1beta/{+parent}/lfpInventories:insert","baseUrl":"https://merchantapi.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"lfp/v1beta/{+parent}/lfpSales:insert","baseUrl":"https://merchantapi.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"lfp/v1beta/{+parent}/lfpStores:insert","baseUrl":"https://merchantapi.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"lfp/v1beta/{+parent}/lfpStores","baseUrl":"https://merchantapi.googleapis.com/"})),
