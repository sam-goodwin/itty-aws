...
export const FileInput: Schema.Schema<FileInput> = /*@__PURE__*/ Schema.Struct({
...
export const CreateAccountsDataSourcesRequest = /*@__PURE__*/ Schema.Struct({
...
export const CreateAccountsDataSourcesResponse = /*@__PURE__*/ DataSource;
...
export const FetchAccountsDataSourcesRequest = /*@__PURE__*/ Schema.Struct({
...
export const FetchAccountsDataSourcesResponse = /*@__PURE__*/ Empty;
...
export const GetAccountsDataSourcesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
...
export const GetAccountsDataSourcesResponse = /*@__PURE__*/ DataSource;
...
export const PatchAccountsDataSourcesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const PatchAccountsDataSourcesResponse = /*@__PURE__*/ DataSource;
...
export const DeleteAccountsDataSourcesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
...
export const DeleteAccountsDataSourcesResponse = /*@__PURE__*/ Empty;
...
export const ListAccountsDataSourcesRequest = /*@__PURE__*/ Schema.Struct({
