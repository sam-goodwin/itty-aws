...
export const DetectDetectionsRequest = /*@__PURE__*/ Schema.Struct({
  pp: Schema.optional(Schema.Boolean).pipe(T.HttpQuery("pp")),
  bearer_token: Schema.optional(Schema.String).pipe(
    T.HttpQuery("bearer_token"),
  ),
...
export const TranslateTranslationsRequest = /*@__PURE__*/ Schema.Struct({
  pp: Schema.optional(Schema.Boolean).pipe(T.HttpQuery("pp")),
  bearer_token: Schema.optional(Schema.String).pipe(
    T.HttpQuery("bearer_token"),
  ),
...
export const ListTranslationsRequest = /*@__PURE__*/ Schema.Struct({
  pp: Schema.optional(Schema.Boolean).pipe(T.HttpQuery("pp")),
  bearer_token: Schema.optional(Schema.String).pipe(
    T.HttpQuery("bearer_token"),
  ),
