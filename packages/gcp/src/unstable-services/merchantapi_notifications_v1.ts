...
}).pipe(T.Http({"method":"POST","uri":"notifications/v1/{+parent}/notificationsubscriptions","baseUrl":"https://merchantapi.googleapis.com/"})),
...
}).pipe(T.Http({"method":"DELETE","uri":"notifications/v1/{+name}","baseUrl":"https://merchantapi.googleapis.com/"})),
...
S.Struct({
  "name": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"notifications/v1/{+name}","baseUrl":"https://merchantapi.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"notifications/v1/{+parent}/notificationsubscriptions","baseUrl":"https://merchantapi.googleapis.com/"})),
...
S.Struct({
  ...
  "body": S.optional(NotificationSubscription.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"PATCH","uri":"notifications/v1/{+name}","baseUrl":"https://merchantapi.googleapis.com/"})),
