...
export const Hash: Schema.Schema<Hash> = /*@__PURE__*/ Schema.Struct({
...
export const CVSS: Schema.Schema<CVSS> = /*@__PURE__*/ Schema.Struct({
...
export const Version: Schema.Schema<Version> = /*@__PURE__*/ Schema.Struct({
...
export const BaseImage: Schema.Schema<BaseImage> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const URI: Schema.Schema<URI> = /*@__PURE__*/ Schema.Struct({
  uri: Schema.optional(Schema.String),
...
export const Risk: Schema.Schema<Risk> = /*@__PURE__*/ Schema.Struct({
...
export const Command: Schema.Schema<Command> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const Artifact: Schema.Schema<Artifact> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const Recipe: Schema.Schema<Recipe> = /*@__PURE__*/ Schema.Struct({
  type: Schema.optional(Schema.String),
...
export const Material: Schema.Schema<Material> = /*@__PURE__*/ Schema.Struct({
  uri: Schema.optional(Schema.String),
  digest: Schema.optional(Schema.Record(Schema.String, Schema.String)),
...
export const Layer: Schema.Schema<Layer> = /*@__PURE__*/ Schema.Struct({
...
export const Derived: Schema.Schema<Derived> = /*@__PURE__*/ Schema.Struct({
...
export const License: Schema.Schema<License> = /*@__PURE__*/ Schema.Struct({
...
export const Envelope: Schema.Schema<Envelope> = /*@__PURE__*/ Schema.Struct({
...
export const Detail: Schema.Schema<Detail> = /*@__PURE__*/ Schema.Struct({
  cpeUri: Schema.optional(Schema.String),
  package: Schema.optional(Schema.String),
...
export const BuildType: Schema.Schema<BuildType> = /*@__PURE__*/ Schema.Struct({
  builderVersion: Schema.optional(Schema.String),
...
export const Basis: Schema.Schema<Basis> = /*@__PURE__*/ Schema.Struct({
  resourceUrl: Schema.optional(Schema.String),
  fingerprint: Schema.optional(Fingerprint),
...
export const Digest: Schema.Schema<Digest> = /*@__PURE__*/ Schema.Struct({
...
export const Discovery: Schema.Schema<Discovery> = /*@__PURE__*/ Schema.Struct({
...
export const FileNote: Schema.Schema<FileNote> = /*@__PURE__*/ Schema.Struct({
  title: Schema.optional(Schema.String),
...
export const DSSEHint: Schema.Schema<DSSEHint> = /*@__PURE__*/ Schema.Struct({
  humanReadableName: Schema.optional(Schema.String),
...
export const Publisher: Schema.Schema<Publisher> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const SecretNote: Schema.Schema<SecretNote> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "SecretNote" });
...
export const Note: Schema.Schema<Note> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
  shortDescription: Schema.optional(Schema.String),
  longDescription: Schema.optional(Schema.String),
  kind: Schema.optional(Schema.String),
...
export const Volume: Schema.Schema<Volume> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
  path: Schema.optional(Schema.String),
...
export const TimeSpan: Schema.Schema<TimeSpan> = /*@__PURE__*/ Schema.Struct({
  startTime: Schema.optional(Schema.String),
  endTime: Schema.optional(Schema.String),
...
export const BuildStep: Schema.Schema<BuildStep> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
  env: Schema.optional(Schema.Array(Schema.String)),
  args: Schema.optional(Schema.Array(Schema.String)),
  dir: Schema.optional(Schema.String),
...
export const GetProjectsOccurrencesRequest = /*@__PURE__*/ Schema.Struct({
...
export const ListProjectsOccurrencesRequest = /*@__PURE__*/ Schema.Struct({
...
export const DeleteProjectsOccurrencesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
...
export const CreateProjectsOccurrencesRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  name: Schema.optional(Schema.String).pipe(T.HttpQuery("name")),
...
export const PatchProjectsOccurrencesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const GetNotesProjectsOccurrencesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
...
export const GetProjectsNotesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1alpha1/{+name}" }),
  svc,
...
export const ListProjectsNotesRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  name: Schema.optional(Schema.String).pipe(T.HttpQuery("name")),
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
...
export const DeleteProjectsNotesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "DELETE", path: "v1alpha1/{+name}" }),
  svc,
...
export const CreateProjectsNotesRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  name: Schema.optional(Schema.String).pipe(T.HttpQuery("name")),
...
export const PatchProjectsNotesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(Note).pipe(T.HttpBody()),
}).pipe(
...
export const SetIamPolicyProjectsNotesRequest = /*@__PURE__*/ Schema.Struct({
  resource: Schema.String.pipe(T.HttpPath("resource")),
  body: Schema.optional(SetIamPolicyRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({
...
export const GetIamPolicyProjectsNotesRequest = /*@__PURE__*/ Schema.Struct({
  resource: Schema.String.pipe(T.HttpPath("resource")),
  body: Schema.optional(GetIamPolicyRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({
...
export const ListProjectsNotesOccurrencesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
...
export const CreateProjectsOperationsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const PatchProjectsOperationsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const GetProjectsScanConfigsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1alpha1/{+name}" }),
  svc,
...
export const ListProjectsScanConfigsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
...
export const PatchProjectsScanConfigsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
...
export const GetProvidersNotesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1alpha1/{+name}" }),
  svc,
...
export const ListProvidersNotesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const DeleteProvidersNotesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "DELETE", path: "v1alpha1/{+name}" }),
  svc,
...
export const CreateProvidersNotesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  parent: Schema.optional(Schema.String).pipe(T.HttpQuery("parent")),
  noteId: Schema.optional(Schema.String).pipe(T.HttpQuery("noteId")),
  body: Schema.optional(Note).pipe(T.HttpBody()),
...
export const PatchProvidersNotesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  body: Schema.optional(Note).pipe(T.HttpBody()),
}).pipe(
...
export const SetIamPolicyProvidersNotesRequest = /*@__PURE__*/ Schema.Struct({
  resource: Schema.String.pipe(T.HttpPath("resource")),
  body: Schema.optional(SetIamPolicyRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({
...
export const GetIamPolicyProvidersNotesRequest = /*@__PURE__*/ Schema.Struct({
  resource: Schema.String.pipe(T.HttpPath("resource")),
  body: Schema.optional(GetIamPolicyRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({
...
export const ListProvidersNotesOccurrencesRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
    filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
    pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
