...
export const Aws: Schema.Schema<Aws> = /*@__PURE__*/ Schema.Struct({
...
export const X509: Schema.Schema<X509> = /*@__PURE__*/ Schema.Struct({
...
export const Saml: Schema.Schema<Saml> = /*@__PURE__*/ Schema.Struct({
...
export const Oidc: Schema.Schema<Oidc> = /*@__PURE__*/ Schema.Struct({
...
export const AuditData: Schema.Schema<AuditData> = /*@__PURE__*/ Schema.Struct({
...
export const KeyData: Schema.Schema<KeyData> = /*@__PURE__*/ Schema.Struct({
  key: Schema.optional(Schema.String),
...
export const PatchProjectsServiceAccountsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const ListProjectsServiceAccountsRequest = /*@__PURE__*/ Schema.Struct({
...
export const CreateProjectsServiceAccountsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
    body: Schema.optional(CreateServiceAccountRequest).pipe(T.HttpBody()),
  },
).pipe(
  T.Http({ method: "POST", path: "v1/{+name}/serviceAccounts", hasBody: true }),
  svc,
...
export const DeleteProjectsServiceAccountsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
  },
).pipe(
...
export const GetProjectsServiceAccountsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
...
export const UpdateProjectsServiceAccountsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
...
export const EnableProjectsServiceAccountsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
...
export const UndeleteProjectsRolesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const PatchProjectsRolesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
...
export const ListProjectsRolesRequest = /*@__PURE__*/ Schema.Struct({
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
...
export const DeleteProjectsRolesRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetProjectsRolesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const CreateProjectsRolesRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const DeleteLocationsWorkforcePoolsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
  },
).pipe(
...
export const GetLocationsWorkforcePoolsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const PatchLocationsWorkforcePoolsRequest = /*@__PURE__*/ Schema.Struct({
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const ListLocationsWorkforcePoolsRequest = /*@__PURE__*/ Schema.Struct({
...
export const CreateLocationsWorkforcePoolsRequest = /*@__PURE__*/ Schema.Struct(
  {
    location: Schema.String.pipe(T.HttpPath("location")),
...
export const QueryGrantableRolesRolesRequest = /*@__PURE__*/ Schema.Struct({
...
export const CreateOrganizationsRolesRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(CreateRoleRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1/{+parent}/roles", hasBody: true }),
...
export const GetOrganizationsRolesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const ListOrganizationsRolesRequest = /*@__PURE__*/ Schema.Struct({
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  showDeleted: Schema.optional(Schema.Boolean).pipe(T.HttpQuery("showDeleted")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
  view: Schema.optional(Schema.String).pipe(T.HttpQuery("view")),
...
export const DeleteOrganizationsRolesRequest = /*@__PURE__*/ Schema.Struct({
  etag: Schema.optional(Schema.String).pipe(T.HttpQuery("etag")),
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "DELETE", path: "v1/{+name}" }),
...
export const PatchOrganizationsRolesRequest = /*@__PURE__*/ Schema.Struct({
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(Role).pipe(T.HttpBody()),
}).pipe(
...
export const UndeleteOrganizationsRolesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(UndeleteRoleRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1/{+name}:undelete", hasBody: true }),
...
export const LintPolicyIamPoliciesRequest = /*@__PURE__*/ Schema.Struct({
