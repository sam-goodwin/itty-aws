...
export const ListAccountsPermissionsRequest = /*@__PURE__*/ Schema.Struct({
  accountId: Schema.String.pipe(T.HttpPath("accountId")),
}).pipe(
  T.Http({
    method: "GET",
...
export const DeleteAccountsPermissionsRequest = /*@__PURE__*/ Schema.Struct({
  accountId: Schema.String.pipe(T.HttpPath("accountId")),
...
export const UpdateAccountsPermissionsRequest = /*@__PURE__*/ Schema.Struct({
  accountId: Schema.String.pipe(T.HttpPath("accountId")),
  permissionId: Schema.String.pipe(T.HttpPath("permissionId")),
...
export const CreateAccountsPermissionsRequest = /*@__PURE__*/ Schema.Struct({
  accountId: Schema.String.pipe(T.HttpPath("accountId")),
  body: Schema.optional(UserAccess).pipe(T.HttpBody()),
}).pipe(
  T.Http({
...
export const GetAccountsPermissionsRequest = /*@__PURE__*/ Schema.Struct({
  accountId: Schema.String.pipe(T.HttpPath("accountId")),
  permissionId: Schema.String.pipe(T.HttpPath("permissionId")),
}).pipe(
  T.Http({
...
export const ListAccountsContainersFoldersRequest = /*@__PURE__*/ Schema.Struct(
  {
    accountId: Schema.String.pipe(T.HttpPath("accountId")),
    containerId: Schema.String.pipe(T.HttpPath("containerId")),
  },
...
export const GetAccountsContainersFoldersRequest = /*@__PURE__*/ Schema.Struct({
  accountId: Schema.String.pipe(T.HttpPath("accountId")),
  containerId: Schema.String.pipe(T.HttpPath("containerId")),
  folderId: Schema.String.pipe(T.HttpPath("folderId")),
}).pipe(
...
export const GetAccountsContainersTriggersRequest = /*@__PURE__*/ Schema.Struct(
  {
    triggerId: Schema.String.pipe(T.HttpPath("triggerId")),
    accountId: Schema.String.pipe(T.HttpPath("accountId")),
    containerId: Schema.String.pipe(T.HttpPath("containerId")),
...
export const CreateAccountsContainersTagsRequest = /*@__PURE__*/ Schema.Struct({
  accountId: Schema.String.pipe(T.HttpPath("accountId")),
  containerId: Schema.String.pipe(T.HttpPath("containerId")),
...
export const GetAccountsContainersTagsRequest = /*@__PURE__*/ Schema.Struct({
...
export const UpdateAccountsContainersTagsRequest = /*@__PURE__*/ Schema.Struct({
  tagId: Schema.String.pipe(T.HttpPath("tagId")),
  fingerprint: Schema.optional(Schema.String).pipe(T.HttpQuery("fingerprint")),
  accountId: Schema.String.pipe(T.HttpPath("accountId")),
  containerId: Schema.String.pipe(T.HttpPath("containerId")),
...
export const DeleteAccountsContainersTagsRequest = /*@__PURE__*/ Schema.Struct({
  accountId: Schema.String.pipe(T.HttpPath("accountId")),
  containerId: Schema.String.pipe(T.HttpPath("containerId")),
  tagId: Schema.String.pipe(T.HttpPath("tagId")),
}).pipe(
...
export const ListAccountsContainersTagsRequest = /*@__PURE__*/ Schema.Struct({
  accountId: Schema.String.pipe(T.HttpPath("accountId")),
  containerId: Schema.String.pipe(T.HttpPath("containerId")),
}).pipe(
  T.Http({
