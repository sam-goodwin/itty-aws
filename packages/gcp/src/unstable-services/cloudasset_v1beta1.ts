...
export type BatchGetAssetsHistoryOrganizationsContentTypeEnum = "CONTENT_TYPE_UNSPECIFIED" | "RESOURCE" | "IAM_POLICY";
export const BatchGetAssetsHistoryOrganizationsContentTypeEnum = /*@__PURE__*/ S.String;
...
export interface BatchGetAssetsHistoryOrganizationsRequest {
  ...
  contentType?: BatchGetAssetsHistoryOrganizationsContentTypeEnum | (string & {});
...
export const BatchGetAssetsHistoryOrganizationsRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "readTimeWindow.startTime": S.optional(S.String.pipe(T.Query())),
  "readTimeWindow.endTime": S.optional(S.String.pipe(T.Query())),
  "contentType": S.optional(BatchGetAssetsHistoryOrganizationsContentTypeEnum.pipe(T.Query())),
  "parent": S.String.pipe(T.Label()),
  "assetNames": S.optional(StringList.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1beta1/{+parent}:batchGetAssetsHistory","baseUrl":"https://cloudasset.googleapis.com/"})),
).annotate({ identifier: "BatchGetAssetsHistoryOrganizationsRequest" }) as any as S.Schema<BatchGetAssetsHistoryOrganizationsRequest>;
...
export type BatchGetAssetsHistoryProjectsContentTypeEnum = "CONTENT_TYPE_UNSPECIFIED" | "RESOURCE" | "IAM_POLICY";
export const BatchGetAssetsHistoryProjectsContentTypeEnum = /*@__PURE__*/ S.String;
...
S.Struct({
  ...
  "readTimeWindow.endTime": S.optional(S.String.pipe(T.Query())),
  "parent": S.String.pipe(T.Label()),
  "contentType": S.optional(BatchGetAssetsHistoryProjectsContentTypeEnum.pipe(T.Query())),
  "assetNames": S.optional(StringList.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1beta1/{+parent}:batchGetAssetsHistory","baseUrl":"https://cloudasset.googleapis.com/"})),
).annotate({ identifier: "BatchGetAssetsHistoryProjectsRequest" }) as any as S.Schema<BatchGetAssetsHistoryProjectsRequest>;

export type ExportAssetsRequestContentTypeEnum = "CONTENT_TYPE_UNSPECIFIED" | "RESOURCE" | "IAM_POLICY";
...
}).pipe(T.Http({"method":"POST","uri":"v1beta1/{+parent}:exportAssets","baseUrl":"https://cloudasset.googleapis.com/"})),
).annotate({ identifier: "ExportAssetsFoldersRequest" }) as any as S.Schema<ExportAssetsFoldersRequest>;
...
).annotate({ identifier: "ExportAssetsOrganizationsRequest" }) as any as S.Schema<ExportAssetsOrganizationsRequest>;
...
).annotate({ identifier: "ExportAssetsProjectsRequest" }) as any as S.Schema<ExportAssetsProjectsRequest>;
...
}).pipe(T.Http({"method":"GET","uri":"v1beta1/{+name}","baseUrl":"https://cloudasset.googleapis.com/"})),
).annotate({ identifier: "GetFoldersOperationsRequest" }) as any as S.Schema<GetFoldersOperationsRequest>;
...
export type BatchGetAssetsHistoryOrganizationsError = NotFound | Forbidden | GcpOpError;
...
export type BatchGetAssetsHistoryProjectsError = NotFound | Forbidden | GcpOpError;
/** Batch gets the update history of assets that overlap a time window. For IAM_POLICY content, this API outputs history when the asset and its attached IAM POLICY both exist. This can create gaps in the output history. Otherwise, this API outputs history with asset in both non-delete or deleted status. If a specified asset does not exist, this API returns an INVALID_ARGUMENT error. */
...
export type ExportAssetsFoldersError = NotFound | Forbidden | BadRequest | Conflict | GcpOpError;
...
export type ExportAssetsOrganizationsError = NotFound | Forbidden | BadRequest | Conflict | GcpOpError;
/** Exports assets with time and resource types to a given Cloud Storage location. The output format is newline-delimited JSON. This API implements the google.longrunning.Operation API allowing you to keep track of the export. We recommend intervals of at least 2 seconds with exponential retry to poll the export operation result. For regular-size resource parent, the export operation usually finishes within 5 minutes. */
...
export type ExportAssetsProjectsError = NotFound | Forbidden | BadRequest | Conflict | GcpOpError;
/** Exports assets with time and resource types to a given Cloud Storage location. The output format is newline-delimited JSON. This API implements the google.longrunning.Operation API allowing you to keep track of the export. We recommend intervals of at least 2 seconds with exponential retry to poll the export operation result. For regular-size resource parent, the export operation usually finishes within 5 minutes. */
