...
}).pipe(T.Http({"method":"POST","uri":"v2alpha1/{+name}:cancel","baseUrl":"https://tpu.googleapis.com/"})),
...
export type SchedulingConfigProvisioningModelEnum = "PROVISIONING_MODEL_UNSPECIFIED" | "STANDARD" | "SPOT" | "RESERVATION_BOUND";
...
}).pipe(T.Http({"method":"POST","uri":"v2alpha1/{+parent}/nodes","baseUrl":"https://tpu.googleapis.com/"})),
...
export type MultiNodeParamsWorkloadTypeEnum = "WORKLOAD_TYPE_UNSPECIFIED" | "THROUGHPUT_OPTIMIZED" | "AVAILABILITY_OPTIMIZED";
...
export const BestEffort = /*@__PURE__*/ S.suspend(() =>
S.Struct({}),
).annotate({ identifier: "BestEffort" }) as any as S.Schema<BestEffort>;

export type QueuedResourceProvisioningModelEnum = "PROVISIONING_MODEL_UNSPECIFIED" | "STANDARD" | "SPOT" | "RESERVATION_BOUND" | "FLEX_START";
...
}).pipe(T.Http({"method":"POST","uri":"v2alpha1/{+parent}/queuedResources","baseUrl":"https://tpu.googleapis.com/"})),
...
S.Struct({
  "name": S.String.pipe(T.Label()),
  "requestId": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"DELETE","uri":"v2alpha1/{+name}","baseUrl":"https://tpu.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v2alpha1/{+parent}:generateServiceIdentity","baseUrl":"https://tpu.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v2alpha1/{+name}:getGuestAttributes","baseUrl":"https://tpu.googleapis.com/"})),
...
export const GetMaintenanceInfoProjectsLocationsQueuedResourcesRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "name": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v2alpha1/{+name}:getMaintenanceInfo","baseUrl":"https://tpu.googleapis.com/"})),
).annotate({ identifier: "GetMaintenanceInfoProjectsLocationsQueuedResourcesRequest" }) as any as S.Schema<GetMaintenanceInfoProjectsLocationsQueuedResourcesRequest>;
...
).annotate({ identifier: "NodeUpcomingMaintenanceInfo" }) as any as S.Schema<NodeUpcomingMaintenanceInfo>;

export type NodeUpcomingMaintenanceInfoList = ReadonlyArray<NodeUpcomingMaintenanceInfo>;
export const NodeUpcomingMaintenanceInfoList = /*@__PURE__*/ S.Array(NodeUpcomingMaintenanceInfo) as any as S.Schema<NodeUpcomingMaintenanceInfoList>;
...
).annotate({ identifier: "GetMaintenanceInfoResponse" }) as any as S.Schema<GetMaintenanceInfoResponse>;
...
S.Struct({
  "name": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v2alpha1/{+name}","baseUrl":"https://tpu.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v2alpha1/{+name}/locations","baseUrl":"https://tpu.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v2alpha1/{+parent}/acceleratorTypes","baseUrl":"https://tpu.googleapis.com/"})),
...
S.Struct({
  ...
  "parent": S.String.pipe(T.Label()),
  "pageSize": S.optional(S.Number.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v2alpha1/{+parent}/nodes","baseUrl":"https://tpu.googleapis.com/"})),
...
S.Struct({
  ...
  "pageSize": S.optional(S.Number.pipe(T.Query())),
  "name": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v2alpha1/{+name}/operations","baseUrl":"https://tpu.googleapis.com/"})),
...
S.Struct({
  ...
  "parent": S.String.pipe(T.Label()),
  "pageSize": S.optional(S.Number.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v2alpha1/{+parent}/queuedResources","baseUrl":"https://tpu.googleapis.com/"})),
...
S.Struct({
  ...
  "pageSize": S.optional(S.Number.pipe(T.Query())),
  "pageToken": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v2alpha1/{+parent}/reservations","baseUrl":"https://tpu.googleapis.com/"})),
...
export type ReservationStateEnum = "STATE_UNSPECIFIED" | "APPROVED" | "PROVISIONING" | "ACTIVE" | "DEPROVISIONING" | "EXPIRED" | "FAILED";
...
S.Struct({
  ...
  "parent": S.String.pipe(T.Label()),
  "filter": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v2alpha1/{+parent}/runtimeVersions","baseUrl":"https://tpu.googleapis.com/"})),
...
S.Struct({
  ...
  "body": S.optional(Node.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"PATCH","uri":"v2alpha1/{+name}","baseUrl":"https://tpu.googleapis.com/"})),
...
export const PerformMaintenanceRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({}),
).annotate({ identifier: "PerformMaintenanceRequest" }) as any as S.Schema<PerformMaintenanceRequest>;
...
export const PerformMaintenanceProjectsLocationsNodesRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "name": S.String.pipe(T.Label()),
  "body": S.optional(PerformMaintenanceRequest.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"POST","uri":"v2alpha1/{+name}:performMaintenance","baseUrl":"https://tpu.googleapis.com/"})),
).annotate({ identifier: "PerformMaintenanceProjectsLocationsNodesRequest" }) as any as S.Schema<PerformMaintenanceProjectsLocationsNodesRequest>;
...
).annotate({ identifier: "PerformMaintenanceQueuedResourceRequest" }) as any as S.Schema<PerformMaintenanceQueuedResourceRequest>;
...
export const PerformMaintenanceQueuedResourceProjectsLocationsQueuedResourcesRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "name": S.String.pipe(T.Label()),
  "body": S.optional(PerformMaintenanceQueuedResourceRequest.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"POST","uri":"v2alpha1/{+name}:performMaintenanceQueuedResource","baseUrl":"https://tpu.googleapis.com/"})),
).annotate({ identifier: "PerformMaintenanceQueuedResourceProjectsLocationsQueuedResourcesRequest" }) as any as S.Schema<PerformMaintenanceQueuedResourceProjectsLocationsQueuedResourcesRequest>;
...
}).pipe(T.Http({"method":"POST","uri":"v2alpha1/{+name}:reset","baseUrl":"https://tpu.googleapis.com/"})),
...
).annotate({ identifier: "SimulateMaintenanceEventRequest" }) as any as S.Schema<SimulateMaintenanceEventRequest>;
...
export const SimulateMaintenanceEventProjectsLocationsNodesRequest = /*@__PURE__*/ S.suspend(() =>
S.Struct({
  "name": S.String.pipe(T.Label()),
  "body": S.optional(SimulateMaintenanceEventRequest.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"POST","uri":"v2alpha1/{+name}:simulateMaintenanceEvent","baseUrl":"https://tpu.googleapis.com/"})),
).annotate({ identifier: "SimulateMaintenanceEventProjectsLocationsNodesRequest" }) as any as S.Schema<SimulateMaintenanceEventProjectsLocationsNodesRequest>;
...
}).pipe(T.Http({"method":"POST","uri":"v2alpha1/{+name}:start","baseUrl":"https://tpu.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v2alpha1/{+name}:stop","baseUrl":"https://tpu.googleapis.com/"})),
...
export type GetMaintenanceInfoProjectsLocationsQueuedResourcesError = NotFound | Forbidden | GcpOpError;
...
export type PerformMaintenanceProjectsLocationsNodesError = NotFound | Forbidden | BadRequest | Conflict | GcpOpError;
...
export type PerformMaintenanceQueuedResourceProjectsLocationsQueuedResourcesError = NotFound | Forbidden | BadRequest | Conflict | GcpOpError;
...
export type SimulateMaintenanceEventProjectsLocationsNodesError = NotFound | Forbidden | BadRequest | Conflict | GcpOpError;
