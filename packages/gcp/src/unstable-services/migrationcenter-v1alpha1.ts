...
export const SignedUri: Schema.Schema<SignedUri> = /*@__PURE__*/ Schema.Struct({
...
export const AssetList: Schema.Schema<AssetList> = /*@__PURE__*/ Schema.Struct({
...
export const NfsExport: Schema.Schema<NfsExport> = /*@__PURE__*/ Schema.Struct({
...
export const AggregationCount: Schema.Schema<AggregationCount> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "AggregationCount" });
...
export const AggregationSum: Schema.Schema<AggregationSum> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "AggregationSum" });
...
export const AwsVpcDetails: Schema.Schema<AwsVpcDetails> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "AwsVpcDetails" });
...
export const AwsRds: Schema.Schema<AwsRds> = /*@__PURE__*/ Schema.Struct(
  {},
).annotate({ identifier: "AwsRds" });
...
export const DiskEntry: Schema.Schema<DiskEntry> = /*@__PURE__*/ Schema.Struct({
...
export const Selinux: Schema.Schema<Selinux> = /*@__PURE__*/ Schema.Struct({
...
export const Frames: Schema.Schema<Frames> = /*@__PURE__*/ Schema.Struct({
...
export const GetProjectsLocationsRelationsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
  },
).pipe(
...
export const PatchProjectsLocationsAssetsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  requestId: Schema.optional(Schema.String).pipe(T.HttpQuery("requestId")),
...
export const ListProjectsLocationsAssetsRequest = /*@__PURE__*/ Schema.Struct({
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
  view: Schema.optional(Schema.String).pipe(T.HttpQuery("view")),
  orderBy: Schema.optional(Schema.String).pipe(T.HttpQuery("orderBy")),
...
export const GetProjectsLocationsAssetsRequest = /*@__PURE__*/ Schema.Struct({
  view: Schema.optional(Schema.String).pipe(T.HttpQuery("view")),
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1alpha1/{+name}" }),
...
export const DeleteProjectsLocationsAssetsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
    requestId: Schema.optional(Schema.String).pipe(T.HttpQuery("requestId")),
  },
