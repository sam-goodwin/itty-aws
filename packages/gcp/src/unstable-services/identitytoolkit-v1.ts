...
export const AccountsProjectsRequest = /*@__PURE__*/ Schema.Struct({
...
export const QueryAccountsProjectsRequest = /*@__PURE__*/ Schema.Struct({
  targetProjectId: Schema.String.pipe(T.HttpPath("targetProjectId")),
...
export const CreateSessionCookieProjectsRequest = /*@__PURE__*/ Schema.Struct({
  targetProjectId: Schema.String.pipe(T.HttpPath("targetProjectId")),
...
export const BatchGetProjectsAccountsRequest = /*@__PURE__*/ Schema.Struct({
  targetProjectId: Schema.String.pipe(T.HttpPath("targetProjectId")),
...
export const DeleteProjectsAccountsRequest = /*@__PURE__*/ Schema.Struct({
  targetProjectId: Schema.String.pipe(T.HttpPath("targetProjectId")),
...
export const SendOobCodeProjectsAccountsRequest = /*@__PURE__*/ Schema.Struct({
  targetProjectId: Schema.String.pipe(T.HttpPath("targetProjectId")),
...
export const UpdateProjectsAccountsRequest = /*@__PURE__*/ Schema.Struct({
  targetProjectId: Schema.String.pipe(T.HttpPath("targetProjectId")),
...
export const BatchDeleteProjectsAccountsRequest = /*@__PURE__*/ Schema.Struct({
  targetProjectId: Schema.String.pipe(T.HttpPath("targetProjectId")),
  body: Schema.optional(
...
export const QueryProjectsAccountsRequest = /*@__PURE__*/ Schema.Struct({
  targetProjectId: Schema.String.pipe(T.HttpPath("targetProjectId")),
  body: Schema.optional(GoogleCloudIdentitytoolkitV1QueryUserInfoRequest).pipe(
    T.HttpBody(),
  ),
...
export const BatchCreateProjectsAccountsRequest = /*@__PURE__*/ Schema.Struct({
  targetProjectId: Schema.String.pipe(T.HttpPath("targetProjectId")),
...
export const LookupProjectsAccountsRequest = /*@__PURE__*/ Schema.Struct({
  targetProjectId: Schema.String.pipe(T.HttpPath("targetProjectId")),
...
export const AccountsProjectsTenantsRequest = /*@__PURE__*/ Schema.Struct({
  targetProjectId: Schema.String.pipe(T.HttpPath("targetProjectId")),
  tenantId: Schema.String.pipe(T.HttpPath("tenantId")),
  body: Schema.optional(GoogleCloudIdentitytoolkitV1SignUpRequest).pipe(
    T.HttpBody(),
...
export const UpdateProjectsTenantsAccountsRequest = /*@__PURE__*/ Schema.Struct(
  {
    targetProjectId: Schema.String.pipe(T.HttpPath("targetProjectId")),
    tenantId: Schema.String.pipe(T.HttpPath("tenantId")),
    body: Schema.optional(
...
export const DeleteProjectsTenantsAccountsRequest = /*@__PURE__*/ Schema.Struct(
  {
    targetProjectId: Schema.String.pipe(T.HttpPath("targetProjectId")),
    tenantId: Schema.String.pipe(T.HttpPath("tenantId")),
    body: Schema.optional(
...
export const LookupProjectsTenantsAccountsRequest = /*@__PURE__*/ Schema.Struct(
  {
    targetProjectId: Schema.String.pipe(T.HttpPath("targetProjectId")),
    tenantId: Schema.String.pipe(T.HttpPath("tenantId")),
    body: Schema.optional(
...
export const QueryProjectsTenantsAccountsRequest = /*@__PURE__*/ Schema.Struct({
  targetProjectId: Schema.String.pipe(T.HttpPath("targetProjectId")),
  tenantId: Schema.String.pipe(T.HttpPath("tenantId")),
  body: Schema.optional(GoogleCloudIdentitytoolkitV1QueryUserInfoRequest).pipe(
    T.HttpBody(),
...
export const GetSessionCookiePublicKeysV1Request = /*@__PURE__*/ Schema.Struct(
  {},
).pipe(
...
export const GetRecaptchaParamsV1Request = /*@__PURE__*/ Schema.Struct({}).pipe(
...
export const SendVerificationCodeAccountsRequest = /*@__PURE__*/ Schema.Struct({
  body: Schema.optional(
...
export const ResetPasswordAccountsRequest = /*@__PURE__*/ Schema.Struct({
...
export const SignInWithEmailLinkAccountsRequest = /*@__PURE__*/ Schema.Struct({
  body: Schema.optional(
...
export const SignInWithPasswordAccountsRequest = /*@__PURE__*/ Schema.Struct({
  body: Schema.optional(
...
export const CreateAuthUriAccountsRequest = /*@__PURE__*/ Schema.Struct({
...
export const SendOobCodeAccountsRequest = /*@__PURE__*/ Schema.Struct({
  body: Schema.optional(GoogleCloudIdentitytoolkitV1GetOobCodeRequest).pipe(
    T.HttpBody(),
  ),
}).pipe(
...
export const IssueSamlResponseAccountsRequest = /*@__PURE__*/ Schema.Struct({
  body: Schema.optional(
...
export const VerifyIosClientAccountsRequest = /*@__PURE__*/ Schema.Struct({
  body: Schema.optional(
...
export const SignInWithIdpAccountsRequest = /*@__PURE__*/ Schema.Struct({
...
export const SignInWithPhoneNumberAccountsRequest = /*@__PURE__*/ Schema.Struct(
  {
    body: Schema.optional(
...
export const SignInWithCustomTokenAccountsRequest = /*@__PURE__*/ Schema.Struct(
  {
    body: Schema.optional(
...
export const SignInWithGameCenterAccountsRequest = /*@__PURE__*/ Schema.Struct({
  body: Schema.optional(
