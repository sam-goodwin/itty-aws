...
export const GetAppsUpload_statusRequest = /*@__PURE__*/ Schema.Struct({
  mobilesdkAppId: Schema.String.pipe(T.HttpPath("mobilesdkAppId")),
...
export const GetAppsRelease_by_hashRequest = /*@__PURE__*/ Schema.Struct({
  mobilesdkAppId: Schema.String.pipe(T.HttpPath("mobilesdkAppId")),
...
export const GetTesterUdidsAppsTestersRequest = /*@__PURE__*/ Schema.Struct({
  mobilesdkAppId: Schema.String.pipe(T.HttpPath("mobilesdkAppId")),
...
export const Enable_accessAppsReleasesRequest = /*@__PURE__*/ Schema.Struct({
  mobilesdkAppId: Schema.String.pipe(T.HttpPath("mobilesdkAppId")),
...
export const CreateAppsReleasesNotesRequest = /*@__PURE__*/ Schema.Struct({
  releaseId: Schema.String.pipe(T.HttpPath("releaseId")),
  mobilesdkAppId: Schema.String.pipe(T.HttpPath("mobilesdkAppId")),
  body: Schema.optional(
...
export const GetTestQuotaProjectsRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetUdidsProjectsTestersRequest = /*@__PURE__*/ Schema.Struct({
...
export const UpdateTestConfigProjectsAppsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const GetTestConfigProjectsAppsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1alpha/{+name}" }),
  svc,
...
export const ListProjectsAppsReleasesTestsRequest = /*@__PURE__*/ Schema.Struct(
  {
...
export const GetProjectsAppsReleasesTestsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1alpha/{+name}" }),
  svc,
...
export const DeleteProjectsAppsTestCasesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
...
export const GetProjectsAppsTestCasesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1alpha/{+name}" }),
  svc,
...
export const CreateProjectsAppsTestCasesRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const ListProjectsAppsTestCasesRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
}).pipe(
...
export const PatchProjectsAppsTestCasesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
