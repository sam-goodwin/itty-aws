...
export const CreateBillingAccountsBudgetsRequest = /*@__PURE__*/ Schema.Struct({
...
export const PatchBillingAccountsBudgetsRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetBillingAccountsBudgetsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
...
export const ListBillingAccountsBudgetsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const DeleteBillingAccountsBudgetsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
