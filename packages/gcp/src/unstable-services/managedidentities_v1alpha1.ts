...
S.Struct({
  ...
  "lastKnownTrustConnectedHeartbeatTime": S.optional(S.String),
}),
...
}).pipe(T.Http({"method":"POST","uri":"v1alpha1/{+name}:attachTrust","baseUrl":"https://managedidentities.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1alpha1/{+name}:cancel","baseUrl":"https://managedidentities.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1alpha1/{+domain}:checkMigrationPermission","baseUrl":"https://managedidentities.googleapis.com/"})),
...
export type DomainStateEnum = "STATE_UNSPECIFIED" | "CREATING" | "READY" | "UPDATING" | "DELETING" | "REPAIRING" | "PERFORMING_MAINTENANCE" | "DOWN";
...
S.Struct({
  ...
  "managedIdentitiesAdminName": S.optional(S.String),
...
}).pipe(T.Http({"method":"POST","uri":"v1alpha1/{+parent}/domains","baseUrl":"https://managedidentities.googleapis.com/"})),
...
export type BackupTypeEnum = "TYPE_UNSPECIFIED" | "ON_DEMAND" | "SCHEDULED" | "SCHEMA_EXTENSION";
...
}).pipe(T.Http({"method":"POST","uri":"v1alpha1/{+parent}/backups","baseUrl":"https://managedidentities.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1alpha1/{+parent}/peerings","baseUrl":"https://managedidentities.googleapis.com/"})),
...
S.Struct({
  "name": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"DELETE","uri":"v1alpha1/{+name}","baseUrl":"https://managedidentities.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1alpha1/{+name}:detachTrust","baseUrl":"https://managedidentities.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1alpha1/{+domain}:disableMigration","baseUrl":"https://managedidentities.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1alpha1/{+domain}:domainJoinMachine","baseUrl":"https://managedidentities.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1alpha1/{+domain}:enableMigration","baseUrl":"https://managedidentities.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1alpha1/{+domain}:extendSchema","baseUrl":"https://managedidentities.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v1alpha1/{+resource}:getIamPolicy","baseUrl":"https://managedidentities.googleapis.com/"})),
...
S.Struct({
  "name": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v1alpha1/{+name}/ldapssettings","baseUrl":"https://managedidentities.googleapis.com/"})),
...
S.Struct({
  "name": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v1alpha1/{+name}","baseUrl":"https://managedidentities.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v1alpha1/{+name}/locations","baseUrl":"https://managedidentities.googleapis.com/"})),
...
S.Struct({
  ...
  "filter": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1alpha1/{+parent}/domains","baseUrl":"https://managedidentities.googleapis.com/"})),
...
S.Struct({
  ...
  "filter": S.optional(S.String.pipe(T.Query())),
  "orderBy": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1alpha1/{+parent}/backups","baseUrl":"https://managedidentities.googleapis.com/"})),
...
S.Struct({
  ...
  "filter": S.optional(S.String.pipe(T.Query())),
  "orderBy": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1alpha1/{+parent}/sqlIntegrations","baseUrl":"https://managedidentities.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v1alpha1/{+name}/operations","baseUrl":"https://managedidentities.googleapis.com/"})),
...
S.Struct({
  ...
  "filter": S.optional(S.String.pipe(T.Query())),
  "orderBy": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1alpha1/{+parent}/peerings","baseUrl":"https://managedidentities.googleapis.com/"})),
...
S.Struct({
  ...
  "name": S.String.pipe(T.Label()),
  "body": S.optional(Domain.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"PATCH","uri":"v1alpha1/{+name}","baseUrl":"https://managedidentities.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1alpha1/{+name}:reconfigureTrust","baseUrl":"https://managedidentities.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1alpha1/{+name}:resetAdminPassword","baseUrl":"https://managedidentities.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1alpha1/{+name}:restore","baseUrl":"https://managedidentities.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1alpha1/{+resource}:setIamPolicy","baseUrl":"https://managedidentities.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1alpha1/{+resource}:testIamPermissions","baseUrl":"https://managedidentities.googleapis.com/"})),
...
}).pipe(T.Http({"method":"PATCH","uri":"v1alpha1/{+name}/ldapssettings","baseUrl":"https://managedidentities.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1alpha1/{+name}:validateTrust","baseUrl":"https://managedidentities.googleapis.com/"})),
