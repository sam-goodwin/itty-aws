...
export const CheckMigrationPermissionProjectsLocationsGlobalDomainsRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "POST",
        uri: "v1alpha1/{+domain}:checkMigrationPermission",
        baseUrl: "https://managedidentities.googleapis.com/",
      }),
    ),
  ).annotate({
...
export const DisableMigrationProjectsLocationsGlobalDomainsRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "POST",
        uri: "v1alpha1/{+domain}:disableMigration",
        baseUrl: "https://managedidentities.googleapis.com/",
      }),
    ),
  ).annotate({
...
export const DomainJoinMachineProjectsLocationsGlobalDomainsRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "POST",
        uri: "v1alpha1/{+domain}:domainJoinMachine",
        baseUrl: "https://managedidentities.googleapis.com/",
      }),
    ),
  ).annotate({
...
export const EnableMigrationProjectsLocationsGlobalDomainsRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "POST",
        uri: "v1alpha1/{+domain}:enableMigration",
        baseUrl: "https://managedidentities.googleapis.com/",
      }),
    ),
  ).annotate({
...
export const ExtendSchemaProjectsLocationsGlobalDomainsRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "POST",
        uri: "v1alpha1/{+domain}:extendSchema",
        baseUrl: "https://managedidentities.googleapis.com/",
      }),
    ),
  ).annotate({
...
export const GetLdapssettingsProjectsLocationsGlobalDomainsRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "GET",
        uri: "v1alpha1/{+name}/ldapssettings",
        baseUrl: "https://managedidentities.googleapis.com/",
      }),
    ),
  ).annotate({
...
export const ListProjectsLocationsGlobalDomainsSqlIntegrationsRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "GET",
        uri: "v1alpha1/{+parent}/sqlIntegrations",
        baseUrl: "https://managedidentities.googleapis.com/",
      }),
    ),
  ).annotate({
...
export const ReconfigureTrustProjectsLocationsGlobalDomainsRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "POST",
        uri: "v1alpha1/{+name}:reconfigureTrust",
        baseUrl: "https://managedidentities.googleapis.com/",
      }),
    ),
  ).annotate({
...
export const ResetAdminPasswordProjectsLocationsGlobalDomainsRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "POST",
        uri: "v1alpha1/{+name}:resetAdminPassword",
        baseUrl: "https://managedidentities.googleapis.com/",
      }),
    ),
  ).annotate({
...
export const ValidateTrustProjectsLocationsGlobalDomainsRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "POST",
        uri: "v1alpha1/{+name}:validateTrust",
        baseUrl: "https://managedidentities.googleapis.com/",
      }),
    ),
  ).annotate({
