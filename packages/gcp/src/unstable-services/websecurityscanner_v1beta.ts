...
).annotate({ identifier: "IapTestServiceAccountInfo" }) as any as S.Schema<IapTestServiceAccountInfo>;
...
export type ScanRunWarningTraceCodeEnum = "CODE_UNSPECIFIED" | "INSUFFICIENT_CRAWL_RESULTS" | "TOO_MANY_CRAWL_RESULTS" | "TOO_MANY_FUZZ_TASKS" | "BLOCKED_BY_IAP" | "NO_STARTING_URL_FOUND_FOR_MANAGED_SCAN";
...
export type ScanRunWarningTraceList = ReadonlyArray<ScanRunWarningTrace>;
export const ScanRunWarningTraceList = /*@__PURE__*/ S.Array(ScanRunWarningTrace) as any as S.Schema<ScanRunWarningTraceList>;
...
export type ScanRunErrorTraceCodeEnum = "CODE_UNSPECIFIED" | "INTERNAL_ERROR" | "SCAN_CONFIG_ISSUE" | "AUTHENTICATION_CONFIG_ISSUE" | "TIMED_OUT_WHILE_SCANNING" | "TOO_MANY_REDIRECTS" | "TOO_MANY_HTTP_ERRORS" | "STARTING_URLS_CRAWL_HTTP_ERRORS";
...
export type ScanConfigExportToSecurityCommandCenterEnum = "EXPORT_TO_SECURITY_COMMAND_CENTER_UNSPECIFIED" | "ENABLED" | "DISABLED";
export const ScanConfigExportToSecurityCommandCenterEnum = /*@__PURE__*/ S.String;
...
}).pipe(T.Http({"method":"POST","uri":"v1beta/{+parent}/scanConfigs","baseUrl":"https://websecurityscanner.googleapis.com/"})),
...
}).pipe(T.Http({"method":"DELETE","uri":"v1beta/{+name}","baseUrl":"https://websecurityscanner.googleapis.com/"})),
...
S.Struct({
  "name": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v1beta/{+name}","baseUrl":"https://websecurityscanner.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v1beta/{+parent}/scanConfigs","baseUrl":"https://websecurityscanner.googleapis.com/"})),
...
S.Struct({
  ...
  "pageToken": S.optional(S.String.pipe(T.Query())),
  "pageSize": S.optional(S.Number.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1beta/{+parent}/scanRuns","baseUrl":"https://websecurityscanner.googleapis.com/"})),
...
S.Struct({
  ...
  "pageToken": S.optional(S.String.pipe(T.Query())),
  "pageSize": S.optional(S.Number.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1beta/{+parent}/crawledUrls","baseUrl":"https://websecurityscanner.googleapis.com/"})),
...
S.Struct({
  ...
  "pageSize": S.optional(S.Number.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1beta/{+parent}/findings","baseUrl":"https://websecurityscanner.googleapis.com/"})),
...
S.Struct({
  "parent": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v1beta/{+parent}/findingTypeStats","baseUrl":"https://websecurityscanner.googleapis.com/"})),
...
S.Struct({
  ...
  "body": S.optional(ScanConfig.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"PATCH","uri":"v1beta/{+name}","baseUrl":"https://websecurityscanner.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1beta/{+name}:start","baseUrl":"https://websecurityscanner.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1beta/{+name}:stop","baseUrl":"https://websecurityscanner.googleapis.com/"})),
