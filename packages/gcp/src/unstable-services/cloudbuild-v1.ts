...
export const GitConfig: Schema.Schema<GitConfig> = /*@__PURE__*/ Schema.Struct({
...
export const Secrets: Schema.Schema<Secrets> = /*@__PURE__*/ Schema.Struct({
...
export const Warning: Schema.Schema<Warning> = /*@__PURE__*/ Schema.Struct({
...
export const Results: Schema.Schema<Results> = /*@__PURE__*/ Schema.Struct({
...
export const GoModule: Schema.Schema<GoModule> = /*@__PURE__*/ Schema.Struct({
...
export const Oci: Schema.Schema<Oci> = /*@__PURE__*/ Schema.Struct({
...
export const Artifacts: Schema.Schema<Artifacts> = /*@__PURE__*/ Schema.Struct({
...
export const PatchProjectsTriggersRequest = /*@__PURE__*/ Schema.Struct({
...
export const RunProjectsTriggersRequest = /*@__PURE__*/ Schema.Struct({
  triggerId: Schema.String.pipe(T.HttpPath("triggerId")),
...
export const ListProjectsTriggersRequest = /*@__PURE__*/ Schema.Struct({
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
...
export const CreateProjectsTriggersRequest = /*@__PURE__*/ Schema.Struct({
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
  parent: Schema.optional(Schema.String).pipe(T.HttpQuery("parent")),
  body: Schema.optional(BuildTrigger).pipe(T.HttpBody()),
}).pipe(
...
export const GetProjectsTriggersRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String).pipe(T.HttpQuery("name")),
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
  triggerId: Schema.String.pipe(T.HttpPath("triggerId")),
}).pipe(
...
export const WebhookProjectsTriggersRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String).pipe(T.HttpQuery("name")),
...
export const DeleteProjectsTriggersRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String).pipe(T.HttpQuery("name")),
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
  triggerId: Schema.String.pipe(T.HttpPath("triggerId")),
}).pipe(
...
export const RunProjectsLocationsTriggersRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const ListProjectsLocationsBuildsRequest = /*@__PURE__*/ Schema.Struct({
  projectId: Schema.optional(Schema.String).pipe(T.HttpQuery("projectId")),
...
export const CancelProjectsLocationsBuildsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
...
export const RetryProjectsLocationsBuildsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const CreateProjectsLocationsBuildsRequest = /*@__PURE__*/ Schema.Struct(
  {
    parent: Schema.String.pipe(T.HttpPath("parent")),
    projectId: Schema.optional(Schema.String).pipe(T.HttpQuery("projectId")),
...
export const GetProjectsLocationsBuildsRequest = /*@__PURE__*/ Schema.Struct({
  projectId: Schema.optional(Schema.String).pipe(T.HttpQuery("projectId")),
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const RetryProjectsBuildsRequest = /*@__PURE__*/ Schema.Struct({
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
...
export const CreateProjectsBuildsRequest = /*@__PURE__*/ Schema.Struct({
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
  parent: Schema.optional(Schema.String).pipe(T.HttpQuery("parent")),
  body: Schema.optional(Build).pipe(T.HttpBody()),
}).pipe(
...
export const GetProjectsBuildsRequest = /*@__PURE__*/ Schema.Struct({
  id: Schema.String.pipe(T.HttpPath("id")),
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
  name: Schema.optional(Schema.String).pipe(T.HttpQuery("name")),
}).pipe(
...
export const ListProjectsBuildsRequest = /*@__PURE__*/ Schema.Struct({
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  parent: Schema.optional(Schema.String).pipe(T.HttpQuery("parent")),
...
export const CancelProjectsBuildsRequest = /*@__PURE__*/ Schema.Struct({
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
  id: Schema.String.pipe(T.HttpPath("id")),
  body: Schema.optional(CancelBuildRequest).pipe(T.HttpBody()),
}).pipe(
...
export const ApproveProjectsBuildsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(ApproveBuildRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({ method: "POST", path: "v1/{+name}:approve", hasBody: true }),
...
export const RegionalWebhookLocationsRequest = /*@__PURE__*/ Schema.Struct({
...
export const ReceiveGithubDotComWebhookRequest = /*@__PURE__*/ Schema.Struct({
  webhookKey: Schema.optional(Schema.String).pipe(T.HttpQuery("webhookKey")),
  body: Schema.optional(HttpBody).pipe(T.HttpBody()),
}).pipe(
  T.Http({
