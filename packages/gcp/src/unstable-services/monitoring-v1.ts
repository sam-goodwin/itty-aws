...
export const Measure: Schema.Schema<Measure> = /*@__PURE__*/ Schema.Struct({
  column: Schema.optional(Schema.String),
...
export const RatioPart: Schema.Schema<RatioPart> = /*@__PURE__*/ Schema.Struct({
...
export const PieChart: Schema.Schema<PieChart> = /*@__PURE__*/ Schema.Struct({
...
export const Treemap: Schema.Schema<Treemap> = /*@__PURE__*/ Schema.Struct({
...
export const Axis: Schema.Schema<Axis> = /*@__PURE__*/ Schema.Struct({
...
export const Threshold: Schema.Schema<Threshold> = /*@__PURE__*/ Schema.Struct({
  direction: Schema.optional(Schema.String),
  label: Schema.optional(Schema.String),
...
export const XyChart: Schema.Schema<XyChart> = /*@__PURE__*/ Schema.Struct({
...
export const LogsPanel: Schema.Schema<LogsPanel> = /*@__PURE__*/ Schema.Struct({
  filter: Schema.optional(Schema.String),
...
export const GaugeView: Schema.Schema<GaugeView> = /*@__PURE__*/ Schema.Struct({
...
export const Scorecard: Schema.Schema<Scorecard> = /*@__PURE__*/ Schema.Struct({
...
export const Widget: Schema.Schema<Widget> = /*@__PURE__*/ Schema.Struct({
...
export const Tile: Schema.Schema<Tile> = /*@__PURE__*/ Schema.Struct({
...
export const RowLayout: Schema.Schema<RowLayout> = /*@__PURE__*/ Schema.Struct({
...
export const Dashboard: Schema.Schema<Dashboard> = /*@__PURE__*/ Schema.Struct({
...
export const ListMetricsScopesByMonitoredProjectLocationsGlobalMetricsScopesResponse =
  /*@__PURE__*/ ListMetricsScopesByMonitoredProjectResponse;
...
export const ListProjectsDashboardsRequest = /*@__PURE__*/ Schema.Struct({
...
export const ListProjectsDashboardsResponse =
  /*@__PURE__*/ ListDashboardsResponse;
...
export const GetProjectsDashboardsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const GetProjectsDashboardsResponse = /*@__PURE__*/ Dashboard;
...
export const PatchProjectsDashboardsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const PatchProjectsDashboardsResponse = /*@__PURE__*/ Dashboard;
...
export const CreateProjectsDashboardsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  validateOnly: Schema.optional(Schema.Boolean).pipe(
    T.HttpQuery("validateOnly"),
  ),
...
export const CreateProjectsDashboardsResponse = /*@__PURE__*/ Dashboard;
...
export const DeleteProjectsDashboardsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "DELETE", path: "v1/{+name}" }),
  svc,
...
export const DeleteProjectsDashboardsResponse = /*@__PURE__*/ Empty;
