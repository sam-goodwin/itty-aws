...
export const CreatePolicyPoliciesRequest = /*@__PURE__*/ Schema.Struct({
...
export const ListPoliciesPoliciesRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const GetPoliciesOperationsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v2beta/{+name}" }),
  svc,
