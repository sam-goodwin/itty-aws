...
export const IOPSPerTB: Schema.Schema<IOPSPerTB> = /*@__PURE__*/ Schema.Struct({
...
export const FixedIOPS: Schema.Schema<FixedIOPS> = /*@__PURE__*/ Schema.Struct({
...
export const Share: Schema.Schema<Share> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
...
export const File_Date: Schema.Schema<File_Date> = /*@__PURE__*/ Schema.Struct({
