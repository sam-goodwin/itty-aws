...
export type FirstAndThirdPartyAudienceTargetingSettingList =
  Array<FirstAndThirdPartyAudienceTargetingSetting>;
...
export type FirstAndThirdPartyAudienceGroupList =
  Array<FirstAndThirdPartyAudienceGroup>;
...
export interface AudienceGroupAssignedTargetingOptionDetails {
  ...
  includedFirstAndThirdPartyAudienceGroups?: FirstAndThirdPartyAudienceGroupList;
...
export interface Adloox {
  ...
  misinformationContent?: AdlooxMisinformationContentEnum | (string & {});
  ...
  armsAmmunitionContent?: AdlooxArmsAmmunitionContentEnum | (string & {});
  /** Optional. IAB viewability threshold for video ads. */
  videoIabViewability?: AdlooxVideoIabViewabilityEnum | (string & {});
  /** Optional. Spam or Harmful Content [GARM](https://wfanet.org/leadership/garm/about-garm) risk ranges to exclude. */
  spamHarmfulContent?: AdlooxSpamHarmfulContentEnum | (string & {});
  ...
  obscenityProfanityContent?:
    | AdlooxObscenityProfanityContentEnum
    | (string & {});
  ...
  terrorismContent?: AdlooxTerrorismContentEnum | (string & {});
  /** Optional. IAB viewability threshold for display ads. */
  displayIabViewability?: AdlooxDisplayIabViewabilityEnum | (string & {});
  /** Optional. Online Piracy Content [GARM](https://wfanet.org/leadership/garm/about-garm) risk ranges to exclude. */
  onlinePiracyContent?: AdlooxOnlinePiracyContentEnum | (string & {});
...
export interface AdPolicyTopicAppealInfo {
  ...
  appealType?: AdPolicyTopicAppealInfoAppealTypeEnum | (string & {});
...
export type AdPolicyCriterionRestrictionList =
  Array<AdPolicyCriterionRestriction>;
...
export type AdPolicyTopicConstraintAdPolicyResellerConstraint =
  AdPolicyTopicConstraintAdPolicyGlobalCertificateMissingConstraint;
...
export type AdPolicyTopicConstraintAdPolicyGlobalCertificateDomainMismatchConstraint =
  AdPolicyTopicConstraintAdPolicyGlobalCertificateMissingConstraint;
...
export interface AdPolicyTopicConstraint {
  ...
  /** Reseller constraint. */
  resellerConstraint?: AdPolicyTopicConstraintAdPolicyGlobalCertificateMissingConstraint;
  /** Certificate is required to serve in any country and the existing certificate does not cover the ad's domain. */
  globalCertificateDomainMismatch?: AdPolicyTopicConstraintAdPolicyGlobalCertificateMissingConstraint;
...
export type AdPolicyTopicConstraintList = Array<AdPolicyTopicConstraint>;
...
export interface AdPolicyTopicEvidenceDestinationNotWorking {
  ...
  device?: AdPolicyTopicEvidenceDestinationNotWorkingDeviceEnum | (string & {});
...
export type AdPolicyTopicEvidenceDestinationMismatchUriTypesItemEnumList =
  Array<
    AdPolicyTopicEvidenceDestinationMismatchUriTypesItemEnum | (string & {})
  >;
...
export type AdPolicyTopicEvidenceRegionalRequirementsRegionalRequirementsEntryList =
  Array<AdPolicyTopicEvidenceRegionalRequirementsRegionalRequirementsEntry>;
...
export type AdPolicyTopicEvidenceList = Array<AdPolicyTopicEvidence>;
...
export interface AdPolicyTopicEntry {
  ...
  policyDecisionType?: AdPolicyTopicEntryPolicyDecisionTypeEnum | (string & {});
  ...
  policyTopicType?: AdPolicyTopicEntryPolicyTopicTypeEnum | (string & {});
}
...
export type AdPolicyTopicEntryList = Array<AdPolicyTopicEntry>;
...
export interface AdPolicy {
  ...
  adPolicyReviewStatus?: AdPolicyAdPolicyReviewStatusEnum | (string & {});
  /** The policy approval status of an ad, indicating the approval decision. */
  adPolicyApprovalStatus?: AdPolicyAdPolicyApprovalStatusEnum | (string & {});
}
...
export interface YoutubeVideoDetails {
  ...
  unavailableReason?: YoutubeVideoDetailsUnavailableReasonEnum | (string & {});
}
...
export type CarouselCardList = Array<CarouselCard>;
...
export interface DemandGenProductAd {
  ...
  callToAction?: DemandGenProductAdCallToActionEnum | (string & {});
  /** Required. The description of the ad. */
  description?: string;
  /** Required. The logo image used by this ad. */
  logo?: ImageAsset;
...
export interface MastheadAd {
  ...
  videoAspectRatio?: MastheadAdVideoAspectRatioEnum | (string & {});
  /** The text on the call-to-action button. */
...
export interface DemandGenVideoAd {
  ...
  callToAction?: DemandGenVideoAdCallToActionEnum | (string & {});
  /** Optional. The custom parameters and accompanying values to add to the tracking URL. */
  customParameters?: StringMap;
  /** Optional. The first piece after the domain in the display URL. */
  displayUrlBreadcrumb1?: string;
...
export interface VideoDiscoveryAd {
  ...
  thumbnail?: VideoDiscoveryAdThumbnailEnum | (string & {});
...
export type NonSkippableAd = InStreamAd;
export const NonSkippableAd = InStreamAd;
...
export interface AdGroupAd {
  ...
  entityStatus?: AdGroupAdEntityStatusEnum | (string & {});
...
export const AdGroupAd = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    nonSkippableAd: S.optional(InStreamAd),
  }),
...
export interface ProductFeedData {
  ...
  productMatchType?: ProductFeedDataProductMatchTypeEnum | (string & {});
}
...
export interface AdGroup {
  ...
  entityStatus?: AdGroupEntityStatusEnum | (string & {});
  ...
  adGroupFormat?: AdGroupAdGroupFormatEnum | (string & {});
...
export interface CreateAdvertisersAdGroupsTargetingTypesAssignedTargetingOptionsRequest {
  ...
  targetingType:
    | CreateAdvertisersAdGroupsTargetingTypesAssignedTargetingOptionsTargetingTypeEnum
    | (string & {});
  /** Request body */
...
export interface InsertionOrder {
  ...
  optimizationObjective?:
    | InsertionOrderOptimizationObjectiveEnum
    | (string & {});
...
export interface CustomBiddingAlgorithmRulesError {
  /** The type of error. */
  errorCode?: CustomBiddingAlgorithmRulesErrorErrorCodeEnum | (string & {});
}
...
export interface CustomBiddingAlgorithmRules {
  ...
  state?: CustomBiddingAlgorithmRulesStateEnum | (string & {});
...
export type FirstAndThirdPartyAudienceFirstAndThirdPartyAudienceTypeEnum =
  | "FIRST_AND_THIRD_PARTY_AUDIENCE_TYPE_UNSPECIFIED"
  | "FIRST_AND_THIRD_PARTY_AUDIENCE_TYPE_FIRST_PARTY"
  | "FIRST_AND_THIRD_PARTY_AUDIENCE_TYPE_THIRD_PARTY";
export const FirstAndThirdPartyAudienceFirstAndThirdPartyAudienceTypeEnum =
  /*@__PURE__*/ S.String;

export type FirstAndThirdPartyAudienceAudienceSourceEnum =
  ...
  | "YOUTUBE"
  | "ADS_DATA_HUB";
export const FirstAndThirdPartyAudienceAudienceSourceEnum =
  /*@__PURE__*/ S.String;
...
export type ContactInfoList_ = Array<ContactInfo>;
export const ContactInfoList_ = /*@__PURE__*/ S.Array(
  ContactInfo,
) as any as S.Schema<ContactInfoList_>;
...
}) as any as S.Schema<MobileDeviceIdList>;

export type FirstAndThirdPartyAudienceAudienceTypeEnum =
  ...
  | "YOUTUBE_USERS"
  | "LICENSED";
export const FirstAndThirdPartyAudienceAudienceTypeEnum =
  /*@__PURE__*/ S.String;
...
export interface FirstAndThirdPartyAudience {
  ...
  firstAndThirdPartyAudienceType?:
    | FirstAndThirdPartyAudienceFirstAndThirdPartyAudienceTypeEnum
    | (string & {});
  /** The display name of the first and third party audience. */
  displayName?: string;
  /** Output only. The source of the audience. */
  audienceSource?: FirstAndThirdPartyAudienceAudienceSourceEnum | (string & {});
  ...
  audienceType?: FirstAndThirdPartyAudienceAudienceTypeEnum | (string & {});
...
export const FirstAndThirdPartyAudience = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    membershipDurationDays: S.optional(S.String),
    name: S.optional(S.String),
    activeDisplayAudienceSize: S.optional(S.String),
    firstAndThirdPartyAudienceType: S.optional(
      FirstAndThirdPartyAudienceFirstAndThirdPartyAudienceTypeEnum,
    ),
    displayName: S.optional(S.String),
    audienceSource: S.optional(FirstAndThirdPartyAudienceAudienceSourceEnum),
    ...
    audienceType: S.optional(FirstAndThirdPartyAudienceAudienceTypeEnum),
    appId: S.optional(S.String),
    firstAndThirdPartyAudienceId: S.optional(S.String),
...
}) as any as S.Schema<FirstAndThirdPartyAudience>;
...
export const CreateFirstAndThirdPartyAudiencesRequest = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      advertiserId: S.optional(S.String.pipe(T.Query())),
      body: S.optional(FirstAndThirdPartyAudience.pipe(T.HttpBody())),
    }).pipe(
      T.Http({
        method: "POST",
        uri: "v3/firstAndThirdPartyAudiences",
        baseUrl: "https://displayvideo.googleapis.com/",
      }),
    ),
).annotate({
  identifier: "CreateFirstAndThirdPartyAudiencesRequest",
}) as any as S.Schema<CreateFirstAndThirdPartyAudiencesRequest>;
...
export interface DeleteAdvertisersAdGroupsTargetingTypesAssignedTargetingOptionsRequest {
  ...
  targetingType:
    | DeleteAdvertisersAdGroupsTargetingTypesAssignedTargetingOptionsTargetingTypeEnum
    | (string & {});
...
}) as any as S.Schema<EditCustomerMatchMembersRequest>;
...
export const EditCustomerMatchMembersFirstAndThirdPartyAudiencesRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      firstAndThirdPartyAudienceId: S.String.pipe(T.Label()),
      body: S.optional(EditCustomerMatchMembersRequest.pipe(T.HttpBody())),
    }).pipe(
      T.Http({
        method: "POST",
        uri: "v3/firstAndThirdPartyAudiences/{+firstAndThirdPartyAudienceId}:editCustomerMatchMembers",
        baseUrl: "https://displayvideo.googleapis.com/",
      }),
    ),
  ).annotate({
    identifier: "EditCustomerMatchMembersFirstAndThirdPartyAudiencesRequest",
  }) as any as S.Schema<EditCustomerMatchMembersFirstAndThirdPartyAudiencesRequest>;
...
}) as any as S.Schema<EditCustomerMatchMembersResponse>;
...
export interface GetAdvertisersAdGroupsTargetingTypesAssignedTargetingOptionsRequest {
  ...
  targetingType:
    | GetAdvertisersAdGroupsTargetingTypesAssignedTargetingOptionsTargetingTypeEnum
    | (string & {});
...
export const GetFirstAndThirdPartyAudiencesRequest = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      advertiserId: S.optional(S.String.pipe(T.Query())),
      partnerId: S.optional(S.String.pipe(T.Query())),
      ...
      T.Http({
        method: "GET",
        uri: "v3/firstAndThirdPartyAudiences/{+firstAndThirdPartyAudienceId}",
        baseUrl: "https://displayvideo.googleapis.com/",
      }),
    ),
).annotate({
  identifier: "GetFirstAndThirdPartyAudiencesRequest",
}) as any as S.Schema<GetFirstAndThirdPartyAudiencesRequest>;
...
export type AdGroupAdList = Array<AdGroupAd>;
...
export type AdGroupList = Array<AdGroup>;
...
export interface ListAdvertisersAdGroupsTargetingTypesAssignedTargetingOptionsRequest {
  ...
  targetingType:
    | ListAdvertisersAdGroupsTargetingTypesAssignedTargetingOptionsTargetingTypeEnum
    | (string & {});
...
export type CustomBiddingAlgorithmRulesList =
  Array<CustomBiddingAlgorithmRules>;
...
export const ListFirstAndThirdPartyAudiencesRequest = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      filter: S.optional(S.String.pipe(T.Query())),
      pageToken: S.optional(S.String.pipe(T.Query())),
  ...
  identifier: "ListFirstAndThirdPartyAudiencesRequest",
}) as any as S.Schema<ListFirstAndThirdPartyAudiencesRequest>;

export type FirstAndThirdPartyAudienceList = Array<FirstAndThirdPartyAudience>;
export const FirstAndThirdPartyAudienceList = /*@__PURE__*/ S.Array(
  FirstAndThirdPartyAudience,
) as any as S.Schema<FirstAndThirdPartyAudienceList>;
...
export interface ListFirstAndThirdPartyAudiencesResponse {
  ...
  firstAndThirdPartyAudiences?: FirstAndThirdPartyAudienceList;
...
export const ListFirstAndThirdPartyAudiencesResponse = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      firstAndThirdPartyAudiences: S.optional(FirstAndThirdPartyAudienceList),
      nextPageToken: S.optional(S.String),
    }),
).annotate({
  identifier: "ListFirstAndThirdPartyAudiencesResponse",
}) as any as S.Schema<ListFirstAndThirdPartyAudiencesResponse>;
...
export const PatchFirstAndThirdPartyAudiencesRequest = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      advertiserId: S.optional(S.String.pipe(T.Query())),
      firstAndThirdPartyAudienceId: S.String.pipe(T.Label()),
  ...
  identifier: "PatchFirstAndThirdPartyAudiencesRequest",
}) as any as S.Schema<PatchFirstAndThirdPartyAudiencesRequest>;
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  output: FirstAndThirdPartyAudience,
  errors: [NotFound, Forbidden, BadRequest, Conflict, UnknownGCPError],
  protocol: GcpProtocol,
  retry: Retry.Retry,
}));
