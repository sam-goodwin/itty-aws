...
export const CdcConfig: Schema.Schema<CdcConfig> = /*@__PURE__*/ Schema.Struct({
...
export const MessageSet: Schema.Schema<MessageSet> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "MessageSet" });
...
export const Lake: Schema.Schema<Lake> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
