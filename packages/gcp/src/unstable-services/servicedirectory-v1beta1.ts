...
export const TestIamPermissionsProjectsLocationsNamespacesWorkloadsRequest =
  /*@__PURE__*/ Schema.Struct({
    ...
    svc,
  ) as unknown as Schema.Codec<TestIamPermissionsProjectsLocationsNamespacesWorkloadsRequest>;
...
export const GetIamPolicyProjectsLocationsNamespacesWorkloadsRequest =
  /*@__PURE__*/ Schema.Struct({
    ...
    svc,
  ) as unknown as Schema.Codec<GetIamPolicyProjectsLocationsNamespacesWorkloadsRequest>;
...
export const SetIamPolicyProjectsLocationsNamespacesWorkloadsRequest =
  /*@__PURE__*/ Schema.Struct({
    ...
    svc,
  ) as unknown as Schema.Codec<SetIamPolicyProjectsLocationsNamespacesWorkloadsRequest>;
