...
export const Platform: Schema.Schema<Platform> = /*@__PURE__*/ Schema.Struct({
  description: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
...
export const ListAccountsPlatformsRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetAccountsPlatformsRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetAccountsPlatformsGroupsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1alpha/{+name}" }),
  svc,
...
export const ListAccountsPlatformsGroupsRequest = /*@__PURE__*/ Schema.Struct({
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
}).pipe(
...
export const PatchAccountsPlatformsGroupsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const CreatePlatformsAccountsRequest = /*@__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1alpha/{+parent}/accounts", hasBody: true }),
  svc,
