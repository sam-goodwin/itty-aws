...
export type LanguagesResourceList = LanguagesResource[];
...
export interface ListTranslationsRequest {
  ...
  format?: ListTranslationsFormatEnum;
...
export type TranslationsResourceList = TranslationsResource[];
