...
}).pipe(T.Http({"method":"POST","uri":"v1beta/{+name}:cancel","baseUrl":"https://firebasedataconnect.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1beta/{+parent}/services","baseUrl":"https://firebasedataconnect.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1beta/{+parent}/connectors","baseUrl":"https://firebasedataconnect.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1beta/{+parent}/schemas","baseUrl":"https://firebasedataconnect.googleapis.com/"})),
...
S.Struct({
  "name": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"DELETE","uri":"v1beta/{+name}","baseUrl":"https://firebasedataconnect.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1beta/{+name}:executeGraphql","baseUrl":"https://firebasedataconnect.googleapis.com/"})),
...
S.Struct({
  "name": S.String.pipe(T.Label()),
  "body": S.optional(GraphqlRequest.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"POST","uri":"v1beta/{+name}:executeGraphqlRead","baseUrl":"https://firebasedataconnect.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1beta/{+name}:executeMutation","baseUrl":"https://firebasedataconnect.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1beta/{+name}:executeQuery","baseUrl":"https://firebasedataconnect.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1beta/{+name}:generateQuery","baseUrl":"https://firebasedataconnect.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1beta/{+name}:generateSchema","baseUrl":"https://firebasedataconnect.googleapis.com/"})),
...
S.Struct({
  "name": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v1beta/{+name}","baseUrl":"https://firebasedataconnect.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1beta/{+name}:impersonateMutation","baseUrl":"https://firebasedataconnect.googleapis.com/"})),
...
S.Struct({
  "name": S.String.pipe(T.Label()),
  "body": S.optional(ImpersonateRequest.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"POST","uri":"v1beta/{+name}:impersonateQuery","baseUrl":"https://firebasedataconnect.googleapis.com/"})),
...
S.Struct({
  "name": S.String.pipe(T.Label()),
  "body": S.optional(GraphqlRequest.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"POST","uri":"v1beta/{+name}:introspectGraphql","baseUrl":"https://firebasedataconnect.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v1beta/{+name}/locations","baseUrl":"https://firebasedataconnect.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v1beta/{+name}/operations","baseUrl":"https://firebasedataconnect.googleapis.com/"})),
...
S.Struct({
  ...
  "pageSize": S.optional(S.Number.pipe(T.Query())),
  "pageToken": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1beta/{+parent}/services","baseUrl":"https://firebasedataconnect.googleapis.com/"})),
...
S.Struct({
  ...
  "pageSize": S.optional(S.Number.pipe(T.Query())),
  "pageToken": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1beta/{+parent}/connectors","baseUrl":"https://firebasedataconnect.googleapis.com/"})),
...
S.Struct({
  ...
  "parent": S.String.pipe(T.Label()),
  "orderBy": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1beta/{+parent}/schemas","baseUrl":"https://firebasedataconnect.googleapis.com/"})),
...
S.Struct({
  ...
  "validateOnly": S.optional(S.Boolean.pipe(T.Query())),
  "body": S.optional(Service.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"PATCH","uri":"v1beta/{+name}","baseUrl":"https://firebasedataconnect.googleapis.com/"})),
