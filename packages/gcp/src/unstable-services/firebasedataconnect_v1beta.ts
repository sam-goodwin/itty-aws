...
export const ExecuteGraphqlProjectsLocationsServicesRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "POST",
        uri: "v1beta/{+name}:executeGraphql",
        baseUrl: "https://firebasedataconnect.googleapis.com/",
      }),
    ),
  ).annotate({
...
export const ExecuteGraphqlReadProjectsLocationsServicesRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "POST",
        uri: "v1beta/{+name}:executeGraphqlRead",
        baseUrl: "https://firebasedataconnect.googleapis.com/",
      }),
    ),
  ).annotate({
...
export const ExecuteMutationProjectsLocationsServicesConnectorsRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "POST",
        uri: "v1beta/{+name}:executeMutation",
        baseUrl: "https://firebasedataconnect.googleapis.com/",
      }),
    ),
  ).annotate({
...
export const GenerateSchemaProjectsLocationsServicesRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "POST",
        uri: "v1beta/{+name}:generateSchema",
        baseUrl: "https://firebasedataconnect.googleapis.com/",
      }),
    ),
  ).annotate({
...
export const ImpersonateMutationProjectsLocationsServicesConnectorsRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "POST",
        uri: "v1beta/{+name}:impersonateMutation",
        baseUrl: "https://firebasedataconnect.googleapis.com/",
      }),
    ),
  ).annotate({
...
export const ImpersonateQueryProjectsLocationsServicesConnectorsRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "POST",
        uri: "v1beta/{+name}:impersonateQuery",
        baseUrl: "https://firebasedataconnect.googleapis.com/",
      }),
    ),
  ).annotate({
...
export const IntrospectGraphqlProjectsLocationsServicesRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "POST",
        uri: "v1beta/{+name}:introspectGraphql",
        baseUrl: "https://firebasedataconnect.googleapis.com/",
      }),
    ),
  ).annotate({
