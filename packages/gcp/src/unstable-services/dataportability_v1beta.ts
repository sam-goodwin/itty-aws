...
}).pipe(T.Http({"method":"POST","uri":"v1beta/{+name}:cancel","baseUrl":"https://dataportability.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1beta/accessType:check","baseUrl":"https://dataportability.googleapis.com/"})),
...
S.Struct({
  "name": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v1beta/{+name}","baseUrl":"https://dataportability.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1beta/portabilityArchive:initiate","baseUrl":"https://dataportability.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1beta/authorization:reset","baseUrl":"https://dataportability.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1beta/{+name}:retry","baseUrl":"https://dataportability.googleapis.com/"})),
