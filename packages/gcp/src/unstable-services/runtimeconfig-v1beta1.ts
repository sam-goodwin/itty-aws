...
export const Waiter: Schema.Schema<Waiter> = /*@__PURE__*/ Schema.Struct({
...
export const Variable: Schema.Schema<Variable> = /*@__PURE__*/ Schema.Struct({
...
export const GetProjectsConfigsRequest = /*@__PURE__*/ Schema.Struct({
...
export const DeleteProjectsConfigsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
...
export const GetIamPolicyProjectsConfigsRequest = /*@__PURE__*/ Schema.Struct({
  resource: Schema.String.pipe(T.HttpPath("resource")),
...
export const SetIamPolicyProjectsConfigsRequest = /*@__PURE__*/ Schema.Struct({
  resource: Schema.String.pipe(T.HttpPath("resource")),
...
export const CreateProjectsConfigsRequest = /*@__PURE__*/ Schema.Struct({
...
export const UpdateProjectsConfigsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(RuntimeConfig).pipe(T.HttpBody()),
}).pipe(
...
export const ListProjectsConfigsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const GetProjectsConfigsVariablesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta1/{+name}" }),
  svc,
...
export const WatchProjectsConfigsVariablesRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
...
export const ListProjectsConfigsVariablesRequest = /*@__PURE__*/ Schema.Struct({
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
...
export const CreateProjectsConfigsWaitersRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  requestId: Schema.optional(Schema.String).pipe(T.HttpQuery("requestId")),
...
export const ListProjectsConfigsWaitersRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
}).pipe(
...
export const DeleteProjectsConfigsWaitersRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "DELETE", path: "v1beta1/{+name}" }),
  svc,
...
export const GetProjectsConfigsWaitersRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta1/{+name}" }),
  svc,
...
export const GetProjectsConfigsOperationsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta1/{+name}" }),
  svc,
