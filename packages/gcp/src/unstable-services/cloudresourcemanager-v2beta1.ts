...
export const TestIamPermissionsFoldersRequest = /*@__PURE__*/ Schema.Struct({
...
export const SetIamPolicyFoldersRequest = /*@__PURE__*/ Schema.Struct({
  resource: Schema.String.pipe(T.HttpPath("resource")),
...
export const GetIamPolicyFoldersRequest = /*@__PURE__*/ Schema.Struct({
  resource: Schema.String.pipe(T.HttpPath("resource")),
...
export const SearchFoldersRequest_Op = /*@__PURE__*/ Schema.Struct({
