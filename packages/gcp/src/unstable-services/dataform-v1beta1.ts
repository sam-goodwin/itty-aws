...
export const TableUpdateTrigger: Schema.Schema<TableUpdateTrigger> =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    table: Schema.optional(Target),
    triggerUpdateTime: Schema.optional(Schema.String),
  }).annotate({ identifier: "TableUpdateTrigger" });
...
export const WorkflowTrigger: Schema.Schema<WorkflowTrigger> =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    tableUpdateTrigger: Schema.optional(TableUpdateTrigger),
  }).annotate({ identifier: "WorkflowTrigger" });
...
export interface DeleteRepositoryLongRunningRequest {
...
export const DeleteRepositoryLongRunningRequest: Schema.Schema<DeleteRepositoryLongRunningRequest> =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    force: Schema.optional(Schema.Boolean),
  }).annotate({ identifier: "DeleteRepositoryLongRunningRequest" });
...
export const TriggerEvaluationRecord: Schema.Schema<TriggerEvaluationRecord> =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    evaluationTime: Schema.optional(Schema.String),
    status: Schema.optional(Status),
  }).annotate({ identifier: "TriggerEvaluationRecord" });
...
export interface WorkflowTriggerConfig {
  ...
  condition?: "CONDITION_UNSPECIFIED" | "ALL" | "ANY" | (string & {});
  /** Required. The trigger definitions to invoke a workflow. */
  workflowTriggers?: ReadonlyArray<WorkflowTrigger>;
  ...
  recentTriggerEvaluationRecords?: ReadonlyArray<TriggerEvaluationRecord>;
}

export const WorkflowTriggerConfig: Schema.Schema<WorkflowTriggerConfig> =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    minExecutionDuration: Schema.optional(Schema.String),
    lastSuccessfulEvaluationTime: Schema.optional(Schema.String),
    maxWaitDuration: Schema.optional(Schema.String),
    condition: Schema.optional(Schema.String),
    workflowTriggers: Schema.optional(Schema.Array(WorkflowTrigger)),
    recentTriggerEvaluationRecords: Schema.optional(
      Schema.Array(TriggerEvaluationRecord),
    ),
  }).annotate({ identifier: "WorkflowTriggerConfig" });
...
export const WorkflowConfig: Schema.Schema<WorkflowConfig> =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    disabled: Schema.optional(Schema.Boolean),
    invocationConfig: Schema.optional(InvocationConfig),
    workflowTriggerConfig: Schema.optional(WorkflowTriggerConfig),
...
export interface DeleteLongRunningProjectsLocationsRepositoriesRequest {
  /** Required. The repository's name. */
  name: string;
  /** Request body */
...
export const DeleteLongRunningProjectsLocationsRepositoriesRequest =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    name: Schema.String.pipe(T.HttpPath("name")),
    body: Schema.optional(DeleteRepositoryLongRunningRequest).pipe(
      T.HttpBody(),
    ),
  }).pipe(
    T.Http({
    ...
    svc,
  ) as unknown as Schema.Schema<DeleteLongRunningProjectsLocationsRepositoriesRequest>;

export type DeleteLongRunningProjectsLocationsRepositoriesResponse = Operation;
export const DeleteLongRunningProjectsLocationsRepositoriesResponse =
  /*@__PURE__*/ /*#__PURE__*/ Operation;

export type DeleteLongRunningProjectsLocationsRepositoriesError =
  | DefaultErrors
  | NotFound
  | Forbidden
  | BadRequest
...
export const deleteLongRunningProjectsLocationsRepositories: API.OperationMethod<
  DeleteLongRunningProjectsLocationsRepositoriesRequest,
  DeleteLongRunningProjectsLocationsRepositoriesResponse,
  DeleteLongRunningProjectsLocationsRepositoriesError,
  Credentials | HttpClient.HttpClient
> = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  input: DeleteLongRunningProjectsLocationsRepositoriesRequest,
  output: DeleteLongRunningProjectsLocationsRepositoriesResponse,
  errors: [NotFound, Forbidden, BadRequest, Conflict],
}));
