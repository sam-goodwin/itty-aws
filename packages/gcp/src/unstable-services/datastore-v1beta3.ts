...
export const Value: Schema.Schema<Value> = /*@__PURE__*/ Schema.suspend(() =>
  Schema.Struct({
...
export const Entity: Schema.Schema<Entity> = /*@__PURE__*/ Schema.suspend(() =>
  Schema.Struct({
...
export const Sum: Schema.Schema<Sum> = /*@__PURE__*/ Schema.Struct({
...
export const GqlQuery: Schema.Schema<GqlQuery> = /*@__PURE__*/ Schema.Struct({
...
export const Count: Schema.Schema<Count> = /*@__PURE__*/ Schema.Struct({
...
export const RollbackResponse: Schema.Schema<RollbackResponse> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "RollbackResponse" });
...
export const Avg: Schema.Schema<Avg> = /*@__PURE__*/ Schema.Struct({
  property: Schema.optional(PropertyReference),
...
export const ReserveIdsProjectsRequest = /*@__PURE__*/ Schema.Struct({
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
...
export const RunQueryProjectsRequest = /*@__PURE__*/ Schema.Struct({
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
...
export const RunAggregationQueryProjectsRequest = /*@__PURE__*/ Schema.Struct({
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
...
export const BeginTransactionProjectsRequest = /*@__PURE__*/ Schema.Struct({
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
...
export const RollbackProjectsRequest = /*@__PURE__*/ Schema.Struct({
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
...
export const AllocateIdsProjectsRequest = /*@__PURE__*/ Schema.Struct({
  projectId: Schema.String.pipe(T.HttpPath("projectId")),
