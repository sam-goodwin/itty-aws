...
export const TextInput: Schema.Schema<TextInput> = /*@__PURE__*/ Schema.Struct({
...
export const CheckboxInput: Schema.Schema<CheckboxInput> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "CheckboxInput" });
...
export const Reason: Schema.Schema<Reason> = /*@__PURE__*/ Schema.suspend(() =>
  Schema.Struct({
    detail: Schema.optional(Schema.String),
    message: Schema.optional(Schema.String),
...
export const TriggeractionIssueresolutionRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  languageCode: Schema.optional(Schema.String).pipe(
    T.HttpQuery("languageCode"),
  ),
