...
}).pipe(T.Http({"method":"POST","uri":"v1alpha:answerQuery","baseUrl":"https://developerknowledge.googleapis.com/"})),
).annotate({ identifier: "AnswerQueryV1alphaRequest" }) as any as S.Schema<AnswerQueryV1alphaRequest>;
...
}).pipe(T.Http({"method":"GET","uri":"v1alpha/documents:batchGet","baseUrl":"https://developerknowledge.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v1alpha/{+name}","baseUrl":"https://developerknowledge.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v1alpha/documents:searchDocumentChunks","baseUrl":"https://developerknowledge.googleapis.com/"})),
...
export type AnswerQueryV1alphaError = NotFound | Forbidden | BadRequest | Conflict | GcpOpError;
