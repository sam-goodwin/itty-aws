...
export const UserName: Schema.Schema<UserName> = /*@__PURE__*/ Schema.Struct({
...
export const Token: Schema.Schema<Token> = /*@__PURE__*/ Schema.Struct({
...
export const Schemas: Schema.Schema<Schemas> = /*@__PURE__*/ Schema.Struct({
  etag: Schema.optional(Schema.String),
  kind: Schema.optional(Schema.String),
...
export const Tokens: Schema.Schema<Tokens> = /*@__PURE__*/ Schema.Struct({
  kind: Schema.optional(Schema.String),
...
export const Printer: Schema.Schema<Printer> = /*@__PURE__*/ Schema.Struct({
  createTime: Schema.optional(Schema.String),
  uri: Schema.optional(Schema.String),
  id: Schema.optional(Schema.String),
...
export const Channel: Schema.Schema<Channel> = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
...
export const UserAbout: Schema.Schema<UserAbout> = /*@__PURE__*/ Schema.Struct({
...
export const Asp: Schema.Schema<Asp> = /*@__PURE__*/ Schema.Struct({
...
export const Asps: Schema.Schema<Asps> = /*@__PURE__*/ Schema.Struct({
  etag: Schema.optional(Schema.String),
  kind: Schema.optional(Schema.String),
...
export const Group: Schema.Schema<Group> = /*@__PURE__*/ Schema.Struct({
  aliases: Schema.optional(Schema.Array(Schema.String)),
...
export const Feature: Schema.Schema<Feature> = /*@__PURE__*/ Schema.Struct({
  etags: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
  kind: Schema.optional(Schema.String),
...
export const OrgUnit: Schema.Schema<OrgUnit> = /*@__PURE__*/ Schema.Struct({
  orgUnitPath: Schema.optional(Schema.String),
  kind: Schema.optional(Schema.String),
...
export const Aliases: Schema.Schema<Aliases> = /*@__PURE__*/ Schema.Struct({
  etag: Schema.optional(Schema.String),
  kind: Schema.optional(Schema.String),
...
export const Features: Schema.Schema<Features> = /*@__PURE__*/ Schema.Struct({
...
export const UserIm: Schema.Schema<UserIm> = /*@__PURE__*/ Schema.Struct({
  primary: Schema.optional(Schema.Boolean),
...
export const Building: Schema.Schema<Building> = /*@__PURE__*/ Schema.Struct({
  etags: Schema.optional(Schema.String),
  buildingId: Schema.optional(Schema.String),
  kind: Schema.optional(Schema.String),
  description: Schema.optional(Schema.String),
...
export const FanInfo: Schema.Schema<FanInfo> = /*@__PURE__*/ Schema.Struct({
...
export const Domains: Schema.Schema<Domains> = /*@__PURE__*/ Schema.Struct({
  domainAliases: Schema.optional(Schema.Array(DomainAlias)),
  verified: Schema.optional(Schema.Boolean),
...
export const UserEmail: Schema.Schema<UserEmail> = /*@__PURE__*/ Schema.Struct({
  address: Schema.optional(Schema.String),
  primary: Schema.optional(Schema.Boolean),
...
export const Users: Schema.Schema<Users> = /*@__PURE__*/ Schema.Struct({
...
export const UserPhone: Schema.Schema<UserPhone> = /*@__PURE__*/ Schema.Struct({
  primary: Schema.optional(Schema.Boolean),
  value: Schema.optional(Schema.String),
  customType: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
...
export const UserAlias: Schema.Schema<UserAlias> = /*@__PURE__*/ Schema.Struct({
  id: Schema.optional(Schema.String),
  primaryEmail: Schema.optional(Schema.String),
  alias: Schema.optional(Schema.String),
  kind: Schema.optional(Schema.String),
...
export const Privilege: Schema.Schema<Privilege> = /*@__PURE__*/ Schema.suspend(
  () =>
    Schema.Struct({
      etag: Schema.optional(Schema.String),
...
export const Member: Schema.Schema<Member> = /*@__PURE__*/ Schema.Struct({
...
export const Buildings: Schema.Schema<Buildings> = /*@__PURE__*/ Schema.Struct({
...
export const Members: Schema.Schema<Members> = /*@__PURE__*/ Schema.Struct({
  nextPageToken: Schema.optional(Schema.String),
...
export const Roles: Schema.Schema<Roles> = /*@__PURE__*/ Schema.Struct({
  kind: Schema.optional(Schema.String),
...
export const OrgUnits: Schema.Schema<OrgUnits> = /*@__PURE__*/ Schema.Struct({
  kind: Schema.optional(Schema.String),
  etag: Schema.optional(Schema.String),
...
export const Alias: Schema.Schema<Alias> = /*@__PURE__*/ Schema.Struct({
  alias: Schema.optional(Schema.String),
  primaryEmail: Schema.optional(Schema.String),
  id: Schema.optional(Schema.String),
  etag: Schema.optional(Schema.String),
...
export const ByteUsage: Schema.Schema<ByteUsage> = /*@__PURE__*/ Schema.Struct({
...
export const Customer: Schema.Schema<Customer> = /*@__PURE__*/ Schema.Struct({
  kind: Schema.optional(Schema.String),
...
export const UserPhoto: Schema.Schema<UserPhoto> = /*@__PURE__*/ Schema.Struct({
  primaryEmail: Schema.optional(Schema.String),
...
export const Domains2: Schema.Schema<Domains2> = /*@__PURE__*/ Schema.Struct({
  kind: Schema.optional(Schema.String),
  etag: Schema.optional(Schema.String),
...
export const DeleteAspsResponse: Schema.Schema<DeleteAspsResponse> =
  /*@__PURE__*/ Schema.Struct({}) as any as Schema.Schema<DeleteAspsResponse>;
...
export const ListResourcesBuildingsRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetResourcesBuildingsRequest = /*@__PURE__*/ Schema.Struct({
  customer: Schema.String.pipe(T.HttpPath("customer")),
...
export const InsertResourcesBuildingsRequest = /*@__PURE__*/ Schema.Struct({
  customer: Schema.String.pipe(T.HttpPath("customer")),
...
export const UpdateResourcesBuildingsRequest = /*@__PURE__*/ Schema.Struct({
  coordinatesSource: Schema.optional(Schema.String).pipe(
    T.HttpQuery("coordinatesSource"),
  ),
  customer: Schema.String.pipe(T.HttpPath("customer")),
...
export const PatchResourcesBuildingsRequest = /*@__PURE__*/ Schema.Struct({
  coordinatesSource: Schema.optional(Schema.String).pipe(
    T.HttpQuery("coordinatesSource"),
  ),
  buildingId: Schema.String.pipe(T.HttpPath("buildingId")),
...
export const DeleteResourcesBuildingsRequest = /*@__PURE__*/ Schema.Struct({
  customer: Schema.String.pipe(T.HttpPath("customer")),
  buildingId: Schema.String.pipe(T.HttpPath("buildingId")),
}).pipe(
  T.Http({
...
export const ListResourcesCalendarsRequest = /*@__PURE__*/ Schema.Struct({
...
export const InsertResourcesCalendarsRequest = /*@__PURE__*/ Schema.Struct({
  customer: Schema.String.pipe(T.HttpPath("customer")),
...
export const UpdateResourcesCalendarsRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetResourcesCalendarsRequest = /*@__PURE__*/ Schema.Struct({
  customer: Schema.String.pipe(T.HttpPath("customer")),
  calendarResourceId: Schema.String.pipe(T.HttpPath("calendarResourceId")),
}).pipe(
  T.Http({
...
export const PatchResourcesCalendarsRequest = /*@__PURE__*/ Schema.Struct({
  calendarResourceId: Schema.String.pipe(T.HttpPath("calendarResourceId")),
  customer: Schema.String.pipe(T.HttpPath("customer")),
  body: Schema.optional(CalendarResource).pipe(T.HttpBody()),
}).pipe(
...
export const DeleteResourcesCalendarsRequest = /*@__PURE__*/ Schema.Struct({
  customer: Schema.String.pipe(T.HttpPath("customer")),
  calendarResourceId: Schema.String.pipe(T.HttpPath("calendarResourceId")),
}).pipe(
  T.Http({
...
export const PatchResourcesFeaturesRequest = /*@__PURE__*/ Schema.Struct({
...
export const DeleteResourcesFeaturesRequest = /*@__PURE__*/ Schema.Struct({
  customer: Schema.String.pipe(T.HttpPath("customer")),
  featureKey: Schema.String.pipe(T.HttpPath("featureKey")),
}).pipe(
  T.Http({
...
export const ListResourcesFeaturesRequest = /*@__PURE__*/ Schema.Struct({
  maxResults: Schema.optional(Schema.Number).pipe(T.HttpQuery("maxResults")),
  customer: Schema.String.pipe(T.HttpPath("customer")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
}).pipe(
...
export const RenameResourcesFeaturesRequest = /*@__PURE__*/ Schema.Struct({
  customer: Schema.String.pipe(T.HttpPath("customer")),
...
export const GetResourcesFeaturesRequest = /*@__PURE__*/ Schema.Struct({
  customer: Schema.String.pipe(T.HttpPath("customer")),
  featureKey: Schema.String.pipe(T.HttpPath("featureKey")),
}).pipe(
  T.Http({
...
export const InsertResourcesFeaturesRequest = /*@__PURE__*/ Schema.Struct({
  customer: Schema.String.pipe(T.HttpPath("customer")),
  body: Schema.optional(Feature).pipe(T.HttpBody()),
}).pipe(
  T.Http({
...
export const UpdateResourcesFeaturesRequest = /*@__PURE__*/ Schema.Struct({
  featureKey: Schema.String.pipe(T.HttpPath("featureKey")),
  customer: Schema.String.pipe(T.HttpPath("customer")),
  body: Schema.optional(Feature).pipe(T.HttpBody()),
}).pipe(
...
export const UpdateChromeosdevicesRequest = /*@__PURE__*/ Schema.Struct({
  deviceId: Schema.String.pipe(T.HttpPath("deviceId")),
...
export const GetChromeosdevicesRequest = /*@__PURE__*/ Schema.Struct({
  deviceId: Schema.String.pipe(T.HttpPath("deviceId")),
  customerId: Schema.String.pipe(T.HttpPath("customerId")),
  projection: Schema.optional(Schema.String).pipe(T.HttpQuery("projection")),
}).pipe(
...
export const ListChromeosdevicesRequest = /*@__PURE__*/ Schema.Struct({
  includeChildOrgunits: Schema.optional(Schema.Boolean).pipe(
    T.HttpQuery("includeChildOrgunits"),
  ),
  orderBy: Schema.optional(Schema.String).pipe(T.HttpQuery("orderBy")),
...
export const ActionChromeosdevicesRequest = /*@__PURE__*/ Schema.Struct({
  customerId: Schema.String.pipe(T.HttpPath("customerId")),
...
export const PatchChromeosdevicesRequest = /*@__PURE__*/ Schema.Struct({
  projection: Schema.optional(Schema.String).pipe(T.HttpQuery("projection")),
  customerId: Schema.String.pipe(T.HttpPath("customerId")),
  deviceId: Schema.String.pipe(T.HttpPath("deviceId")),
  body: Schema.optional(ChromeOsDevice).pipe(T.HttpBody()),
...
export const DeleteRoleAssignmentsRequest = /*@__PURE__*/ Schema.Struct({
...
export const InsertRoleAssignmentsRequest = /*@__PURE__*/ Schema.Struct({
  customer: Schema.String.pipe(T.HttpPath("customer")),
...
export const GetRoleAssignmentsRequest = /*@__PURE__*/ Schema.Struct({
  customer: Schema.String.pipe(T.HttpPath("customer")),
  roleAssignmentId: Schema.String.pipe(T.HttpPath("roleAssignmentId")),
}).pipe(
  T.Http({
...
export const ListRoleAssignmentsRequest = /*@__PURE__*/ Schema.Struct({
...
export const DeleteTokensResponse: Schema.Schema<DeleteTokensResponse> =
  /*@__PURE__*/ Schema.Struct({}) as any as Schema.Schema<DeleteTokensResponse>;
...
export const DeleteGroupsResponse: Schema.Schema<DeleteGroupsResponse> =
  /*@__PURE__*/ Schema.Struct({}) as any as Schema.Schema<DeleteGroupsResponse>;
...
export const DeleteGroupsAliasesRequest = /*@__PURE__*/ Schema.Struct({
  groupKey: Schema.String.pipe(T.HttpPath("groupKey")),
...
export const InsertGroupsAliasesRequest = /*@__PURE__*/ Schema.Struct({
  groupKey: Schema.String.pipe(T.HttpPath("groupKey")),
...
export const ListGroupsAliasesRequest = /*@__PURE__*/ Schema.Struct({
  groupKey: Schema.String.pipe(T.HttpPath("groupKey")),
}).pipe(
  T.Http({
    method: "GET",
...
export const StopChannelsResponse: Schema.Schema<StopChannelsResponse> =
  /*@__PURE__*/ Schema.Struct({}) as any as Schema.Schema<StopChannelsResponse>;
...
export const ListDomainAliasesRequest = /*@__PURE__*/ Schema.Struct({
...
export const DeleteDomainAliasesRequest = /*@__PURE__*/ Schema.Struct({
  customer: Schema.String.pipe(T.HttpPath("customer")),
...
export const InsertDomainAliasesRequest = /*@__PURE__*/ Schema.Struct({
  customer: Schema.String.pipe(T.HttpPath("customer")),
...
export const GetDomainAliasesRequest = /*@__PURE__*/ Schema.Struct({
  customer: Schema.String.pipe(T.HttpPath("customer")),
  domainAliasName: Schema.String.pipe(T.HttpPath("domainAliasName")),
}).pipe(
  T.Http({
...
export const DeleteRolesResponse: Schema.Schema<DeleteRolesResponse> =
  /*@__PURE__*/ Schema.Struct({}) as any as Schema.Schema<DeleteRolesResponse>;
...
export const HasMemberMembersRequest = /*@__PURE__*/ Schema.Struct({
  groupKey: Schema.String.pipe(T.HttpPath("groupKey")),
  memberKey: Schema.String.pipe(T.HttpPath("memberKey")),
}).pipe(
  T.Http({
...
export const ActionMobiledevicesRequest = /*@__PURE__*/ Schema.Struct({
  customerId: Schema.String.pipe(T.HttpPath("customerId")),
  resourceId: Schema.String.pipe(T.HttpPath("resourceId")),
...
export const ListMobiledevicesRequest = /*@__PURE__*/ Schema.Struct({
  customerId: Schema.String.pipe(T.HttpPath("customerId")),
  projection: Schema.optional(Schema.String).pipe(T.HttpQuery("projection")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  query: Schema.optional(Schema.String).pipe(T.HttpQuery("query")),
...
export const GetMobiledevicesRequest = /*@__PURE__*/ Schema.Struct({
  projection: Schema.optional(Schema.String).pipe(T.HttpQuery("projection")),
  customerId: Schema.String.pipe(T.HttpPath("customerId")),
  resourceId: Schema.String.pipe(T.HttpPath("resourceId")),
}).pipe(
...
export const DeleteMobiledevicesRequest = /*@__PURE__*/ Schema.Struct({
  resourceId: Schema.String.pipe(T.HttpPath("resourceId")),
  customerId: Schema.String.pipe(T.HttpPath("customerId")),
}).pipe(
  T.Http({
...
export const CreateGuestUsersRequest = /*@__PURE__*/ Schema.Struct({
...
export const SignOutUsersResponse: Schema.Schema<SignOutUsersResponse> =
  /*@__PURE__*/ Schema.Struct({}) as any as Schema.Schema<SignOutUsersResponse>;
...
export const DeleteUsersPhotosRequest = /*@__PURE__*/ Schema.Struct({
  userKey: Schema.String.pipe(T.HttpPath("userKey")),
}).pipe(
  T.Http({
    method: "DELETE",
...
export const UpdateUsersPhotosRequest = /*@__PURE__*/ Schema.Struct({
  userKey: Schema.String.pipe(T.HttpPath("userKey")),
...
export const PatchUsersPhotosRequest = /*@__PURE__*/ Schema.Struct({
  userKey: Schema.String.pipe(T.HttpPath("userKey")),
  body: Schema.optional(UserPhoto).pipe(T.HttpBody()),
}).pipe(
  T.Http({
...
export const DeleteUsersAliasesRequest = /*@__PURE__*/ Schema.Struct({
  alias: Schema.String.pipe(T.HttpPath("alias")),
  userKey: Schema.String.pipe(T.HttpPath("userKey")),
}).pipe(
  T.Http({
...
export const InsertUsersAliasesRequest = /*@__PURE__*/ Schema.Struct({
  userKey: Schema.String.pipe(T.HttpPath("userKey")),
  body: Schema.optional(Alias).pipe(T.HttpBody()),
}).pipe(
  T.Http({
...
export const ListUsersAliasesRequest = /*@__PURE__*/ Schema.Struct({
  userKey: Schema.String.pipe(T.HttpPath("userKey")),
  event: Schema.optional(Schema.String).pipe(T.HttpQuery("event")),
}).pipe(
...
export const WatchUsersAliasesRequest = /*@__PURE__*/ Schema.Struct({
  userKey: Schema.String.pipe(T.HttpPath("userKey")),
  event: Schema.optional(Schema.String).pipe(T.HttpQuery("event")),
  body: Schema.optional(Channel).pipe(T.HttpBody()),
}).pipe(
...
export const GenerateVerificationCodesRequest = /*@__PURE__*/ Schema.Struct({
  userKey: Schema.String.pipe(T.HttpPath("userKey")),
}).pipe(
  T.Http({
    method: "POST",
...
export const InvalidateVerificationCodesRequest = /*@__PURE__*/ Schema.Struct({
  userKey: Schema.String.pipe(T.HttpPath("userKey")),
}).pipe(
  T.Http({
    method: "POST",
...
export const ListVerificationCodesRequest = /*@__PURE__*/ Schema.Struct({
  userKey: Schema.String.pipe(T.HttpPath("userKey")),
}).pipe(
  T.Http({
    method: "GET",
...
export const TurnOffTwoStepVerificationRequest = /*@__PURE__*/ Schema.Struct({
  userKey: Schema.String.pipe(T.HttpPath("userKey")),
}).pipe(
  T.Http({
    method: "POST",
...
export const DeleteCustomersChromePrintersRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
  },
).pipe(
...
export const CreateCustomersChromePrintersRequest = /*@__PURE__*/ Schema.Struct(
  {
    parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const PatchCustomersChromePrintersRequest = /*@__PURE__*/ Schema.Struct({
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const GetCustomersChromePrintersRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "admin/directory/v1/{+name}" }),
  svc,
...
export const ListCustomersChromePrintersRequest = /*@__PURE__*/ Schema.Struct({
  orderBy: Schema.optional(Schema.String).pipe(T.HttpQuery("orderBy")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
  filter: Schema.optional(Schema.String).pipe(T.HttpQuery("filter")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
