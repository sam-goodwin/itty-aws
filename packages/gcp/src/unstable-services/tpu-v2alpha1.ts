...
export const CreatingData: Schema.Schema<CreatingData> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "CreatingData" });
...
export const BestEffort: Schema.Schema<BestEffort> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "BestEffort" });
...
export const SuspendedData: Schema.Schema<SuspendedData> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "SuspendedData" });
...
export const Symptom: Schema.Schema<Symptom> = /*@__PURE__*/ Schema.Struct({
  createTime: Schema.optional(Schema.String),
...
export const NodeSpec: Schema.Schema<NodeSpec> = /*@__PURE__*/ Schema.Struct({
...
export const Tpu: Schema.Schema<Tpu> = /*@__PURE__*/ Schema.Struct({
...
export const Spot: Schema.Schema<Spot> = /*@__PURE__*/ Schema.Struct(
  {},
).annotate({ identifier: "Spot" });
...
export const StopNodeRequest: Schema.Schema<StopNodeRequest> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "StopNodeRequest" });
...
export const StartNodeRequest: Schema.Schema<StartNodeRequest> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "StartNodeRequest" });
...
export const CreateProjectsLocationsNodesRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const ListProjectsLocationsNodesRequest = /*@__PURE__*/ Schema.Struct({
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
}).pipe(
...
export const DeleteProjectsLocationsNodesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  requestId: Schema.optional(Schema.String).pipe(T.HttpQuery("requestId")),
}).pipe(
  T.Http({ method: "DELETE", path: "v2alpha1/{+name}" }),
...
export const PatchProjectsLocationsNodesRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetProjectsLocationsNodesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v2alpha1/{+name}" }),
  svc,
...
export const StartProjectsLocationsNodesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const StopProjectsLocationsNodesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
