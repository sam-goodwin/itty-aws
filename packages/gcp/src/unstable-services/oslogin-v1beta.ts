...
export const WebAuthn: Schema.Schema<WebAuthn> = /*@__PURE__*/ Schema.Struct({
...
export const SignSshPublicKeyProjectsLocationsResponse =
  /*@__PURE__*/ GoogleCloudOsloginControlplaneRegionalV1betaSignSshPublicKeyResponse;
...
export const GetLoginProfileUsersRequest = /*@__PURE__*/ Schema.Struct({
...
export const ImportSshPublicKeyUsersRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  projectId: Schema.optional(Schema.String).pipe(T.HttpQuery("projectId")),
  view: Schema.optional(Schema.String).pipe(T.HttpQuery("view")),
...
export const CreateUsersSshPublicKeysRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(SshPublicKey).pipe(T.HttpBody()),
}).pipe(
  T.Http({
...
export const DeleteUsersSshPublicKeysRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
...
export const GetUsersSshPublicKeysRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
...
export const PatchUsersSshPublicKeysRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const DeleteUsersProjectsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "DELETE", path: "v1beta/{+name}" }),
  svc,
