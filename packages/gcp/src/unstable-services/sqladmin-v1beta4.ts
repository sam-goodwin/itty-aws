...
export const BackupRun: Schema.Schema<BackupRun> = /*@__PURE__*/ Schema.Struct({
  kind: Schema.optional(Schema.String),
  status: Schema.optional(Schema.String),
...
export const Flag: Schema.Schema<Flag> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
...
export const AclEntry: Schema.Schema<AclEntry> = /*@__PURE__*/ Schema.Struct({
...
export const IpMapping: Schema.Schema<IpMapping> = /*@__PURE__*/ Schema.Struct({
  type: Schema.optional(Schema.String),
  ipAddress: Schema.optional(Schema.String),
...
export const SslCert: Schema.Schema<SslCert> = /*@__PURE__*/ Schema.Struct({
  kind: Schema.optional(Schema.String),
...
export const SyncFlags: Schema.Schema<SyncFlags> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
  value: Schema.optional(Schema.String),
...
export const Column: Schema.Schema<Column> = /*@__PURE__*/ Schema.Struct({
  name: Schema.optional(Schema.String),
  type: Schema.optional(Schema.String),
...
export const Tier: Schema.Schema<Tier> = /*@__PURE__*/ Schema.Struct({
  tier: Schema.optional(Schema.String),
...
export const DeleteBackupRunsRequest = /*@__PURE__*/ Schema.Struct({
...
export const InsertBackupRunsRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  instance: Schema.String.pipe(T.HttpPath("instance")),
...
export const AddServerCaInstancesRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  instance: Schema.String.pipe(T.HttpPath("instance")),
}).pipe(
  T.Http({
...
export const AddServerCertificateInstancesRequest = /*@__PURE__*/ Schema.Struct(
  {
    project: Schema.String.pipe(T.HttpPath("project")),
    instance: Schema.String.pipe(T.HttpPath("instance")),
  },
...
export const DemoteMasterInstancesRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  instance: Schema.String.pipe(T.HttpPath("instance")),
...
export const FailoverInstancesRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  instance: Schema.String.pipe(T.HttpPath("instance")),
...
export const ReencryptInstancesRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  instance: Schema.String.pipe(T.HttpPath("instance")),
...
export const ListServerCasInstancesRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  instance: Schema.String.pipe(T.HttpPath("instance")),
}).pipe(
  T.Http({
...
export const PromoteReplicaInstancesRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  instance: Schema.String.pipe(T.HttpPath("instance")),
...
export const SwitchoverInstancesRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  instance: Schema.String.pipe(T.HttpPath("instance")),
...
export const ResetSslConfigInstancesRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  instance: Schema.String.pipe(T.HttpPath("instance")),
...
export const RestartInstancesRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  instance: Schema.String.pipe(T.HttpPath("instance")),
}).pipe(
  T.Http({
...
export const RestoreBackupInstancesRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  instance: Schema.String.pipe(T.HttpPath("instance")),
...
export const RotateServerCaInstancesRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  instance: Schema.String.pipe(T.HttpPath("instance")),
...
export const StartReplicaInstancesRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  instance: Schema.String.pipe(T.HttpPath("instance")),
}).pipe(
  T.Http({
...
export const StopReplicaInstancesRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  instance: Schema.String.pipe(T.HttpPath("instance")),
}).pipe(
  T.Http({
...
export const TruncateLogInstancesRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  instance: Schema.String.pipe(T.HttpPath("instance")),
...
export const ExecuteSqlInstancesRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  instance: Schema.String.pipe(T.HttpPath("instance")),
...
export const AcquireSsrsLeaseInstancesRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  instance: Schema.String.pipe(T.HttpPath("instance")),
...
export const ReleaseSsrsLeaseInstancesRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  instance: Schema.String.pipe(T.HttpPath("instance")),
}).pipe(
  T.Http({
...
export const PointInTimeRestoreInstancesRequest = /*@__PURE__*/ Schema.Struct({
...
export const CreateEphemeralSslCertsRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  instance: Schema.String.pipe(T.HttpPath("instance")),
...
export const CreateBackupBackupsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const GetBackupBackupsRequest = /*@__PURE__*/ Schema.Struct({
...
export const ListBackupsBackupsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const UpdateBackupBackupsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const DeleteBackupBackupsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
...
export const GenerateEphemeralCertConnectRequest = /*@__PURE__*/ Schema.Struct({
  project: Schema.String.pipe(T.HttpPath("project")),
  instance: Schema.String.pipe(T.HttpPath("instance")),
