...
export const Shipping: Schema.Schema<Shipping> = /*@__PURE__*/ Schema.Struct({
...
export const DeleteAccountsProductInputsRequest = /*@__PURE__*/ Schema.Struct({
...
export const InsertAccountsProductInputsRequest = /*@__PURE__*/ Schema.Struct({
...
export const PatchAccountsProductInputsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const GetAccountsProductsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
...
export const ListAccountsProductsRequest = /*@__PURE__*/ Schema.Struct({
