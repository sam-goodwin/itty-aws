...
export const Details: Schema.Schema<Details> = /*@__PURE__*/ Schema.Struct({
...
export const InToto: Schema.Schema<InToto> = /*@__PURE__*/ Schema.Struct({
...
export const ExportSBOMRequest: Schema.Schema<ExportSBOMRequest> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "ExportSBOMRequest" });
...
export const ExportSBOMProjectsResourcesRequest = /*@__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "POST", path: "v1beta1/{+name}:exportSBOM", hasBody: true }),
  svc,
