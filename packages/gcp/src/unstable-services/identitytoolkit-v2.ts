...
export const GetRecaptchaConfigV2Request = /*@__PURE__*/ Schema.Struct({
...
export const GetPasswordPolicyV2Request = /*@__PURE__*/ Schema.Struct({
  tenantId: Schema.optional(Schema.String).pipe(T.HttpQuery("tenantId")),
}).pipe(
...
export const UpdateConfigProjectsRequest = /*@__PURE__*/ Schema.Struct({
...
export const GetIamPolicyProjectsTenantsRequest = /*@__PURE__*/ Schema.Struct({
...
export const SetIamPolicyProjectsTenantsRequest = /*@__PURE__*/ Schema.Struct({
  resource: Schema.String.pipe(T.HttpPath("resource")),
...
export const ListProjectsOauthIdpConfigsRequest = /*@__PURE__*/ Schema.Struct({
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
}).pipe(
...
export const CreateProjectsOauthIdpConfigsRequest = /*@__PURE__*/ Schema.Struct(
  {
    parent: Schema.String.pipe(T.HttpPath("parent")),
    oauthIdpConfigId: Schema.optional(Schema.String).pipe(
      T.HttpQuery("oauthIdpConfigId"),
...
export const DeleteProjectsOauthIdpConfigsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
  },
).pipe(
...
export const PatchProjectsOauthIdpConfigsRequest = /*@__PURE__*/ Schema.Struct({
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
  name: Schema.String.pipe(T.HttpPath("name")),
  body: Schema.optional(GoogleCloudIdentitytoolkitAdminV2OAuthIdpConfig).pipe(
    T.HttpBody(),
...
export const GetProjectsOauthIdpConfigsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v2/{+name}" }),
  svc,
...
export const GetProjectsInboundSamlConfigsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
  },
).pipe(
...
export const ListDefaultSupportedIdpsRequest = /*@__PURE__*/ Schema.Struct({
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
}).pipe(
...
export const RevokeTokenAccountsRequest = /*@__PURE__*/ Schema.Struct({
...
export const StartAccountsMfaEnrollmentRequest = /*@__PURE__*/ Schema.Struct({
  body: Schema.optional(
...
export const WithdrawAccountsMfaEnrollmentRequest = /*@__PURE__*/ Schema.Struct(
  {
...
export const FinalizeAccountsMfaEnrollmentRequest = /*@__PURE__*/ Schema.Struct(
  {
    body: Schema.optional(
...
export const FinalizeAccountsMfaSignInRequest = /*@__PURE__*/ Schema.Struct({
  body: Schema.optional(
...
export const StartAccountsMfaSignInRequest = /*@__PURE__*/ Schema.Struct({
