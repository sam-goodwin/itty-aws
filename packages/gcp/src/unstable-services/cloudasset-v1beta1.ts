...
export const ExportAssetsProjectsRequest = /*@__PURE__*/ Schema.Struct({
...
export const BatchGetAssetsHistoryProjectsRequest = /*@__PURE__*/ Schema.Struct(
  {
    parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const ExportAssetsFoldersRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(ExportAssetsRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({
...
export const GetFoldersOperationsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1beta1/{+name}" }),
  svc,
...
export const ExportAssetsOrganizationsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
  body: Schema.optional(ExportAssetsRequest).pipe(T.HttpBody()),
}).pipe(
  T.Http({
