...
}).pipe(T.Http({"method":"POST","uri":"v1beta/{+parent}/authProviders","baseUrl":"https://agentidentity.googleapis.com/"})),
...
S.Struct({
  ...
  "requestId": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"DELETE","uri":"v1beta/{+name}","baseUrl":"https://agentidentity.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1beta/{+name}:disable","baseUrl":"https://agentidentity.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1beta/{+name}:enable","baseUrl":"https://agentidentity.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v1beta/{+resource}:getIamPolicy","baseUrl":"https://agentidentity.googleapis.com/"})),
...
S.Struct({
  "name": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v1beta/{+name}","baseUrl":"https://agentidentity.googleapis.com/"})),
...
}).pipe(T.Http({"method":"GET","uri":"v1beta/{+name}/locations","baseUrl":"https://agentidentity.googleapis.com/"})),
...
S.Struct({
  ...
  "pageSize": S.optional(S.Number.pipe(T.Query())),
  "filter": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1beta/{+parent}/accessSummaries","baseUrl":"https://agentidentity.googleapis.com/"})),
...
S.Struct({
  ...
  "filter": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1beta/{+parent}/authProviders","baseUrl":"https://agentidentity.googleapis.com/"})),
...
S.Struct({
  ...
  "pageSize": S.optional(S.Number.pipe(T.Query())),
  "parent": S.String.pipe(T.Label()),
}).pipe(T.Http({"method":"GET","uri":"v1beta/{+parent}/authorizations","baseUrl":"https://agentidentity.googleapis.com/"})),
...
S.Struct({
  ...
  "body": S.optional(AuthProvider.pipe(T.HttpBody())),
}).pipe(T.Http({"method":"PATCH","uri":"v1beta/{+name}","baseUrl":"https://agentidentity.googleapis.com/"})),
...
S.Struct({
  ...
  "pageSize": S.optional(S.Number.pipe(T.Query())),
  "pageToken": S.optional(S.String.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1beta/{+parent}/authProviders:query","baseUrl":"https://agentidentity.googleapis.com/"})),
...
S.Struct({
  ...
  "pageToken": S.optional(S.String.pipe(T.Query())),
  "pageSize": S.optional(S.Number.pipe(T.Query())),
}).pipe(T.Http({"method":"GET","uri":"v1beta/{+name}:queryWorkloads","baseUrl":"https://agentidentity.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1beta/{+name}:revokeAuthorization","baseUrl":"https://agentidentity.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1beta/{+resource}:setIamPolicy","baseUrl":"https://agentidentity.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1beta/{+resource}:testIamPermissions","baseUrl":"https://agentidentity.googleapis.com/"})),
...
}).pipe(T.Http({"method":"POST","uri":"v1beta/{+name}:undelete","baseUrl":"https://agentidentity.googleapis.com/"})),
