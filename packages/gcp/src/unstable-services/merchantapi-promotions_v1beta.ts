...
export const GetAccountsPromotionsRequest = /*@__PURE__*/ Schema.Struct({
...
export const InsertAccountsPromotionsRequest = /*@__PURE__*/ Schema.Struct({
...
export const ListAccountsPromotionsRequest = /*@__PURE__*/ Schema.Struct({
  parent: Schema.String.pipe(T.HttpPath("parent")),
