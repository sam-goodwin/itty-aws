...
export const ScopeFeatureSpec: Schema.Schema<ScopeFeatureSpec> =
  /*@__PURE__*/ Schema.Struct({}).annotate({ identifier: "ScopeFeatureSpec" });
...
export const Origin: Schema.Schema<Origin> = /*@__PURE__*/ Schema.Struct({
...
export const TypeMeta: Schema.Schema<TypeMeta> = /*@__PURE__*/ Schema.Struct({
  kind: Schema.optional(Schema.String),
...
export const Namespace: Schema.Schema<Namespace> = /*@__PURE__*/ Schema.Struct({
  uid: Schema.optional(Schema.String),
  deleteTime: Schema.optional(Schema.String),
  scope: Schema.optional(Schema.String),
  name: Schema.optional(Schema.String),
...
export const Authority: Schema.Schema<Authority> = /*@__PURE__*/ Schema.Struct({
...
export const GetProjectsLocationsFeaturesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
...
export const ListProjectsLocationsFeaturesRequest = /*@__PURE__*/ Schema.Struct(
  {
    pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
    returnPartialSuccess: Schema.optional(Schema.Boolean).pipe(
      T.HttpQuery("returnPartialSuccess"),
...
export const PatchProjectsLocationsScopesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
...
export const ListProjectsLocationsScopesRequest = /*@__PURE__*/ Schema.Struct({
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
}).pipe(
...
export const DeleteProjectsLocationsScopesRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
  },
).pipe(
...
export const GetProjectsLocationsScopesRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const CreateProjectsLocationsScopesRequest = /*@__PURE__*/ Schema.Struct(
  {
    parent: Schema.String.pipe(T.HttpPath("parent")),
...
export const ListProjectsLocationsFleetsRequest = /*@__PURE__*/ Schema.Struct({
  pageToken: Schema.optional(Schema.String).pipe(T.HttpQuery("pageToken")),
  parent: Schema.String.pipe(T.HttpPath("parent")),
  pageSize: Schema.optional(Schema.Number).pipe(T.HttpQuery("pageSize")),
}).pipe(
...
export const PatchProjectsLocationsFleetsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
  updateMask: Schema.optional(Schema.String).pipe(T.HttpQuery("updateMask")),
...
export const CreateProjectsLocationsFleetsRequest = /*@__PURE__*/ Schema.Struct(
  {
    parent: Schema.String.pipe(T.HttpPath("parent")),
    body: Schema.optional(Fleet).pipe(T.HttpBody()),
  },
...
export const GetProjectsLocationsFleetsRequest = /*@__PURE__*/ Schema.Struct({
  name: Schema.String.pipe(T.HttpPath("name")),
}).pipe(
  T.Http({ method: "GET", path: "v1/{+name}" }),
  svc,
...
export const DeleteProjectsLocationsFleetsRequest = /*@__PURE__*/ Schema.Struct(
  {
    name: Schema.String.pipe(T.HttpPath("name")),
  },
).pipe(
