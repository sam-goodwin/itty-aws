...
export const GetIamPolicyV1beta1Request = /*@__PURE__*/ Schema.Struct({
...
export const TestIamPermissionsV1beta1Request = /*@__PURE__*/ Schema.Struct({
  resource: Schema.String.pipe(T.HttpPath("resource")),
...
export const SetIamPolicyV1beta1Request = /*@__PURE__*/ Schema.Struct({
  resource: Schema.String.pipe(T.HttpPath("resource")),
