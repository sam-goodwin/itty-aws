...
// Input Schema
export const DeleteGroupServiceAccountSecretInput = /*@__PURE__*/ Schema.Struct(
  {
...
// Output Schema
export const DeleteGroupServiceAccountSecretOutput = /*@__PURE__*/ Schema.Void;
 ...
 */
export const deleteGroupServiceAccountSecret = /*@__PURE__*/ API.make(() => ({
