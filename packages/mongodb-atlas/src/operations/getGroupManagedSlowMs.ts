...
// Input Schema
export const GetGroupManagedSlowMsInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  groupId: Schema.String.pipe(T.PathParam()),
  envelope: Schema.optional(Schema.Boolean),
  pretty: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "GET", path: "/api/atlas/v2/groups/{groupId}/managedSlowMs" }));
export type GetGroupManagedSlowMsInput = typeof GetGroupManagedSlowMsInput.Type;

// Output Schema
export const GetGroupManagedSlowMsOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type GetGroupManagedSlowMsOutput = typeof GetGroupManagedSlowMsOutput.Type;
