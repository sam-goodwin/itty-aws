...
// Input Schema
export const ListGroupAlertConfigsInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "GET", path: "/api/atlas/v2/groups/{groupId}/alertConfigs" }));
export type ListGroupAlertConfigsInput = typeof ListGroupAlertConfigsInput.Type;

// Output Schema
export const ListGroupAlertConfigsOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type ListGroupAlertConfigsOutput = typeof ListGroupAlertConfigsOutput.Type;
