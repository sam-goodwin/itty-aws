...
export const DeleteOrgInput = /*@__PURE__*/ Schema.Struct({
...
export const DeleteOrgOutput =
  /*@__PURE__*/ Schema.Void as unknown as Schema.Codec<DeleteOrgOutput>;
 ...
 */
export const deleteOrg = /*@__PURE__*/ API.make(() => ({
