...
// Input Schema
export const ListGroupContainersInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "GET", path: "/api/atlas/v2/groups/{groupId}/containers" }));
export type ListGroupContainersInput = typeof ListGroupContainersInput.Type;

// Output Schema
export const ListGroupContainersOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
