...
// Input Schema
export const GetGroupProcessMeasurementsInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "GET", path: "/api/atlas/v2/groups/{groupId}/processes/{processId}/measurements" }));
export type GetGroupProcessMeasurementsInput = typeof GetGroupProcessMeasurementsInput.Type;

// Output Schema
export const GetGroupProcessMeasurementsOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type GetGroupProcessMeasurementsOutput = typeof GetGroupProcessMeasurementsOutput.Type;
