...
// Input Schema
export const DeleteFederationSettingIdentityProviderInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  federationSettingsId: Schema.String.pipe(T.PathParam()),
  identityProviderId: Schema.String.pipe(T.PathParam()),
  envelope: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "DELETE", path: "/api/atlas/v2/federationSettings/{federationSettingsId}/identityProviders/{identityProviderId}" }));
export type DeleteFederationSettingIdentityProviderInput = typeof DeleteFederationSettingIdentityProviderInput.Type;

// Output Schema
export const DeleteFederationSettingIdentityProviderOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type DeleteFederationSettingIdentityProviderOutput = typeof DeleteFederationSettingIdentityProviderOutput.Type;
 ...
 */
export const deleteFederationSettingIdentityProvider = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
