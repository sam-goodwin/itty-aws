...
) as unknown as Schema.Codec<RemoveOrgUserInput>;

// Output Schema
export type RemoveOrgUserOutput = void;
export const RemoveOrgUserOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Void as unknown as Schema.Codec<RemoveOrgUserOutput>;
