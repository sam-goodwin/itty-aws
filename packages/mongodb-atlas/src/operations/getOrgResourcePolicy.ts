...
// Input Schema
export const GetOrgResourcePolicyInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  orgId: Schema.String.pipe(T.PathParam()),
  resourcePolicyId: Schema.String.pipe(T.PathParam()),
  envelope: Schema.optional(Schema.Boolean),
  pretty: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "GET", path: "/api/atlas/v2/orgs/{orgId}/resourcePolicies/{resourcePolicyId}" }));
export type GetOrgResourcePolicyInput = typeof GetOrgResourcePolicyInput.Type;

// Output Schema
export const GetOrgResourcePolicyOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
