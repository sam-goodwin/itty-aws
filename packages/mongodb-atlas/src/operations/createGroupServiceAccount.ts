...
// Input Schema
export interface CreateGroupServiceAccountInput {
  groupId: string;
  envelope?: boolean;
  pretty?: boolean;
}
export const CreateGroupServiceAccountInput =
  ...
  ) as unknown as Schema.Codec<CreateGroupServiceAccountInput>;

// Output Schema
export type CreateGroupServiceAccountOutput = void;
export const CreateGroupServiceAccountOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Void as unknown as Schema.Codec<CreateGroupServiceAccountOutput>;
