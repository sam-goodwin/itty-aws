...
// Input Schema
export const ListGroupHostFtsMetricIndexMeasurementsInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "GET", path: "/api/atlas/v2/groups/{groupId}/hosts/{processId}/fts/metrics/indexes/{databaseName}/{collectionName}/measurements" }));
export type ListGroupHostFtsMetricIndexMeasurementsInput = typeof ListGroupHostFtsMetricIndexMeasurementsInput.Type;

// Output Schema
export const ListGroupHostFtsMetricIndexMeasurementsOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type ListGroupHostFtsMetricIndexMeasurementsOutput = typeof ListGroupHostFtsMetricIndexMeasurementsOutput.Type;
 ...
 */
export const listGroupHostFtsMetricIndexMeasurements = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
