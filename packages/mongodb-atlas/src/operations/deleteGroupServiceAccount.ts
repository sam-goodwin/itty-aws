...
// Input Schema
export const DeleteGroupServiceAccountInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  clientId: Schema.String.pipe(T.PathParam()),
  groupId: Schema.String.pipe(T.PathParam()),
  envelope: Schema.optional(Schema.Boolean),
  pretty: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "DELETE", path: "/api/atlas/v2/groups/{groupId}/serviceAccounts/{clientId}" }));
export type DeleteGroupServiceAccountInput = typeof DeleteGroupServiceAccountInput.Type;

// Output Schema
export const DeleteGroupServiceAccountOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type DeleteGroupServiceAccountOutput = typeof DeleteGroupServiceAccountOutput.Type;
