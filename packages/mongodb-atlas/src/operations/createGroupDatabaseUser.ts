...
// Input Schema
export const CreateGroupDatabaseUserInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  groupId: Schema.String.pipe(T.PathParam()),
  envelope: Schema.optional(Schema.Boolean),
  pretty: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "POST", path: "/api/atlas/v2/groups/{groupId}/databaseUsers" }));
export type CreateGroupDatabaseUserInput = typeof CreateGroupDatabaseUserInput.Type;

// Output Schema
export const CreateGroupDatabaseUserOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type CreateGroupDatabaseUserOutput = typeof CreateGroupDatabaseUserOutput.Type;
