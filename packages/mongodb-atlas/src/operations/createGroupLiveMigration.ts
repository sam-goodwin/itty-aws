...
// Input Schema
export const CreateGroupLiveMigrationInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  groupId: Schema.String.pipe(T.PathParam()),
  envelope: Schema.optional(Schema.Boolean),
  pretty: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "POST", path: "/api/atlas/v2/groups/{groupId}/liveMigrations" }));
export type CreateGroupLiveMigrationInput = typeof CreateGroupLiveMigrationInput.Type;

// Output Schema
export const CreateGroupLiveMigrationOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type CreateGroupLiveMigrationOutput = typeof CreateGroupLiveMigrationOutput.Type;
