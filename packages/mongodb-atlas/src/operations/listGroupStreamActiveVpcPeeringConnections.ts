...
// Input Schema
export const ListGroupStreamActiveVpcPeeringConnectionsInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  groupId: Schema.String.pipe(T.PathParam()),
  envelope: Schema.optional(Schema.Boolean),
  itemsPerPage: Schema.optional(Schema.Number),
  pageNum: Schema.optional(Schema.Number),
  pretty: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "GET", path: "/api/atlas/v2/groups/{groupId}/streams/activeVpcPeeringConnections" }));
export type ListGroupStreamActiveVpcPeeringConnectionsInput = typeof ListGroupStreamActiveVpcPeeringConnectionsInput.Type;

// Output Schema
export const ListGroupStreamActiveVpcPeeringConnectionsOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
 ...
 */
export const listGroupStreamActiveVpcPeeringConnections = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
