...
// Input Schema
export const CreateGroupDataFederationInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  groupId: Schema.String.pipe(T.PathParam()),
  envelope: Schema.optional(Schema.Boolean),
  pretty: Schema.optional(Schema.Boolean),
  skipRoleValidation: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "POST", path: "/api/atlas/v2/groups/{groupId}/dataFederation" }));
export type CreateGroupDataFederationInput = typeof CreateGroupDataFederationInput.Type;

// Output Schema
export const CreateGroupDataFederationOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type CreateGroupDataFederationOutput = typeof CreateGroupDataFederationOutput.Type;
