...
// Input Schema
export const UpdateGroupLogIntegrationInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  groupId: Schema.String.pipe(T.PathParam()),
  id: Schema.String.pipe(T.PathParam()),
  envelope: Schema.optional(Schema.Boolean),
  pretty: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "PUT", path: "/api/atlas/v2/groups/{groupId}/logIntegrations/{id}" }));
export type UpdateGroupLogIntegrationInput = typeof UpdateGroupLogIntegrationInput.Type;

// Output Schema
export const UpdateGroupLogIntegrationOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type UpdateGroupLogIntegrationOutput = typeof UpdateGroupLogIntegrationOutput.Type;
