...
// Input Schema
export const CreateGroupCloudProviderAccessInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const CreateGroupCloudProviderAccessOutput = /*@__PURE__*/ Schema.Void;
 ...
 */
export const createGroupCloudProviderAccess = /*@__PURE__*/ API.make(() => ({
