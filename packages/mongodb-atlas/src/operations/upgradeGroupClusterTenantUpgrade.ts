...
// Input Schema
export const UpgradeGroupClusterTenantUpgradeInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  groupId: Schema.String.pipe(T.PathParam()),
  envelope: Schema.optional(Schema.Boolean),
  pretty: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "POST", path: "/api/atlas/v2/groups/{groupId}/clusters/tenantUpgrade" }));
export type UpgradeGroupClusterTenantUpgradeInput = typeof UpgradeGroupClusterTenantUpgradeInput.Type;

// Output Schema
export const UpgradeGroupClusterTenantUpgradeOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type UpgradeGroupClusterTenantUpgradeOutput = typeof UpgradeGroupClusterTenantUpgradeOutput.Type;
 ...
 */
export const upgradeGroupClusterTenantUpgrade = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
