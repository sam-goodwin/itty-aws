...
// Input Schema
export const DeleteGroupStreamProcessorInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  groupId: Schema.String.pipe(T.PathParam()),
  tenantName: Schema.String.pipe(T.PathParam()),
  processorName: Schema.String.pipe(T.PathParam()),
  envelope: Schema.optional(Schema.Boolean),
  pretty: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "DELETE", path: "/api/atlas/v2/groups/{groupId}/streams/{tenantName}/processor/{processorName}" }));
export type DeleteGroupStreamProcessorInput = typeof DeleteGroupStreamProcessorInput.Type;

// Output Schema
export const DeleteGroupStreamProcessorOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type DeleteGroupStreamProcessorOutput = typeof DeleteGroupStreamProcessorOutput.Type;
