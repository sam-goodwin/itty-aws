...
// Input Schema
export const GetGroupLiveMigrationInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  groupId: Schema.String.pipe(T.PathParam()),
  liveMigrationId: Schema.String.pipe(T.PathParam()),
  envelope: Schema.optional(Schema.Boolean),
  pretty: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "GET", path: "/api/atlas/v2/groups/{groupId}/liveMigrations/{liveMigrationId}" }));
export type GetGroupLiveMigrationInput = typeof GetGroupLiveMigrationInput.Type;

// Output Schema
export const GetGroupLiveMigrationOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type GetGroupLiveMigrationOutput = typeof GetGroupLiveMigrationOutput.Type;
