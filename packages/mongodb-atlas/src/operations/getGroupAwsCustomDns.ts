...
// Input Schema
export const GetGroupAwsCustomDnsInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  groupId: Schema.String.pipe(T.PathParam()),
  envelope: Schema.optional(Schema.Boolean),
  pretty: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "GET", path: "/api/atlas/v2/groups/{groupId}/awsCustomDNS" }));
export type GetGroupAwsCustomDnsInput = typeof GetGroupAwsCustomDnsInput.Type;

// Output Schema
export const GetGroupAwsCustomDnsOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
