...
// Input Schema
export const UpdateGroupClusterSearchIndexInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const UpdateGroupClusterSearchIndexOutput = /*@__PURE__*/ Schema.Void;
 ...
 */
export const updateGroupClusterSearchIndex = /*@__PURE__*/ API.make(() => ({
