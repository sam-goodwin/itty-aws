...
// Input Schema
export const CreateGroupIntegrationInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "POST", path: "/api/atlas/v2/groups/{groupId}/integrations/{integrationType}" }));
export type CreateGroupIntegrationInput = typeof CreateGroupIntegrationInput.Type;

// Output Schema
export const CreateGroupIntegrationOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type CreateGroupIntegrationOutput = typeof CreateGroupIntegrationOutput.Type;
