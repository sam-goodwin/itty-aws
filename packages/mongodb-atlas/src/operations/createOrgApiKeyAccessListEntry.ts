...
// Input Schema
export const CreateOrgApiKeyAccessListEntryInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "POST", path: "/api/atlas/v2/orgs/{orgId}/apiKeys/{apiUserId}/accessList" }));
export type CreateOrgApiKeyAccessListEntryInput = typeof CreateOrgApiKeyAccessListEntryInput.Type;

// Output Schema
export const CreateOrgApiKeyAccessListEntryOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type CreateOrgApiKeyAccessListEntryOutput = typeof CreateOrgApiKeyAccessListEntryOutput.Type;
 ...
 */
export const createOrgApiKeyAccessListEntry = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
