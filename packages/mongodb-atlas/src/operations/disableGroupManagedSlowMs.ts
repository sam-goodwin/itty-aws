...
// Input Schema
export const DisableGroupManagedSlowMsInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  groupId: Schema.String.pipe(T.PathParam()),
  envelope: Schema.optional(Schema.Boolean),
  pretty: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "DELETE", path: "/api/atlas/v2/groups/{groupId}/managedSlowMs/disable" }));
export type DisableGroupManagedSlowMsInput = typeof DisableGroupManagedSlowMsInput.Type;

// Output Schema
export const DisableGroupManagedSlowMsOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type DisableGroupManagedSlowMsOutput = typeof DisableGroupManagedSlowMsOutput.Type;
