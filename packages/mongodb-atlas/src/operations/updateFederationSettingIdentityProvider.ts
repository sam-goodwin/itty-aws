...
// Input Schema
export const UpdateFederationSettingIdentityProviderInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  federationSettingsId: Schema.String.pipe(T.PathParam()),
  identityProviderId: Schema.String.pipe(T.PathParam()),
  envelope: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "PATCH", path: "/api/atlas/v2/federationSettings/{federationSettingsId}/identityProviders/{identityProviderId}" }));
export type UpdateFederationSettingIdentityProviderInput = typeof UpdateFederationSettingIdentityProviderInput.Type;

// Output Schema
export const UpdateFederationSettingIdentityProviderOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type UpdateFederationSettingIdentityProviderOutput = typeof UpdateFederationSettingIdentityProviderOutput.Type;
 ...
 */
export const updateFederationSettingIdentityProvider = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
