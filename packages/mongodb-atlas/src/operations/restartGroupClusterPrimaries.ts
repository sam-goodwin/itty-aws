...
// Input Schema
export const RestartGroupClusterPrimariesInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  groupId: Schema.String.pipe(T.PathParam()),
  clusterName: Schema.String.pipe(T.PathParam()),
  envelope: Schema.optional(Schema.Boolean),
  pretty: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "POST", path: "/api/atlas/v2/groups/{groupId}/clusters/{clusterName}/restartPrimaries" }));
export type RestartGroupClusterPrimariesInput = typeof RestartGroupClusterPrimariesInput.Type;

// Output Schema
export const RestartGroupClusterPrimariesOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
 ...
 */
export const restartGroupClusterPrimaries = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
