...
// Input Schema
export const ListGroupDataFederationInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  groupId: Schema.String.pipe(T.PathParam()),
  envelope: Schema.optional(Schema.Boolean),
  pretty: Schema.optional(Schema.Boolean),
  type: Schema.optional(Schema.Literals(["USER", "ONLINE_ARCHIVE"])),
}).pipe(T.Http({ method: "GET", path: "/api/atlas/v2/groups/{groupId}/dataFederation" }));
export type ListGroupDataFederationInput = typeof ListGroupDataFederationInput.Type;

// Output Schema
export const ListGroupDataFederationOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type ListGroupDataFederationOutput = typeof ListGroupDataFederationOutput.Type;
