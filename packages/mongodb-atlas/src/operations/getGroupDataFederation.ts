...
// Input Schema
export const GetGroupDataFederationInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  groupId: Schema.String.pipe(T.PathParam()),
  tenantName: Schema.String.pipe(T.PathParam()),
  envelope: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "GET", path: "/api/atlas/v2/groups/{groupId}/dataFederation/{tenantName}" }));
export type GetGroupDataFederationInput = typeof GetGroupDataFederationInput.Type;

// Output Schema
export const GetGroupDataFederationOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type GetGroupDataFederationOutput = typeof GetGroupDataFederationOutput.Type;
