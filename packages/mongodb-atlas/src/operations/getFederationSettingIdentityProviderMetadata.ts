...
// Input Schema
export const GetFederationSettingIdentityProviderMetadataInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  federationSettingsId: Schema.String.pipe(T.PathParam()),
  identityProviderId: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "GET", path: "/api/atlas/v2/federationSettings/{federationSettingsId}/identityProviders/{identityProviderId}/metadata.xml" }));
export type GetFederationSettingIdentityProviderMetadataInput = typeof GetFederationSettingIdentityProviderMetadataInput.Type;

// Output Schema
export const GetFederationSettingIdentityProviderMetadataOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type GetFederationSettingIdentityProviderMetadataOutput = typeof GetFederationSettingIdentityProviderMetadataOutput.Type;
 ...
 */
export const getFederationSettingIdentityProviderMetadata = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
