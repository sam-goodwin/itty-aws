...
export const GetGroupLimitInput = /*@__PURE__*/ Schema.Struct({
...
export const GetGroupLimitOutput =
  /*@__PURE__*/ Schema.Void as unknown as Schema.Codec<GetGroupLimitOutput>;
 ...
 */
export const getGroupLimit = /*@__PURE__*/ API.make(() => ({
