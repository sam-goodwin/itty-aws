...
// Input Schema
export const RevokeFederationSettingIdentityProviderJwksInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  federationSettingsId: Schema.String.pipe(T.PathParam()),
  identityProviderId: Schema.String.pipe(T.PathParam()),
  envelope: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "DELETE", path: "/api/atlas/v2/federationSettings/{federationSettingsId}/identityProviders/{identityProviderId}/jwks" }));
export type RevokeFederationSettingIdentityProviderJwksInput = typeof RevokeFederationSettingIdentityProviderJwksInput.Type;

// Output Schema
export const RevokeFederationSettingIdentityProviderJwksOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type RevokeFederationSettingIdentityProviderJwksOutput = typeof RevokeFederationSettingIdentityProviderJwksOutput.Type;
 ...
 */
export const revokeFederationSettingIdentityProviderJwks = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
