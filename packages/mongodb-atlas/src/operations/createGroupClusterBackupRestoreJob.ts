...
// Input Schema
export const CreateGroupClusterBackupRestoreJobInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  groupId: Schema.String.pipe(T.PathParam()),
  clusterName: Schema.String.pipe(T.PathParam()),
  envelope: Schema.optional(Schema.Boolean),
  pretty: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "POST", path: "/api/atlas/v2/groups/{groupId}/clusters/{clusterName}/backup/restoreJobs" }));
export type CreateGroupClusterBackupRestoreJobInput = typeof CreateGroupClusterBackupRestoreJobInput.Type;

// Output Schema
export const CreateGroupClusterBackupRestoreJobOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type CreateGroupClusterBackupRestoreJobOutput = typeof CreateGroupClusterBackupRestoreJobOutput.Type;
 ...
 */
export const createGroupClusterBackupRestoreJob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
