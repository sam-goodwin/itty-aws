...
// Input Schema
export const CreateGroupClusterSearchIndexInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const CreateGroupClusterSearchIndexOutput = /*@__PURE__*/ Schema.Void;
 ...
 */
export const createGroupClusterSearchIndex = /*@__PURE__*/ API.make(() => ({
