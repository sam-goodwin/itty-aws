...
// Input Schema
export const DeleteGroupClusterSearchIndexInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  groupId: Schema.String.pipe(T.PathParam()),
  clusterName: Schema.String.pipe(T.PathParam()),
  indexId: Schema.String.pipe(T.PathParam()),
  envelope: Schema.optional(Schema.Boolean),
  pretty: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "DELETE", path: "/api/atlas/v2/groups/{groupId}/clusters/{clusterName}/search/indexes/{indexId}" }));
export type DeleteGroupClusterSearchIndexInput = typeof DeleteGroupClusterSearchIndexInput.Type;

// Output Schema
export const DeleteGroupClusterSearchIndexOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type DeleteGroupClusterSearchIndexOutput = typeof DeleteGroupClusterSearchIndexOutput.Type;
 ...
 */
export const deleteGroupClusterSearchIndex = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
