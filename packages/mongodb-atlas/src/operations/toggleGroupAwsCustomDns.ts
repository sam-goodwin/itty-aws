...
// Input Schema
export const ToggleGroupAwsCustomDnsInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  groupId: Schema.String.pipe(T.PathParam()),
  envelope: Schema.optional(Schema.Boolean),
  pretty: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "PATCH", path: "/api/atlas/v2/groups/{groupId}/awsCustomDNS" }));
export type ToggleGroupAwsCustomDnsInput = typeof ToggleGroupAwsCustomDnsInput.Type;

// Output Schema
export const ToggleGroupAwsCustomDnsOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type ToggleGroupAwsCustomDnsOutput = typeof ToggleGroupAwsCustomDnsOutput.Type;
