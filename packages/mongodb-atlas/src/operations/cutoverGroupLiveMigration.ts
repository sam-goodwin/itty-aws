...
// Input Schema
export const CutoverGroupLiveMigrationInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  groupId: Schema.String.pipe(T.PathParam()),
  liveMigrationId: Schema.String.pipe(T.PathParam()),
  envelope: Schema.optional(Schema.Boolean),
  pretty: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "PUT", path: "/api/atlas/v2/groups/{groupId}/liveMigrations/{liveMigrationId}/cutover" }));
export type CutoverGroupLiveMigrationInput = typeof CutoverGroupLiveMigrationInput.Type;

// Output Schema
export const CutoverGroupLiveMigrationOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type CutoverGroupLiveMigrationOutput = typeof CutoverGroupLiveMigrationOutput.Type;
