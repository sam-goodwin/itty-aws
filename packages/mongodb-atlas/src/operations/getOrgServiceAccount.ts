...
// Input Schema
export const GetOrgServiceAccountInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  orgId: Schema.String.pipe(T.PathParam()),
  clientId: Schema.String.pipe(T.PathParam()),
  envelope: Schema.optional(Schema.Boolean),
  pretty: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "GET", path: "/api/atlas/v2/orgs/{orgId}/serviceAccounts/{clientId}" }));
export type GetOrgServiceAccountInput = typeof GetOrgServiceAccountInput.Type;

// Output Schema
export const GetOrgServiceAccountOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
