...
// Input Schema
export const GetGroupClusterOnlineArchiveInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  groupId: Schema.String.pipe(T.PathParam()),
  archiveId: Schema.String.pipe(T.PathParam()),
  clusterName: Schema.String.pipe(T.PathParam()),
  envelope: Schema.optional(Schema.Boolean),
  pretty: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "GET", path: "/api/atlas/v2/groups/{groupId}/clusters/{clusterName}/onlineArchives/{archiveId}" }));
export type GetGroupClusterOnlineArchiveInput = typeof GetGroupClusterOnlineArchiveInput.Type;

// Output Schema
export const GetGroupClusterOnlineArchiveOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type GetGroupClusterOnlineArchiveOutput = typeof GetGroupClusterOnlineArchiveOutput.Type;
 ...
 */
export const getGroupClusterOnlineArchive = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
