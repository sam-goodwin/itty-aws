...
// Input Schema
export const DeleteGroupBackupExportBucketInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  groupId: Schema.String.pipe(T.PathParam()),
  exportBucketId: Schema.String.pipe(T.PathParam()),
  envelope: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "DELETE", path: "/api/atlas/v2/groups/{groupId}/backup/exportBuckets/{exportBucketId}" }));
export type DeleteGroupBackupExportBucketInput = typeof DeleteGroupBackupExportBucketInput.Type;

// Output Schema
export const DeleteGroupBackupExportBucketOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type DeleteGroupBackupExportBucketOutput = typeof DeleteGroupBackupExportBucketOutput.Type;
 ...
 */
export const deleteGroupBackupExportBucket = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
