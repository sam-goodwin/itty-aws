...
// Input Schema
export const ListGroupCustomDbRoleRolesInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ListGroupCustomDbRoleRolesOutput = /*@__PURE__*/ Schema.Void;
 ...
 */
export const listGroupCustomDbRoleRoles = /*@__PURE__*/ API.make(() => ({
