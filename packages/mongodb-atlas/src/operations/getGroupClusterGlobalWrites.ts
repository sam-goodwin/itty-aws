...
// Input Schema
export const GetGroupClusterGlobalWritesInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  groupId: Schema.String.pipe(T.PathParam()),
  clusterName: Schema.String.pipe(T.PathParam()),
  envelope: Schema.optional(Schema.Boolean),
  pretty: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "GET", path: "/api/atlas/v2/groups/{groupId}/clusters/{clusterName}/globalWrites" }));
export type GetGroupClusterGlobalWritesInput = typeof GetGroupClusterGlobalWritesInput.Type;

// Output Schema
export const GetGroupClusterGlobalWritesOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type GetGroupClusterGlobalWritesOutput = typeof GetGroupClusterGlobalWritesOutput.Type;
