...
// Input Schema
export const ValidateGroupLiveMigrationsInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  groupId: Schema.String.pipe(T.PathParam()),
  envelope: Schema.optional(Schema.Boolean),
  pretty: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "POST", path: "/api/atlas/v2/groups/{groupId}/liveMigrations/validate" }));
export type ValidateGroupLiveMigrationsInput = typeof ValidateGroupLiveMigrationsInput.Type;

// Output Schema
export const ValidateGroupLiveMigrationsOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type ValidateGroupLiveMigrationsOutput = typeof ValidateGroupLiveMigrationsOutput.Type;
