...
// Input Schema
export const GetGroupUserSecurityInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const GetGroupUserSecurityOutput = /*@__PURE__*/ Schema.Void;
 ...
 */
export const getGroupUserSecurity = /*@__PURE__*/ API.make(() => ({
