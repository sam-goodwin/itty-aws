...
// Input Schema
export const ImportSolanaAccountInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ImportSolanaAccountOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const importSolanaAccount = /*@__PURE__*/ API.make(() => ({
