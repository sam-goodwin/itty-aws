...
// Input Schema
export const AddEndUserEvmSmartAccountInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const AddEndUserEvmSmartAccountOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const addEndUserEvmSmartAccount = /*@__PURE__*/ API.make(() => ({
