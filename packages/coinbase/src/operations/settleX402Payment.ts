...
export const SettleX402PaymentInput = /*@__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "POST", path: "/v2/x402/settle" }),
) as unknown as Schema.Codec<SettleX402PaymentInput>;

// Output Schema
export interface SettleX402PaymentOutput {
  success: boolean;
  errorReason?:
    | "insufficient_funds"
    | "invalid_scheme"
...
export const SettleX402PaymentOutput =
  /*@__PURE__*/ Schema.Struct({
    ...
    extra: Schema.optional(Schema.Record(Schema.String, Schema.Unknown)),
  }) as unknown as Schema.Codec<SettleX402PaymentOutput>;
 ...
 */
export const settleX402Payment = /*@__PURE__*/ API.make(() => ({
