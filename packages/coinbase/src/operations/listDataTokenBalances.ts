...
// Input Schema
export const ListDataTokenBalancesInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ListDataTokenBalancesOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const listDataTokenBalances = /*@__PURE__*/ API.make(() => ({
