...
}).pipe(T.Http({ method: "GET", path: "/v2/transfers" }));
export type ListTransfersInput = typeof ListTransfersInput.Type;
...
export type ListTransfersOutput = typeof ListTransfersOutput.Type;
