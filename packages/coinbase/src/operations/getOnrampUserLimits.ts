...
// Input Schema
export const GetOnrampUserLimitsInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const GetOnrampUserLimitsOutput = /*@__PURE__*/ Schema.Struct({
  limits: Schema.Array(
    Schema.Struct({
      limitType: Schema.Literals(["weekly_spending", "lifetime_transactions"]),
