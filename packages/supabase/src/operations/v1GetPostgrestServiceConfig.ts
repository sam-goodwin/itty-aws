...
// Input Schema
export const V1GetPostgrestServiceConfigInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ref: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "GET", path: "/v1/projects/{ref}/postgrest" }));
export type V1GetPostgrestServiceConfigInput = typeof V1GetPostgrestServiceConfigInput.Type;

// Output Schema
export const V1GetPostgrestServiceConfigOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type V1GetPostgrestServiceConfigOutput = typeof V1GetPostgrestServiceConfigOutput.Type;
