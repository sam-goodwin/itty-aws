...
// Input Schema
export const V1RollbackMigrationsInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ref: Schema.String.pipe(T.PathParam()),
  gte: Schema.String,
}).pipe(T.Http({ method: "DELETE", path: "/v1/projects/{ref}/database/migrations" }));
export type V1RollbackMigrationsInput = typeof V1RollbackMigrationsInput.Type;

// Output Schema
export const V1RollbackMigrationsOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
