...
// Input Schema
export const V1DeleteProjectTpaIntegrationInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const V1DeleteProjectTpaIntegrationOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.String,
  type: Schema.String,
 ...
 */
export const v1DeleteProjectTpaIntegration = /*@__PURE__*/ API.make(() => ({
