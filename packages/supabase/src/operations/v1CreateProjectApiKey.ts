...
// Input Schema
export const V1CreateProjectApiKeyInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ref: Schema.String.pipe(T.PathParam()),
  reveal: Schema.optional(Schema.Boolean),
  type: Schema.Literals(["publishable", "secret"]),
  name: Schema.String,
  description: Schema.optional(Schema.NullOr(Schema.String)),
  secret_jwt_template: Schema.optional(Schema.NullOr(Schema.Record(Schema.String, Schema.Unknown))),
...
// Output Schema
export const V1CreateProjectApiKeyOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  api_key: Schema.optional(SensitiveNullableString),
  id: Schema.optional(Schema.NullOr(Schema.String)),
  type: Schema.optional(Schema.NullOr(Schema.Literals(["legacy", "publishable", "secret"]))),
...
export type V1CreateProjectApiKeyOutput = typeof V1CreateProjectApiKeyOutput.Type;
