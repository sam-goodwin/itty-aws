...
// Input Schema
export const V1RemoveProjectAddonInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ref: Schema.String.pipe(T.PathParam()),
  addon_variant: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "DELETE", path: "/v1/projects/{ref}/billing/addons/{addon_variant}" }));
export type V1RemoveProjectAddonInput = typeof V1RemoveProjectAddonInput.Type;

// Output Schema
export const V1RemoveProjectAddonOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
