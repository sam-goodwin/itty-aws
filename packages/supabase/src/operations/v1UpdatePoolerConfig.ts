...
// Input Schema
export const V1UpdatePoolerConfigInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "PATCH", path: "/v1/projects/{ref}/config/database/pooler" }));
export type V1UpdatePoolerConfigInput = typeof V1UpdatePoolerConfigInput.Type;

// Output Schema
export const V1UpdatePoolerConfigOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
