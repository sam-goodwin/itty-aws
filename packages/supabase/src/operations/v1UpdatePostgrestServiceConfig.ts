...
// Input Schema
export const V1UpdatePostgrestServiceConfigInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type V1UpdatePostgrestServiceConfigInput = typeof V1UpdatePostgrestServiceConfigInput.Type;

// Output Schema
export const V1UpdatePostgrestServiceConfigOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  db_schema: Schema.String,
  max_rows: Schema.Number,
  db_extra_search_path: Schema.String,
  db_pool: Schema.NullOr(Schema.Number),
});
export type V1UpdatePostgrestServiceConfigOutput = typeof V1UpdatePostgrestServiceConfigOutput.Type;
 ...
 */
export const v1UpdatePostgrestServiceConfig = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
