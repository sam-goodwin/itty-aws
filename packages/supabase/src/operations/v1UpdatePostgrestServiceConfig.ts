...
// Input Schema
export const V1UpdatePostgrestServiceConfigInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const V1UpdatePostgrestServiceConfigOutput = /*@__PURE__*/ Schema.Struct(
  {
 ...
 */
export const v1UpdatePostgrestServiceConfig = /*@__PURE__*/ API.make(() => ({
