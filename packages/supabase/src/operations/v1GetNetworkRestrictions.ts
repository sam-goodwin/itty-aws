...
// Input Schema
export const V1GetNetworkRestrictionsInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ref: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "GET", path: "/v1/projects/{ref}/network-restrictions" }));
export type V1GetNetworkRestrictionsInput = typeof V1GetNetworkRestrictionsInput.Type;

// Output Schema
export const V1GetNetworkRestrictionsOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  old_config: Schema.optional(Schema.Struct({
    dbAllowedCidrs: Schema.optional(Schema.Array(Schema.String)),
    dbAllowedCidrsV6: Schema.optional(Schema.Array(Schema.String)),
  })),
...
export type V1GetNetworkRestrictionsOutput = typeof V1GetNetworkRestrictionsOutput.Type;
