...
// Input Schema
export const V1GetProjectClaimTokenInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const V1GetProjectClaimTokenOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const v1GetProjectClaimToken = /*@__PURE__*/ API.make(() => ({
