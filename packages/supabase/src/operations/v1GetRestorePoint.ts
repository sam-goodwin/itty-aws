...
// Input Schema
export const V1GetRestorePointInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const V1GetRestorePointOutput = /*@__PURE__*/ Schema.Struct({
  name: Schema.String,
 ...
 */
export const v1GetRestorePoint = /*@__PURE__*/ API.make(() => ({
