...
// Input Schema
export const V1GetRealtimeConfigInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ref: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "GET", path: "/v1/projects/{ref}/config/realtime" }));
export type V1GetRealtimeConfigInput = typeof V1GetRealtimeConfigInput.Type;

// Output Schema
export const V1GetRealtimeConfigOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
