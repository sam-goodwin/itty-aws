...
// Input Schema
export const V1CreateProjectSigningKeyInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "POST", path: "/v1/projects/{ref}/config/auth/signing-keys" }));
export type V1CreateProjectSigningKeyInput = typeof V1CreateProjectSigningKeyInput.Type;

// Output Schema
export const V1CreateProjectSigningKeyOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String,
  algorithm: Schema.Literals(["EdDSA", "ES256", "RS256", "HS256"]),
...
export type V1CreateProjectSigningKeyOutput = typeof V1CreateProjectSigningKeyOutput.Type;
