...
// Input Schema
export const V1UpdateAFunctionInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const V1UpdateAFunctionOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.String,
  slug: Schema.String,
  name: Schema.String,
 ...
 */
export const v1UpdateAFunction = /*@__PURE__*/ API.make(() => ({
