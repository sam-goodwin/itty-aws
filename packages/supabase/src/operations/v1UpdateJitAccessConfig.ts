...
// Input Schema
export const V1UpdateJitAccessConfigInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ref: Schema.String.pipe(T.PathParam()),
  state: Schema.Literals(["enabled", "disabled", "unavailable"]),
}).pipe(T.Http({ method: "PUT", path: "/v1/projects/{ref}/jit-access" }));
export type V1UpdateJitAccessConfigInput = typeof V1UpdateJitAccessConfigInput.Type;

// Output Schema
export const V1UpdateJitAccessConfigOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type V1UpdateJitAccessConfigOutput = typeof V1UpdateJitAccessConfigOutput.Type;
