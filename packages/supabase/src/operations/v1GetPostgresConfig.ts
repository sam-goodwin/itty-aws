...
// Input Schema
export const V1GetPostgresConfigInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ref: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "GET", path: "/v1/projects/{ref}/config/database/postgres" }));
export type V1GetPostgresConfigInput = typeof V1GetPostgresConfigInput.Type;

// Output Schema
export const V1GetPostgresConfigOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
