...
// Input Schema
export interface V1GetPostgresConfigInput {
  ref: string;
}
export const V1GetPostgresConfigInput =
  ...
  ) as unknown as Schema.Codec<V1GetPostgresConfigInput>;

// Output Schema
export interface V1GetPostgresConfigOutput {
...
export const V1GetPostgresConfigOutput =
  ...
  }) as unknown as Schema.Codec<V1GetPostgresConfigOutput>;
