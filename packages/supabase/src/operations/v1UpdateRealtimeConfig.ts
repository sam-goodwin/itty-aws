...
// Input Schema
export const V1UpdateRealtimeConfigInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "PATCH", path: "/v1/projects/{ref}/config/realtime" }));
export type V1UpdateRealtimeConfigInput = typeof V1UpdateRealtimeConfigInput.Type;

// Output Schema
export const V1UpdateRealtimeConfigOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
export type V1UpdateRealtimeConfigOutput = typeof V1UpdateRealtimeConfigOutput.Type;
