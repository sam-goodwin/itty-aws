...
// Input Schema
export const V1GetAuthServiceConfigInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ref: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "GET", path: "/v1/projects/{ref}/config/auth" }));
export type V1GetAuthServiceConfigInput = typeof V1GetAuthServiceConfigInput.Type;

// Output Schema
export const V1GetAuthServiceConfigOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type V1GetAuthServiceConfigOutput = typeof V1GetAuthServiceConfigOutput.Type;
