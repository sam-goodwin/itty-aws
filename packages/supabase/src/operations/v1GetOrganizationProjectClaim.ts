...
// Input Schema
export const V1GetOrganizationProjectClaimInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const V1GetOrganizationProjectClaimOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const v1GetOrganizationProjectClaim = /*@__PURE__*/ API.make(() => ({
