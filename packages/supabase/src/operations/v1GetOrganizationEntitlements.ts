...
// Input Schema
export const V1GetOrganizationEntitlementsInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const V1GetOrganizationEntitlementsOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const v1GetOrganizationEntitlements = /*@__PURE__*/ API.make(() => ({
