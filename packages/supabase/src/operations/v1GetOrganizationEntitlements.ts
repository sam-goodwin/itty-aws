...
// Input Schema
export interface V1GetOrganizationEntitlementsInput {
  slug: string;
}
export const V1GetOrganizationEntitlementsInput =
  ...
  ) as unknown as Schema.Codec<V1GetOrganizationEntitlementsInput>;

// Output Schema
export interface V1GetOrganizationEntitlementsOutput {
  entitlements: {
    feature: {
      key:
    ...
    config:
      | { enabled: boolean }
      | { enabled: boolean; value: number; unlimited: boolean; unit: string }
...
export const V1GetOrganizationEntitlementsOutput =
  ...
  }) as unknown as Schema.Codec<V1GetOrganizationEntitlementsOutput>;
