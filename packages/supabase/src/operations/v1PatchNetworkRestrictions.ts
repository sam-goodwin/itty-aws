...
// Input Schema
export const V1PatchNetworkRestrictionsInput = /*@__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "/v1/projects/{ref}/network-restrictions" }),
);
export type V1PatchNetworkRestrictionsInput =
  typeof V1PatchNetworkRestrictionsInput.Type;

// Output Schema
export const V1PatchNetworkRestrictionsOutput = /*@__PURE__*/ Schema.Struct({
