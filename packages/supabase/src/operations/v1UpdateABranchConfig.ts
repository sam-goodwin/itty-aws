...
// Input Schema
export const V1UpdateABranchConfigInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  status: Schema.optional(Schema.Literals(["CREATING_PROJECT", "RUNNING_MIGRATIONS", "MIGRATIONS_PASSED", "MIGRATIONS_FAILED", "FUNCTIONS_DEPLOYED", "FUNCTIONS_FAILED"])),
...
// Output Schema
export const V1UpdateABranchConfigOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String,
  name: Schema.String,
  ...
  status: Schema.Literals(["CREATING_PROJECT", "RUNNING_MIGRATIONS", "MIGRATIONS_PASSED", "MIGRATIONS_FAILED", "FUNCTIONS_DEPLOYED", "FUNCTIONS_FAILED"]),
  ...
  preview_project_status: Schema.optional(Schema.Literals(["INACTIVE", "ACTIVE_HEALTHY", "ACTIVE_UNHEALTHY", "COMING_UP", "UNKNOWN", "GOING_DOWN", "INIT_FAILED", "REMOVED", "RESTORING", "UPGRADING", "PAUSING", "RESTORE_FAILED", "RESTARTING", "PAUSE_FAILED", "RESIZING"])),
});
export type V1UpdateABranchConfigOutput = typeof V1UpdateABranchConfigOutput.Type;
