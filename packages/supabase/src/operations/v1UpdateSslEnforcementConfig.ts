...
// Input Schema
export const V1UpdateSslEnforcementConfigInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const V1UpdateSslEnforcementConfigOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const v1UpdateSslEnforcementConfig = /*@__PURE__*/ API.make(() => ({
