...
// Input Schema
export const V1ListAllFunctionsInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
// Output Schema
export const V1ListAllFunctionsOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Array(Schema.Struct({
  id: Schema.String,
  slug: Schema.String,
  name: Schema.String,
