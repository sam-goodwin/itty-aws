...
// Input Schema
export const V1ExchangeOauthTokenInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  grant_type: Schema.optional(Schema.Literals(["authorization_code", "refresh_token"])),
...
}).pipe(T.Http({ method: "POST", path: "/v1/oauth/token", contentType: "form-urlencoded" }));
export type V1ExchangeOauthTokenInput = typeof V1ExchangeOauthTokenInput.Type;

// Output Schema
export const V1ExchangeOauthTokenOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
