...
// Input Schema
export const V1GetDiskUtilizationInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ref: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "GET", path: "/v1/projects/{ref}/config/disk/util" }));
export type V1GetDiskUtilizationInput = typeof V1GetDiskUtilizationInput.Type;

// Output Schema
export const V1GetDiskUtilizationOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
