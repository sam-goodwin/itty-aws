...
// Input Schema
export const V1GetServicesHealthInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
// Output Schema
export const V1GetServicesHealthOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Array(Schema.Struct({
  name: Schema.Literals(["auth", "db", "db_postgres_user", "pooler", "realtime", "rest", "storage", "pg_bouncer"]),
