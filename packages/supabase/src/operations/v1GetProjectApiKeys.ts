...
// Input Schema
export const V1GetProjectApiKeysInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
// Output Schema
export const V1GetProjectApiKeysOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Array(Schema.Struct({
