...
// Input Schema
export const V1GetProjectTpaIntegrationInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ref: Schema.String.pipe(T.PathParam()),
  tpa_id: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "GET", path: "/v1/projects/{ref}/config/auth/third-party-auth/{tpa_id}" }));
export type V1GetProjectTpaIntegrationInput = typeof V1GetProjectTpaIntegrationInput.Type;

// Output Schema
export const V1GetProjectTpaIntegrationOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String,
  type: Schema.String,
...
export type V1GetProjectTpaIntegrationOutput = typeof V1GetProjectTpaIntegrationOutput.Type;
