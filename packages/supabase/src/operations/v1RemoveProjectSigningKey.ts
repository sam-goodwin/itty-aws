...
// Input Schema
export const V1RemoveProjectSigningKeyInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String.pipe(T.PathParam()),
  ref: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "DELETE", path: "/v1/projects/{ref}/config/auth/signing-keys/{id}" }));
export type V1RemoveProjectSigningKeyInput = typeof V1RemoveProjectSigningKeyInput.Type;

// Output Schema
export const V1RemoveProjectSigningKeyOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String,
...
export type V1RemoveProjectSigningKeyOutput = typeof V1RemoveProjectSigningKeyOutput.Type;
