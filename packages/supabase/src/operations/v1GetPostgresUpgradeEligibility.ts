...
// Input Schema
export const V1GetPostgresUpgradeEligibilityInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ref: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "GET", path: "/v1/projects/{ref}/upgrade/eligibility" }));
export type V1GetPostgresUpgradeEligibilityInput = typeof V1GetPostgresUpgradeEligibilityInput.Type;

// Output Schema
export const V1GetPostgresUpgradeEligibilityOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  eligible: Schema.Boolean,
  current_app_version: Schema.String,
  current_app_version_release_channel: Schema.Literals(["internal", "alpha", "beta", "ga", "withdrawn", "preview"]),
  latest_app_version: Schema.String,
  target_upgrade_versions: Schema.Array(Schema.Struct({
...
export type V1GetPostgresUpgradeEligibilityOutput = typeof V1GetPostgresUpgradeEligibilityOutput.Type;
 ...
 */
export const v1GetPostgresUpgradeEligibility = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
