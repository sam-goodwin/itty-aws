...
// Input Schema
export const V1DeleteProjectApiKeyInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ref: Schema.String.pipe(T.PathParam()),
  id: Schema.String.pipe(T.PathParam()),
  reveal: Schema.optional(Schema.Boolean),
  was_compromised: Schema.optional(Schema.Boolean),
  reason: Schema.optional(Schema.String),
}).pipe(T.Http({ method: "DELETE", path: "/v1/projects/{ref}/api-keys/{id}" }));
export type V1DeleteProjectApiKeyInput = typeof V1DeleteProjectApiKeyInput.Type;

// Output Schema
export const V1DeleteProjectApiKeyOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type V1DeleteProjectApiKeyOutput = typeof V1DeleteProjectApiKeyOutput.Type;
