...
// Input Schema
export const V1DeleteNetworkBansInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ref: Schema.String.pipe(T.PathParam()),
  ipv4_addresses: Schema.Array(Schema.String),
  requester_ip: Schema.optional(Schema.Boolean),
  identifier: Schema.optional(Schema.String),
}).pipe(T.Http({ method: "DELETE", path: "/v1/projects/{ref}/network-bans" }));
export type V1DeleteNetworkBansInput = typeof V1DeleteNetworkBansInput.Type;

// Output Schema
export const V1DeleteNetworkBansOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Void;
