...
// Input Schema
export const V1GetHostnameConfigInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ref: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "GET", path: "/v1/projects/{ref}/custom-hostname" }));
export type V1GetHostnameConfigInput = typeof V1GetHostnameConfigInput.Type;

// Output Schema
export const V1GetHostnameConfigOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
