...
// Input Schema
export const V1CreateProjectTpaIntegrationInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const V1CreateProjectTpaIntegrationOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.String,
  type: Schema.String,
 ...
 */
export const v1CreateProjectTpaIntegration = /*@__PURE__*/ API.make(() => ({
