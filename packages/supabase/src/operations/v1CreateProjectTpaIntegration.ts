...
// Input Schema
export const V1CreateProjectTpaIntegrationInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "POST", path: "/v1/projects/{ref}/config/auth/third-party-auth" }));
export type V1CreateProjectTpaIntegrationInput = typeof V1CreateProjectTpaIntegrationInput.Type;

// Output Schema
export const V1CreateProjectTpaIntegrationOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String,
  type: Schema.String,
...
export type V1CreateProjectTpaIntegrationOutput = typeof V1CreateProjectTpaIntegrationOutput.Type;
 ...
 */
export const v1CreateProjectTpaIntegration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
