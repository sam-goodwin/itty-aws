...
// Input Schema
export const V1CreateLegacySigningKeyInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ref: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "POST", path: "/v1/projects/{ref}/config/auth/signing-keys/legacy" }));
export type V1CreateLegacySigningKeyInput = typeof V1CreateLegacySigningKeyInput.Type;

// Output Schema
export const V1CreateLegacySigningKeyOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String,
...
export type V1CreateLegacySigningKeyOutput = typeof V1CreateLegacySigningKeyOutput.Type;
