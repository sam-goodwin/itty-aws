...
// Input Schema
export const V1CreateASsoProviderInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const V1CreateASsoProviderOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.String,
 ...
 */
export const v1CreateASsoProvider = /*@__PURE__*/ API.make(() => ({
