...
// Input Schema
export const V1ListAllNetworkBansInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ref: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "POST", path: "/v1/projects/{ref}/network-bans/retrieve" }));
export type V1ListAllNetworkBansInput = typeof V1ListAllNetworkBansInput.Type;

// Output Schema
export const V1ListAllNetworkBansOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
