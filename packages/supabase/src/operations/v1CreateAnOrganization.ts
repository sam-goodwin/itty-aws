...
// Input Schema
export const V1CreateAnOrganizationInput = /*@__PURE__*/ Schema.Struct({
  name: Schema.String,
...
// Output Schema
export const V1CreateAnOrganizationOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.String,
  slug: Schema.String,
  name: Schema.String,
});
 ...
 */
export const v1CreateAnOrganization = /*@__PURE__*/ API.make(() => ({
