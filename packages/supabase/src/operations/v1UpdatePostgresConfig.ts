...
// Input Schema
export const V1UpdatePostgresConfigInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  session_replication_role: Schema.optional(Schema.Literals(["origin", "replica", "local"])),
...
}).pipe(T.Http({ method: "PUT", path: "/v1/projects/{ref}/config/database/postgres" }));
export type V1UpdatePostgresConfigInput = typeof V1UpdatePostgresConfigInput.Type;

// Output Schema
export const V1UpdatePostgresConfigOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  effective_cache_size: Schema.optional(Schema.String),
  logical_decoding_work_mem: Schema.optional(Schema.String),
  maintenance_work_mem: Schema.optional(Schema.String),
  track_activity_query_size: Schema.optional(Schema.String),
...
export type V1UpdatePostgresConfigOutput = typeof V1UpdatePostgresConfigOutput.Type;
