...
// Input Schema
export const V1ListProjectTpaIntegrationsInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const V1ListProjectTpaIntegrationsOutput = /*@__PURE__*/ Schema.Array(
  Schema.Struct({
    id: Schema.String,
    type: Schema.String,
 ...
 */
export const v1ListProjectTpaIntegrations = /*@__PURE__*/ API.make(() => ({
