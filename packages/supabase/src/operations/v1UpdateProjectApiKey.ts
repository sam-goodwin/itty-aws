...
// Input Schema
export const V1UpdateProjectApiKeyInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "PATCH", path: "/v1/projects/{ref}/api-keys/{id}" }));
export type V1UpdateProjectApiKeyInput = typeof V1UpdateProjectApiKeyInput.Type;

// Output Schema
export const V1UpdateProjectApiKeyOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type V1UpdateProjectApiKeyOutput = typeof V1UpdateProjectApiKeyOutput.Type;
