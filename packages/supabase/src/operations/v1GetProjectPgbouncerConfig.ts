...
// Input Schema
export const V1GetProjectPgbouncerConfigInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ref: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "GET", path: "/v1/projects/{ref}/config/database/pgbouncer" }));
export type V1GetProjectPgbouncerConfigInput = typeof V1GetProjectPgbouncerConfigInput.Type;

// Output Schema
export const V1GetProjectPgbouncerConfigOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  pool_mode: Schema.optional(Schema.Literals(["transaction", "session", "statement"])),
...
export type V1GetProjectPgbouncerConfigOutput = typeof V1GetProjectPgbouncerConfigOutput.Type;
