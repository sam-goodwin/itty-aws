...
// Input Schema
export const V1ListProjectAddonsInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
// Output Schema
export const V1ListProjectAddonsOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  selected_addons: Schema.Array(Schema.Struct({
    type: Schema.Literals(["custom_domain", "compute_instance", "pitr", "ipv4", "auth_mfa_phone", "auth_mfa_web_authn", "log_drain"]),
  ...
  available_addons: Schema.Array(Schema.Struct({
    type: Schema.Literals(["custom_domain", "compute_instance", "pitr", "ipv4", "auth_mfa_phone", "auth_mfa_web_authn", "log_drain"]),
    name: Schema.String,
