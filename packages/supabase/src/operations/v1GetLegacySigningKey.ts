...
// Input Schema
export const V1GetLegacySigningKeyInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ref: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "GET", path: "/v1/projects/{ref}/config/auth/signing-keys/legacy" }));
export type V1GetLegacySigningKeyInput = typeof V1GetLegacySigningKeyInput.Type;

// Output Schema
export const V1GetLegacySigningKeyOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String,
...
export type V1GetLegacySigningKeyOutput = typeof V1GetLegacySigningKeyOutput.Type;
