...
// Input Schema
export interface V1GetLegacySigningKeyInput {
  ref: string;
}
export const V1GetLegacySigningKeyInput =
  ...
  ) as unknown as Schema.Codec<V1GetLegacySigningKeyInput>;

// Output Schema
export interface V1GetLegacySigningKeyOutput {
  id: string;
...
export const V1GetLegacySigningKeyOutput =
  ...
  }) as unknown as Schema.Codec<V1GetLegacySigningKeyOutput>;
 ...
 */
export const v1GetLegacySigningKey = /*@__PURE__*/ API.make(() => ({
