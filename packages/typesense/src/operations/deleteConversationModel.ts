...
// Input Schema
export const DeleteConversationModelInput = /*@__PURE__*/ Schema.Struct({
  modelId: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "DELETE", path: "/conversations/models/{modelId}" }));
export type DeleteConversationModelInput =
  typeof DeleteConversationModelInput.Type;

// Output Schema
export const DeleteConversationModelOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.String,
});
