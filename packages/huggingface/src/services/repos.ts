...
export const DuplicationStatusRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    repoType: DuplicationStatusRequestRepoType.pipe(T.Label()),
    namespace: S.String.pipe(T.Label()),
    repo: S.String.pipe(T.Label()),
  }).pipe(
    T.Http({
      method: "GET",
      uri: "/api/{repoType}/{namespace}/{repo}/duplicate/status",
      code: 200,
    }),
  ),
).annotate({
...
export const DuplicationStatusResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    pending: S.Boolean,
    filesTotal: S.optional(S.Number),
    filesCopied: S.optional(S.Number),
  }),
).annotate({
...
export type DuplicationStatusError = HuggingFaceOpError;
/** Duplication status */
export const duplicationStatus: API.OperationMethod<
  DuplicationStatusRequest,
  DuplicationStatusResponse,
  DuplicationStatusError,
  HuggingFaceOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: DuplicationStatusRequest,
  output: DuplicationStatusResponse,
  errors: [],
  protocol: HuggingFaceProtocol,
  retry: Retry.Retry,
}));
