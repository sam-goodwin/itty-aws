...
export interface AddUsersResponseSpendLimits {
  total?: number;
  inferenceProviders?: number;
  spaces?: number;
  jobs?: number;
  endpoints?: number;
}
export const AddUsersResponseSpendLimits = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    total: S.optional(S.Number),
    inferenceProviders: S.optional(S.Number),
    spaces: S.optional(S.Number),
    jobs: S.optional(S.Number),
    endpoints: S.optional(S.Number),
  }),
).annotate({
  identifier: "AddUsersResponseSpendLimits",
}) as any as S.Schema<AddUsersResponseSpendLimits>;
...
export const CreateResourceGroupResponseSpendLimits =
  AddUsersResponseSpendLimits;
...
export type GetResourceGroupsResponseBodyItemSpendLimits =
  AddUsersResponseSpendLimits;
export const GetResourceGroupsResponseBodyItemSpendLimits =
  AddUsersResponseSpendLimits;
...
export interface UpdateResourceGroupRequestSpendLimits {
  total?: number | null;
  inferenceProviders?: number | null;
  spaces?: number | null;
  jobs?: number | null;
  endpoints?: number | null;
}
export const UpdateResourceGroupRequestSpendLimits = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      total: S.optional(S.NullOr(S.Number)),
      inferenceProviders: S.optional(S.NullOr(S.Number)),
      spaces: S.optional(S.NullOr(S.Number)),
      jobs: S.optional(S.NullOr(S.Number)),
      endpoints: S.optional(S.NullOr(S.Number)),
    }),
).annotate({
  identifier: "UpdateResourceGroupRequestSpendLimits",
}) as any as S.Schema<UpdateResourceGroupRequestSpendLimits>;

export interface UpdateResourceGroupRequest {
  name: string;
  resourceGroupId: string;
  description?: string;
  spendLimits?: UpdateResourceGroupRequestSpendLimits;
}
export const UpdateResourceGroupRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    resourceGroupId: S.String.pipe(T.Label()),
    description: S.optional(S.String),
    spendLimits: S.optional(UpdateResourceGroupRequestSpendLimits),
  }).pipe(
    T.Http({
      method: "PATCH",
      uri: "/api/organizations/{name}/resource-groups/{resourceGroupId}",
...
export type UpdateResourceGroupResponseSpendLimits =
  AddUsersResponseSpendLimits;
export const UpdateResourceGroupResponseSpendLimits =
  AddUsersResponseSpendLimits;
...
/** Update resource group Update the name, description and/or monthly spend limits (in cents, `null` to remove) of a resource group. `spendLimits.total` caps the group's combined spend across every product; the per-product limits cap each product on top of it. Requires the org to have a Team plan or higher. */
