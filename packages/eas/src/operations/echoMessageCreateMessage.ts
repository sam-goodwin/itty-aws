...
export const EchoMessageCreateMessageInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "echoMessageCreateMessage",
    type: "mutation",
  }),
);
export type EchoMessageCreateMessageInput =
  typeof EchoMessageCreateMessageInput.Type;

// Output Schema (GraphQL selection set)
export const EchoMessageCreateMessageOutput = Schema.Struct({
...
}).pipe(T.ResponsePath("echoMessage.createMessage"));
export type EchoMessageCreateMessageOutput =
  typeof EchoMessageCreateMessageOutput.Type;

export const echoMessageCreateMessage = API.make(() => ({
  inputSchema: EchoMessageCreateMessageInput,
  outputSchema: EchoMessageCreateMessageOutput,
}));
