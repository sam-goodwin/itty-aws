...
export const EnvironmentVariableCreateEnvironmentVariableForAccountInput =
  Schema.Struct({
    ...
    T.GraphQLOp({
      query: __document,
      operationName: "environmentVariableCreateEnvironmentVariableForAccount",
      type: "mutation",
    }),
  );
export type EnvironmentVariableCreateEnvironmentVariableForAccountInput =
  typeof EnvironmentVariableCreateEnvironmentVariableForAccountInput.Type;

// Output Schema (GraphQL selection set)
export const EnvironmentVariableCreateEnvironmentVariableForAccountOutput =
  Schema.Struct({
    apps: Schema.Array(
      Schema.Struct({
    ...
    T.ResponsePath("environmentVariable.createEnvironmentVariableForAccount"),
  );
export type EnvironmentVariableCreateEnvironmentVariableForAccountOutput =
  typeof EnvironmentVariableCreateEnvironmentVariableForAccountOutput.Type;

export const environmentVariableCreateEnvironmentVariableForAccount = API.make(
  () => ({
    inputSchema: EnvironmentVariableCreateEnvironmentVariableForAccountInput,
    outputSchema: EnvironmentVariableCreateEnvironmentVariableForAccountOutput,
  }),
);
