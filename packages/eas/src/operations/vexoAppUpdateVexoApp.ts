...
export const VexoAppUpdateVexoAppInput = Schema.Struct({
  ...
  vexoAppId: Schema.String,
}).pipe(
  T.Http({ method: "POST", path: "/graphql" }),
  T.GraphQLOp({
    query: __document,
    operationName: "vexoAppUpdateVexoApp",
    type: "mutation",
  }),
);
export type VexoAppUpdateVexoAppInput = typeof VexoAppUpdateVexoAppInput.Type;

// Output Schema (GraphQL selection set)
export const VexoAppUpdateVexoAppOutput = Schema.Struct({
  app: Schema.Struct({
...
}).pipe(T.ResponsePath("vexoApp.updateVexoApp"));
export type VexoAppUpdateVexoAppOutput = typeof VexoAppUpdateVexoAppOutput.Type;

export const vexoAppUpdateVexoApp = API.make(() => ({
  inputSchema: VexoAppUpdateVexoAppInput,
  outputSchema: VexoAppUpdateVexoAppOutput,
}));
