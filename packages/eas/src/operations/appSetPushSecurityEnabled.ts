...
}).pipe(T.ResponsePath("app.setPushSecurityEnabled"));
export type AppSetPushSecurityEnabledOutput =
  typeof AppSetPushSecurityEnabledOutput.Type;

export const appSetPushSecurityEnabled = API.make(() => ({
  inputSchema: AppSetPushSecurityEnabledInput,
  outputSchema: AppSetPushSecurityEnabledOutput,
}));
