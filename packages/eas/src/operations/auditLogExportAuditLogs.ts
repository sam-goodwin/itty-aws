...
export const AuditLogExportAuditLogsInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "auditLogExportAuditLogs",
    type: "mutation",
  }),
);
export type AuditLogExportAuditLogsInput =
  typeof AuditLogExportAuditLogsInput.Type;

// Output Schema (GraphQL selection set)
export const AuditLogExportAuditLogsOutput = Schema.Struct({
...
}).pipe(T.ResponsePath("auditLog.exportAuditLogs"));
export type AuditLogExportAuditLogsOutput =
  typeof AuditLogExportAuditLogsOutput.Type;

export const auditLogExportAuditLogs = API.make(() => ({
  inputSchema: AuditLogExportAuditLogsInput,
  outputSchema: AuditLogExportAuditLogsOutput,
}));
