...
}).pipe(T.ResponsePath("vexoApp.deleteVexoApp"));
export type VexoAppDeleteVexoAppOutput = typeof VexoAppDeleteVexoAppOutput.Type;

export const vexoAppDeleteVexoApp = API.make(() => ({
  inputSchema: VexoAppDeleteVexoAppInput,
  outputSchema: VexoAppDeleteVexoAppOutput,
}));
