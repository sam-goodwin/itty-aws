...
}).pipe(T.ResponsePath("robot.scheduleRobotDeletion"));
export type RobotScheduleRobotDeletionOutput =
  typeof RobotScheduleRobotDeletionOutput.Type;

export const robotScheduleRobotDeletion = API.make(() => ({
  inputSchema: RobotScheduleRobotDeletionInput,
  outputSchema: RobotScheduleRobotDeletionOutput,
}));
