...
export const GithubRepositoryScheduleGitHubRepositoryDeletionOutput =
  ...
  }).pipe(T.ResponsePath("githubRepository.scheduleGitHubRepositoryDeletion"));
export type GithubRepositoryScheduleGitHubRepositoryDeletionOutput =
  typeof GithubRepositoryScheduleGitHubRepositoryDeletionOutput.Type;

export const githubRepositoryScheduleGitHubRepositoryDeletion = API.make(
  () => ({
    inputSchema: GithubRepositoryScheduleGitHubRepositoryDeletionInput,
    outputSchema: GithubRepositoryScheduleGitHubRepositoryDeletionOutput,
  }),
);
