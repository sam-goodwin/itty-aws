...
export const AppStoreConnectApiKeyByIdOutput = Schema.Struct({
  ...
  updatedAt: Schema.String,
}).pipe(T.ResponsePath("appStoreConnectApiKey.byId"));
export type AppStoreConnectApiKeyByIdOutput =
  typeof AppStoreConnectApiKeyByIdOutput.Type;

export const appStoreConnectApiKeyById = API.make(() => ({
  inputSchema: AppStoreConnectApiKeyByIdInput,
  outputSchema: AppStoreConnectApiKeyByIdOutput,
}));
