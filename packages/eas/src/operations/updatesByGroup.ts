...
export const UpdatesByGroupInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "updatesByGroup",
    type: "query",
  }),
);
export type UpdatesByGroupInput = typeof UpdatesByGroupInput.Type;

// Output Schema (GraphQL selection set)
export const UpdatesByGroupOutput = Schema.Array(
  Schema.Struct({
 ...
 */
export const updatesByGroup = API.make(() => ({
  inputSchema: UpdatesByGroupInput,
  outputSchema: UpdatesByGroupOutput,
}));
