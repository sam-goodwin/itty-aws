...
export const GithubRepositoryCreateAndConfigureRepositoryInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "githubRepositoryCreateAndConfigureRepository",
    type: "mutation",
  }),
);
export type GithubRepositoryCreateAndConfigureRepositoryInput =
  typeof GithubRepositoryCreateAndConfigureRepositoryInput.Type;

// Output Schema (GraphQL selection set)
export const GithubRepositoryCreateAndConfigureRepositoryOutput = Schema.Struct(
  {
...
).pipe(T.ResponsePath("githubRepository.createAndConfigureRepository"));
export type GithubRepositoryCreateAndConfigureRepositoryOutput =
  typeof GithubRepositoryCreateAndConfigureRepositoryOutput.Type;

export const githubRepositoryCreateAndConfigureRepository = API.make(() => ({
  inputSchema: GithubRepositoryCreateAndConfigureRepositoryInput,
  outputSchema: GithubRepositoryCreateAndConfigureRepositoryOutput,
}));
