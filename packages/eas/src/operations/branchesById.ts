...
export const BranchesByIdOutput = Schema.Struct({
  ...
  name: Schema.String,
  updatedAt: Schema.String,
}).pipe(T.ResponsePath("branches.byId"));
export type BranchesByIdOutput = typeof BranchesByIdOutput.Type;

export const branchesById = API.make(() => ({
  inputSchema: BranchesByIdInput,
  outputSchema: BranchesByIdOutput,
}));
