...
export const EchoChatCreateChatInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "echoChatCreateChat",
    type: "mutation",
  }),
);
export type EchoChatCreateChatInput = typeof EchoChatCreateChatInput.Type;

// Output Schema (GraphQL selection set)
export const EchoChatCreateChatOutput = Schema.Struct({
...
}).pipe(T.ResponsePath("echoChat.createChat"));
export type EchoChatCreateChatOutput = typeof EchoChatCreateChatOutput.Type;

export const echoChatCreateChat = API.make(() => ({
  inputSchema: EchoChatCreateChatInput,
  outputSchema: EchoChatCreateChatOutput,
}));
