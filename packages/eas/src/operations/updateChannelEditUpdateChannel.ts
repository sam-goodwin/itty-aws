...
export const UpdateChannelEditUpdateChannelInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "updateChannelEditUpdateChannel",
    type: "mutation",
  }),
);
export type UpdateChannelEditUpdateChannelInput =
  typeof UpdateChannelEditUpdateChannelInput.Type;

// Output Schema (GraphQL selection set)
export const UpdateChannelEditUpdateChannelOutput = Schema.Struct({
  app: Schema.Struct({
  ...
  updatedAt: Schema.String,
}).pipe(T.ResponsePath("updateChannel.editUpdateChannel"));
export type UpdateChannelEditUpdateChannelOutput =
  typeof UpdateChannelEditUpdateChannelOutput.Type;

export const updateChannelEditUpdateChannel = API.make(() => ({
  inputSchema: UpdateChannelEditUpdateChannelInput,
  outputSchema: UpdateChannelEditUpdateChannelOutput,
}));
