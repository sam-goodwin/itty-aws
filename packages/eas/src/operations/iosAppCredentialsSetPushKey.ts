...
}).pipe(T.ResponsePath("iosAppCredentials.setPushKey"));
export type IosAppCredentialsSetPushKeyOutput =
  typeof IosAppCredentialsSetPushKeyOutput.Type;

export const iosAppCredentialsSetPushKey = API.make(() => ({
  inputSchema: IosAppCredentialsSetPushKeyInput,
  outputSchema: IosAppCredentialsSetPushKeyOutput,
}));
