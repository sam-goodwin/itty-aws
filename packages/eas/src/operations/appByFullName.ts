...
export const AppByFullNameInput = Schema.Struct({
  fullName: Schema.String,
}).pipe(
  T.Http({ method: "POST", path: "/graphql" }),
  T.GraphQLOp({
    query: __document,
    operationName: "appByFullName",
    type: "query",
  }),
);
export type AppByFullNameInput = typeof AppByFullNameInput.Type;

// Output Schema (GraphQL selection set)
export const AppByFullNameOutput = Schema.Struct({
...
}).pipe(T.ResponsePath("app.byFullName"));
export type AppByFullNameOutput = typeof AppByFullNameOutput.Type;

export const appByFullName = API.make(() => ({
  inputSchema: AppByFullNameInput,
  outputSchema: AppByFullNameOutput,
}));
