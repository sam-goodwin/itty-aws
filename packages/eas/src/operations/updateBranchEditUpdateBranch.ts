...
export const UpdateBranchEditUpdateBranchInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "updateBranchEditUpdateBranch",
    type: "mutation",
  }),
);
export type UpdateBranchEditUpdateBranchInput =
  typeof UpdateBranchEditUpdateBranchInput.Type;

// Output Schema (GraphQL selection set)
export const UpdateBranchEditUpdateBranchOutput = Schema.Struct({
  app: Schema.Struct({
  ...
  name: Schema.String,
  updatedAt: Schema.String,
}).pipe(T.ResponsePath("updateBranch.editUpdateBranch"));
export type UpdateBranchEditUpdateBranchOutput =
  typeof UpdateBranchEditUpdateBranchOutput.Type;

export const updateBranchEditUpdateBranch = API.make(() => ({
  inputSchema: UpdateBranchEditUpdateBranchInput,
  outputSchema: UpdateBranchEditUpdateBranchOutput,
}));
