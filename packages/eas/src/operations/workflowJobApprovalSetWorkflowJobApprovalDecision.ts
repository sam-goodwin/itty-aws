...
export const WorkflowJobApprovalSetWorkflowJobApprovalDecisionInput =
  Schema.Struct({
    ...
    T.GraphQLOp({
      query: __document,
      operationName: "workflowJobApprovalSetWorkflowJobApprovalDecision",
      type: "mutation",
    }),
  );
export type WorkflowJobApprovalSetWorkflowJobApprovalDecisionInput =
  typeof WorkflowJobApprovalSetWorkflowJobApprovalDecisionInput.Type;

// Output Schema (GraphQL selection set)
export const WorkflowJobApprovalSetWorkflowJobApprovalDecisionOutput =
  Schema.Struct({
  ...
  }).pipe(T.ResponsePath("workflowJobApproval.setWorkflowJobApprovalDecision"));
export type WorkflowJobApprovalSetWorkflowJobApprovalDecisionOutput =
  typeof WorkflowJobApprovalSetWorkflowJobApprovalDecisionOutput.Type;

export const workflowJobApprovalSetWorkflowJobApprovalDecision = API.make(
  () => ({
    inputSchema: WorkflowJobApprovalSetWorkflowJobApprovalDecisionInput,
    outputSchema: WorkflowJobApprovalSetWorkflowJobApprovalDecisionOutput,
  }),
);
