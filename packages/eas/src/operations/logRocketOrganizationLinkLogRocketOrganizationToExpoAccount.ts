...
export const LogRocketOrganizationLinkLogRocketOrganizationToExpoAccountInput =
  Schema.Struct({
    ...
    T.GraphQLOp({
      query: __document,
      operationName:
        "logRocketOrganizationLinkLogRocketOrganizationToExpoAccount",
      type: "mutation",
    }),
  );
export type LogRocketOrganizationLinkLogRocketOrganizationToExpoAccountInput =
  typeof LogRocketOrganizationLinkLogRocketOrganizationToExpoAccountInput.Type;

// Output Schema (GraphQL selection set)
export const LogRocketOrganizationLinkLogRocketOrganizationToExpoAccountOutput =
  Schema.Struct({
    ...
    T.ResponsePath(
      "logRocketOrganization.linkLogRocketOrganizationToExpoAccount",
    ),
  );
export type LogRocketOrganizationLinkLogRocketOrganizationToExpoAccountOutput =
  typeof LogRocketOrganizationLinkLogRocketOrganizationToExpoAccountOutput.Type;

export const logRocketOrganizationLinkLogRocketOrganizationToExpoAccount =
  API.make(() => ({
    inputSchema:
      LogRocketOrganizationLinkLogRocketOrganizationToExpoAccountInput,
    outputSchema:
      LogRocketOrganizationLinkLogRocketOrganizationToExpoAccountOutput,
  }));
