...
}).pipe(T.ResponsePath("updateBranch.scheduleUpdateBranchDeletion"));
export type UpdateBranchScheduleUpdateBranchDeletionOutput =
  typeof UpdateBranchScheduleUpdateBranchDeletionOutput.Type;

export const updateBranchScheduleUpdateBranchDeletion = API.make(() => ({
  inputSchema: UpdateBranchScheduleUpdateBranchDeletionInput,
  outputSchema: UpdateBranchScheduleUpdateBranchDeletionOutput,
}));
