...
export const AppSetAppInfoInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "appSetAppInfo",
    type: "mutation",
  }),
);
export type AppSetAppInfoInput = typeof AppSetAppInfoInput.Type;

// Output Schema (GraphQL selection set)
export const AppSetAppInfoOutput = Schema.Struct({
...
}).pipe(T.ResponsePath("app.setAppInfo"));
export type AppSetAppInfoOutput = typeof AppSetAppInfoOutput.Type;

export const appSetAppInfo = API.make(() => ({
  inputSchema: AppSetAppInfoInput,
  outputSchema: AppSetAppInfoOutput,
}));
