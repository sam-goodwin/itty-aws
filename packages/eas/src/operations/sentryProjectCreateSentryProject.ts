...
export const SentryProjectCreateSentryProjectInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "sentryProjectCreateSentryProject",
    type: "mutation",
  }),
);
export type SentryProjectCreateSentryProjectInput =
  typeof SentryProjectCreateSentryProjectInput.Type;

// Output Schema (GraphQL selection set)
export const SentryProjectCreateSentryProjectOutput = Schema.Struct({
  app: Schema.Struct({
  ...
  sentryProjectSlug: Schema.String,
  updatedAt: Schema.String,
}).pipe(T.ResponsePath("sentryProject.createSentryProject"));
export type SentryProjectCreateSentryProjectOutput =
  typeof SentryProjectCreateSentryProjectOutput.Type;

export const sentryProjectCreateSentryProject = API.make(() => ({
  inputSchema: SentryProjectCreateSentryProjectInput,
  outputSchema: SentryProjectCreateSentryProjectOutput,
}));
