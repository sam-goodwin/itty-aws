...
export const AppStoreConnectAppCreateAppStoreConnectAppInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "appStoreConnectAppCreateAppStoreConnectApp",
    type: "mutation",
  }),
);
export type AppStoreConnectAppCreateAppStoreConnectAppInput =
  typeof AppStoreConnectAppCreateAppStoreConnectAppInput.Type;

// Output Schema (GraphQL selection set)
export const AppStoreConnectAppCreateAppStoreConnectAppOutput = Schema.Struct({
  app: Schema.Struct({
...
}).pipe(T.ResponsePath("appStoreConnectApp.createAppStoreConnectApp"));
export type AppStoreConnectAppCreateAppStoreConnectAppOutput =
  typeof AppStoreConnectAppCreateAppStoreConnectAppOutput.Type;

export const appStoreConnectAppCreateAppStoreConnectApp = API.make(() => ({
  inputSchema: AppStoreConnectAppCreateAppStoreConnectAppInput,
  outputSchema: AppStoreConnectAppCreateAppStoreConnectAppOutput,
}));
