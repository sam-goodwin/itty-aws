...
export const ConvexTeamConnectionCreateConvexTeamConnectionOutput =
  Schema.Struct({
    ...
    id: Schema.String,
    updatedAt: Schema.String,
  }).pipe(T.ResponsePath("convexTeamConnection.createConvexTeamConnection"));
export type ConvexTeamConnectionCreateConvexTeamConnectionOutput =
  typeof ConvexTeamConnectionCreateConvexTeamConnectionOutput.Type;

export const convexTeamConnectionCreateConvexTeamConnection = API.make(() => ({
  inputSchema: ConvexTeamConnectionCreateConvexTeamConnectionInput,
  outputSchema: ConvexTeamConnectionCreateConvexTeamConnectionOutput,
}));
