...
export const GithubRepositorySettingsCreateGitHubRepositorySettingsInput =
  Schema.Struct({
    ...
    T.GraphQLOp({
      query: __document,
      operationName: "githubRepositorySettingsCreateGitHubRepositorySettings",
      type: "mutation",
    }),
  );
export type GithubRepositorySettingsCreateGitHubRepositorySettingsInput =
  typeof GithubRepositorySettingsCreateGitHubRepositorySettingsInput.Type;

// Output Schema (GraphQL selection set)
export const GithubRepositorySettingsCreateGitHubRepositorySettingsOutput =
  Schema.Struct({
    app: Schema.Struct({
    ...
    T.ResponsePath("githubRepositorySettings.createGitHubRepositorySettings"),
  );
export type GithubRepositorySettingsCreateGitHubRepositorySettingsOutput =
  typeof GithubRepositorySettingsCreateGitHubRepositorySettingsOutput.Type;

export const githubRepositorySettingsCreateGitHubRepositorySettings = API.make(
  () => ({
    inputSchema: GithubRepositorySettingsCreateGitHubRepositorySettingsInput,
    outputSchema: GithubRepositorySettingsCreateGitHubRepositorySettingsOutput,
  }),
);
