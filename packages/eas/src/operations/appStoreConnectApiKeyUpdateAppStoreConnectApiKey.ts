...
export const AppStoreConnectApiKeyUpdateAppStoreConnectApiKeyInput =
  Schema.Struct({
    ...
    T.GraphQLOp({
      query: __document,
      operationName: "appStoreConnectApiKeyUpdateAppStoreConnectApiKey",
      type: "mutation",
    }),
  );
export type AppStoreConnectApiKeyUpdateAppStoreConnectApiKeyInput =
  typeof AppStoreConnectApiKeyUpdateAppStoreConnectApiKeyInput.Type;

// Output Schema (GraphQL selection set)
export const AppStoreConnectApiKeyUpdateAppStoreConnectApiKeyOutput =
  Schema.Struct({
    ...
    updatedAt: Schema.String,
  }).pipe(T.ResponsePath("appStoreConnectApiKey.updateAppStoreConnectApiKey"));
export type AppStoreConnectApiKeyUpdateAppStoreConnectApiKeyOutput =
  typeof AppStoreConnectApiKeyUpdateAppStoreConnectApiKeyOutput.Type;

export const appStoreConnectApiKeyUpdateAppStoreConnectApiKey = API.make(
  () => ({
    inputSchema: AppStoreConnectApiKeyUpdateAppStoreConnectApiKeyInput,
    outputSchema: AppStoreConnectApiKeyUpdateAppStoreConnectApiKeyOutput,
  }),
);
