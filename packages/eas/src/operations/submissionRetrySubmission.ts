...
export const SubmissionRetrySubmissionInput = Schema.Struct({
  parentSubmissionId: Schema.String,
}).pipe(
...
export type SubmissionRetrySubmissionInput =
  typeof SubmissionRetrySubmissionInput.Type;

// Output Schema (GraphQL selection set)
export const SubmissionRetrySubmissionOutput = Schema.Struct({
...
export type SubmissionRetrySubmissionOutput =
  typeof SubmissionRetrySubmissionOutput.Type;

export const submissionRetrySubmission = API.make(() => ({
  inputSchema: SubmissionRetrySubmissionInput,
  outputSchema: SubmissionRetrySubmissionOutput,
}));
