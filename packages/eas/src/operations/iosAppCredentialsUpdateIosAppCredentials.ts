...
}).pipe(T.ResponsePath("iosAppCredentials.updateIosAppCredentials"));
export type IosAppCredentialsUpdateIosAppCredentialsOutput =
  typeof IosAppCredentialsUpdateIosAppCredentialsOutput.Type;

export const iosAppCredentialsUpdateIosAppCredentials = API.make(() => ({
  inputSchema: IosAppCredentialsUpdateIosAppCredentialsInput,
  outputSchema: IosAppCredentialsUpdateIosAppCredentialsOutput,
}));
