...
export const GithubRepositorySettingsDeleteGitHubRepositorySettingsOutput =
  Schema.Struct({
    ...
    T.ResponsePath("githubRepositorySettings.deleteGitHubRepositorySettings"),
  );
export type GithubRepositorySettingsDeleteGitHubRepositorySettingsOutput =
  typeof GithubRepositorySettingsDeleteGitHubRepositorySettingsOutput.Type;

export const githubRepositorySettingsDeleteGitHubRepositorySettings = API.make(
  () => ({
    inputSchema: GithubRepositorySettingsDeleteGitHubRepositorySettingsInput,
    outputSchema: GithubRepositorySettingsDeleteGitHubRepositorySettingsOutput,
  }),
);
