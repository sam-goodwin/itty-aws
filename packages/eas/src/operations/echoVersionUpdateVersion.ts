...
export const EchoVersionUpdateVersionInput = Schema.Struct({
  ...
  input: Schema.Struct({
    ...
    buildStatus: Schema.optional(
      Schema.NullOr(
        Schema.Literals(["BUILDING", "FAILED", "PENDING", "SUCCESS"]),
      ),
    ),
...
export type EchoVersionUpdateVersionInput =
  typeof EchoVersionUpdateVersionInput.Type;
...
export type EchoVersionUpdateVersionOutput =
  typeof EchoVersionUpdateVersionOutput.Type;
