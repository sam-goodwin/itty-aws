...
export const UserDashboardViewPinsPinDashboardViewInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "userDashboardViewPinsPinDashboardView",
    type: "mutation",
  }),
);
export type UserDashboardViewPinsPinDashboardViewInput =
  typeof UserDashboardViewPinsPinDashboardViewInput.Type;

// Output Schema (GraphQL selection set)
export const UserDashboardViewPinsPinDashboardViewOutput = Schema.Struct({
  ...
  view: Schema.Literals(["ACTIVITY", "OVERVIEW"]),
}).pipe(T.ResponsePath("userDashboardViewPins.pinDashboardView"));
export type UserDashboardViewPinsPinDashboardViewOutput =
  typeof UserDashboardViewPinsPinDashboardViewOutput.Type;

export const userDashboardViewPinsPinDashboardView = API.make(() => ({
  inputSchema: UserDashboardViewPinsPinDashboardViewInput,
  outputSchema: UserDashboardViewPinsPinDashboardViewOutput,
}));
