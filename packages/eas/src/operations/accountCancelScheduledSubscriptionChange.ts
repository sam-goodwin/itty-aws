...
export const AccountCancelScheduledSubscriptionChangeInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "accountCancelScheduledSubscriptionChange",
    type: "mutation",
  }),
);
export type AccountCancelScheduledSubscriptionChangeInput =
  typeof AccountCancelScheduledSubscriptionChangeInput.Type;

// Output Schema (GraphQL selection set)
export const AccountCancelScheduledSubscriptionChangeOutput = Schema.Struct({
...
}).pipe(T.ResponsePath("account.cancelScheduledSubscriptionChange"));
export type AccountCancelScheduledSubscriptionChangeOutput =
  typeof AccountCancelScheduledSubscriptionChangeOutput.Type;

export const accountCancelScheduledSubscriptionChange = API.make(() => ({
  inputSchema: AccountCancelScheduledSubscriptionChangeInput,
  outputSchema: AccountCancelScheduledSubscriptionChangeOutput,
}));
