...
export class UnknownModrinthError extends Schema.TaggedError<UnknownModrinthError>()(
...
export class ModrinthParseError extends Schema.TaggedError<ModrinthParseError>()(
  "ModrinthParseError",
  {
    body: Schema.Unknown,
