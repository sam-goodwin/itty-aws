...
// Input Schema
export const GetVersionInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "GET", path: "/version/{id}" }));
export type GetVersionInput = typeof GetVersionInput.Type;

// Output Schema
export const GetVersionOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  name: Schema.String,
...
export type GetVersionOutput = typeof GetVersionOutput.Type;
 ...
 */
export const getVersion = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: GetVersionInput,
  outputSchema: GetVersionOutput,
