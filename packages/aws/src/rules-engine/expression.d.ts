...
export declare function isReference(expr: Expression): expr is ReferenceObject;
/** Check if expression is a function call */
export declare function isFunction(expr: Expression): expr is FunctionObject;
/** Check if rule is a tree rule */
export declare function isTreeRule(rule: RuleObject): rule is TreeRuleObject;
/** Check if rule is an endpoint rule */
export declare function isEndpointRule(
  rule: RuleObject,
): rule is EndpointRuleObject;
/** Check if rule is an error rule */
export declare function isErrorRule(rule: RuleObject): rule is ErrorRuleObject;
export {};
