...
export interface CreateLifecyclePolicyRequest {
  name: string;
  description?: string;
  status?: LifecyclePolicyStatus | (string & {});
  executionRole: string;
  resourceType: LifecyclePolicyResourceType | (string & {});
...
export interface GetMarketplaceResourceRequest {
  resourceType: MarketplaceResourceType | (string & {});
  resourceArn: string;
...
export interface SendWorkflowStepActionRequest {
  stepExecutionId: string;
  imageBuildVersionArn: string;
  action: WorkflowStepActionType | (string & {});
  reason?: string;
  clientToken: string;
}
