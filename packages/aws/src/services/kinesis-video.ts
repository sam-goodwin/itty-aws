...
export const MappedResourceConfigurationList =
  /*@__PURE__*/ S.Array(MappedResourceConfigurationListItem);
...
export const NotificationDestinationConfig =
  /*@__PURE__*/ S.suspend(() => S.Struct({ Uri: S.String })).annotate({
...
export const ListEdgeAgentConfigurationsEdgeConfigList =
  /*@__PURE__*/ S.Array(ListEdgeAgentConfigurationsEdgeConfig);
