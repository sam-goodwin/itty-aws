...
export interface ListConfigurationCheckOperationsInput {
  ApplicationId: string;
  ListMode?: ConfigurationCheckOperationListingMode | (string & {});
  MaxResults?: number;
  NextToken?: string;
  Filters?: Filter[];
}
...
export type ConfigurationCheckTypeList = (
...
export interface StopApplicationInput {
  ApplicationId: string;
  StopConnectedEntity?: ConnectedEntityType | (string & {});
...
export interface BackintConfig {
  BackintMode: BackintMode | (string & {});
