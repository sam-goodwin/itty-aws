...
export interface CreateSecurityRequirementPackInput {
  name: string;
  description?: string;
  status?: SecurityRequirementPackStatus | (string & {});
  kmsKeyId?: string;
  tags?: { [key: string]: string | undefined };
}
...
export interface CreateTargetDomainInput {
  ...
  verificationMethod: DomainVerificationMethod | (string & {});
  tags?: { [key: string]: string | undefined };
}
...
export interface SecurityRequirementArtifact {
  name: string;
  format: SecurityRequirementArtifactFormat | (string & {});
...
export type IntegrationFilter =
  | { provider: Provider | (string & {}); providerType?: never }
  | { provider?: never; providerType: ProviderType | (string & {}) };
...
export interface ListMembershipsRequest {
  applicationId: string;
  agentSpaceId: string;
  memberType?: MembershipTypeFilter | (string & {});
  maxResults?: number;
  nextToken?: string;
}
