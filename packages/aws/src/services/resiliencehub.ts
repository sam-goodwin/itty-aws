...
export type AssessmentStatusList = (AssessmentStatus | (string & {}))[];
...
export interface Field {
  name: string;
  aggregation?: FieldAggregationType | (string & {});
}
...
export interface Condition {
  field: string;
  operator: ConditionOperatorType | (string & {});
  value?: string;
}
...
export interface RejectGroupingRecommendationEntry {
  groupingRecommendationId: string;
  rejectionReason?: GroupingRecommendationRejectionReason | (string & {});
}
