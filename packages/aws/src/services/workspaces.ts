...
export interface ApplicationSettingsRequest {
  Status: ApplicationSettingsStatusEnum | (string & {});
...
export interface CreateWorkspacesPoolRequest {
  ...
  RunningMode?: PoolsRunningMode | (string & {});
}
...
export type ClientDeviceTypeList = (ClientDeviceType | (string & {}))[];
...
export interface DescribeWorkspaceDirectoriesFilter {
  Name: DescribeWorkspaceDirectoriesFilterName | (string & {});
  Values: string[];
}
...
export interface DescribeWorkspacesPoolsFilter {
  Name: DescribeWorkspacesPoolsFilterName | (string & {});
  Values: string[];
  Operator: DescribeWorkspacesPoolsFilterOperator | (string & {});
}
...
export interface ImportCustomWorkspaceImageRequest {
  ...
  ComputeType: ImageComputeType | (string & {});
  Protocol: CustomImageProtocol | (string & {});
  ImageSource: ImageSourceIdentifier;
  InfrastructureConfigurationArn: string;
...
export type ApplicationList = (Application | (string & {}))[];
export const ApplicationList = /*@__PURE__*/ S.Array(Application);
export interface ImportWorkspaceImageRequest {
  Ec2ImageId: string;
  IngestionProcess: WorkspaceImageIngestionProcess | (string & {});
  ImageName: string;
  ImageDescription: string;
  Tags?: Tag[];
...
export type LinkStatusFilterList = (AccountLinkStatusEnum | (string & {}))[];
...
export interface ModifyEndpointEncryptionModeRequest {
  DirectoryId: string;
  EndpointEncryptionMode: EndpointEncryptionMode | (string & {});
}
...
export type DeletableSamlPropertiesList = (
...
export interface ModifyWorkspaceStateRequest {
  WorkspaceId: string;
  WorkspaceState: TargetWorkspaceState | (string & {});
}
...
export interface RegisterWorkspaceDirectoryRequest {
  ...
  WorkspaceDirectoryName?: string;
  WorkspaceDirectoryDescription?: string;
  UserIdentityType?: UserIdentityType | (string & {});
