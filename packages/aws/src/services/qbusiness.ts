...
export const InlineDocumentEnrichmentConfigurations =
  /*@__PURE__*/ S.Array(InlineDocumentEnrichmentConfiguration);
...
export const ActionExecutionPayloadField =
  /*@__PURE__*/ S.suspend(() => S.Struct({ value: S.Any })).annotate({
...
export const ActionReviewPayloadFieldAllowedValues =
  /*@__PURE__*/ S.Array(ActionReviewPayloadFieldAllowedValue);
...
export const ListPluginTypeMetadataSummaries =
  /*@__PURE__*/ S.Array(PluginTypeMetadataSummary);
...
export const DocumentAttributeConfigurations =
  /*@__PURE__*/ S.Array(DocumentAttributeConfiguration);
...
export const WebExperienceAuthConfiguration =
  /*@__PURE__*/ S.Union([S.Struct({ samlConfiguration: SamlConfiguration })]);
