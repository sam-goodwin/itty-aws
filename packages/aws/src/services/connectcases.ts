...
export const SearchRelatedItemsResponseItemList =
  /*@__PURE__*/ S.Array(SearchRelatedItemsResponseItem).pipe(T.Sparse());
...
export const ParentChildFieldOptionsMappingList =
  /*@__PURE__*/ S.Array(ParentChildFieldOptionsMapping);
...
export const SearchAllRelatedItemsSortList =
  /*@__PURE__*/ S.Array(SearchAllRelatedItemsSort);
...
export const SearchAllRelatedItemsResponseItemList =
  /*@__PURE__*/ S.Array(SearchAllRelatedItemsResponseItem).pipe(T.Sparse());
...
export const TagPropagationConfigurationList =
  /*@__PURE__*/ S.Array(TagPropagationConfiguration);
