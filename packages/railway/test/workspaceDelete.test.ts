...
describe("workspaceDelete", () => {
  it("happy path - exercises workspace delete with a fabricated workspace id (real deletion would destroy the test workspace and all of its resources, and there is no workspaceCreate operation to provision a throwaway one)", async () => {
