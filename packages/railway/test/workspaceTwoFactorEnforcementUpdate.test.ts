...
describe("workspaceTwoFactorEnforcementUpdate", () => {
  it(
    "happy path - exercises 2FA enforcement update with a fabricated workspace id (real enforcement on the test workspace would lock the test runner out if 2FA is not enrolled; lands in RailwayNotFound or RailwayInvalidInput for the fabricated workspace)",
    async () => {
