...
describe("workspaceLeave", () => {
  it(
    "happy path - exercises workspace leave with a fabricated workspace id (real leaving would remove the test runner from its workspace and break subsequent tests, and there is no workspaceCreate operation to provision a throwaway one)",
    async () => {
