...
describe("userTermsUpdate", () => {
  it("happy path - records terms agreement for the authenticated user (returns user struct, or RailwayInvalidInput if the credentials cannot record agreement)", async () => {
    await runEffect(
