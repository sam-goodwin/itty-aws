...
describe("trustedDomainRetriggerVerification", () => {
  it("happy path - retriggers verification for a freshly registered trusted domain", async () => {
    await runEffect(
      Effect.gen(function* () {
  ...
  it("error - non-existent trusted domain id surfaces RailwayNotAuthorized", async () => {
