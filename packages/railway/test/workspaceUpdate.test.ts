...
describe("workspaceUpdate", () => {
  it(
    "happy path - exercises workspace update with a fabricated workspace id (mutating the real test workspace's name/avatar/preferredRegion would alter shared state across parallel test runs, and there is no workspaceCreate operation to provision a throwaway one; lands in RailwayNotFound for the fabricated workspace)",
    async () => {
