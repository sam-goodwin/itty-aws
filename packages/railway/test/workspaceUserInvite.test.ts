...
describe("workspaceUserInvite", () => {
  it(
    "happy path - exercises workspace user invite with a fabricated workspace id (real invitations would email a real recipient and add a member to the test workspace; lands in RailwayInvalidInput for the fabricated workspace + invite code)",
    async () => {
  ...
  it(
    "error - RailwayInvalidInput for a malformed email/workspace id",
    async () => {
      const error = await runEffect(
        workspaceUserInvite({
