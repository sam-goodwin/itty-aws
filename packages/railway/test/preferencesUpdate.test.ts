...
describe("preferencesUpdate", () => {
  it("happy path - returns the authenticated user's preferences after a no-op update", async () => {
  ...
  it("error - RailwayInvalidInput when the confirmation token is invalid", async () => {
