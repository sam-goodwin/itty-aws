...
const __document =
  "query getAdminVolumeInstancesForVolume($volumeId: String!) {\n  adminVolumeInstancesForVolume(volumeId: $volumeId) {\n    createdAt\n    currentSizeMB\n    deletedAt\n    environment {\n      canAccess\n      createdAt\n      deletedAt\n      id\n      isEphemeral\n      meta {\n        baseBranch\n        branch\n        latestSuccessfulGitHubDeploymentId\n        prCommentId\n        prNumber\n        prRepo\n        prTitle\n        skippedResourceIds\n      }\n      name\n      projectId\n      unmergedChangesCount\n      updatedAt\n    }\n    environmentId\n    externalId\n    id\n    isPendingDeletion\n    mountPath\n    region\n    service {\n      createdAt\n      deletedAt\n      featureFlags\n      hasHiddenRegistryCredentialsFromTemplate\n      icon\n      id\n      name\n      project {\n        baseEnvironmentId\n        botPrEnvironments\n        createdAt\n        deletedAt\n        description\n        expiredAt\n        featureFlags\n        focusedPrEnvironments\n        id\n        isPublic\n        isTempProject\n        name\n        prDeploys\n        primaryEnvironmentId\n        subscriptionPlanLimit\n        subscriptionType\n        teamId\n        updatedAt\n        workspaceId\n      }\n      projectId\n      templateId\n      templateServiceId\n      templateThreadSlug\n      updatedAt\n    }\n    serviceId\n    sizeMB\n    state\n    volume {\n      createdAt\n      id\n      name\n      project {\n        baseEnvironmentId\n        botPrEnvironments\n        createdAt\n        deletedAt\n        description\n        expiredAt\n        featureFlags\n        focusedPrEnvironments\n        id\n        isPublic\n        isTempProject\n        name\n        prDeploys\n        primaryEnvironmentId\n        subscriptionPlanLimit\n        subscriptionType\n        teamId\n        updatedAt\n        workspaceId\n      }\n      projectId\n    }\n    volumeId\n  }\n}";

// Input Schema (GraphQL variables)
export const GetAdminVolumeInstancesForVolumeInput = Schema.Struct({
  volumeId: Schema.String,
}).pipe(
  T.Http({ method: "POST", path: "/graphql/v2" }),
  T.GraphQLOp({
    query: __document,
    operationName: "getAdminVolumeInstancesForVolume",
    type: "query",
  }),
);
export type GetAdminVolumeInstancesForVolumeInput =
  typeof GetAdminVolumeInstancesForVolumeInput.Type;

// Output Schema (GraphQL selection set)
export const GetAdminVolumeInstancesForVolumeOutput = Schema.Array(
  Schema.Struct({
    ...
    id: Schema.String,
    isPendingDeletion: Schema.Boolean,
...
export type GetAdminVolumeInstancesForVolumeOutput =
  typeof GetAdminVolumeInstancesForVolumeOutput.Type;

/**
 * Get all volume instances for a given volume
 */
export const getAdminVolumeInstancesForVolume = API.make(() => ({
  inputSchema: GetAdminVolumeInstancesForVolumeInput,
  outputSchema: GetAdminVolumeInstancesForVolumeOutput,
}));
