...
export const WorkspaceTemplatesInput = Schema.Struct({
...
export type WorkspaceTemplatesInput = typeof WorkspaceTemplatesInput.Type;

// Output Schema (GraphQL selection set)
export const WorkspaceTemplatesOutput = Schema.Struct({
  edges: Schema.Array(
    Schema.Struct({
...
export type WorkspaceTemplatesOutput = typeof WorkspaceTemplatesOutput.Type;

/**
 * Get all templates for a workspace.
 */
export const workspaceTemplates = API.make(() => ({
  inputSchema: WorkspaceTemplatesInput,
  outputSchema: WorkspaceTemplatesOutput,
}));
