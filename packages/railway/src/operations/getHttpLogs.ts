...
export type GetHttpLogsInput = typeof GetHttpLogsInput.Type;

// Output Schema (GraphQL selection set)
export const GetHttpLogsOutput = Schema.Array(
  Schema.Struct({
...
export type GetHttpLogsOutput = typeof GetHttpLogsOutput.Type;

/**
 * Fetch HTTP logs for a deployment
 */
export const getHttpLogs = API.make(() => ({
  inputSchema: GetHttpLogsInput,
  outputSchema: GetHttpLogsOutput,
}));
