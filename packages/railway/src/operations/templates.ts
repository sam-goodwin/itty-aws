...
export const TemplatesInput = Schema.Struct({
...
export type TemplatesInput = typeof TemplatesInput.Type;

// Output Schema (GraphQL selection set)
export const TemplatesOutput = Schema.Struct({
  edges: Schema.Array(
    Schema.Struct({
...
export type TemplatesOutput = typeof TemplatesOutput.Type;

/**
 * Get all published templates.
 */
export const templates = API.make(() => ({
