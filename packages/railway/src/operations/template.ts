...
export const TemplateInput = Schema.Struct({
...
export type TemplateInput = typeof TemplateInput.Type;

// Output Schema (GraphQL selection set)
export const TemplateOutput = Schema.Struct({
...
export type TemplateOutput = typeof TemplateOutput.Type;

/**
 * Get a template by code or ID or GitHub owner and repo.
 */
export const template = API.make(() => ({
  inputSchema: TemplateInput,
  outputSchema: TemplateOutput,
}));
