...
export const SshPublicKeysInput = Schema.Struct({
...
export type SshPublicKeysInput = typeof SshPublicKeysInput.Type;

// Output Schema (GraphQL selection set)
export const SshPublicKeysOutput = Schema.Struct({
  edges: Schema.Array(
    Schema.Struct({
...
export type SshPublicKeysOutput = typeof SshPublicKeysOutput.Type;
 ...
 */
export const sshPublicKeys = API.make(() => ({
  inputSchema: SshPublicKeysInput,
  outputSchema: SshPublicKeysOutput,
}));
