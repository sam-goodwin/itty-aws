...
export const ServiceRemoveUpstreamUrlInput = Schema.Struct({
  id: Schema.String,
}).pipe(
...
export type ServiceRemoveUpstreamUrlInput =
  typeof ServiceRemoveUpstreamUrlInput.Type;

// Output Schema (GraphQL selection set)
export const ServiceRemoveUpstreamUrlOutput = Schema.Struct({
...
export type ServiceRemoveUpstreamUrlOutput =
  typeof ServiceRemoveUpstreamUrlOutput.Type;

/**
 * Remove the upstream URL from all service instances for this service
 */
export const serviceRemoveUpstreamUrl = API.make(() => ({
  inputSchema: ServiceRemoveUpstreamUrlInput,
  outputSchema: ServiceRemoveUpstreamUrlOutput,
}));
