...
export const ProjectInviteCodeInput = Schema.Struct({
...
export type ProjectInviteCodeInput = typeof ProjectInviteCodeInput.Type;

// Output Schema (GraphQL selection set)
export const ProjectInviteCodeOutput = Schema.Struct({
  code: Schema.String,
  ...
  projectId: Schema.String,
  role: Schema.Literals(["ADMIN", "MEMBER", "VIEWER"]),
}).pipe(T.ResponsePath("projectInviteCode"));
export type ProjectInviteCodeOutput = typeof ProjectInviteCodeOutput.Type;

/**
 * Get an invite code for a project for a specifc role
 */
export const projectInviteCode = API.make(() => ({
  inputSchema: ProjectInviteCodeInput,
  outputSchema: ProjectInviteCodeOutput,
}));
