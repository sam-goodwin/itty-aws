...
export const UseInviteCodeInput = Schema.Struct({
  code: Schema.String,
}).pipe(
  T.Http({ method: "POST", path: "/graphql/v2" }),
  T.GraphQLOp({
    query: __document,
    operationName: "useInviteCode",
    type: "mutation",
  }),
);
export type UseInviteCodeInput = typeof UseInviteCodeInput.Type;

// Output Schema (GraphQL selection set)
export const UseInviteCodeOutput = Schema.Struct({
...
export type UseInviteCodeOutput = typeof UseInviteCodeOutput.Type;

/**
 * Join a project using an invite code
 */
export const useInviteCode = API.make(() => ({
  inputSchema: UseInviteCodeInput,
  outputSchema: UseInviteCodeOutput,
}));
