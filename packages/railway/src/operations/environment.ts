...
export const EnvironmentOutput = Schema.Struct({
...
export type EnvironmentOutput = typeof EnvironmentOutput.Type;

/**
 * Find a single environment
 */
export const environment = API.make(() => ({
  inputSchema: EnvironmentInput,
  outputSchema: EnvironmentOutput,
}));
