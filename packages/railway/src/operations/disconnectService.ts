...
export const DisconnectServiceInput = Schema.Struct({
  id: Schema.String,
}).pipe(
...
export type DisconnectServiceInput = typeof DisconnectServiceInput.Type;

// Output Schema (GraphQL selection set)
export const DisconnectServiceOutput = Schema.Struct({
...
export type DisconnectServiceOutput = typeof DisconnectServiceOutput.Type;

/**
 * Disconnect a service from a repo
 */
export const disconnectService = API.make(() => ({
  inputSchema: DisconnectServiceInput,
  outputSchema: DisconnectServiceOutput,
}));
