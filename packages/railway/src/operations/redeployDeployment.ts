...
export const RedeployDeploymentInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "redeployDeployment",
    type: "mutation",
  }),
);
export type RedeployDeploymentInput = typeof RedeployDeploymentInput.Type;

// Output Schema (GraphQL selection set)
export const RedeployDeploymentOutput = Schema.Struct({
...
export type RedeployDeploymentOutput = typeof RedeployDeploymentOutput.Type;

/**
 * Redeploys a deployment.
 */
export const redeployDeployment = API.make(() => ({
  inputSchema: RedeployDeploymentInput,
  outputSchema: RedeployDeploymentOutput,
}));
