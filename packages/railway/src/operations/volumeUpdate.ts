...
export const VolumeUpdateInput = Schema.Struct({
  input: Schema.Struct({
...
export type VolumeUpdateInput = typeof VolumeUpdateInput.Type;

// Output Schema (GraphQL selection set)
export const VolumeUpdateOutput = Schema.Struct({
...
export type VolumeUpdateOutput = typeof VolumeUpdateOutput.Type;

/**
 * Update a persistent volume in a project
 */
export const volumeUpdate = API.make(() => ({
  inputSchema: VolumeUpdateInput,
  outputSchema: VolumeUpdateOutput,
}));
