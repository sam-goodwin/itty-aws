...
export const NotificationRuleCreateInput = Schema.Struct({
  input: Schema.Struct({
...
export type NotificationRuleCreateInput =
  typeof NotificationRuleCreateInput.Type;

// Output Schema (GraphQL selection set)
export const NotificationRuleCreateOutput = Schema.Struct({
...
export type NotificationRuleCreateOutput =
  typeof NotificationRuleCreateOutput.Type;

/**
 * Create a new notification rule
 */
export const notificationRuleCreate = API.make(() => ({
  inputSchema: NotificationRuleCreateInput,
  outputSchema: NotificationRuleCreateOutput,
}));
