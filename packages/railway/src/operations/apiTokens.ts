...
export const ApiTokensInput = Schema.Struct({
...
export type ApiTokensInput = typeof ApiTokensInput.Type;

// Output Schema (GraphQL selection set)
export const ApiTokensOutput = Schema.Struct({
  edges: Schema.Array(
    Schema.Struct({
...
export type ApiTokensOutput = typeof ApiTokensOutput.Type;

/**
 * Gets all API tokens for the authenticated user.
 */
export const apiTokens = API.make(() => ({
  inputSchema: ApiTokensInput,
  outputSchema: ApiTokensOutput,
}));
