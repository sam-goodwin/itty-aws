...
export const UserProfileInput = Schema.Struct({
...
export type UserProfileInput = typeof UserProfileInput.Type;

// Output Schema (GraphQL selection set)
export const UserProfileOutput = Schema.Struct({
...
export type UserProfileOutput = typeof UserProfileOutput.Type;

/**
 * Get the public profile for a user
 */
export const userProfile = API.make(() => ({
  inputSchema: UserProfileInput,
  outputSchema: UserProfileOutput,
}));
