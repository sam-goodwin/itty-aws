...
export const CreateServiceInput = Schema.Struct({
  input: Schema.Struct({
    ...
    templateServiceId: Schema.optional(Schema.NullOr(Schema.String)),
...
export type CreateServiceInput = typeof CreateServiceInput.Type;

// Output Schema (GraphQL selection set)
export const CreateServiceOutput = Schema.Struct({
  ...
  updatedAt: Schema.String,
}).pipe(T.ResponsePath("serviceCreate"));
export type CreateServiceOutput = typeof CreateServiceOutput.Type;
