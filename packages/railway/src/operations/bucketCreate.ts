...
export const BucketCreateInput = Schema.Struct({
  input: Schema.Struct({
...
export type BucketCreateInput = typeof BucketCreateInput.Type;

// Output Schema (GraphQL selection set)
export const BucketCreateOutput = Schema.Struct({
...
export type BucketCreateOutput = typeof BucketCreateOutput.Type;

/**
 * Create a bucket in a project
 */
export const bucketCreate = API.make(() => ({
  inputSchema: BucketCreateInput,
  outputSchema: BucketCreateOutput,
}));
