...
export const GetMeInput = Schema.Struct({}).pipe(
...
export const GetMeOutput = Schema.Struct({
...
export type GetMeOutput = typeof GetMeOutput.Type;

/**
 * Gets the authenticated user.
 */
export const getMe = API.make(() => ({
