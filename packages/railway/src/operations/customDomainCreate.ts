...
export const CustomDomainCreateInput = Schema.Struct({
  input: Schema.Struct({
...
export type CustomDomainCreateInput = typeof CustomDomainCreateInput.Type;

// Output Schema (GraphQL selection set)
export const CustomDomainCreateOutput = Schema.Struct({
...
}).pipe(T.ResponsePath("customDomainCreate"));
export type CustomDomainCreateOutput = typeof CustomDomainCreateOutput.Type;

/**
 * Creates a new custom domain.
 */
export const customDomainCreate = API.make(() => ({
  inputSchema: CustomDomainCreateInput,
  outputSchema: CustomDomainCreateOutput,
}));
