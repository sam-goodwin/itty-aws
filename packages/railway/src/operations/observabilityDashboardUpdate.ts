...
export const ObservabilityDashboardUpdateInput = Schema.Struct({
  id: Schema.String,
  input: Schema.Array(
    Schema.Struct({
...
export type ObservabilityDashboardUpdateInput =
  typeof ObservabilityDashboardUpdateInput.Type;

// Output Schema (GraphQL selection set)
export const ObservabilityDashboardUpdateOutput = Schema.Boolean.pipe(
  T.ResponsePath("observabilityDashboardUpdate"),
);
export type ObservabilityDashboardUpdateOutput =
  typeof ObservabilityDashboardUpdateOutput.Type;

/**
 * Update an observability dashboard
 */
export const observabilityDashboardUpdate = API.make(() => ({
  inputSchema: ObservabilityDashboardUpdateInput,
  outputSchema: ObservabilityDashboardUpdateOutput,
}));
