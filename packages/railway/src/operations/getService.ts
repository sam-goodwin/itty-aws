...
export const GetServiceInput = Schema.Struct({
  id: Schema.String,
}).pipe(
...
export type GetServiceInput = typeof GetServiceInput.Type;

// Output Schema (GraphQL selection set)
export const GetServiceOutput = Schema.Struct({
  ...
  updatedAt: Schema.String,
}).pipe(T.ResponsePath("service"));
export type GetServiceOutput = typeof GetServiceOutput.Type;

/**
 * Get a service by ID
 */
export const getService = API.make(() => ({
  inputSchema: GetServiceInput,
  outputSchema: GetServiceOutput,
}));
