...
export const ProjectClaimInput = Schema.Struct({
  id: Schema.String,
...
export type ProjectClaimInput = typeof ProjectClaimInput.Type;

// Output Schema (GraphQL selection set)
export const ProjectClaimOutput = Schema.Struct({
...
export type ProjectClaimOutput = typeof ProjectClaimOutput.Type;

/**
 * Claims a project.
 */
export const projectClaim = API.make(() => ({
  inputSchema: ProjectClaimInput,
  outputSchema: ProjectClaimOutput,
}));
