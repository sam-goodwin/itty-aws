...
export const DomainsInput = Schema.Struct({
...
export type DomainsInput = typeof DomainsInput.Type;

// Output Schema (GraphQL selection set)
export const DomainsOutput = Schema.Struct({
...
export type DomainsOutput = typeof DomainsOutput.Type;

/**
 * All domains for a service instance
 */
export const domains = API.make(() => ({
  inputSchema: DomainsInput,
  outputSchema: DomainsOutput,
}));
