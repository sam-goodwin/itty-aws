...
export type UpdateUserTermsOutput = typeof UpdateUserTermsOutput.Type;

/**
 * Update date of TermsAgreedOn
 */
export const updateUserTerms = API.make(() => ({
  inputSchema: UpdateUserTermsInput,
  outputSchema: UpdateUserTermsOutput,
}));
