...
export const TrustedDomainsInput = Schema.Struct({
...
export type TrustedDomainsInput = typeof TrustedDomainsInput.Type;

// Output Schema (GraphQL selection set)
export const TrustedDomainsOutput = Schema.Struct({
  edges: Schema.Array(
    Schema.Struct({
...
export type TrustedDomainsOutput = typeof TrustedDomainsOutput.Type;

/**
 * Get all trusted domains for a workspace
 */
export const trustedDomains = API.make(() => ({
  inputSchema: TrustedDomainsInput,
  outputSchema: TrustedDomainsOutput,
}));
