...
export const CreateCustomDomainInput = Schema.Struct({
  input: Schema.Struct({
...
export type CreateCustomDomainInput = typeof CreateCustomDomainInput.Type;

// Output Schema (GraphQL selection set)
export const CreateCustomDomainOutput = Schema.Struct({
...
export type CreateCustomDomainOutput = typeof CreateCustomDomainOutput.Type;
