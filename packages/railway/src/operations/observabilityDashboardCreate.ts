...
export const ObservabilityDashboardCreateInput = Schema.Struct({
  input: Schema.Struct({
...
export type ObservabilityDashboardCreateInput =
  typeof ObservabilityDashboardCreateInput.Type;

// Output Schema (GraphQL selection set)
export const ObservabilityDashboardCreateOutput = Schema.Boolean.pipe(
  T.ResponsePath("observabilityDashboardCreate"),
);
export type ObservabilityDashboardCreateOutput =
  typeof ObservabilityDashboardCreateOutput.Type;

/**
 * Create an observability dashboard
 */
export const observabilityDashboardCreate = API.make(() => ({
  inputSchema: ObservabilityDashboardCreateInput,
  outputSchema: ObservabilityDashboardCreateOutput,
}));
