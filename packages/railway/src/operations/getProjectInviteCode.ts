...
export const GetProjectInviteCodeInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "getProjectInviteCode",
    type: "query",
  }),
);
export type GetProjectInviteCodeInput = typeof GetProjectInviteCodeInput.Type;

// Output Schema (GraphQL selection set)
export const GetProjectInviteCodeOutput = Schema.Struct({
  code: Schema.String,
...
export type GetProjectInviteCodeOutput = typeof GetProjectInviteCodeOutput.Type;

/**
 * Get an invite code for a project for a specifc role
 */
export const getProjectInviteCode = API.make(() => ({
  inputSchema: GetProjectInviteCodeInput,
  outputSchema: GetProjectInviteCodeOutput,
}));
