...
export const DeploymentTriggerUpdateInput = Schema.Struct({
  id: Schema.String,
  input: Schema.Struct({
...
export type DeploymentTriggerUpdateInput =
  typeof DeploymentTriggerUpdateInput.Type;

// Output Schema (GraphQL selection set)
export const DeploymentTriggerUpdateOutput = Schema.Struct({
...
export type DeploymentTriggerUpdateOutput =
  typeof DeploymentTriggerUpdateOutput.Type;

/**
 * Updates a deployment trigger.
 */
export const deploymentTriggerUpdate = API.make(() => ({
  inputSchema: DeploymentTriggerUpdateInput,
  outputSchema: DeploymentTriggerUpdateOutput,
}));
