...
export const BuildLogsInput = Schema.Struct({
...
export type BuildLogsInput = typeof BuildLogsInput.Type;

// Output Schema (GraphQL selection set)
export const BuildLogsOutput = Schema.Array(
  Schema.Struct({
...
export type BuildLogsOutput = typeof BuildLogsOutput.Type;

/**
 * Fetch logs for a build
 */
export const buildLogs = API.make(() => ({
  inputSchema: BuildLogsInput,
  outputSchema: BuildLogsOutput,
}));
