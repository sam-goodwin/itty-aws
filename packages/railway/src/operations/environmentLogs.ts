...
export const EnvironmentLogsInput = Schema.Struct({
...
export type EnvironmentLogsInput = typeof EnvironmentLogsInput.Type;

// Output Schema (GraphQL selection set)
export const EnvironmentLogsOutput = Schema.Array(
  Schema.Struct({
...
export type EnvironmentLogsOutput = typeof EnvironmentLogsOutput.Type;

/**
 * Fetch logs for a project environment. Build logs are excluded unless a snapshot ID is explicitly provided in the filter
 */
export const environmentLogs = API.make(() => ({
  inputSchema: EnvironmentLogsInput,
  outputSchema: EnvironmentLogsOutput,
}));
