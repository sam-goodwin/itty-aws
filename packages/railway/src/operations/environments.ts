...
export const EnvironmentsInput = Schema.Struct({
...
export type EnvironmentsInput = typeof EnvironmentsInput.Type;

// Output Schema (GraphQL selection set)
export const EnvironmentsOutput = Schema.Struct({
  edges: Schema.Array(
    Schema.Struct({
...
export type EnvironmentsOutput = typeof EnvironmentsOutput.Type;

/**
 * Gets all environments for a project.
 */
export const environments = API.make(() => ({
  inputSchema: EnvironmentsInput,
  outputSchema: EnvironmentsOutput,
}));
