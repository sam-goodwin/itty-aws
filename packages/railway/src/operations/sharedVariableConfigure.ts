...
export const SharedVariableConfigureInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "sharedVariableConfigure",
    type: "mutation",
  }),
);
export type SharedVariableConfigureInput =
  typeof SharedVariableConfigureInput.Type;

// Output Schema (GraphQL selection set)
export const SharedVariableConfigureOutput = Schema.Struct({
...
export type SharedVariableConfigureOutput =
  typeof SharedVariableConfigureOutput.Type;

/**
 * Configure a shared variable.
 */
export const sharedVariableConfigure = API.make(() => ({
  inputSchema: SharedVariableConfigureInput,
  outputSchema: SharedVariableConfigureOutput,
}));
