...
export type GetAuditLogInput = typeof GetAuditLogInput.Type;

// Output Schema (GraphQL selection set)
export const GetAuditLogOutput = Schema.Struct({
  ...
  workspaceId: Schema.NullOr(Schema.String),
}).pipe(T.ResponsePath("auditLog"));
export type GetAuditLogOutput = typeof GetAuditLogOutput.Type;

/**
 * Get an audit log by ID
 */
export const getAuditLog = API.make(() => ({
