...
export const GetVolumeInstanceInput = Schema.Struct({
  id: Schema.String,
}).pipe(
  T.Http({ method: "POST", path: "/graphql/v2" }),
  T.GraphQLOp({
    query: __document,
    operationName: "getVolumeInstance",
    type: "query",
  }),
);
export type GetVolumeInstanceInput = typeof GetVolumeInstanceInput.Type;

// Output Schema (GraphQL selection set)
export const GetVolumeInstanceOutput = Schema.Struct({
...
export type GetVolumeInstanceOutput = typeof GetVolumeInstanceOutput.Type;

/**
 * Get a single volume instance by id
 */
export const getVolumeInstance = API.make(() => ({
  inputSchema: GetVolumeInstanceInput,
  outputSchema: GetVolumeInstanceOutput,
}));
