...
export const ServiceDisconnectInput = Schema.Struct({
  id: Schema.String,
}).pipe(
...
export type ServiceDisconnectInput = typeof ServiceDisconnectInput.Type;

// Output Schema (GraphQL selection set)
export const ServiceDisconnectOutput = Schema.Struct({
...
export type ServiceDisconnectOutput = typeof ServiceDisconnectOutput.Type;

/**
 * Disconnect a service from a repo
 */
export const serviceDisconnect = API.make(() => ({
  inputSchema: ServiceDisconnectInput,
  outputSchema: ServiceDisconnectOutput,
}));
