...
export const ServiceDomainCreateInput = Schema.Struct({
  input: Schema.Struct({
...
export type ServiceDomainCreateInput = typeof ServiceDomainCreateInput.Type;

// Output Schema (GraphQL selection set)
export const ServiceDomainCreateOutput = Schema.Struct({
...
export type ServiceDomainCreateOutput = typeof ServiceDomainCreateOutput.Type;

/**
 * Creates a new service domain.
 */
export const serviceDomainCreate = API.make(() => ({
  inputSchema: ServiceDomainCreateInput,
  outputSchema: ServiceDomainCreateOutput,
}));
