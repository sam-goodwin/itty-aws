...
export const GenerateTemplateInput = Schema.Struct({
  input: Schema.Struct({
...
export type GenerateTemplateInput = typeof GenerateTemplateInput.Type;

// Output Schema (GraphQL selection set)
export const GenerateTemplateOutput = Schema.Struct({
...
export type GenerateTemplateOutput = typeof GenerateTemplateOutput.Type;

/**
 * Generate a template for a project
 */
export const generateTemplate = API.make(() => ({
  inputSchema: GenerateTemplateInput,
  outputSchema: GenerateTemplateOutput,
}));
