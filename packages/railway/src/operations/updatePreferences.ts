...
export type UpdatePreferencesInput = typeof UpdatePreferencesInput.Type;

// Output Schema (GraphQL selection set)
export const UpdatePreferencesOutput = Schema.Struct({
...
export type UpdatePreferencesOutput = typeof UpdatePreferencesOutput.Type;

/**
 * Update the email preferences for a user
 */
export const updatePreferences = API.make(() => ({
  inputSchema: UpdatePreferencesInput,
  outputSchema: UpdatePreferencesOutput,
}));
