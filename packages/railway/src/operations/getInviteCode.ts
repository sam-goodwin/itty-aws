...
export type GetInviteCodeInput = typeof GetInviteCodeInput.Type;

// Output Schema (GraphQL selection set)
export const GetInviteCodeOutput = Schema.Struct({
  code: Schema.String,
...
export type GetInviteCodeOutput = typeof GetInviteCodeOutput.Type;

/**
 * Get an invite code by the code
 */
export const getInviteCode = API.make(() => ({
  inputSchema: GetInviteCodeInput,
  outputSchema: GetInviteCodeOutput,
}));
