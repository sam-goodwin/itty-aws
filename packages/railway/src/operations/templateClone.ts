...
export const TemplateCloneInput = Schema.Struct({
  input: Schema.Struct({
    code: Schema.String,
...
export type TemplateCloneInput = typeof TemplateCloneInput.Type;

// Output Schema (GraphQL selection set)
export const TemplateCloneOutput = Schema.Struct({
...
export type TemplateCloneOutput = typeof TemplateCloneOutput.Type;

/**
 * Duplicates an existing template
 */
export const templateClone = API.make(() => ({
  inputSchema: TemplateCloneInput,
  outputSchema: TemplateCloneOutput,
}));
