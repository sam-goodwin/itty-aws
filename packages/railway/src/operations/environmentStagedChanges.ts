...
export const EnvironmentStagedChangesInput = Schema.Struct({
...
export type EnvironmentStagedChangesInput =
  typeof EnvironmentStagedChangesInput.Type;

// Output Schema (GraphQL selection set)
export const EnvironmentStagedChangesOutput = Schema.Struct({
...
export type EnvironmentStagedChangesOutput =
  typeof EnvironmentStagedChangesOutput.Type;

/**
 * Get the latest staged commit for a single environment.
 */
export const environmentStagedChanges = API.make(() => ({
  inputSchema: EnvironmentStagedChangesInput,
  outputSchema: EnvironmentStagedChangesOutput,
}));
