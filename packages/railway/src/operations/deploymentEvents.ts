...
export const DeploymentEventsInput = Schema.Struct({
...
export type DeploymentEventsInput = typeof DeploymentEventsInput.Type;

// Output Schema (GraphQL selection set)
export const DeploymentEventsOutput = Schema.Struct({
  edges: Schema.Array(
    Schema.Struct({
...
export type DeploymentEventsOutput = typeof DeploymentEventsOutput.Type;

/**
 * Get the deployment events for a deployment
 */
export const deploymentEvents = API.make(() => ({
  inputSchema: DeploymentEventsInput,
  outputSchema: DeploymentEventsOutput,
}));
