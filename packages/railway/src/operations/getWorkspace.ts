...
export const GetWorkspaceInput = Schema.Struct({
...
export type GetWorkspaceInput = typeof GetWorkspaceInput.Type;

// Output Schema (GraphQL selection set)
export const GetWorkspaceOutput = Schema.Struct({
...
export type GetWorkspaceOutput = typeof GetWorkspaceOutput.Type;

/**
 * Get the workspace
 */
export const getWorkspace = API.make(() => ({
  inputSchema: GetWorkspaceInput,
