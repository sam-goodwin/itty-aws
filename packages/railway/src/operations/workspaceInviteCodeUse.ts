...
export const WorkspaceInviteCodeUseInput = Schema.Struct({
  code: Schema.String,
}).pipe(
...
export type WorkspaceInviteCodeUseInput =
  typeof WorkspaceInviteCodeUseInput.Type;

// Output Schema (GraphQL selection set)
export const WorkspaceInviteCodeUseOutput = Schema.Struct({
...
export type WorkspaceInviteCodeUseOutput =
  typeof WorkspaceInviteCodeUseOutput.Type;

/**
 * Use an invite code to join a workspace
 */
export const workspaceInviteCodeUse = API.make(() => ({
  inputSchema: WorkspaceInviteCodeUseInput,
  outputSchema: WorkspaceInviteCodeUseOutput,
}));
