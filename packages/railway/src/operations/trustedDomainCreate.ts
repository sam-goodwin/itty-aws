...
export const TrustedDomainCreateInput = Schema.Struct({
  input: Schema.Struct({
...
export type TrustedDomainCreateInput = typeof TrustedDomainCreateInput.Type;

// Output Schema (GraphQL selection set)
export const TrustedDomainCreateOutput = Schema.Struct({
  domainName: Schema.String,
  id: Schema.String,
  role: Schema.String,
...
export type TrustedDomainCreateOutput = typeof TrustedDomainCreateOutput.Type;

/**
 * Create a new trusted domain for this workspace
 */
export const trustedDomainCreate = API.make(() => ({
  inputSchema: TrustedDomainCreateInput,
  outputSchema: TrustedDomainCreateOutput,
}));
