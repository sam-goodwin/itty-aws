...
export const DeploymentInstanceExecutionsInput = Schema.Struct({
...
export type DeploymentInstanceExecutionsInput =
  typeof DeploymentInstanceExecutionsInput.Type;

// Output Schema (GraphQL selection set)
export const DeploymentInstanceExecutionsOutput = Schema.Struct({
  edges: Schema.Array(
    Schema.Struct({
...
export type DeploymentInstanceExecutionsOutput =
  typeof DeploymentInstanceExecutionsOutput.Type;

/**
 * Get the deployment instance executions for a deployment.
 */
export const deploymentInstanceExecutions = API.make(() => ({
  inputSchema: DeploymentInstanceExecutionsInput,
  outputSchema: DeploymentInstanceExecutionsOutput,
}));
