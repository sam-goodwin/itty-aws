...
export type GetDeploymentTriggersInput = typeof GetDeploymentTriggersInput.Type;

// Output Schema (GraphQL selection set)
export const GetDeploymentTriggersOutput = Schema.Struct({
  edges: Schema.Array(
    Schema.Struct({
...
export type GetDeploymentTriggersOutput =
  typeof GetDeploymentTriggersOutput.Type;

/**
 * All deployment triggers.
 */
export const getDeploymentTriggers = API.make(() => ({
  inputSchema: GetDeploymentTriggersInput,
  outputSchema: GetDeploymentTriggersOutput,
}));
