...
export const ConnectServiceInput = Schema.Struct({
  id: Schema.String,
  input: Schema.Struct({
...
export type ConnectServiceInput = typeof ConnectServiceInput.Type;

// Output Schema (GraphQL selection set)
export const ConnectServiceOutput = Schema.Struct({
...
export type ConnectServiceOutput = typeof ConnectServiceOutput.Type;

/**
 * Connect a service to a source
 */
export const connectService = API.make(() => ({
  inputSchema: ConnectServiceInput,
  outputSchema: ConnectServiceOutput,
}));
