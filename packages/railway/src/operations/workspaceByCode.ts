...
export const WorkspaceByCodeInput = Schema.Struct({
  code: Schema.String,
}).pipe(
...
export type WorkspaceByCodeInput = typeof WorkspaceByCodeInput.Type;

// Output Schema (GraphQL selection set)
export const WorkspaceByCodeOutput = Schema.Struct({
...
export type WorkspaceByCodeOutput = typeof WorkspaceByCodeOutput.Type;

/**
 * Find a workspace by invite code
 */
export const workspaceByCode = API.make(() => ({
  inputSchema: WorkspaceByCodeInput,
  outputSchema: WorkspaceByCodeOutput,
}));
