...
export type GetHttpDurationMetricsInput =
  typeof GetHttpDurationMetricsInput.Type;

// Output Schema (GraphQL selection set)
export const GetHttpDurationMetricsOutput = Schema.Struct({
...
export type GetHttpDurationMetricsOutput =
  typeof GetHttpDurationMetricsOutput.Type;

/**
 * Get HTTP request duration metrics for a service (avg, p50, p90, p95, p99)
 */
export const getHttpDurationMetrics = API.make(() => ({
  inputSchema: GetHttpDurationMetricsInput,
  outputSchema: GetHttpDurationMetricsOutput,
}));
