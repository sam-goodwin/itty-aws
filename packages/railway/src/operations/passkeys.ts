...
export const PasskeysInput = Schema.Struct({
...
export type PasskeysInput = typeof PasskeysInput.Type;

// Output Schema (GraphQL selection set)
export const PasskeysOutput = Schema.Struct({
  edges: Schema.Array(
    Schema.Struct({
...
export type PasskeysOutput = typeof PasskeysOutput.Type;

/**
 * Gets all passkeys for the authenticated user
 */
export const passkeys = API.make(() => ({
  inputSchema: PasskeysInput,
  outputSchema: PasskeysOutput,
}));
