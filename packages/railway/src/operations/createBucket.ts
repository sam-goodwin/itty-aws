...
export const CreateBucketInput = Schema.Struct({
  input: Schema.Struct({
...
export type CreateBucketInput = typeof CreateBucketInput.Type;

// Output Schema (GraphQL selection set)
export const CreateBucketOutput = Schema.Struct({
...
export type CreateBucketOutput = typeof CreateBucketOutput.Type;

/**
 * Create a bucket in a project
 */
export const createBucket = API.make(() => ({
  inputSchema: CreateBucketInput,
  outputSchema: CreateBucketOutput,
}));
