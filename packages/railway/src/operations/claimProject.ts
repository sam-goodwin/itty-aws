...
export const ClaimProjectInput = Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "claimProject",
    type: "mutation",
  }),
);
export type ClaimProjectInput = typeof ClaimProjectInput.Type;

// Output Schema (GraphQL selection set)
export const ClaimProjectOutput = Schema.Struct({
...
export type ClaimProjectOutput = typeof ClaimProjectOutput.Type;

/**
 * Claims a project.
 */
export const claimProject = API.make(() => ({
  inputSchema: ClaimProjectInput,
  outputSchema: ClaimProjectOutput,
}));
