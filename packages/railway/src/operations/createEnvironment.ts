...
export type CreateEnvironmentInput = typeof CreateEnvironmentInput.Type;

// Output Schema (GraphQL selection set)
export const CreateEnvironmentOutput = Schema.Struct({
...
export type CreateEnvironmentOutput = typeof CreateEnvironmentOutput.Type;
