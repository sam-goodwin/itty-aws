...
export const TemplatePublishInput = Schema.Struct({
  id: Schema.String,
  input: Schema.Struct({
...
export type TemplatePublishInput = typeof TemplatePublishInput.Type;

// Output Schema (GraphQL selection set)
export const TemplatePublishOutput = Schema.Struct({
...
export type TemplatePublishOutput = typeof TemplatePublishOutput.Type;

/**
 * Publishes a template.
 */
export const templatePublish = API.make(() => ({
  inputSchema: TemplatePublishInput,
  outputSchema: TemplatePublishOutput,
}));
