...
export const SessionsInput = Schema.Struct({
...
export type SessionsInput = typeof SessionsInput.Type;

// Output Schema (GraphQL selection set)
export const SessionsOutput = Schema.Struct({
  edges: Schema.Array(
    Schema.Struct({
...
export type SessionsOutput = typeof SessionsOutput.Type;

/**
 * Gets all sessions for authenticated user.
 */
export const sessions = API.make(() => ({
