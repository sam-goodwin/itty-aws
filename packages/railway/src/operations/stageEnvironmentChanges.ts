...
export type StageEnvironmentChangesInput =
  typeof StageEnvironmentChangesInput.Type;

// Output Schema (GraphQL selection set)
export const StageEnvironmentChangesOutput = Schema.Struct({
...
export type StageEnvironmentChangesOutput =
  typeof StageEnvironmentChangesOutput.Type;

/**
 * Sets the staged patch for a single environment.
 */
export const stageEnvironmentChanges = API.make(() => ({
  inputSchema: StageEnvironmentChangesInput,
  outputSchema: StageEnvironmentChangesOutput,
}));
