...
export const ExternalWorkspacesInput = Schema.Struct({
...
export type ExternalWorkspacesInput = typeof ExternalWorkspacesInput.Type;

// Output Schema (GraphQL selection set)
export const ExternalWorkspacesOutput = Schema.Array(
  Schema.Struct({
...
export type ExternalWorkspacesOutput = typeof ExternalWorkspacesOutput.Type;

/**
 * Get the workspaces the user doesn't belong to, but needs access (like when invited to a project)
 */
export const externalWorkspaces = API.make(() => ({
  inputSchema: ExternalWorkspacesInput,
  outputSchema: ExternalWorkspacesOutput,
}));
