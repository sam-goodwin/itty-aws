...
export const ProjectTokenInput = Schema.Struct({}).pipe(
...
export type ProjectTokenInput = typeof ProjectTokenInput.Type;

// Output Schema (GraphQL selection set)
export const ProjectTokenOutput = Schema.Struct({
...
export type ProjectTokenOutput = typeof ProjectTokenOutput.Type;

/**
 * Get a single project token by the value in the header
 */
export const projectToken = API.make(() => ({
  inputSchema: ProjectTokenInput,
  outputSchema: ProjectTokenOutput,
}));
