...
export const DeploymentRedeployInput = Schema.Struct({
  id: Schema.String,
  usePreviousImageTag: Schema.optional(Schema.NullOr(Schema.Boolean)),
}).pipe(
...
export const DeploymentRedeployOutput = Schema.Struct({
...
export type DeploymentRedeployOutput = typeof DeploymentRedeployOutput.Type;

/**
 * Redeploys a deployment.
 */
export const deploymentRedeploy = API.make(() => ({
  inputSchema: DeploymentRedeployInput,
  outputSchema: DeploymentRedeployOutput,
}));
