...
export const ServiceUpdateInput = Schema.Struct({
  id: Schema.String,
  input: Schema.Struct({
...
export type ServiceUpdateInput = typeof ServiceUpdateInput.Type;

// Output Schema (GraphQL selection set)
export const ServiceUpdateOutput = Schema.Struct({
...
export type ServiceUpdateOutput = typeof ServiceUpdateOutput.Type;

/**
 * Updates a service.
 */
export const serviceUpdate = API.make(() => ({
  inputSchema: ServiceUpdateInput,
  outputSchema: ServiceUpdateOutput,
}));
