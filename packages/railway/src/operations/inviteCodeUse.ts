...
export const InviteCodeUseInput = Schema.Struct({
  code: Schema.String,
}).pipe(
...
export type InviteCodeUseInput = typeof InviteCodeUseInput.Type;

// Output Schema (GraphQL selection set)
export const InviteCodeUseOutput = Schema.Struct({
...
export type InviteCodeUseOutput = typeof InviteCodeUseOutput.Type;

/**
 * Join a project using an invite code
 */
export const inviteCodeUse = API.make(() => ({
  inputSchema: InviteCodeUseInput,
  outputSchema: InviteCodeUseOutput,
}));
