...
const __document =
  "mutation retriggerTrustedDomainVerification($id: String!) {\n  trustedDomainRetriggerVerification(id: $id) {\n    domainName\n    id\n    role\n    status\n    verificationData {\n      dnsHost\n      domainMatch {\n        cdnMode\n        createdAt\n        deletedAt\n        domain\n        edgeId\n        environmentId\n        id\n        projectId\n        serviceId\n        targetPort\n        updatedAt\n      }\n      domainStatus {\n        cdnProvider\n        certificateErrorMessage\n        certificateErrorType\n        certificateRetryable\n        certificateStatus\n        certificateStatusDetailed\n        verificationDnsHost\n        verificationToken\n        verified\n      }\n      token\n    }\n    verificationType\n    workspaceId\n  }\n}";

// Input Schema (GraphQL variables)
export const RetriggerTrustedDomainVerificationInput = Schema.Struct({
  id: Schema.String,
}).pipe(
  T.Http({ method: "POST", path: "/graphql/v2" }),
  T.GraphQLOp({
    query: __document,
    operationName: "retriggerTrustedDomainVerification",
    type: "mutation",
  }),
);
export type RetriggerTrustedDomainVerificationInput =
  typeof RetriggerTrustedDomainVerificationInput.Type;

// Output Schema (GraphQL selection set)
export const RetriggerTrustedDomainVerificationOutput = Schema.NullOr(
  Schema.Struct({
...
export type RetriggerTrustedDomainVerificationOutput =
  typeof RetriggerTrustedDomainVerificationOutput.Type;

/**
 * Retrigger verification for a failed trusted domain
 */
export const retriggerTrustedDomainVerification = API.make(() => ({
  inputSchema: RetriggerTrustedDomainVerificationInput,
  outputSchema: RetriggerTrustedDomainVerificationOutput,
}));
