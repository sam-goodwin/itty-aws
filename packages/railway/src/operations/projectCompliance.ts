...
export const ProjectComplianceInput = Schema.Struct({
...
export type ProjectComplianceInput = typeof ProjectComplianceInput.Type;

// Output Schema (GraphQL selection set)
export const ProjectComplianceOutput = Schema.Struct({
...
export type ProjectComplianceOutput = typeof ProjectComplianceOutput.Type;
 ...
 */
export const projectCompliance = API.make(() => ({
  inputSchema: ProjectComplianceInput,
  outputSchema: ProjectComplianceOutput,
}));
