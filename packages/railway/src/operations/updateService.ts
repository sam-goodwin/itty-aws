...
export type UpdateServiceInput = typeof UpdateServiceInput.Type;

// Output Schema (GraphQL selection set)
export const UpdateServiceOutput = Schema.Struct({
  ...
  updatedAt: Schema.String,
}).pipe(T.ResponsePath("serviceUpdate"));
export type UpdateServiceOutput = typeof UpdateServiceOutput.Type;

/**
 * Updates a service.
 */
export const updateService = API.make(() => ({
  inputSchema: UpdateServiceInput,
  outputSchema: UpdateServiceOutput,
}));
