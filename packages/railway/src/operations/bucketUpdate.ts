...
export const BucketUpdateInput = Schema.Struct({
  id: Schema.String,
  input: Schema.Struct({
    name: Schema.String,
  }),
...
export type BucketUpdateInput = typeof BucketUpdateInput.Type;

// Output Schema (GraphQL selection set)
export const BucketUpdateOutput = Schema.Struct({
...
export type BucketUpdateOutput = typeof BucketUpdateOutput.Type;

/**
 * Updates a bucket.
 */
export const bucketUpdate = API.make(() => ({
  inputSchema: BucketUpdateInput,
  outputSchema: BucketUpdateOutput,
}));
