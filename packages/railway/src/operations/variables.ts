...
export type VariablesInput = typeof VariablesInput.Type;

// Output Schema (GraphQL selection set)
export const VariablesOutput = Schema.Unknown.pipe(T.ResponsePath("variables"));
export type VariablesOutput = typeof VariablesOutput.Type;

/**
 * All variables by pluginId or serviceId. If neither are provided, all shared variables are returned.
 */
export const variables = API.make(() => ({
  inputSchema: VariablesInput,
  outputSchema: VariablesOutput,
}));
