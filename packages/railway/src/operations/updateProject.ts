...
export const UpdateProjectInput = Schema.Struct({
  id: Schema.String,
  input: Schema.Struct({
    baseEnvironmentId: Schema.optional(Schema.NullOr(Schema.String)),
    botPrEnvironments: Schema.optional(Schema.NullOr(Schema.Boolean)),
    description: Schema.optional(Schema.NullOr(Schema.String)),
    focusedPrEnvironments: Schema.optional(Schema.NullOr(Schema.Boolean)),
 ...
 * Updates a project.
 */
export const updateProject = API.make(() => ({
