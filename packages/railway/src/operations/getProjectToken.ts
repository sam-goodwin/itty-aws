...
const __document =
  "query getProjectToken {\n  projectToken {\n    createdAt\n    displayToken\n    environment {\n      canAccess\n      createdAt\n      deletedAt\n      id\n      isEphemeral\n      meta {\n        baseBranch\n        branch\n        latestSuccessfulGitHubDeploymentId\n        prCommentId\n        prNumber\n        prRepo\n        prTitle\n        skippedResourceIds\n      }\n      name\n      projectId\n      unmergedChangesCount\n      updatedAt\n    }\n    environmentId\n    id\n    name\n    project {\n      baseEnvironment {\n        canAccess\n        createdAt\n        deletedAt\n        id\n        isEphemeral\n        name\n        projectId\n        unmergedChangesCount\n        updatedAt\n      }\n      baseEnvironmentId\n      botPrEnvironments\n      createdAt\n      deletedAt\n      description\n      expiredAt\n      featureFlags\n      focusedPrEnvironments\n      id\n      isPublic\n      isTempProject\n      members {\n        avatar\n        email\n        id\n        name\n        role\n      }\n      name\n      prDeploys\n      primaryEnvironmentId\n      subscriptionPlanLimit\n      subscriptionType\n      team {\n        adoptionLevel\n        avatar\n        createdAt\n        id\n        name\n        preferredRegion\n        slackChannelId\n        supportTierOverride\n        updatedAt\n      }\n      teamId\n      updatedAt\n      workspace {\n        adoptionLevel\n        allowDeprecatedRegions\n        avatar\n        banReason\n        createdAt\n        discordRole\n        has2FAEnforcement\n        hasAutomaticDiagnosis\n        hasGuardrailsAccess\n        hasSAML\n        id\n        name\n        plan\n        preferredRegion\n        redactedDueTo2FAPending\n        slackChannelId\n        subscriptionModel\n        subscriptionPlanLimit\n        supportTierOverride\n        updatedAt\n        usersWithout2FA\n      }\n      workspaceId\n    }\n    projectId\n  }\n}";

// Input Schema (GraphQL variables)
export const GetProjectTokenInput = Schema.Struct({}).pipe(
  T.Http({ method: "POST", path: "/graphql/v2" }),
  T.GraphQLOp({
    query: __document,
    operationName: "getProjectToken",
    type: "query",
  }),
);
export type GetProjectTokenInput = typeof GetProjectTokenInput.Type;

// Output Schema (GraphQL selection set)
export const GetProjectTokenOutput = Schema.Struct({
  ...
  projectId: Schema.String,
}).pipe(T.ResponsePath("projectToken"));
export type GetProjectTokenOutput = typeof GetProjectTokenOutput.Type;

/**
 * Get a single project token by the value in the header
 */
export const getProjectToken = API.make(() => ({
  inputSchema: GetProjectTokenInput,
  outputSchema: GetProjectTokenOutput,
}));
