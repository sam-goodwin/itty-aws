...
export const TemplateGenerateInput = Schema.Struct({
  input: Schema.Struct({
  ...
  T.GraphQLOp({
    query: __document,
    operationName: "templateGenerate",
    type: "mutation",
  }),
);
export type TemplateGenerateInput = typeof TemplateGenerateInput.Type;

// Output Schema (GraphQL selection set)
export const TemplateGenerateOutput = Schema.Struct({
  ...
  workspaceId: Schema.NullOr(Schema.String),
}).pipe(T.ResponsePath("templateGenerate"));
export type TemplateGenerateOutput = typeof TemplateGenerateOutput.Type;

/**
 * Generate a template for a project
 */
export const templateGenerate = API.make(() => ({
  inputSchema: TemplateGenerateInput,
  outputSchema: TemplateGenerateOutput,
}));
