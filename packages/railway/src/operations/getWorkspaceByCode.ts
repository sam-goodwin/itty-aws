...
export type GetWorkspaceByCodeOutput = typeof GetWorkspaceByCodeOutput.Type;

/**
 * Find a workspace by invite code
 */
export const getWorkspaceByCode = API.make(() => ({
  inputSchema: GetWorkspaceByCodeInput,
  outputSchema: GetWorkspaceByCodeOutput,
}));
