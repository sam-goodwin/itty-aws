...
export type CreateVolumeInput = typeof CreateVolumeInput.Type;

// Output Schema (GraphQL selection set)
export const CreateVolumeOutput = Schema.Struct({
...
export type CreateVolumeOutput = typeof CreateVolumeOutput.Type;

/**
 * Create a persistent volume in a project
 */
export const createVolume = API.make(() => ({
  inputSchema: CreateVolumeInput,
  outputSchema: CreateVolumeOutput,
}));
