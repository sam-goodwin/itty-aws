...
import { NotAuthorized, ProjectCreateRateLimited } from "./errors.ts";
...
export const CreateProjectInput = Schema.Struct({
  input: Schema.Struct({
    defaultEnvironmentName: Schema.optional(Schema.NullOr(Schema.String)),
    description: Schema.optional(Schema.NullOr(Schema.String)),
    isMonorepo: Schema.optional(Schema.NullOr(Schema.Boolean)),
    isPublic: Schema.optional(Schema.NullOr(Schema.Boolean)),
    name: Schema.optional(Schema.NullOr(Schema.String)),
    prDeploys: Schema.optional(Schema.NullOr(Schema.Boolean)),
    ...
    runtime: Schema.optional(
      Schema.NullOr(Schema.Literals(["LEGACY", "UNSPECIFIED", "V2"])),
    ),
...
export const createProject = API.make(() => ({
  ...
  errors: [NotAuthorized, ProjectCreateRateLimited],
}));
