...
import { NotAuthorized, VolumeNameInvalid } from "./errors.ts";
...
export type UpdateVolumeInput = typeof UpdateVolumeInput.Type;

// Output Schema (GraphQL selection set)
export const UpdateVolumeOutput = Schema.Struct({
...
export type UpdateVolumeOutput = typeof UpdateVolumeOutput.Type;

/**
 * Update a persistent volume in a project
 */
export const updateVolume = API.make(() => ({
  inputSchema: UpdateVolumeInput,
  outputSchema: UpdateVolumeOutput,
  errors: [NotAuthorized, VolumeNameInvalid],
}));
