...
export const GetProjectsByIdsInput = Schema.Struct({
  ids: Schema.Array(Schema.String),
}).pipe(
  T.Http({ method: "POST", path: "/graphql/v2" }),
  T.GraphQLOp({
    query: __document,
    operationName: "getProjectsByIds",
    type: "query",
  }),
);
export type GetProjectsByIdsInput = typeof GetProjectsByIdsInput.Type;

// Output Schema (GraphQL selection set)
export const GetProjectsByIdsOutput = Schema.Array(
  Schema.Struct({
...
export type GetProjectsByIdsOutput = typeof GetProjectsByIdsOutput.Type;
 ...
 */
export const getProjectsByIds = API.make(() => ({
  inputSchema: GetProjectsByIdsInput,
  outputSchema: GetProjectsByIdsOutput,
}));
