...
export const UpdateBucketInput = Schema.Struct({
  id: Schema.String,
  input: Schema.Struct({
    name: Schema.String,
  }),
...
export type UpdateBucketInput = typeof UpdateBucketInput.Type;

// Output Schema (GraphQL selection set)
export const UpdateBucketOutput = Schema.Struct({
...
export type UpdateBucketOutput = typeof UpdateBucketOutput.Type;

/**
 * Updates a bucket.
 */
export const updateBucket = API.make(() => ({
  inputSchema: UpdateBucketInput,
  outputSchema: UpdateBucketOutput,
}));
