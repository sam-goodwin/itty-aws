...
export type GetDeploymentsInput = typeof GetDeploymentsInput.Type;

// Output Schema (GraphQL selection set)
export const GetDeploymentsOutput = Schema.Struct({
  edges: Schema.Array(
    Schema.Struct({
...
export type GetDeploymentsOutput = typeof GetDeploymentsOutput.Type;

/**
 * Get all deployments
 */
export const getDeployments = API.make(() => ({
  inputSchema: GetDeploymentsInput,
  outputSchema: GetDeploymentsOutput,
}));
