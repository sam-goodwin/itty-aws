...
export const DeploymentInput = Schema.Struct({
  id: Schema.String,
}).pipe(
...
export type DeploymentInput = typeof DeploymentInput.Type;

// Output Schema (GraphQL selection set)
export const DeploymentOutput = Schema.Struct({
...
export type DeploymentOutput = typeof DeploymentOutput.Type;

/**
 * Find a single deployment
 */
export const deployment = API.make(() => ({
