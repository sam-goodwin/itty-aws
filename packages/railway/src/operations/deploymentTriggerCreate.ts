...
export const DeploymentTriggerCreateInput = Schema.Struct({
  input: Schema.Struct({
...
export type DeploymentTriggerCreateInput =
  typeof DeploymentTriggerCreateInput.Type;

// Output Schema (GraphQL selection set)
export const DeploymentTriggerCreateOutput = Schema.Struct({
...
export type DeploymentTriggerCreateOutput =
  typeof DeploymentTriggerCreateOutput.Type;

/**
 * Creates a deployment trigger.
 */
export const deploymentTriggerCreate = API.make(() => ({
  inputSchema: DeploymentTriggerCreateInput,
  outputSchema: DeploymentTriggerCreateOutput,
}));
