...
export const NotificationDeliveriesInput = Schema.Struct({
...
export type NotificationDeliveriesInput =
  typeof NotificationDeliveriesInput.Type;

// Output Schema (GraphQL selection set)
export const NotificationDeliveriesOutput = Schema.Struct({
  edges: Schema.Array(
    Schema.Struct({
...
export type NotificationDeliveriesOutput =
  typeof NotificationDeliveriesOutput.Type;

/**
 * Gets notification deliveries for the authenticated user
 */
export const notificationDeliveries = API.make(() => ({
  inputSchema: NotificationDeliveriesInput,
  outputSchema: NotificationDeliveriesOutput,
}));
