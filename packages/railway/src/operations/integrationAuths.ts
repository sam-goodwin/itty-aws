...
export const IntegrationAuthsInput = Schema.Struct({
...
export type IntegrationAuthsInput = typeof IntegrationAuthsInput.Type;

// Output Schema (GraphQL selection set)
export const IntegrationAuthsOutput = Schema.Struct({
  edges: Schema.Array(
    Schema.Struct({
...
export type IntegrationAuthsOutput = typeof IntegrationAuthsOutput.Type;

/**
 * Get all integration auths for a user
 */
export const integrationAuths = API.make(() => ({
  inputSchema: IntegrationAuthsInput,
  outputSchema: IntegrationAuthsOutput,
}));
