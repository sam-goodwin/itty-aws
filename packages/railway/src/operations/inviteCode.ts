...
export const InviteCodeInput = Schema.Struct({
  code: Schema.String,
}).pipe(
...
export type InviteCodeInput = typeof InviteCodeInput.Type;

// Output Schema (GraphQL selection set)
export const InviteCodeOutput = Schema.Struct({
  code: Schema.String,
  ...
  projectId: Schema.String,
  role: Schema.Literals(["ADMIN", "MEMBER", "VIEWER"]),
}).pipe(T.ResponsePath("inviteCode"));
export type InviteCodeOutput = typeof InviteCodeOutput.Type;

/**
 * Get an invite code by the code
 */
export const inviteCode = API.make(() => ({
  inputSchema: InviteCodeInput,
  outputSchema: InviteCodeOutput,
}));
