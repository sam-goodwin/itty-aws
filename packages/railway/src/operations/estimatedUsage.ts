...
export const EstimatedUsageInput = Schema.Struct({
...
export type EstimatedUsageInput = typeof EstimatedUsageInput.Type;

// Output Schema (GraphQL selection set)
export const EstimatedUsageOutput = Schema.Array(
  Schema.Struct({
...
export type EstimatedUsageOutput = typeof EstimatedUsageOutput.Type;
 ...
 */
export const estimatedUsage = API.make(() => ({
  inputSchema: EstimatedUsageInput,
  outputSchema: EstimatedUsageOutput,
}));
