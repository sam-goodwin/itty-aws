...
// Input Schema
export interface QueueDeployRequestInput {
  organization: string;
  database: string;
  number: number;
  instant_ddl?: boolean;
...
export const QueueDeployRequestInput =
  ...
  ) as unknown as Schema.Codec<QueueDeployRequestInput>;

// Output Schema
export interface QueueDeployRequestOutput {
  id: string;
  number: number;
...
export const QueueDeployRequestOutput =
  ...
  }) as unknown as Schema.Codec<QueueDeployRequestOutput>;
