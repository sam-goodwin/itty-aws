...
// Input Schema
export const WorkflowReverseCutoverInput = /*@__PURE__*/ Schema.Struct({
...
export type WorkflowReverseCutoverInput =
  typeof WorkflowReverseCutoverInput.Type;

// Output Schema
export const WorkflowReverseCutoverOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.String,
  name: Schema.String,
...
export type WorkflowReverseCutoverOutput =
  typeof WorkflowReverseCutoverOutput.Type;
