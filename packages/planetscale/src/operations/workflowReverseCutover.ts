...
// Input Schema
export interface WorkflowReverseCutoverInput {
  organization: string;
  database: string;
  number: number;
}
export const WorkflowReverseCutoverInput =
  ...
  ) as unknown as Schema.Codec<WorkflowReverseCutoverInput>;

// Output Schema
export interface WorkflowReverseCutoverOutput {
  id: string;
  name: string;
  number: number;
  state:
...
export const WorkflowReverseCutoverOutput =
  ...
  }) as unknown as Schema.Codec<WorkflowReverseCutoverOutput>;
