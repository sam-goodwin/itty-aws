...
// Input Schema
export const ListMaintenanceWindowsInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ListMaintenanceWindowsOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const listMaintenanceWindows = /*@__PURE__*/ API.makePaginated(() => ({
