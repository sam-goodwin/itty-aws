...
// Input Schema
export const ListDatabasePostgresCidrsInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ListDatabasePostgresCidrsOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const listDatabasePostgresCidrs = /*@__PURE__*/ API.makePaginated(
  () => ({
