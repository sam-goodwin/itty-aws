...
// Input Schema
export const ListDatabaseRegionsInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ListDatabaseRegionsOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const listDatabaseRegions = /*@__PURE__*/ API.makePaginated(() => ({
