...
// Input Schema
export const DismissSchemaRecommendationInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const DismissSchemaRecommendationOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.String,
 ...
 */
export const dismissSchemaRecommendation = /*@__PURE__*/ API.make(() => ({
