...
// Input Schema
export interface DisableSafeMigrationsInput {
  organization: string;
  database: string;
  branch: string;
}
export const DisableSafeMigrationsInput =
  ...
  ) as unknown as Schema.Codec<DisableSafeMigrationsInput>;

// Output Schema
export interface DisableSafeMigrationsOutput {
  id: string;
  name: string;
  created_at: string;
  updated_at: string;
...
export const DisableSafeMigrationsOutput =
  /*@__PURE__*/ Schema.Struct({
    id: Schema.String,
    name: Schema.String,
  ...
  }) as unknown as Schema.Codec<DisableSafeMigrationsOutput>;
 ...
 */
export const disableSafeMigrations = /*@__PURE__*/ API.make(() => ({
