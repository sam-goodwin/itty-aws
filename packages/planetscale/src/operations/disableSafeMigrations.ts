...
// Input Schema
export const DisableSafeMigrationsInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const DisableSafeMigrationsOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.String,
  name: Schema.String,
...
export type DisableSafeMigrationsOutput =
  typeof DisableSafeMigrationsOutput.Type;
