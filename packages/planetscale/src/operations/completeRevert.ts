...
// Input Schema
export interface CompleteRevertInput {
  organization: string;
  database: string;
  number: number;
}
...
) as unknown as Schema.Codec<CompleteRevertInput>;

// Output Schema
export interface CompleteRevertOutput {
  id: string;
  number: number;
...
}) as unknown as Schema.Codec<CompleteRevertOutput>;
