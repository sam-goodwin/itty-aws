...
// Input Schema
export interface CompleteGatedDeployRequestInput {
  organization: string;
  database: string;
  number: number;
}
export const CompleteGatedDeployRequestInput =
  ...
  ) as unknown as Schema.Codec<CompleteGatedDeployRequestInput>;

// Output Schema
export interface CompleteGatedDeployRequestOutput {
  id: string;
  number: number;
...
export const CompleteGatedDeployRequestOutput =
  ...
  }) as unknown as Schema.Codec<CompleteGatedDeployRequestOutput>;
