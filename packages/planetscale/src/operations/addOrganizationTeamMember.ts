...
// Input Schema
export const AddOrganizationTeamMemberInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const AddOrganizationTeamMemberOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.String,
  user: Schema.Struct({
    id: Schema.String,
 ...
 */
export const addOrganizationTeamMember = /*@__PURE__*/ API.make(() => ({
