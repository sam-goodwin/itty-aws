...
// Input Schema
export const ListBouncerResizeRequestsInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ListBouncerResizeRequestsOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const listBouncerResizeRequests = /*@__PURE__*/ API.makePaginated(
  () => ({
