...
// Input Schema
export const UpdateDeployRequestThrottlerInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const UpdateDeployRequestThrottlerOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const updateDeployRequestThrottler = /*@__PURE__*/ API.make(() => ({
