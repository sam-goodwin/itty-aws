...
// Input Schema
export interface ListDeployRequestsInput {
  organization: string;
  database: string;
  state?: string;
  branch?: string;
...
export const ListDeployRequestsInput =
  ...
  ) as unknown as Schema.Codec<ListDeployRequestsInput>;

// Output Schema
export interface ListDeployRequestsOutput {
  type: string;
  current_page: number;
...
export const ListDeployRequestsOutput =
  ...
  }) as unknown as Schema.Codec<ListDeployRequestsOutput>;
