...
// Input Schema
export const ListBackupPoliciesInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ListBackupPoliciesOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const listBackupPolicies = /*@__PURE__*/ API.makePaginated(() => ({
