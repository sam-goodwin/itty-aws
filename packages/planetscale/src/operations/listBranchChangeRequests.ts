...
// Input Schema
export const ListBranchChangeRequestsInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ListBranchChangeRequestsOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const listBranchChangeRequests = /*@__PURE__*/ API.makePaginated(() => ({
