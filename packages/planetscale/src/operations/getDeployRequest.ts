...
// Input Schema
export interface GetDeployRequestInput {
  organization: string;
  database: string;
  number: number;
}
export const GetDeployRequestInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
) as unknown as Schema.Codec<GetDeployRequestInput>;

// Output Schema
export interface GetDeployRequestOutput {
  id: string;
  number: number;
...
export const GetDeployRequestOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct(
  {
    id: Schema.String,
...
) as unknown as Schema.Codec<GetDeployRequestOutput>;
 ...
 */
export const getDeployRequest = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: GetDeployRequestInput,
  outputSchema: GetDeployRequestOutput,
