...
// Input Schema
export interface CancelDeployRequestInput {
  organization: string;
  database: string;
  number: number;
}
export const CancelDeployRequestInput =
  ...
  ) as unknown as Schema.Codec<CancelDeployRequestInput>;

// Output Schema
export interface CancelDeployRequestOutput {
  id: string;
  number: number;
...
export const CancelDeployRequestOutput =
  ...
  }) as unknown as Schema.Codec<CancelDeployRequestOutput>;
