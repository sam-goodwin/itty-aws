...
// Input Schema
export interface GetDefaultRoleInput {
  organization: string;
  database: string;
  branch: string;
}
...
) as unknown as Schema.Codec<GetDefaultRoleInput>;

// Output Schema
export interface GetDefaultRoleOutput {
  id: string;
  name: string;
...
}) as unknown as Schema.Codec<GetDefaultRoleOutput>;
