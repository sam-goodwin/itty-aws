...
// Input Schema
export interface GetBranchQueryErrorInput {
  organization: string;
  database: string;
  branch: string;
  fingerprint: string;
...
export const GetBranchQueryErrorInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({
      method: "GET",
      path: "/organizations/{organization}/databases/{database}/branches/{branch}/insights/errors/{fingerprint}",
    }),
  ) as unknown as Schema.Codec<GetBranchQueryErrorInput>;

// Output Schema
export interface GetBranchQueryErrorOutput {
  type: string;
  current_page: number;
...
export const GetBranchQueryErrorOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    type: Schema.String,
  ...
  }) as unknown as Schema.Codec<GetBranchQueryErrorOutput>;
 ...
 * @param from - Start time for filtering queries (ISO 8601 timestamp)
 * @param to - End time for filtering queries (ISO 8601 timestamp)
 * @param period - Time period for filtering queries (e.g., '1h', '24h')
 * @param page - If provided, specifies the page offset of returned results
 * @param per_page - If provided, specifies the number of returned results
 */
export const getBranchQueryError =
  /*@__PURE__*/ /*#__PURE__*/ API.makePaginated(() => ({
    inputSchema: GetBranchQueryErrorInput,
    outputSchema: GetBranchQueryErrorOutput,
