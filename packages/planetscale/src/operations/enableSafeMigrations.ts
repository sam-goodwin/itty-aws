...
// Input Schema
export interface EnableSafeMigrationsInput {
  organization: string;
  database: string;
  branch: string;
}
export const EnableSafeMigrationsInput =
  ...
  ) as unknown as Schema.Codec<EnableSafeMigrationsInput>;

// Output Schema
export interface EnableSafeMigrationsOutput {
  id: string;
  name: string;
  created_at: string;
  updated_at: string;
...
export const EnableSafeMigrationsOutput =
  ...
  }) as unknown as Schema.Codec<EnableSafeMigrationsOutput>;
