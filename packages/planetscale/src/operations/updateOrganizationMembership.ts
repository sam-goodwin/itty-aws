...
// Input Schema
export const UpdateOrganizationMembershipInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const UpdateOrganizationMembershipOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.String,
  user: Schema.Struct({
    id: Schema.String,
 ...
 */
export const updateOrganizationMembership = /*@__PURE__*/ API.make(() => ({
