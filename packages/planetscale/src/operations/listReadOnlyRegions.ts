...
// Input Schema
export const ListReadOnlyRegionsInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ListReadOnlyRegionsOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const listReadOnlyRegions = /*@__PURE__*/ API.makePaginated(() => ({
