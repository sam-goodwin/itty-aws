...
// Input Schema
export const ListDeployRequestReviewsInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ListDeployRequestReviewsOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const listDeployRequestReviews = /*@__PURE__*/ API.makePaginated(() => ({
