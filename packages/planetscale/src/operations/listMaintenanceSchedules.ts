...
// Input Schema
export const ListMaintenanceSchedulesInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ListMaintenanceSchedulesOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const listMaintenanceSchedules = /*@__PURE__*/ API.makePaginated(() => ({
