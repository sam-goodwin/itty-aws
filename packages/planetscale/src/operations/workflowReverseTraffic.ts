...
// Input Schema
export interface WorkflowReverseTrafficInput {
  organization: string;
  database: string;
  number: number;
}
export const WorkflowReverseTrafficInput =
  ...
  ) as unknown as Schema.Codec<WorkflowReverseTrafficInput>;

// Output Schema
export interface WorkflowReverseTrafficOutput {
  id: string;
  name: string;
  number: number;
  state:
...
export const WorkflowReverseTrafficOutput =
  ...
  }) as unknown as Schema.Codec<WorkflowReverseTrafficOutput>;
