...
// Input Schema
export const CompleteErroredDeployInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const CompleteErroredDeployOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.String,
 ...
 */
export const completeErroredDeploy = /*@__PURE__*/ API.make(() => ({
