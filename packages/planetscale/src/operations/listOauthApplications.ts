...
// Input Schema
export const ListOauthApplicationsInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ListOauthApplicationsOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const listOauthApplications = /*@__PURE__*/ API.makePaginated(() => ({
