...
// Input Schema
export const ListOrganizationTeamMembersInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ListOrganizationTeamMembersOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const listOrganizationTeamMembers = /*@__PURE__*/ API.makePaginated(
  () => ({
