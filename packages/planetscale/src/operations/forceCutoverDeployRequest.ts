...
// Input Schema
export interface ForceCutoverDeployRequestInput {
  organization: string;
  database: string;
  number: number;
}
export const ForceCutoverDeployRequestInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({
      method: "POST",
      path: "/organizations/{organization}/databases/{database}/deploy-requests/{number}/force-cutover",
    }),
  ) as unknown as Schema.Codec<ForceCutoverDeployRequestInput>;

// Output Schema
export interface ForceCutoverDeployRequestOutput {
  id: string;
  number: number;
...
export const ForceCutoverDeployRequestOutput =
  ...
  }) as unknown as Schema.Codec<ForceCutoverDeployRequestOutput>;
