...
// Input Schema
export const GetQueryPatternsReportStatusInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const GetQueryPatternsReportStatusOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.String,
 ...
 */
export const getQueryPatternsReportStatus = /*@__PURE__*/ API.make(() => ({
