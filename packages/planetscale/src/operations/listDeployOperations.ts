...
// Input Schema
export const ListDeployOperationsInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ListDeployOperationsOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const listDeployOperations = /*@__PURE__*/ API.makePaginated(() => ({
