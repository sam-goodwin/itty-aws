...
// Input Schema
export interface CloseDeployRequestInput {
  organization: string;
  database: string;
  number: number;
  state?: "closed";
...
export const CloseDeployRequestInput =
  ...
  ) as unknown as Schema.Codec<CloseDeployRequestInput>;

// Output Schema
export interface CloseDeployRequestOutput {
  id: string;
  number: number;
...
export const CloseDeployRequestOutput =
  ...
  }) as unknown as Schema.Codec<CloseDeployRequestOutput>;
