...
// Input Schema
export const ListOrganizationTeamsInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ListOrganizationTeamsOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const listOrganizationTeams = /*@__PURE__*/ API.makePaginated(() => ({
