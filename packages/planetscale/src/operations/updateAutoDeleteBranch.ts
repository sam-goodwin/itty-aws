...
// Input Schema
export interface UpdateAutoDeleteBranchInput {
  organization: string;
  database: string;
  number: number;
  enable?: boolean;
...
export const UpdateAutoDeleteBranchInput =
  ...
  ) as unknown as Schema.Codec<UpdateAutoDeleteBranchInput>;

// Output Schema
export interface UpdateAutoDeleteBranchOutput {
  id: string;
  number: number;
...
export const UpdateAutoDeleteBranchOutput =
  ...
  }) as unknown as Schema.Codec<UpdateAutoDeleteBranchOutput>;
