...
// Input Schema
export interface WorkflowSwitchPrimariesInput {
  organization: string;
  database: string;
  number: number;
}
export const WorkflowSwitchPrimariesInput =
  ...
  ) as unknown as Schema.Codec<WorkflowSwitchPrimariesInput>;

// Output Schema
export interface WorkflowSwitchPrimariesOutput {
  id: string;
  name: string;
  number: number;
  state:
...
export const WorkflowSwitchPrimariesOutput =
  ...
  }) as unknown as Schema.Codec<WorkflowSwitchPrimariesOutput>;
