...
// Input Schema
export interface UpdateAutoApplyInput {
  organization: string;
  database: string;
  number: number;
  enable?: boolean;
...
) as unknown as Schema.Codec<UpdateAutoApplyInput>;

// Output Schema
export interface UpdateAutoApplyOutput {
  id: string;
  number: number;
...
}) as unknown as Schema.Codec<UpdateAutoApplyOutput>;
