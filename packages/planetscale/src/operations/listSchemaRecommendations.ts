...
// Input Schema
export const ListSchemaRecommendationsInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ListSchemaRecommendationsOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const listSchemaRecommendations = /*@__PURE__*/ API.makePaginated(
  () => ({
