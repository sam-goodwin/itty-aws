...
// Input Schema
export interface DemoteBranchInput {
  organization: string;
  database: string;
  branch: string;
}
...
) as unknown as Schema.Codec<DemoteBranchInput>;

// Output Schema
export interface DemoteBranchOutput {
  id: string;
  name: string;
  created_at: string;
  updated_at: string;
...
}) as unknown as Schema.Codec<DemoteBranchOutput>;
