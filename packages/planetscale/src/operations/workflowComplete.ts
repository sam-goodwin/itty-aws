...
export const WorkflowCompleteInput = /*@__PURE__*/ Schema.Struct({
...
) as unknown as Schema.Codec<WorkflowCompleteInput>;
...
export const WorkflowCompleteOutput = /*@__PURE__*/ Schema.Struct({
  id: Schema.String,
  name: Schema.String,
...
}) as unknown as Schema.Codec<WorkflowCompleteOutput>;
 ...
 */
export const workflowComplete = /*@__PURE__*/ API.make(() => ({
