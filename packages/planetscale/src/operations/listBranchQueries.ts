...
// Input Schema
export interface ListBranchQueriesInput {
  organization: string;
  database: string;
  branch: string;
  q?: string;
...
export const ListBranchQueriesInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct(
  {
...
) as unknown as Schema.Codec<ListBranchQueriesInput>;

// Output Schema
export interface ListBranchQueriesOutput {
  type: string;
  current_page: number;
...
export const ListBranchQueriesOutput =
  ...
  }) as unknown as Schema.Codec<ListBranchQueriesOutput>;
 ...
 */
export const listBranchQueries = /*@__PURE__*/ /*#__PURE__*/ API.makePaginated(
  () => ({
    inputSchema: ListBranchQueriesInput,
    outputSchema: ListBranchQueriesOutput,
