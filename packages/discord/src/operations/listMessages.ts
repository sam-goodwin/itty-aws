...
// Input Schema
export const ListMessagesInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  channel_id: Schema.String.pipe(T.PathParam()),
  around: Schema.optional(Schema.String),
  before: Schema.optional(Schema.String),
  after: Schema.optional(Schema.String),
  limit: Schema.optional(Schema.Number),
}).pipe(T.Http({ method: "GET", path: "/channels/{channel_id}/messages" }));
export type ListMessagesInput = typeof ListMessagesInput.Type;

// Output Schema
export const ListMessagesOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Array(
  Schema.Struct({
    type: Schema.Unknown,
...
export type ListMessagesOutput = typeof ListMessagesOutput.Type;
