...
// Input Schema
export const ListThreadMembersInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct(
  {
  ...
  T.Http({ method: "GET", path: "/channels/{channel_id}/thread-members" }),
);
export type ListThreadMembersInput = typeof ListThreadMembersInput.Type;

// Output Schema
export const ListThreadMembersOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Array(
  Schema.Struct({
    id: Schema.String,
...
export type ListThreadMembersOutput = typeof ListThreadMembersOutput.Type;

// The operation
export const listThreadMembers = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: ListThreadMembersInput,
  outputSchema: ListThreadMembersOutput,
