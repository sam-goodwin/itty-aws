...
// Input Schema
export const UpdateMessageInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type UpdateMessageInput = typeof UpdateMessageInput.Type;

// Output Schema
export const UpdateMessageOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  type: Schema.Unknown,
...
export type UpdateMessageOutput = typeof UpdateMessageOutput.Type;

// The operation
export const updateMessage = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: UpdateMessageInput,
  outputSchema: UpdateMessageOutput,
