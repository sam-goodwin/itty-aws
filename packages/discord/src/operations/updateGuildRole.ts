...
// Input Schema
export const UpdateGuildRoleInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  T.Http({ method: "PATCH", path: "/guilds/{guild_id}/roles/{role_id}" }),
);
export type UpdateGuildRoleInput = typeof UpdateGuildRoleInput.Type;

// Output Schema
export const UpdateGuildRoleOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String,
  name: Schema.String,
...
export type UpdateGuildRoleOutput = typeof UpdateGuildRoleOutput.Type;

// The operation
export const updateGuildRole = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: UpdateGuildRoleInput,
  outputSchema: UpdateGuildRoleOutput,
