...
// Input Schema
export const GetMyUserInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct(
  {},
).pipe(T.Http({ method: "GET", path: "/users/@me" }));
export type GetMyUserInput = typeof GetMyUserInput.Type;

// Output Schema
export const GetMyUserOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String,
...
export type GetMyUserOutput = typeof GetMyUserOutput.Type;

// The operation
export const getMyUser = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: GetMyUserInput,
  outputSchema: GetMyUserOutput,
