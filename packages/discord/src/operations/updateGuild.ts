...
// Input Schema
export const UpdateGuildInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  guild_id: Schema.String.pipe(T.PathParam()),
  name: Schema.optional(Schema.String),
  description: Schema.optional(Schema.NullOr(Schema.String)),
  region: Schema.optional(Schema.NullOr(Schema.String)),
  icon: Schema.optional(Schema.NullOr(Schema.String)),
  verification_level: Schema.optional(Schema.Unknown),
  default_message_notifications: Schema.optional(Schema.Unknown),
  explicit_content_filter: Schema.optional(Schema.Unknown),
  preferred_locale: Schema.optional(Schema.Unknown),
  afk_timeout: Schema.optional(Schema.Unknown),
  afk_channel_id: Schema.optional(Schema.Unknown),
  system_channel_id: Schema.optional(Schema.Unknown),
  splash: Schema.optional(Schema.NullOr(Schema.String)),
  banner: Schema.optional(Schema.NullOr(Schema.String)),
  system_channel_flags: Schema.optional(Schema.NullOr(Schema.Number)),
  ...
  rules_channel_id: Schema.optional(Schema.Unknown),
  safety_alerts_channel_id: Schema.optional(Schema.Unknown),
  public_updates_channel_id: Schema.optional(Schema.Unknown),
  premium_progress_bar_enabled: Schema.optional(Schema.NullOr(Schema.Boolean)),
}).pipe(T.Http({ method: "PATCH", path: "/guilds/{guild_id}" }));
export type UpdateGuildInput = typeof UpdateGuildInput.Type;

// Output Schema
export const UpdateGuildOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String,
  name: Schema.String,
...
export type UpdateGuildOutput = typeof UpdateGuildOutput.Type;

// The operation
export const updateGuild = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: UpdateGuildInput,
  outputSchema: UpdateGuildOutput,
