...
// Input Schema
export const CrosspostMessageInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type CrosspostMessageInput = typeof CrosspostMessageInput.Type;

// Output Schema
export const CrosspostMessageOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct(
  {
    type: Schema.Unknown,
...
export type CrosspostMessageOutput = typeof CrosspostMessageOutput.Type;

// The operation
export const crosspostMessage = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: CrosspostMessageInput,
  outputSchema: CrosspostMessageOutput,
