...
// Input Schema
export const UpdateMyApplicationInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    team_id: Schema.optional(Schema.Unknown),
    flags: Schema.optional(Schema.NullOr(Schema.Number)),
    interactions_endpoint_url: Schema.optional(Schema.NullOr(Schema.String)),
    explicit_content_filter: Schema.optional(Schema.Unknown),
    ...
    custom_install_url: Schema.optional(Schema.NullOr(Schema.String)),
    install_params: Schema.optional(Schema.Unknown),
    role_connections_verification_url: Schema.optional(
    ...
    event_webhooks_types: Schema.optional(
      Schema.NullOr(Schema.Array(Schema.Unknown)),
    ),
  }).pipe(T.Http({ method: "PATCH", path: "/applications/@me" }));
export type UpdateMyApplicationInput = typeof UpdateMyApplicationInput.Type;

// Output Schema
export const UpdateMyApplicationOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.String,
    name: Schema.String,
...
export type UpdateMyApplicationOutput = typeof UpdateMyApplicationOutput.Type;

// The operation
export const updateMyApplication = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: UpdateMyApplicationInput,
