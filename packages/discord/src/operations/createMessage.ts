...
// Input Schema
export const CreateMessageInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "POST", path: "/channels/{channel_id}/messages" }));
export type CreateMessageInput = typeof CreateMessageInput.Type;

// Output Schema
export const CreateMessageOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  type: Schema.Unknown,
...
export type CreateMessageOutput = typeof CreateMessageOutput.Type;

// The operation
export const createMessage = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: CreateMessageInput,
  outputSchema: CreateMessageOutput,
