...
// Input Schema
export const GetOriginalWebhookMessageInput =
...
export type GetOriginalWebhookMessageInput =
  typeof GetOriginalWebhookMessageInput.Type;

// Output Schema
export const GetOriginalWebhookMessageOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    type: Schema.Unknown,
...
export type GetOriginalWebhookMessageOutput =
  typeof GetOriginalWebhookMessageOutput.Type;

// The operation
export const getOriginalWebhookMessage = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: GetOriginalWebhookMessageInput,
    outputSchema: GetOriginalWebhookMessageOutput,
