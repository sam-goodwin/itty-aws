...
// Input Schema
export const CreateApplicationCommandInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "POST", path: "/applications/{application_id}/commands" }),
  );
export type CreateApplicationCommandInput =
  typeof CreateApplicationCommandInput.Type;

// Output Schema
export const CreateApplicationCommandOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.String,
...
export type CreateApplicationCommandOutput =
  typeof CreateApplicationCommandOutput.Type;

// The operation
export const createApplicationCommand = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: CreateApplicationCommandInput,
    outputSchema: CreateApplicationCommandOutput,
