...
// Input Schema
export const SearchGuildMembersInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    guild_id: Schema.String.pipe(T.PathParam()),
    limit: Schema.optional(Schema.Number),
    query: Schema.String,
  }).pipe(T.Http({ method: "GET", path: "/guilds/{guild_id}/members/search" }));
export type SearchGuildMembersInput = typeof SearchGuildMembersInput.Type;

// Output Schema
export const SearchGuildMembersOutput =
...
export type SearchGuildMembersOutput = typeof SearchGuildMembersOutput.Type;

// The operation
export const searchGuildMembers = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: SearchGuildMembersInput,
  outputSchema: SearchGuildMembersOutput,
