...
// Input Schema
export const GetGuildMemberInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  guild_id: Schema.String.pipe(T.PathParam()),
  user_id: Schema.String.pipe(T.PathParam()),
}).pipe(
  T.Http({ method: "GET", path: "/guilds/{guild_id}/members/{user_id}" }),
);
export type GetGuildMemberInput = typeof GetGuildMemberInput.Type;

// Output Schema
export const GetGuildMemberOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type GetGuildMemberOutput = typeof GetGuildMemberOutput.Type;

// The operation
export const getGuildMember = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: GetGuildMemberInput,
  outputSchema: GetGuildMemberOutput,
