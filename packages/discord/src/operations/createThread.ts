...
// Input Schema
export const CreateThreadInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  channel_id: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "POST", path: "/channels/{channel_id}/threads" }));
export type CreateThreadInput = typeof CreateThreadInput.Type;

// Output Schema
export const CreateThreadOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String,
  type: Schema.Unknown,
...
export type CreateThreadOutput = typeof CreateThreadOutput.Type;

// The operation
export const createThread = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: CreateThreadInput,
  outputSchema: CreateThreadOutput,
