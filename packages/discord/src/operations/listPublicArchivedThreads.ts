...
// Input Schema
export const ListPublicArchivedThreadsInput =
...
export type ListPublicArchivedThreadsInput =
  typeof ListPublicArchivedThreadsInput.Type;

// Output Schema
export const ListPublicArchivedThreadsOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    first_messages: Schema.optional(
      Schema.Array(
        Schema.Struct({
          type: Schema.Unknown,
                ...
                Schema.Struct({
                  ...
                  member: Schema.optional(
                    Schema.Struct({
                      ...
                      avatar_decoration_data: Schema.optional(Schema.Unknown),
                      banner: Schema.NullOr(Schema.String),
                      communication_disabled_until: Schema.NullOr(
                        Schema.String,
                      ),
                      flags: Schema.Number,
                      joined_at: Schema.String,
                    ...
                    Schema.Struct({
                      ...
                      tags: Schema.optional(
                        Schema.Struct({
                          ...
                          subscription_listing_id: Schema.optional(
                            Schema.String,
                          ),
                          available_for_purchase: Schema.optional(
                            Schema.Unknown,
                          ),
                    ...
                    Schema.Struct({
                      ...
                      application: Schema.optional(
                        Schema.Struct({
                          ...
                          slug: Schema.optional(Schema.String),
                          guild_id: Schema.optional(Schema.String),
                          rpc_origins: Schema.optional(
                            Schema.Array(Schema.String),
                          ),
                          bot_public: Schema.optional(Schema.Boolean),
                          bot_require_code_grant: Schema.optional(
                            Schema.Boolean,
                          ),
                          terms_of_service_url: Schema.optional(Schema.String),
                          privacy_policy_url: Schema.optional(Schema.String),
...
export type ListPublicArchivedThreadsOutput =
  typeof ListPublicArchivedThreadsOutput.Type;

// The operation
export const listPublicArchivedThreads = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: ListPublicArchivedThreadsInput,
    outputSchema: ListPublicArchivedThreadsOutput,
