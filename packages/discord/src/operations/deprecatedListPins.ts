...
// Input Schema
export const DeprecatedListPinsInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    channel_id: Schema.String.pipe(T.PathParam()),
  }).pipe(T.Http({ method: "GET", path: "/channels/{channel_id}/pins" }));
export type DeprecatedListPinsInput = typeof DeprecatedListPinsInput.Type;

// Output Schema
export const DeprecatedListPinsOutput =
                    ...
                    Schema.Struct({
                      ...
                      bot: Schema.optional(
                        Schema.Struct({
                          ...
                          global_name: Schema.NullOr(Schema.String),
                          avatar_decoration_data: Schema.optional(
                            Schema.Unknown,
                          ),
                          collectibles: Schema.optional(Schema.Unknown),
                          primary_guild: Schema.Unknown,
...
export type DeprecatedListPinsOutput = typeof DeprecatedListPinsOutput.Type;

// The operation
export const deprecatedListPins = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: DeprecatedListPinsInput,
  outputSchema: DeprecatedListPinsOutput,
