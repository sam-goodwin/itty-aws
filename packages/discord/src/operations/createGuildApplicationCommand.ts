...
// Input Schema
export const CreateGuildApplicationCommandInput =
...
export type CreateGuildApplicationCommandInput =
  typeof CreateGuildApplicationCommandInput.Type;

// Output Schema
export const CreateGuildApplicationCommandOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.String,
...
export type CreateGuildApplicationCommandOutput =
  typeof CreateGuildApplicationCommandOutput.Type;

// The operation
export const createGuildApplicationCommand =
  /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
    inputSchema: CreateGuildApplicationCommandInput,
    outputSchema: CreateGuildApplicationCommandOutput,
