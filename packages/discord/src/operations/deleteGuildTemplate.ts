...
// Input Schema
export const DeleteGuildTemplateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    guild_id: Schema.String.pipe(T.PathParam()),
    code: Schema.String.pipe(T.PathParam()),
  }).pipe(
    T.Http({ method: "DELETE", path: "/guilds/{guild_id}/templates/{code}" }),
  );
export type DeleteGuildTemplateInput = typeof DeleteGuildTemplateInput.Type;

// Output Schema
export const DeleteGuildTemplateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    code: Schema.String,
    name: Schema.String,
...
export type DeleteGuildTemplateOutput = typeof DeleteGuildTemplateOutput.Type;

// The operation
export const deleteGuildTemplate = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: DeleteGuildTemplateInput,
  outputSchema: DeleteGuildTemplateOutput,
