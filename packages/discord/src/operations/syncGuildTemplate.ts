...
// Input Schema
export const SyncGuildTemplateInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct(
  {
    guild_id: Schema.String.pipe(T.PathParam()),
    code: Schema.String.pipe(T.PathParam()),
  },
).pipe(T.Http({ method: "PUT", path: "/guilds/{guild_id}/templates/{code}" }));
export type SyncGuildTemplateInput = typeof SyncGuildTemplateInput.Type;

// Output Schema
export const SyncGuildTemplateOutput =
...
export type SyncGuildTemplateOutput = typeof SyncGuildTemplateOutput.Type;

// The operation
export const syncGuildTemplate = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: SyncGuildTemplateInput,
  outputSchema: SyncGuildTemplateOutput,
