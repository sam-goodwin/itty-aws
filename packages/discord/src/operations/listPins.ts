...
// Input Schema
export const ListPinsInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  channel_id: Schema.String.pipe(T.PathParam()),
  before: Schema.optional(Schema.String),
  limit: Schema.optional(Schema.Number),
}).pipe(
  T.Http({ method: "GET", path: "/channels/{channel_id}/messages/pins" }),
);
export type ListPinsInput = typeof ListPinsInput.Type;

// Output Schema
export const ListPinsOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  items: Schema.Array(
    Schema.Struct({
      pinned_at: Schema.String,
...
export type ListPinsOutput = typeof ListPinsOutput.Type;

// The operation
export const listPins = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: ListPinsInput,
  outputSchema: ListPinsOutput,
