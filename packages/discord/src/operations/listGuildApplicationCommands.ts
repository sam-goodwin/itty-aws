...
// Input Schema
export const ListGuildApplicationCommandsInput =
...
export type ListGuildApplicationCommandsInput =
  typeof ListGuildApplicationCommandsInput.Type;

// Output Schema
export const ListGuildApplicationCommandsOutput =
...
export type ListGuildApplicationCommandsOutput =
  typeof ListGuildApplicationCommandsOutput.Type;

// The operation
export const listGuildApplicationCommands =
  /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
    inputSchema: ListGuildApplicationCommandsInput,
    outputSchema: ListGuildApplicationCommandsOutput,
