...
// Input Schema
export const CreateLobbyInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "POST", path: "/lobbies" }));
export type CreateLobbyInput = typeof CreateLobbyInput.Type;

// Output Schema
export const CreateLobbyOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String,
...
export type CreateLobbyOutput = typeof CreateLobbyOutput.Type;

// The operation
export const createLobby = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: CreateLobbyInput,
  outputSchema: CreateLobbyOutput,
