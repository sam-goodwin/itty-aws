...
// Input Schema
export const UpdateGuildStickerInput =
...
export type UpdateGuildStickerInput = typeof UpdateGuildStickerInput.Type;

// Output Schema
export const UpdateGuildStickerOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.String,
    name: Schema.String,
    tags: Schema.String,
...
export type UpdateGuildStickerOutput = typeof UpdateGuildStickerOutput.Type;

// The operation
export const updateGuildSticker = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: UpdateGuildStickerInput,
  outputSchema: UpdateGuildStickerOutput,
