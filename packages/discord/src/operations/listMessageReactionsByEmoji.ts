...
// Input Schema
export const ListMessageReactionsByEmojiInput =
...
export type ListMessageReactionsByEmojiInput =
  typeof ListMessageReactionsByEmojiInput.Type;

// Output Schema
export const ListMessageReactionsByEmojiOutput =
...
export type ListMessageReactionsByEmojiOutput =
  typeof ListMessageReactionsByEmojiOutput.Type;

// The operation
export const listMessageReactionsByEmoji = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: ListMessageReactionsByEmojiInput,
    outputSchema: ListMessageReactionsByEmojiOutput,
