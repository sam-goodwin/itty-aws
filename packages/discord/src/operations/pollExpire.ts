...
// Input Schema
export const PollExpireInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type PollExpireInput = typeof PollExpireInput.Type;

// Output Schema
export const PollExpireOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  type: Schema.Unknown,
...
export type PollExpireOutput = typeof PollExpireOutput.Type;

// The operation
export const pollExpire = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: PollExpireInput,
  outputSchema: PollExpireOutput,
