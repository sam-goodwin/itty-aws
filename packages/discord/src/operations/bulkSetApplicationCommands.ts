...
// Input Schema
export const BulkSetApplicationCommandsInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    application_id: Schema.String.pipe(T.PathParam()),
  }).pipe(
    T.Http({ method: "PUT", path: "/applications/{application_id}/commands" }),
  );
export type BulkSetApplicationCommandsInput =
  typeof BulkSetApplicationCommandsInput.Type;

// Output Schema
export const BulkSetApplicationCommandsOutput =
...
export type BulkSetApplicationCommandsOutput =
  typeof BulkSetApplicationCommandsOutput.Type;

// The operation
export const bulkSetApplicationCommands = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: BulkSetApplicationCommandsInput,
    outputSchema: BulkSetApplicationCommandsOutput,
