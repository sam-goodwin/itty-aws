...
// Input Schema
export const EditLobbyInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "PATCH", path: "/lobbies/{lobby_id}" }));
export type EditLobbyInput = typeof EditLobbyInput.Type;

// Output Schema
export const EditLobbyOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String,
...
export type EditLobbyOutput = typeof EditLobbyOutput.Type;

// The operation
export const editLobby = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: EditLobbyInput,
  outputSchema: EditLobbyOutput,
