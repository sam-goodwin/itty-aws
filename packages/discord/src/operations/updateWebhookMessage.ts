...
// Input Schema
export const UpdateWebhookMessageInput =
...
export type UpdateWebhookMessageInput = typeof UpdateWebhookMessageInput.Type;

// Output Schema
export const UpdateWebhookMessageOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    type: Schema.Unknown,
...
export type UpdateWebhookMessageOutput = typeof UpdateWebhookMessageOutput.Type;

// The operation
export const updateWebhookMessage = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: UpdateWebhookMessageInput,
