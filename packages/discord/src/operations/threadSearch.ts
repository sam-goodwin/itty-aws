...
// Input Schema
export const ThreadSearchInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  channel_id: Schema.String.pipe(T.PathParam()),
  name: Schema.optional(Schema.String),
  slop: Schema.optional(Schema.Number),
  min_id: Schema.optional(Schema.String),
  max_id: Schema.optional(Schema.String),
  tag: Schema.optional(Schema.String),
  tag_setting: Schema.optional(Schema.String),
  ...
  T.Http({ method: "GET", path: "/channels/{channel_id}/threads/search" }),
);
export type ThreadSearchInput = typeof ThreadSearchInput.Type;

// Output Schema
export const ThreadSearchOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type ThreadSearchOutput = typeof ThreadSearchOutput.Type;

// The operation
export const threadSearch = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: ThreadSearchInput,
  outputSchema: ThreadSearchOutput,
