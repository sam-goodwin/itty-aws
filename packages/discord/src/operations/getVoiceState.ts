...
// Input Schema
export const GetVoiceStateInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  guild_id: Schema.String.pipe(T.PathParam()),
  user_id: Schema.String.pipe(T.PathParam()),
}).pipe(
  T.Http({ method: "GET", path: "/guilds/{guild_id}/voice-states/{user_id}" }),
);
export type GetVoiceStateInput = typeof GetVoiceStateInput.Type;

// Output Schema
export const GetVoiceStateOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type GetVoiceStateOutput = typeof GetVoiceStateOutput.Type;

// The operation
export const getVoiceState = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: GetVoiceStateInput,
  outputSchema: GetVoiceStateOutput,
