...
// Input Schema
export const EditLobbyChannelLinkInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    lobby_id: Schema.String.pipe(T.PathParam()),
    channel_id: Schema.optional(Schema.Unknown),
  }).pipe(
    T.Http({ method: "PATCH", path: "/lobbies/{lobby_id}/channel-linking" }),
  );
export type EditLobbyChannelLinkInput = typeof EditLobbyChannelLinkInput.Type;

// Output Schema
export const EditLobbyChannelLinkOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.String,
...
export type EditLobbyChannelLinkOutput = typeof EditLobbyChannelLinkOutput.Type;

// The operation
export const editLobbyChannelLink = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: EditLobbyChannelLinkInput,
    outputSchema: EditLobbyChannelLinkOutput,
