...
// Input Schema
export const GetWebhookMessageInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct(
  {
...
export type GetWebhookMessageInput = typeof GetWebhookMessageInput.Type;

// Output Schema
export const GetWebhookMessageOutput =
...
export type GetWebhookMessageOutput = typeof GetWebhookMessageOutput.Type;

// The operation
export const getWebhookMessage = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: GetWebhookMessageInput,
  outputSchema: GetWebhookMessageOutput,
