...
// Input Schema
export const UpdateGuildTemplateInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    T.Http({ method: "PATCH", path: "/guilds/{guild_id}/templates/{code}" }),
  );
export type UpdateGuildTemplateInput = typeof UpdateGuildTemplateInput.Type;

// Output Schema
export const UpdateGuildTemplateOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    code: Schema.String,
    name: Schema.String,
...
export type UpdateGuildTemplateOutput = typeof UpdateGuildTemplateOutput.Type;

// The operation
export const updateGuildTemplate = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: UpdateGuildTemplateInput,
  outputSchema: UpdateGuildTemplateOutput,
