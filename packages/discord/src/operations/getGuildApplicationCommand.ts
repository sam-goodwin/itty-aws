...
// Input Schema
export const GetGuildApplicationCommandInput =
...
export type GetGuildApplicationCommandInput =
  typeof GetGuildApplicationCommandInput.Type;

// Output Schema
export const GetGuildApplicationCommandOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    id: Schema.String,
...
export type GetGuildApplicationCommandOutput =
  typeof GetGuildApplicationCommandOutput.Type;

// The operation
export const getGuildApplicationCommand = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: GetGuildApplicationCommandInput,
    outputSchema: GetGuildApplicationCommandOutput,
