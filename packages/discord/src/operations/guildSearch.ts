...
// Input Schema
export const GuildSearchInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  mentions_role_id: Schema.optional(Schema.String),
  replied_to_user_id: Schema.optional(Schema.String),
  replied_to_message_id: Schema.optional(Schema.String),
  mention_everyone: Schema.optional(Schema.Boolean),
  min_id: Schema.optional(Schema.String),
  max_id: Schema.optional(Schema.String),
  limit: Schema.optional(Schema.Number),
  offset: Schema.optional(Schema.Number),
  has: Schema.optional(Schema.String),
  link_hostname: Schema.optional(Schema.String),
  embed_provider: Schema.optional(Schema.String),
  embed_type: Schema.optional(Schema.String),
  attachment_extension: Schema.optional(Schema.String),
  attachment_filename: Schema.optional(Schema.String),
  pinned: Schema.optional(Schema.Boolean),
  include_nsfw: Schema.optional(Schema.Boolean),
  channel_id: Schema.optional(Schema.String),
}).pipe(T.Http({ method: "GET", path: "/guilds/{guild_id}/messages/search" }));
export type GuildSearchInput = typeof GuildSearchInput.Type;

// Output Schema
export const GuildSearchOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  doing_deep_historical_index: Schema.Boolean,
  ...
  documents_indexed: Schema.optional(Schema.NullOr(Schema.Number)),
});
export type GuildSearchOutput = typeof GuildSearchOutput.Type;

// The operation
export const guildSearch = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: GuildSearchInput,
  outputSchema: GuildSearchOutput,
