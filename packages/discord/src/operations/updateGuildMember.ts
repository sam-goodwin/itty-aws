...
// Input Schema
export const UpdateGuildMemberInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct(
  {
  ...
  T.Http({ method: "PATCH", path: "/guilds/{guild_id}/members/{user_id}" }),
);
export type UpdateGuildMemberInput = typeof UpdateGuildMemberInput.Type;

// Output Schema
export const UpdateGuildMemberOutput =
...
export type UpdateGuildMemberOutput = typeof UpdateGuildMemberOutput.Type;

// The operation
export const updateGuildMember = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: UpdateGuildMemberInput,
  outputSchema: UpdateGuildMemberOutput,
