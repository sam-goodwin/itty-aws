...
// Input Schema
export const GetGuildTemplateInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  code: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "GET", path: "/guilds/templates/{code}" }));
export type GetGuildTemplateInput = typeof GetGuildTemplateInput.Type;

// Output Schema
export const GetGuildTemplateOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct(
  {
    code: Schema.String,
    name: Schema.String,
...
export type GetGuildTemplateOutput = typeof GetGuildTemplateOutput.Type;

// The operation
export const getGuildTemplate = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
  inputSchema: GetGuildTemplateInput,
  outputSchema: GetGuildTemplateOutput,
