...
// Input Schema
export const CreateProjectBranchDatabaseInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "POST", path: "/projects/{project_id}/branches/{branch_id}/databases" }));
export type CreateProjectBranchDatabaseInput = typeof CreateProjectBranchDatabaseInput.Type;

// Output Schema
export const CreateProjectBranchDatabaseOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  database: Schema.Struct({
    id: Schema.Number,
...
export type CreateProjectBranchDatabaseOutput = typeof CreateProjectBranchDatabaseOutput.Type;
