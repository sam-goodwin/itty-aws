...
// Input Schema
export const ListProjectEndpointsInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ListProjectEndpointsOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const listProjectEndpoints = /*@__PURE__*/ API.make(() => ({
