...
// Input Schema
export const ResetProjectBranchRolePasswordInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  project_id: Schema.String.pipe(T.PathParam()),
  branch_id: Schema.String.pipe(T.PathParam()),
  role_name: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "POST", path: "/projects/{project_id}/branches/{branch_id}/roles/{role_name}/reset_password" }));
export type ResetProjectBranchRolePasswordInput = typeof ResetProjectBranchRolePasswordInput.Type;

// Output Schema
export const ResetProjectBranchRolePasswordOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  role: Schema.Struct({
...
export type ResetProjectBranchRolePasswordOutput = typeof ResetProjectBranchRolePasswordOutput.Type;
 ...
 */
export const resetProjectBranchRolePassword = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
