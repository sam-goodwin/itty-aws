...
// Input Schema
export const CreateProjectBranchAnonymizedInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const CreateProjectBranchAnonymizedOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const createProjectBranchAnonymized = /*@__PURE__*/ API.make(() => ({
