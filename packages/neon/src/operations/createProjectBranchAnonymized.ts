...
// Input Schema
export const CreateProjectBranchAnonymizedInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  project_id: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "POST", path: "/projects/{project_id}/branch_anonymized" }));
export type CreateProjectBranchAnonymizedInput = typeof CreateProjectBranchAnonymizedInput.Type;

// Output Schema
export const CreateProjectBranchAnonymizedOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type CreateProjectBranchAnonymizedOutput = typeof CreateProjectBranchAnonymizedOutput.Type;
 ...
 */
export const createProjectBranchAnonymized = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
