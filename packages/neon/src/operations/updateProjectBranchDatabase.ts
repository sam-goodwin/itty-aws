...
// Input Schema
export const UpdateProjectBranchDatabaseInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
// Output Schema
export const UpdateProjectBranchDatabaseOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  database: Schema.Struct({
    id: Schema.Number,
