...
// Input Schema
export const GetCurrentUserInfoInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({

}).pipe(T.Http({ method: "GET", path: "/users/me" }));
export type GetCurrentUserInfoInput = typeof GetCurrentUserInfoInput.Type;

// Output Schema
export const GetCurrentUserInfoOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  active_seconds_limit: Schema.Number,
  billing_account: Schema.optional(Schema.Struct({
    state: Schema.Literals(["UNKNOWN", "active", "suspended", "deactivated", "deleted"]),
    payment_source: Schema.Struct({
      type: Schema.String,
      card: Schema.optional(Schema.Struct({
        last4: Schema.String,
        brand: Schema.optional(Schema.Literals(["amex", "diners", "discover", "jcb", "mastercard", "unionpay", "unknown", "visa"])),
    ...
    payment_method: Schema.Literals(["UNKNOWN", "none", "stripe", "direct_payment", "aws_mp", "azure_mp", "vercel_mp", "staff", "trial", "sponsorship"]),
  ...
  auth_accounts: Schema.Array(Schema.Struct({
    ...
    login: Schema.String,
    name: Schema.String,
    provider: Schema.Literals(["github", "google", "hasura", "microsoft", "microsoftv2", "vercelmp", "keycloak"]),
  })),
  email: Schema.String,
  id: Schema.String,
  image: Schema.String,
