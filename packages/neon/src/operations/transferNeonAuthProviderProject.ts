...
// Input Schema
export const TransferNeonAuthProviderProjectInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
// Output Schema
export const TransferNeonAuthProviderProjectOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  url: Schema.String,
});
