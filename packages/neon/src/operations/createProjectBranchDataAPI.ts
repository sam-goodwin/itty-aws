...
// Input Schema
export const CreateProjectBranchDataAPIInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "POST", path: "/projects/{project_id}/branches/{branch_id}/data-api/{database_name}" }));
export type CreateProjectBranchDataAPIInput = typeof CreateProjectBranchDataAPIInput.Type;

// Output Schema
export const CreateProjectBranchDataAPIOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  url: Schema.String,
});
export type CreateProjectBranchDataAPIOutput = typeof CreateProjectBranchDataAPIOutput.Type;
