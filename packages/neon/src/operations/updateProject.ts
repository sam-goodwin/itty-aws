...
export const UpdateProjectInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  project: Schema.Struct({
    settings: Schema.optional(Schema.Struct({
      ...
      audit_log_level: Schema.optional(Schema.Literals(["base", "extended", "full"])),
...
export const UpdateProjectOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  project: Schema.Struct({
    ...
    owner: Schema.optional(Schema.Struct({
      ...
      subscription_type: Schema.Literals(["UNKNOWN", "direct_sales", "direct_sales_v3", "aws_marketplace", "free_v2", "free_v3", "launch", "launch_v3", "scale", "scale_v3", "business", "vercel_pg_legacy"]),
    })),
