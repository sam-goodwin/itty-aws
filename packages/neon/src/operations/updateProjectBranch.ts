...
// Input Schema
export const UpdateProjectBranchInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "PATCH", path: "/projects/{project_id}/branches/{branch_id}" }));
export type UpdateProjectBranchInput = typeof UpdateProjectBranchInput.Type;

// Output Schema
export const UpdateProjectBranchOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  branch: Schema.Struct({
    id: Schema.String,
