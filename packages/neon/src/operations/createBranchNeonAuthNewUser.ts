...
// Input Schema
export const CreateBranchNeonAuthNewUserInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
// Output Schema
export const CreateBranchNeonAuthNewUserOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.String,
});
