...
// Input Schema
export const TransferProjectsFromOrgToOrgInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const TransferProjectsFromOrgToOrgOutput = /*@__PURE__*/ Schema.Struct(
  {},
);
 ...
 */
export const transferProjectsFromOrgToOrg = /*@__PURE__*/ API.make(() => ({
