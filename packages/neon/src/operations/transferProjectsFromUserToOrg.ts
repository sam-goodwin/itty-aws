...
// Input Schema
export const TransferProjectsFromUserToOrgInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const TransferProjectsFromUserToOrgOutput = /*@__PURE__*/ Schema.Struct(
  {},
);
 ...
 */
export const transferProjectsFromUserToOrg = /*@__PURE__*/ API.make(() => ({
