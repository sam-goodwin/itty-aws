...
// Input Schema
export interface DeleteProjectBranchDatabaseInput {
  project_id: string;
  branch_id: string;
...
export const DeleteProjectBranchDatabaseInput =
  ...
  ) as unknown as Schema.Codec<DeleteProjectBranchDatabaseInput>;

// Output Schema
export interface DeleteProjectBranchDatabaseOutput {
  database: {
    id: number;
    branch_id: string;
    name: string;
...
export const DeleteProjectBranchDatabaseOutput =
  ...
  }) as unknown as Schema.Codec<DeleteProjectBranchDatabaseOutput>;
