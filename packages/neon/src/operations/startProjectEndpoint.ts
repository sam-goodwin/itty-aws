...
// Input Schema
export interface StartProjectEndpointInput {
  project_id: string;
  endpoint_id: string;
}
export const StartProjectEndpointInput =
  ...
  ) as unknown as Schema.Codec<StartProjectEndpointInput>;

// Output Schema
export interface StartProjectEndpointOutput {
  endpoint: {
    host: string;
    id: string;
    name?: string;
...
export const StartProjectEndpointOutput =
  ...
  }) as unknown as Schema.Codec<StartProjectEndpointOutput>;
