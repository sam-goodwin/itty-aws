...
// Input Schema
export const SuspendProjectEndpointInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  project_id: Schema.String.pipe(T.PathParam()),
  endpoint_id: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "POST", path: "/projects/{project_id}/endpoints/{endpoint_id}/suspend" }));
export type SuspendProjectEndpointInput = typeof SuspendProjectEndpointInput.Type;

// Output Schema
export const SuspendProjectEndpointOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type SuspendProjectEndpointOutput = typeof SuspendProjectEndpointOutput.Type;
