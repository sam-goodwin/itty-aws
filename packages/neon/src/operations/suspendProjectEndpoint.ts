...
// Input Schema
export const SuspendProjectEndpointInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const SuspendProjectEndpointOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const suspendProjectEndpoint = /*@__PURE__*/ API.make(() => ({
