...
// Input Schema
export interface DeleteProjectEndpointInput {
  project_id: string;
  endpoint_id: string;
}
export const DeleteProjectEndpointInput =
  ...
  ) as unknown as Schema.Codec<DeleteProjectEndpointInput>;

// Output Schema
export interface DeleteProjectEndpointOutput {
  endpoint: {
    host: string;
    id: string;
    name?: string;
...
export const DeleteProjectEndpointOutput =
  ...
  }) as unknown as Schema.Codec<DeleteProjectEndpointOutput>;
