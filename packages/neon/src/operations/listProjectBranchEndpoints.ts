...
// Input Schema
export const ListProjectBranchEndpointsInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  project_id: Schema.String.pipe(T.PathParam()),
  branch_id: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "GET", path: "/projects/{project_id}/branches/{branch_id}/endpoints" }));
export type ListProjectBranchEndpointsInput = typeof ListProjectBranchEndpointsInput.Type;

// Output Schema
export const ListProjectBranchEndpointsOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type ListProjectBranchEndpointsOutput = typeof ListProjectBranchEndpointsOutput.Type;
