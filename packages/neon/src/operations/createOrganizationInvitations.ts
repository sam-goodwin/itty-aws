...
// Input Schema
export const CreateOrganizationInvitationsInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
// Output Schema
export const CreateOrganizationInvitationsOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  invitations: Schema.Array(Schema.Struct({
    id: Schema.String,
    email: Schema.String,
