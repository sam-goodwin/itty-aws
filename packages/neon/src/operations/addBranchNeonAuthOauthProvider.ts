...
// Input Schema
export const AddBranchNeonAuthOauthProviderInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
// Output Schema
export const AddBranchNeonAuthOauthProviderOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  id: Schema.Literals(["google", "github", "microsoft", "vercel"]),
