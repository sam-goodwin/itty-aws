...
// Input Schema
export const AddBranchNeonAuthOauthProviderInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const AddBranchNeonAuthOauthProviderOutput = /*@__PURE__*/ Schema.Struct(
  {
    id: Schema.Literals(["google", "github", "microsoft", "vercel"]),
 ...
 */
export const addBranchNeonAuthOauthProvider = /*@__PURE__*/ API.make(() => ({
