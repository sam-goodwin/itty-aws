...
// Input Schema
export const ListProjectOperationsInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ListProjectOperationsOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const listProjectOperations = /*@__PURE__*/ API.makePaginated(() => ({
