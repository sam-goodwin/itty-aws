...
// Input Schema
export const ListProjectBranchesInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ListProjectBranchesOutput = /*@__PURE__*/ Schema.Struct({
 ...
 */
export const listProjectBranches = /*@__PURE__*/ API.makePaginated(() => ({
