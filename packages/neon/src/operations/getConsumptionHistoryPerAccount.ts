...
// Input Schema
export const GetConsumptionHistoryPerAccountInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  from: Schema.String,
  to: Schema.String,
...
// Output Schema
export const GetConsumptionHistoryPerAccountOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
