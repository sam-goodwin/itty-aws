...
export const ListProjectsOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  applications: Schema.Record(Schema.String, Schema.Array(Schema.Literals(["vercel", "github", "datadog", "opentelemetry"]))),
  integrations: Schema.Record(Schema.String, Schema.Array(Schema.Literals(["vercel", "github", "datadog", "opentelemetry"]))),
});
