...
// Input Schema
export const UpdateNeonAuthWebhookConfigInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const UpdateNeonAuthWebhookConfigOutput = /*@__PURE__*/ Schema.Struct({
  enabled: Schema.Boolean,
  webhook_url: Schema.optional(Schema.String),
  enabled_events: Schema.optional(
    Schema.Array(
 ...
 */
export const updateNeonAuthWebhookConfig = /*@__PURE__*/ API.make(() => ({
