...
// Input Schema
export const GetNeonAuthPluginConfigsInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  project_id: Schema.String.pipe(T.PathParam()),
  branch_id: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "GET", path: "/projects/{project_id}/branches/{branch_id}/auth/plugins" }));
export type GetNeonAuthPluginConfigsInput = typeof GetNeonAuthPluginConfigsInput.Type;

// Output Schema
export const GetNeonAuthPluginConfigsOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  ...
  email_and_password: Schema.optional(Schema.Struct({
    enabled: Schema.Boolean,
  ...
  oauth_providers: Schema.optional(Schema.Array(Schema.Struct({
...
export type GetNeonAuthPluginConfigsOutput = typeof GetNeonAuthPluginConfigsOutput.Type;
