...
// Input Schema
export interface SetDefaultProjectBranchInput {
  project_id: string;
  branch_id: string;
}
export const SetDefaultProjectBranchInput =
  ...
  ) as unknown as Schema.Codec<SetDefaultProjectBranchInput>;

// Output Schema
export interface SetDefaultProjectBranchOutput {
  branch: {
    id: string;
    project_id: string;
    parent_id?: string;
...
export const SetDefaultProjectBranchOutput =
  ...
  }) as unknown as Schema.Codec<SetDefaultProjectBranchOutput>;
