...
// Input Schema
export const RestartProjectEndpointInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  project_id: Schema.String.pipe(T.PathParam()),
  endpoint_id: Schema.String.pipe(T.PathParam()),
}).pipe(T.Http({ method: "POST", path: "/projects/{project_id}/endpoints/{endpoint_id}/restart" }));
export type RestartProjectEndpointInput = typeof RestartProjectEndpointInput.Type;

// Output Schema
export const RestartProjectEndpointOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type RestartProjectEndpointOutput = typeof RestartProjectEndpointOutput.Type;
