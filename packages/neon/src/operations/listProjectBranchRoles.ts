...
// Input Schema
export const ListProjectBranchRolesInput = /*@__PURE__*/ Schema.Struct({
...
// Output Schema
export const ListProjectBranchRolesOutput = /*@__PURE__*/ Schema.Struct({
  roles: Schema.Array(
    Schema.Struct({
 ...
 */
export const listProjectBranchRoles = /*@__PURE__*/ API.make(() => ({
