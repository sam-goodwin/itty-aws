...
// Input Schema
export const UpdateNeonAuthEmailAndPasswordConfigInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "PATCH", path: "/projects/{project_id}/branches/{branch_id}/auth/email_and_password" }));
export type UpdateNeonAuthEmailAndPasswordConfigInput = typeof UpdateNeonAuthEmailAndPasswordConfigInput.Type;

// Output Schema
export const UpdateNeonAuthEmailAndPasswordConfigOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type UpdateNeonAuthEmailAndPasswordConfigOutput = typeof UpdateNeonAuthEmailAndPasswordConfigOutput.Type;
 ...
 */
export const updateNeonAuthEmailAndPasswordConfig = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({
