...
// Input Schema
export const UpdateNeonAuthAllowLocalhostInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
// Output Schema
export const UpdateNeonAuthAllowLocalhostOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  allow_localhost: Schema.Boolean,
});
