...
// Input Schema
export interface DeleteProjectBranchRoleInput {
  project_id: string;
  branch_id: string;
  role_name: string;
}
export const DeleteProjectBranchRoleInput =
  ...
  ) as unknown as Schema.Codec<DeleteProjectBranchRoleInput>;

// Output Schema
export interface DeleteProjectBranchRoleOutput {
  role: {
    branch_id: string;
    name: string;
...
export const DeleteProjectBranchRoleOutput =
  ...
  }) as unknown as Schema.Codec<DeleteProjectBranchRoleOutput>;
