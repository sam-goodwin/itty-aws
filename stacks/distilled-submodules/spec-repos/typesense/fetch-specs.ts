#!/usr/bin/env bun
/**
 * Mirrors the Typesense API spec into ../specs/.
 *
 * Only the 1 file the distilled typesense generator actually reads
...
const REPO = "typesense/typesense-api-spec";
...
const FILES: SpecFile[] = [{ path: "openapi.yml", output: "openapi.yml" }];
