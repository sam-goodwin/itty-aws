#!/usr/bin/env bun
/**
 * Mirrors the Expo EAS API spec into ../specs/.
 *
 * Only the 1 file the distilled expo-eas generator actually reads
...
const FILES: SpecFile[] = [
  {
    path: "packages/eas-cli/graphql.schema.json",
    output: "graphql.schema.json",
  },
];
