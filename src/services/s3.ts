...
export type AnalyticsFilter = { Prefix: string } | { Tag: Tag } | { And: AnalyticsAndOperator };
...
export type MetricsFilter = { Prefix: string } | { Tag: Tag } | { AccessPointArn: string } | { And: MetricsAndOperator };
...
export declare class NoSuchKey extends Data.TaggedError(
  "NoSuchKey",
)<{
}> {}
...
export declare class NotFound extends Data.TaggedError(
  "NotFound",
)<{
}> {}
...
export type SelectObjectContentEventStream = { Records: RecordsEvent } | { Stats: StatsEvent } | { Progress: ProgressEvent } | { Cont: ContinuationEvent } | { End: EndEvent };
